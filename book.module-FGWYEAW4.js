import {
  subMinutes
} from "./chunk-K3MROOIF.js";
import {
  FindAvailabilityModalComponent
} from "./chunk-DJQ2HJQK.js";
import {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringItemModalComponent, { className: "CateringItemModalComponent", filePath: "libs/catering/src/lib/catering-item-modal.component.ts", lineNumber: 370 });
})();
...
_CateringImportMenuModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringImportMenuModalComponent, selectors: [["catering-import-menu-modal"]], outputs: { event: "event" }, decls: 7, vars: 5, consts: [[1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "h-[24rem]", "w-[24rem]", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "relative", "mx-2", "flex", "h-[24rem]", "w-[24rem]", "cursor-pointer", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-xl", "border-4", "border-dashed", "border-base-300", "p-4", "hover:bg-base-200"], [1, "text-8xl", "opacity-30"], [1, "px-4", "text-center", "opacity-30"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], [1, "flex", "items-center", "justify-center", "p-2"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], ["diameter", "32"]], template: function CateringImportMenuModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringImportMenuModalComponent, { className: "CateringImportMenuModalComponent", filePath: "libs/catering/src/lib/catering-import-menu-modal.component.ts", lineNumber: 81 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CateringOrderModalComponent, [{
    ...
    `, imports: [
      ...
      IconComponent,
      FormsModule
    ], styles: ["/* angular:styles/component:css;5536655fe6280e2e9325798331e95ca078d9d7135df9909d513f54cd4f999c56;/home/runner/work/user-interfaces/user-interfaces/libs/catering/src/lib/catering-order-modal.component.ts */\n.list {\n  height: 24em;\n  min-width: 32em;\n  max-width: calc(100vw - 1em);\n}\nfooter button {\n  min-width: 12em;\n}\ninput {\n  position: relative;\n  width: 100%;\n  padding: 1em;\n  border: none;\n  border-radius: 0 !important;\n  border-top: 1px solid #ccc;\n  border-bottom: 1px solid #ccc;\n  outline: none;\n  font-size: 1em;\n}\ninput:focus {\n  border: none;\n  border-top: 2px solid var(--s);\n  border-bottom: 2px solid var(--s);\n  box-shadow: none;\n}\ninput.error::placeholder {\n  color: rgba(var(--error), 0.45);\n}\n/*# sourceMappingURL=catering-order-modal.component.css.map */\n"] }]
  }], () => [], { event: [{
    type: Output
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringOrderModalComponent, { className: "CateringOrderModalComponent", filePath: "libs/catering/src/lib/catering-order-modal.component.ts", lineNumber: 277 });
})();
...
_CateringOrderListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringOrderListComponent, selectors: [["catering-order-list"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 27, vars: 61, consts: [["state_template", ""], ["time_template", ""], ["location_template", ""], ["host_template", ""], ["status_template", ""], ["actions_template", ""], ["child_template", ""], ["menu", "matMenu"], ["notes_template", ""], [1, "flex", "h-full", "w-full", "flex-col", "overflow-auto"], ["mode", "indeterminate", 1, "sticky", "left-0", "top-0", "w-full"], [1, "block", "w-full", "min-w-[72rem]", "text-sm", 3, "data", "columns", "sortable", "show_children", "child_template", "empty_message"], [1, "p-2"], [1, "flex", "items-center", "justify-center", "rounded-full", "bg-base-200", "p-2", "text-2xl"], [1, "p-4"], [1, "text-xs", "opacity-30"], [1, "px-4", "py-2"], [1, "opacity-30"], ["status", "", "matRipple", "", 1, "flex", "h-10", "w-36", "items-center", "rounded-3xl", "border-none", "px-4", "text-base", "text-white", 3, "matMenuTriggerFor"], [1, "mx-2", "flex", "text-center", "capitalize"], [1, "pl-2"], ["mat-menu-item", "", 1, "flex", "items-center"], ["mat-menu-item", "", 1, "flex", "items-center", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "mr-2", "h-4", "w-4", "rounded-full"], [1, "mr-2", "w-20"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "matRipple", "", "customTooltip", "", "xPosition", "end", "yPosition", "top", 3, "hover", "content", "disabled"], ["icon", "", "matRipple", "", 3, "click"], [1, "min-w-[8rem]", "max-w-[32rem]", "rounded-lg", "border", "border-base-200", "bg-base-100", "p-2", "text-base-content", "shadow"], [1, "mb-2"], [1, "rounded", "bg-base-200", "px-4", "py-2", "text-sm"], [1, "relative", "z-0", "m-0", "w-full", "list-none", "p-0"], ["catering-order-item", "", 1, "flex", "items-center", 3, "order_id", "item"]], template: function CateringOrderListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9);
...
function CateringItemDetailsComponent_Conditional_0_For_22_Conditional_4_For_6_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function CateringItemDetailsComponent_Conditional_0_For_22_Conditional_4_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-radio-button", 25)(1, "div", 26)(2, "div", 27);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, CateringItemDetailsComponent_Conditional_0_For_22_Conditional_4_For_6_Conditional_4_Template, 3, 4, "div", 28);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const opt_r6 = ctx.$implicit;
...
function CateringItemDetailsComponent_Conditional_0_For_22_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-radio-group", 22);
    \u0275\u0275twoWayListener("ngModelChange", function CateringItemDetailsComponent_Conditional_0_For_22_Conditional_4_Template_mat_radio_group_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r4);
    ...
    \u0275\u0275listener("ngModelChange", function CateringItemDetailsComponent_Conditional_0_For_22_Conditional_4_Template_mat_radio_group_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r4);
      const group_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.updateGroupOption(group_r5, $event));
    });
    \u0275\u0275elementStart(1, "mat-radio-button", 23)(2, "div", 24);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(5, CateringItemDetailsComponent_Conditional_0_For_22_Conditional_4_For_6_Template, 5, 3, "mat-radio-button", 25, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const group_r5 = \u0275\u0275nextContext().$implicit;
...
function CateringItemDetailsComponent_Conditional_0_For_22_Conditional_5_For_1_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 28);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "currency");
...
function CateringItemDetailsComponent_Conditional_0_For_22_Conditional_5_For_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-checkbox", 30);
    \u0275\u0275twoWayListener("ngModelChange", function CateringItemDetailsComponent_Conditional_0_For_22_Conditional_5_For_1_Template_mat_checkbox_ngModelChange_0_listener($event) {
    ...
    \u0275\u0275listener("ngModelChange", function CateringItemDetailsComponent_Conditional_0_For_22_Conditional_5_For_1_Template_mat_checkbox_ngModelChange_0_listener($event) {
      const opt_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateCheckedState(opt_r8.id, $event));
    });
    \u0275\u0275elementStart(1, "div", 17)(2, "div", 31);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, CateringItemDetailsComponent_Conditional_0_For_22_Conditional_5_For_1_Conditional_4_Template, 3, 4, "div", 28);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function CateringItemDetailsComponent_Conditional_0_For_22_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, CateringItemDetailsComponent_Conditional_0_For_22_Conditional_5_For_1_Template, 5, 4, "mat-checkbox", 29, \u0275\u0275repeaterTrackByIdentity);
  }
  if (rf & 2) {
    const group_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275repeater(group_r5 == null ? null : group_r5.options);
...
function CateringItemDetailsComponent_Conditional_0_For_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "div", 19);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 20);
    \u0275\u0275conditionalCreate(4, CateringItemDetailsComponent_Conditional_0_For_22_Conditional_4_Template, 7, 5, "mat-radio-group", 21)(5, CateringItemDetailsComponent_Conditional_0_For_22_Conditional_5_Template, 2, 0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function CateringItemDetailsComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(18, "hr");
    \u0275\u0275elementStart(19, "section", 12)(20, "div", 13);
    \u0275\u0275repeaterCreate(21, CateringItemDetailsComponent_Conditional_0_For_22_Template, 6, 3, "div", 14, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(23, "div", 15)(24, "button", 16);
    \u0275\u0275listener("click", function CateringItemDetailsComponent_Conditional_0_Template_button_click_24_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      ctx_r1.active = !ctx_r1.active;
      return \u0275\u0275resetView(ctx_r1.activeChange.emit(ctx_r1.active));
    });
    \u0275\u0275elementStart(25, "div", 17)(26, "icon", 18);
    \u0275\u0275text(27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "p");
    \u0275\u0275text(29);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(30, 15, ctx_r1.active ? "CATERING.ORDER_ITEM_REMOVE" : "CATERING.ORDER_ITEM_ADD"), " ");
  }
}
function CateringItemDetailsComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "p", 32);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd()();
  }
...
_CateringItemDetailsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringItemDetailsComponent, selectors: [["catering-item-details"]], inputs: { item: "item", active: "active", fav: "fav", code: "code" }, outputs: { toggleFav: "toggleFav", activeChange: "activeChange", close: "close" }, features: [\u0275\u0275NgOnChangesFeature], decls: 2, vars: 1, consts: [["empty", "", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-16"], ["image", "", 1, "relative", "h-64", "w-full", "bg-base-200", "sm:h-40"], [1, "absolute", "inset-0", 3, "images"], ["icon", "", "matRipple", "", "name", "close-catering-item-details", 1, "absolute", "left-2", "top-2", "bg-neutral", "text-white", "sm:hidden", 3, "click"], ["icon", "", "matRipple", "", "name", "toggle-catering-item-favourite-details", 1, "absolute", "right-2", "top-2", 3, "click"], [3, "className"], [1, "h-1/2", "flex-1", "space-y-2", "overflow-auto", "p-2"], ["actions", "", 1, "z-0", "flex", "items-center", "justify-between"], [1, "mb-2", "mt-4", "text-xl", "font-medium"], [3, "ngModelChange", "ngModel", "min", "max"], [1, "flex", "flex-wrap", "items-center"], [1, "m-1", "rounded-2xl", "bg-base-200", "px-2", "py-1", "text-sm", "capitalize"], ["details", "", 1, "space-y-2"], [1, "flex", "flex-col", "flex-wrap"], [1, "min-w-1/2", "flex-1"], [1, "border-t", "border-base-200", "px-2", "pb-[5.5rem]", "pt-2", "shadow", "sm:hidden"], ["btn", "", "matRipple", "", "name", "select-catering-item-details", 1, "w-full", 3, "click"], [1, "flex", "items-center", "justify-center"], [1, "text-2xl"], [1, "p-2", "font-medium", "capitalize"], [1, "flex", "flex-col", "pl-4"], ["aria-label", "Select an option", 1, "flex", "flex-col", 3, "ngModel", "disabled"], ["aria-label", "Select an option", 1, "flex", "flex-col", 3, "ngModelChange", "ngModel", "disabled"], ["value", "", 1, "m-0"], [1, "p-2", "font-medium", "opacity-60"], [1, "m-0", 3, "value"], [1, "flex", "max-w-[calc(100vw-4rem)]", "items-center", "justify-center", "sm:max-w-[15rem]"], [1, "w-1/2", "flex-1", "whitespace-normal", "p-2", "font-medium", "capitalize"], [1, "text-xs", "opacity-60"], [3, "ngModel", "disabled"], [3, "ngModelChange", "ngModel", "disabled"], [1, "w-1/2", "flex-1", "p-2", "font-medium"], [1, "text-center", "opacity-30"]], template: function CateringItemDetailsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, CateringItemDetailsComponent_Conditional_0_Template, 31, 17)(1, CateringItemDetailsComponent_Conditional_1_Template, 4, 3, "div", 0);
  }
  if (rf & 2) {
    \u0275\u0275conditional(ctx.item ? 0 : 1);
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CateringItemDetailsComponent, [{
    ...
    `, imports: [
      ...
      CounterComponent,
      ImageCarouselComponent
    ], styles: ["/* angular:styles/component:css;a66e4ce37902106698f7ffd2a8b8ad629be11d1630b05efe8db8afcd7e758b2c;/home/runner/work/user-interfaces/user-interfaces/libs/catering/src/lib/catering-order-modal/catering-item-details.component.ts */\n:host {\n  display: flex;\n  flex-direction: column;\n  width: 30%;\n  min-width: 20rem;\n  height: 100%;\n  min-height: 65vh;\n}\n/*# sourceMappingURL=catering-item-details.component.css.map */\n"] }]
  }], null, { item: [{
    type: Input
  }], active: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringItemDetailsComponent, { className: "CateringItemDetailsComponent", filePath: "libs/catering/src/lib/catering-order-modal/catering-item-details.component.ts", lineNumber: 272 });
})();
...
function CateringItemFiltersComponent_Conditional_7_For_9_Template(rf, ctx) {
  if (rf & 1) {
...
function CateringItemFiltersComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 1)(5, "mat-select", 10);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275pipe(7, "async");
    \u0275\u0275listener("ngModelChange", function CateringItemFiltersComponent_Conditional_7_Template_mat_select_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setFilters({ caterer: $event }));
    });
    \u0275\u0275repeaterCreate(8, CateringItemFiltersComponent_Conditional_7_For_9_Template, 2, 2, "mat-option", 11, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(10, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function CateringItemFiltersComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function CateringItemFiltersComponent_Conditional_10_Conditional_4_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 11);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function CateringItemFiltersComponent_Conditional_10_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 14)(4, "mat-select", 10);
    \u0275\u0275twoWayListener("ngModelChange", function CateringItemFiltersComponent_Conditional_10_Conditional_4_Template_mat_select_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.offset_day, $event) || (ctx_r1.offset_day = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function CateringItemFiltersComponent_Conditional_10_Conditional_4_Template_mat_select_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.offset_dayChange.next($event));
    });
    \u0275\u0275repeaterCreate(5, CateringItemFiltersComponent_Conditional_10_Conditional_4_For_6_Template, 3, 5, "mat-option", 11, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function CateringItemFiltersComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 6)(1, "mat-checkbox", 12);
    \u0275\u0275twoWayListener("ngModelChange", function CateringItemFiltersComponent_Conditional_10_Template_mat_checkbox_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.at_time, $event) || (ctx_r1.at_time = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function CateringItemFiltersComponent_Conditional_10_Template_mat_checkbox_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, CateringItemFiltersComponent_Conditional_10_Conditional_4_Template, 7, 4);
    \u0275\u0275elementStart(5, "label");
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "a-duration-field", 13);
    \u0275\u0275pipe(9, "async");
    \u0275\u0275twoWayListener("ngModelChange", function CateringItemFiltersComponent_Conditional_10_Template_a_duration_field_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.offset, $event) || (ctx_r1.offset = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function CateringItemFiltersComponent_Conditional_10_Template_a_duration_field_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.day_options.length > 1 ? 4 : -1);
    \u0275\u0275advance(2);
...
function CateringItemFiltersComponent_For_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-checkbox", 10);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275listener("ngModelChange", function CateringItemFiltersComponent_For_14_Template_mat_checkbox_ngModelChange_0_listener() {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ngModel", (tmp_10_0 = \u0275\u0275pipeBind1(1, 3, ctx_r1.filters)) == null ? null : tmp_10_0.categories == null ? null : tmp_10_0.categories.includes(item_r8));
...
_CateringItemFiltersComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringItemFiltersComponent, selectors: [["catering-item-filters"]], inputs: { search: "search", at_time: "at_time", offset: "offset", offset_day: "offset_day" }, outputs: { at_timeChange: "at_timeChange", offsetChange: "offsetChange", offset_dayChange: "offset_dayChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 16, vars: 20, consts: [[1, "mb-2", "mt-2", "px-2"], ["appearance", "outline", 1, "h-14", "w-full"], ["matPrefix", "", 1, "text-xl"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], [1, "hidden", "px-2", "py-2", "sm:block"], [1, "hidden", "px-2", "py-2", "font-medium", "sm:block"], [1, "flex", "flex-col", "px-2"], [1, "hidden", "px-2", "py-4", "font-medium", "sm:block"], [1, "flex", "flex-col", "space-y-2", "px-2"], [3, "ngModel"], [3, "ngModelChange", "ngModel"], [3, "value"], [3, "ngModelChange", "ngModel", "matTooltip"], [3, "ngModelChange", "ngModel", "time", "step", "min", "max", "use_24hr"], ["appearance", "outline", 1, "no-subscript", "mb-4", "w-full"]], template: function CateringItemFiltersComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(7, CateringItemFiltersComponent_Conditional_7_Template, 11, 10, "div", 4);
    \u0275\u0275pipe(8, "async");
    \u0275\u0275conditionalCreate(9, CateringItemFiltersComponent_Conditional_9_Template, 3, 3, "h3", 5);
    \u0275\u0275conditionalCreate(10, CateringItemFiltersComponent_Conditional_10_Template, 10, 17, "div", 6);
    \u0275\u0275conditionalCreate(11, CateringItemFiltersComponent_Conditional_11_Template, 3, 3, "h3", 7);
    \u0275\u0275elementStart(12, "div", 8);
    \u0275\u0275repeaterCreate(13, CateringItemFiltersComponent_For_14_Template, 3, 5, "mat-checkbox", 9, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(15, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", (tmp_1_0 = \u0275\u0275pipeBind1(5, 12, ctx.filters)) == null ? null : tmp_1_0.search)("placeholder", \u0275\u0275pipeBind1(6, 14, "CATERING.MENU_SEARCH"));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!ctx.search && ((tmp_3_0 = \u0275\u0275pipeBind1(8, 16, ctx.caterers)) == null ? null : tmp_3_0.length) > 1 ? 7 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx.search ? 9 : -1);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275repeater(\u0275\u0275pipeBind1(15, 18, ctx.categories));
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CateringItemFiltersComponent, [{
    ...
    `, imports: [
      ...
      FormsModule,
      MatTooltipModule
    ], styles: ["/* angular:styles/component:css;e0abaa33836e11e9884ebb76a9ba1496ebe025201e47e5fbafc8bf29d7b7cf09;/home/runner/work/user-interfaces/user-interfaces/libs/catering/src/lib/catering-order-modal/catering-item-filters.component.ts */\n:host {\n  min-width: 16rem;\n  overflow: auto;\n}\n/*# sourceMappingURL=catering-item-filters.component.css.map */\n"] }]
  }], () => [], { search: [{
    type: Input
  }], at_time: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringItemFiltersComponent, { className: "CateringItemFiltersComponent", filePath: "libs/catering/src/lib/catering-order-modal/catering-item-filters.component.ts", lineNumber: 207 });
})();
...
_CateringItemListItemComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringItemListItemComponent, selectors: [["catering-item-list-item"]], inputs: { item: "item", active: "active", selected: "selected", favourite: "favourite", code: "code" }, outputs: { toggleFav: "toggleFav", select: "select" }, decls: 23, vars: 16, consts: [["item", "", "matRipple", "", 1, "relative", "w-full", "rounded-lg", "border", "border-base-200", "bg-base-100", "p-2", "shadow", "sm:w-[20rem]"], ["name", "select-catering-item", 1, "z-0", "flex", "h-full", "w-full", "items-center", 3, "click"], [1, "relative", "mr-4", "flex", "h-16", "w-16", "items-center", "justify-center", "overflow-hidden", "rounded-xl", "border", "border-base-200", "bg-neutral"], [1, "absolute", "left-1", "top-1", "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", "border", "border-white", "bg-neutral", "text-xs", "text-white"], ["auth", "", 1, "min-h-full", "min-w-full", "object-cover", 3, "source"], ["src", "assets/icons/catering-placeholder.svg", 1, "m-auto"], [1, "flex-1", "space-y-2", "text-left"], [1, "flex", "flex-col", "pr-10", "font-medium"], [1, "text-xs", "opacity-60"], [1, "flex", "items-center", "space-x-1", "text-sm"], [1, "w-px", "flex-1", "rounded", "bg-base-100"], [1, "rounded-2xl", "border", "border-base-200", "px-2", "py-1", "text-xs", "shadow"], [1, "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "bg-success", "text-xs", "shadow"], [1, "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "bg-info", "text-xs", "shadow"], [1, "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "bg-warning", "text-xs", "shadow"], [1, "bg-orange-600", "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "text-xs", "shadow"], ["icon", "", "matRipple", "", "name", "toggle-catering-item-favourite", 1, "absolute", "right-1", "top-1", 3, "click"], [3, "className"]], template: function CateringItemListItemComponent_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional((ctx.item.images == null ? null : ctx.item.images.length) ? 4 : 5);
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional((ctx.item.option_list == null ? null : ctx.item.option_list.length) ? 14 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((ctx.item.tags == null ? null : ctx.item.tags.includes("Gluten Free")) ? 15 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((ctx.item.tags == null ? null : ctx.item.tags.includes("Vegan")) ? 16 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((ctx.item.tags == null ? null : ctx.item.tags.includes("Vegetarian")) ? 17 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((ctx.item.tags == null ? null : ctx.item.tags.includes("Contains Dairy")) ? 18 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((ctx.item.tags == null ? null : ctx.item.tags.includes("Contains Nuts")) ? 19 : -1);
    \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringItemListItemComponent, { className: "CateringItemListItemComponent", filePath: "libs/catering/src/lib/catering-order-modal/catering-item-list-item.component.ts", lineNumber: 130 });
})();

// libs/catering/src/lib/catering-order-modal/catering-item-list.component.ts
var _c06 = (a0) => ({ count: a0 });
var _forTrack0 = ($index, $item) => $item.custom_id;
function CateringItemListComponent_Conditional_1_For_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "catering-item-list-item", 6);
    \u0275\u0275listener("toggleFav", function CateringItemListComponent_Conditional_1_For_9_Template_catering_item_list_item_toggleFav_0_listener() {
      const item_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.toggleFav.emit(item_r2.id));
    })("select", function CateringItemListComponent_Conditional_1_For_9_Template_catering_item_list_item_select_0_listener() {
      const item_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function CateringItemListComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(8, CateringItemListComponent_Conditional_1_For_9_Template, 1, 4, "catering-item-list-item", 5, _forTrack0);
    \u0275\u0275pipe(10, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function CateringItemListComponent_Conditional_10_Conditional_0_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "catering-item-list-item", 9);
    \u0275\u0275listener("toggleFav", function CateringItemListComponent_Conditional_10_Conditional_0_For_2_Template_catering_item_list_item_toggleFav_0_listener() {
      const item_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.toggleFav(item_r5.id));
    })("select", function CateringItemListComponent_Conditional_10_Conditional_0_For_2_Template_catering_item_list_item_select_0_listener() {
      const item_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
...
function CateringItemListComponent_Conditional_10_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 4);
    \u0275\u0275repeaterCreate(1, CateringItemListComponent_Conditional_10_Conditional_0_For_2_Template, 1, 5, "catering-item-list-item", 8, _forTrack0);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function CateringItemListComponent_Conditional_10_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function CateringItemListComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, CateringItemListComponent_Conditional_10_Conditional_0_Template, 4, 2, "ul", 4);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275conditionalBranchCreate(2, CateringItemListComponent_Conditional_10_Conditional_2_Template, 4, 3, "div", 7);
  }
  if (rf & 2) {
    let tmp_1_0;
    const ctx_r2 = \u0275\u0275nextContext();
...
function CateringItemListComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 3);
...
_CateringItemListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringItemListComponent, selectors: [["catering-item-list"]], inputs: { active: "active", selected: "selected", selected_items: "selected_items", favorites: "favorites" }, outputs: { toggleFav: "toggleFav", onSelect: "onSelect" }, features: [\u0275\u0275NgOnChangesFeature], decls: 13, vars: 17, consts: [[1, "h-full", "w-full", "overflow-auto", "py-2"], [1, "px-2", "font-bold"], ["count", "", 1, "mb-2", "px-2", "text-sm", "opacity-60"], ["loading", "", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-16"], [1, "list-style-none", "space-y-2", "p-2"], [1, "block", 3, "item", "active", "selected", "favourite"], [1, "block", 3, "toggleFav", "select", "item", "active", "selected", "favourite"], ["empty", "", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-16"], [1, "block", 3, "item", "active", "selected", "favourite", "code"], [1, "block", 3, "toggleFav", "select", "item", "active", "selected", "favourite", "code"], [1, "text-center", "opacity-30"], [3, "diameter"], [1, "opacity-30"]], template: function CateringItemListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275conditionalCreate(1, CateringItemListComponent_Conditional_1_Template, 11, 13);
    \u0275\u0275pipe(2, "async");
    ...
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(10, CateringItemListComponent_Conditional_10_Template, 3, 3);
    \u0275\u0275pipe(11, "async");
    \u0275\u0275conditionalBranchCreate(12, CateringItemListComponent_Conditional_12_Template, 5, 4, "div", 3);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_0_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringItemListComponent, { className: "CateringItemListComponent", filePath: "libs/catering/src/lib/catering-order-modal/catering-item-list.component.ts", lineNumber: 100 });
})();

// libs/catering/src/lib/catering-order-modal/new-catering-order-modal.component.ts
var _c07 = (a0) => ({ count: a0 });
function NewCateringOrderModalComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 20);
    \u0275\u0275listener("click", function NewCateringOrderModalComponent_Conditional_15_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
_NewCateringOrderModalComponent.\u0275fac = function NewCateringOrderModalComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NewCateringOrderModalComponent)();
};
_NewCateringOrderModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewCateringOrderModalComponent, selectors: [["new-catering-order-modal"]], decls: 37, vars: 44, consts: [[1, "flex", "h-[100vh]", "w-[100vw]", "flex-col", "bg-base-100", "sm:relative", "sm:h-auto", "sm:w-auto"], [1, "flex", "w-full", "items-center", "justify-between", "space-x-4"], ["icon", "", "matRipple", "", 3, "mat-dialog-close"], [1, "flex", "h-[65vh]", "min-h-[65vh]", "w-full", "flex-1", "items-center", "divide-x", "divide-base-200", "overflow-hidden", "sm:max-h-[65vh]", "sm:max-w-[95vw]"], [1, "hidden", "h-full", "sm:block", "sm:h-[65vh]", "sm:max-h-full", "sm:max-w-[12rem]", 3, "at_timeChange", "offsetChange", "offset_dayChange", "at_time", "offset", "offset_day"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col", "items-center", "sm:h-[65vh]"], [1, "w-full", "border-b", "border-base-200", 3, "search"], [1, "h-1/2", "w-full", "flex-1", "overflow-hidden", 3, "toggleFav", "onSelect", "active", "selected", "selected_items", "favorites"], [1, "absolute", "z-20", "h-full", "w-full", "bg-base-100", "sm:relative", "sm:flex", "sm:h-[65vh]", "sm:max-w-[16rem]", 3, "activeChange", "toggleFav", "close", "item", "active", "code", "fav"], [1, "flex", "w-full", "flex-col-reverse", "items-center", "justify-end", "border-t", "border-base-200", "px-2", "pb-[5.5rem]", "pt-2", "sm:hidden"], ["btn", "", "matRipple", "", "name", "catering-item-return", 1, "inverse", "w-full", "sm:hidden", "sm:w-auto"], ["btn", "", "matRipple", "", "name", "save-catering-item", 1, "w-full", "sm:mb-0", "sm:w-auto", 3, "mat-dialog-close"], [1, "hidden", "w-full", "items-center", "justify-between", "border-t", "border-base-200", "p-2", "sm:flex"], ["btn", "", "matRipple", "", "name", "catering-item-return", 1, "clear", "text-secondary", 3, "mat-dialog-close"], [1, "flex", "items-center"], [1, "text-xl"], [1, "mr-1", "underline"], [1, "text-sm", "opacity-60"], ["btn", "", "matRipple", "", "name", "toggle-catering-item", 3, "click", "disabled"], [1, "mr-1"], ["btn", "", "matRipple", "", "name", "catering-item-return", 1, "inverse", "w-full", "sm:hidden", "sm:w-auto", 3, "click"]], template: function NewCateringOrderModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(15, NewCateringOrderModalComponent_Conditional_15_Template, 3, 3, "button", 10);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NewCateringOrderModalComponent, [{
    type: Component,
    args: [{ selector: "new-catering-order-modal", template: `
        <div
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewCateringOrderModalComponent, { className: "NewCateringOrderModalComponent", filePath: "libs/catering/src/lib/catering-order-modal/new-catering-order-modal.component.ts", lineNumber: 159 });
})();
...
_NewCateringItemDetailsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewCateringItemDetailsComponent, selectors: [["new-catering-item-details"]], inputs: { item: "item", active: "active", fav: "fav", code: "code" }, outputs: { toggleFav: "toggleFav", activeChange: "activeChange", close: "close" }, features: [\u0275\u0275NgOnChangesFeature], decls: 2, vars: 1, consts: [["empty", "", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-16"], ["image", "", 1, "relative", "h-64", "w-full", "bg-base-200", "sm:h-40"], [1, "absolute", "inset-0", 3, "images"], ["icon", "", "matRipple", "", "name", "close-catering-item-details", 1, "absolute", "left-2", "top-2", "bg-base-100", "lg:hidden", 3, "click"], ["icon", "", "matRipple", "", "name", "toggle-catering-item-favourite-details", 1, "absolute", "right-2", "top-2", "bg-base-100", 3, "click"], [3, "className"], [1, "flex-1", "space-y-4", "p-2"], ["actions", "", 1, "z-0", "flex", "items-center", "justify-between"], [1, "mb-2", "mt-4", "text-xl", "font-medium"], [3, "ngModelChange", "ngModel", "min", "max"], [1, "flex", "flex-wrap", "items-center"], [1, "m-1", "rounded-2xl", "bg-base-200", "px-2", "py-1", "text-sm", "capitalize"], ["details", "", 1, "space-y-2"], [1, "flex", "flex-col", "space-y-4"], [1, "relative", "space-y-2", "rounded", "border", "border-base-400", "px-3", "pb-2", "pt-4"], [1, "text-md", "absolute", "left-2", "top-0", "-translate-y-1/2", "bg-base-100", "px-2", "font-medium"], [1, "flex", "flex-col"], ["aria-label", "Select an option", 1, "flex", "flex-col", 3, "ngModel", "disabled"], ["aria-label", "Select an option", 1, "flex", "flex-col", 3, "ngModelChange", "ngModel", "disabled"], ["value", "", 1, "m-0"], [1, "p-2", "font-medium", "opacity-60"], [1, "m-0", 3, "value"], [1, "flex", "max-w-[calc(100vw-4rem)]", "items-center", "justify-center", "sm:max-w-[15rem]"], [1, "w-1/2", "flex-1", "whitespace-normal", "p-2", "font-medium", "capitalize"], [1, "text-xs", "opacity-60"], [3, "ngModel", "disabled"], [3, "ngModelChange", "ngModel", "disabled"], [1, "flex", "items-center", "justify-center"], [1, "w-1/2", "flex-1", "p-2", "font-medium"], [1, "text-center", "opacity-30"]], template: function NewCateringItemDetailsComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewCateringItemDetailsComponent, { className: "NewCateringItemDetailsComponent", filePath: "libs/catering/src/lib/new-catering-order-modal/new-catering-item-details.component.ts", lineNumber: 235 });
})();
...
function NewCateringItemFiltersComponent_Conditional_14_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function NewCateringItemFiltersComponent_Conditional_14_Conditional_3_Template_mat_select_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.offset_day, $event) || (ctx_r1.offset_day = $event);
      return \u0275\u0275resetView($event);
...
function NewCateringItemFiltersComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function NewCateringItemFiltersComponent_Conditional_14_Template_settings_toggle_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.at_time, $event) || (ctx_r1.at_time = $event);
      return \u0275\u0275resetView($event);
    ...
    \u0275\u0275pipe(8, "async");
    \u0275\u0275twoWayListener("ngModelChange", function NewCateringItemFiltersComponent_Conditional_14_Template_a_duration_field_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.offset, $event) || (ctx_r1.offset = $event);
      return \u0275\u0275resetView($event);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewCateringItemFiltersComponent, { className: "NewCateringItemFiltersComponent", filePath: "libs/catering/src/lib/new-catering-order-modal/new-catering-item-filters.component.ts", lineNumber: 205 });
})();
...
_NewCateringItemListItemComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewCateringItemListItemComponent, selectors: [["new-catering-item-list-item"]], inputs: { item: "item", active: "active", selected: "selected", favourite: "favourite", code: "code" }, outputs: { toggleFav: "toggleFav", select: "select" }, decls: 23, vars: 16, consts: [["item", "", "matRipple", "", 1, "relative", "w-full", "rounded-lg", "border", "border-base-200", "bg-base-100", "p-2", "shadow"], ["name", "select-catering-item", 1, "z-0", "flex", "h-full", "w-full", "items-center", 3, "click"], [1, "relative", "mr-4", "flex", "h-16", "w-16", "items-center", "justify-center", "overflow-hidden", "rounded-xl", "border", "border-base-200", "bg-neutral"], [1, "absolute", "left-1", "top-1", "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", "border", "border-white", "bg-neutral", "text-xs", "text-white"], ["auth", "", 1, "min-h-full", "min-w-full", "object-cover", 3, "source"], ["src", "assets/icons/catering-placeholder.svg", 1, "m-auto"], [1, "flex-1", "space-y-2", "text-left"], [1, "flex", "flex-col", "pr-10", "font-medium"], [1, "text-xs", "opacity-60"], [1, "flex", "items-center", "space-x-1", "text-sm"], [1, "w-px", "flex-1", "rounded", "bg-base-100"], [1, "rounded-2xl", "border", "border-base-200", "px-2", "py-1", "text-xs", "shadow"], [1, "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "bg-success", "text-xs", "shadow"], [1, "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "bg-info", "text-xs", "shadow"], [1, "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "bg-warning", "text-xs", "shadow"], [1, "bg-orange-600", "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "text-xs", "shadow"], ["icon", "", "matRipple", "", "name", "toggle-catering-item-favourite", 1, "absolute", "right-1", "top-1", 3, "click"], [3, "className"]], template: function NewCateringItemListItemComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 0)(1, "button", 1);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewCateringItemListItemComponent, { className: "NewCateringItemListItemComponent", filePath: "libs/catering/src/lib/new-catering-order-modal/new-catering-item-list-item.component.ts", lineNumber: 130 });
})();
...
function NewCateringItemListComponent_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 2, "CATERING.ORDER_SELECTED_HEADER"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 6, "CATERING.ORDER_SELECTED_COUNT", \u0275\u0275pureFunction1(11, _c08, ((tmp_2_0 = \u0275\u0275pipeBind1(5, 4, ctx_r2.list)) == null ? null : tmp_2_0.length) || 0)), " ");
    \u0275\u0275advance(4);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(10, 9, ctx_r2.list));
  }
}
...
_NewCateringItemListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewCateringItemListComponent, selectors: [["new-catering-item-list"]], inputs: { active: "active", selected: "selected", selected_items: "selected_items", favorites: "favorites" }, outputs: { toggleFav: "toggleFav", onSelect: "onSelect" }, features: [\u0275\u0275NgOnChangesFeature], decls: 13, vars: 17, consts: [[1, "h-full", "w-full", "py-2"], [1, "px-2", "font-bold"], ["count", "", 1, "mb-2", "px-2", "text-sm", "opacity-60"], ["loading", "", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-16"], [1, "list-style-none", "space-y-2", "p-2"], [1, "block", 3, "item", "active", "selected", "favourite"], [1, "block", 3, "toggleFav", "select", "item", "active", "selected", "favourite"], ["empty", "", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-16"], [1, "block", 3, "item", "active", "selected", "favourite", "code"], [1, "block", 3, "toggleFav", "select", "item", "active", "selected", "favourite", "code"], [1, "text-center", "opacity-30"], [3, "diameter"], [1, "opacity-30"]], template: function NewCateringItemListComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 6, "COMMON.RESULTS"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(9, 10, "COMMON.RESULTS_COUNT", \u0275\u0275pureFunction1(15, _c08, ((tmp_2_0 = \u0275\u0275pipeBind1(8, 8, ctx.item_list)) == null ? null : tmp_2_0.length) || 0)), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!\u0275\u0275pipeBind1(11, 13, ctx.loading) ? 10 : 12);
  }
}, dependencies: [
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewCateringItemListComponent, { className: "NewCateringItemListComponent", filePath: "libs/catering/src/lib/new-catering-order-modal/new-catering-item-list.component.ts", lineNumber: 100 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewCateringSelectModalComponent, { className: "NewCateringSelectModalComponent", filePath: "libs/catering/src/lib/new-catering-order-modal/new-catering-select-modal.component.ts", lineNumber: 147 });
})();
...
function CateringListFieldComponent_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(22, CateringListFieldComponent_For_2_For_23_Template, 14, 14, "div", 14, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(8, 19, "CALENDAR_EVENT.CATERING_ORDER_AT_DATE", \u0275\u0275pureFunction2(30, _c09, \u0275\u0275pipeBind2(6, 13, order_r4.deliver_at_time, "mediumDate"), \u0275\u0275pipeBind2(7, 16, order_r4.deliver_at_time, ctx_r1.time_format))), " ");
    \u0275\u0275advance(4);
...
_ChargeCodeListModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChargeCodeListModalComponent, selectors: [["charge-code-list-modal"]], decls: 8, vars: 6, consts: [[1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "max-h-[65vh]", "min-h-[20rem]", "flex-col", "overflow-auto"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-20"], [1, "flex", "items-center", "space-x-2", "border-t", "border-base-200", "p-2"], [1, "flex", "h-full", "min-h-[20rem]", "w-full", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "flex", "w-full", "items-center", "space-x-2", "px-2", "py-1", "hover:bg-base-200"], ["appearance", "outline", 1, "no-subscript", "flex-1"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "border", "border-error", "text-error", 3, "click", "matTooltip"], [1, "text-2xl"], [1, "opacity-30"], ["diameter", "32"], ["btn", "", "matRipple", "", 1, "inverse", "relative", "w-48"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "border", "border-secondary", "text-secondary", 3, "click", "matTooltip"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click"]], template: function ChargeCodeListModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "header", 0)(1, "h2", 1);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
...
_SharedCateringModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [STANDALONE_COMPONENTS] });
var SharedCateringModule = _SharedCateringModule;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SharedCateringModule, [{
    type: NgModule,
    args: [{
      declarations: [],
...
_BookComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookComponent, selectors: [["placeos-book"]], standalone: false, decls: 5, vars: 2, consts: [[1, "flex", "h-1/2", "flex-1", "flex-col-reverse", "sm:flex-row"], [1, "flex", "h-1/2", "flex-1", "flex-col", "overflow-hidden", "sm:h-auto"], [1, "z-10"]], template: function BookComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookComponent, { className: "BookComponent", filePath: "apps/workplace/src/app/book/book.component.ts", lineNumber: 30 });
})();
...
function NewDeskFlowConfirmComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
...
function NewDeskFlowConfirmComponent_Conditional_28_For_19_Template(rf, ctx) {
  if (rf & 1) {
...
function NewDeskFlowConfirmComponent_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(18, NewDeskFlowConfirmComponent_Conditional_28_For_19_Template, 5, 1, "div", 20, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function NewDeskFlowConfirmComponent_Conditional_29_For_8_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
...
function NewDeskFlowConfirmComponent_Conditional_29_For_8_For_14_Template(rf, ctx) {
  if (rf & 1) {
...
function NewDeskFlowConfirmComponent_Conditional_29_For_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, NewDeskFlowConfirmComponent_Conditional_29_For_8_Conditional_7_Template, 3, 1, "div", 28);
    \u0275\u0275element(8, "div", 29);
    ...
    \u0275\u0275repeaterCreate(13, NewDeskFlowConfirmComponent_Conditional_29_For_8_For_14_Template, 6, 2, "div", 32, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 10, "FORM.ASSETS_REQUESTED_FOR", \u0275\u0275pureFunction1(16, _c013, \u0275\u0275pipeBind2(5, 7, request_r4.deliver_at_time, "MMM d, " + ctx_r1.time_format))), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.end_time < request_r4.deliver_at || request_r4.conflict ? 7 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 13, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(18, _c17, request_r4.item_count)), " ");
    \u0275\u0275advance(3);
...
function NewDeskFlowConfirmComponent_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(7, NewDeskFlowConfirmComponent_Conditional_29_For_8_Template, 15, 20, "div", 23, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function NewDeskFlowConfirmComponent_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 36);
    \u0275\u0275listener("click", function NewDeskFlowConfirmComponent_Conditional_32_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
_NewDeskFlowConfirmComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDeskFlowConfirmComponent, selectors: [["desk-flow-confirm"]], inputs: { show_close: "show_close" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 34, vars: 21, consts: [[1, "sticky", "top-2", "z-10", "mx-auto", "mb-4", "flex", "h-14", "w-full", "max-w-[calc(100%-1rem)]", "items-center", "justify-between", "rounded", "border-none", "bg-base-200", "p-2"], [1, "m-0", "flex-1", "px-2", "text-xl", "font-medium", "capitalize"], [1, ""], ["diameter", "32"], ["icon", "", "name", "close-desk-confirm", "matRipple", ""], ["period", "", 1, "flex", "space-x-1", "px-2", "py-4", "text-base"], [1, "text-2xl", "text-success"], ["details", "", 1, "space-y-2"], [1, "text-xl"], [1, "flex", "items-center", "space-x-2"], ["date", ""], ["time", ""], [1, "text-xs", "opacity-30"], ["desk", "", 1, "flex", "space-x-1", "border-t", "border-neutral", "px-2", "py-4", "text-base"], ["assets", "", 1, "flex", "max-h-[50vh]", "space-x-1", "overflow-auto", "border-t", "px-2", "py-4"], ["locker", "", 1, "flex", "space-x-1", "border-t", "px-2", "py-4"], [1, "mt-4", "w-full", "border-t", "border-base-200", "p-2"], ["name", "confirm-desk", "btn", "", "matRipple", "", 1, "w-full"], ["icon", "", "name", "close-desk-confirm", "matRipple", "", 3, "click"], [1, "text-2xl"], ["features", "", 1, "flex", "items-center", "space-x-2"], [1, "text-success"], ["details", "", 1, "w-1/2", "flex-1", "pr-2", "leading-6"], ["request", "", 1, "overflow-hidden", "rounded-xl", "border", "bg-base-100", 3, "border-error", "border-base-300"], ["request", "", 1, "overflow-hidden", "rounded-xl", "border", "bg-base-100"], [1, "flex", "items-center", "space-x-2", "p-3"], [1, "flex", "flex-1", "items-center", "space-x-2"], [1, "text-sm"], [1, "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", "bg-error", "text-error-content", 3, "matTooltip"], [1, "flex-1"], [1, "rounded", "bg-success", "px-2", "py-1", "text-xs", "text-success-content"], [1, "flex", "flex-col", "divide-y", "divide-base-100", "bg-base-200"], [1, "flex", "items-center", "space-x-2", "px-3", "py-1", "hover:opacity-90"], [1, "flex", "flex-1", "items-center"], ["details", "", 1, "leading-6"], [1, "flex", "space-x-2"], ["name", "confirm-desk", "btn", "", "matRipple", "", 1, "w-full", 3, "click"]], template: function NewDeskFlowConfirmComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(19, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(20, NewDeskFlowConfirmComponent_Conditional_20_Template, 5, 1, "div", 9);
    \u0275\u0275elementStart(21, "div", 9)(22, "icon", 8);
    \u0275\u0275text(23, "schedule");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 11)(25, "div", 11);
    \u0275\u0275text(26);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(27, NewDeskFlowConfirmComponent_Conditional_27_Template, 2, 1, "div", 12);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(28, NewDeskFlowConfirmComponent_Conditional_28_Template, 20, 7, "section", 13);
    \u0275\u0275conditionalCreate(29, NewDeskFlowConfirmComponent_Conditional_29_Template, 9, 3, "section", 14);
    \u0275\u0275conditionalCreate(30, NewDeskFlowConfirmComponent_Conditional_30_Template, 10, 3, "section", 15);
    \u0275\u0275elementStart(31, "footer", 16);
    \u0275\u0275conditionalCreate(32, NewDeskFlowConfirmComponent_Conditional_32_Template, 3, 3, "button", 17);
    \u0275\u0275pipe(33, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.booking.recurrence_type && ctx.booking.recurrence_type !== "none" ? 20 : -1);
    \u0275\u0275advance(6);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.assets.length ? 29 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.needs_locker ? 30 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!\u0275\u0275pipeBind1(33, 19, ctx.loading) ? 32 : -1);
  }
}, dependencies: [MatRipple, MatProgressSpinner, MatTooltip, IconComponent, AsyncPipe, DatePipe, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDeskFlowConfirmComponent, { className: "NewDeskFlowConfirmComponent", filePath: "apps/workplace/src/app/book/desk-flow/desk-flow-confirm.component.ts", lineNumber: 219 });
})();
...
function NewDeskFormDetailsComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(9, NewDeskFormDetailsComponent_Conditional_0_Conditional_9_Template, 7, 3, "div", 6);
    \u0275\u0275pipe(10, "async");
    ...
    \u0275\u0275conditionalCreate(35, NewDeskFormDetailsComponent_Conditional_0_Conditional_35_Template, 8, 8, "div", 17);
...
_NewDeskFlowSuccessComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDeskFlowSuccessComponent, selectors: [["desk-flow-success"]], standalone: false, decls: 14, vars: 15, consts: [[1, "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto", "bg-base-100"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-center", "text-2xl", "font-medium"], ["src", "assets/icons/success.svg"], [1, "text-center"], ["assets", ""], [1, "relative", "flex", "flex-col", "items-center", "space-y-4", "p-4"], [1, "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "border-base-200", "bg-base-100", "p-2"], ["btn", "", "name", "desk-confirm-continue", "matRipple", "", 1, "mx-auto", "w-full", "max-w-[32rem]", 3, "routerLink"], ["btn", "", "matRipple", "", "name", "desk-outlook-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/outlook.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-google-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/gcal.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-ical-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], [1, "text-xl"]], template: function NewDeskFlowSuccessComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(5, "img", 3);
    \u0275\u0275conditionalCreate(6, NewDeskFlowSuccessComponent_Conditional_6_Template, 7, 15, "p", 4);
...
}, dependencies: [MatRipple, IconComponent, RouterLink, DatePipe, TranslatePipe, SafePipe, SanitizePipe], encapsulation: 2 });
...
}, dependencies: [NewDeskFlowFormComponent, NewDeskFlowSuccessComponent], styles: ["\n\n[_nghost-%COMP%] {\n  height: 100%;\n  width: 100%;\n}\n/*# sourceMappingURL=desk-flow.component.css.map */"] });
...
function FlowSuccessComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "br");
  }
}
...
_FlowSuccessComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FlowSuccessComponent, selectors: [["flow-success"]], inputs: { calendar: "calendar", extra: "extra", route: "route", type: "type" }, standalone: false, decls: 15, vars: 14, consts: [["name", "success", 1, "bg-indigo-900", "fixed", "inset-0", "z-50", "flex", "flex-col", "items-center", "justify-center"], [1, "mb-4", "rounded-full", "bg-base-100", "text-7xl", "text-success"], [1, "mb-4", "text-center", "text-lg", "leading-10", "text-white"], [1, "flex", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "w-32", "border", "border-white", 3, "routerLink", "queryParams"]], template: function FlowSuccessComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(6, "br");
    \u0275\u0275text(7);
    \u0275\u0275conditionalCreate(8, FlowSuccessComponent_Conditional_8_Template, 1, 0, "br");
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
...
}, dependencies: [MatRipple, IconComponent, RouterLink], encapsulation: 2 });
var FlowSuccessComponent = _FlowSuccessComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FlowSuccessComponent, [{
    type: Component,
    args: [{ selector: "flow-success", template: `
        <div
            name="success"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FlowSuccessComponent, { className: "FlowSuccessComponent", filePath: "apps/workplace/src/app/book/flow-success.component.ts", lineNumber: 47 });
})();
...
}, dependencies: [MatRipple, MatProgressSpinner, IconComponent, AsyncPipe, DatePipe, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookLockerFlowConfirmComponent, { className: "BookLockerFlowConfirmComponent", filePath: "apps/workplace/src/app/book/locker-flow/locker-flow-confirm.component.ts", lineNumber: 104 });
})();
...
function LockerFormDetailsComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(23, _c017));
    \u0275\u0275advance();
...
}, dependencies: [MatOption, MatFormField, MatSelect, MatCheckbox, DateFieldComponent, DurationFieldComponent, TimeFieldComponent, LockerListFieldComponent, NgControlStatus, NgControlStatusGroup, NgModel, FormGroupDirective, FormControlName, AsyncPipe, TranslatePipe], encapsulation: 2 });
...
function BookLockerFlowComponent_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 5, "APP.WORKPLACE.LOCKER_ASSIGNED", \u0275\u0275pureFunction1(10, _c019, (tmp_1_0 = \u0275\u0275pipeBind1(4, 3, ctx_r0.assigned_space)) == null ? null : tmp_1_0.name)), " ");
    \u0275\u0275advance(3);
...
}, dependencies: [MatRipple, RouterLink, BookLockerFlowFormComponent, BookLockerFlowConfirmComponent, BookLockerFlowSuccessComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  height: 100%;\n  width: 100%;\n}\n/*# sourceMappingURL=locker-flow.component.css.map */"] });
...
function MeetingFlowConfirmComponent_Conditional_28_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 1, "CALENDAR_EVENT.ATTENDEE_COUNT", \u0275\u0275pureFunction1(4, _c020, ctx_r1.event.attendees.length)), " ");
    \u0275\u0275advance(5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowConfirmComponent, { className: "MeetingFlowConfirmComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-confirm.component.ts", lineNumber: 182 });
})();
...
function MeetingFlowConfirmModalComponent_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(9, MeetingFlowConfirmModalComponent_Conditional_31_For_10_Template, 10, 8, "div", 11, _forTrack02);
...
function MeetingFlowConfirmModalComponent_Conditional_33_Conditional_2_For_9_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32)(1, "icon");
    \u0275\u0275text(2, "priority_high");
    \u0275\u0275elementEnd()();
...
function MeetingFlowConfirmModalComponent_Conditional_33_Conditional_2_For_9_For_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 37)(1, "div", 38)(2, "span", 31);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
...
function MeetingFlowConfirmModalComponent_Conditional_33_Conditional_2_For_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, MeetingFlowConfirmModalComponent_Conditional_33_Conditional_2_For_9_Conditional_7_Template, 3, 1, "div", 32);
    \u0275\u0275element(8, "div", 33);
    \u0275\u0275elementStart(9, "div", 34);
    \u0275\u0275text(10);
    \u0275\u0275pipe(11, "translate");
    ...
    \u0275\u0275repeaterCreate(13, MeetingFlowConfirmModalComponent_Conditional_33_Conditional_2_For_9_For_14_Template, 6, 2, "div", 37, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 13, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(18, _c021, request_r8.item_count)), " ");
    \u0275\u0275advance(3);
...
function MeetingFlowConfirmModalComponent_Conditional_33_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25)(1, "div", 6)(2, "div", 7)(3, "icon");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "h3", 9);
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(8, MeetingFlowConfirmModalComponent_Conditional_33_Conditional_2_For_9_Template, 15, 20, "div", 40, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 6, "RESOURCE.ASSETS"), " ");
    \u0275\u0275advance(2);
...
function MeetingFlowConfirmModalComponent_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, MeetingFlowConfirmModalComponent_Conditional_33_Conditional_2_Template, 10, 8, "div", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
}, dependencies: [MatRipple, MatDialogClose, MatProgressSpinner, MatChip, MatTooltip, IconComponent, AsyncPipe, CurrencyPipe, DatePipe, TranslatePipe, SanitizePipe, LevelPipe, SpacePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowConfirmModalComponent, { className: "MeetingFlowConfirmModalComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-confirm-modal.component.ts", lineNumber: 455 });
})();
...
function MeetingFormDetailsComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(15, MeetingFormDetailsComponent_Conditional_0_Conditional_15_Template, 7, 3, "div", 8);
    \u0275\u0275conditionalCreate(16, MeetingFormDetailsComponent_Conditional_0_Conditional_16_Template, 7, 3, "div", 8);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.can_book_for_anyone ? 15 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.can_book_for_others ? 16 : -1);
    \u0275\u0275advance();
...
_MeetingFormDetailsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFormDetailsComponent, selectors: [["meeting-form-details"]], inputs: { form: "form" }, standalone: false, decls: 1, vars: 1, consts: [[3, "formGroup"], [1, "flex", "flex-wrap", "items-center", "sm:space-x-2"], [1, "min-w-[256px]", "flex-1"], ["for", "title"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "title", "formControlName", "title", 3, "placeholder"], [1, "relative", "min-w-[256px]", "flex-1"], [1, "flex", "items-center", "space-x-2"], [1, "flex", "w-full", "flex-col"], ["for", "date"], ["name", "date", "formControlName", "date", 3, "to", "use_24hr", "timezone"], ["formControlName", "all_day", 1, "absolute", "-top-2", "right-2"], ["name", "date", "formControlName", "date", 3, "to", "use_24hr", "timezone", "range"], ["name", "date", "formControlName", "date_end", 3, "from", "to", "use_24hr", "timezone", "range"], [1, "w-1/3", "flex-1"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "disabled", "use_24hr", "timezone"], ["for", "end-time"], ["name", "end-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "from", "use_24hr", "extra_info_fn", "timezone"], ["name", "end-time", "formControlName", "duration", 3, "time", "max", "use_24hr", "timezone"], ["for", "host"], ["name", "host", "formControlName", "organiser"], ["for", "recurrence"], ["name", "recurrence", "type", "event", "formControlName", "recurrence", 3, "date"], ["formControlName", "update_master"]], template: function MeetingFormDetailsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, MeetingFormDetailsComponent_Conditional_0_Template, 18, 16, "div", 0);
  }
  if (rf & 2) {
    \u0275\u0275conditional(ctx.form ? 0 : -1);
  }
}, dependencies: [MatFormField, MatError, MatInput, MatCheckbox, DateFieldComponent, DurationFieldComponent, HostSelectFieldComponent, RecurrenceFieldComponent, TimeFieldComponent, UserSearchFieldComponent, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, FormGroupDirective, FormControlName, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFormDetailsComponent, { className: "MeetingFormDetailsComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-form-details.component.ts", lineNumber: 215 });
})();
...
}, dependencies: [MatOption, MatFormField, MatError, MatSelect, MatRipple, MatInput, IconComponent, RichTextInputComponent, SpaceListFieldComponent, UserListFieldComponent, AssetListFieldComponent, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, CateringListFieldComponent, FormGroupDirective, FormControlName, MeetingFormDetailsComponent, AsyncPipe, TranslatePipe], encapsulation: 2, data: { animation: [ANIMATION_SHOW_CONTRACT_EXPAND] } });
...
function MeetingFlowSuccessComponent_Conditional_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275conditional((ctx_r0.last_event == null ? null : ctx_r0.last_event.all_day) ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!(ctx_r0.last_event == null ? null : ctx_r0.last_event.all_day) ? 9 : -1);
    \u0275\u0275advance();
...
}, dependencies: [MeetingFlowConfirmComponent, MeetingFlowFormComponent, MeetingFlowSuccessComponent], styles: ["\n\n[_nghost-%COMP%] {\n  height: 100%;\n  width: 100%;\n}\n/*# sourceMappingURL=meeting-flow.component.css.map */"] });
...
}, dependencies: [MatRipple, MatProgressSpinner, IconComponent, AsyncPipe, DatePipe, TranslatePipe], styles: ["\n\nsection[_ngcontent-%COMP%]    > icon[_ngcontent-%COMP%] {\n  font-size: 1.5rem;\n  margin-top: 0.3rem;\n}\nh3[_ngcontent-%COMP%] {\n  font-size: 1.25rem;\n  font-weight: medium;\n  margin: 0.5rem 0;\n}\n/*# sourceMappingURL=parking-flow-confirm.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewParkingFlowConfirmComponent, { className: "NewParkingFlowConfirmComponent", filePath: "apps/workplace/src/app/book/parking-flow/parking-flow-confirm.component.ts", lineNumber: 112 });
})();
...
function ParkingFormDetailsComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(10, 18, ctx_r1.building))("ngModelOptions", \u0275\u0275pureFunction0(36, _c025));
    \u0275\u0275advance(2);
...
}, dependencies: [MatOption, MatFormField, MatError, MatSelect, MatInput, MatCheckbox, DateFieldComponent, DurationFieldComponent, HostSelectFieldComponent, TimeFieldComponent, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, FormGroupDirective, FormControlName, AsyncPipe, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingFormDetailsComponent, { className: "ParkingFormDetailsComponent", filePath: "apps/workplace/src/app/book/parking-flow/parking-form-details.component.ts", lineNumber: 146 });
})();
...
var _c116 = () => ["/"];
function ParkingFlowSuccessComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "a", 8);
    \u0275\u0275pipe(2, "sanitize");
    \u0275\u0275element(3, "img", 9);
...
_ParkingFlowSuccessComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingFlowSuccessComponent, selectors: [["parking-flow-success"]], standalone: false, decls: 15, vars: 24, consts: [[1, "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto", "bg-base-100"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium"], [1, "max-w-[32rem]", "text-center"], ["src", "assets/icons/parking-success.svg"], [1, "relative", "flex", "flex-col", "items-center", "space-y-4", "p-4"], [1, "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "border-base-200", "bg-base-100", "p-2"], ["btn", "", "matRipple", "", 1, "w-full", "max-w-[32rem]", 3, "routerLink"], ["btn", "", "matRipple", "", "name", "desk-outlook-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/outlook.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-google-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/gcal.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-ical-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], [1, "text-xl"]], template: function ParkingFlowSuccessComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(9, "img", 4);
    \u0275\u0275conditionalCreate(10, ParkingFlowSuccessComponent_Conditional_10_Template, 20, 21, "div", 5);
    \u0275\u0275elementEnd();
...
function NewParkingFlowComponent_Conditional_0_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 5, "APP.WORKPLACE.PARKING_ASSIGNED", \u0275\u0275pureFunction1(10, _c027, (tmp_2_0 = \u0275\u0275pipeBind1(4, 3, ctx_r0.assigned_space)) == null ? null : tmp_2_0.name)), " ");
    \u0275\u0275advance(3);
...
}, dependencies: [MatRipple, RouterLink, ParkingFlowFormComponent, NewParkingFlowConfirmComponent, ParkingFlowSuccessComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  height: 100%;\n  width: 100%;\n}\n/*# sourceMappingURL=parking-flow.component.css.map */"] });
...
//# sourceMappingURL=book.module-FGWYEAW4.js.map
