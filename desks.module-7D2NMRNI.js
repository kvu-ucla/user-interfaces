...
function DeskBookingsComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275template(2, DeskBookingsComponent_ng_template_6_span_2_Template, 2, 0, "span", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const row_r3 = ctx.row;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", row_r3.group || (row_r3.extension_data == null ? null : row_r3.extension_data.group), " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !(row_r3.group || (row_r3.extension_data == null ? null : row_r3.extension_data.group)));
  }
}
function DeskBookingsComponent_ng_template_8_ng_container_1_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(2, 2, row_r4.date, ctx_r4.time_format), " \u2013 ", \u0275\u0275pipeBind2(3, 5, row_r4.date_end, ctx_r4.time_format), " ");
  }
}
...
function DeskBookingsComponent_ng_template_8_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, DeskBookingsComponent_ng_template_8_ng_container_1_ng_container_2_Template, 4, 8, "ng-container", 20)(3, DeskBookingsComponent_ng_template_8_ng_container_1_ng_container_3_Template, 2, 0, "ng-container", 20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !row_r4.all_day);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", row_r4.all_day);
  }
}
function DeskBookingsComponent_ng_template_8_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const row_r4 = \u0275\u0275nextContext().row;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", row_r4.status === "ended" ? "Manually Ended" : "Expired", " ");
  }
}
function DeskBookingsComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 19);
    \u0275\u0275template(1, DeskBookingsComponent_ng_template_8_ng_container_1_Template, 4, 2, "ng-container", 20)(2, DeskBookingsComponent_ng_template_8_ng_container_2_Template, 3, 1, "ng-container", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const row_r4 = ctx.row;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", row_r4.status !== "declined" && !row_r4.deleted && row_r4.status !== "ended");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", row_r4.status === "declined" || row_r4.deleted || row_r4.status === "ended");
  }
}
...
function DeskBookingsComponent_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, DeskBookingsComponent_ng_template_10_div_3_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DeskBookingsComponent_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "app-icon", 30);
    \u0275\u0275text(6, "arrow_drop_down");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(7, "mat-menu", null, 6)(9, "button", 12);
    \u0275\u0275listener("click", function DeskBookingsComponent_ng_template_12_Template_button_click_9_listener() {
      ...
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.approve(row_r8));
    });
    \u0275\u0275elementStart(10, "div", 31)(11, "app-icon", 30);
    ...
    \u0275\u0275listener("click", function DeskBookingsComponent_ng_template_12_Template_button_click_15_listener() {
      const row_r8 = \u0275\u0275restoreView(_r7).row;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.reject(row_r8));
    });
    \u0275\u0275elementStart(16, "div", 31)(17, "app-icon", 30);
...
function DeskBookingsComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 26)(1, "button", 33)(2, "div", 28)(3, "div", 29);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "app-icon", 30);
    \u0275\u0275text(6, " arrow_drop_down ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(7, "mat-menu", null, 7)(9, "button", 12);
    \u0275\u0275listener("click", function DeskBookingsComponent_ng_template_14_Template_button_click_9_listener() {
      ...
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.checkin(row_r11, true));
    });
    \u0275\u0275elementStart(10, "div", 31)(11, "app-icon", 30);
    \u0275\u0275text(12, "check");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function DeskBookingsComponent_ng_template_14_Template_button_click_15_listener() {
      const row_r11 = \u0275\u0275restoreView(_r10).row;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.checkin(row_r11, false));
    });
    \u0275\u0275elementStart(16, "div", 31)(17, "app-icon", 30);
    \u0275\u0275text(18, "cancel");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const checkinMenu_r13 = \u0275\u0275reference(8);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", data_r12 ? "Yes" : "No", " ");
  }
}
...
_DeskBookingsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskBookingsComponent, selectors: [["desk-bookings"]], decls: 25, vars: 38, consts: [["date_template", ""], ["group_template", ""], ["period_template", ""], ["user_template", ""], ["status_template", ""], ["option_template", ""], ["menu", "matMenu"], ["checkinMenu", "matMenu"], [1, "overflow-auto", "h-full", "w-full", "pb-4"], [1, "min-w-[72rem]", "block", "text-sm", 3, "data", "filter", "filter_on", "columns", "empty_message", "sortable"], ["btn", "", "matRipple", "", "class", "absolute bottom-2 left-2 w-32 mx-auto my-4", 3, "click", 4, "ngIf"], ["icon", "", "matRipple", "", 1, "absolute", "bottom-2", "right-2", "bg-base-100", "shadow", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "flex-col", "items-center", "justify-center", "w-full", "py-2"], [1, "opacity-60"], [1, "text-xl"], [1, "p-4", "text-[0.625rem]", "font-mono"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"], [1, "p-2"], [4, "ngIf"], [1, "text-xs", "py-2", "px-4", "bg-error", "rounded-3xl", "text-white"], [1, "flex", "flex-col", "justify-center", "px-4", "py-2"], [1, "select-all"], ["class", "text-xs opacity-30 select-all", 4, "ngIf"], [1, "text-xs", "opacity-30", "select-all"], [1, "px-2"], ["matRipple", "", 1, "rounded-3xl", "bg-warning", "text-warning-content", "border-none", "w-[7.5rem]", "h-10", 3, "matMenuTriggerFor", "disabled"], [1, "flex", "items-center", "pl-4", "pr-2", "space-x-2"], [1, "flex-1", "text-left"], [1, "text-2xl"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], ["matRipple", "", 1, "rounded-3xl", "bg-warning", "text-warning-content", "border-none", "w-[4.5rem]", "h-10", 3, "matMenuTriggerFor", "disabled", "matTooltip"], ["btn", "", "matRipple", "", 1, "absolute", "bottom-2", "left-2", "w-32", "mx-auto", "my-4", 3, "click"]], template: function DeskBookingsComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275pipe(17, "async");
    \u0275\u0275elementStart(18, "button", 11)(19, "app-icon");
    \u0275\u0275text(20, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "mat-menu", null, 6)(23, "button", 12);
    \u0275\u0275listener("click", function DeskBookingsComponent_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r1);
  ...
  if (rf & 2) {
    ...
    const group_template_r16 = \u0275\u0275reference(7);
    const period_template_r17 = \u0275\u0275reference(9);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.bookings)("filter", (tmp_8_0 = \u0275\u0275pipeBind1(2, 8, ctx.filters)) == null ? null : tmp_8_0.search)("filter_on", \u0275\u0275pureFunction0(14, _c03))("columns", \u0275\u0275pureFunction8(29, _c9, \u0275\u0275pureFunction1(15, _c13, date_template_r15), \u0275\u0275pureFunction1(17, _c23, period_template_r17), \u0275\u0275pureFunction1(19, _c32, user_template_r18), \u0275\u0275pureFunction1(21, _c4, group_template_r16), \u0275\u0275pureFunction0(23, _c5), \u0275\u0275pureFunction0(24, _c6), \u0275\u0275pureFunction1(25, _c7, status_template_r19), \u0275\u0275pureFunction1(27, _c8, option_template_r20)))("empty_message", ((tmp_11_0 = \u0275\u0275pipeBind1(3, 10, ctx.filters)) == null ? null : tmp_11_0.search) ? "No matching desk bookings" : "There are no desk booking for the currently selected date.")("sortable", true);
    \u0275\u0275advance(15);
    \u0275\u0275property("ngIf", !ctx.loading && \u0275\u0275pipeBind1(17, 12, ctx.has_more_pages));
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskBookingsComponent, { className: "DeskBookingsComponent", filePath: "apps/concierge/src/app/desks/desk-bookings.component.ts", lineNumber: 271 });
})();
...
function NewDesksComponent_ng_container_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "qr_code");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "button", 28)(5, "app-icon");
...
function NewDesksComponent_mat_progress_bar_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-bar", 32);
  }
}
...
_NewDesksComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDesksComponent, selectors: [["", "app-new-desks", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c05, decls: 22, vars: 13, consts: [[1, "print:hidden"], [1, "flex", "flex-1", "h-px", "print:hidden"], [1, "flex", "flex-col", "flex-1", "w-1/2", "h-full"], [1, "flex", "items-center", "w-full", "py-4", "px-8", "space-x-2"], [1, "text-2xl", "font-medium"], [1, "flex-1", "w-px"], [1, "mr-2", 3, "modelChange", "model"], ["btn", "", "matRipple", "", "class", "space-x-2 w-44", 3, "click", 4, "ngIf"], [1, "w-full", "flex", "items-center", "px-8", "space-x-2", "mb-4"], ["appearance", "outline", "class", "no-subscript w-60", 4, "ngIf"], [4, "ngIf"], [1, "flex-1", "h-1/2", "px-8", "w-full", "relative", "overflow-auto"], ["class", "w-full", "mode", "indeterminate", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "space-x-2", "w-44", 3, "click"], [1, "pl-2"], [1, "text-2xl"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["placeholder", "All Levels", "multiple", "", 3, "ngModelChange", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], ["placeholder", "All Levels", 3, "ngModelChange", "ngModel"], [3, "dateChange"], ["btn", "", "icon", "", "matRipple", "", "matTooltip", "Refresh List", 1, "ml-2", "rounded", "border", "border-base-200", 3, "click", "disabled"], ["btn", "", "icon", "", "matRipple", "", "matTooltip", "View Desk QR Codes", 1, "bg-secondary", "text-secondary-content", "rounded", "h-12", "w-12", 3, "click"], ["btn", "", "icon", "", "matRipple", "", "matTooltip", "Upload Desks CSV", 1, "bg-secondary", "text-secondary-content", "rounded", "h-12", "w-12"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], ["btn", "", "icon", "", "matRipple", "", "matTooltip", "Download Template Desk CSV", 1, "bg-secondary", "text-secondary-content", "rounded", "h-12", "w-12", 3, "click"], ["icon", "", "matRipple", "", "matTooltip", "Desk Restrictions", 1, "bg-secondary", "text-secondary-content", "rounded", "h-12", "w-12", 3, "click"], ["mode", "indeterminate", 1, "w-full"]], template: function NewDesksComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(15, "div", 5);
    \u0275\u0275template(16, NewDesksComponent_ng_container_16_Template, 6, 3, "ng-container", 10)(17, NewDesksComponent_ng_container_17_Template, 14, 0, "ng-container", 10);
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDesksComponent, { className: "NewDesksComponent", filePath: "apps/concierge/src/app/desks/new-desks.component.ts", lineNumber: 218 });
})();
...
//# sourceMappingURL=desks.module-7D2NMRNI.js.map
