...
// apps/concierge/src/app/surveys/pages/building-list.component.ts
var _c03 = (a0) => ({ count: a0 });
var _c13 = (a0) => ["/surveys", "survey-list", a0];
...
var BuildingListComponent = class _BuildingListComponent {
  constructor(_org, _settings) {
    ...
    this.surveys$ = this.buildings$.pipe(switchMap((bld_list) => forkJoin(bld_list.map((bld) => ga({ building_id: bld.id })))), shareReplay(1));
    this.answers$ = this.surveys$.pipe(switchMap((surveys) => forkJoin(flatten(surveys).map((survey) => sa({ survey_id: survey.id })))), shareReplay(1));
  ...
  static {
    this.\u0275fac = function BuildingListComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _BuildingListComponent)(\u0275\u0275directiveInject(OrganisationService), \u0275\u0275directiveInject(SettingsService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BuildingListComponent, selectors: [["building-list"]], standalone: false, decls: 13, vars: 13, consts: [[1, "flex", "h-full", "w-full", "flex-col"], [1, "flex", "items-center", "justify-between", "px-8", "pb-2", "pt-8"], [1, "text-2xl", "font-medium"], [1, "mb-8", "px-8"], [1, "h-1/2", "w-full", "flex-1", "space-y-4", "overflow-auto", "px-8"], ["matRipple", "", 1, "relative", "flex", "space-x-4", "overflow-hidden", "rounded-xl", "border", "border-base-300", "bg-base-100", "shadow", "hover:border-info", 3, "routerLink"], [1, "flex", "h-40", "w-32", "items-center", "justify-center", "bg-base-300"], ["auth", "", "class", "h-full w-full object-cover object-center", 3, "source", 4, "ngIf"], ["class", "text-6xl text-base-100", 4, "ngIf"], [1, "flex-1", "py-4"], [1, "mb-4", "text-2xl", "font-medium"], [1, "flex", "items-center", "space-x-4"], [1, "flex", "h-20", "w-24", "flex-col", "items-center", "justify-center", "space-y-2", "rounded-xl", "border", "border-base-200"], [1, "text-4xl"], [1, "text-xs", "font-medium"], [1, "absolute", "right-2", "top-1/2", "-translate-y-1/2", "text-4xl"], ["auth", "", 1, "h-full", "w-full", "object-cover", "object-center", 3, "source"], [1, "text-6xl", "text-base-100"]], template: function BuildingListComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(8, 6, "APP.CONCIERGE.SURVEY_BUILDING_COUNT", \u0275\u0275pureFunction1(11, _c03, (tmp_1_0 = \u0275\u0275pipeBind1(7, 4, ctx.buildings$)) == null ? null : tmp_1_0.length)), " ");
        \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BuildingListComponent, { className: "BuildingListComponent", filePath: "apps/concierge/src/app/surveys/pages/building-list.component.ts", lineNumber: 116 });
})();

// apps/concierge/src/app/surveys/pages/not-found.component.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NotFoundComponent, { className: "NotFoundComponent", filePath: "apps/concierge/src/app/surveys/pages/not-found.component.ts", lineNumber: 28 });
})();
...
// libs/survey-suite/src/lib/question/base-question.component.ts
var BaseQuestionComponent = class _BaseQuestionComponent {
  constructor() {
    this.preview = false;
    this._has_value = false;
    this.placeholderTitle = "Enter your question here";
  }
  ...
  static {
    this.\u0275fac = function BaseQuestionComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _BaseQuestionComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BaseQuestionComponent, selectors: [["base-question"]], inputs: { preview: "preview", value: "value" }, decls: 0, vars: 0, template: function BaseQuestionComponent_Template(rf, ctx) {
    }, encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BaseQuestionComponent, { className: "BaseQuestionComponent", filePath: "libs/survey-suite/src/lib/question/base-question.component.ts", lineNumber: 9 });
})();

// libs/survey-suite/src/lib/question/multi-line-text.component.ts
function MultiLineTextComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "mat-form-field", 2);
...
var MultiLineTextComponent = class _MultiLineTextComponent extends BaseQuestionComponent {
  static {
    this.\u0275fac = /* @__PURE__ */ (() => {
      let \u0275MultiLineTextComponent_BaseFactory;
      return function MultiLineTextComponent_Factory(__ngFactoryType__) {
        return (\u0275MultiLineTextComponent_BaseFactory || (\u0275MultiLineTextComponent_BaseFactory = \u0275\u0275getInheritedFactory(_MultiLineTextComponent)))(__ngFactoryType__ || _MultiLineTextComponent);
      };
    })();
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MultiLineTextComponent, selectors: [["multi-line-text"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [["class", "flex w-full flex-col", 4, "ngIf"], [1, "flex", "w-full", "flex-col"], ["appearance", "outline"], ["matInput", "", "cols", "30", "rows", "5"]], template: function MultiLineTextComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, MultiLineTextComponent_div_0_Template, 6, 3, "div", 0);
      }
      if (rf & 2) {
        \u0275\u0275property("ngIf", ctx.preview);
      }
    }, dependencies: [CommonModule, NgIf, MatFormFieldModule, MatFormField, MatHint, MatInputModule, MatInput], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MultiLineTextComponent, { className: "MultiLineTextComponent", filePath: "libs/survey-suite/src/lib/question/multi-line-text.component.ts", lineNumber: 22 });
})();

// libs/survey-suite/src/lib/question/rating.component.ts
function RatingsComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
...
function RatingsComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 6)(1, "mat-slider", 7)(2, "input", 8);
    \u0275\u0275twoWayListener("ngModelChange", function RatingsComponent_div_3_Template_input_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.question.rateMax, $event) || (ctx_r2.question.rateMax = $event);
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("max", 10)("min", 3)("thumbLabel", true)("step", 1);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.question.rateMax);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 6, "APP.CONCIERGE.SURVEY_QUESTION_HINT_RATING"), " ");
  }
}
var RatingsComponent = class _RatingsComponent extends BaseQuestionComponent {
  constructor() {
    super();
  }
  ngOnInit() {
  ...
  static {
    this.\u0275fac = function RatingsComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _RatingsComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RatingsComponent, selectors: [["rating"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 2, consts: [[1, "flex", "w-full", "flex-col", "p-4"], [1, "mb-4", "flex", "flex-row", "items-center", "space-x-2"], ["class", "flex h-10 w-10 items-center justify-center rounded-full border", 4, "ngFor", "ngForOf"], ["class", "flex flex-col", 4, "ngIf"], [1, "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-full", "border"], [1, "font-semibold"], [1, "flex", "flex-col"], [3, "max", "min", "thumbLabel", "step"], ["matSliderThumb", "", 3, "ngModelChange", "ngModel"], [1, "text-xs"]], template: function RatingsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1);
        \u0275\u0275template(2, RatingsComponent_div_2_Template, 3, 1, "div", 2);
        \u0275\u0275elementEnd();
        \u0275\u0275template(3, RatingsComponent_div_3_Template, 6, 8, "div", 3);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
        \u0275\u0275property("ngForOf", ctx.generateArray(ctx.question.rateMax));
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.preview);
      }
    }, dependencies: [CommonModule, NgForOf, NgIf, TranslatePipe, MatSliderModule, MatSlider, MatSliderThumb], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RatingsComponent, { className: "RatingsComponent", filePath: "libs/survey-suite/src/lib/question/rating.component.ts", lineNumber: 35 });
})();

// libs/survey-suite/src/lib/question/selection.component.ts
function SelectionComponent_ng_container_0_ng_container_2_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 9)(1, "span");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 10)(4, "input", 11);
    \u0275\u0275twoWayListener("ngModelChange", function SelectionComponent_ng_container_0_ng_container_2_div_2_Template_input_ngModelChange_4_listener($event) {
      const item_r3 = \u0275\u0275restoreView(_r2).$implicit;
      \u0275\u0275twoWayBindingSet(item_r3.text, $event) || (item_r3.text = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "button", 12);
    \u0275\u0275listener("click", function SelectionComponent_ng_container_0_ng_container_2_div_2_Template_button_click_5_listener() {
      const i_r4 = \u0275\u0275restoreView(_r2).index;
      const ctx_r4 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r4.deleteOption(i_r4));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275propertyInterpolate1("name", "item", i_r4, "");
    \u0275\u0275twoWayProperty("ngModel", item_r3.text);
  }
}
function SelectionComponent_ng_container_0_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 5);
    \u0275\u0275template(2, SelectionComponent_ng_container_0_ng_container_2_div_2_Template, 8, 5, "div", 6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 7);
    \u0275\u0275listener("click", function SelectionComponent_ng_container_0_ng_container_2_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.addOption());
    });
    \u0275\u0275elementStart(4, "div", 8)(5, "icon");
    \u0275\u0275text(6, "add_circle");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r4.question.choices);
  }
}
function SelectionComponent_ng_container_0_ng_template_3_mat_form_field_0_mat_option_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(item_r6.text);
  }
}
function SelectionComponent_ng_container_0_ng_template_3_mat_form_field_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-form-field")(1, "mat-select");
    \u0275\u0275template(2, SelectionComponent_ng_container_0_ng_template_3_mat_form_field_0_mat_option_2_Template, 2, 2, "mat-option", 13);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext(3);
...
function SelectionComponent_ng_container_0_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SelectionComponent_ng_container_0_ng_template_3_mat_form_field_0_Template, 3, 1, "mat-form-field", 4);
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
    const inputType_r7 = \u0275\u0275reference(6);
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275property("ngIf", ctx_r4.isDropDown)("ngIfElse", inputType_r7);
  }
}
function SelectionComponent_ng_container_0_ng_template_5_div_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r4 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275property("type", ctx_r4.multiple ? "checkbox" : "radio");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r8.text);
  }
}
function SelectionComponent_ng_container_0_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275template(1, SelectionComponent_ng_container_0_ng_template_5_div_1_Template, 4, 2, "div", 6);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext(2);
...
function SelectionComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 3);
    \u0275\u0275template(2, SelectionComponent_ng_container_0_ng_container_2_Template, 9, 1, "ng-container", 4)(3, SelectionComponent_ng_container_0_ng_template_3_Template, 1, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(5, SelectionComponent_ng_container_0_ng_template_5_Template, 2, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const previewState_r9 = \u0275\u0275reference(4);
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !ctx_r4.preview)("ngIfElse", previewState_r9);
  }
}
var SelectionComponent = class _SelectionComponent extends BaseQuestionComponent {
  get isDropDown() {
  ...
  static {
    this.\u0275fac = /* @__PURE__ */ (() => {
      let \u0275SelectionComponent_BaseFactory;
      return function SelectionComponent_Factory(__ngFactoryType__) {
        return (\u0275SelectionComponent_BaseFactory || (\u0275SelectionComponent_BaseFactory = \u0275\u0275getInheritedFactory(_SelectionComponent)))(__ngFactoryType__ || _SelectionComponent);
      };
    })();
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SelectionComponent, selectors: [["selection"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [["previewState", ""], ["inputType", ""], [4, "ngIf"], [1, "flex", "w-full", "flex-col"], [4, "ngIf", "ngIfElse"], [1, "mb-4", "flex", "w-full", "flex-col", "pl-2"], ["class", "flex w-full flex-row items-center space-x-3 pb-3", 4, "ngFor", "ngForOf"], ["mat-stroked-button", "", 3, "click"], [1, "text-gray-800", "flex", "flex-row", "items-center"], [1, "flex", "w-full", "flex-row", "items-center", "space-x-3", "pb-3"], ["appearance", "outline", 1, "w-full", 3, "subscriptSizing"], ["matInput", "", "type", "text", 3, "ngModelChange", "ngModel", "name"], ["matSuffix", "", "icon-button", "", 3, "click"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [1, "flex", "w-full", "flex-col", "pl-2"], ["name", "options", 3, "type"]], template: function SelectionComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, SelectionComponent_ng_container_0_Template, 7, 2, "ng-container", 2);
      }
      if (rf & 2) {
        \u0275\u0275property("ngIf", ctx.question);
      }
    }, dependencies: [CommonModule, NgForOf, NgIf, MatFormFieldModule, MatFormField, MatSuffix, MatSelectModule, MatSelect, MatOption], styles: ["\n\n.item-textbox[_ngcontent-%COMP%] {\n  padding: 0.25rem;\n}\n/*# sourceMappingURL=selection.component.css.map */"], changeDetection: 0 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SelectionComponent, { className: "SelectionComponent", filePath: "libs/survey-suite/src/lib/question/selection.component.ts", lineNumber: 87 });
})();

// libs/survey-suite/src/lib/question/single-line-text.component.ts
function SingleLineTextComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "mat-form-field", 2);
    \u0275\u0275element(2, "input", 3);
    \u0275\u0275elementStart(3, "mat-hint");
...
var SingleLineTextComponent = class _SingleLineTextComponent extends BaseQuestionComponent {
  static {
    this.\u0275fac = /* @__PURE__ */ (() => {
      let \u0275SingleLineTextComponent_BaseFactory;
      return function SingleLineTextComponent_Factory(__ngFactoryType__) {
        return (\u0275SingleLineTextComponent_BaseFactory || (\u0275SingleLineTextComponent_BaseFactory = \u0275\u0275getInheritedFactory(_SingleLineTextComponent)))(__ngFactoryType__ || _SingleLineTextComponent);
      };
    })();
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SingleLineTextComponent, selectors: [["single-line-text"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [["class", "flex w-full flex-col", 4, "ngIf"], [1, "flex", "w-full", "flex-col"], ["apppearance", "outline"], ["matInput", "", "type", "text"]], template: function SingleLineTextComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, SingleLineTextComponent_div_0_Template, 6, 3, "div", 0);
      }
      if (rf & 2) {
        \u0275\u0275property("ngIf", ctx.preview);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SingleLineTextComponent, { className: "SingleLineTextComponent", filePath: "libs/survey-suite/src/lib/question/single-line-text.component.ts", lineNumber: 22 });
})();

// libs/survey-suite/src/lib/question/question.component.ts
var _c04 = ["container_el"];
function QuestionComponent_ng_container_2_mat_error_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 10);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
  }
...
function QuestionComponent_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "mat-form-field", 7)(2, "input", 8);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function QuestionComponent_ng_container_2_Template_input_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, QuestionComponent_ng_container_2_mat_error_4_Template, 3, 3, "mat-error", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(3, 3, "APP.CONCIERGE.SURVEY_QUESTION_ENTER"));
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.question.title);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !(ctx_r1.question == null ? null : ctx_r1.question.title));
  }
}
function QuestionComponent_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.question.title || "No question");
  }
}
function QuestionComponent_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "multi-line-text", 12);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("question", ctx_r1.question)("preview", ctx_r1.preview);
  }
}
function QuestionComponent_ng_container_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "single-line-text", 12);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function QuestionComponent_ng_container_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "selection", 13);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("value", ctx_r1.question)("preview", ctx_r1.preview);
  }
}
function QuestionComponent_ng_container_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "selection", 13);
    \u0275\u0275elementContainerEnd();
...
function QuestionComponent_div_12_For_4_mat_option_0_Template(rf, ctx) {
  if (rf & 1) {
...
function QuestionComponent_div_12_For_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, QuestionComponent_div_12_For_4_mat_option_0_Template, 2, 2, "mat-option", 19);
  }
  if (rf & 2) {
...
function QuestionComponent_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function QuestionComponent_div_12_Template_mat_select_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.question.type, $event) || (ctx_r1.question.type = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275repeaterCreate(3, QuestionComponent_div_12_For_4_Template, 1, 1, "mat-option", 17, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "settings-toggle", 18);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function QuestionComponent_div_12_Template_settings_toggle_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("name", \u0275\u0275pipeBind1(6, 3, "COMMON.REQUIRED"));
  }
}
var QuestionComponent = class _QuestionComponent {
  ...
  static {
    ...
    }, inputs: { isCard: "isCard", preview: "preview", value: "value" }, decls: 13, vars: 10, consts: [["container_el", ""], ["previewTitle", ""], [1, "flex", "w-full", "flex-col", "items-center", "justify-between", "px-4", "py-2", "pt-4"], [4, "ngIf", "ngIfElse"], [1, "mb-4", "flex", "w-full", "flex-col", 3, "ngSwitch"], [4, "ngSwitchCase"], ["class", "flex w-full flex-row items-center justify-end space-x-4", 4, "ngIf"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "type", "text", 3, "ngModelChange", "placeholder", "ngModel"], ["class", "input-error", 4, "ngIf"], [1, "input-error"], [1, "mb-4", "w-full", "text-xl"], [3, "question", "preview"], [3, "value", "preview"], [1, "flex", "w-full", "flex-row", "items-center", "justify-end", "space-x-4"], ["appearance", "outline", 1, "no-subscript"], [3, "ngModelChange", "ngModel"], [3, "value"], [3, "ngModelChange", "ngModel", "name"], [3, "value", 4, "ngIf"]], template: function QuestionComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2, 0);
        \u0275\u0275template(2, QuestionComponent_ng_container_2_Template, 5, 5, "ng-container", 3)(3, QuestionComponent_ng_template_3_Template, 2, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementStart(5, "div", 4);
        \u0275\u0275template(6, QuestionComponent_ng_container_6_Template, 2, 2, "ng-container", 5)(7, QuestionComponent_ng_container_7_Template, 2, 2, "ng-container", 5)(8, QuestionComponent_ng_container_8_Template, 2, 2, "ng-container", 5)(9, QuestionComponent_ng_container_9_Template, 2, 2, "ng-container", 5)(10, QuestionComponent_ng_container_10_Template, 2, 2, "ng-container", 5)(11, QuestionComponent_ng_container_11_Template, 2, 2, "ng-container", 5);
        \u0275\u0275elementEnd();
        \u0275\u0275template(12, QuestionComponent_div_12_Template, 7, 5, "div", 6);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        const previewTitle_r5 = \u0275\u0275reference(4);
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !ctx.preview)("ngIfElse", previewTitle_r5);
        \u0275\u0275advance(3);
        \u0275\u0275property("ngSwitch", ctx.question.type);
        \u0275\u0275advance();
        \u0275\u0275property("ngSwitchCase", ctx.QuestionType.Comment_Box);
        \u0275\u0275advance();
        \u0275\u0275property("ngSwitchCase", ctx.QuestionType.Single_Line_Text);
        \u0275\u0275advance();
        \u0275\u0275property("ngSwitchCase", ctx.QuestionType.Check_Box);
        \u0275\u0275advance();
        \u0275\u0275property("ngSwitchCase", ctx.QuestionType.Radio_Group);
        \u0275\u0275advance();
        \u0275\u0275property("ngSwitchCase", ctx.QuestionType.Drop_Down);
        \u0275\u0275advance();
        \u0275\u0275property("ngSwitchCase", ctx.QuestionType.Rating);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.preview);
      }
    }, dependencies: [
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(QuestionComponent, { className: "QuestionComponent", filePath: "libs/survey-suite/src/lib/question/question.component.ts", lineNumber: 134 });
})();
...
var _c05 = (a0, a1, a2, a3, a4) => ({ cx: a0, cy: a1, r: a2, stroke: "var(--b2)", "stroke-width": a3, "stroke-dasharray": a4 });
var _c14 = (a0, a1, a2, a3, a4, a5, a6) => ({ cx: a0, cy: a1, r: a2, stroke: a3, "stroke-width": a4, "stroke-dasharray": a5, "stroke-dashoffset": a6 });
...
function RatingsWidgetComponent_ng_container_0_ng_container_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction5(7, _c05, ctx_r1.size / 2 + "px", ctx_r1.size / 2 + "px", (ctx_r1.size - ctx_r1.border_width) / 2 + "px", ctx_r1.border_width + "px", ctx_r1.circle + "px"));
    \u0275\u0275advance();
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction7(13, _c14, ctx_r1.size / 2 + "px", ctx_r1.size / 2 + "px", (ctx_r1.size - ctx_r1.border_width) / 2 + "px", ctx_r1.progress <= 0.25 ? "var(--er)" : ctx_r1.progress <= 0.5 ? "var(--wa)" : ctx_r1.progress <= 0.75 ? "var(--in)" : "var(--su)", ctx_r1.border_width + "px", ctx_r1.circle + "px", ctx_r1.radius + "px"));
    \u0275\u0275advance(2);
...
function SelectionWidgetComponent_Conditional_7_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction4(7, _c06, percent_r2 <= 25, percent_r2 > 25 && percent_r2 <= 50, percent_r2 > 50 && percent_r2 <= 75, percent_r2 > 75))("ngStyle", \u0275\u0275pureFunction1(12, _c15, percent_r2 + "%"));
    \u0275\u0275advance(2);
...
// apps/concierge/src/app/surveys/overlays/mod-question-overlay.component.ts
var _c07 = ["questionElement"];
var ModQuestionOverlayComponent = class _ModQuestionOverlayComponent {
  ...
  static {
    this.\u0275fac = function ModQuestionOverlayComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ModQuestionOverlayComponent)(\u0275\u0275directiveInject(MAT_DIALOG_DATA), \u0275\u0275directiveInject(MatDialogRef));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ModQuestionOverlayComponent, selectors: [["mod-question-overlay"]], viewQuery: function ModQuestionOverlayComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c07, 5);
      }
      if (rf & 2) {
        let _t;
        \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.questionElement = _t.first);
      }
    }, standalone: false, decls: 14, vars: 7, consts: [["questionElement", ""], [1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "min-w-[40rem]", "overflow-x-hidden"], [3, "isCard", "value"], [1, "flex", "flex-row", "justify-end", "space-x-2", "px-4", "py-2"], ["btn", "", "matRipple", "", 3, "click", "disabled"]], template: function ModQuestionOverlayComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        ...
        \u0275\u0275listener("click", function ModQuestionOverlayComponent_Template_button_click_12_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.done());
        });
        \u0275\u0275text(13);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        const questionElement_r2 = \u0275\u0275reference(10);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 5, ctx.isEdit ? "APP.CONCIERGE.SURVEY_QUESTION_EDIT" : "APP.CONCIERGE.SURVEY_QUESTION_NEW"), " ");
        \u0275\u0275advance(7);
        \u0275\u0275property("isCard", false)("value", ctx.question);
        \u0275\u0275advance(3);
        \u0275\u0275property("disabled", !questionElement_r2.valid);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", ctx.isEdit ? "Update" : "Add to bank", " ");
      }
    }, dependencies: [MatDialogClose, MatRipple, IconComponent, QuestionComponent, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModQuestionOverlayComponent, { className: "ModQuestionOverlayComponent", filePath: "apps/concierge/src/app/surveys/overlays/mod-question-overlay.component.ts", lineNumber: 50 });
})();

// apps/concierge/src/app/surveys/services/question-bank.service.ts
...
// apps/concierge/src/app/surveys/components/search-input.component.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SearchInputComponent, { className: "SearchInputComponent", filePath: "apps/concierge/src/app/surveys/components/search-input.component.ts", lineNumber: 49 });
})();

// apps/concierge/src/app/surveys/components/question-bank.component.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(QuestionBankComponent, { className: "QuestionBankComponent", filePath: "apps/concierge/src/app/surveys/components/question-bank.component.ts", lineNumber: 149 });
})();

// apps/concierge/src/app/surveys/services/survey-builder.service.ts
...
// apps/concierge/src/app/surveys/services/survey.service.ts
...
// apps/concierge/src/app/surveys/pages/survey-listings.component.ts
var _c09 = () => ["/surveys"];
...
function SurveyListingsComponent_ng_template_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function SurveyListingsComponent_ng_template_26_Template_button_click_27_listener() {
      ...
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.onDelete(row_r4.id));
    });
...
var SurveyListingsComponent = class _SurveyListingsComponent extends AsyncHandler {
  get building() {
    return this._org.buildings.find((_) => _.id === this._building_id.getValue());
  }
  constructor(_org, _route, _service) {
    super();
    this._org = _org;
    this._route = _route;
    this._service = _service;
    this._building_id = new BehaviorSubject("");
    this._change = new BehaviorSubject(0);
    this.loading$ = new BehaviorSubject("");
    this.surveys$ = combineLatest([
      this._building_id,
      this._change
    ]).pipe(switchMap(([bld_id]) => {
      return ga({ building_id: bld_id }).pipe(catchError(() => of([])));
    }), tap((list) => console.log("List:", list)), shareReplay(1));
  }
  ngOnInit() {
    return __async(this, null, function* () {
      this.subscription("route-param", this._route.paramMap.subscribe((params) => this._building_id.next(params.get("id") || "")));
      this.timeout("load", () => this._change.next(Date.now()));
    });
  }
  onDelete(id) {
    return __async(this, null, function* () {
      yield this._service.confirmDeleteSurvey(id);
      this.timeout("load", () => this._change.next(Date.now()));
    });
  }
  static {
    this.\u0275fac = function SurveyListingsComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SurveyListingsComponent)(\u0275\u0275directiveInject(OrganisationService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(SurveyService));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SurveyListingsComponent, { className: "SurveyListingsComponent", filePath: "apps/concierge/src/app/surveys/pages/survey-listings.component.ts", lineNumber: 155 });
})();
...
function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_3_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 18);
    \u0275\u0275listener("click", function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_3_For_2_Template_button_click_0_listener() {
...
function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13);
    \u0275\u0275repeaterCreate(1, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_3_For_2_Template, 2, 5, "button", 17, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275nextContext(2);
...
function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-form-field", 14);
...
function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_6_For_3_Template(rf, ctx) {
  if (rf & 1) {
...
function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-form-field", 14)(1, "mat-select", 20);
    \u0275\u0275repeaterCreate(2, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_6_For_3_Template, 2, 2, "mat-option", 21, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275nextContext(2);
...
function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_7_For_3_Template(rf, ctx) {
  if (rf & 1) {
...
function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-radio-group", 15)(1, "div", 16);
    \u0275\u0275repeaterCreate(2, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_7_For_3_Template, 2, 2, "mat-radio-button", 21, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275nextContext(2);
...
function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_8_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-checkbox", 23);
    \u0275\u0275listener("ngModelChanges", function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_8_For_2_Template_mat_checkbox_ngModelChanges_0_listener($event) {
  ...
  if (rf & 2) {
    ...
    const question_r3 = \u0275\u0275readContextLet(0);
    const ctx_r3 = \u0275\u0275nextContext(5);
    \u0275\u0275property("ngModel", ctx_r3.form.value[question_r3.id].includes(choice_r8.text))("ngModelOptions", \u0275\u0275pureFunction0(3, _c010));
    \u0275\u0275advance();
...
function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275repeaterCreate(1, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_8_For_2_Template, 2, 4, "mat-checkbox", 22, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275nextContext(2);
...
function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_3_Template, 3, 0, "div", 13)(4, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_4_Template, 2, 2, "mat-form-field", 14)(5, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_5_Template, 2, 2, "mat-form-field", 14)(6, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_6_Template, 4, 2, "mat-form-field", 14)(7, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_7_Template, 4, 1, "mat-radio-group", 15)(8, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_8_Template, 3, 0, "div", 16)(9, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Case_9_Template, 0, 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_18_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_18_0 = question_r3.type) === "rating" ? 3 : tmp_18_0 === "text" ? 4 : tmp_18_0 === "comment" ? 5 : tmp_18_0 === "dropdown" ? 6 : tmp_18_0 === "radiogroup" ? 7 : tmp_18_0 === "checkbox" ? 8 : 9);
  }
}
function SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275declareLet(0);
    \u0275\u0275template(1, SurveyOutletComponent_Conditional_0_Conditional_5_Conditional_1_Conditional_0_For_5_Conditional_1_Template, 10, 2, "div", 11);
  }
  if (rf & 2) {
  ...
  _generateForm() {
    ...
    for (const q_id in this.questions) {
      switch (this.questions[q_id].type) {
        case "rating":
          controls[q_id] = new FormControl(null, []);
          break;
        case "text":
        case "comment":
          controls[q_id] = new FormControl("", []);
          break;
        case "dropdown":
          controls[q_id] = new FormControl("", []);
          break;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SurveyOutletComponent, { className: "SurveyOutletComponent", filePath: "apps/concierge/src/app/surveys/survey-outlet.component.ts", lineNumber: 324 });
})();

// apps/concierge/src/app/surveys/pages/survey-manage.component.ts
var _c011 = (a0) => ["/surveys", "survey-list", a0];
var _c17 = (a0) => ({ id: a0 });
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SurveyManageComponent, selectors: [["survey-manage"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 39, vars: 45, consts: [["empty_template", ""], ["tabPanel", ""], ["pagePanel", ""], ["class", "absolute inset-0 z-10 flex bg-base-100 opacity-60", 4, "ngIf"], [1, "flex", "w-full", "items-center", "justify-between", "pb-4", "pl-4", "pr-8", "pt-8"], [1, "flex", "items-center"], ["icon", "", "matRipple", "", 3, "routerLink"], [1, "flex"], [1, "text-2xl"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "mb-4", "flex", "items-center", "space-x-4", "px-8"], ["appearance", "outline", 1, "no-subscript", "flex-1"], [3, "valueChange", "placeholder", "value"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["class", "mb-4 flex items-center space-x-4 px-8", 4, "ngIf"], ["cdkDropListGroup", "", "class", "flex h-1/2 w-full flex-1 flex-col bg-base-100", 4, "ngIf"], [1, "absolute", "inset-0", "z-10", "flex", "bg-base-100", "opacity-60"], [1, "m-auto", "flex", "flex-col", "items-center"], [3, "diameter"], ["name", "title", "appearance", "outline", 1, "no-subscript", "flex-1"], ["matInput", "", "required", "", 3, "ngModelChange", "placeholder", "ngModel"], ["name", "desc", "appearance", "outline", 1, "no-subscript", "flex-1"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], ["cdkDropListGroup", "", 1, "flex", "h-1/2", "w-full", "flex-1", "flex-col", "bg-base-100"], ["mat-tab-nav-bar", "", 1, "flex", "border-b", "border-base-400", "bg-base-200", 3, "tabPanel"], ["mat-tab-link", "", 3, "click", "active"], ["mat-tab-nav-panel", "", 1, "flex", "h-full", "min-h-0", "w-full", "bg-base-200"], ["class", "mt-0 flex h-full min-h-0 w-full", 4, "ngIf"], ["class", "flex h-full w-full flex-col overflow-y-auto", 4, "ngIf"], [1, "mt-0", "flex", "h-full", "min-h-0", "w-full"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col", "space-y-3", "overflow-y-auto"], [1, "flex", "w-full", "flex-row", "items-center", "justify-end", "space-x-2", "pr-2"], ["mat-tab-nav-bar", "", 1, "max-w-xl", 3, "tabPanel"], ["mat-tab-link", "", "class", "rounded-b-md", 3, "active", "click", 4, "ngFor", "ngForOf"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "flex", "w-full", "flex-col", "overflow-x-hidden", "px-6", "py-2", "pt-0"], [4, "ngIf"], [1, "flex", "w-[20rem]", "min-w-[20rem]", "flex-col"], [1, "w-full"], ["mat-tab-link", "", 1, "rounded-b-md", 3, "click", "active"], [1, "mb-4", "flex", "w-full", "flex-row", "items-center", "justify-end", "space-x-2"], ["appearance", "fill", 1, "flex-1", 3, "subscriptSizing"], ["matInput", "", "type", "text", 3, "ngModelChange", "placeholder", "ngModel"], ["btn", "", "matRipple", "", "class", "inverse border-error text-error", 3, "click", 4, "ngIf"], ["cdkDropList", "", 1, "flex", "w-full", "flex-col", "space-y-3", 3, "cdkDropListDropped", "cdkDropListData"], ["cdkDrag", "", "class", "flex w-full flex-row items-start rounded-md bg-base-200 py-1", 4, "ngFor", "ngForOf"], [4, "ngIf", "ngIfElse"], ["btn", "", "matRipple", "", 1, "inverse", "border-error", "text-error", 3, "click"], ["cdkDrag", "", 1, "flex", "w-full", "flex-row", "items-start", "rounded-md", "bg-base-200", "py-1"], [1, "flex", "h-full", "flex-col", "px-2"], [1, "text-lg"], [1, "flex-1", 3, "preview", "value"], [1, "flex", "h-full", "flex-col", "items-center", "py-2"], ["cdkDragHandle", "", 1, "hover:cursor-move"], ["icon", "", "matRipple", "", 1, "mt-auto", "text-error", 3, "click", "matTooltip"], [1, "flex", "h-full", "w-full", "flex-col", "overflow-y-auto"], [3, "survey", "preview", 4, "ngIf"], [3, "survey", "preview"], [1, "m-auto", "flex", "h-52", "flex-col", "justify-center", "space-y-2"], ["src", "assets/icons/dragdrop.svg", "alt", "Icon of drag and drop", 1, "h-12", "opacity-60"], [1, "opacity-30"]], template: function SurveyManageComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(4);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(43, _c011, ctx.bld_id || (ctx.survey == null ? null : ctx.survey.building_id)));
        \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SurveyManageComponent, { className: "SurveyManageComponent", filePath: "apps/concierge/src/app/surveys/pages/survey-manage.component.ts", lineNumber: 343 });
})();

// apps/concierge/src/app/surveys/pages/survey-responses.component.ts
var _c012 = (a0) => ["/surveys", "survey-list", a0];
...
function SurveyResponsesComponent_ng_container_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(39, _c012, (tmp_5_0 = \u0275\u0275pipeBind1(4, 14, ctx_r1.survey$)) == null ? null : tmp_5_0.building_id));
    \u0275\u0275advance(6);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SurveyResponsesComponent, { className: "SurveyResponsesComponent", filePath: "apps/concierge/src/app/surveys/pages/survey-responses.component.ts", lineNumber: 175 });
})();
...
//# sourceMappingURL=surveys.module-M4NY6ZYA.js.map
