...
_ParkingBookingsListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingBookingsListComponent, selectors: [["parking-bookings-list"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 27, vars: 58, consts: [["date_template", ""], ["person_template", ""], ["host_template", ""], ["state_template", ""], ["plate_template", ""], ["status_template", ""], ["action_template", ""], ["menu", "matMenu"], [1, "sticky", "left-0", "w-full"], [1, "block", "min-w-[76rem]", "text-sm", 3, "data", "columns", "filter", "sortable", "empty_message"], [1, "h-20", "w-full"], [1, "px-4", "py-2"], [1, "text-xs", "opacity-30"], ["matTooltipPosition", "right", 1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "bg-base-300", "text-2xl", "text-base-100", 3, "matTooltip"], ["matTooltipPosition", "right", 1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "bg-warning", "text-2xl", "text-warning-content", 3, "matTooltip"], ["matTooltipPosition", "right", 1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "bg-success", "text-2xl", "text-success-content", 3, "matTooltip"], [1, "p-4", "font-mono", "text-sm", "uppercase"], [1, "opacity-30"], [1, "px-4"], ["matRipple", "", 1, "h-10", "w-[7.5rem]", "rounded-3xl", "border-none", 3, "matMenuTriggerFor", "disabled"], [1, "flex", "items-center", "space-x-2", "pl-4", "pr-2"], [1, "flex-1", "text-left"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], [1, "mx-auto", "flex", "items-center", "justify-end", "space-x-2"], ["icon", "", "matRipple", "", 3, "click", "disabled", "matTooltip"]], template: function ParkingBookingsListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
}, dependencies: [MatMenu, MatMenuItem, MatMenuTrigger, MatTooltip, MatProgressBar, MatRipple, IconComponent, SimpleTableComponent, AsyncPipe, DatePipe, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ParkingBookingsListComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: ParkingStateService }, { type: SettingsService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingBookingsListComponent, { className: "ParkingBookingsListComponent", filePath: "apps/concierge/src/app/parking/parking-bookings-list.component.ts", lineNumber: 225 });
})();
  ...
  ngOnInit() {
    return __async(this, null, function* () {
      ...
      this._ex_parking.on_book = (space) => __async(this, null, function* () {
        const options = yield nextValueFrom(this._parking.options);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ParkingMapComponent, [{
    ...
    `, providers: [ExploreParkingService], standalone: false }]
  }], () => [{ type: ExploreStateService }, { type: ExploreParkingService }, { type: ParkingStateService }, { type: OrganisationService }], null);
})();
(() => {
...
}, dependencies: [MatTooltip, MatProgressBar, MatRipple, IconComponent, SimpleTableComponent, AsyncPipe, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ParkingSpaceListComponent, [{
    ...
    args: [{ selector: "parking-space-list", template: `
        ...
        <div class="h-20 w-full"></div>
    `, standalone: false }]
  }], () => [{ type: ParkingStateService }, { type: Clipboard }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingSpaceListComponent, { className: "ParkingSpaceListComponent", filePath: "apps/concierge/src/app/parking/parking-space-list.component.ts", lineNumber: 143 });
})();
...
function ParkingTopbarComponent_For_17_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ParkingTopbarComponent_For_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 11)(1, "div", 18);
    \u0275\u0275conditionalCreate(2, ParkingTopbarComponent_For_17_Conditional_2_Template, 5, 3, "div", 19);
...
function ParkingTopbarComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function ParkingTopbarComponent_Conditional_20_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function ParkingTopbarComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("dateChange", function ParkingTopbarComponent_Conditional_21_Template_date_options_dateChange_0_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
...
_ParkingTopbarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingTopbarComponent, selectors: [["parking-topbar"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 22, vars: 20, consts: [[1, "flex", "w-full", "items-center", "space-x-2", "px-8", "py-4"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], [1, "mr-2", 3, "modelChange", "model"], [3, "matTooltip"], ["btn", "", "matRipple", "", 1, "w-40", "space-x-2", 3, "disabled"], ["btn", "", "matRipple", "", 1, "w-40", "space-x-2"], ["btn", "", "matRipple", "", 1, "w-48", "space-x-2"], [1, "mb-2", "flex", "h-14", "items-center", "bg-base-100", "px-8"], ["appearance", "outline", 1, "no-subscript", "w-56"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [1, "w-0", "flex-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "matTooltip"], ["btn", "", "matRipple", "", 1, "w-40", "space-x-2", 3, "click", "disabled"], [1, "pl-2"], ["btn", "", "matRipple", "", 1, "w-40", "space-x-2", 3, "click"], ["btn", "", "matRipple", "", 1, "w-48", "space-x-2", 3, "click"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "matTooltip"], [3, "dateChange"]], template: function ParkingTopbarComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(16, ParkingTopbarComponent_For_17_Template, 5, 3, "mat-option", 11, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(18, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(19, "div", 12);
    \u0275\u0275conditionalCreate(20, ParkingTopbarComponent_Conditional_20_Template, 4, 3, "button", 13);
    \u0275\u0275conditionalCreate(21, ParkingTopbarComponent_Conditional_21_Template, 1, 0, "date-options");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
    let tmp_2_0;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 10, ctx.path !== "events" ? "APP.CONCIERGE.PARKING_HEADER" : "APP.CONCIERGE.PARKING_BOOK_HEADER"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("model", (tmp_1_0 = \u0275\u0275pipeBind1(6, 12, ctx.options)) == null ? null : tmp_1_0.search);
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", ((tmp_2_0 = \u0275\u0275pipeBind1(8, 14, ctx.options)) == null ? null : tmp_2_0.zones == null ? null : tmp_2_0.zones.length) ? "" : "Select a level to add a space");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.path === "manage" ? 9 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.path === "users" ? 10 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.path === "events" ? 11 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx.zones);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(15, 16, "COMMON.LEVEL_ALL"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(18, 18, ctx.levels));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx.path !== "events" && ctx.path !== "map" ? 20 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.path === "events" || ctx.path === "map" ? 21 : -1);
  }
}, dependencies: [DateOptionsComponent, SearchbarComponent, MatFormField, MatSelect, MatOption, MatTooltip, MatRipple, NgControlStatus, NgModel, IconComponent, AsyncPipe, TranslatePipe, BuildingPipe], styles: ["\n\nbutton[_ngcontent-%COMP%] {\n  min-width: 0;\n  padding: 0 0.85rem;\n}\nmat-form-field[_ngcontent-%COMP%] {\n  height: 3.25em;\n  width: 8em;\n}\n/*# sourceMappingURL=parking-topbar.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ParkingTopbarComponent, [{
    ...
    `, standalone: false, styles: ["/* angular:styles/component:css;4bb26a1eb5035846e32fdbd8af6a308e831b6910e15ebdbaee0887184c668792;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/parking/parking-topbar.component.ts */\nbutton {\n  min-width: 0;\n  padding: 0 0.85rem;\n}\nmat-form-field {\n  height: 3.25em;\n  width: 8em;\n}\n/*# sourceMappingURL=parking-topbar.component.css.map */\n"] }]
  }], () => [{ type: ParkingStateService }, { type: OrganisationService }, { type: ActivatedRoute }, { type: Router }, { type: SettingsService }, { type: MatDialog }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingTopbarComponent, { className: "ParkingTopbarComponent", filePath: "apps/concierge/src/app/parking/parking-topbar.component.ts", lineNumber: 142 });
})();
...
_ParkingUsersListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingUsersListComponent, selectors: [["parking-users-list"]], standalone: false, decls: 18, vars: 42, consts: [["name_template", ""], ["denied_template", ""], ["plate_template", ""], ["action_template", ""], [1, "w-full"], [1, "block", "min-w-[68rem]", "text-sm", 3, "data", "columns", "filter", "sortable"], [1, "h-20", "w-full"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "bg-error", "text-2xl", "text-error-content"], [1, "p-4", "font-mono", "text-sm", "uppercase"], [1, "opacity-30"], [1, "mx-auto", "flex", "items-center", "space-x-2"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", 1, "text-error", 3, "click", "matTooltip"]], template: function ParkingUsersListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-bar", 4);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275element(2, "simple-table", 5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingUsersListComponent, { className: "ParkingUsersListComponent", filePath: "apps/concierge/src/app/parking/parking-users-list.component.ts", lineNumber: 108 });
})();

// apps/concierge/src/app/parking/parking.component.ts
var _c05 = () => ["/book", "parking", "manage"];
var _c14 = () => ["/book", "parking", "manage", "users"];
...
function ParkingComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(16, _c05))("active", ctx_r1.path === "manage");
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(18, _c24))("active", ctx_r1.path === "map");
    \u0275\u0275advance();
...
_ParkingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingComponent, selectors: [["app-parking"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 11, vars: 4, consts: [["tabPanel", ""], [1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "px-8", "pb-2"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], [1, "h-full", "w-full", "overflow-auto"], [1, "absolute", "inset-0", "z-50", "flex", "flex-col", "items-center", "justify-center"], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", 3, "routerLink", "active"], [1, "absolute", "inset-0", "z-0", "bg-base-100", "opacity-80"], [1, "z-10", "opacity-60"]], template: function ParkingComponent_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    let tmp_1_0;
    \u0275\u0275advance(5);
    \u0275\u0275conditional(ctx.path !== "events" ? 5 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(!((tmp_1_0 = \u0275\u0275pipeBind1(10, 2, ctx.levels)) == null ? null : tmp_1_0.length) ? 9 : -1);
  }
}, dependencies: [ApplicationTopbarComponent, ApplicationSidebarComponent, MatTabNav, MatTabNavPanel, MatTabLink, RouterOutlet, RouterLink, ParkingTopbarComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: 100%;\n  background-color: var(--b1);\n}\nsidebar[_ngcontent-%COMP%] {\n  height: 100%;\n}\nmain[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  flex: 1;\n  min-width: 50%;\n  height: 100%;\n}\n/*# sourceMappingURL=parking.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ParkingComponent, [{
    ...
    `, standalone: false, styles: ["/* angular:styles/component:css;dd45660a96c490516c2f2104d17b5d40ade70328f67ef5d45dcf89ed7685333a;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/parking/parking.component.ts */\n:host {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: 100%;\n  background-color: var(--b1);\n}\nsidebar {\n  height: 100%;\n}\nmain {\n  display: flex;\n  flex-direction: column;\n  flex: 1;\n  min-width: 50%;\n  height: 100%;\n}\n/*# sourceMappingURL=parking.component.css.map */\n"] }]
  }], () => [{ type: ParkingStateService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingComponent, { className: "ParkingComponent", filePath: "apps/concierge/src/app/parking/parking.component.ts", lineNumber: 107 });
})();
...
//# sourceMappingURL=parking.module-UJFYCPE5.js.map
