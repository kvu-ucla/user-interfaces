...
var EmailTemplatesComponent = class _EmailTemplatesComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplatesComponent, selectors: [["", "app-email-templates", ""]], standalone: false, attrs: _c0, decls: 5, vars: 0, consts: [[1, "flex", "flex-1", "h-px"], [1, "relative", "flex", "flex-col", "flex-1", "w-1/2", "h-full"]], template: function EmailTemplatesComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var EmailTemplatesStateService = class _EmailTemplatesStateService {
...
var _c1 = (a0) => ({ key: "subject", name: a0 });
...
var EmailTemplatesListComponent = class _EmailTemplatesListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplatesListComponent, selectors: [["email-templates-list"]], standalone: false, decls: 29, vars: 46, consts: [["date_template", ""], ["bld_template", ""], ["trigger_template", ""], ["actions_template", ""], ["menu", "matMenu"], [1, "absolute", "inset-0", "flex", "flex-col"], [1, "flex", "items-center", "justify-between", "p-8", "space-x-2"], [1, "text-2xl", "font-medium"], [1, "flex-1"], ["btn", "", "matRipple", "", 3, "routerLink"], [1, "ml-2"], [1, "text-2xl"], [1, "h-1/2", "flex-1", "w-full", "px-8", "overflow-y-auto", "relative"], [1, "w-full", "min-h-full", "overflow-x-auto"], ["empty_message", "No group events for selected period", 1, "min-w-[56rem]", "w-full", "block", "text-sm", 3, "data", "columns", "sortable"], [1, "opacity-60", "p-4"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"], [1, "p-4", "font-mono", "text-xs"], ["icon", "", "matRipple", "", 1, "mx-auto", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], ["mat-menu-item", "", 3, "routerLink"], [1, "text-2xl", "text-error"]], template: function EmailTemplatesListComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmailTemplatesListComponent, { className: "EmailTemplatesListComponent", filePath: "apps/concierge/src/app/email-templates/email-templates-list.component.ts", lineNumber: 158 });
})();

// apps/concierge/src/app/email-templates/email-template-manage.component.ts
var _c03 = () => [];
var _c12 = () => ["/email-templates"];
...
var EmailTemplateManageComponent = class _EmailTemplateManageComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplateManageComponent, selectors: [["email-template-manage"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 73, vars: 61, consts: [["trigger_menu", "matMenu"], ["tracking_menu", "matMenu"], ["load_state", ""], [1, "absolute", "inset-0", "bg-base-100", "overflow-auto"], [1, "sticky", "flex", "items-center", "justify-between", "top-0", "px-4", "py-2", "mx-auto", "my-2", "max-w-[40rem]", "w-full", "border-none", "z-10", "bg-base-200", "rounded"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", 3, "routerLink", 4, "ngIf"], [1, "mx-auto", "my-2", "max-w-[40rem]", "w-full", "z-0", "p-4", "overflow-visible", 3, "formGroup"], [1, "flex", "items-center", "space-x-4"], [1, "flex-1", "space-y-2", "w-1/4"], ["for", "zone"], ["appearance", "outline", 1, "w-full"], ["name", "zone", "formControlName", "zone_id", 3, "placeholder"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], [1, "flex-1", "space-y-2", "w-1/4", "pb-6"], ["for", "trigger"], ["duration-field", "", "matRipple", "", 1, "flex", "items-center", "justify-between", "border", "border-neutral", "rounded", "h-12", "w-full", "px-2", 3, "click", "matMenuTriggerFor"], [1, "flex", "flex-col", "leading-tight", "px-2", "text-left", "flex-1", "w-1/2"], [1, "truncate"], ["class", "opacity-30 truncate", 4, "ngIf"], [1, "text-2xl"], [1, "max-h-[24rem]"], ["mat-menu-item", "", 3, "click"], [4, "ngFor", "ngForOf"], ["btn", "", "matRipple", "", "matTooltip", "Values that get replaced in the email template when sent", 1, "flex-1", "mt-2", 3, "disabled", "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click", 4, "ngFor", "ngForOf"], ["mat-menu-item", "", 3, "disabled", 4, "ngIf"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "flex-1"], ["matInput", "", "formControlName", "reply_to", 3, "placeholder"], ["matInput", "", "formControlName", "from", 3, "placeholder"], ["matPrefix", "", 1, "text-2xl", "relative", "-left-1"], ["matInput", "", "placeholder", "Template Subject", "formControlName", "subject"], ["formControlName", "html", 1, "min-h-[calc(100vh-32rem)]", "block", 3, "placeholder", "images_allowed"], ["class", "fixed bottom-0 left-1/2 -translate-x-1/2 px-4 py-2 mx-auto my-2 max-w-[640px] w-full border-none z-10 bg-base-200 rounded flex items-center justify-end", 4, "ngIf"], ["icon", "", "matRipple", "", 3, "routerLink"], [3, "value"], [1, "opacity-30", "truncate"], [1, "p-4"], [1, "flex", "items-center", "space-x-2", "pl-2"], [1, "flex", "flex-col-reverse", "leading-tight", "my-2", "flex-1"], [1, "text-xs", "opacity-30"], [1, "text-sm"], [1, "opacity-0"], ["class", "text-2xl", 4, "ngIf"], [1, "flex", "flex-col", "leading-tight"], [1, "font-mono", "text-sm"], ["mat-menu-item", "", 3, "disabled"], [1, "fixed", "bottom-0", "left-1/2", "-translate-x-1/2", "px-4", "py-2", "mx-auto", "my-2", "max-w-[640px]", "w-full", "border-none", "z-10", "bg-base-200", "rounded", "flex", "items-center", "justify-end"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], [1, "absolute", "inset-0", "bg-base-100"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"]], template: function EmailTemplateManageComponent_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(4);
        \u0275\u0275property("ngForOf", (ctx.active_trigger == null ? null : ctx.active_trigger.fields) || \u0275\u0275pureFunction0(59, _c03));
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !((ctx.active_trigger == null ? null : ctx.active_trigger.fields) || \u0275\u0275pureFunction0(60, _c03)).length);
        \u0275\u0275advance(3);
...
//# sourceMappingURL=email-templates.module-BFHZ6RFZ.js.map
