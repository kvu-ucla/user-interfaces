...
function BuildingFormComponent_ng_container_0_form_1_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10)(1, "label", 20);
    \u0275\u0275i18n(2, 5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 12)(4, "mat-select", 21)(5, "mat-option", 22);
    \u0275\u0275text(6, "None");
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, BuildingFormComponent_ng_container_0_form_1_div_1_mat_option_7_Template, 2, 2, "mat-option", 16);
    \u0275\u0275pipe(8, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function BuildingFormComponent_ng_container_0_form_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, BuildingFormComponent_ng_container_0_form_1_div_1_Template, 9, 4, "div", 9);
    \u0275\u0275pipe(2, "async");
    ...
    \u0275\u0275i18n(10, 3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 12)(12, "app-icon", 14);
    \u0275\u0275text(13, "search");
    \u0275\u0275elementEnd();
    \u0275\u0275element(14, "input", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-autocomplete", null, 1);
    \u0275\u0275template(17, BuildingFormComponent_ng_container_0_form_1_mat_option_17_Template, 2, 2, "mat-option", 16)(18, BuildingFormComponent_ng_container_0_form_1_mat_option_18_Template, 2, 1, "mat-option", 17);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 10)(20, "label", 18);
    \u0275\u0275i18n(21, 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "mat-form-field", 12);
...
function BuildingFormComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, BuildingFormComponent_ng_container_0_form_1_Template, 24, 7, "form", 7);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
_BuildingFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BuildingFormComponent, selectors: [["building-form"]], inputs: { building: "building", save: "save", loading: "loading" }, outputs: { loadingChange: "loadingChange", done: "done" }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 3, vars: 2, consts: () => {
  let i18n_0;
  if (false) {
  ...
  if (rf & 1) {
    \u0275\u0275template(0, BuildingFormComponent_ng_container_0_Template, 2, 1, "ng-container", 6)(1, BuildingFormComponent_ng_template_1_Template, 4, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BuildingFormComponent, { className: "BuildingFormComponent", filePath: "apps/concierge/src/app/building-manager/building-form.component.ts", lineNumber: 115 });
})();
...
//# sourceMappingURL=building-manager.module-HQ3RM4NS.js.map
