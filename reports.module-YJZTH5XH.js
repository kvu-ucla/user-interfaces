import "./chunk-XLVEIYLX.js";
import "./chunk-TFZ3DMRT.js";
import "./chunk-U3GA6UJ2.js";
import "./chunk-H7WX3QGT.js";
import {
  ActivatedRoute,
...
var ReportsStateService = class _ReportsStateService {
  ...
  constructor(_org, _settings) {
    ...
    this.counts = this._options.pipe(debounceTime(500), switchMap((filters) => {
      ...
      return Promise.all(zones.map((z) => hu(z, "desks").pipe(catchError(() => of({ details: [] })), map((m) => [z, m.details.length])).toPromise()));
    }), map((list) => {
      const map2 = {};
...
var AssetReportDailyUsageComponent = class _AssetReportDailyUsageComponent {
  constructor(_state) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield nextValueFrom(this.daily_products);
...
var AssetReportExpiredItemsComponent = class _AssetReportExpiredItemsComponent {
  constructor(_state) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield nextValueFrom(this.expired_items);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetReportExpiredItemsComponent, { className: "AssetReportExpiredItemsComponent", filePath: "apps/concierge/src/app/reports/assets/asset-report-expired-items.component.ts", lineNumber: 79 });
})();
...
var AssetReportProductUsageComponent = class _AssetReportProductUsageComponent {
  constructor(_state) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield nextValueFrom(this.products);
...
var AssetReportUsersComponent = class _AssetReportUsersComponent {
  constructor(_state) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield nextValueFrom(this.users);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetReportUsersComponent, { className: "AssetReportUsersComponent", filePath: "apps/concierge/src/app/reports/assets/asset-report-users.component.ts", lineNumber: 62 });
})();
...
var ReportsOptionsComponent = class _ReportsOptionsComponent extends AsyncHandler {
  ...
  static {
    ...
    }, dependencies: [NgForOf, NgIf, DefaultValueAccessor, NgControlStatus, NgModel, MatFormField, MatSelect, MatOption, MatTooltip, MatProgressSpinner, MatRipple, DateRangeFieldComponent, IconComponent, AsyncPipe, TranslatePipe, BuildingPipe], styles: ["\n\nbutton[_ngcontent-%COMP%] {\n  min-width: 0;\n  padding: 0 0.85rem;\n}\nbutton[icon][disabled][_ngcontent-%COMP%] {\n  background-color: var(--n) !important;\n}\nmat-slide-toggle[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  width: 5.5em;\n  white-space: initial;\n  line-height: 1.2em;\n}\n/*# sourceMappingURL=reports-options.component.css.map */"] });
  }
};
(() => {
...
var CateringReportStateService = class _CateringReportStateService {
  ...
  downloadOrders() {
    return __async(this, null, function* () {
      const orders = yield nextValueFrom(this.catering_orders);
...
var CateringReportOverallComponent = class _CateringReportOverallComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportOverallComponent, selectors: [["catering-report-overall"]], standalone: false, decls: 37, vars: 36, consts: [["item", "", 1, "flex", "flex-1", "flex-col", "items-center", "justify-center"], ["count", "", 1, "text-3xl"], [1, "text-sm"], ["unique", "", 1, "text-3xl"], ["items", "", 1, "text-3xl"], ["total", "", 1, "text-3xl"], ["average", "", 1, "text-3xl"]], template: function CateringReportOverallComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var ContactTracingStateService = class _ContactTracingStateService {
  ...
  constructor(_org, _reports, _settings) {
    ...
    this.events = combineLatest([
      ...
      const mod = Ea(this.system_id, "ContactTracing");
  ...
  downloadReport() {
    return __async(this, null, function* () {
      const { start, end } = yield nextValueFrom(this._reports.options);
      const events = yield nextValueFrom(this.events);
...
var ReportDesksChartsComponent = class _ReportDesksChartsComponent extends AsyncHandler {
  ...
  updateCharts() {
    this.timeout("update_charts", () => __async(this, null, function* () {
      const day_list = yield nextValueFrom(this.day_list);
      this.updateDailyChart(day_list);
      const [mappings, counts] = yield nextValueFrom(this.stats);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportDesksChartsComponent, { className: "ReportDesksChartsComponent", filePath: "apps/concierge/src/app/reports/desks/report-desks-charts.component.ts", lineNumber: 61 });
})();
...
var ReportDesksLevelListComponent = class _ReportDesksLevelListComponent {
  constructor(_state, _org, _settings) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield nextValueFrom(this.level_list);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportDesksLevelListComponent, { className: "ReportDesksLevelListComponent", filePath: "apps/concierge/src/app/reports/desks/report-desks-level-list.component.ts", lineNumber: 82 });
})();
...
var ReportDesksOverallListComponent = class _ReportDesksOverallListComponent {
  constructor(_state) {
    ...
    this.day_list = this._state.day_list;
    this.download = () => __async(this, null, function* () {
      let data = yield nextValueFrom(this.day_list);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportDesksOverallListComponent, { className: "ReportDesksOverallListComponent", filePath: "apps/concierge/src/app/reports/desks/report-desks-overall-list.component.ts", lineNumber: 74 });
})();
...
var LockersReportService = class _LockersReportService {
  constructor(_settings, _org, _report) {
    ...
    this.counts$ = this._options.pipe(debounceTime(500), switchMap((filters) => {
      ...
      return Promise.all(zones.map((z) => hu(z, "lockers-spaces").pipe(catchError(() => of({ details: [] })), map((m) => [z, m.details.length])).toPromise()));
    }), map((list) => {
      const mapping = {};
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportChartsComponent, { className: "LockersReportChartsComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-charts.component.ts", lineNumber: 68 });
})();
...
var LockersReportDailyUsageComponent = class _LockersReportDailyUsageComponent {
  constructor(_state) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield nextValueFrom(this.daily_stats);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportDailyUsageComponent, { className: "LockersReportDailyUsageComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-daily-usage.component.ts", lineNumber: 75 });
})();
...
var LockersReportListComponent = class _LockersReportListComponent {
  constructor(_state) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield nextValueFrom(this.lockers_bookings);
      for (const bkn of data) {
        bkn.date = format(bkn.date, "yyyy-MM-dd HH:mm");
      }
      downloadFile("report-lockers-daily-usage.csv", jsonToCsv(data));
  ...
  static {
    ...
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe, DurationPipe], encapsulation: 2 });
  }
};
(() => {
...
var ParkingReportService = class _ParkingReportService {
  constructor(_settings, _org, _report) {
    ...
    this.counts$ = this._options.pipe(debounceTime(500), switchMap((filters) => {
      ...
      return Promise.all(zones.map((z) => hu(z, "parking-spaces").pipe(catchError(() => of({ details: [] })), map((m) => [z, m.details.length])).toPromise()));
    }), map((list) => {
      const mapping = {};
      list.forEach(([id, count]) => mapping[id] = Math.max(count || 0, 1));
      return mapping;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingReportChartsComponent, { className: "ParkingReportChartsComponent", filePath: "apps/concierge/src/app/reports/parking/parking-report-charts.component.ts", lineNumber: 61 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingReportDailyUsageComponent, { className: "ParkingReportDailyUsageComponent", filePath: "apps/concierge/src/app/reports/parking/parking-report-daily-usage.component.ts", lineNumber: 75 });
})();
...
var ParkingReportListComponent = class _ParkingReportListComponent {
  constructor(_state) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield nextValueFrom(this.parking_bookings);
      for (const bkn of data) {
        bkn.date = format(bkn.date, "yyyy-MM-dd HH:mm");
      }
      downloadFile("report-parking-daily-usage.csv", jsonToCsv(data));
...
var ParkingReportComponent = class _ParkingReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportComponent, selectors: [["", "parking-report", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c017, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "m-4", "flex", "items-center", "rounded", "bg-base-200", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"]], template: function ParkingReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
...
function ReportsMenuComponent_a_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(1, _c114));
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportsMenuComponent, { className: "ReportsMenuComponent", filePath: "apps/concierge/src/app/reports/reports-menu.component.ts", lineNumber: 102 });
})();
...
var ReportsComponent = class _ReportsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportsComponent, selectors: [["", "app-new-reports", ""]], standalone: false, attrs: _c019, decls: 6, vars: 1, consts: [[1, "screen-only"], [1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"], ["reports-menu", "", "class", "screen-only absolute inset-0", 4, "ngIf"], ["reports-menu", "", 1, "screen-only", "absolute", "inset-0"]], template: function ReportsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(5, ReportsComponent_div_5_Template, 1, 0, "div", 3);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportsComponent, { className: "ReportsComponent", filePath: "apps/concierge/src/app/reports/reports.component.ts", lineNumber: 40 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesChartsComponent, { className: "ReportSpacesChartsComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces-charts.component.ts", lineNumber: 61 });
})();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesOverallListComponent, selectors: [["report-spaces-overall-list"]], inputs: { print: "print" }, standalone: false, decls: 17, vars: 34, consts: [["date_template", ""], ["percent_template", ""], [1, "w-full"], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "p-4"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ReportSpacesOverallListComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.day_list)("columns", \u0275\u0275pureFunction4(29, _c414, \u0275\u0275pureFunction2(19, _c020, \u0275\u0275pipeBind1(8, 9, "FORM.DATE"), date_template_r5), \u0275\u0275pureFunction1(22, _c115, \u0275\u0275pipeBind1(9, 11, "APP.CONCIERGE.REPORTS_APPROVED")), \u0275\u0275pureFunction1(24, _c215, \u0275\u0275pipeBind1(10, 13, "APP.CONCIERGE.REPORTS_TOTAL_REQUESTS")), \u0275\u0275pureFunction2(26, _c315, \u0275\u0275pipeBind1(11, 15, "APP.CONCIERGE.REPORTS_UTILISATION"), percent_template_r6)))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesOverallListComponent, { className: "ReportSpacesOverallListComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces-overall-list.component.ts", lineNumber: 73 });
})();
...
var ReportSpacesSpaceListingComponent = class _ReportSpacesSpaceListingComponent {
  constructor(_reports) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield nextValueFrom(this.space_list);
...
var ReportSpacesUserListingComponent = class _ReportSpacesUserListingComponent {
  constructor(_reports) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield nextValueFrom(this.user_list);
      for (const item of data) {
        delete item.attendance;
        delete item.avg_attendance;
        delete item.min_attendance;
...
var ReportSpacesComponent = class _ReportSpacesComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesComponent, selectors: [["", "report-spaces", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c023, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "m-4", "flex", "items-center", "rounded", "bg-base-200", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"]], template: function ReportSpacesComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorReportDailyUsageComponent, selectors: [["visitor-report-daily-usage"]], inputs: { print: "print" }, standalone: false, decls: 14, vars: 33, consts: [["date_template", ""], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function VisitorReportDailyUsageComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.daily_stats)("columns", \u0275\u0275pureFunction4(28, _c417, \u0275\u0275pureFunction2(19, _c024, \u0275\u0275pipeBind1(7, 9, "FORM.DATE"), date_template_r4), \u0275\u0275pureFunction1(22, _c118, \u0275\u0275pipeBind1(8, 11, "APP.CONCIERGE.REPORTS_VISITORS_UNIQUE")), \u0275\u0275pureFunction1(24, _c218, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_VISITORS_HOSTS")), \u0275\u0275pureFunction1(26, _c318, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_BOOKING_COUNT_HEADER"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorReportDailyUsageComponent, { className: "VisitorReportDailyUsageComponent", filePath: "apps/concierge/src/app/reports/visitors/visitor-report-daily-usage.component.ts", lineNumber: 75 });
})();
...
var VisitorReportListComponent = class _VisitorReportListComponent {
  constructor(_state) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield nextValueFrom(this.visitor_bookings);
      for (const bkn of data) {
        bkn.date = format(bkn.date, "yyyy-MM-dd HH:mm");
      }
...
var VisitorsReportComponent = class _VisitorsReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorsReportComponent, selectors: [["", "visitors-report", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c026, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "m-4", "flex", "items-center", "rounded", "bg-base-200", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"]], template: function VisitorsReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
...
//# sourceMappingURL=reports.module-YJZTH5XH.js.map
