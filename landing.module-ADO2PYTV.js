import "./chunk-5E5ZMQDL.js";
import {
  ScheduleStateService
} from "./chunk-ZCC74ZFJ.js";
import {
  AsyncHandler,
  AsyncPipe,
...
function LandingAvailabilityComponent_Conditional_3_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(5, _c0))("queryParams", \u0275\u0275pureFunction1(6, _c1, lvl_r1.id));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_15_0 = ctx_r1.building(lvl_r1.parent_id)) == null ? null : tmp_15_0.display_name) || ((tmp_15_0 = ctx_r1.building(lvl_r1.parent_id)) == null ? null : tmp_15_0.name));
  }
}
...
function LandingAvailabilityComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, LandingAvailabilityComponent_Conditional_3_For_2_Template, 12, 8, "button", 5, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(3, "async");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("mb-4", !ctx_r1.hide_rooms);
    \u0275\u0275advance();
    \u0275\u0275repeater(\u0275\u0275pipeBind1(3, 3, ctx_r1.levels_free));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!\u0275\u0275pipeBind1(5, 5, ctx_r1.levels_free).length ? 4 : -1);
  }
}
...
function LandingAvailabilityComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, LandingAvailabilityComponent_Conditional_4_Conditional_4_Template, 1, 0, "mat-spinner", 14);
    \u0275\u0275pipe(5, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(\u0275\u0275pipeBind1(5, 4, ctx_r1.loading_spaces) ? 4 : -1);
  }
}
function LandingAvailabilityComponent_Conditional_5_For_2_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("source", (tmp_12_0 = \u0275\u0275pipeBind1(2, 3, \u0275\u0275pipeBind1(1, 1, space_r4.id))) == null ? null : tmp_12_0.images[0]);
  }
}
...
function LandingAvailabilityComponent_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LandingAvailabilityComponent_Conditional_5_For_2_Template_button_click_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.book(space_r4));
    });
    \u0275\u0275elementStart(1, "div", 7);
    \u0275\u0275conditionalCreate(2, LandingAvailabilityComponent_Conditional_5_For_2_Conditional_2_Template, 3, 5, "img", 8);
    \u0275\u0275pipe(3, "space");
    \u0275\u0275pipe(4, "async");
    \u0275\u0275conditionalBranchCreate(5, LandingAvailabilityComponent_Conditional_5_For_2_Conditional_5_Template, 1, 0, "img", 17);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_11_0 = \u0275\u0275pipeBind1(4, 5, \u0275\u0275pipeBind1(3, 3, space_r4.id))) == null ? null : tmp_11_0.images == null ? null : tmp_11_0.images.length) ? 2 : 5);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", space_r4.display_name || space_r4.name, " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_13_0 = ctx_r1.level(space_r4.zones)) == null ? null : tmp_13_0.display_name) || ((tmp_13_0 = ctx_r1.level(space_r4.zones)) == null ? null : tmp_13_0.name));
  }
}
...
function LandingAvailabilityComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4);
    \u0275\u0275repeaterCreate(1, LandingAvailabilityComponent_Conditional_5_For_2_Template, 14, 7, "button", 15, \u0275\u0275componentInstance().trackBySpaceId, true);
    \u0275\u0275pipe(3, "async");
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(\u0275\u0275pipeBind1(3, 1, ctx_r1.space_list));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!((tmp_2_0 = \u0275\u0275pipeBind1(5, 3, ctx_r1.space_list)) == null ? null : tmp_2_0.length) ? 4 : -1);
  }
}
...
}, dependencies: [MatRipple, MatProgressSpinner, IconComponent, AuthenticatedImageDirective, RouterLink, AsyncPipe, TranslatePipe, SpacePipe], styles: ["\n\n*[_ngcontent-%COMP%] {\n  flex-shrink: 0;\n}\n/*# sourceMappingURL=landing-availability.component.css.map */"] });
...
}, dependencies: [MatMenu, MatMenuItem, MatMenuTrigger, MatRipple, MatProgressSpinner, MatTooltip, IconComponent, UserAvatarComponent, DefaultValueAccessor, NgControlStatus, NgModel, AsyncPipe, TranslatePipe], styles: ["\n\n[user][_ngcontent-%COMP%]:hover   button[_ngcontent-%COMP%] {\n  opacity: 1;\n}\n[_nghost-%COMP%] {\n  height: 100%;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n}\n/*# sourceMappingURL=landing-colleagues.component.css.map */"] });
...
function LandingFavouritesComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, LandingFavouritesComponent_Conditional_6_For_1_Template, 4, 6, null, null, \u0275\u0275repeaterTrackByIdentity);
...
}, dependencies: [MatMenu, MatMenuItem, MatMenuTrigger, MatRipple, IconComponent, AuthenticatedImageDirective, AsyncPipe, TranslatePipe, SpacePipe], styles: ["\n\n[user][_ngcontent-%COMP%]:hover   button[_ngcontent-%COMP%] {\n  opacity: 1;\n}\n[_nghost-%COMP%] {\n  height: 100%;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n}\n/*# sourceMappingURL=landing-favourites.component.css.map */"] });
...
_LandingQuickLinksComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingQuickLinksComponent, selectors: [["landing-quick-links"]], standalone: false, decls: 8, vars: 7, consts: [[1, "mb-2", "px-4", "font-medium", "sm:mb-4", "sm:text-lg"], [1, "mx-4", "mb-4", "flex", "w-[calc(100%-2rem)]", "snap-x", "space-x-2", "overflow-auto"], ["matRipple", "", 1, "flex", "w-64", "min-w-64", "snap-start", "items-center", "space-x-4", "rounded", "border", "border-base-200", "bg-base-100", "p-2", "shadow", 3, "routerLink"], [1, "flex", "h-16", "min-w-[4rem]", "items-center", "justify-center", "rounded", "bg-base-200"], ["src", "assets/icons/room-placeholder.svg", 1, "h-1/2", "w-1/2", "object-contain", "object-center"], [1, "text-xl"], ["src", "assets/icons/desk-placeholder.svg", 1, "h-1/2", "w-1/2", "object-contain", "object-center"], ["src", "assets/icons/car-placeholder.svg", 1, "h-1/2", "w-1/2", "object-contain", "object-center"], ["src", "assets/icons/locker-placeholder.svg", 1, "h-1/2", "w-1/2", "object-contain", "object-center"]], template: function LandingQuickLinksComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.features.includes("parking") ? 7 : -1);
  }
...
function LandingUpcomingComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, LandingUpcomingComponent_Conditional_12_For_1_Template, 2, 1, null, null, \u0275\u0275componentInstance().trackByFn, true);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275pipe(3, "slice");
  }
  if (rf & 2) {
...
}, dependencies: [EventCardComponent, BookingCardComponent, RouterLink, AsyncPipe, SlicePipe, TranslatePipe], encapsulation: 2 });
...
function LandingComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
_LandingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingComponent, selectors: [["app-landing"]], standalone: false, decls: 20, vars: 15, consts: [[1, "z-10"], [1, "flex", "h-1/2", "flex-1", "bg-base-200"], [1, "relative", "hidden", "h-full", "w-[18rem]", "flex-col", "overflow-hidden", "border-r", "border-base-300", "bg-base-100", "sm:flex"], [1, "z-0", "h-full", "w-1/2", "flex-1", "overflow-auto", "sm:px-4"], [1, "sticky", "top-0", "z-50", "mb-4", "flex", "items-center", "justify-between", "overflow-hidden", "bg-ternary", "px-4", "sm:rounded-b"], [1, ""], [1, "font-medium", "sm:text-xl"], ["date", "", 1, "text-sm", "sm:text-base"], [1, "text-sm", "sm:text-base"], [1, "h-32", "pt-4"], ["src", "assets/img/landing.svg"], [1, "mx-4", "mb-2", "h-px", "w-[calc(100%-2rem)]", "bg-base-200"], [1, "flex", "items-center", "space-x-2", "p-2"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "inverse"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "click"], [1, "flex", "items-center", "space-x-2", "capitalize"], [1, "pr-2"], [1, "h-1/2", "w-full", "flex-1"]], template: function LandingComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(16, "landing-availability")(17, "div", 11)(18, "landing-upcoming");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(19, LandingComponent_Conditional_19_Template, 1, 0, "footer-menu");
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional((ctx.building == null ? null : ctx.building.address) || (ctx.building == null ? null : ctx.building.name) ? 12 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx.show_quick_links ? 15 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(!ctx.hide_nav ? 19 : -1);
  }
}, dependencies: [TopbarComponent, FooterMenuComponent, MatRipple, IconComponent, LandingColleaguesComponent, LandingAvailabilityComponent, LandingUpcomingComponent, LandingFavouritesComponent, LandingQuickLinksComponent, DatePipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  overflow: hidden;\n  display: flex;\n  flex-direction: column;\n}\nmain[_ngcontent-%COMP%] {\n  min-height: 50%;\n}\n/*# sourceMappingURL=landing.component.css.map */"] });
...
//# sourceMappingURL=landing.module-ADO2PYTV.js.map
