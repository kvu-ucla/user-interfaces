...
var ExploreComponent = class _ExploreComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreComponent, selectors: [["app-explore"]], standalone: false, decls: 5, vars: 2, consts: [[4, "ngIf"], [1, "flex-1", "flex", "sm:flex-row", "flex-col-reverse", "h-1/2", "bg-base-200"], [1, "relative", "z-0", "flex", "flex-col", "flex-1", "h-1/2", "sm:h-auto", "overflow-hidden"]], template: function ExploreComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=explore.module-2XA7TXUQ.js.map
