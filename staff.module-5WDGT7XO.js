...
var _EmergencyContactModalComponent = class _EmergencyContactModalComponent {
  ...
  async addRole() {
    ...
    await du(this._org.building.id, {
...
_StaffDetailsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StaffDetailsComponent, selectors: [["staff-details"]], inputs: { user: [1, "user"], onsite: [1, "onsite"] }, standalone: false, decls: 1, vars: 1, consts: [["details", "", 1, "flex", "w-full", "items-center", "border-b", "border-base-200", "bg-base-100", "px-4", "py-2", "hover:opacity-80"], [3, "user"], [1, "flex", "flex-1", "flex-col"], [1, "px-2"], [1, "px-2", "text-xs", "text-opacity-50"], [1, "px-4", "text-xs", "opacity-50"], [1, "flex", "items-center"], [3, "click", "matTooltip", "loading", "content"], ["icon", "", "matRipple", "", 3, "matTooltip", "href"]], template: function StaffDetailsComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=staff.module-5WDGT7XO.js.map
