...
var ParkingTopbarComponent = class _ParkingTopbarComponent extends AsyncHandler {
  ...
  static {
    ...
    }, dependencies: [NgForOf, NgIf, DateOptionsComponent, SearchbarComponent, MatFormField, MatSelect, MatOption, MatTooltip, MatRipple, NgControlStatus, NgModel, IconComponent, AsyncPipe, TranslatePipe, BuildingPipe], styles: ["\n\nbutton[_ngcontent-%COMP%] {\n  min-width: 0;\n  padding: 0 0.85rem;\n}\nmat-form-field[_ngcontent-%COMP%] {\n  height: 3.25em;\n  width: 8em;\n}\n/*# sourceMappingURL=parking-topbar.component.css.map */"] });
  }
};
(() => {
...
function ParkingComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
...
function ParkingComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
...
var ParkingComponent = class _ParkingComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingComponent, selectors: [["app-parking"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 11, vars: 4, consts: [["tabPanel", ""], [1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"], ["class", "px-8 pb-2", 4, "ngIf"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], [1, "h-full", "w-full", "overflow-auto"], ["class", "absolute inset-0 z-50 flex flex-col items-center justify-center", 4, "ngIf"], [1, "px-8", "pb-2"], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", 3, "routerLink", "active"], [1, "absolute", "inset-0", "z-50", "flex", "flex-col", "items-center", "justify-center"], [1, "absolute", "inset-0", "z-0", "bg-base-100", "opacity-80"], [1, "z-10", "opacity-60"]], template: function ParkingComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(5, ParkingComponent_div_5_Template, 13, 19, "div", 3);
        \u0275\u0275elementStart(6, "div", 4)(7, "div", 5);
        \u0275\u0275element(8, "router-outlet");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(9, ParkingComponent_div_9_Template, 5, 3, "div", 6);
        \u0275\u0275pipe(10, "async");
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingComponent, { className: "ParkingComponent", filePath: "apps/concierge/src/app/parking/parking.component.ts", lineNumber: 89 });
})();
...
//# sourceMappingURL=parking.module-AEVEJO2P.js.map
