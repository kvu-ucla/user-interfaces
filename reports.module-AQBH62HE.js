...
import "./chunk-XMYBBKQZ.js";
import "./chunk-R6ZUMP2N.js";
import {
  SharedUsersModule
...
var _ParkingReportService = class _ParkingReportService {
  constructor(_settings, _org) {
    ...
    this.counts$ = this._options.pipe(debounceTime(500), switchMap((filters) => {
      ...
      return Promise.all(zones.map((z) => showMetadata(z, "parking_spaces").pipe(catchError(() => of({ details: [] })), map((m) => [z, m.details.length])).toPromise()));
    }), map((list) => {
...
function ParkingReportComponent_ng_container_12_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "parking-report-overall")(2, "parking-report-daily-usage", 10)(3, "parking-report-list");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ParkingReportComponent_ng_container_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ParkingReportComponent_ng_container_12_ng_container_1_Template, 4, 1, "ng-container", 9);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
}, dependencies: [NgIf, MatProgressSpinner, AuthenticatedImageDirective, ReportsOptionsComponent, ParkingReportDailyUsageComponent, ParkingReportOverallComponent, ParkingReportListComponent, AsyncPipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=parking-report.component.css.map */"] });
var ParkingReportComponent = _ParkingReportComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingReportComponent, { className: "ParkingReportComponent", filePath: "apps/concierge/src/app/reports/parking/parking-report.component.ts", lineNumber: 69 });
})();
...
var _ParkingReportChartsComponent = class _ParkingReportChartsComponent extends AsyncHandler {
  constructor(_state, _org, _settings) {
    ...
    this._settings = _settings;
    this.print = false;
    this.day_list = this._state.daily_stats$.pipe(map((days) => {
      let list = [];
      for (const date in days) {
        list.push({
          date,
...
_ParkingReportChartsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportChartsComponent, selectors: [["parking-report-charts"]], inputs: { print: "print" }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 9, vars: 2, consts: [[1, "flex", "items-center", "space-x-4", "w-full", "px-4", 3, "resize"], [1, "bg-base-100", "border", "border-base-200", "rounded", "flex-1", "h-[18rem]"], [1, "border-b", "border-base-200", "p-4", "text-xl", "font-bold"], ["id", "daily-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-full", "h-56", "mx-auto"], ["id", "level-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-[24rem]", "h-56", "mx-auto"]], template: function ParkingReportChartsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
...
//# sourceMappingURL=reports.module-AQBH62HE.js.map
