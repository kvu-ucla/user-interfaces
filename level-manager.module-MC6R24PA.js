...
var LevelModalComponent = class _LevelModalComponent {
  ...
  save() {
    return __async(this, null, function* () {
      ...
      const resp = yield (data.id ? jc(data.id, __spreadProps(__spreadValues({}, data), {
        name: `LEVEL ${bt().description} ${data.display_name}`
      })) : zc(__spreadProps(__spreadValues({}, data), {
        name: `LEVEL ${bt().description} ${data.display_name}`
      }))).toPromise().catch();
      if (resp.id)
...
var LevelManagementService = class _LevelManagementService {
  ...
  removeLevel(level) {
    return __async(this, null, function* () {
      ...
      yield Lc(level.id).toPromise().catch((e) => {
...
function LevelListComponent_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(7, "div", 15)(8, "icon", 16);
    \u0275\u0275text(9, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(14, "div", 15)(15, "icon", 17);
    ...
    \u0275\u0275elementStart(21, "div", 15)(22, "icon", 18);
    \u0275\u0275text(23, " delete ");
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LevelListComponent, { className: "LevelListComponent", filePath: "apps/concierge/src/app/level-manager/level-list.component.ts", lineNumber: 121 });
})();
...
//# sourceMappingURL=level-manager.module-MC6R24PA.js.map
