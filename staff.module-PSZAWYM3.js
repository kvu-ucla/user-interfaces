...
var NewStaffComponent = class _NewStaffComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewStaffComponent, selectors: [["", "app-new-staff", ""]], standalone: false, attrs: _c04, decls: 8, vars: 3, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "w-full"], [1, "h-0", "w-full", "flex-1"], ["class", "w-full", "mode", "indeterminate", 4, "ngIf"], ["mode", "indeterminate", 1, "w-full"]], template: function NewStaffComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "app-topbar");
...
var StaffComponent = class _StaffComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StaffComponent, selectors: [["", "app-staff", ""]], standalone: false, attrs: _c05, decls: 6, vars: 3, consts: [[1, "relative", "flex", "flex-1", "flex-col", "overflow-hidden"], [1, "w-full"], [1, "h-0", "w-full", "flex-1"], ["class", "w-full", "mode", "indeterminate", 4, "ngIf"], ["mode", "indeterminate", 1, "w-full"]], template: function StaffComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "sidebar");
...
//# sourceMappingURL=staff.module-PSZAWYM3.js.map
