...
var _POIModalComponent = class _POIModalComponent extends AsyncHandler {
  ...
  async save() {
    ...
    this.loading = true;
    const old_metadata = await hu(this._org.organisation.id, "points-of-interest", {}).toPromise();
    ...
    const resp = await du(this._org.organisation.id, {
...
var _POIManagementService = class _POIManagementService {
  ...
  async removePointOfInterest(poi) {
    ...
    await du(this._org.organisation.id, {
      name: "points-of-interest",
      details: metadata,
      description: ""
    }).toPromise().catch((e) => {
...
//# sourceMappingURL=poi-manager.module-WCJCL3MC.js.map
