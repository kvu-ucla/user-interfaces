import "./chunk-PN4NAE3K.js";
import "./chunk-GRKXRAGU.js";
import {
  SharedUsersModule
...
var ReportSpacesSpaceListing = class _ReportSpacesSpaceListing {
  ...
  static {
    this.\u0275fac = function ReportSpacesSpaceListing_Factory(__ngFactoryType__) {
...
var CustomReportComponent = class _CustomReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CustomReportComponent, selectors: [["custom-report"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [["class", "w-full h-full", 3, "src", 4, "ngIf"], [1, "w-full", "h-full", 3, "src"]], template: function CustomReportComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=reports.module-YWS3QVR7.js.map
