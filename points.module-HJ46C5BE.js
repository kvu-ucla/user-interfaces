...
var PointsTopbarComponent = class _PointsTopbarComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsTopbarComponent, selectors: [["points-topbar"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], ngContentSelectors: _c02, decls: 8, vars: 3, consts: [[1, "flex", "h-20", "items-center", "space-x-2", "bg-base-100", "px-8", "py-4"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], [1, "pl-2"]], template: function PointsTopbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275projectionDef();
...
var _c03 = () => ["/points-management", "new", "overview"];
var _c12 = () => ["/points-management", "new", "assets"];
...
var NewPointsComponent = class _NewPointsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewPointsComponent, selectors: [["placeos-new-points"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 17, vars: 14, consts: [["tabPanel", ""], [1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "relative", "z-10"], ["btn", "", "matRipple", "", "class", "w-40", 3, "click", 4, "ngIf"], [1, "mb-4", "px-8"], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", 3, "routerLink", "active"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"]], template: function NewPointsComponent_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(12, _c03))("active", ctx.page === "overview");
        \u0275\u0275advance();
...
var _c13 = (a0, a1) => ({ key: "type", name: a0, content: a1 });
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsAssetsComponent, selectors: [["points-assets"]], standalone: false, decls: 17, vars: 39, consts: [["type_template", ""], ["price_template", ""], ["bool_template", ""], ["discount_template", ""], ["action_template", ""], [1, "block", "w-full", "min-w-[32rem]", 3, "data", "columns", "sortable", "empty_message"], [1, "p-2"], [1, "rounded", "bg-base-200", "px-2", "py-1", "text-sm", "capitalize"], [1, "p-4", "font-mono", "text-xs"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "text-2xl", "text-white"], [1, "p-4", "text-right"], [1, "mx-auto", "flex", "items-center", "justify-end", "p-2"], ["icon", "", "matRipple", "", 3, "click"], [1, "text-error"]], template: function PointsAssetsComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("data", ctx.asset_list)("columns", \u0275\u0275pureFunction6(32, _c6, \u0275\u0275pureFunction1(16, _c04, \u0275\u0275pipeBind1(1, 4, "FORM.NAME")), \u0275\u0275pureFunction2(18, _c13, \u0275\u0275pipeBind1(2, 6, "COMMON.TYPE"), type_template_r8), \u0275\u0275pureFunction2(21, _c2, \u0275\u0275pipeBind1(3, 8, "APP.CONCIERGE.POINTS_PRICE"), price_template_r9), \u0275\u0275pureFunction2(24, _c3, \u0275\u0275pipeBind1(4, 10, "APP.CONCIERGE.POINTS_LABEL"), bool_template_r10), \u0275\u0275pureFunction2(27, _c4, \u0275\u0275pipeBind1(5, 12, "APP.CONCIERGE.POINTS_DISCOUNT"), discount_template_r11), \u0275\u0275pureFunction1(30, _c5, action_template_r12)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(6, 14, "APP.CONCIERGE.POINTS_ASSETS_EMPTY"));
      }
...
var _c05 = () => ["/points", "overview"];
var _c14 = () => ["/points", "assets"];
...
var PointsComponent = class _PointsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsComponent, selectors: [["placeos-points"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 13, vars: 13, consts: [[1, "relative", "flex", "w-full", "flex-col", "bg-base-200"], [1, "relative", "z-10"], ["btn", "", "matRipple", "", 3, "click", 4, "ngIf"], ["mat-tab-nav-bar", ""], ["mat-tab-link", "", 3, "routerLink", "active"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto"], ["btn", "", "matRipple", "", 3, "click"]], template: function PointsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "sidebar");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", ctx.page === "assets");
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(11, _c05))("active", ctx.page === "overview");
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 7, "APP.CONCIERGE.POINTS_TAB_OVERVIEW"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(12, _c14))("active", ctx.page === "assets");
        \u0275\u0275advance();
...
//# sourceMappingURL=points.module-HJ46C5BE.js.map
