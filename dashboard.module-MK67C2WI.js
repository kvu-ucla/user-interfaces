...
var DashboardAvailabilityComponent = class _DashboardAvailabilityComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardAvailabilityComponent, selectors: [["a-dashboard-availability"]], standalone: false, decls: 14, vars: 13, consts: [[1, "m-0", "font-medium", "text-xl"], [1, "flex", "flex-col", "items-center", "p-2", "bg-base-100", "shadow", "my-4", "rounded-lg"], [1, "flex", "items-center", "w-full", "mb-2"], ["free-levels", "", 1, "items", "space-y-2", "w-full"], ["btn", "", "matRipple", "", "class", "w-full", 3, "routerLink", "queryParams", 4, "ngFor", "ngForOf"], ["class", "text-black/30/30 text-sm mb-2", 4, "ngIf"], ["free-spaces", "", "class", "flex items-center flex-col rounded-lg bg-base-100 shadow my-4 p-2", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "w-full", 3, "routerLink", "queryParams"], [1, "max-w-full", "truncate"], [1, "text-black/30/30", "text-sm", "mb-2"], ["free-spaces", "", 1, "flex", "items-center", "flex-col", "rounded-lg", "bg-base-100", "shadow", "my-4", "p-2"], [1, "items", "space-y-2", "w-full"], ["class", "text-dark-fade text-sm mb-2", 4, "ngIf"], [1, "text-dark-fade", "text-sm", "mb-2"]], template: function DashboardAvailabilityComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var DashboardDeliveriesComponent = class _DashboardDeliveriesComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardDeliveriesComponent, selectors: [["dashboard-deliveries"]], standalone: false, decls: 6, vars: 2, consts: [["empty_state", ""], [1, "m-0", "my-2", "font-medium", "text-xl"], [1, "bg-base-100", "shadow", "p-2", "rounded"], ["class", "divide-y", 4, "ngIf", "ngIfElse"], [1, "divide-y"], ["class", "flex items-center py-2", 4, "ngFor", "ngForOf"], ["matRipple", "", 1, "w-full", "mt-2", 3, "click"], [1, "flex", "items-center", "py-2"], [1, "flex-1", "pl-2"], [1, ""], [1, "text-xs", "opacity-60"], [1, "m-4", "h-2", "w-2", "rounded-full"], [1, "p-8", "flex", "items-center", "justify-center", "opacity-40"]], template: function DashboardDeliveriesComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=dashboard.module-MK67C2WI.js.map
