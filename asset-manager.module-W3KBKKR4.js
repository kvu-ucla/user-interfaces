...
(() => {
  ...
  }] }, { type: AssetManagerStateService }, { type: MatDialogRef }], null);
})();
(() => {
...
(() => {
  ...
  }], () => [{ type: SpacesService }, { type: OrganisationService }, { type: MatDialog }, { type: SettingsService }], null);
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AssetBulkFormComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: AssetManagerStateService }, { type: ActivatedRoute }, { type: Router }, { type: OrganisationService }], null);
})();
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AssetGroupFormComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: AssetManagerStateService }, { type: ActivatedRoute }, { type: Router }, { type: MatDialog }], null);
})();
(() => {
...
(() => {
  ...
  }], () => [{ type: AssetManagerStateService }], null);
})();
(() => {
...
_AssetManagerTopbarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetManagerTopbarComponent, selectors: [["asset-manager-topbar"]], inputs: { active: "active" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 16, vars: 15, consts: [[1, "flex", "w-full", "items-center", "space-x-2", "bg-base-100", "px-8", "pb-2", "pt-4"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], ["appearance", "outline", 1, "no-subscript"], ["matPrefix", "", 1, "relative", "-left-1", "top-1", "text-2xl"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["btn", "", "matRipple", "", 1, "w-40", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "w-48", 3, "routerLink"], [1, "mb-2", "flex", "items-center", "space-x-2", "px-8"], [1, "flex", "items-center", "space-x-2", "px-4", "pb-2"], [1, "flex", "items-center", "rounded", "border", "border-secondary"], ["icon", "", "matRipple", "", 1, "h-12", "w-14", "rounded-l", "rounded-r-none", 3, "click", "matTooltip"], [1, "text-2xl"], ["icon", "", "matRipple", "", 1, "h-12", "w-14", "rounded-l-none", "rounded-r", 3, "click", "matTooltip"], [1, "flex-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "matTooltip"], ["appearance", "outline", 1, "no-subscript", "w-48"], [3, "ngModelChange", "ngModel", "placeholder"], [3, "value"]], template: function AssetManagerTopbarComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AssetManagerTopbarComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: AssetManagerStateService }, { type: OrganisationService }, { type: SettingsService }, { type: MatDialog }], { active: [{
    type: Input
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetManagerTopbarComponent, { className: "AssetManagerTopbarComponent", filePath: "apps/concierge/src/app/asset-manager/asset-manager-topbar.component.ts", lineNumber: 155 });
})();
...
(() => {
  ...
  }], () => [{ type: Router }, { type: AssetManagerStateService }], null);
})();
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AssetLocationModalComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: AssetManagerStateService }, { type: OrganisationService }], null);
})();
(() => {
...
(() => {
  ...
  }], () => [{ type: AssetManagerStateService }, { type: Router }], null);
})();
(() => {
...
function AssetRequestDetailsComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(95, 64, ctx_r1.request.extension_data == null ? null : ctx_r1.request.extension_data.tracking) || "In Storage", " ");
    \u0275\u0275advance(7);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AssetRequestDetailsComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: AssetManagerStateService }, { type: OrganisationService }, { type: SettingsService }], { request: [{
    type: Input
  }], requestChange: [{
    type: Output
  }] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetRequestDetailsComponent, { className: "AssetRequestDetailsComponent", filePath: "apps/concierge/src/app/asset-manager/asset-request-details.component.ts", lineNumber: 255 });
})();
...
(() => {
  ...
  }], () => [{ type: ActivatedRoute }, { type: Router }, { type: AssetManagerStateService }, { type: MatDialog }, { type: OrganisationService }], { _tooltip_el: [{
    type: ViewChild,
...
//# sourceMappingURL=asset-manager.module-W3KBKKR4.js.map
