...
function ParkingUserModalComponent_main_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "main", 9)(1, "div", 10);
    \u0275\u0275element(2, "a-user-search-field", 11);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div", 19)(19, "div", 20)(20, "label", 21);
    \u0275\u0275text(21, "Car Number Plate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "mat-form-field", 22);
    \u0275\u0275element(23, "input", 23);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "div", 20)(25, "label", 24);
    \u0275\u0275text(26, "Car Colour");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "mat-form-field", 22);
    \u0275\u0275element(28, "input", 25);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(29, "label", 26);
    \u0275\u0275text(30, "Notes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "mat-form-field", 15);
    \u0275\u0275element(32, "textarea", 27);
    \u0275\u0275elementEnd();
...
_ParkingUserModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingUserModalComponent, selectors: [["parking-user-modal"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 9, vars: 5, consts: () => {
  let i18n_0;
  if (false) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, ParkingUserModalComponent_button_4_Template, 3, 0, "button", 5);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, ParkingUserModalComponent_main_5_Template, 36, 1, "main", 6)(6, ParkingUserModalComponent_footer_6_Template, 5, 0, "footer", 7);
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingUserModalComponent, { className: "ParkingUserModalComponent", filePath: "apps/concierge/src/app/parking/parking-user-modal.component.ts", lineNumber: 134 });
})();
...
//# sourceMappingURL=chunk-3L66B2CS.js.map
