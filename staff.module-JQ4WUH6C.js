...
function EmergencyContactModalComponent_Conditional_5_For_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, EmergencyContactModalComponent_Conditional_5_For_46_Conditional_0_Template, 2, 2, "mat-option", 20);
  }
  if (rf & 2) {
...
function EmergencyContactModalComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(27, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "mat-form-field", 11)(29, "mat-select", 18);
    \u0275\u0275pipe(30, "translate");
    \u0275\u0275elementStart(31, "mat-option", 19);
    \u0275\u0275text(32);
    \u0275\u0275pipe(33, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(34, EmergencyContactModalComponent_Conditional_5_For_35_Template, 2, 2, "mat-option", 20, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(36, "async");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(37, "div", 9)(38, "label", 15);
    \u0275\u0275text(39);
    \u0275\u0275pipe(40, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "div", 13)(42, "mat-form-field", 21)(43, "mat-select", 22);
    \u0275\u0275pipe(44, "translate");
    \u0275\u0275repeaterCreate(45, EmergencyContactModalComponent_Conditional_5_For_46_Template, 1, 1, null, null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(47, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(48, "button", 23)(49, "icon");
    \u0275\u0275text(50, "add");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(30, 26, "COMMON.LEVEL_ALL"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(33, 28, "COMMON.LEVEL_ALL"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275repeater(((tmp_15_0 = \u0275\u0275pipeBind1(47, 36, ctx_r1.data)) == null ? null : tmp_15_0.roles) || \u0275\u0275pureFunction0(41, _c1));
    \u0275\u0275advance(3);
...
function EmergencyContactModalComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "footer", 6)(1, "button", 26);
...
function EmergencyContactModalComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 27)(1, "mat-form-field", 11)(2, "input", 28);
    \u0275\u0275pipe(3, "translate");
...
}, standalone: false, decls: 10, vars: 6, consts: [["role_form", ""], [1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "w-[36rem]", "p-4"], ["loading", "", 1, "flex", "h-64", "flex-col", "items-center", "justify-center"], [1, "flex", "items-center", "justify-end", "border-t", "border-base-200", "px-4", "py-2"], [3, "formGroup"], ["ngModel", "", 1, "mb-4", 3, "ngModelChange", "ngModelOptions"], [1, "flex", "flex-col"], ["for", "name"], ["appearance", "outline"], ["matInput", "", "formControlName", "name", "placeholder", "Full name"], [1, "flex", "items-center", "space-x-4"], [1, "flex", "flex-1", "flex-col"], ["for", "email"], ["matInput", "", "formControlName", "email", "type", "email", 3, "placeholder"], ["matInput", "", "formControlName", "phone", "type", "tel", 3, "placeholder"], ["formControlName", "zone", 3, "placeholder"], ["value", ""], [3, "value"], ["appearance", "outline", 1, "no-subscript", "flex-1"], ["multiple", "", "formControlName", "roles", 3, "placeholder"], ["btn", "", "matRipple", "", "customTooltip", "", 1, "space-x-2", 3, "content"], [1, "pr-2"], [1, "mb-4", 3, "diameter"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "rounded", "bg-base-100", "p-4"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"]], template: function EmergencyContactModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, EmergencyContactModalComponent_Conditional_5_Template, 54, 42, "main", 4)(6, EmergencyContactModalComponent_Conditional_6_Template, 5, 4, "main", 5);
...
(() => {
  ...
  }] }, { type: MatDialogRef }, { type: OrganisationService }], { _tooltip: [{
    type: ViewChild,
    args: [CustomTooltipComponent]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmergencyContactModalComponent, { className: "EmergencyContactModalComponent", filePath: "apps/concierge/src/app/staff/emergency-contact-modal.component.ts", lineNumber: 194 });
})();
...
}, standalone: false, decls: 18, vars: 10, consts: [["role_form", ""], [1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "h-[32rem]", "max-h-[65vh]", "min-w-[28rem]", "overflow-y-auto"], [1, "hover:bg-base-200:bg-base-300", "m-2", "flex", "items-center", "space-x-2", "rounded", "border", "border-base-200", "p-2"], [1, "border-t", "border-base-200"], ["btn", "", "matRipple", "", "customTooltip", "", 1, "m-2", "flex", "w-[calc(100%-1rem)]", "items-center", "justify-center", "space-x-2", 3, "click", "content"], [1, "truncate", "pl-2"], [1, "text-2xl"], [1, "flex-1", "truncate", "px-2"], ["icon", "", "matRipple", "", "customTooltip", "", 1, "h-12", "w-12", "rounded", "border", "border-secondary", "text-secondary", 3, "click", "content"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "border", "border-error", "text-error", 3, "click"], [1, "rounded", "bg-base-100", "p-4"], ["appearance", "outline"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"]], template: function RoleManagementModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "header", 1)(1, "h2", 2);
    \u0275\u0275text(2);
    ...
    \u0275\u0275repeaterCreate(6, RoleManagementModalComponent_For_7_Template, 9, 2, "div", 5, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(8, "async");
    \u0275\u0275elementEnd();
...
}, dependencies: [DefaultValueAccessor, NgControlStatus, NgModel, MatFormField, MatInput, MatDialogClose, MatRipple, IconComponent, CustomTooltipComponent, AsyncPipe, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(RoleManagementModalComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: OrganisationService }, { type: MatDialogRef }], { _tooltip: [{
    type: ViewChild,
    args: [CustomTooltipComponent]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoleManagementModalComponent, { className: "RoleManagementModalComponent", filePath: "apps/concierge/src/app/staff/role-management-modal.component.ts", lineNumber: 87 });
})();
...
_EmergencyContactsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmergencyContactsComponent, selectors: [["", "app-emergency-contacts", ""]], standalone: false, attrs: _c02, decls: 51, vars: 52, consts: [["person_template", ""], ["roles_template", ""], ["zone_template", ""], ["actions_template", ""], [1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], ["topbar", "", 1, "flex", "flex-col", "px-8", "py-4"], [1, "flex", "items-center", "justify-between"], [1, "text-2xl", "font-medium"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["btn", "", "matRipple", "", 1, "space-x-2", 3, "click"], [1, "text-2xl"], [1, "pr-2"], [1, "mt-2", "flex", "items-center", "justify-between", "py-2"], [3, "ngModelChange", "ngModel", "placeholder"], ["value", ""], [3, "value"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "matTooltip"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], [1, "block", "min-w-[52rem]", "text-sm", 3, "data", "filter", "empty_message", "columns", "sortable"], [1, "h-12", "w-full"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "flex", "flex-wrap", "p-2"], [1, "m-1", "rounded-2xl", "bg-info", "px-2", "py-1", "font-mono", "text-xs", "text-info-content"], [1, "p-4"], [1, "flex", "w-full", "items-center", "justify-end", "space-x-2", "p-2"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click", "matTooltip"]], template: function EmergencyContactsComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275pipe(27, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(28, EmergencyContactsComponent_For_29_Template, 2, 2, "mat-option", 19, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(30, "async");
    \u0275\u0275elementEnd()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EmergencyContactsComponent, [{
    ...
    `, standalone: false, styles: ["/* angular:styles/component:css;08c828c36224658230d6844bbbe8551e02a5c30c320aa5e48c90063783b9b8fa;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/staff/emergency-contacts.component.ts */\n:host {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: 100%;\n  background-color: var(--b1);\n}\n/*# sourceMappingURL=emergency-contacts.component.css.map */\n"] }]
  }], () => [{ type: OrganisationService }, { type: MatDialog }, { type: Clipboard }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmergencyContactsComponent, { className: "EmergencyContactsComponent", filePath: "apps/concierge/src/app/staff/emergency-contacts.component.ts", lineNumber: 225 });
})();
...
_StaffDetailsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StaffDetailsComponent, selectors: [["staff-details"]], inputs: { user: "user", onsite: "onsite" }, standalone: false, decls: 1, vars: 1, consts: [["details", "", 1, "flex", "w-full", "items-center", "border-b", "border-base-200", "bg-base-100", "px-4", "py-2", "hover:opacity-80"], [3, "user"], [1, "flex", "flex-1", "flex-col"], [1, "px-2"], [1, "px-2", "text-xs", "text-opacity-50"], [1, "px-4", "text-xs", "opacity-50"], [1, "flex", "items-center"], [3, "click", "matTooltip", "loading", "content"], ["icon", "", "matRipple", "", 3, "matTooltip", "href"]], template: function StaffDetailsComponent_Template(rf, ctx) {
  if (rf & 1) {
...
}, dependencies: [MatTooltip, MatRipple, ActionIconComponent, IconComponent, UserAvatarComponent, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaffDetailsComponent, { className: "StaffDetailsComponent", filePath: "apps/concierge/src/app/staff/staff-details.component.ts", lineNumber: 67 });
})();
...
}, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 10, vars: 6, consts: [["container", ""], [1, "flex", "w-full", "items-center", "justify-center", "p-2"], ["letter", "", 1, "flex", "h-6", "w-6", "cursor-pointer", "items-center", "justify-center", "text-xs", "capitalize", 3, "disabled", "active"], [1, "relative", "w-full", "flex-1", "overflow-auto", "bg-base-200", 2, "height", "50%", 3, "scroll"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center"], ["mode", "indeterminate"], ["letter", "", 1, "flex", "h-6", "w-6", "cursor-pointer", "items-center", "justify-center", "text-xs", "capitalize", 3, "click"], ["group", "", 1, "sticky", "top-0", "z-10", "border-b", "bg-base-200", "text-sm", "font-medium", "capitalize", 3, "id"], [3, "id", "user", "onsite"]], template: function StaffListingComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(StaffListingComponent, [{
    ...
    `, standalone: false, styles: ["/* angular:styles/component:css;94a94c12bcee17d4e5d214b11fe8feaa74e59a28a2b0847c7f81fc8b2e6494ed;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/staff/staff-listing.component.ts */\n:host {\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  height: 50%;\n}\n[letter] {\n  transition: font-size 200ms, color 200ms;\n}\n[group] {\n  border-color: #ccc;\n  padding: 0.5rem 1.65rem;\n}\n.disabled {\n  opacity: 0.2;\n  pointer-events: none;\n}\n.active {\n  font-size: 1.25rem;\n  opacity: 1;\n  color: #d81b60;\n}\n/*# sourceMappingURL=staff-listing.component.css.map */\n"] }]
  }], () => [{ type: StaffStateService }], { _el: [{
    type: ViewChild,
    args: ["container"]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaffListingComponent, { className: "StaffListingComponent", filePath: "apps/concierge/src/app/staff/staff-listing.component.ts", lineNumber: 106 });
})();
...
_StaffTopbarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StaffTopbarComponent, selectors: [["staff-topbar"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 14, vars: 12, consts: [[1, "flex", "h-20", "items-center", "space-x-2", "border-b", "border-base-200", "bg-base-100", "px-4"], ["appearance", "outline"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [1, "m-2", 3, "ngModelChange", "ngModel"], [1, "text-xs"], [1, "w-2", "flex-1"], [1, "mr-2", 3, "modelChange"]], template: function StaffTopbarComponent_Template(rf, ctx) {
  if (rf & 1) {
...
}, dependencies: [NgControlStatus, NgModel, SearchbarComponent, MatFormField, MatSelect, MatOption, MatSlideToggle, AsyncPipe, TranslatePipe], styles: ["\n\nmat-form-field[_ngcontent-%COMP%] {\n  height: 3.25em;\n  width: 8em;\n}\n/*# sourceMappingURL=staff-topbar.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(StaffTopbarComponent, [{
    ...
    `, standalone: false, styles: ["/* angular:styles/component:css;598beeb1039b1ab45f9544c34b6ccfd79f95c38cdc3862574ac547cac62c7acc;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/staff/staff-topbar.component.ts */\nmat-form-field {\n  height: 3.25em;\n  width: 8em;\n}\n/*# sourceMappingURL=staff-topbar.component.css.map */\n"] }]
  }], () => [{ type: StaffStateService }, { type: OrganisationService }, { type: ActivatedRoute }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaffTopbarComponent, { className: "StaffTopbarComponent", filePath: "apps/concierge/src/app/staff/staff-topbar.component.ts", lineNumber: 54 });
})();
...
_StaffComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StaffComponent, selectors: [["", "app-new-staff", ""]], standalone: false, attrs: _c04, decls: 8, vars: 3, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "w-full"], [1, "h-0", "w-full", "flex-1"], ["mode", "indeterminate", 1, "w-full"]], template: function StaffComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-topbar");
...
}, dependencies: [ApplicationTopbarComponent, ApplicationSidebarComponent, MatProgressBar, StaffTopbarComponent, StaffListingComponent, AsyncPipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: 100%;\n  background-color: var(--b1);\n}\n/*# sourceMappingURL=staff.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(StaffComponent, [{
    ...
    `, standalone: false, styles: ["/* angular:styles/component:css;08c828c36224658230d6844bbbe8551e02a5c30c320aa5e48c90063783b9b8fa;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/staff/staff.component.ts */\n:host {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: 100%;\n  background-color: var(--b1);\n}\n/*# sourceMappingURL=staff.component.css.map */\n"] }]
  }], () => [{ type: StaffStateService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaffComponent, { className: "StaffComponent", filePath: "apps/concierge/src/app/staff/staff.component.ts", lineNumber: 36 });
})();
...
//# sourceMappingURL=staff.module-JQ4WUH6C.js.map
