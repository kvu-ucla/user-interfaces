...
function BookingDetailsModalComponent_div_10_button_1_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29)(1, "app-icon");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function BookingDetailsModalComponent_div_10_button_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, BookingDetailsModalComponent_div_10_button_1_div_1_Template, 5, 2, "div", 28)(2, BookingDetailsModalComponent_div_10_button_1_ng_template_2_Template, 1, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function BookingDetailsModalComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, BookingDetailsModalComponent_div_10_button_1_Template, 4, 7, "button", 25);
...
function BookingDetailsModalComponent_ng_container_36_div_5_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 45)(1, "div", 46)(2, "span", 39);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
...
function BookingDetailsModalComponent_ng_container_36_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 40)(7, "app-icon");
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275template(13, BookingDetailsModalComponent_ng_container_36_div_5_div_13_Template, 6, 2, "div", 44);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function BookingDetailsModalComponent_ng_container_36_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(5, BookingDetailsModalComponent_ng_container_36_div_5_Template, 14, 21, "div", 35);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Assets (", (ctx_r1.booking.valid_assets == null ? null : ctx_r1.booking.valid_assets.length) || 0, ") ");
    \u0275\u0275advance(2);
...
function BookingDetailsModalComponent_ng_container_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "interactive-map", 48);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function BookingDetailsModalComponent_button_44_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 50)(2, "app-icon");
    \u0275\u0275text(3, "edit");
    \u0275\u0275elementEnd();
...
function BookingDetailsModalComponent_button_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 50)(2, "app-icon", 52);
    \u0275\u0275text(3, " height ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div");
    \u0275\u0275text(5, "Set Desk Height");
    \u0275\u0275elementEnd()()();
  }
}
function BookingDetailsModalComponent_button_46_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 50)(2, "app-icon", 53);
    \u0275\u0275text(3, "delete");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div");
    \u0275\u0275text(5, "Delete booking");
    \u0275\u0275elementEnd()()();
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingDetailsModalComponent, selectors: [["booking-details-modal"]], outputs: { edit: "edit", remove: "remove", end: "end" }, decls: 49, vars: 24, consts: [["menu", "matMenu"], ["loading_state", ""], [1, "w-[100vw]", "h-[100vh]", "sm:relative", "sm:inset-auto", "sm:w-[51rem]", "sm:h-auto", "sm:max-h-[80vh]", "bg-base-100", "sm:bg-base-200", "sm:rounded", "overflow-auto", "space-y-2", "pb-2"], [1, "sm:flex", "flex-col", "items-center", "pb-4", "max-h-screen", "sm:max-h-[80vh]", "sm:px-16", "sm:border-b", "bg-base-100", "border-base-200"], ["class", "h-8 w-full sm:hidden block", 4, "ngIf"], ["class", "bg-neutral w-full h-64 sm:rounded-b overflow-hidden", 4, "ngIf"], ["title", "", 1, "px-3", "mt-2", "text-xl", "font-medium", "w-full"], [1, "sm:flex", "items-center", "justify-between", "w-full"], [1, "flex", "m-2"], [3, "status"], ["actions", "", "class", "flex items-center space-x-2 px-2", 4, "ngIf"], [1, "sm:flex", "flex-wrap", "sm:px-12"], [1, "sm:p-4", "sm:bg-base-100", "rounded", "sm:m-2", "sm:border", "border-base-200", "flex-grow-[4]", "min-w-1/3", "sm:w-[16rem]"], [1, "px-3", "mt-2", "text-lg", "font-medium", "mb-2"], [1, "flex", "items-center", "px-2", "space-x-2"], [4, "ngIf"], ["map", "", 1, "mt-4", "sm:my-2", "h-64", "sm:h-48", "relative", "border", "border-base-200", "overflow-hidden", "rounded", "sm:bg-base-100", "m-2", "flex-grow-[3]", "min-w-1/3", "w-[calc(100%-1rem)]", "p-2", "sm:w-[16rem]", 3, "click"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 1, "absolute", "top-0", "left-2", "bg-neutral", "text-white"], ["xPosition", "before"], ["mat-menu-item", "", "mat-dialog-close", "", 3, "click", 4, "ngIf"], ["mat-menu-item", "", 3, "click", 4, "ngIf"], [1, "h-8", "w-full", "sm:hidden", "block"], [1, "bg-neutral", "w-full", "h-64", "sm:rounded-b", "overflow-hidden"], [1, "w-full", "h-64", 3, "images"], ["actions", "", 1, "flex", "items-center", "space-x-2", "px-2"], ["btn", "", "matRipple", "", "class", "flex-1 h-10 border-none", 3, "bg-success", "text-success-content", "disabled", "click", 4, "ngIf"], ["icon", "", "matRipple", "", 1, "bg-secondary", "rounded", "text-white", "h-12", "w-12", 3, "matMenuTriggerFor"], ["btn", "", "matRipple", "", 1, "flex-1", "h-10", "border-none", 3, "click", "disabled"], ["class", "flex items-center space-x-2 justify-center", 4, "ngIf", "ngIfElse"], [1, "flex", "items-center", "space-x-2", "justify-center"], [1, "mr-4"], [1, "mx-auto", 3, "diameter"], [1, "mt-4", "sm:p-4", "sm:bg-base-100", "rounded", "sm:m-2", "sm:border", "border-base-200", "flex-grow-[3]", "min-w-1/3", "sm:w-[16rem]"], [1, "mx-3", "py-2", "text-lg", "font-medium"], [1, "flex", "flex-col", "space-y-2"], ["request", "", "class", "border border-base-300 bg-base-100 rounded-xl overflow-hidden", 4, "ngFor", "ngForOf"], ["request", "", 1, "border", "border-base-300", "bg-base-100", "rounded-xl", "overflow-hidden"], ["matRipple", "", 1, "flex", "items-center", "space-x-2", "p-3", "w-full", 3, "click"], [1, "flex-1", "text-left"], [1, "text-sm"], [1, "flex", "items-center", "justify-center", "rounded-full", "w-8", "h-8", 3, "matTooltip"], [1, "flex", "items-center", "justify-center", "rounded-full", "w-8", "h-8"], [1, "text-2xl"], [1, "flex", "flex-col", "bg-base-200", "divide-y", "divide-base-100"], ["class", "flex items-center px-3 py-1 space-x-2 hover:opacity-90", 4, "ngFor", "ngForOf"], [1, "flex", "items-center", "px-3", "py-1", "space-x-2", "hover:opacity-90"], [1, "flex", "items-center", "flex-1"], [1, "rounded", "bg-success", "text-success-content", "text-xs", "px-2", "py-1"], [1, "pointer-events-none", 3, "src", "features", "options"], ["mat-menu-item", "", "mat-dialog-close", "", 3, "click"], [1, "flex", "items-center", "space-x-2", "text-base"], ["mat-menu-item", "", 3, "click"], ["className", "material-symbols-rounded"], [1, "text-error"]], template: function BookingDetailsModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(14, "Details");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(15, "div", 14)(16, "app-icon");
        \u0275\u0275text(17, "event");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275pipe(20, "date");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(21, "div", 14)(22, "app-icon");
        \u0275\u0275text(23, "schedule");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(24, "div");
        \u0275\u0275text(25);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(26, "div", 14)(27, "app-icon");
        \u0275\u0275text(28, "map");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(29, "div");
        \u0275\u0275text(30);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(31, "div", 14)(32, "app-icon");
        \u0275\u0275text(33, "place");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(34, "div");
        \u0275\u0275text(35);
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(36, BookingDetailsModalComponent_ng_container_36_Template, 6, 2, "ng-container", 15);
        ...
        \u0275\u0275template(38, BookingDetailsModalComponent_ng_container_38_Template, 2, 4, "ng-container", 15);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(39, "button", 17)(40, "app-icon");
        \u0275\u0275text(41, "close");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(42, "mat-menu", 18, 0);
        \u0275\u0275template(44, BookingDetailsModalComponent_button_44_Template, 6, 0, "button", 19)(45, BookingDetailsModalComponent_button_45_Template, 6, 0, "button", 20)(46, BookingDetailsModalComponent_button_46_Template, 6, 0, "button", 20)(47, BookingDetailsModalComponent_button_47_Template, 6, 0, "button", 20)(48, BookingDetailsModalComponent_button_48_Template, 6, 0, "button", 20);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingDetailsModalComponent, { className: "BookingDetailsModalComponent", filePath: "libs/bookings/src/lib/booking-details-modal.component.ts", lineNumber: 330 });
})();
...
function DeskDetailsComponent_ng_container_0_section_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "Facilities");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, DeskDetailsComponent_ng_container_0_section_31_div_3_Template, 3, 1, "div", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function DeskDetailsComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div", 11)(27, "app-icon");
    \u0275\u0275text(28, "place");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "p");
    \u0275\u0275text(30);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(31, DeskDetailsComponent_ng_container_0_section_31_Template, 4, 2, "section", 12)(32, DeskDetailsComponent_ng_container_0_section_32_Template, 2, 5, "section", 13);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(35, "div", 16)(36, "app-icon", 17);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "p");
    \u0275\u0275text(39);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.active ? "Remove from booking" : "Add to booking", " ");
  }
}
function DeskDetailsComponent_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25)(1, "p", 26);
    \u0275\u0275text(2, " Select a desk to view it's details ");
    \u0275\u0275elementEnd()();
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskDetailsComponent, { className: "DeskDetailsComponent", filePath: "libs/bookings/src/lib/desk-select-modal/desk-details.component.ts", lineNumber: 157 });
})();
...
function DeskFiltersComponent_mat_form_field_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, DeskFiltersComponent_mat_form_field_13_mat_option_2_Template, 2, 2, "mat-option", 25);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DeskFiltersComponent_mat_form_field_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(5, DeskFiltersComponent_mat_form_field_15_mat_option_5_Template, 2, 2, "mat-option", 25);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DeskFiltersComponent_mat_form_field_17_mat_option_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, DeskFiltersComponent_mat_form_field_17_mat_option_3_div_2_Template, 5, 3, "div", 30);
...
function DeskFiltersComponent_mat_form_field_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, DeskFiltersComponent_mat_form_field_17_mat_option_3_Template, 5, 3, "mat-option", 25);
    \u0275\u0275pipe(4, "async");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DeskFiltersComponent_section_36_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "Type");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, DeskFiltersComponent_section_36_div_3_Template, 5, 7, "div", 40);
    \u0275\u0275pipe(4, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var DeskFiltersComponent = class _DeskFiltersComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskFiltersComponent, selectors: [["desk-filters"]], inputs: { hide_levels: "hide_levels" }, decls: 39, vars: 34, consts: [[1, "flex", "rounded-t-md", "items-center", "border-b", "border-base-200", "pb-2", "sm:hidden"], [1, "flex-1", "pl-2"], ["icon", "", "matRipple", "", "name", "close-desk-filters", "class", "sm:hidden", 3, "click", 4, "ngIf"], [1, "font-medium", "flex-2", "text-center"], [1, "flex-1"], [1, "max-h-[65vh]", "p-2", "overflow-y-auto", "overflow-x-hidden", "divide-y", "divide-base-200", "w-full", "max-w-[100vw]", "sm:max-w-[30vw]", 3, "formGroup"], ["details", ""], [1, "text-lg", "font-medium", "mb-1"], [1, "flex-1", "min-w-[8rem]", "flex", "flex-col"], ["for", "location"], ["appearance", "outline", "class", "w-full", 4, "ngIf"], [1, "flex-1", "min-w-[256px]"], ["name", "date", 3, "ngModelChange", "ngModel", "ngModelOptions", "to", "timezone"], ["class", "flex justify-end -mt-2 mb-2", 4, "ngIf"], ["class", "flex items-center space-x-2", 4, "ngIf"], ["favs", "", 1, "space-y-2", "pb-4"], [1, "text-lg", "font-medium"], [1, "flex", "items-center"], ["for", "fav", 1, "flex-1", "w-1/2"], ["name", "fav", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["class", "space-y-2", "features", "", 4, "ngIf"], ["class", "px-2 py-2 w-full border-t border-base-200", 4, "ngIf"], ["icon", "", "matRipple", "", "name", "close-desk-filters", 1, "sm:hidden", 3, "click"], ["appearance", "outline", 1, "w-full"], ["name", "region", "placeholder", "Any Region", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["name", "building", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["name", "location", "placeholder", "Any Level", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "flex", "flex-col-reverse"], ["class", "opacity-30 text-xs", 4, "ngIf"], [1, "opacity-30", "text-xs"], [1, "opacity-0"], [1, "flex", "justify-end", "-mt-2", "mb-2"], ["formControlName", "all_day"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1", "w-1/3"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "use_24hr", "timezone"], ["formControlName", "duration", 3, "time", "max", "min", "step", "use_24hr", "timezone"], ["features", "", 1, "space-y-2"], ["class", "flex items-center flex-wrap space-x-2", 4, "ngFor", "ngForOf"], [1, "flex", "items-center", "flex-wrap", "space-x-2"], ["for", "feat", 1, "flex-1", "w-1/2"], [3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "px-2", "py-2", "w-full", "border-t", "border-base-200"], ["btn", "", "matRipple", "", "name", "apply-desk-filters", 1, "w-full", 3, "click"]], template: function DeskFiltersComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1);
        \u0275\u0275template(2, DeskFiltersComponent_button_2_Template, 3, 0, "button", 2);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(3, "h3", 3);
        \u0275\u0275text(4, "Desk Filters");
        \u0275\u0275elementEnd();
        \u0275\u0275element(5, "div", 4);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(12, "Location");
        \u0275\u0275elementEnd();
        \u0275\u0275template(13, DeskFiltersComponent_mat_form_field_13_Template, 4, 6, "mat-form-field", 10);
        \u0275\u0275pipe(14, "async");
        \u0275\u0275template(15, DeskFiltersComponent_mat_form_field_15_Template, 7, 13, "mat-form-field", 10);
        \u0275\u0275pipe(16, "async");
        \u0275\u0275template(17, DeskFiltersComponent_mat_form_field_17_Template, 5, 8, "mat-form-field", 10);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275pipe(23, "translate");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(24, DeskFiltersComponent_div_24_Template, 3, 0, "div", 13)(25, DeskFiltersComponent_div_25_Template, 9, 11, "div", 14);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(36, DeskFiltersComponent_section_36_Template, 5, 3, "section", 20);
        \u0275\u0275pipe(37, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(38, DeskFiltersComponent_div_38_Template, 3, 0, "div", 21);
      }
      if (rf & 2) {
        let tmp_2_0;
        let tmp_3_0;
        ...
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(29, 24, "COMMON.FAVOURITES"), " ");
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(33, 26, "DESKS.SHOW_FAVOURITES"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngModel", (tmp_14_0 = \u0275\u0275pipeBind1(35, 28, ctx.options)) == null ? null : tmp_14_0.show_fav)("ngModelOptions", \u0275\u0275pureFunction0(33, _c04));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", (tmp_16_0 = \u0275\u0275pipeBind1(37, 30, ctx.features)) == null ? null : tmp_16_0.length);
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", ctx.can_close);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskFiltersComponent, { className: "DeskFiltersComponent", filePath: "libs/bookings/src/lib/desk-select-modal/desk-filters.component.ts", lineNumber: 235 });
})();
...
var DeskFiltersDisplayComponent = class _DeskFiltersDisplayComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskFiltersDisplayComponent, selectors: [["desk-filters-display"]], inputs: { view: "view" }, outputs: { viewChange: "viewChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 19, vars: 17, consts: [["actions", "", 1, "sm:hidden", "space-x-2", "flex", "flex-row", "items-center", "p-2"], ["btn", "", "matRipple", "", "name", "edit-desk-filters", 1, "flex-1", "w-1/2", 3, "click"], [1, "flex", "items-center"], ["btn", "", "matRipple", "", "name", "view-desk-map", 1, "rounded-l", "rounded-r-none", 3, "click"], ["btn", "", "matRipple", "", "name", "view-desk-list", 1, "rounded-r", "rounded-l-none", 3, "click"], ["filters", "", 1, "flex", "items-center", "flex-wrap", "p-2", "w-[35rem]", "max-w-full", "sm:max-w-[35rem]"], ["filter-item", "", "date", ""], ["filter-item", "", "time", ""], [4, "ngIf"], ["filter-item", "", "features", "", 4, "ngFor", "ngForOf"], ["filter-item", "", 4, "ngIf"], ["filter-item", "", "features", ""], ["icon", "", "matRipple", "", "name", "remove-desk-filter", 1, "-mr-4", 3, "click"], ["filter-item", ""], ["icon", "", "matRipple", "", "name", "remove-desk-favs-filter", 1, "-mr-4", 3, "click"]], template: function DeskFiltersDisplayComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(13, DeskFiltersDisplayComponent_ng_container_13_Template, 4, 8, "ng-container", 8)(14, DeskFiltersDisplayComponent_ng_container_14_Template, 2, 0, "ng-container", 8);
        \u0275\u0275elementEnd();
        \u0275\u0275template(15, DeskFiltersDisplayComponent_div_15_Template, 6, 1, "div", 9);
        \u0275\u0275pipe(16, "async");
        \u0275\u0275template(17, DeskFiltersDisplayComponent_div_17_Template, 6, 0, "div", 10);
        \u0275\u0275pipe(18, "async");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskFiltersDisplayComponent, { className: "DeskFiltersDisplayComponent", filePath: "libs/bookings/src/lib/desk-select-modal/desk-filters-display.component.ts", lineNumber: 115 });
})();
...
function DeskListComponent_ng_container_5_ul_1_li_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, DeskListComponent_ng_container_5_ul_1_li_1_div_3_Template, 3, 0, "div", 12)(4, DeskListComponent_ng_container_5_ul_1_li_1_img_4_Template, 1, 1, "img", 13)(5, DeskListComponent_ng_container_5_ul_1_li_1_ng_template_5_Template, 1, 0, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
...
function DeskListComponent_ng_container_5_ul_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, DeskListComponent_ng_container_5_ul_1_li_1_Template, 18, 10, "li", 8);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DeskListComponent_ng_container_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, DeskListComponent_ng_container_5_ul_1_Template, 3, 3, "ul", 6);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskListComponent, selectors: [["desk-list"]], inputs: { active: "active", selected: "selected", favorites: "favorites" }, outputs: { onSelect: "onSelect", toggleFav: "toggleFav" }, decls: 11, vars: 7, consts: [["load_state", ""], ["empty_state", ""], ["placeholder", ""], [1, "font-bold"], ["count", "", 1, "text-sm", "opacity-60", "mb-4"], [4, "ngIf", "ngIfElse"], ["class", "list-style-none space-y-2", 4, "ngIf", "ngIfElse"], [1, "list-style-none", "space-y-2"], ["desk", "", "class", "relative rounded-lg w-full shadow border bg-base-100 border-base-200 overflow-hidden", 3, "!border-info", 4, "ngFor", "ngForOf"], ["desk", "", 1, "relative", "rounded-lg", "w-full", "shadow", "border", "bg-base-100", "border-base-200", "overflow-hidden"], ["name", "select-desk", "matRipple", "", 1, "w-full", "h-full", "flex", "p-2", 3, "click"], [1, "relative", "w-20", "h-20", "rounded-xl", "bg-base-200", "mr-4", "flex", "items-center", "justify-center"], ["class", "absolute top-1 left-1 border border-neutral bg-base-200 rounded-full h-6 w-6 flex items-center justify-center text-white", 4, "ngIf"], ["auth", "", "class", "object-cover h-full", 3, "source", 4, "ngIf", "ngIfElse"], [1, "space-y-2", "pt-2", "flex-1", "text-left"], [1, "font-medium"], [1, "flex", "items-center", "text-sm", "space-x-2"], [1, "text-info"], [1, "text-xs"], ["icon", "", "matRipple", "", "name", "toggle-desk-favourite", 1, "absolute", "top-1", "right-1", 3, "click"], [1, "absolute", "top-1", "left-1", "border", "border-neutral", "bg-base-200", "rounded-full", "h-6", "w-6", "flex", "items-center", "justify-center", "text-white"], ["auth", "", 1, "object-cover", "h-full", 3, "source"], ["src", "assets/icons/desk-placeholder.svg", 1, "m-auto"], ["loading", "", 1, "p-16", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"], [1, "opacity-30"], ["empty", "", 1, "p-16", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "opacity-30", "text-center"]], template: function DeskListComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(4, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, DeskListComponent_ng_container_5_Template, 3, 4, "ng-container", 5);
        \u0275\u0275pipe(6, "async");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", ((tmp_2_0 = \u0275\u0275pipeBind1(4, 3, ctx.desks)) == null ? null : tmp_2_0.length) || 0, " result(s) found ");
        \u0275\u0275advance(2);
...
var DeskMapComponent = class _DeskMapComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskMapComponent, selectors: [["desk-map"]], inputs: { is_displayed: "is_displayed", active: "active" }, outputs: { onSelect: "onSelect" }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 8, vars: 17, consts: [[1, "bg-base-100", "p-2", "border-b", "border-base-200", "w-full"], ["levels", "", "appearance", "outline", "class", "w-full", 4, "ngIf"], [1, "relative", "flex-1", "w-full"], [3, "zoomChange", "centerChange", "src", "zoom", "center", "styles", "features", "actions", "options"], ["levels", "", "appearance", "outline", 1, "w-full"], ["name", "location", "placeholder", "Any Level", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "opacity-30 text-xs", 4, "ngIf"], [1, "opacity-30", "text-xs"], [1, "opacity-0"]], template: function DeskMapComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskMapComponent, { className: "DeskMapComponent", filePath: "libs/bookings/src/lib/desk-select-modal/desk-map.component.ts", lineNumber: 80 });
})();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskSelectModalComponent, selectors: [["desk-select-modal"]], decls: 39, vars: 27, consts: [["map_view", ""], [1, "w-[100vw]", "h-[100vh]", "sm:relative", "sm:w-auto", "sm:h-auto", "flex", "flex-col", "bg-base-100"], [1, "flex", "items-center", "space-x-4", "w-full"], ["icon", "", "mat-dialog-close", "", 1, "bg-base-200"], [1, "hidden", "sm:flex", "items-center", "justify-end", "flex-1"], ["btn", "", "matRipple", "", "name", "view-desk-map", 1, "rounded-l", "rounded-r-none", 3, "click"], ["btn", "", "matRipple", "", "name", "view-desk-list", 1, "rounded-r", "rounded-l-none", 3, "click"], [1, "flex", "items-center", "divide-x", "divide-base-200", "h-[65vh]", "w-[calc(100vw-4rem)]", "overflow-hidden"], [1, "h-full", "hidden", "sm:flex", "max-w-[20rem]", "sm:h-[65vh]", "sm:max-h-full", 3, "hide_levels"], [1, "flex", "flex-col", "items-center", "flex-1", "w-1/2", "h-full", "sm:h-[65vh]"], [1, "w-full", "border-b", "border-base-200", 3, "viewChange", "view"], ["class", "flex-1 h-1/2 bg-base-200", 3, "active", "selected", "favorites", "toggleFav", "onSelect", 4, "ngIf", "ngIfElse"], [1, "h-full", "w-full", "sm:h-[65vh]", "absolute", "sm:relative", "sm:flex", "sm:max-w-[20rem]", "z-20", "bg-base-100", "block", 3, "activeChange", "toggleFav", "close", "desk", "active", "hide_map", "fav"], [1, "flex", "sm:hidden", "flex-col-reverse", "items-center", "justify-end", "px-2", "pt-2", "pb-[5.5rem]", "border-t", "border-base-200", "w-full"], ["btn", "", "matRipple", "", "name", "desk-return", "class", "inverse sm:hidden w-full", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", "name", "save-desks", 1, "w-full", "sm:w-32", "sm:mb-0", 3, "mat-dialog-close"], [1, "hidden", "sm:flex", "items-center", "justify-between", "p-2", "border-t", "border-base-200", "w-full"], ["btn", "", "matRipple", "", "name", "desk-return", 1, "clear", "text-secondary", 3, "mat-dialog-close"], [1, "flex", "items-center"], [1, "text-xl"], [1, "mr-1", "underline"], [1, "opacity-60", "text-sm"], ["btn", "", "matRipple", "", "name", "toggle-desk", 3, "click", "disabled"], [1, "mr-1"], [1, "flex-1", "h-1/2", "bg-base-200", 3, "toggleFav", "onSelect", "active", "selected", "favorites"], ["btn", "", "matRipple", "", "name", "desk-return", 1, "inverse", "sm:hidden", "w-full", 3, "click"], [1, "flex-1", "h-1/2", "w-full", 3, "onSelect", "is_displayed", "active"]], template: function DeskSelectModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(13, "desk-filters", 8);
        \u0275\u0275elementStart(14, "div", 9)(15, "desk-filters-display", 10);
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(16, DeskSelectModalComponent_desk_list_16_Template, 1, 3, "desk-list", 11);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(17, "desk-details", 12);
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(18, "footer", 13);
        \u0275\u0275template(19, DeskSelectModalComponent_button_19_Template, 2, 0, "button", 14);
        \u0275\u0275elementStart(20, "button", 15);
        \u0275\u0275text(21, " View List ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(22, "footer", 16)(23, "button", 17)(24, "div", 18)(25, "app-icon", 19);
        \u0275\u0275text(26, "arrow_back");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(27, "div", 20);
        \u0275\u0275text(28, "Back to form");
        \u0275\u0275elementEnd()()();
        ...
        \u0275\u0275elementStart(32, "div", 18)(33, "app-icon", 19);
        \u0275\u0275text(34);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("mat-dialog-close", ctx.selected);
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate1(" ", ctx.selected.length, " desk(s) added ");
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskSelectModalComponent, { className: "DeskSelectModalComponent", filePath: "libs/bookings/src/lib/desk-select-modal/desk-select-modal.component.ts", lineNumber: 160 });
})();

// libs/bookings/src/lib/invite-visitor-form.component.ts
var _c07 = () => ({ standalone: true });
function InviteVisitorFormComponent_ng_container_0_div_1_form_4_div_1_mat_option_7_Template(rf, ctx) {
  if (rf & 1) {
...
function InviteVisitorFormComponent_ng_container_0_div_1_form_4_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "mat-form-field", 26)(6, "mat-select", 29);
    \u0275\u0275listener("ngModelChange", function InviteVisitorFormComponent_ng_container_0_div_1_form_4_div_1_Template_mat_select_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r3 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r3.form.patchValue({ zones: [$event] }));
    });
    \u0275\u0275template(7, InviteVisitorFormComponent_ng_container_0_div_1_form_4_div_1_mat_option_7_Template, 2, 2, "mat-option", 30);
    \u0275\u0275pipe(8, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(8, 3, ctx_r3.buildings));
  }
}
function InviteVisitorFormComponent_ng_container_0_div_1_form_4_div_21_Template(rf, ctx) {
  if (rf & 1) {
...
function InviteVisitorFormComponent_ng_container_0_div_1_form_4_ng_container_22_mat_option_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-option", 41);
    \u0275\u0275listener("click", function InviteVisitorFormComponent_ng_container_0_div_1_form_4_ng_container_22_mat_option_10_Template_mat_option_click_0_listener() {
...
function InviteVisitorFormComponent_ng_container_0_div_1_form_4_ng_container_22_mat_option_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-option", 41);
    \u0275\u0275listener("click", function InviteVisitorFormComponent_ng_container_0_div_1_form_4_ng_container_22_mat_option_22_Template_mat_option_click_0_listener() {
...
function InviteVisitorFormComponent_ng_container_0_div_1_form_4_ng_container_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    ...
    \u0275\u0275text(5, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "mat-form-field", 26)(7, "input", 36);
    \u0275\u0275listener("focus", function InviteVisitorFormComponent_ng_container_0_div_1_form_4_ng_container_22_Template_input_focus_7_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r3 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r3.filterVisitors(ctx_r3.form.value.asset_name));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "mat-autocomplete", null, 3);
    \u0275\u0275template(10, InviteVisitorFormComponent_ng_container_0_div_1_form_4_ng_container_22_mat_option_10_Template, 6, 4, "mat-option", 37);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 15)(12, "label", 38);
    \u0275\u0275text(13, " Visitor Email");
    \u0275\u0275elementStart(14, "span");
    \u0275\u0275text(15, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "mat-form-field", 26)(17, "input", 39);
    \u0275\u0275listener("focus", function InviteVisitorFormComponent_ng_container_0_div_1_form_4_ng_container_22_Template_input_focus_17_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r3 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "mat-autocomplete", null, 4);
    \u0275\u0275template(22, InviteVisitorFormComponent_ng_container_0_div_1_form_4_ng_container_22_mat_option_22_Template, 6, 4, "mat-option", 37);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 15)(24, "label", 35);
    \u0275\u0275text(25, "Company");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "mat-form-field", 26);
    \u0275\u0275element(27, "input", 40);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const name_auto_r11 = \u0275\u0275reference(9);
    const email_auto_r12 = \u0275\u0275reference(21);
    const ctx_r3 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(7);
...
function InviteVisitorFormComponent_ng_container_0_div_1_form_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, InviteVisitorFormComponent_ng_container_0_div_1_form_4_div_1_Template, 9, 6, "div", 14);
    \u0275\u0275elementStart(2, "div", 15)(3, "label", 16);
    \u0275\u0275text(4, "Date");
    \u0275\u0275elementStart(5, "span");
    \u0275\u0275text(6, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(7, "a-date-field", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 18)(9, "div", 19)(10, "label", 20);
    \u0275\u0275text(11, " Start Time");
    \u0275\u0275elementStart(12, "span");
    \u0275\u0275text(13, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "a-time-field", 21);
    \u0275\u0275listener("ngModelChange", function InviteVisitorFormComponent_ng_container_0_div_1_form_4_Template_a_time_field_ngModelChange_14_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r3 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r3.form.patchValue({ date: $event }));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 19)(16, "label", 22);
    \u0275\u0275text(17, "End Time");
    \u0275\u0275elementStart(18, "span");
    \u0275\u0275text(19, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(20, "a-duration-field", 23);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(21, InviteVisitorFormComponent_ng_container_0_div_1_form_4_div_21_Template, 7, 3, "div", 24)(22, InviteVisitorFormComponent_ng_container_0_div_1_form_4_ng_container_22_Template, 28, 4, "ng-container", 5);
    \u0275\u0275elementStart(23, "div", 15)(24, "label", 25);
    \u0275\u0275text(25, "Reason for visit");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "mat-form-field", 26);
...
function InviteVisitorFormComponent_ng_container_0_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "Invite Visitor");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, InviteVisitorFormComponent_ng_container_0_div_1_form_4_Template, 28, 12, "form", 10);
...
function InviteVisitorFormComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, InviteVisitorFormComponent_ng_container_0_div_1_Template, 8, 1, "div", 6);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function InviteVisitorFormComponent_ng_template_1_ng_container_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", (ctx_r3.last_success == null ? null : ctx_r3.last_success.asset_name) || (ctx_r3.last_success == null ? null : ctx_r3.last_success.asset_id), " ");
  }
}
function InviteVisitorFormComponent_ng_template_1_ng_container_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", ctx_r3.last_count, " visitor", ctx_r3.last_count == 1 ? "" : "s", " ");
  }
}
...
function InviteVisitorFormComponent_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, " Visitor invite sent to ");
    \u0275\u0275template(4, InviteVisitorFormComponent_ng_template_1_ng_container_4_Template, 2, 1, "ng-container", 47)(5, InviteVisitorFormComponent_ng_template_1_ng_container_5_Template, 2, 2, "ng-container", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "img", 48);
    \u0275\u0275elementStart(7, "p");
    \u0275\u0275text(8, " Invite has been sent to ");
    \u0275\u0275elementStart(9, "i");
    \u0275\u0275template(10, InviteVisitorFormComponent_ng_template_1_ng_container_10_Template, 2, 1, "ng-container", 47)(11, InviteVisitorFormComponent_ng_template_1_ng_container_11_Template, 2, 2, "ng-container", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275text(12);
    \u0275\u0275pipe(13, "date");
    \u0275\u0275pipe(14, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 49)(16, "div", 50)(17, "button", 51);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "button", 51);
    \u0275\u0275listener("click", function InviteVisitorFormComponent_ng_template_1_Template_button_click_19_listener() {
      \u0275\u0275restoreView(_r15);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.sent = false);
    });
    \u0275\u0275text(20, " Book Another Visitor ");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275property("ngIf", ctx_r3.multiple);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate3(" to attend ", (ctx_r3.building == null ? null : ctx_r3.building.display_name) || (ctx_r3.building == null ? null : ctx_r3.building.name), " from ", \u0275\u0275pipeBind2(13, 7, ctx_r3.last_success == null ? null : ctx_r3.last_success.date, "mediumDate"), " at ", \u0275\u0275pipeBind2(14, 10, ctx_r3.last_success == null ? null : ctx_r3.last_success.date, ctx_r3.time_format), " ");
  }
}
...
function InviteVisitorFormComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 54)(1, "label", 35);
    \u0275\u0275text(2, "Visitors");
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(5, "a-user-list-field", 55);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
var InviteVisitorFormComponent = class _InviteVisitorFormComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InviteVisitorFormComponent, selectors: [["invite-visitor-form"]], inputs: { date: "date" }, outputs: { done: "done" }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 7, vars: 2, consts: [["send_state", ""], ["load_state", ""], ["multi_state", ""], ["name_auto", "matAutocomplete"], ["email_auto", "matAutocomplete"], [4, "ngIf", "ngIfElse"], ["class", "relative flex flex-col bg-base-100 overflow-auto max-h-full", 4, "ngIf", "ngIfElse"], [1, "relative", "flex", "flex-col", "bg-base-100", "overflow-auto", "max-h-full"], [1, "w-full", "border-b", "border-base-200", "sm:px-16", "px-4", "py-4"], [1, "text-2xl", "font-medium"], ["class", "sm:px-16 px-4 py-4", 3, "formGroup", 4, "ngIf"], [1, "sticky", "sm:px-16", "px-4", "py-4", "border-t", "bg-base-100", "border-base-200", "bottom-0"], ["btn", "", "matRipple", "", "send", "", 1, "w-full", "sm:w-auto", 3, "click"], [1, "sm:px-16", "px-4", "py-4", 3, "formGroup"], ["class", "flex flex-col", 4, "ngIf"], [1, "flex", "flex-col"], ["for", "date"], ["name", "date", "formControlName", "date"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1", "flex", "flex-col", "w-1/3"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "disabled", "use_24hr"], ["for", "end-time"], ["name", "end-time", "formControlName", "duration", 3, "time", "use_24hr"], ["class", "w-full flex flex-col", 4, "ngIf"], ["for", "reason"], ["appearance", "outline"], ["name", "reason", "matInput", "", "formControlName", "description", "placeholder", "e.g. Meeting Catchup"], ["for", "building"], ["name", "building", "placeholder", "Select building", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [1, "w-full", "flex", "flex-col"], ["for", "host"], ["name", "host", "formControlName", "user", 1, "mb-4"], ["for", "visitor-name"], ["matInput", "", "name", "visitor-name", "formControlName", "asset_name", "placeholder", "Name of the visitor", 3, "focus", "matAutocomplete"], [3, "value", "click", 4, "ngFor", "ngForOf"], ["for", "visitor-email"], ["matInput", "", "name", "visitor-email", "type", "email", "formControlName", "asset_id", "placeholder", "Email of the visitor", 3, "focus", "matAutocomplete"], ["matInput", "", "name", "company", "formControlName", "company", "placeholder", "Company of the visitor"], [3, "click", "value"], [1, "flex", "flex-col", "leading-tight"], [1, "text-xs", "opacity-60"], ["sent", "", 1, "absolute", "inset-0", "bg-base-100", "flex", "flex-col", "items-center", "justify-center", "text-center"], [1, "w-full", "max-w-[32rem]", "flex-1", "h-1/2", "space-y-2", "m-8"], [1, "text-3xl"], [4, "ngIf"], ["src", "assets/icons/sent.svg", 1, "mx-auto"], [1, "w-full", "p-2", "border-t", "border-base-200"], [1, "mx-auto", "flex", "items-center", "space-x-2", "w-full", "max-w-[32rem]"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "click"], ["loading", "", 1, "relative", "flex", "flex-col", "items-center", "justify-center", "rounded", "overflow-hidden", "w-full", "h-full", "min-h-[18rem]"], [3, "diameter"], [1, "flex", "flex-col", 3, "formGroup"], ["formControlName", "assets", 3, "guests_only"]], template: function InviteVisitorFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, InviteVisitorFormComponent_ng_container_0_Template, 3, 4, "ng-container", 5)(1, InviteVisitorFormComponent_ng_template_1_Template, 21, 13, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(3, InviteVisitorFormComponent_ng_template_3_Template, 4, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(5, InviteVisitorFormComponent_ng_template_5_Template, 6, 2, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InviteVisitorFormComponent, { className: "InviteVisitorFormComponent", filePath: "libs/bookings/src/lib/invite-visitor-form.component.ts", lineNumber: 300 });
})();
...
function ParkingSpaceDetailsComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 11)(23, "app-icon");
    \u0275\u0275text(24, "meeting_room");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "p");
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 11)(28, "app-icon");
    \u0275\u0275text(29, "place");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "p");
    \u0275\u0275text(31);
    ...
    \u0275\u0275element(34, "interactive-map", 13);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate1("", ctx_r1.space.capacity, " People");
    \u0275\u0275advance(5);
...
function ParkingSpaceDetailsComponent_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, " Select a space to view it's details ");
    \u0275\u0275elementEnd()();
  }
}
var ParkingSpaceDetailsComponent = class _ParkingSpaceDetailsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingSpaceDetailsComponent, selectors: [["parking-space-details"]], inputs: { space: "space", fav: "fav", active: "active" }, outputs: { activeChange: "activeChange", close: "close", toggleFav: "toggleFav" }, features: [\u0275\u0275NgOnChangesFeature], decls: 3, vars: 2, consts: [["empty_state", ""], [4, "ngIf", "ngIfElse"], ["image", "", 1, "relative", "w-full", "bg-base-200"], ["class", "absolute inset-0", 3, "images", 4, "ngIf"], ["icon", "", "matRipple", "", "close", "", 1, "absolute", "top-2", "left-2", "bg-base-200", "sm:hidden", 3, "click"], ["icon", "", "matRipple", "", "fav", "", 1, "absolute", "top-2", "right-2", "bg-base-200", 3, "click"], [1, "p-2", "space-y-2", "flex-1", "h-1/2", "overflow-auto"], ["actions", "", 1, "z-0"], [1, "text-xl", "font-medium", "mb-2", "mt-4"], ["details", "", 1, "space-y-2"], [1, "text-xl", "font-medium"], [1, "flex", "items-center", "space-x-2"], ["map", "", 1, "w-full", "mx-auto", "h-64", "sm:h-48", "relative", "border", "border-base-200", "overflow-hidden", "rounded"], [1, "pointer-events-none", 3, "src", "focus", "features", "options"], [1, "p-2", "border-t", "border-base-200", "shadow", "sm:hidden"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "flex", "items-center", "justify-center"], [1, "text-2xl"], [1, "absolute", "inset-0", 3, "images"], ["empty", "", 1, "p-16", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "opacity-30", "text-center"]], template: function ParkingSpaceDetailsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, ParkingSpaceDetailsComponent_ng_container_0_Template, 42, 29, "ng-container", 1)(1, ParkingSpaceDetailsComponent_ng_template_1_Template, 3, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
...
function ParkingSpaceFiltersComponent_ng_container_13_mat_form_field_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(5, ParkingSpaceFiltersComponent_ng_container_13_mat_form_field_1_mat_option_5_Template, 2, 2, "mat-option", 25);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ParkingSpaceFiltersComponent_ng_container_13_mat_form_field_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, ParkingSpaceFiltersComponent_ng_container_13_mat_form_field_3_mat_option_3_Template, 2, 2, "mat-option", 25);
    \u0275\u0275pipe(4, "async");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ParkingSpaceFiltersComponent_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ParkingSpaceFiltersComponent_ng_container_13_mat_form_field_1_Template, 7, 13, "mat-form-field", 22);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275template(3, ParkingSpaceFiltersComponent_ng_container_13_mat_form_field_3_Template, 5, 8, "mat-form-field", 22);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
...
function ParkingSpaceFiltersComponent_ng_container_14_mat_form_field_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, ParkingSpaceFiltersComponent_ng_container_14_mat_form_field_1_mat_option_2_Template, 2, 2, "mat-option", 25);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ParkingSpaceFiltersComponent_ng_container_14_mat_form_field_3_mat_optgroup_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, ParkingSpaceFiltersComponent_ng_container_14_mat_form_field_3_mat_optgroup_5_mat_option_1_Template, 2, 2, "mat-option", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ParkingSpaceFiltersComponent_ng_container_14_mat_form_field_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(3, "mat-option", 26);
    \u0275\u0275text(4, "Any Level");
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, ParkingSpaceFiltersComponent_ng_container_14_mat_form_field_3_mat_optgroup_5_Template, 2, 2, "mat-optgroup", 29);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ParkingSpaceFiltersComponent_ng_container_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ParkingSpaceFiltersComponent_ng_container_14_mat_form_field_1_Template, 4, 6, "mat-form-field", 22);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275template(3, ParkingSpaceFiltersComponent_ng_container_14_mat_form_field_3_Template, 7, 8, "mat-form-field", 22);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
...
function ParkingSpaceFiltersComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275text(5, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "a-time-field", 34);
    \u0275\u0275listener("ngModelChange", function ParkingSpaceFiltersComponent_div_22_Template_a_time_field_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.form.patchValue({ date: $event }));
    });
    ...
    \u0275\u0275text(11, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(12, "a-duration-field", 36);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function ParkingSpaceFiltersComponent_section_31_div_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275pipe(4, "async");
    \u0275\u0275listener("ngModelChange", function ParkingSpaceFiltersComponent_section_31_div_3_Template_mat_checkbox_ngModelChange_3_listener($event) {
...
function ParkingSpaceFiltersComponent_section_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "Facilities");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ParkingSpaceFiltersComponent_section_31_div_3_Template, 5, 6, "div", 38);
    \u0275\u0275pipe(4, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var ParkingSpaceFiltersComponent = class _ParkingSpaceFiltersComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingSpaceFiltersComponent, selectors: [["parking-space-filters"]], inputs: { hide_levels: "hide_levels" }, decls: 34, vars: 18, consts: [[1, "flex", "items-center", "border-b", "border-base-200", "pb-2", "sm:hidden"], [1, "flex-1", "pl-2"], ["icon", "", "matRipple", "", "close", "", 3, "click", 4, "ngIf"], [1, "font-medium", "flex-2", "text-center"], [1, "flex-1"], [1, "max-h-[65vh]", "p-2", "overflow-y-auto", "overflow-x-hidden", "divide-y", "divide-base-200", "w-full", "max-w-[100vw]", 3, "formGroup"], ["details", ""], [1, "text-lg", "font-medium"], [1, "flex-1", "min-w-[256px]", "flex", "flex-col"], ["for", "location"], [4, "ngIf"], [1, "flex-1", "min-w-[256px]"], ["for", "date"], ["name", "date", 3, "ngModelChange", "ngModel", "ngModelOptions", "to"], ["class", "flex items-center space-x-2", 4, "ngIf"], ["favs", "", 1, "space-y-2", "pb-4"], [1, "flex", "items-center"], ["for", "fav", 1, "flex-1", "w-1/2"], ["name", "fav", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["features", "", "class", "space-y-2", 4, "ngIf"], ["class", "px-2 pt-2 w-full border-t border-base-200", 4, "ngIf"], ["icon", "", "matRipple", "", "close", "", 3, "click"], ["appearance", "outline", "class", "w-full", 4, "ngIf"], ["appearance", "outline", 1, "w-full"], ["name", "building", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["name", "location", "placeholder", "Any Level", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["name", "region", "placeholder", "Any Region", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "label", 4, "ngFor", "ngForOf"], [3, "label"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1", "w-1/3"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "use_24hr"], ["for", "end-time"], ["name", "end-time", "formControlName", "duration", 3, "time", "max", "use_24hr"], ["features", "", 1, "space-y-2"], ["class", "flex items-center", 4, "ngFor", "ngForOf"], ["for", "feat", 1, "flex-1", "w-1/2"], ["name", "feat", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "px-2", "pt-2", "w-full", "border-t", "border-base-200"], ["btn", "", "matRipple", "", "close", "", 1, "w-full", 3, "click"]], template: function ParkingSpaceFiltersComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1);
        \u0275\u0275template(2, ParkingSpaceFiltersComponent_button_2_Template, 3, 0, "button", 2);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(3, "h3", 3);
        \u0275\u0275text(4, "Space Filters");
        \u0275\u0275elementEnd();
        \u0275\u0275element(5, "div", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "form", 5)(7, "section", 6)(8, "h2", 7);
        ...
        \u0275\u0275text(12, "Location");
        \u0275\u0275elementEnd();
        \u0275\u0275template(13, ParkingSpaceFiltersComponent_ng_container_13_Template, 4, 4, "ng-container", 10)(14, ParkingSpaceFiltersComponent_ng_container_14_Template, 4, 4, "ng-container", 10);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(19, "*");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(20, "a-date-field", 13);
        \u0275\u0275listener("ngModelChange", function ParkingSpaceFiltersComponent_Template_a_date_field_ngModelChange_20_listener($event) {
          return ctx.form.patchValue({ date: $event });
        });
        \u0275\u0275text(21, " Date and time must be in the future ");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(22, ParkingSpaceFiltersComponent_div_22_Template, 13, 7, "div", 14);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(23, "section", 15)(24, "h2", 7);
        \u0275\u0275text(25, "Favourites");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(26, "div", 16)(27, "div", 17);
        \u0275\u0275text(28, " Only show favourite spaces ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(29, "mat-checkbox", 18);
        \u0275\u0275pipe(30, "async");
        \u0275\u0275listener("ngModelChange", function ParkingSpaceFiltersComponent_Template_mat_checkbox_ngModelChange_29_listener($event) {
          return ctx.setOptions({ show_fav: $event });
        });
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(31, ParkingSpaceFiltersComponent_section_31_Template, 5, 3, "section", 19);
        \u0275\u0275pipe(32, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(33, ParkingSpaceFiltersComponent_div_33_Template, 3, 0, "div", 20);
      }
      if (rf & 2) {
        let tmp_8_0;
        let tmp_10_0;
        ...
        \u0275\u0275advance(7);
        \u0275\u0275property("ngModel", (tmp_8_0 = \u0275\u0275pipeBind1(30, 12, ctx.options)) == null ? null : tmp_8_0.show_fav)("ngModelOptions", \u0275\u0275pureFunction0(17, _c09));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", (tmp_10_0 = \u0275\u0275pipeBind1(32, 14, ctx.features)) == null ? null : tmp_10_0.length);
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", ctx.can_close);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingSpaceFiltersComponent, { className: "ParkingSpaceFiltersComponent", filePath: "libs/bookings/src/lib/parking-select-modal/parking-filters.component.ts", lineNumber: 224 });
})();
...
var ParkingSpaceFiltersDisplayComponent = class _ParkingSpaceFiltersDisplayComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingSpaceFiltersDisplayComponent, selectors: [["parking-space-filters-display"]], inputs: { view: "view" }, outputs: { viewChange: "viewChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 22, vars: 23, consts: [["actions", "", 1, "sm:hidden", "space-x-2", "flex", "items-center", "p-2"], ["matRipple", "", "filters", "", 1, "flex-1", "w-1/2", 3, "click"], [1, "flex", "items-center"], ["matRipple", "", "map", "", 1, "rounded-l", "rounded-r-none", 3, "click"], ["matRipple", "", "list", "", 1, "rounded-r", "rounded-l-none", 3, "click"], ["filters", "", 1, "flex", "items-center", "flex-wrap", "p-2", "w-[35rem]", "max-w-full", "sm:max-w-[35rem]"], ["filter-item", "", "zone", "", 4, "ngIf"], ["filter-item", "", "date", ""], ["filter-item", "", "time", ""], ["filter-item", "", "count", ""], ["filter-item", "", 4, "ngFor", "ngForOf"], ["filter-item", "", "zone", ""], ["filter-item", ""], ["icon", "", "matRipple", "", 1, "-mr-4", 3, "click"]], template: function ParkingSpaceFiltersDisplayComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "section", 0)(1, "button", 1);
        ...
        \u0275\u0275template(9, ParkingSpaceFiltersDisplayComponent_div_9_Template, 2, 1, "div", 6);
        ...
        \u0275\u0275pipe(19, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(20, ParkingSpaceFiltersDisplayComponent_div_20_Template, 6, 1, "div", 10);
        \u0275\u0275pipe(21, "async");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        ...
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" Min. ", ((tmp_5_0 = \u0275\u0275pipeBind1(19, 19, ctx.options)) == null ? null : tmp_5_0.capcaity) || 2, " People ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngForOf", (tmp_6_0 = \u0275\u0275pipeBind1(21, 21, ctx.options)) == null ? null : tmp_6_0.features);
      }
    }, dependencies: [NgForOf, NgIf, IconComponent, MatRipple, AsyncPipe, DatePipe], styles: ["\n\n[filter-item][_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  padding: 0 1rem;\n  height: 2rem;\n  font-size: 0.875rem;\n  border: 1px solid rgba(0, 0, 0, 0.2);\n  border-radius: 1.25rem;\n  margin-right: 0.5rem;\n  margin-bottom: 0.5rem;\n}\n[filter-item][_ngcontent-%COMP%]:hover {\n  background: rgba(0, 0, 0, 0.1);\n}\n[filter-item][_ngcontent-%COMP%]    > *[_ngcontent-%COMP%]    + *[_ngcontent-%COMP%] {\n  margin-left: 0.5rem;\n}\n/*# sourceMappingURL=parking-filters-display.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingSpaceFiltersDisplayComponent, { className: "ParkingSpaceFiltersDisplayComponent", filePath: "libs/bookings/src/lib/parking-select-modal/parking-filters-display.component.ts", lineNumber: 96 });
})();
...
function ParkingSpaceListComponent_ng_container_5_ul_1_li_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(2, "div", 11);
    \u0275\u0275template(3, ParkingSpaceListComponent_ng_container_5_ul_1_li_1_div_3_Template, 3, 0, "div", 12)(4, ParkingSpaceListComponent_ng_container_5_ul_1_li_1_img_4_Template, 1, 1, "img", 13)(5, ParkingSpaceListComponent_ng_container_5_ul_1_li_1_ng_template_5_Template, 1, 0, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", space_r2.capacity < 1 ? 2 : space_r2.capacity, " People ");
    \u0275\u0275advance();
...
function ParkingSpaceListComponent_ng_container_5_ul_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 7);
    \u0275\u0275template(1, ParkingSpaceListComponent_ng_container_5_ul_1_li_1_Template, 23, 11, "li", 8);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ParkingSpaceListComponent_ng_container_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ParkingSpaceListComponent_ng_container_5_ul_1_Template, 3, 3, "ul", 6);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function ParkingSpaceListComponent_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, " No available spaces for selected time and/or filters ");
    \u0275\u0275elementEnd()();
  }
}
function ParkingSpaceListComponent_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "Finding available spaces...");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingSpaceListComponent, selectors: [["parking-space-list"]], inputs: { active: "active", selected: "selected", favorites: "favorites" }, outputs: { onSelect: "onSelect", toggleFav: "toggleFav" }, decls: 11, vars: 7, consts: [["empty_state", ""], ["load_state", ""], ["placeholder", ""], [1, "font-bold"], ["count", "", 1, "text-sm", "opacity-60", "mb-4"], [4, "ngIf", "ngIfElse"], ["class", "list-style-none space-y-2", 4, "ngIf", "ngIfElse"], [1, "list-style-none", "space-y-2"], ["space", "", "class", "relative p-2 rounded-lg w-full shadow border bg-base-100 border-base-200", 3, "!border-info", 4, "ngFor", "ngForOf"], ["space", "", 1, "relative", "p-2", "rounded-lg", "w-full", "shadow", "border", "bg-base-100", "border-base-200"], ["matRipple", "", "select", "", 1, "w-full", "h-full", "flex", "items-center", 3, "click"], [1, "relative", "w-20", "h-20", "rounded-xl", "bg-base-200", "mr-4", "overflow-hidden", "flex", "items-center", "justify-center"], ["class", "absolute top-1 left-1 border border-neutral bg-base-200 rounded-full h-6 w-6 flex items-center justify-center text-white", 4, "ngIf"], ["auth", "", "class", "object-cover h-full", 3, "source", 4, "ngIf", "ngIfElse"], [1, "space-y-2"], [1, "font-medium", "truncate", "mr-10"], [1, "flex", "items-center", "text-sm", "space-x-2"], [1, "text-info"], ["icon", "", "matRipple", "", "fav", "", 1, "absolute", "top-1", "right-1", 3, "click"], [1, "absolute", "top-1", "left-1", "border", "border-neutral", "bg-base-200", "rounded-full", "h-6", "w-6", "flex", "items-center", "justify-center", "text-white"], ["auth", "", 1, "object-cover", "h-full", 3, "source"], ["src", "assets/icons/car-placeholder.svg", 1, "m-auto"], ["empty", "", 1, "p-16", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "opacity-30", "text-center"], ["loading", "", 1, "p-16", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"], [1, "opacity-30"]], template: function ParkingSpaceListComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(4, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, ParkingSpaceListComponent_ng_container_5_Template, 3, 4, "ng-container", 5);
        \u0275\u0275pipe(6, "async");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", ((tmp_2_0 = \u0275\u0275pipeBind1(4, 3, ctx.assets)) == null ? null : tmp_2_0.length) || 0, " result(s) found ");
        \u0275\u0275advance(2);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingSpaceSelectModalComponent, selectors: [["parking-space-select-modal"]], decls: 34, vars: 22, consts: [["map_view", ""], [1, "w-[100vw]", "h-[100vh]", "sm:relative", "sm:w-auto", "sm:h-auto", "flex", "flex-col", "bg-base-100"], [1, "flex", "items-center", "space-x-4", "w-full"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 1, "bg-base-200"], [1, "flex-1", "flex", "items-center", "divide-x", "divide-base-200", "min-h-[65vh]", "h-[65vh]", "sm:max-h-[65vh]", "sm:max-w-[95vw]", "w-full", "overflow-hidden"], [1, "h-full", "hidden", "sm:flex", "max-w-[20rem]", "sm:h-[65vh]", "sm:max-h-full", 3, "hide_levels"], [1, "flex", "flex-col", "items-center", "flex-1", "w-1/2", "h-full", "sm:h-[65vh]"], [1, "w-full", "border-b", "border-base-200", 3, "viewChange", "view"], ["class", "flex-1 h-1/2 bg-base-200", 3, "active", "selected", "favorites", "toggleFav", "onSelect", 4, "ngIf", "ngIfElse"], [1, "h-full", "w-full", "sm:h-[65vh]", "absolute", "sm:relative", "sm:flex", "sm:max-w-[20rem]", "z-20", "bg-base-100", "block", 3, "activeChange", "toggleFav", "close", "space", "active", "fav"], [1, "flex", "sm:hidden", "flex-col-reverse", "items-center", "justify-end", "p-2", "border-t", "border-base-200", "w-full"], ["btn", "", "matRipple", "", "return", "", "class", "inverse sm:hidden w-full", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", "save", "", 1, "w-full", "sm:w-32", "sm:mb-0", 3, "mat-dialog-close"], [1, "hidden", "sm:flex", "items-center", "justify-between", "p-2", "border-t", "border-base-200", "w-full"], ["btn", "", "matRipple", "", 1, "clear", "text-secondary", 3, "mat-dialog-close"], [1, "flex", "items-center"], [1, "text-xl"], [1, "mr-1", "underline"], [1, "opacity-60", "text-sm"], ["btn", "", "matRipple", "", 3, "click", "disabled"], [1, "mr-1"], [1, "flex-1", "h-1/2", "bg-base-200", 3, "toggleFav", "onSelect", "active", "selected", "favorites"], ["btn", "", "matRipple", "", "return", "", 1, "inverse", "sm:hidden", "w-full", 3, "click"], [1, "flex-1", "h-1/2", "w-full", 3, "onSelect", "selected", "is_displayed"]], template: function ParkingSpaceSelectModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(5, "h3");
        \u0275\u0275text(6, "Find Parking Space");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(7, "main", 4);
        \u0275\u0275element(8, "parking-space-filters", 5);
        \u0275\u0275elementStart(9, "div", 6)(10, "parking-space-filters-display", 7);
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(11, ParkingSpaceSelectModalComponent_parking_space_list_11_Template, 1, 3, "parking-space-list", 8);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(12, "parking-space-details", 9);
        ...
        \u0275\u0275template(14, ParkingSpaceSelectModalComponent_button_14_Template, 2, 0, "button", 11);
        \u0275\u0275elementStart(15, "button", 12);
        \u0275\u0275text(16, " View List ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(17, "footer", 13)(18, "button", 14)(19, "div", 15)(20, "app-icon", 16);
        ...
        \u0275\u0275elementStart(27, "div", 15)(28, "app-icon", 16);
        \u0275\u0275text(29);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("mat-dialog-close", ctx.selected);
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate1(" ", ctx.selected.length, " bay(s) added ");
        \u0275\u0275advance();
        \u0275\u0275classProp("inverse", ctx.isSelected(ctx.displayed == null ? null : ctx.displayed.id));
        \u0275\u0275property("disabled", !ctx.displayed);
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingSpaceSelectModalComponent, { className: "ParkingSpaceSelectModalComponent", filePath: "libs/bookings/src/lib/parking-select-modal/parking-select-modal.component.ts", lineNumber: 135 });
})();
...
function ParkingSpaceListFieldComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 13)(14, "app-icon", 14);
    \u0275\u0275text(15, "people");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "p");
    \u0275\u0275text(17);
    ...
    \u0275\u0275elementStart(20, "div", 17)(21, "app-icon", 5);
    \u0275\u0275text(22, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ParkingSpaceListFieldComponent_div_1_Template_button_click_25_listener() {
      const space_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.removeResource(space_r2));
    });
    \u0275\u0275elementStart(26, "div", 17)(27, "app-icon", 5);
    \u0275\u0275text(28, "close");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "div");
    \u0275\u0275text(30, "Remove");
    ...
    \u0275\u0275listener("click", function ParkingSpaceListFieldComponent_div_1_Template_button_click_31_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleFavourite(ctx_r2.asset));
    });
    \u0275\u0275elementStart(32, "app-icon");
    \u0275\u0275text(33);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", space_r2.location || (space_r2.level == null ? null : space_r2.level.display_name) || (space_r2.level == null ? null : space_r2.level.name) || (space_r2.zone == null ? null : space_r2.zone.display_name) || (space_r2.zone == null ? null : space_r2.zone.name), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", space_r2.capacity < 1 ? 2 : space_r2.capacity || 1, " Person(s) ");
    \u0275\u0275advance(14);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingSpaceListFieldComponent, selectors: [["parking-space-list-field"]], inputs: { disable_date: "disable_date" }, features: [\u0275\u0275ProvidersFeature([
      ...
      if (rf & 1) {
        ...
        \u0275\u0275template(1, ParkingSpaceListFieldComponent_div_1_Template, 34, 8, "div", 2);
        \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingSpaceListFieldComponent, { className: "ParkingSpaceListFieldComponent", filePath: "libs/bookings/src/lib/parking-space-list-field.component.ts", lineNumber: 134 });
})();
...
function DeskListFieldComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "button", 18);
    \u0275\u0275listener("click", function DeskListFieldComponent_div_1_Template_button_click_20_listener() {
      const item_r5 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.removeResource(item_r5));
    });
    \u0275\u0275elementStart(21, "div", 17)(22, "app-icon");
    \u0275\u0275text(23, "close");
    \u0275\u0275elementEnd();
    \u0275\u0275text(24, " Remove ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(25, "button", 19);
    \u0275\u0275listener("click", function DeskListFieldComponent_div_1_Template_button_click_25_listener() {
      const item_r5 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.toggleFavourite(item_r5));
    });
    \u0275\u0275elementStart(26, "app-icon");
    \u0275\u0275text(27);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
var DeskListFieldComponent = class _DeskListFieldComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskListFieldComponent, selectors: [["desk-list-field"]], inputs: { features: "features" }, features: [\u0275\u0275ProvidersFeature([
      ...
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1);
        \u0275\u0275template(1, DeskListFieldComponent_div_1_Template, 28, 8, "div", 2);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(2, "button", 3);
...
function LockerSelectModalComponent_ng_container_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LockerSelectModalComponent_ng_container_16_locker_bank_list_1_Template, 1, 3, "locker-bank-list", 25);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function LockerSelectModalComponent_ng_template_40_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "locker-grid", 30);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerSelectModalComponent, selectors: [["locker-select-modal"]], decls: 42, vars: 20, consts: [["map_view", ""], ["bank_view", ""], [1, "w-[100vw]", "h-[100vh]", "sm:relative", "sm:w-auto", "sm:h-auto", "flex", "flex-col", "bg-base-100"], [1, "flex", "items-center", "space-x-4", "w-full"], ["icon", "", "mat-dialog-close", "", 1, "bg-base-200"], [1, "hidden", "sm:flex", "items-center", "justify-end", "flex-1"], ["btn", "", "matRipple", "", "name", "view-locker-map", 1, "rounded-l", "rounded-r-none", 3, "click"], ["btn", "", "matRipple", "", "name", "view-locker-list", 1, "rounded-r", "rounded-l-none", 3, "click"], [1, "flex-1", "flex", "items-center", "divide-x", "divide-base-200", "min-h-[65vh]", "h-[65vh]", "sm:max-h-[65vh]", "sm:max-w-[95vw]", "w-full", "overflow-hidden"], [1, "h-full", "hidden", "sm:flex", "max-w-[20rem]", "sm:h-[65vh]", "sm:max-h-full", 3, "hide_levels"], [1, "flex", "flex-col", "items-center", "flex-1", "w-1/2", "h-full", "sm:h-[65vh]"], [1, "w-full", "border-b", "border-base-200", 3, "viewChange", "view"], [4, "ngIf", "ngIfElse"], [1, "flex", "sm:hidden", "flex-col-reverse", "items-center", "justify-end", "px-2", "pt-2", "pb-[5.5rem]", "border-t", "border-base-200", "w-full"], ["btn", "", "matRipple", "", "name", "locker-return", "class", "inverse sm:hidden w-full", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", "name", "save-lockers", 1, "w-full", "sm:w-32", "sm:mb-0", 3, "mat-dialog-close"], [1, "hidden", "sm:flex", "items-center", "justify-between", "p-2", "border-t", "border-base-200", "w-full"], ["btn", "", "matRipple", "", "name", "locker-return", 1, "clear", "text-secondary", 3, "mat-dialog-close"], [1, "flex", "items-center"], [1, "text-xl"], [1, "mr-1", "underline"], [1, "opacity-60", "text-sm", "text-center"], ["btn", "", "matRipple", "", "name", "clear-bank", "class", "inverse mr-2 w-32", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", "name", "toggle-locker", 3, "click", "disabled"], [1, "mr-1"], ["class", "flex-1 h-1/2 bg-base-200", 3, "active", "selected", "favorites", "toggleFav", "onSelect", 4, "ngIf", "ngIfElse"], [1, "flex-1", "h-1/2", "bg-base-200", 3, "toggleFav", "onSelect", "active", "selected", "favorites"], ["btn", "", "matRipple", "", "name", "locker-return", 1, "inverse", "sm:hidden", "w-full", 3, "click"], ["btn", "", "matRipple", "", "name", "clear-bank", 1, "inverse", "mr-2", "w-32", 3, "click"], [1, "flex-1", "h-1/2", "w-full", 3, "onSelect", "is_displayed"], [1, "max-w-full", "overflow-auto", "flex-1", "h-1/2", "bg-base-200", 3, "clicked", "bank", "selected"]], template: function LockerSelectModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(13, "locker-filters", 9);
        \u0275\u0275elementStart(14, "div", 10)(15, "locker-filters-display", 11);
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(16, LockerSelectModalComponent_ng_container_16_Template, 2, 2, "ng-container", 12);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(17, "footer", 13);
        \u0275\u0275template(18, LockerSelectModalComponent_button_18_Template, 2, 0, "button", 14);
        \u0275\u0275elementStart(19, "button", 15);
        \u0275\u0275text(20, " View List ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(21, "footer", 16)(22, "button", 17)(23, "div", 18)(24, "app-icon", 19);
        \u0275\u0275text(25, "arrow_back");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(26, "div", 20);
        \u0275\u0275text(27, "Back to form");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(28, "p", 21);
        \u0275\u0275text(29);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(30, "div", 18);
        \u0275\u0275template(31, LockerSelectModalComponent_button_31_Template, 2, 0, "button", 22);
        \u0275\u0275elementStart(32, "button", 23);
        \u0275\u0275listener("click", function LockerSelectModalComponent_Template_button_click_32_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setSelected(ctx.displayed, !ctx.isSelected(ctx.displayed == null ? null : ctx.displayed.id)));
        });
        \u0275\u0275elementStart(33, "div", 18)(34, "app-icon", 19);
        \u0275\u0275text(35);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("mat-dialog-close", ctx.selected);
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate1(" ", ctx.selected.length, " locker(s) added ");
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockerSelectModalComponent, { className: "LockerSelectModalComponent", filePath: "libs/bookings/src/lib/locker-select-modal/locker-select-modal.component.ts", lineNumber: 173 });
})();
...
function LockerListFieldComponent_div_1_div_1_mat_checkbox_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const opt_r3 = ctx.$implicit;
    const ctx_r3 = \u0275\u0275nextContext(3);
    \u0275\u0275property("ngModel", (ctx_r3.selected_features || \u0275\u0275pureFunction0(3, _c013)).includes(opt_r3))("ngModelOptions", \u0275\u0275pureFunction0(4, _c16));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", opt_r3, " ");
  }
}
function LockerListFieldComponent_div_1_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(4, LockerListFieldComponent_div_1_div_1_mat_checkbox_4_Template, 2, 5, "mat-checkbox", 24);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
...
function LockerListFieldComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 7);
    \u0275\u0275template(1, LockerListFieldComponent_div_1_div_1_Template, 5, 1, "div", 8);
    \u0275\u0275elementStart(2, "div", 9);
...
function LockerFiltersComponent_mat_form_field_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.region)("ngModelOptions", \u0275\u0275pureFunction0(5, _c014));
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(3, 3, ctx_r1.regions));
  }
}
...
function LockerFiltersComponent_mat_form_field_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(2, 4, ctx_r1.building))("ngModelOptions", \u0275\u0275pureFunction0(12, _c014))("placeholder", ((tmp_3_0 = \u0275\u0275pipeBind1(3, 6, ctx_r1.building)) == null ? null : tmp_3_0.display_name) || ((tmp_3_0 = \u0275\u0275pipeBind1(4, 8, ctx_r1.building)) == null ? null : tmp_3_0.name));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(6, 10, ctx_r1.buildings));
  }
}
...
function LockerFiltersComponent_mat_form_field_17_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", (tmp_1_0 = \u0275\u0275pipeBind1(2, 3, ctx_r1.options)) == null ? null : tmp_1_0.zone_id)("ngModelOptions", \u0275\u0275pureFunction0(7, _c014));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(4, 5, ctx_r1.levels));
  }
}
...
function LockerFiltersComponent_div_25_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(8, _c014))("use_24hr", ctx_r1.use_24hr);
    \u0275\u0275advance(4);
...
function LockerFiltersComponent_section_36_div_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate(feat_r11);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", (((tmp_4_0 = \u0275\u0275pipeBind1(4, 3, ctx_r1.options)) == null ? null : tmp_4_0.features) || \u0275\u0275pureFunction0(5, _c17)).includes(feat_r11))("ngModelOptions", \u0275\u0275pureFunction0(6, _c014));
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerFiltersComponent, selectors: [["locker-filters"]], inputs: { hide_levels: "hide_levels" }, decls: 39, vars: 30, consts: [[1, "flex", "rounded-t-md", "items-center", "border-b", "border-base-200", "pb-2", "sm:hidden"], [1, "flex-1", "pl-2"], ["icon", "", "matRipple", "", "name", "close-locker-filters", "class", "sm:hidden", 3, "click", 4, "ngIf"], [1, "font-medium", "flex-2", "text-center"], [1, "flex-1"], [1, "max-h-[65vh]", "p-2", "overflow-y-auto", "overflow-x-hidden", "divide-y", "divide-base-200", "w-full", "max-w-[100vw]", "sm:max-w-[30vw]", 3, "formGroup"], ["details", ""], [1, "text-lg", "font-medium", "mb-1"], [1, "flex-1", "min-w-[8rem]", "flex", "flex-col"], ["for", "location"], ["appearance", "outline", "class", "w-full", 4, "ngIf"], [1, "flex-1", "min-w-[256px]"], ["name", "date", "formControlName", "date", 3, "to"], ["class", "flex justify-end -mt-2 mb-2", 4, "ngIf"], ["class", "flex items-center space-x-2", 4, "ngIf"], ["favs", "", 1, "space-y-2", "pb-4"], [1, "text-lg", "font-medium"], [1, "flex", "items-center"], ["for", "fav", 1, "flex-1", "w-1/2"], ["name", "fav", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["class", "space-y-2", "features", "", 4, "ngIf"], ["class", "px-2 py-2 w-full border-t border-base-200", 4, "ngIf"], ["icon", "", "matRipple", "", "name", "close-locker-filters", 1, "sm:hidden", 3, "click"], ["appearance", "outline", 1, "w-full"], ["name", "region", "placeholder", "Any Region", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["name", "building", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["name", "location", "placeholder", "Any Level", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "flex", "flex-col-reverse"], ["class", "opacity-30 text-xs", 4, "ngIf"], [1, "opacity-30", "text-xs"], [1, "opacity-0"], [1, "flex", "justify-end", "-mt-2", "mb-2"], ["formControlName", "all_day"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1", "w-1/3"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "use_24hr"], ["formControlName", "duration", 3, "time", "max", "min", "step", "use_24hr"], ["features", "", 1, "space-y-2"], ["class", "flex items-center flex-wrap space-x-2", 4, "ngFor", "ngForOf"], [1, "flex", "items-center", "flex-wrap", "space-x-2"], ["for", "feat", 1, "flex-1", "w-1/2"], [3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "px-2", "py-2", "w-full", "border-t", "border-base-200"], ["btn", "", "matRipple", "", "name", "apply-locker-filters", 1, "w-full", 3, "click"]], template: function LockerFiltersComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("ngModel", (tmp_11_0 = \u0275\u0275pipeBind1(35, 25, ctx.options)) == null ? null : tmp_11_0.show_fav)("ngModelOptions", \u0275\u0275pureFunction0(29, _c014));
        \u0275\u0275advance(2);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerFiltersDisplayComponent, selectors: [["locker-filters-display"]], inputs: { view: "view" }, outputs: { viewChange: "viewChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 20, vars: 23, consts: [["actions", "", 1, "sm:hidden", "space-x-2", "flex", "flex-row", "items-center", "p-2"], ["btn", "", "matRipple", "", "name", "edit-locker-filters", 1, "flex-1", "w-1/2", 3, "click"], [1, "flex", "items-center"], ["btn", "", "matRipple", "", "name", "view-locker-map", 1, "rounded-l", "rounded-r-none", 3, "click"], ["btn", "", "matRipple", "", "name", "view-locker-list", 1, "rounded-r", "rounded-l-none", 3, "click"], ["filters", "", 1, "flex", "items-center", "flex-wrap", "p-2", "w-[35rem]", "max-w-full", "sm:max-w-[35rem]"], ["filter-item", "", "date", ""], ["filter-item", "", "time", ""], ["filter-item", "", "features", "", 4, "ngFor", "ngForOf"], ["filter-item", "", 4, "ngIf"], ["filter-item", "", "features", ""], ["icon", "", "matRipple", "", "name", "remove-locker-filter", 1, "-mr-4", 3, "click"], ["filter-item", ""], ["icon", "", "matRipple", "", "name", "remove-locker-favs-filter", 1, "-mr-4", 3, "click"]], template: function LockerFiltersDisplayComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275property("ngForOf", ((tmp_4_0 = \u0275\u0275pipeBind1(17, 18, ctx.options)) == null ? null : tmp_4_0.features) || \u0275\u0275pureFunction0(22, _c015));
        \u0275\u0275advance(2);
...
var LockerBankListComponent = class _LockerBankListComponent {
  constructor(_state, _org, _settings) {
    ...
    this.lockers_banks$ = combineLatest([
      this._org.active_building,
      this._org.active_region
    ]).pipe(filter(([bld]) => !!bld), switchMap(([bld]) => this._settings.get("app.use_region") ? forkJoin(this._org.buildingsForRegion().map((building) => showMetadata(building.id, "locker_banks").pipe(catchError(() => of(new PlaceMetadata())), map((_) => _.details instanceof Array ? _.details : [])))).pipe(map((_) => flatten(_))) : showMetadata(bld.id, "locker_banks").pipe(catchError(() => of(new PlaceMetadata())), map((_) => _.details instanceof Array ? _.details : []))), shareReplay(1));
    this.lockers$ = combineLatest([
      this._org.active_building,
      this._org.active_region
    ]).pipe(filter(([bld]) => !!bld), switchMap(([bld]) => combineLatest([
      this._settings.get("app.use_region") ? forkJoin(this._org.buildingsForRegion().map((building) => showMetadata(building.id, "lockers").pipe(catchError(() => of(new PlaceMetadata())), map((_) => _.details instanceof Array ? _.details : [])))).pipe(map((_) => flatten(_))) : showMetadata(bld.id, "lockers").pipe(catchError(() => of(new PlaceMetadata())), map((_) => _.details instanceof Array ? _.details : [])),
      this.lockers_banks$
    ])), map(([lockers, banks]) => {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerMapComponent, selectors: [["locker-map"]], inputs: { is_displayed: "is_displayed" }, outputs: { onSelect: "onSelect" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 21, vars: 18, consts: [[3, "zoomChange", "centerChange", "src", "zoom", "center", "features", "styles", "actions"], [1, "absolute", "inset-x-0", "top-0", "bg-base-100", "p-2", "border-b", "border-base-200"], ["levels", "", "appearance", "outline", 1, "w-full", "h-[3.25rem]"], [3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], ["zoom", "", 1, "absolute", "bottom-2", "right-2", "rounded-lg", "border", "border-base-200", "bg-base-100", "flex", "flex-col", "overflow-hidden"], ["zoom-in", "", "icon", "", "matRipple", "", 3, "click"], [1, "border-t", "border-base-200", "w-full"], ["zoom-out", "", "icon", "", "matRipple", "", 3, "click"], ["reset", "", "icon", "", "matRipple", "", 3, "click"], [3, "value"]], template: function LockerMapComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(6);
        \u0275\u0275twoWayProperty("ngModel", ctx.level);
        \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(17, _c016));
        \u0275\u0275advance();
...
//# sourceMappingURL=chunk-5IGIM5NQ.js.map
