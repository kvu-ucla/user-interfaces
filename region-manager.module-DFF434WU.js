...
function RegionModalComponent_main_4_form_1_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275i18n(2, 3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 14);
...
function RegionModalComponent_main_4_form_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, RegionModalComponent_main_4_form_1_div_1_Template, 5, 0, "div", 11);
    \u0275\u0275elementStart(2, "div", 12)(3, "label", 13);
    \u0275\u0275i18n(4, 2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "mat-form-field", 14)(6, "app-icon", 15);
    \u0275\u0275text(7, "search");
    \u0275\u0275elementEnd();
    \u0275\u0275element(8, "input", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "mat-autocomplete", null, 1);
    \u0275\u0275template(11, RegionModalComponent_main_4_form_1_mat_option_11_Template, 2, 2, "mat-option", 17)(12, RegionModalComponent_main_4_form_1_mat_option_12_Template, 2, 1, "mat-option", 18);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function RegionModalComponent_main_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, RegionModalComponent_main_4_form_1_Template, 13, 5, "form", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
_RegionModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegionModalComponent, selectors: [["region-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 8, vars: 5, consts: () => {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, RegionModalComponent_button_3_Template, 3, 0, "button", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, RegionModalComponent_main_4_Template, 2, 1, "main", 5)(5, RegionModalComponent_footer_5_Template, 3, 0, "footer", 6)(6, RegionModalComponent_ng_template_6_Template, 4, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RegionModalComponent, { className: "RegionModalComponent", filePath: "apps/concierge/src/app/region-manager/region-modal.component.ts", lineNumber: 87 });
})();
...
//# sourceMappingURL=region-manager.module-DFF434WU.js.map
