import {
  SharedExploreModule
} from "./chunk-CNWCL4TP.js";
import "./chunk-KZ26LSLF.js";
import {
  MatTabLink,
  MatTabNav,
  MatTabsModule
} from "./chunk-VEQCIHWS.js";
import {
  BookingFormService,
  LockerListFieldComponent,
  SharedBookingsModule
} from "./chunk-L7JRSF7R.js";
import "./chunk-OXDSY3V4.js";
import {
  ActivatedRoute,
...
function LockerBankModalComponent_main_5_mat_option_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, LockerBankModalComponent_main_5_mat_option_5_div_2_Template, 5, 3, "div", 28);
...
function LockerBankModalComponent_main_5_mat_chip_row_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-chip-row", 31);
    \u0275\u0275listener("removed", function LockerBankModalComponent_main_5_mat_chip_row_28_Template_mat_chip_row_removed_0_listener() {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 33)(4, "app-icon");
    \u0275\u0275text(5, "cancel");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function LockerBankModalComponent_main_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(24, " Tags ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "mat-form-field", 10)(26, "mat-chip-grid", 20, 1);
    \u0275\u0275template(28, LockerBankModalComponent_main_5_mat_chip_row_28_Template, 6, 2, "mat-chip-row", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "input", 22);
    \u0275\u0275listener("matChipInputTokenEnd", function LockerBankModalComponent_main_5_Template_input_matChipInputTokenEnd_29_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function LockerBankModalComponent_main_5_Template_button_click_33_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.postForm());
    });
  ...
  if (rf & 2) {
    const chipList_r6 = \u0275\u0275reference(27);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("formGroup", ctx_r1.form);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.value.zones[0])("ngModelOptions", \u0275\u0275pureFunction0(10, _c03));
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(6, 8, ctx_r1.levels));
    \u0275\u0275advance(23);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerBankModalComponent, selectors: [["locker-bank-modal"]], outputs: { event: "event" }, decls: 8, vars: 4, consts: [["load_state", ""], ["chipList", ""], [1, "w-[28rem]"], [1, "flex", "items-center", "justify-between", "px-2", "w-full"], [1, "px-2"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "p-4 flex flex-col", 3, "formGroup", 4, "ngIf", "ngIfElse"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "p-4", "flex", "flex-col", 3, "formGroup"], ["for", "name"], ["appearance", "outline", 1, "w-full"], [3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], ["appearance", "outline"], ["matInput", "", "name", "name", "formControlName", "name", "placeholder", "Name"], ["for", "map-id"], ["matInput", "", "name", "map-id", "formControlName", "map_id", "placeholder", "Map ID"], ["for", "notes"], ["matInput", "", "name", "notes", "placeholder", "Locker Bank Notes", "formControlName", "notes"], ["for", "tags"], ["name", "tags", "aria-label", "Tag List"], [3, "removed", 4, "ngFor", "ngForOf"], ["placeholder", "Tags...", 3, "matChipInputTokenEnd", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur"], [1, "flex", "items-center", "justify-center", "space-x-2"], ["btn", "", "matRipple", "", "mat-dialog-close", "", 1, "w-32", "inverse"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "removed"], [1, "truncate", "max-w-md"], ["matChipRemove", ""], [1, "p-8", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], ["diameter", "32"]], template: function LockerBankModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, LockerBankModalComponent_main_5_Template, 35, 11, "main", 6);
        \u0275\u0275elementEnd();
    ...
    }, dependencies: [NgForOf, NgIf, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, FormGroupDirective, FormControlName, MatFormField, MatError, MatInput, MatSelect, MatOption, MatProgressSpinner, MatDialogClose, MatRipple, IconComponent, MatChipGrid, MatChipInput, MatChipRemove, MatChipRow, AsyncPipe, BuildingPipe] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockerBankModalComponent, { className: "LockerBankModalComponent", filePath: "apps/concierge/src/app/lockers/locker-bank-modal.component.ts", lineNumber: 134 });
})();
...
function LockerListComponent_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LockerListComponent_ng_template_9_Template_button_click_18_listener() {
      const row_r8 = \u0275\u0275restoreView(_r7).row;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.editLockerBank(row_r8));
    });
    \u0275\u0275elementStart(19, "div", 24)(20, "app-icon", 25);
    \u0275\u0275text(21, "edit");
    \u0275\u0275elementEnd();
...
//# sourceMappingURL=lockers.module-AH6LWBTY.js.map
