...
var DirectoryUserListItemComponent = class _DirectoryUserListItemComponent {
  get show_image() {
  ...
  static {
    this.\u0275fac = function DirectoryUserListItemComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _DirectoryUserListItemComponent)(\u0275\u0275directiveInject(SettingsService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DirectoryUserListItemComponent, selectors: [["a-directory-user-list-item"]], inputs: { user: "user" }, standalone: false, decls: 1, vars: 1, consts: [["class", "mb-2 flex flex-wrap items-center overflow-hidden bg-base-100 p-4 hover:bg-base-200 sm:space-x-4", 3, "with-image", 4, "ngIf"], [1, "mb-2", "flex", "flex-wrap", "items-center", "overflow-hidden", "bg-base-100", "p-4", "hover:bg-base-200", "sm:space-x-4"], [3, "user", 4, "ngIf"], [1, "ml-4", "flex", "w-1/2", "flex-1", "flex-col", "sm:ml-0"], [1, "name"], ["name", "email", 1, "text-sm", "underline", 3, "href"], [1, "mt-4", "flex", "w-full", "items-center", "space-x-2", "sm:mt-0", "sm:w-auto", "sm:flex-col", "sm:space-x-0", "sm:space-y-2"], ["btn", "", "matRipple", "", "locate", "", 1, "w-32", "flex-1", "sm:flex-none", 3, "click", "routerLink", "queryParams"], ["btn", "", "matRipple", "", "class", "sm:flex-nones w-32 flex-1", "call", "", 3, "href", "click", 4, "ngIf"], [3, "user"], ["btn", "", "matRipple", "", "call", "", 1, "sm:flex-nones", "w-32", "flex-1", 3, "click", "href"]], template: function DirectoryUserListItemComponent_Template(rf, ctx) {
      if (rf & 1) {
    ...
    }, dependencies: [NgIf, RouterLink, UserAvatarComponent, MatRipple, SafePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DirectoryUserListItemComponent, { className: "DirectoryUserListItemComponent", filePath: "apps/workplace/src/app/directory/user-details.component.ts", lineNumber: 56 });
})();
...
var DirectoryUserListComponent = class _DirectoryUserListComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DirectoryUserListComponent, selectors: [["", "a-directory-user-list", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c02, decls: 14, vars: 4, consts: [["empty_state", ""], [1, "flex", "h-1/2", "flex-1", "flex-col-reverse", "sm:flex-row"], [1, "relative", "z-0", "flex", "h-1/2", "flex-1", "flex-col", "overflow-hidden", "sm:h-auto"], [1, "flex", "w-full", "items-center", "justify-center", "p-2"], ["overlay", "", "appearance", "outline", 1, "rounded"], ["matPrefix", "", 1, "text-xl"], ["matInput", "", "placeholder", "Search for a person...", 3, "ngModelChange", "ngModel"], ["matSuffix", "", "class", "top-2", 3, "diameter", 4, "ngIf"], [1, "h-1/2", "w-full", "flex-1"], [4, "ngIf", "ngIfElse"], ["matSuffix", "", 1, "top-2", 3, "diameter"], [4, "ngFor", "ngForOf"], [4, "ngIf"], [1, "px-4", "py-2", "font-medium"], [3, "user", 4, "ngFor", "ngForOf"], [3, "user"], [1, "flex", "flex-col", "items-center", "p-8"], [1, "text-5xl"], [1, "text"]], template: function DirectoryUserListComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275element(0, "topbar");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DirectoryUserListComponent, { className: "DirectoryUserListComponent", filePath: "apps/workplace/src/app/directory/user-list.component.ts", lineNumber: 102 });
})();
...
//# sourceMappingURL=directory.module-PMLMATZV.js.map
