...
_EventsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventsComponent, selectors: [["", "app-events", ""]], standalone: false, attrs: _c0, decls: 5, vars: 0, consts: [[1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"]], template: function EventsComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EventsComponent, [{
    ...
    `, standalone: false, styles: ["/* angular:styles/component:css;08c828c36224658230d6844bbbe8551e02a5c30c320aa5e48c90063783b9b8fa;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/events/events.component.ts */\n:host {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: 100%;\n  background-color: var(--b1);\n}\n/*# sourceMappingURL=events.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
(() => {
  ...
  }], () => [{ type: SettingsService }, { type: OrganisationService }, { type: MatDialog }, { type: Router }], null);
})();
...
function EventManageComponent_Conditional_0_For_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-chip-row", 48);
    \u0275\u0275listener("removed", function EventManageComponent_Conditional_0_For_33_Template_mat_chip_row_removed_0_listener() {
...
function EventManageComponent_Conditional_0_Conditional_64_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 30)(1, "div", 50)(2, "label", 51);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    ...
    \u0275\u0275listener("ngModelChange", function EventManageComponent_Conditional_0_Conditional_64_Template_a_time_field_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("ngModelChange", function EventManageComponent_Conditional_0_Conditional_64_Template_a_time_field_ngModelChange_14_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r3.form.value.date_end || ctx_r3.form.value.date + ctx_r3.form.value.duration * 60 * 1e3)("ngModelOptions", \u0275\u0275pureFunction0(16, _c02))("from", (ctx_r3.form == null ? null : (tmp_12_0 = ctx_r3.form.getRawValue()) == null ? null : tmp_12_0.date) + 30 * 60 * 1e3)("use_24hr", ctx_r3.use_24hr)("extra_info_fn", ctx_r3.duration_info);
  }
}
function EventManageComponent_Conditional_0_For_77_Template(rf, ctx) {
  if (rf & 1) {
...
function EventManageComponent_Conditional_0_Conditional_78_Template(rf, ctx) {
  if (rf & 1) {
...
function EventManageComponent_Conditional_0_Conditional_103_For_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 36);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function EventManageComponent_Conditional_0_Conditional_103_For_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 36);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function EventManageComponent_Conditional_0_Conditional_103_For_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 36);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function EventManageComponent_Conditional_0_Conditional_103_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 33)(4, "mat-select", 56);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275listener("ngModelChange", function EventManageComponent_Conditional_0_Conditional_103_Template_mat_select_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.setBuilding($event));
    });
    \u0275\u0275repeaterCreate(6, EventManageComponent_Conditional_0_Conditional_103_For_7_Template, 2, 2, "mat-option", 36, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(8, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 57)(10, "div", 58)(11, "label", 59);
    \u0275\u0275text(12);
    \u0275\u0275pipe(13, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "mat-form-field", 33)(15, "mat-select", 56);
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275listener("ngModelChange", function EventManageComponent_Conditional_0_Conditional_103_Template_mat_select_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.setLevel($event));
    });
    \u0275\u0275repeaterCreate(17, EventManageComponent_Conditional_0_Conditional_103_For_18_Template, 2, 2, "mat-option", 36, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(19, "async");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "div", 60)(21, "label", 59);
    \u0275\u0275text(22);
    \u0275\u0275pipe(23, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "mat-form-field", 33)(25, "mat-select", 61);
    \u0275\u0275pipe(26, "async");
    \u0275\u0275pipe(27, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function EventManageComponent_Conditional_0_Conditional_103_Template_mat_select_ngModelChange_25_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275pipe(31, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(32, EventManageComponent_Conditional_0_Conditional_103_For_33_Template, 2, 2, "mat-option", 36, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(34, "async");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r3.building_zone)("ngModelOptions", \u0275\u0275pureFunction0(36, _c02))("placeholder", \u0275\u0275pipeBind1(5, 16, "COMMON.BUILDING_SELECT"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(8, 18, ctx_r3.building_list));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 20, "RESOURCE.LEVEL"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r3.level_zone)("ngModelOptions", \u0275\u0275pureFunction0(37, _c02))("placeholder", \u0275\u0275pipeBind1(16, 22, "COMMON.LEVEL_SELECT"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(38, _c02))("disabled", ((tmp_17_0 = \u0275\u0275pipeBind1(26, 28, ctx_r3.available_spaces)) == null ? null : tmp_17_0.length) === 0)("placeholder", \u0275\u0275pipeBind1(27, 30, "COMMON.ROOM_SELECT"));
    \u0275\u0275advance(5);
...
function EventManageComponent_Conditional_0_Conditional_118_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "footer", 47)(1, "button", 62);
    \u0275\u0275listener("click", function EventManageComponent_Conditional_0_Conditional_118_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r3 = \u0275\u0275nextContext(2);
...
function EventManageComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(25, "a-user-search-field", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "label", 15);
    \u0275\u0275text(27);
    \u0275\u0275pipe(28, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "mat-form-field", 16)(30, "mat-chip-grid", 17, 0);
    \u0275\u0275repeaterCreate(32, EventManageComponent_Conditional_0_For_33_Template, 4, 3, "mat-chip-row", 18, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementStart(34, "input", 19);
    \u0275\u0275listener("matChipInputTokenEnd", function EventManageComponent_Conditional_0_Template_input_matChipInputTokenEnd_34_listener($event) {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275element(36, "settings-toggle", 21);
    \u0275\u0275pipe(37, "translate");
    \u0275\u0275elementStart(38, "settings-toggle", 22);
    \u0275\u0275pipe(39, "translate");
    \u0275\u0275listener("ngModelChange", function EventManageComponent_Conditional_0_Template_settings_toggle_ngModelChange_38_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(51, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(52, "a-date-field", 28);
    \u0275\u0275text(53);
    \u0275\u0275pipe(54, "translate");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(60, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(61, "a-date-field", 29);
    \u0275\u0275text(62);
    \u0275\u0275pipe(63, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(64, EventManageComponent_Conditional_0_Conditional_64_Template, 15, 17, "div", 30);
    \u0275\u0275elementStart(65, "div", 31)(66, "label", 32);
    \u0275\u0275text(67);
    \u0275\u0275pipe(68, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "mat-form-field", 33)(70, "icon", 34);
    \u0275\u0275text(71, " search ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(76, EventManageComponent_Conditional_0_For_77_Template, 2, 2, "mat-option", 36, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275conditionalCreate(78, EventManageComponent_Conditional_0_Conditional_78_Template, 3, 4, "mat-option", 37);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
    \u0275\u0275element(79, "div", 23);
    \u0275\u0275elementStart(80, "h3", 24);
    \u0275\u0275text(81);
    \u0275\u0275pipe(82, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerStart(83);
    \u0275\u0275elementStart(84, "div", 38)(85, "button", 39);
    \u0275\u0275listener("click", function EventManageComponent_Conditional_0_Template_button_click_85_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.form.patchValue({ attendance_type: "ONSITE" }));
    });
    \u0275\u0275elementStart(86, "icon", 40);
    \u0275\u0275text(87, "domain");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(92, "icon", 40);
    \u0275\u0275text(93, "laptop_mac");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(98, "icon", 40);
    \u0275\u0275text(99, "add");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(100, "div", 41);
    \u0275\u0275text(101);
    \u0275\u0275pipe(102, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(103, EventManageComponent_Conditional_0_Conditional_103_Template, 35, 39);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275element(104, "div", 23);
    \u0275\u0275elementStart(105, "h3", 24);
    \u0275\u0275text(106);
    \u0275\u0275pipe(107, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerStart(108);
    \u0275\u0275elementStart(109, "label", 42);
    \u0275\u0275text(110);
    \u0275\u0275pipe(111, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(112, "div", 43);
    \u0275\u0275element(113, "rich-text-input", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(114, "label", 45);
    \u0275\u0275text(115);
    \u0275\u0275pipe(116, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(117, "image-list-field", 46);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(118, EventManageComponent_Conditional_0_Conditional_118_Template, 4, 3, "footer", 47);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const chipList_r12 = \u0275\u0275reference(31);
    const auto_r13 = \u0275\u0275reference(75);
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(18, 48, "FORM.TITLE_ERROR"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 50, "FORM.HOST"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(28, 52, "COMMON.TAGS"));
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(37, 54, "CALENDAR_EVENT.GROUP_FEATURED"));
    \u0275\u0275advance(2);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(39, 56, "APP.CONCIERGE.EVENTS_PUBLISH"))("ngModel", ctx_r3.form.value.view_access === "OPEN")("ngModelOptions", \u0275\u0275pureFunction0(86, _c02));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(43, 58, "APP.CONCIERGE.EVENTS_DATE_TIME"), " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(49, 60, "FORM.DATE"));
    \u0275\u0275advance(4);
    \u0275\u0275property("to", ctx_r3.end_date);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(54, 62, "FORM.DATE_ERROR"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(58, 64, "FORM.DATE_END"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275property("from", ctx_r3.start_date)("to", ctx_r3.end_date);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(63, 66, "FORM.DATE_ERROR"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r3.form.value.all_day ? 64 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(68, 68, "COMMON.TIMEZONE"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(73, 70, "COMMON.TIMEZONE"))("matAutocomplete", auto_r13);
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r3.filtered_timezones);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r3.timezones.length ? 78 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(82, 72, "COMMON.LOCATION"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275classProp("inverse", false)("inverse", ctx_r3.form.value.attendance_type !== "ONSITE");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(90, 74, "APP.CONCIERGE.EVENTS_LOCATION_ONSITE"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("inverse", ctx_r3.form.value.attendance_type !== "ONLINE");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(96, 76, "APP.CONCIERGE.EVENTS_LOCATION_ONLINE"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("inverse", ctx_r3.form.value.attendance_type !== "ANY");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(102, 78, "APP.CONCIERGE.EVENTS_LOCATION_BOTH"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r3.form.value.attendance_type !== "ONLINE" ? 103 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(107, 80, "APP.CONCIERGE.EVENTS_INFO"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(111, 82, "COMMON.DESCRIPTION"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(116, 84, "COMMON.IMAGES"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!ctx_r3.loading ? 118 : -1);
  }
}
...
_EventManageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventManageComponent, selectors: [["app-event-manage"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 1, consts: [["chipList", ""], ["auto", "matAutocomplete"], [1, "absolute", "inset-0", "overflow-auto", "bg-base-100"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-4", "bg-base-100"], [1, "sticky", "top-0", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "items-center", "justify-between", "rounded", "border-none", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", 3, "routerLink"], [1, "mx-auto", "my-2", "flex", "w-[40rem]", "max-w-full", "flex-col", "px-4", "pb-16", 3, "formGroup"], [1, "flex", "flex-col", "space-y-2"], ["for", "title"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "title", "formControlName", "title", "placeholder", "e.g. Team Meeting"], ["for", "host"], [1, "pb-4"], ["name", "host", "formControlName", "organiser"], ["for", "tags"], ["appearance", "outline", 1, "no-subscript"], ["aria-label", "Event Tags"], [3, "selectable", "removable"], ["placeholder", "Add new tags relevant to this event...", 3, "matChipInputTokenEnd", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur"], [1, "flex", "items-center", "space-x-4", "py-4"], ["formControlName", "featured", 1, "flex-1", 3, "name"], [1, "flex-1", 3, "ngModelChange", "name", "ngModel", "ngModelOptions"], [1, "h-px", "w-full", "bg-base-200"], [1, "py-4", "text-2xl", "font-medium"], [1, "flex", "flex-wrap", "items-center", "sm:space-x-2"], [1, "relative", "min-w-[256px]", "flex-1"], ["for", "date"], ["name", "date", "formControlName", "date", 3, "to"], ["name", "date", "formControlName", "date_end", 3, "from", "to"], [1, "flex", "items-center", "space-x-2"], [1, "flex", "flex-col"], ["for", "display-name"], ["appearance", "outline"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", "formControlName", "timezone", 3, "placeholder", "matAutocomplete"], [3, "value"], [3, "disabled"], [1, "flex", "items-center", "space-x-2", "pb-2"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "click"], [1, "text-2xl"], [1, "mx-2"], ["for", "description"], [1, "mb-16"], ["formControlName", "body"], ["for", "images"], ["formControlName", "images"], [1, "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "-translate-x-1/2", "items-center", "justify-end", "rounded", "border-none", "bg-base-200", "px-4", "py-2"], [3, "removed", "selectable", "removable"], ["matChipRemove", ""], [1, "w-1/3", "flex-1"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "disabled", "ngModelOptions", "use_24hr"], ["for", "end-time"], ["name", "end-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "from", "use_24hr", "extra_info_fn"], ["for", "location"], [3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [1, "flex", "space-x-2"], [1, "flex", "flex-[2]", "flex-col"], ["for", "level"], [1, "flex", "flex-[3]", "flex-col"], [3, "ngModelChange", "ngModel", "ngModelOptions", "disabled", "placeholder"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], ["diameter", "48"]], template: function EventManageComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, EventManageComponent_Conditional_0_Template, 119, 87, "div", 2)(1, EventManageComponent_Conditional_1_Template, 5, 3, "div", 3);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EventManageComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: EventFormService }, { type: EventStateService }, { type: ActivatedRoute }, { type: Router }, { type: OrganisationService }, { type: SettingsService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventManageComponent, { className: "EventManageComponent", filePath: "apps/concierge/src/app/events/event-manage.component.ts", lineNumber: 497 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EventListingComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: SettingsService }, { type: EventStateService }], null);
})();
(() => {
...
function EventWeekViewComponent_For_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, EventWeekViewComponent_For_16_For_2_Template, 8, 11, "button", 15, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(3, "async");
...
_EventWeekViewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventWeekViewComponent, selectors: [["event-week-view"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 17, vars: 4, consts: [["event_card", ""], [1, "absolute", "inset-0", "flex", "overflow-auto"], [1, "sticky", "left-0", "z-20", "flex", "min-h-full", "w-24", "flex-col", "items-end", "bg-base-100"], ["header", "", 1, "sticky", "top-0", "z-10", "flex", "h-16", "min-h-16", "justify-end"], [1, "h-10", "bg-base-100", "pt-6"], [1, "px-2", "text-xs", "opacity-30"], [1, "relative", "min-h-10", "w-full", "flex-1", "bg-base-100"], [1, "relative", "z-10", "min-h-full", "min-w-[84rem]"], ["header", "", 1, "sticky", "top-0", "z-10", "flex", "h-16", "min-h-16", "border-b", "border-base-200", "bg-base-100"], ["date", "", 1, "flex", "min-w-48", "flex-1", "flex-col", "items-center", "justify-center", "border-r", "border-base-200", "p-4"], [1, "pointer-events-none", "relative", "flex", "min-h-10", "min-w-[84rem]", "flex-1", "border-x", "border-b", "border-base-200"], ["date", "", 1, "pointer-events-none", "absolute", "left-0", "top-16", "h-[60rem]", "w-[calc(100%/7)]", "flex-1", "border-r", "border-base-200", 3, "transform"], ["hour", "", 1, "absolute", "right-1", "top-0", "-translate-y-1/2", "whitespace-nowrap", "text-xs", "opacity-60"], [1, "text-sm", "opacity-60"], ["date", "", 1, "pointer-events-none", "absolute", "left-0", "top-16", "h-[60rem]", "w-[calc(100%/7)]", "flex-1", "border-r", "border-base-200"], ["matRipple", "", 1, "pointer-events-auto", "absolute", "inset-x-1", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100", "py-1", "pl-3", "pr-2", "shadow", "hover:border-info", 3, "top", "height"], ["now", "", 1, "absolute", "inset-x-0", "h-0", "border-y-2", "border-base-content", 3, "top"], ["matRipple", "", 1, "pointer-events-auto", "absolute", "inset-x-1", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100", "py-1", "pl-3", "pr-2", "shadow", "hover:border-info", 3, "click"], [1, "absolute", "inset-y-0", "left-0", "w-1.5", "bg-info"], [1, "h-full", "text-left", "text-sm", "opacity-60"], ["customTooltip", "", "xPosition", "center", "yPosition", "bottom", 1, "absolute", "inset-0", 3, "content", "hover"], [1, "pointer-events-none", "p-2"], [3, "event"], ["now", "", 1, "absolute", "inset-x-0", "h-0", "border-y-2", "border-base-content"], [1, "absolute", "left-0", "top-0", "h-4", "w-4", "-translate-x-1/2", "-translate-y-1/2", "rounded-full", "bg-base-content"]], template: function EventWeekViewComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "div", 3)(3, "div", 4)(4, "div", 5);
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "date");
    \u0275\u0275elementEnd()()();
    \u0275\u0275repeaterCreate(7, EventWeekViewComponent_For_8_Template, 3, 2, "div", 6, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 7)(10, "div", 8);
    \u0275\u0275repeaterCreate(11, EventWeekViewComponent_For_12_Template, 7, 8, "div", 9, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(13, EventWeekViewComponent_For_14_Template, 1, 0, "div", 10, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275repeaterCreate(15, EventWeekViewComponent_For_16_Template, 5, 6, "div", 11, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(5);
...
}, dependencies: [MatRipple, CustomTooltipComponent, GroupEventCardComponent, AsyncPipe, DatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EventWeekViewComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: EventStateService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventWeekViewComponent, { className: "EventWeekViewComponent", filePath: "apps/concierge/src/app/events/event-week-view.component.ts", lineNumber: 123 });
})();
...
function EventMonthViewComponent_For_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(4, EventMonthViewComponent_For_5_For_5_Template, 8, 7, "button", 7, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275pipe(7, "slice");
    ...
    \u0275\u0275repeaterCreate(12, EventMonthViewComponent_For_5_For_13_Template, 7, 5, "button", 9, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(14, "async");
    \u0275\u0275pipe(15, "slice");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind3(7, 13, \u0275\u0275pipeBind1(6, 11, ctx_r3.event_day_map)[ctx_r3.dateString(day_r6.id)] || \u0275\u0275pureFunction0(24, _c05), 0, 3));
    \u0275\u0275advance(4);
    \u0275\u0275conditional((\u0275\u0275pipeBind1(9, 17, ctx_r3.event_day_map)[ctx_r3.dateString(day_r6.id)] || \u0275\u0275pureFunction0(25, _c05)).length > 3 ? 8 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275repeater(\u0275\u0275pipeBind2(15, 21, \u0275\u0275pipeBind1(14, 19, ctx_r3.event_day_map)[ctx_r3.dateString(day_r6.id)] || \u0275\u0275pureFunction0(26, _c05), 3));
  }
}
...
_EventMonthViewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventMonthViewComponent, selectors: [["event-month-view"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 6, vars: 0, consts: [["menu", "matMenu"], ["event_card", ""], [1, "absolute", "inset-0", "overflow-auto"], [1, "m-2", "grid", "h-[56rem]", "min-h-full", "w-[80rem]", "min-w-full", "grid-cols-7", "border-b", "border-base-200"], ["weekday", "", 1, "relative", "flex", "h-12", "items-center", "justify-center", "p-2", "text-sm", "opacity-60"], ["monthday", "", 1, "relative", "flex", "flex-col", "space-y-1", "border", "border-base-200"], [1, "ml-1", "mt-1", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full"], ["matRipple", "", 1, "relative", "mx-1", "h-7", "w-[calc(100%-0.5rem)]", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100", "py-1", "pl-3", "pr-2", "shadow", "hover:border-info"], ["matRipple", "", "matTooltip", "More events", 1, "relative", "mx-1", "h-7", "w-[calc(100%-0.5rem)]", "overflow-hidden", "rounded", "py-1", "pl-3", "pr-2", "text-sm", "underline", 3, "matMenuTriggerFor"], ["mat-menu-item", ""], ["matRipple", "", 1, "relative", "mx-1", "h-7", "w-[calc(100%-0.5rem)]", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100", "py-1", "pl-3", "pr-2", "shadow", "hover:border-info", 3, "click"], [1, "absolute", "inset-y-0", "left-0", "w-1.5", "bg-info"], [1, "h-full", "truncate", "text-left", "text-sm", "opacity-60"], ["customTooltip", "", "xPosition", "center", "yPosition", "bottom", 1, "absolute", "inset-0", 3, "content", "hover"], [1, "pointer-events-none", "p-2"], [3, "event"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-4"], [1, "flex-1"], [1, "rounded", "bg-base-200", "px-2", "py-1", "text-xs", "text-base-content", "opacity-60"]], template: function EventMonthViewComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 3);
    \u0275\u0275repeaterCreate(2, EventMonthViewComponent_For_3_Template, 3, 4, "div", 4, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275repeaterCreate(4, EventMonthViewComponent_For_5_Template, 16, 27, "div", 5, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
...
}, dependencies: [MatMenu, MatMenuItem, MatMenuTrigger, MatTooltip, MatRipple, CustomTooltipComponent, GroupEventCardComponent, AsyncPipe, SlicePipe, DatePipe, TranslatePipe], styles: ["\n\n.grid[_ngcontent-%COMP%] {\n  grid-template-rows: 3rem repeat(6, minmax(0, 1fr));\n}\n/*# sourceMappingURL=event-month-view.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EventMonthViewComponent, [{
    ...
    `, standalone: false, styles: ["/* angular:styles/component:css;621b776a5c5c572a196a31eafa7dd26229f2e236f44d1e7e1ede4ba9fb207c2d;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/events/event-month-view.component.ts */\n.grid {\n  grid-template-rows: 3rem repeat(6, minmax(0, 1fr));\n}\n/*# sourceMappingURL=event-month-view.component.css.map */\n"] }]
  }], () => [{ type: EventStateService }, { type: SettingsService }, { type: MatDialog }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventMonthViewComponent, { className: "EventMonthViewComponent", filePath: "apps/concierge/src/app/events/event-month-view.component.ts", lineNumber: 145 });
})();
...
_EventCalendarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventCalendarComponent, selectors: [["event-calendar"]], standalone: false, decls: 29, vars: 26, consts: [[1, "flex", "w-full", "items-center", "border-y", "border-base-200"], [1, "flex-1", "px-2", "py-4"], [1, "text-xs", "text-info"], [1, "flex-2", "flex", "items-center", "justify-center", "space-x-2"], [1, "pl-4", "font-medium"], ["icon", "", "matRipple", "", 3, "click"], [1, "flex", "flex-1", "items-center", "justify-end", "space-x-2", "py-2"], ["btn", "", "matRipple", "", 1, "rounded-3xl", 3, "click"], [1, "h-4", "w-full"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto"]], template: function EventCalendarComponent_Template(rf, ctx) {
  if (rf & 1) {
...
}, dependencies: [MatRipple, IconComponent, EventWeekViewComponent, EventMonthViewComponent, AsyncPipe, DatePipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: 100%;\n}\n/*# sourceMappingURL=event-calendar.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EventCalendarComponent, [{
    ...
    `, standalone: false, styles: ["/* angular:styles/component:css;2c590c9e56511a088a1469fe4b227d8190323c208f95620a03712f1a8f5bae8d;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/events/event-calendar.component.ts */\n:host {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: 100%;\n}\n/*# sourceMappingURL=event-calendar.component.css.map */\n"] }]
  }], () => [{ type: SettingsService }, { type: EventStateService }, { type: Router }, { type: ActivatedRoute }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventCalendarComponent, { className: "EventCalendarComponent", filePath: "apps/concierge/src/app/events/event-calendar.component.ts", lineNumber: 75 });
})();
...
_EventsListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventsListComponent, selectors: [["app-event-list"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 45, vars: 31, consts: [[1, "absolute", "inset-0", "flex", "flex-col"], [1, "flex", "items-center", "justify-between", "p-8"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 3, "routerLink"], [1, "ml-2"], [1, "text-2xl"], ["filters", "", 1, "flex", "items-center", "space-x-2", "px-8", "pb-4"], ["btn", "", "matRipple", "", 1, "rounded-3xl", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl"], [1, "pr-2"], [1, "h-full", "px-2"], [1, "h-full", "w-px", "bg-base-300"], ["appearance", "outline", 1, "no-subscript", "w-32"], [3, "ngModelChange", "ngModel"], ["value", "week"], ["value", "month"], ["appearance", "outline", 1, "no-subscript", "w-64"], [3, "value"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-y-auto", "px-8"], [1, "min-h-full", "w-full", "overflow-x-auto"], [3, "period"], [1, "absolute", "inset-0", "z-50", "flex", "items-center", "justify-center"], [1, "block"], [1, "absolute", "inset-0", "bg-base-100", "opacity-80"], [1, "max-w-[32rem]", "text-lg", "opacity-60"]], template: function EventsListComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(39, EventsListComponent_For_40_Template, 2, 2, "mat-option", 18, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(41, "div", 19);
    \u0275\u0275conditionalCreate(42, EventsListComponent_Conditional_42_Template, 2, 0, "div", 20);
    \u0275\u0275conditionalCreate(43, EventsListComponent_Conditional_43_Template, 2, 3, "event-calendar", 21);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(44, EventsListComponent_Conditional_44_Template, 5, 3, "div", 22);
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
...
}, dependencies: [NgControlStatus, NgModel, MatFormField, MatSelect, MatOption, MatRipple, IconComponent, RouterLink, EventListingComponent, EventCalendarComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  flex: 1;\n}\n/*# sourceMappingURL=events-list.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EventsListComponent, [{
    ...
    `, standalone: false, styles: ["/* angular:styles/component:css;f992f808f00abdb3d341f52af27489d2a52f705030fa77da9b19706093ffd928;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/events/events-list.component.ts */\n:host {\n  flex: 1;\n}\n/*# sourceMappingURL=events-list.component.css.map */\n"] }]
  }], () => [{ type: SettingsService }, { type: EventStateService }, { type: Router }, { type: ActivatedRoute }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventsListComponent, { className: "EventsListComponent", filePath: "apps/concierge/src/app/events/events-list.component.ts", lineNumber: 121 });
})();
...
//# sourceMappingURL=events.module-MRI4YDOM.js.map
