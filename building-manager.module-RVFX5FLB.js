...
function AutoReleaseSettingsModalComponent_main_5_For_39_Conditional_0_div_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 24)(1, "a-duration-field", 11);
    \u0275\u0275twoWayListener("ngModelChange", function AutoReleaseSettingsModalComponent_main_5_For_39_Conditional_0_div_3_Template_a_duration_field_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      const name_r4 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.settings[name_r4 + "_time_before"], $event) || (ctx_r1.settings[name_r4 + "_time_before"] = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "a-duration-field", 11);
    \u0275\u0275twoWayListener("ngModelChange", function AutoReleaseSettingsModalComponent_main_5_For_39_Conditional_0_div_3_Template_a_duration_field_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r5);
      const name_r4 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.settings[name_r4 + "_time_after"], $event) || (ctx_r1.settings[name_r4 + "_time_after"] = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.settings[name_r4 + "_time_before"]);
    \u0275\u0275advance();
    \u0275\u0275property("min", 0)("max", 60)("step", 5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.settings[name_r4 + "_time_after"]);
  }
}
function AutoReleaseSettingsModalComponent_main_5_For_39_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 21)(1, "settings-toggle", 22);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("ngModelChange", function AutoReleaseSettingsModalComponent_main_5_For_39_Conditional_0_Template_settings_toggle_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r3);
      const name_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleCustom(name_r4, $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, AutoReleaseSettingsModalComponent_main_5_For_39_Conditional_0_div_3_Template, 3, 8, "div", 23);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const name_r4 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("name", \u0275\u0275pipeBind1(2, 3, "APP.CONCIERGE.AUTO_RELEASE_" + name_r4.toUpperCase()))("ngModel", ctx_r1.settings.custom == null ? null : ctx_r1.settings.custom.includes(name_r4));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.settings.custom == null ? null : ctx_r1.settings.custom.includes(name_r4));
  }
}
function AutoReleaseSettingsModalComponent_main_5_For_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, AutoReleaseSettingsModalComponent_main_5_For_39_Conditional_0_Template, 4, 5, "div", 21);
  }
  if (rf & 2) {
    const name_r4 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275conditional(ctx_r1.settings.resources.includes(name_r4) ? 0 : -1);
  }
}
function AutoReleaseSettingsModalComponent_main_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(22, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "mat-form-field", 15)(24, "mat-select", 16);
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function AutoReleaseSettingsModalComponent_main_5_Template_mat_select_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(37, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275repeaterCreate(38, AutoReleaseSettingsModalComponent_main_5_For_39_Template, 1, 1, null, null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 22, "APP.CONCIERGE.AUTO_RELEASE_NOTIFY"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("min", -15)("max", 60)("step", 5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.settings.time_before);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(10, 24, "APP.CONCIERGE.AUTO_RELEASE_CANCEL"));
    \u0275\u0275advance(2);
    \u0275\u0275property("min", 0)("max", 60)("step", 5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.settings.time_after);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 26, "APP.CONCIERGE.AUTO_RELEASE_ALL_DAY_START"));
    \u0275\u0275advance(2);
    \u0275\u0275property("no_past_times", false)("ngModel", ctx_r1.start_hour);
    \u0275\u0275advance();
    \u0275\u0275property("name", \u0275\u0275pipeBind1(19, 28, "APP.CONCIERGE.AUTO_RELEASE_OUTSIDE_HOURS"));
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.settings.release_outside_hours);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(22, 30, "APP.CONCIERGE.AUTO_RELEASE_TYPES"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.settings.resources);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(25, 32, "APP.CONCIERGE.AUTO_RELEASE_TYPES"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(28, 34, "RESOURCE.DESKS"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(31, 36, "RESOURCE.VISITORS"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(34, 38, "RESOURCE.PARKING"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(37, 40, "RESOURCE.LOCKERS"), " ");
    \u0275\u0275advance(2);
...
function AutoReleaseSettingsModalComponent_footer_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "footer", 25)(1, "button", 26);
...
var AutoReleaseSettingsModalComponent = class _AutoReleaseSettingsModalComponent {
  get start_hour() {
    return startOfMinute(setHours(Date.now(), this.settings.all_day_start || 8)).valueOf();
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AutoReleaseSettingsModalComponent, selectors: [["auto-release-modal"]], standalone: false, decls: 9, vars: 7, consts: [["load_state", ""], [1, "m-2", "flex", "h-14", "w-[calc(100%-1rem)]", "items-center", "justify-between", "rounded", "border-none", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "w-[32rem] px-4", 4, "ngIf", "ngIfElse"], ["class", "flex justify-end border-t border-base-200 px-4 py-2", 4, "ngIf"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "text-2xl"], [1, "w-[32rem]", "px-4"], [1, "flex", "space-x-2"], [1, "flex-1"], [3, "ngModelChange", "min", "max", "step", "ngModel"], [1, "flex", "items-end", "space-x-2"], [3, "ngModelChange", "no_past_times", "ngModel"], [1, "mb-4", "flex-1", 3, "ngModelChange", "name", "ngModel"], ["appearance", "outline", 1, "w-full"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], ["value", "desk"], ["value", "visitor"], ["value", "parking"], ["value", "lockers"], [1, "mb-4", "space-y-4", "rounded-lg", "border", "border-base-200"], [3, "ngModelChange", "name", "ngModel"], ["class", "flex h-14 space-x-2 px-2", 4, "ngIf"], [1, "flex", "h-14", "space-x-2", "px-2"], [1, "flex", "justify-end", "border-t", "border-base-200", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-32"], [3, "diameter"]], template: function AutoReleaseSettingsModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, AutoReleaseSettingsModalComponent_main_5_Template, 40, 42, "main", 4)(6, AutoReleaseSettingsModalComponent_footer_6_Template, 4, 3, "footer", 5)(7, AutoReleaseSettingsModalComponent_ng_template_7_Template, 4, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        const load_state_r7 = \u0275\u0275reference(8);
        \u0275\u0275advance(2);
    ...
    }, dependencies: [NgIf, NgControlStatus, NgModel, MatFormField, MatSelect, MatOption, MatProgressSpinner, MatDialogClose, MatRipple, DurationFieldComponent, TimeFieldComponent, IconComponent, SettingsToggleComponent, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AutoReleaseSettingsModalComponent, { className: "AutoReleaseSettingsModalComponent", filePath: "apps/concierge/src/app/building-manager/auto-release-settings-modal.component.ts", lineNumber: 160 });
})();
...
var BuildingFormComponent = class _BuildingFormComponent extends AsyncHandler {
  ...
  saveChanges() {
    return __async(this, null, function* () {
      ...
      const building = yield (data.id ? Nc(data.id, body) : jc(body)).toPromise().catch((e) => {
...
var BuildingManagementService = class _BuildingManagementService {
  ...
  removeBuilding(building) {
    return __async(this, null, function* () {
      ...
      yield zc(building.id).toPromise().catch((e) => {
...
//# sourceMappingURL=building-manager.module-RVFX5FLB.js.map
