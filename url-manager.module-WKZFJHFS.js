...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(UrlListComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: UrlManagementService }, { type: SettingsService }], null);
})();
(() => {
...
_UrlManagerComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UrlManagerComponent, selectors: [["", "app-short-url-manager", ""]], standalone: false, attrs: _c02, decls: 12, vars: 6, consts: [[1, "print:hidden"], [1, "flex", "h-px", "flex-1", "print:hidden"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "mb-2", "flex", "items-center", "justify-between", "px-8", "py-4"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 3, "click"], [1, "relative", "block", "h-1/2", "w-full", "flex-1"]], template: function UrlManagerComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  ...
  }], () => [{ type: UrlManagementService }], null);
})();
(() => {
...
//# sourceMappingURL=url-manager.module-WKZFJHFS.js.map
