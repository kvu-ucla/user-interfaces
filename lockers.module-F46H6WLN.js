import {
  SharedExploreModule
} from "./chunk-NWSCCIVP.js";
import "./chunk-EUYTGKXH.js";
import {
  MatTabLink,
  MatTabNav,
  MatTabsModule
} from "./chunk-BTW3BWL5.js";
import "./chunk-XMYBBKQZ.js";
import {
  SharedBookingsModule
} from "./chunk-R6ZUMP2N.js";
import "./chunk-HFIFROFL.js";
import {
  ActivatedRoute,
...
var _LockersStateService = class _LockersStateService extends AsyncHandler {
  ...
  constructor(_org, _dialog, _settings) {
    ...
    }, { list: [], total: 0 }), tap((_) => this._loading.next(false)), shareReplay(1));
    this.has_more_pages = this.paged_bookings.pipe(map((_) => _.list.length < _.total));
...
var _c02 = (a0) => ({ key: "date", name: "Date", content: a0 });
var _c12 = (a0) => ({ key: "period", name: "Period", content: a0 });
...
var _c7 = (a0) => ({ key: "checked_in", name: "Checked In", content: a0, size: "5.5rem" });
...
function LockerBookingsComponent_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(3, 2, date_r2, "MMM"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(6, 5, date_r2, "dd"));
  }
}
function LockerBookingsComponent_ng_template_6_ng_container_0_ng_container_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(2, 2, row_r3.date, ctx_r3.time_format), " \u2013 ", \u0275\u0275pipeBind2(3, 5, row_r3.end, ctx_r3.time_format), " ");
  }
}
...
function LockerBookingsComponent_ng_template_6_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LockerBookingsComponent_ng_template_6_ng_container_0_ng_container_1_Template, 4, 8, "ng-container", 18)(2, LockerBookingsComponent_ng_template_6_ng_container_0_ng_container_2_Template, 2, 0, "ng-container", 18);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function LockerBookingsComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, LockerBookingsComponent_ng_template_6_ng_container_0_Template, 3, 2, "ng-container", 18)(1, LockerBookingsComponent_ng_template_6_ng_container_1_Template, 3, 0, "ng-container", 18);
  }
  if (rf & 2) {
    const row_r3 = ctx.row;
    \u0275\u0275property("ngIf", row_r3.status !== "declined" && !row_r3.deleted);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", row_r3.status === "declined" || row_r3.deleted);
  }
}
function LockerBookingsComponent_ng_template_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", row_r5.asset_name || row_r5.asset_id, " ");
  }
}
function LockerBookingsComponent_ng_template_10_div_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", row_r6.user_email, " ");
  }
}
function LockerBookingsComponent_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, LockerBookingsComponent_ng_template_10_div_3_Template, 2, 1, "div", 23);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const row_r6 = ctx.row;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", row_r6.user_name || row_r6.user_email || row_r6.booked_by_name || row_r6.booked_by_email, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", row_r6.user_name);
  }
}
function LockerBookingsComponent_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 25)(1, "div", 26);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "app-icon", 17);
    \u0275\u0275text(4, "arrow_drop_down");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "mat-menu", null, 7)(7, "button", 14);
    \u0275\u0275listener("click", function LockerBookingsComponent_ng_template_12_Template_button_click_7_listener() {
    ...
    \u0275\u0275text(12, "Approve Locker");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(13, "button", 14);
    \u0275\u0275listener("click", function LockerBookingsComponent_ng_template_12_Template_button_click_13_listener() {
      const row_r8 = \u0275\u0275restoreView(_r7).row;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.reject(row_r8));
    });
    \u0275\u0275elementStart(14, "div", 27)(15, "app-icon", 28);
    \u0275\u0275text(16, "event_busy");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div");
    \u0275\u0275text(18, "Decline Locker");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const row_r8 = ctx.row;
    const statusMenu_r9 = \u0275\u0275reference(6);
    \u0275\u0275classProp("bg-success", row_r8.approved)("text-white", row_r8.approved || row_r8.rejected)("bg-warning", !row_r8.approved && !row_r8.rejected)("text-black", !row_r8.approved && !row_r8.rejected)("bg-error", row_r8.rejected);
    \u0275\u0275property("matMenuTriggerFor", statusMenu_r9);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", row_r8.approved ? "Approved" : row_r8.rejected ? "Declined" : "Tentative", " ");
  }
}
function LockerBookingsComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 29)(1, "div", 26);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "app-icon", 17);
    \u0275\u0275text(4, "arrow_drop_down");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "mat-menu", null, 8)(7, "button", 14);
    \u0275\u0275listener("click", function LockerBookingsComponent_ng_template_14_Template_button_click_7_listener() {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(13, "button", 14);
    \u0275\u0275listener("click", function LockerBookingsComponent_ng_template_14_Template_button_click_13_listener() {
      const row_r11 = \u0275\u0275restoreView(_r10).row;
      const ctx_r3 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    const checkinMenu_r13 = \u0275\u0275reference(6);
    \u0275\u0275classProp("bg-neutral-600", !data_r12)("bg-success", data_r12)("opacity-30", row_r11.status === "ended");
    \u0275\u0275property("matMenuTriggerFor", checkinMenu_r13)("disabled", row_r11.status === "ended")("matTooltip", row_r11.status === "ended" ? "Locker booking has ended" : "Check-in or check-out locker");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(data_r12 ? "Yes" : "No");
  }
}
...
_LockerBookingsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerBookingsComponent, selectors: [["locker-bookings"]], decls: 25, vars: 33, consts: [["date_template", ""], ["period_template", ""], ["locker_template", ""], ["user_template", ""], ["status_template", ""], ["option_template", ""], ["menu", "matMenu"], ["statusMenu", "matMenu"], ["checkinMenu", "matMenu"], [1, "w-full", "h-4"], [1, "overflow-auto", "h-full", "w-full", "px-4", "pb-4"], [1, "min-w-[76rem]", "block", "text-sm", "w-full", 3, "data", "columns", "sortable", "empty_message"], ["btn", "", "matRipple", "", "class", "absolute bottom-2 left-2 w-32 mx-auto my-4", 3, "click", 4, "ngIf"], ["icon", "", "matRipple", "", 1, "absolute", "bottom-2", "right-2", "bg-base-100", "shadow", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "flex-col", "items-center", "justify-center", "w-full", "px-4", "py-2"], [1, "opacity-60"], [1, "text-xl"], [4, "ngIf"], [1, "text-xs", "py-1", "px-2", "bg-error", "rounded-2xl", "text-white"], [1, "p-4"], [1, "flex", "flex-col", "justify-center", "px-4", "py-2"], [1, "select-all"], ["class", "text-xs opacity-30 select-all", 4, "ngIf"], [1, "text-xs", "opacity-30", "select-all"], ["matRipple", "", 1, "rounded-3xl", "px-2", "py-1", "flex", "items-center", "space-x-2", "capitalize", 3, "matMenuTriggerFor"], [1, "ml-2"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], ["matRipple", "", 1, "rounded-3xl", "px-2", "py-1", "text-white", "flex", "items-center", "space-x-2", 3, "matMenuTriggerFor", "disabled", "matTooltip"], ["btn", "", "matRipple", "", 1, "absolute", "bottom-2", "left-2", "w-32", "mx-auto", "my-4", 3, "click"]], template: function LockerBookingsComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "async");
    \u0275\u0275template(4, LockerBookingsComponent_ng_template_4_Template, 7, 8, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(6, LockerBookingsComponent_ng_template_6_Template, 2, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(8, LockerBookingsComponent_ng_template_8_Template, 2, 1, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(10, LockerBookingsComponent_ng_template_10_Template, 4, 2, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(12, LockerBookingsComponent_ng_template_12_Template, 19, 12, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(14, LockerBookingsComponent_ng_template_14_Template, 19, 10, "ng-template", null, 5, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    \u0275\u0275template(16, LockerBookingsComponent_button_16_Template, 2, 0, "button", 12);
    \u0275\u0275pipe(17, "async");
    \u0275\u0275elementStart(18, "button", 13)(19, "app-icon");
    \u0275\u0275text(20, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "mat-menu", null, 6)(23, "button", 14);
    \u0275\u0275listener("click", function LockerBookingsComponent_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.rejectAll());
    });
    \u0275\u0275text(24, "Reject All");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_10_0;
    const date_template_r15 = \u0275\u0275reference(5);
    const period_template_r16 = \u0275\u0275reference(7);
    const locker_template_r17 = \u0275\u0275reference(9);
    const user_template_r18 = \u0275\u0275reference(11);
    const status_template_r19 = \u0275\u0275reference(13);
    const option_template_r20 = \u0275\u0275reference(15);
    const menu_r21 = \u0275\u0275reference(22);
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx.bookings)("columns", \u0275\u0275pureFunction8(24, _c8, \u0275\u0275pureFunction1(10, _c02, date_template_r15), \u0275\u0275pureFunction1(12, _c12, period_template_r16), \u0275\u0275pureFunction1(14, _c22, user_template_r18), \u0275\u0275pureFunction0(16, _c32), \u0275\u0275pureFunction1(17, _c4, locker_template_r17), \u0275\u0275pureFunction0(19, _c5), \u0275\u0275pureFunction1(20, _c6, status_template_r19), \u0275\u0275pureFunction1(22, _c7, option_template_r20)))("sortable", true)("empty_message", ((tmp_10_0 = \u0275\u0275pipeBind1(3, 6, ctx.filters)) == null ? null : tmp_10_0.search) ? "No matching locker bookings" : "There are no locker booking for the currently selected date.");
    \u0275\u0275advance(14);
    \u0275\u0275property("ngIf", !ctx.loading && \u0275\u0275pipeBind1(17, 8, ctx.has_more_pages));
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockerBookingsComponent, { className: "LockerBookingsComponent", filePath: "apps/concierge/src/app/lockers/locker-bookings.component.ts", lineNumber: 204 });
})();
...
function NewLockersComponent_ng_container_17_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", \u0275\u0275pipeBind1(3, 1, ctx_r1.loading));
  }
}
...
function NewLockersComponent_mat_progress_bar_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-bar", 22);
  }
}
...
_NewLockersComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewLockersComponent, selectors: [["", "app-new-lockers", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c03, decls: 23, vars: 14, consts: [[1, "print:hidden"], [1, "flex", "flex-1", "h-px", "print:hidden"], [1, "flex", "flex-col", "flex-1", "w-1/2", "h-full"], [1, "flex", "items-center", "w-full", "py-4", "px-8", "space-x-2"], [1, "text-2xl", "font-medium"], [1, "flex-1", "w-px"], [1, "mr-2", 3, "modelChange", "model"], [1, "w-full", "flex", "items-center", "px-8", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["placeholder", "All Levels", "multiple", "", 3, "ngModelChange", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], [4, "ngIf"], [1, "flex-1", "h-1/2", "w-full", "relative", "overflow-auto", "px-4"], ["class", "w-full", "mode", "indeterminate", 4, "ngIf"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "dateChange"], ["btn", "", "icon", "", "matRipple", "", "matTooltip", "Refresh List", 1, "ml-2", "rounded", "border", "border-base-200", 3, "click", "disabled"], ["btn", "", "icon", "", "matRipple", "", "matTooltip", "Locker Restrictions", 1, "bg-primary", "text-white", "rounded", 3, "click"], ["mode", "indeterminate", 1, "w-full"]], template: function NewLockersComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275element(16, "div", 5);
    \u0275\u0275template(17, NewLockersComponent_ng_container_17_Template, 6, 3, "ng-container", 11)(18, NewLockersComponent_ng_container_18_Template, 4, 0, "ng-container", 11);
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewLockersComponent, { className: "NewLockersComponent", filePath: "apps/concierge/src/app/lockers/new-lockers.component.ts", lineNumber: 155 });
})();
...
//# sourceMappingURL=lockers.module-F46H6WLN.js.map
