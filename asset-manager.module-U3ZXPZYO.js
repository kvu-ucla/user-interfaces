...
var AssetManagerComponent = class _AssetManagerComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetManagerComponent, selectors: [["", "asset-manager", ""]], attrs: _c05, decls: 3, vars: 0, consts: [[1, "relative", "w-1/2", "flex-1", "bg-base-100", "overflow-hidden"]], template: function AssetManagerComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "sidebar");
...
var DurationFormatPipe = class _DurationFormatPipe {
  ...
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({ name: "duration", type: _DurationFormatPipe, pure: true });
  }
};
...
var NewAssetManagerComponent = class _NewAssetManagerComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewAssetManagerComponent, selectors: [["", "asset-manager", ""]], attrs: _c016, decls: 5, vars: 0, consts: [[1, "flex", "flex-1", "h-px"], [1, "flex", "flex-col", "flex-1", "w-1/2", "h-full"]], template: function NewAssetManagerComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=asset-manager.module-U3ZXPZYO.js.map
