...
var VisitorNotesModalComponent = class _VisitorNotesModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorNotesModalComponent, selectors: [["visitor-notes-modal"]], standalone: false, decls: 11, vars: 8, consts: [["loading_template", ""], [1, "font-medium", "px-2", "py-1", "text-sm", "bg-base-200", "rounded", "ml-2"], ["icon", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "p-4 w-[36rem] max-h-[65vh] overflow-auto", 4, "ngIf", "ngIfElse"], ["class", "flex justify-end space-x-2 p-2 border-t border-base-200", 4, "ngIf"], ["icon", "", "mat-dialog-close", ""], [1, "p-4", "w-[36rem]", "max-h-[65vh]", "overflow-auto"], ["appearance", "outline", 1, "w-full", "no-subscript"], ["matInput", "", 1, "resize-none", "h-[60vh]", "max-h-[64rem]", 3, "ngModelChange", "ngModel", "placeholder"], [1, "flex", "justify-end", "space-x-2", "p-2", "border-t", "border-base-200"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], ["loading", "", 1, "absolute", "inset-0", "bg-base-100", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"]], template: function VisitorNotesModalComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var VisitorsTopbarComponent = class _VisitorsTopbarComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorsTopbarComponent, selectors: [["visitors-topbar"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 18, vars: 13, consts: [[1, "flex", "items-center", "bg-base-100", "h-20", "px-4", "border-b", "border-base-200", "space-x-2"], ["appearance", "outline"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], ["placeholder", "Viewing Period", 3, "ngModelChange", "ngModel"], [3, "value"], [1, "flex-1", "w-2"], [1, "mr-2", 3, "modelChange"], [3, "dateChange"]], template: function VisitorsTopbarComponent_Template(rf, ctx) {
      if (rf & 1) {
...
function GuestListingComponent_ng_template_26_span_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(2, 1, data_r13, "zzzz", ctx_r1.tz), " ");
  }
}
function GuestListingComponent_ng_template_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
    \u0275\u0275template(3, GuestListingComponent_ng_template_26_span_3_Template, 3, 5, "span", 46);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(2, 2, data_r13, ctx_r1.time_format, ctx_r1.tz), " ");
    \u0275\u0275advance(2);
...
function GuestListingComponent_ng_template_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "async");
    \u0275\u0275pipe(3, "date");
    \u0275\u0275template(4, GuestListingComponent_ng_template_28_span_4_Template, 3, 5, "span", 46);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_13_0;
...
function GuestListingComponent_ng_template_30_a_16_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("href", item_r18.url, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", item_r18.name, " ");
  }
}
function GuestListingComponent_ng_template_30_button_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 41);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_30_button_24_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r19);
...
function GuestListingComponent_ng_template_30_button_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 41);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_30_button_32_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r20);
      const row_r17 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
...
function GuestListingComponent_ng_template_30_ng_container_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "button", 41);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_30_ng_container_33_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r21);
      const row_r17 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_30_ng_container_33_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r21);
      const row_r17 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
...
function GuestListingComponent_ng_template_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 48)(1, "button", 49)(2, "app-icon");
    \u0275\u0275text(3, "more_horiz");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "mat-menu", null, 13)(6, "button", 50)(7, "div", 42)(8, "app-icon", 43);
    \u0275\u0275text(9, "attachment");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(13, GuestListingComponent_ng_template_30_button_13_Template, 7, 3, "button", 51);
    \u0275\u0275elementStart(14, "mat-menu", null, 12);
    \u0275\u0275template(16, GuestListingComponent_ng_template_30_a_16_Template, 2, 2, "a", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "button", 41);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_30_Template_button_click_17_listener() {
      const row_r17 = \u0275\u0275restoreView(_r15).row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setExt(row_r17, "remote", true));
    });
    \u0275\u0275elementStart(18, "div", 42)(19, "app-icon", 43);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(23, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(24, GuestListingComponent_ng_template_30_button_24_Template, 7, 3, "button", 51);
    \u0275\u0275elementStart(25, "a", 53)(26, "div", 42)(27, "app-icon", 43);
    \u0275\u0275text(28, "email");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(31, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(32, GuestListingComponent_ng_template_30_button_32_Template, 7, 4, "button", 51)(33, GuestListingComponent_ng_template_30_ng_container_33_Template, 15, 6, "ng-container", 54);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const row_r17 = ctx.row;
    const guest_menu_r22 = \u0275\u0275reference(5);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("matMenuTriggerFor", guest_menu_r22);
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(23, 15, row_r17.extension_data.remote ? "APP.CONCIERGE.VISITORS_ACTION_ONSITE" : "APP.CONCIERGE.VISITORS_ACTION_REMOTE"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.can_print);
    \u0275\u0275advance();
    \u0275\u0275property("href", "mailto:" + (row_r17 == null ? null : row_r17.asset_id), \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(31, 17, (row_r17 == null ? null : row_r17.user_email) === (row_r17 == null ? null : row_r17.asset_id) ? "APP.CONCIERGE.VISITORS_ACTION_EMAIL_HOST" : "APP.CONCIERGE.VISITORS_ACTION_EMAIL_GUEST"), " ");
    \u0275\u0275advance(2);
...
function GuestListingComponent_ng_template_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_32_Template_button_click_1_listener() {
      const row_r24 = \u0275\u0275restoreView(_r23).row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.editVisitorNotes(row_r24));
    });
    \u0275\u0275elementStart(3, "app-icon", 43);
    \u0275\u0275text(4, "edit_square");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(5, GuestListingComponent_ng_template_32_div_5_Template, 4, 3, "div", 57);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", row_r24.extension_data == null ? null : row_r24.extension_data.notes == null ? null : row_r24.extension_data.notes.length);
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GuestListingComponent, selectors: [["guest-listings"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 37, vars: 84, consts: [["state_template", ""], ["person_template", ""], ["host_template", ""], ["id_template", ""], ["parking_template", ""], ["induction_template", ""], ["status_template", ""], ["time_template", ""], ["date_template", ""], ["action_template", ""], ["notes_template", ""], ["id_confirmation", ""], ["menu", "matMenu"], ["guest_menu", "matMenu"], [1, "block", "text-sm", "z-0", 3, "data", "columns", "filter", "sortable"], ["class", "bg-secondary hover:shadow-lg shadow absolute bottom-4 right-4 text-white h-12 w-12 z-20", "matTooltipPosition", "left", "icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "h-8"], ["class", "rounded h-8 w-8 flex items-center justify-center text-2xl bg-base-400 text-neutral-content mx-auto", "matTooltipPosition", "right", 3, "matTooltip", 4, "ngIf"], ["class", "rounded h-8 w-8 flex items-center justify-center text-2xl bg-warning text-warning-content mx-auto", "matTooltipPosition", "right", 3, "matTooltip", 4, "ngIf"], ["class", "rounded h-8 w-8 flex items-center justify-center text-2xl bg-success text-success-content mx-auto", "matTooltipPosition", "right", 3, "matTooltip", 4, "ngIf"], ["matTooltipPosition", "right", 1, "rounded", "h-8", "w-8", "flex", "items-center", "justify-center", "text-2xl", "bg-base-400", "text-neutral-content", "mx-auto", 3, "matTooltip"], ["matTooltipPosition", "right", 1, "rounded", "h-8", "w-8", "flex", "items-center", "justify-center", "text-2xl", "bg-warning", "text-warning-content", "mx-auto", 3, "matTooltip"], ["matTooltipPosition", "right", 1, "rounded", "h-8", "w-8", "flex", "items-center", "justify-center", "text-2xl", "bg-success", "text-success-content", "mx-auto", 3, "matTooltip"], [1, "px-4", "py-2"], ["class", "opacity-30 text-xs", 4, "ngIf"], [1, "opacity-30", "text-xs"], ["customTooltip", "", 3, "content"], ["matRipple", "", "class", "bg-success rounded-3xl px-4 py-2 text-white", 4, "ngIf"], ["matRipple", "", 1, "bg-success", "rounded-3xl", "px-4", "py-2", "text-white"], [1, "bg-base-100", "rounded", "p-2", "flex", "flex-col", "space-y-2", "my-2", "w-[20rem]"], [1, "max-w-[20rem]", "max-h-[20rem]", "object-contain", 3, "src"], ["matRipple", "", 3, "click"], ["matRipple", "", 1, "inverse", "mt-2", 3, "click"], ["class", "rounded h-8 w-8 flex items-center justify-center text-2xl bg-success text-success-content mx-auto", 4, "ngIf"], [1, "rounded", "h-8", "w-8", "flex", "items-center", "justify-center", "text-2xl", "bg-success", "text-success-content", "mx-auto"], [1, "rounded", "h-8", "w-8", "flex", "items-center", "justify-center", "text-2xl", "mx-auto"], [1, "px-4"], ["matRipple", "", 1, "rounded-3xl", "border-none", "w-[7.5rem]", "h-10", 3, "matMenuTriggerFor", "disabled"], [1, "flex", "items-center", "pl-4", "pr-2", "space-x-2"], [1, "flex-1", "text-left"], ["class", "text-2xl", 4, "ngIf"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], [1, "text-2xl", "text-error"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "flex", "items-center", "justify-end", "px-2"], ["icon", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "disabled", "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click", 4, "ngIf"], ["mat-menu-item", "", 3, "href", 4, "ngFor", "ngForOf"], ["mat-menu-item", "", 3, "href"], [4, "ngIf"], [1, "relative", "p-4", "mx-auto"], ["matTooltipPosition", "left", "icon", "", "matRipple", "", 3, "click", "matTooltip"], ["class", "absolute top-1 right-1 bg-info text-info-content rounded-full h-4 w-4 flex items-center justify-center", 3, "matTooltip", 4, "ngIf"], [1, "absolute", "top-1", "right-1", "bg-info", "text-info-content", "rounded-full", "h-4", "w-4", "flex", "items-center", "justify-center", 3, "matTooltip"], ["className", "material-symbols-rounded", 1, "text-sm"], ["matTooltipPosition", "left", "icon", "", "matRipple", "", 1, "bg-secondary", "hover:shadow-lg", "shadow", "absolute", "bottom-4", "right-4", "text-white", "h-12", "w-12", "z-20", 3, "click", "matTooltip"]], template: function GuestListingComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(10, "translate");
        \u0275\u0275pipe(11, "async");
        \u0275\u0275template(12, GuestListingComponent_ng_template_12_Template, 3, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(14, GuestListingComponent_ng_template_14_Template, 4, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(16, GuestListingComponent_ng_template_16_Template, 4, 2, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(18, GuestListingComponent_ng_template_18_Template, 4, 2, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(20, GuestListingComponent_ng_template_20_Template, 1, 1, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(22, GuestListingComponent_ng_template_22_Template, 3, 13, "ng-template", null, 5, \u0275\u0275templateRefExtractor)(24, GuestListingComponent_ng_template_24_Template, 23, 30, "ng-template", null, 6, \u0275\u0275templateRefExtractor)(26, GuestListingComponent_ng_template_26_Template, 4, 6, "ng-template", null, 7, \u0275\u0275templateRefExtractor)(28, GuestListingComponent_ng_template_28_Template, 5, 8, "ng-template", null, 8, \u0275\u0275templateRefExtractor)(30, GuestListingComponent_ng_template_30_Template, 34, 19, "ng-template", null, 9, \u0275\u0275templateRefExtractor)(32, GuestListingComponent_ng_template_32_Template, 6, 4, "ng-template", null, 10, \u0275\u0275templateRefExtractor)(34, GuestListingComponent_button_34_Template, 4, 3, "button", 15);
        \u0275\u0275pipe(35, "async");
        \u0275\u0275element(36, "div", 16);
      }
      if (rf & 2) {
        let tmp_16_0;
        const state_template_r26 = \u0275\u0275reference(13);
        const person_template_r27 = \u0275\u0275reference(15);
        const host_template_r28 = \u0275\u0275reference(17);
        const parking_template_r29 = \u0275\u0275reference(21);
        const induction_template_r30 = \u0275\u0275reference(23);
        const status_template_r31 = \u0275\u0275reference(25);
        const time_template_r32 = \u0275\u0275reference(27);
        const date_template_r33 = \u0275\u0275reference(29);
        const action_template_r34 = \u0275\u0275reference(31);
        const notes_template_r35 = \u0275\u0275reference(33);
        \u0275\u0275styleProp("min-width", 64 + ctx.extra_width + "rem");
        \u0275\u0275property("data", ctx.guests)("columns", \u0275\u0275pureFunctionV(72, _c11, [\u0275\u0275pureFunction3(31, _c0, \u0275\u0275pipeBind1(1, 7, "COMMON.CHECKED_IN"), state_template_r26, !ctx.hide_field("state")), \u0275\u0275pureFunction3(35, _c1, \u0275\u0275pipeBind1(2, 9, "FORM.TIME"), date_template_r33, !ctx.hide_field("date")), \u0275\u0275pureFunction2(39, _c2, \u0275\u0275pipeBind1(3, 11, "RESOURCE.VISITOR"), person_template_r27), \u0275\u0275pureFunction3(42, _c3, \u0275\u0275pipeBind1(4, 13, "FORM.HOST"), host_template_r28, !ctx.hide_field("user_name")), \u0275\u0275pureFunction3(46, _c4, \u0275\u0275pipeBind1(5, 15, "COMMON.CHECKED_IN"), time_template_r32, !ctx.hide_field("checked_in_at")), \u0275\u0275pureFunction3(50, _c5, \u0275\u0275pipeBind1(6, 17, "COMMON.CHECKED_OUT"), time_template_r32, !ctx.hide_field("checked_out_at")), \u0275\u0275pureFunction3(54, _c6, \u0275\u0275pipeBind1(7, 19, "COMMON.STATE"), status_template_r31, !ctx.hide_field("status")), \u0275\u0275pureFunction3(58, _c7, \u0275\u0275pipeBind1(8, 21, "BOOKINGS.INDUCTED"), induction_template_r30, !!ctx.inductions_enabled), \u0275\u0275pureFunction3(62, _c8, \u0275\u0275pipeBind1(9, 23, "RESOURCE.PARKING"), parking_template_r29, !!ctx.has_parking), \u0275\u0275pureFunction3(66, _c9, \u0275\u0275pipeBind1(10, 25, "FORM.NOTES"), notes_template_r35, !ctx.hide_field("notes")), \u0275\u0275pureFunction1(70, _c10, action_template_r34)]))("filter", \u0275\u0275pipeBind1(11, 27, ctx.search))("sortable", true);
        \u0275\u0275advance(34);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GuestListingComponent, { className: "GuestListingComponent", filePath: "apps/concierge/src/app/visitors/guest-listing.component.ts", lineNumber: 548 });
})();
...
var VisitorsComponent = class _VisitorsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorsComponent, selectors: [["", "app-visitors", ""]], standalone: false, attrs: _c02, decls: 6, vars: 3, consts: [[1, "relative", "w-full", "flex", "flex-col", "bg-base-200"], [1, "w-full"], [1, "w-full", "flex-1", "h-0"], ["class", "w-full", "mode", "indeterminate", 4, "ngIf"], ["mode", "indeterminate", 1, "w-full"]], template: function VisitorsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "sidebar");
...
var InviteVisitorModalComponent = class _InviteVisitorModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InviteVisitorModalComponent, selectors: [["invite-visitor-modal"]], standalone: false, decls: 2, vars: 1, consts: [[1, "relative", "min-w-[40rem]", "min-h-[40rem]"], [3, "done", "date"]], template: function InviteVisitorModalComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var NewVisitorsComponent = class _NewVisitorsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewVisitorsComponent, selectors: [["", "app-new-visitors", ""]], standalone: false, attrs: _c03, decls: 26, vars: 18, consts: [[1, "flex", "flex-1", "h-px"], [1, "flex", "flex-col", "flex-1", "w-1/2", "h-full"], [1, "flex", "items-center", "px-8", "py-4", "space-x-2"], [1, "text-2xl", "font-medium"], [1, "flex-1", "w-2"], [1, "mr-2", 3, "modelChange"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], [1, "flex", "items-center", "px-8", "pb-4"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [3, "dateChange"], [1, "mx-8", "flex-1", "h-1/2", "overflow-auto"], ["class", "w-full", "mode", "indeterminate", 4, "ngIf"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], ["mode", "indeterminate", 1, "w-full"]], template: function NewVisitorsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=visitors.module-2D3NTPIT.js.map
