...
} from "./chunk-5UQD7WOV.js";
import "./chunk-KZ26LSLF.js";
import "./chunk-VEQCIHWS.js";
import {
  SharedUsersModule,
  UserPipe
...
var DayviewSpaceComponent = class _DayviewSpaceComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DayviewSpaceComponent, selectors: [["dayview-space"]], inputs: { space: "space" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [[4, "ngIf"], [3, "event", 4, "ngFor", "ngForOf"], [3, "event"]], template: function DayviewSpaceComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var DayViewComponent = class _DayViewComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DayViewComponent, selectors: [["", "app-dayview", ""]], attrs: _c02, decls: 4, vars: 0, consts: [[1, "h-full"], [1, "relative", "overflow-hidden", "flex", "flex-col", "flex-1", "w-1/2", "h-full", "bg-base-200"]], template: function DayViewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
function EventFormComponent_form_0_div_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 12)(9, "label", 30);
    \u0275\u0275text(10, "Duration");
...
function EventFormComponent_form_0_div_41_mat_form_field_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("openedChange", function EventFormComponent_form_0_div_41_mat_form_field_4_Template_mat_form_field_openedChange_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.focusInput());
    });
    \u0275\u0275elementStart(1, "mat-select", 38)(2, "input", 39, 0);
    \u0275\u0275listener("ngModelChange", function EventFormComponent_form_0_div_41_mat_form_field_4_Template_input_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275template(5, EventFormComponent_form_0_div_41_mat_form_field_4_mat_option_5_Template, 2, 2, "mat-option", 41);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275elementEnd();
...
function EventFormComponent_form_0_div_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(4, EventFormComponent_form_0_div_41_mat_form_field_4_Template, 9, 6, "mat-form-field", 35);
    \u0275\u0275pipe(5, "async");
    \u0275\u0275template(6, EventFormComponent_form_0_div_41_mat_form_field_6_Template, 5, 4, "mat-form-field", 36);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function EventFormComponent_form_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(32, ":");
    \u0275\u0275elementEnd();
    \u0275\u0275element(33, "a-user-list-field", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "div", 12)(35, "label", 17);
    \u0275\u0275text(36, "Space");
    ...
    \u0275\u0275text(39, ":");
    \u0275\u0275elementEnd();
    \u0275\u0275element(40, "space-list-field", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275template(41, EventFormComponent_form_0_div_41_Template, 7, 10, "div", 19);
    \u0275\u0275pipe(42, "async");
    \u0275\u0275template(43, EventFormComponent_form_0_div_43_Template, 4, 2, "div", 20);
    \u0275\u0275elementStart(44, "div", 21)(45, "div", 22)(46, "label", 23);
    \u0275\u0275text(47, "Setup Duration");
    \u0275\u0275elementEnd();
    \u0275\u0275element(48, "a-duration-field", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "div", 22)(50, "label", 25);
    \u0275\u0275text(51, "Breakdown Duration");
    \u0275\u0275elementEnd();
    \u0275\u0275element(52, "a-duration-field", 26);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(22);
    \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(42, 9, ctx_r1.has_catering) && ctx_r1.form.contains("catering"));
    \u0275\u0275advance(2);
...
var EventFormComponent = class _EventFormComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventFormComponent, selectors: [["event-form"]], inputs: { form: "form" }, decls: 1, vars: 1, consts: [["input", ""], [3, "formGroup", 4, "ngIf"], [3, "formGroup"], [1, "flex", "flex-col"], ["for", "title"], ["appearance", "outline"], ["matInput", "", "name", "title", "formControlName", "title", "placeholder", "Meeting Title"], [1, "flex", "flex-col", "relative"], ["for", "date"], ["name", "date", "formControlName", "date"], ["formControlName", "all_day", "class", "absolute -top-2 right-0", 4, "ngIf"], ["class", "flex space-x-2", 4, "ngIf"], [1, "flex", "flex-col", "flex-1"], ["for", "organiser"], ["name", "organiser", "formControlName", "organiser", 1, "mb-4"], ["for", "attendees"], ["name", "attendees", "formControlName", "attendees"], ["for", "space"], ["formControlName", "resources", 1, "w-full"], ["class", "py-2", 4, "ngIf"], ["class", "flex flex-col flex-1 mb-4", 4, "ngIf"], [1, "flex", "space-x-2"], [1, "flex", "flex-col", "space-y-2", "flex-1"], ["for", "setup"], ["name", "setup", "formControlName", "setup_time", 3, "min", "custom_options"], ["for", "breakdown"], ["name", "breakdown", "formControlName", "breakdown_time", 3, "min", "custom_options"], ["formControlName", "all_day", 1, "absolute", "-top-2", "right-0"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "use_24hr"], ["for", "duration"], ["name", "duration", "formControlName", "duration", 3, "time", "use_24hr"], [1, "py-2"], ["for", "catering"], ["name", "catering", "formControlName", "catering", 3, "options"], ["appearance", "outline", "class", "w-full mt-2", 3, "openedChange", 4, "ngIf"], ["appearance", "outline", "class", "w-full", 3, "mt-2", 4, "ngIf"], ["appearance", "outline", 1, "w-full", "mt-2", 3, "openedChange"], ["formControlName", "catering_charge_code", "placeholder", "Charge Code"], ["placeholder", "Search charge codes...", 1, "sticky", "top-0", "bg-base-100", "px-4", "py-3", "text-base", "border-x-0", "border-t-0", "border-b", "focus:border-b", "border-base-200", "w-full", "rounded-none", "z-50", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "hidden"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "formControlName", "catering_notes", "placeholder", "Extra catering details..."], [1, "flex", "flex-col", "flex-1", "mb-4"], ["formControlName", "assets", 3, "date", "duration"]], template: function EventFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, EventFormComponent_form_0_Template, 53, 13, "form", 1);
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventFormComponent, { className: "EventFormComponent", filePath: "apps/concierge/src/app/day-view/event-form.component.ts", lineNumber: 170 });
})();
...
function RoomBookingsApprovalsComponent_div_17_img_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    let tmp_3_0;
    const event_r2 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("source", (tmp_3_0 = \u0275\u0275pipeBind1(2, 3, \u0275\u0275pipeBind1(1, 1, event_r2.resources[0] == null ? null : event_r2.resources[0].email))) == null ? null : tmp_3_0.images[0]);
  }
}
function RoomBookingsApprovalsComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "date");
    \u0275\u0275pipe(6, "date");
    \u0275\u0275template(7, RoomBookingsApprovalsComponent_div_17_span_7_Template, 3, 5, "span", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 17);
    \u0275\u0275template(9, RoomBookingsApprovalsComponent_div_17_img_9_Template, 3, 5, "img", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 19)(11, "div", 20)(12, "app-icon", 21);
    \u0275\u0275text(13, "place");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(19, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 19)(21, "div", 20)(22, "app-icon", 21);
    \u0275\u0275text(23, "person");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", function RoomBookingsApprovalsComponent_div_17_Template_button_click_27_listener() {
    ...
    \u0275\u0275text(29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "app-icon", 25);
    \u0275\u0275text(31, "done");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "button", 26);
    \u0275\u0275listener("click", function RoomBookingsApprovalsComponent_div_17_Template_button_click_32_listener() {
      const event_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind3(5, 11, event_r2.date, "mediumDate", ctx_r2.tz), " ", \u0275\u0275pipeBind3(6, 15, event_r2.date, ctx_r2.time_format, ctx_r2.tz), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r2.tz);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", event_r2.resources.length);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", ((tmp_6_0 = event_r2.resources.length && \u0275\u0275pipeBind1(17, 21, \u0275\u0275pipeBind1(16, 19, event_r2.resources[0] == null ? null : event_r2.resources[0].email))) == null ? null : tmp_6_0.display_name) || ((tmp_6_0 = \u0275\u0275pipeBind1(19, 25, \u0275\u0275pipeBind1(18, 23, event_r2.resources[0] == null ? null : event_r2.resources[0].email))) == null ? null : tmp_6_0.name) || "No Location", " ");
    \u0275\u0275advance(10);
...
function RoomBookingsApprovalsComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29);
    \u0275\u0275element(1, "div", 30)(2, "mat-spinner", 31);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsApprovalsComponent, selectors: [["room-bookings-approvals"]], decls: 21, vars: 19, consts: [[1, "flex", "flex-col", "h-full", "overflow-hidden", "border-l", "border-base-200", "w-[20rem]"], [1, "flex", "items-center", "p-2", "justify-center", "border-b", "border-base-200", "space-x-2", "relative"], ["btn", "", "icon", "", "matRipple", "", "matTooltip", "Hide Pending Approvals", "matTooltipPosition", "left", 1, "absolute", "top-3", "left-2", "bg-base-200", 3, "click"], [1, "flex-1", "py-3", "text-center"], [1, "border-b", "border-base-200", "relative", "-mt-px"], ["type", "text", "placeholder", "Search...", 1, "w-full", "py-4", "pr-4", "pl-10", 3, "ngModelChange", "ngModel"], [1, "absolute", "top-1/2", "left-2", "-translate-y-1/2", "text-2xl", "pointer-events-none"], [1, "flex-1", "overflow-auto", "p-2", "space-y-2"], ["class", "w-full h-full flex flex-col items-center justify-center space-y-2", 4, "ngIf"], ["class", "relative border border-base-200 p-2 w-full rounded", 4, "ngFor", "ngForOf"], ["class", "absolute bottom-0 left-0 right-0 top-14 p-2 flex flex-col items-center justify-center space-y-2", 4, "ngIf"], ["btn", "", "icon", "", "matRipple", "", "class", "bg-warning absolute top-3 -left-8 shadow text-warning-content", "matTooltip", "Show Pending Approvals", "matTooltipPosition", "left", 3, "click", 4, "ngIf"], [1, "w-full", "h-full", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], ["src", "assets/icons/no-pending.svg"], [1, "relative", "border", "border-base-200", "p-2", "w-full", "rounded"], [1, "opacity-30", "text-xs", "mb-2"], [4, "ngIf"], [1, "w-64", "h-32", "overflow-hidden", "mb-2", "bg-base-200"], ["auth", "", "class", "object-cover min-w-full min-h-full", 3, "source", 4, "ngIf"], [1, "flex", "items-center", "space-x-2", "mb-2"], [1, "h-8", "w-8", "bg-base-200", "rounded-full", "flex", "items-center", "justify-center"], [1, "text-xl"], [1, "flex-1", "text-xs"], [1, "flex", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "border-success", "bg-success-light", "text-black", "flex", "flex-1", "items-center", "space-x-2", 3, "click", "disabled"], [1, "text-success"], ["btn", "", "matRipple", "", 1, "border-error", "bg-error-light", "text-black", "flex", "flex-1", "items-center", "space-x-2", 3, "click", "disabled"], [1, "text-error"], ["auth", "", 1, "object-cover", "min-w-full", "min-h-full", 3, "source"], [1, "absolute", "bottom-0", "left-0", "right-0", "top-14", "p-2", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "absolute", "inset-0", "bg-base-100", "opacity-80", "z-0"], ["diameter", "32"], [1, "relative", "z-10"], ["btn", "", "icon", "", "matRipple", "", "matTooltip", "Show Pending Approvals", "matTooltipPosition", "left", 1, "bg-warning", "absolute", "top-3", "-left-8", "shadow", "text-warning-content", 3, "click"]], template: function RoomBookingsApprovalsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(16, "async");
        \u0275\u0275template(17, RoomBookingsApprovalsComponent_div_17_Template, 37, 27, "div", 9);
        \u0275\u0275pipe(18, "async");
        \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsApprovalsComponent, { className: "RoomBookingsApprovalsComponent", filePath: "apps/concierge/src/app/day-view/room-approvals.component.ts", lineNumber: 179 });
})();
...
var NewDayViewComponent = class _NewDayViewComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDayViewComponent, selectors: [["", "app-new-dayview", ""]], attrs: _c07, decls: 5, vars: 0, consts: [[1, "flex", "flex-1", "h-px"], [1, "relative", "flex", "flex-col", "flex-1", "w-1/2", "h-full"]], template: function NewDayViewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=day-view.module-TA7PQLYF.js.map
