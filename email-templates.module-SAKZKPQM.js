...
var _EmailTemplatesStateService = class _EmailTemplatesStateService extends AsyncHandler {
  constructor() {
    ...
    this.template_definitions = combineLatest([
      ...
      this._change
    ]).pipe(filter(([bld]) => !!bld), switchMap(() => fu(this._org.organisation.id, "email_template_fields").pipe(map((_) => {
    ...
    this.templates = combineLatest([
      ...
      fu(this._org.organisation.id, "email_templates").pipe(map((_) => this._processTemplates(_, this._org.organisation.id)), catchError(() => of([]))),
      fu(bld.id, "email_templates").pipe(map((_) => this._processTemplates(_, bld.id)), catchError(() => of([]))),
      region ? fu(region.id, "email_templates").pipe(map((_) => this._processTemplates(_, region.id)), catchError(() => of([]))) : of([])
  ...
  saveTemplate(template, old_zone = "") {
    return __async(this, null, function* () {
      ...
      if (template.id && old_zone) {
        const old_metadata = yield lastValueFrom(fu(old_zone, "email_templates"));
        if (old_metadata.details instanceof Array) {
          yield lastValueFrom(hu(old_zone, {
      ...
      const metadata = yield lastValueFrom(fu(template.zone_id, "email_templates"));
      ...
      yield lastValueFrom(hu(template.zone_id, {
        name: `email_templates`,
...
function EmailTemplateManageComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
function EmailTemplateManageComponent_For_19_Template(rf, ctx) {
  if (rf & 1) {
...
function EmailTemplateManageComponent_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
...
function EmailTemplateManageComponent_For_41_For_3_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function EmailTemplateManageComponent_For_41_For_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 23);
    \u0275\u0275listener("click", function EmailTemplateManageComponent_For_41_For_3_Template_button_click_0_listener() {
    ...
    \u0275\u0275text(8, ":");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(9, EmailTemplateManageComponent_For_41_For_3_Conditional_9_Template, 2, 0, "icon", 21);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function EmailTemplateManageComponent_For_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "label", 35);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(2, EmailTemplateManageComponent_For_41_For_3_Template, 10, 3, "button", 25, \u0275\u0275repeaterTrackByIdentity);
  }
  if (rf & 2) {
...
function EmailTemplateManageComponent_For_49_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 23);
    \u0275\u0275listener("click", function EmailTemplateManageComponent_For_49_Template_button_click_0_listener() {
...
function EmailTemplateManageComponent_Conditional_50_Template(rf, ctx) {
  if (rf & 1) {
...
function EmailTemplateManageComponent_Conditional_73_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "footer", 34)(1, "button", 43);
    \u0275\u0275listener("click", function EmailTemplateManageComponent_Conditional_73_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r4 = \u0275\u0275nextContext();
...
function EmailTemplateManageComponent_ng_template_74_Template(rf, ctx) {
  if (rf & 1) {
...
_EmailTemplateManageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplateManageComponent, selectors: [["email-template-manage"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 76, vars: 58, consts: [["trigger_menu", "matMenu"], ["tracking_menu", "matMenu"], ["load_state", ""], [1, "absolute", "inset-0", "overflow-auto", "bg-base-100"], [1, "sticky", "top-0", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[40rem]", "items-center", "justify-between", "rounded", "border-none", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", 3, "routerLink"], [1, "z-0", "mx-auto", "my-2", "w-full", "max-w-[40rem]", "overflow-visible", "p-4", 3, "formGroup"], [1, "flex", "items-center", "space-x-4"], [1, "w-1/4", "flex-1", "space-y-2"], ["for", "zone"], ["appearance", "outline", 1, "w-full"], ["name", "zone", "formControlName", "zone_id", 3, "placeholder"], ["value", ""], [3, "value"], [1, "w-1/4", "flex-1", "space-y-2", "pb-6"], ["for", "trigger"], ["duration-field", "", "matRipple", "", 1, "flex", "h-12", "w-full", "items-center", "justify-between", "rounded", "border", "border-neutral", "px-2", 3, "click", "matMenuTriggerFor"], [1, "flex", "w-1/2", "flex-1", "flex-col", "px-2", "text-left", "leading-tight"], [1, "truncate"], [1, "truncate", "opacity-30"], [1, "text-2xl"], [1, "max-h-[24rem]"], ["mat-menu-item", "", 3, "click"], ["btn", "", "matRipple", "", "matTooltip", "Values that get replaced in the email template when sent", 1, "mt-2", "flex-1", 3, "disabled", "matMenuTriggerFor"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "disabled"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "flex-1"], ["matInput", "", "formControlName", "reply_to", 3, "placeholder"], ["matInput", "", "formControlName", "from", 3, "placeholder"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Template Subject", "formControlName", "subject"], ["formControlName", "html", 1, "block", "min-h-[calc(100vh-32rem)]", 3, "placeholder", "images_allowed"], [1, "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "-translate-x-1/2", "items-center", "justify-end", "rounded", "border-none", "bg-base-200", "px-4", "py-2"], [1, "p-4"], [1, "flex", "items-center", "space-x-2", "pl-2"], [1, "my-2", "flex", "flex-1", "flex-col-reverse", "leading-tight"], [1, "text-xs", "opacity-30"], [1, "text-sm"], [1, "opacity-0"], [1, "flex", "flex-col", "leading-tight"], [1, "font-mono", "text-sm"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], [1, "absolute", "inset-0", "bg-base-100"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"]], template: function EmailTemplateManageComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, EmailTemplateManageComponent_Conditional_5_Template, 3, 2, "a", 6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(17, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(18, EmailTemplateManageComponent_For_19_Template, 2, 2, "mat-option", 14, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(20, "async");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function EmailTemplateManageComponent_Template_button_click_28_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(31);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(32, EmailTemplateManageComponent_Conditional_32_Template, 3, 3, "div", 20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "icon", 21);
    \u0275\u0275text(34, " arrow_drop_down ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "mat-menu", 22, 0)(37, "button", 23);
    ...
    \u0275\u0275pipe(39, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(40, EmailTemplateManageComponent_For_41_Template, 4, 1, null, null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(42, "async");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(45, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "mat-menu", 22, 1);
    \u0275\u0275repeaterCreate(48, EmailTemplateManageComponent_For_49_Template, 6, 2, "button", 25, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275conditionalCreate(50, EmailTemplateManageComponent_Conditional_50_Template, 3, 4, "button", 26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "div", 27)(52, "mat-form-field", 28);
    ...
    \u0275\u0275pipe(57, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(58, "mat-form-field", 28);
    ...
    \u0275\u0275pipe(63, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(64, "mat-form-field", 11)(65, "icon", 31);
    ...
    \u0275\u0275pipe(70, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(71, "rich-text-input", 33);
    \u0275\u0275pipe(72, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(73, EmailTemplateManageComponent_Conditional_73_Template, 4, 3, "footer", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275template(74, EmailTemplateManageComponent_ng_template_74_Template, 5, 2, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const trigger_menu_r10 = \u0275\u0275reference(36);
    const tracking_menu_r11 = \u0275\u0275reference(47);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 24, (ctx.template == null ? null : ctx.template.id) ? "APP.CONCIERGE.EMAIL_TEMPLATES_EDIT" : "APP.CONCIERGE.EMAIL_TEMPLATES_NEW"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx.loading ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 26, "RESOURCE.BUILDING"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(14, 28, "COMMON.BUILDING_SELECT"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(17, 30, "COMMON.BUILDING_EMPTY"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(20, 32, ctx.buildings));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(23, 34, "COMMON.BUILDING_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(27, 36, "COMMON.TRIGGER"), " ");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx.active_trigger ? 32 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(39, 38, "COMMON.NONE"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(42, 40, ctx.definitions));
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", !ctx.form.value.trigger)("matMenuTriggerFor", tracking_menu_r11);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(45, 42, "APP.CONCIERGE.EMAIL_TEMPLATES_PLACEHOLDERS"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275repeater((ctx.active_trigger == null ? null : ctx.active_trigger.fields) || \u0275\u0275pureFunction0(56, _c0));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!((ctx.active_trigger == null ? null : ctx.active_trigger.fields) || \u0275\u0275pureFunction0(57, _c0)).length ? 50 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(54, 44, "APP.CONCIERGE.EMAIL_TEMPLATES_REPLY_TO"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(57, 46, "APP.CONCIERGE.EMAIL_TEMPLATES_REPLY_TO_REQUIRED"));
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(60, 48, "APP.CONCIERGE.EMAIL_TEMPLATES_FROM"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(63, 50, "APP.CONCIERGE.EMAIL_TEMPLATES_FROM_REQUIRED"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(70, 52, "APP.CONCIERGE.EMAIL_TEMPLATES_SUBJECT_REQUIRED"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(72, 54, "APP.CONCIERGE.EMAIL_TEMPLATES_BODY"))("images_allowed", true);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx.loading ? 73 : -1);
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmailTemplateManageComponent, { className: "EmailTemplateManageComponent", filePath: "apps/concierge/src/app/email-templates/email-template-manage.component.ts", lineNumber: 286 });
})();
...
_EmailTemplatesListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplatesListComponent, selectors: [["email-templates-list"]], standalone: false, decls: 29, vars: 46, consts: [["date_template", ""], ["bld_template", ""], ["trigger_template", ""], ["actions_template", ""], ["menu", "matMenu"], [1, "absolute", "inset-0", "flex", "flex-col"], [1, "flex", "items-center", "justify-between", "space-x-2", "p-8"], [1, "text-2xl", "font-medium"], [1, "flex-1"], ["btn", "", "matRipple", "", 3, "routerLink"], [1, "ml-2"], [1, "text-2xl"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-y-auto", "px-8"], [1, "min-h-full", "w-full", "overflow-x-auto"], ["empty_message", "No group events for selected period", 1, "block", "w-full", "min-w-[56rem]", "text-sm", 3, "data", "columns", "sortable"], [1, "p-4", "opacity-60"], [1, "p-4"], [1, "opacity-30"], [1, "p-4", "font-mono", "text-xs"], ["icon", "", "matRipple", "", 1, "mx-auto", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], ["mat-menu-item", "", 3, "routerLink"], [1, "text-2xl", "text-error"]], template: function EmailTemplatesListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
}, dependencies: [MatMenu, MatMenuItem, MatMenuTrigger, MatRipple, IconComponent, SimpleTableComponent, RouterLink, AsyncPipe, DatePipe, TranslatePipe, BuildingPipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmailTemplatesListComponent, { className: "EmailTemplatesListComponent", filePath: "apps/concierge/src/app/email-templates/email-templates-list.component.ts", lineNumber: 161 });
})();
...
_EmailTemplatesComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplatesComponent, selectors: [["", "app-email-templates", ""]], standalone: false, attrs: _c03, decls: 5, vars: 0, consts: [[1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"]], template: function EmailTemplatesComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EmailTemplatesComponent, [{
    ...
    `, standalone: false, styles: ["/* angular:styles/component:css;08c828c36224658230d6844bbbe8551e02a5c30c320aa5e48c90063783b9b8fa;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/email-templates/email-templates.component.ts */\n:host {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: 100%;\n  background-color: var(--b1);\n}\n/*# sourceMappingURL=email-templates.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
//# sourceMappingURL=email-templates.module-SAKZKPQM.js.map
