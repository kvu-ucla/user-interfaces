...
var CateringComponent = class _CateringComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringComponent, selectors: [["", "app-catering", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c0, decls: 9, vars: 4, consts: [[1, "relative", "flex", "w-full", "flex-col", "bg-base-200"], [1, "relative", "z-10"], ["class", "flex items-center justify-center bg-info p-2 text-sm text-info-content", 4, "ngIf"], [1, "flex", "h-1/2", "w-full", "flex-1", "overflow-auto"], [3, "ngSwitch"], ["class", "flex-1", 4, "ngSwitchCase"], ["class", "flex flex-1 flex-wrap items-center justify-center", 4, "ngSwitchDefault"], [1, "flex", "items-center", "justify-center", "bg-info", "p-2", "text-sm", "text-info-content"], [1, "flex-1"], [1, "flex", "flex-1", "flex-wrap", "items-center", "justify-center"], ["matRipple", "", 1, "flex", "flex-col", "items-center", "rounded", "bg-base-100", "text-black", "shadow", 3, "routerLink"], ["name", "img", 1, "relative", "flex", "w-full", "flex-1", "items-center", "justify-center", "bg-cover", "bg-center", "text-2xl", "text-white"], [1, "absolute", "inset-0", "z-0", "bg-neutral", "opacity-60"], [1, "z-10"], [1, "flex", "h-14", "w-full", "items-center", "justify-center", "p-2", "text-center", "text-sm"]], template: function CateringComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "sidebar");
        \u0275\u0275elementStart(1, "main", 0);
        \u0275\u0275element(2, "catering-topbar", 1);
        \u0275\u0275template(3, CateringComponent_div_3_Template, 3, 3, "div", 2);
    ...
    }, dependencies: [NgIf, NgSwitch, NgSwitchCase, NgSwitchDefault, SidebarComponent, MatRipple, CateringMenuComponent, CateringOrderListComponent, RouterLink, CateringTopbarComponent, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  height: 100%;\n  width: 100%;\n}\na[_ngcontent-%COMP%] {\n  width: 28rem;\n  height: 16rem;\n  margin-left: 0.5rem;\n  text-decoration: none;\n  transition: background 200ms;\n}\na[_ngcontent-%COMP%]:hover {\n  opacity: 0.8;\n}\na[_ngcontent-%COMP%]:first-child {\n  margin: 0;\n}\n/*# sourceMappingURL=catering.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringComponent, { className: "CateringComponent", filePath: "apps/concierge/src/app/catering/catering.component.ts", lineNumber: 110 });
})();
...
var NewCateringComponent = class _NewCateringComponent extends AsyncHandler {
  constructor(_route) {
    super();
    this._route = _route;
  }
  ...
  static {
    this.\u0275fac = function NewCateringComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NewCateringComponent)(\u0275\u0275directiveInject(ActivatedRoute));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewCateringComponent, selectors: [["", "app-new-catering", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c02, decls: 12, vars: 4, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "relative", "z-10"], [1, "flex", "h-1/2", "flex-1", "flex-col", "px-8"], ["class", "mb-4 flex items-center justify-center rounded bg-info p-2 text-sm text-white", 4, "ngIf"], [1, "flex", "h-1/2", "w-full", "flex-1", "overflow-auto"], [3, "ngSwitch"], ["class", "flex-1", 4, "ngSwitchCase"], ["class", "flex flex-1 flex-wrap items-center justify-center", 4, "ngSwitchDefault"], [1, "mb-4", "flex", "items-center", "justify-center", "rounded", "bg-info", "p-2", "text-sm", "text-white"], [1, "flex-1"], [1, "flex", "flex-1", "flex-wrap", "items-center", "justify-center"], ["matRipple", "", 1, "flex", "flex-col", "items-center", "rounded", "bg-base-100", "text-black", "shadow", 3, "routerLink"], ["name", "img", 1, "relative", "flex", "w-full", "flex-1", "items-center", "justify-center", "bg-cover", "bg-center", "text-2xl", "text-white"], [1, "absolute", "inset-0", "z-0", "bg-neutral", "opacity-60"], [1, "z-10"], [1, "flex", "h-14", "w-full", "items-center", "justify-center", "p-2", "text-center", "text-sm"]], template: function NewCateringComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(6, NewCateringComponent_div_6_Template, 3, 3, "div", 4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewCateringComponent, { className: "NewCateringComponent", filePath: "apps/concierge/src/app/catering/new-catering.component.ts", lineNumber: 119 });
})();
...
//# sourceMappingURL=catering.module-WRG3RT33.js.map
