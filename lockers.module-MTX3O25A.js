import {
  SharedExploreModule
} from "./chunk-GUIDEHC6.js";
import "./chunk-4GH4HSWE.js";
import {
  MatTabLink,
  MatTabNav,
  MatTabsModule
} from "./chunk-RB6SE6CI.js";
import {
  BookingFormService,
  LockerGridComponent,
...
function LockerModalComponent_main_5_mat_chip_row_44_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-chip-row", 36);
    \u0275\u0275listener("removed", function LockerModalComponent_main_5_mat_chip_row_44_Template_mat_chip_row_removed_0_listener() {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 38)(4, "app-icon");
    \u0275\u0275text(5, "cancel");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function LockerModalComponent_main_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(10, "a-user-search-field", 14);
    ...
    \u0275\u0275element(15, "settings-toggle", 18)(16, "settings-toggle", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 17)(18, "div", 20)(19, "label", 21);
    \u0275\u0275text(20, "Start Column");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "a-counter", 22);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 20)(23, "label", 23);
    \u0275\u0275text(24, "Start Row");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "a-counter", 22);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "div", 17)(27, "div", 20)(28, "label", 21);
    \u0275\u0275text(29, "Width");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "a-counter", 24);
    ...
    \u0275\u0275text(33, "Height");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "a-counter", 25);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(35, "label", 26);
    \u0275\u0275text(36, "Notes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "mat-form-field", 10);
    \u0275\u0275element(38, "textarea", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "label", 28);
    \u0275\u0275text(40, " Features ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "mat-form-field", 29)(42, "mat-chip-grid", 30, 1);
    \u0275\u0275template(44, LockerModalComponent_main_5_mat_chip_row_44_Template, 6, 2, "mat-chip-row", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "input", 32);
    \u0275\u0275listener("matChipInputTokenEnd", function LockerModalComponent_main_5_Template_input_matChipInputTokenEnd_45_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.addTag($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 33)(47, "button", 34);
    \u0275\u0275text(48, " Cancel ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "button", 35);
    \u0275\u0275listener("click", function LockerModalComponent_main_5_Template_button_click_49_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(21);
    \u0275\u0275property("ngModel", ctx_r1.form.value.position[0] + 1)("ngModelOptions", \u0275\u0275pureFunction0(20, _c0))("min", 1);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.value.position[1] + 1)("ngModelOptions", \u0275\u0275pureFunction0(21, _c0))("min", 1);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", ctx_r1.form.value.size[0])("ngModelOptions", \u0275\u0275pureFunction0(22, _c0))("min", 1)("render_fn", ctx_r1.render_fn);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.value.size[1])("ngModelOptions", \u0275\u0275pureFunction0(23, _c0))("min", 1)("max", 10)("render_fn", ctx_r1.render_fn);
    \u0275\u0275advance(10);
    \u0275\u0275property("ngForOf", ctx_r1.tag_list);
    \u0275\u0275advance();
    \u0275\u0275property("matChipInputFor", chipList_r5)("matChipInputSeparatorKeyCodes", ctx_r1.separators)("matChipInputAddOnBlur", true);
  }
}
...
var LockerModalComponent = class _LockerModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerModalComponent, selectors: [["locker-modal"]], outputs: { event: "event" }, decls: 8, vars: 4, consts: [["load_state", ""], ["chipList", ""], [1, "w-[28rem]"], [1, "flex", "items-center", "justify-between", "px-2", "w-full"], [1, "px-2"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "p-4 flex flex-col", 3, "formGroup", 4, "ngIf", "ngIfElse"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "p-4", "flex", "flex-col", 3, "formGroup"], ["for", "name"], ["appearance", "outline"], ["matInput", "", "name", "name", "formControlName", "name", "placeholder", "Name"], ["for", "user"], [1, "flex", "items-center", "space-x-2", "mb-4"], ["name", "user", "formControlName", "assigned_user", 1, "flex-1"], ["icon", "", "matRipple", "", "matTooltip", "Clear Assigned User", 1, "h-12", "w-12", "min-w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click"], ["className", "material-symbols-outlined"], [1, "flex", "space-x-4", "mb-4"], ["name", "Accessible", "formControlName", "accessible", 1, "flex-1"], ["name", "Bookable", "formControlName", "bookable", 1, "flex-1"], [1, "flex-1"], ["for", "row"], [3, "ngModelChange", "ngModel", "ngModelOptions", "min"], ["for", "column"], [3, "ngModelChange", "ngModel", "ngModelOptions", "min", "render_fn"], [3, "ngModelChange", "ngModel", "ngModelOptions", "min", "max", "render_fn"], ["for", "notes"], ["matInput", "", "name", "notes", "formControlName", "notes", "placeholder", "Locker Notes"], ["for", "features"], ["appearance", "outline", 1, "w-full"], ["name", "features", "aria-label", "Tag List"], [3, "removed", 4, "ngFor", "ngForOf"], ["placeholder", "Features...", 3, "matChipInputTokenEnd", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur"], [1, "flex", "items-center", "justify-center", "space-x-2"], ["btn", "", "matRipple", "", "mat-dialog-close", "", 1, "w-32", "inverse"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [3, "removed"], [1, "truncate", "max-w-md"], ["matChipRemove", ""], [1, "p-8", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], ["diameter", "32"]], template: function LockerModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2)(1, "header", 3)(2, "h2", 4);
        \u0275\u0275text(3);
        \u0275\u0275elementEnd();
        \u0275\u0275template(4, LockerModalComponent_button_4_Template, 3, 0, "button", 5);
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, LockerModalComponent_main_5_Template, 51, 24, "main", 6);
        \u0275\u0275elementEnd();
    ...
    }, dependencies: [NgForOf, NgIf, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, FormGroupDirective, FormControlName, MatFormField, MatError, MatInput, MatTooltip, MatProgressSpinner, MatDialogClose, MatRipple, CounterComponent, UserSearchFieldComponent, IconComponent, SettingsToggleComponent, MatChipGrid, MatChipInput, MatChipRemove, MatChipRow] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockerModalComponent, { className: "LockerModalComponent", filePath: "apps/concierge/src/app/lockers/locker-modal.component.ts", lineNumber: 197 });
})();
...
function LockersTopbarComponent_mat_option_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, LockersTopbarComponent_mat_option_13_div_2_Template, 5, 3, "div", 21);
    \u0275\u0275elementStart(3, "div");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()()();
  }
...
var LockersTopbarComponent = class _LockersTopbarComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersTopbarComponent, selectors: [["lockers-topbar"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 18, vars: 15, consts: [[1, "flex", "items-center", "w-full", "py-4", "px-8", "space-x-2"], [1, "text-2xl", "font-medium"], [1, "flex-1", "w-px"], [1, "mr-2", 3, "modelChange", "model"], [3, "matTooltip"], ["btn", "", "matRipple", "", "class", "space-x-2 w-40", 3, "disabled", "click", 4, "ngIf"], ["btn", "", "matRipple", "", "class", "space-x-2 w-48", 3, "click", 4, "ngIf"], [1, "flex", "items-center", "bg-base-100", "px-8", "mb-2", "h-14"], ["appearance", "outline", 1, "w-56", "no-subscript"], ["placeholder", "All Levels", "multiple", "", 3, "ngModelChange", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], [1, "flex-1", "w-0"], ["icon", "", "matRipple", "", "class", "bg-secondary text-secondary-content rounded h-12 w-12", "matTooltip", "Locker Restrictions", 3, "click", 4, "ngIf"], [3, "dateChange", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "space-x-2", "w-40", 3, "click", "disabled"], [1, "pl-4"], [1, "text-2xl"], ["btn", "", "matRipple", "", 1, "space-x-2", "w-48", 3, "click"], [1, "pl-2"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], ["icon", "", "matRipple", "", "matTooltip", "Locker Restrictions", 1, "bg-secondary", "text-secondary-content", "rounded", "h-12", "w-12", 3, "click"], [3, "dateChange"]], template: function LockersTopbarComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=lockers.module-MTX3O25A.js.map
