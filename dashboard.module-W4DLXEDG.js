...
} from "./chunk-AB57OT4Y.js";
import {
  CalendarService
} from "./chunk-2GDVURWU.js";
import {
  AsyncHandler,
  AsyncPipe,
  BehaviorSubject,
...
var DashboardStateService = class _DashboardStateService extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function DashboardStateService_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _DashboardStateService, factory: _DashboardStateService.\u0275fac, providedIn: "root" });
  }
};
...
var DashboardAvailabilityComponent = class _DashboardAvailabilityComponent {
  constructor(_state) {
    this._state = _state;
  ...
  static {
    this.\u0275fac = function DashboardAvailabilityComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _DashboardAvailabilityComponent)(\u0275\u0275directiveInject(DashboardStateService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardAvailabilityComponent, selectors: [["a-dashboard-availability"]], standalone: false, decls: 14, vars: 13, consts: [[1, "m-0", "text-xl", "font-medium"], [1, "my-4", "flex", "flex-col", "items-center", "rounded-lg", "bg-base-100", "p-2", "shadow"], [1, "mb-2", "flex", "w-full", "items-center"], ["free-levels", "", 1, "items", "w-full", "space-y-2"], ["btn", "", "matRipple", "", "class", "w-full", 3, "routerLink", "queryParams", 4, "ngFor", "ngForOf"], ["class", "text-black/30/30 mb-2 text-sm", 4, "ngIf"], ["free-spaces", "", "class", "my-4 flex flex-col items-center rounded-lg bg-base-100 p-2 shadow", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "w-full", 3, "routerLink", "queryParams"], [1, "max-w-full", "truncate"], [1, "text-black/30/30", "mb-2", "text-sm"], ["free-spaces", "", 1, "my-4", "flex", "flex-col", "items-center", "rounded-lg", "bg-base-100", "p-2", "shadow"], [1, "items", "w-full", "space-y-2"], ["class", "text-dark-fade mb-2 text-sm", 4, "ngIf"], [1, "text-dark-fade", "mb-2", "text-sm"]], template: function DashboardAvailabilityComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardAvailabilityComponent, { className: "DashboardAvailabilityComponent", filePath: "apps/workplace/src/app/dashboard/dashboard-availability.component.ts", lineNumber: 74 });
})();

// apps/workplace/src/app/dashboard/dashboard-delivery-modal.component.ts
var DashboardDeliveryModalComponent = class _DashboardDeliveryModalComponent {
  constructor() {
  ...
  static {
    this.\u0275fac = function DashboardDeliveryModalComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _DashboardDeliveryModalComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardDeliveryModalComponent, selectors: [["dashboard-delivery-modal"]], outputs: { events: "events" }, standalone: false, decls: 47, vars: 1, consts: [[1, "flex", "items-center", "justify-between"], ["icon", "", "mat-dialog-close", ""], [1, "w-[24rem]", "p-2", 3, "formGroup"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "placeholder", "Name of items being delivered", "formControlName", "name"], ["matInput", "", "placeholder", "Description of items being delivered", "formControlName", "description"], ["matInput", "", "placeholder", "Name of sender", "formControlName", "sender"], ["placeholder", "Low", "formControlName", "priority"], [1, "flex", "items-center", "justify-center", "border-t", "border-base-200", "p-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"]], template: function DashboardDeliveryModalComponent_Template(rf, ctx) {
      if (rf & 1) {
    ...
    }, dependencies: [DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, IconComponent, MatOption, MatFormField, MatError, MatSelect, MatRipple, MatDialogClose, MatInput, FormGroupDirective, FormControlName], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardDeliveryModalComponent, { className: "DashboardDeliveryModalComponent", filePath: "apps/workplace/src/app/dashboard/dashboard-delivery-modal.component.ts", lineNumber: 71 });
})();
...
var DashboardDeliveriesComponent = class _DashboardDeliveriesComponent {
  constructor(_dialog) {
  ...
  static {
    this.\u0275fac = function DashboardDeliveriesComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _DashboardDeliveriesComponent)(\u0275\u0275directiveInject(MatDialog));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardDeliveriesComponent, selectors: [["dashboard-deliveries"]], standalone: false, decls: 6, vars: 2, consts: [["empty_state", ""], [1, "m-0", "my-2", "text-xl", "font-medium"], [1, "rounded", "bg-base-100", "p-2", "shadow"], ["class", "divide-y", 4, "ngIf", "ngIfElse"], [1, "divide-y"], ["class", "flex items-center py-2", 4, "ngFor", "ngForOf"], ["matRipple", "", 1, "mt-2", "w-full", 3, "click"], [1, "flex", "items-center", "py-2"], [1, "flex-1", "pl-2"], [1, ""], [1, "text-xs", "opacity-60"], [1, "m-4", "h-2", "w-2", "rounded-full"], [1, "flex", "items-center", "justify-center", "p-8", "opacity-40"]], template: function DashboardDeliveriesComponent_Template(rf, ctx) {
      if (rf & 1) {
    ...
    }, dependencies: [NgForOf, NgIf, MatRipple, DatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardDeliveriesComponent, { className: "DashboardDeliveriesComponent", filePath: "apps/workplace/src/app/dashboard/dashboard-deliveries.component.ts", lineNumber: 52 });
})();
...
var DashboardContactsComponent = class _DashboardContactsComponent extends AsyncHandler {
  get can_deliver() {
  ...
  static {
    this.\u0275fac = function DashboardContactsComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardContactsComponent, selectors: [["a-dashboard-contacts"]], viewQuery: function DashboardContactsComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c02, 5);
      }
      if (rf & 2) {
    ...
    }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 21, vars: 18, consts: [["menu", "matMenu"], ["input", ""], [1, "m-0", "mb-2", "text-xl", "font-medium"], ["name", "contact-list", 1, "flex", "flex-wrap", "space-y-2", "rounded-lg", "border", "border-base-200", "bg-base-300", "p-2", "pl-0", "shadow"], ["name", "contact", "class", "relative flex flex-1 flex-col items-center rounded-lg bg-base-100 p-2", 4, "ngFor", "ngForOf"], ["name", "contact", "btn", "", "matRipple", "", 1, "w-full", "flex-1", "rounded-lg", 3, "menuOpened", "menuClosed", "matMenuTriggerFor"], [1, "flex", "w-full", "flex-col", "items-center", "p-4", "text-black"], [1, "text-2xl", 3, "icon"], [1, "w-full", "whitespace-normal", "leading-tight"], ["xPosition", "before"], ["mat-menu-item", "", 1, "p-0", 3, "click"], ["placeholder", "Search for user...", 1, "w-full", "p-2", "text-base", 3, "ngModelChange", "ngModel"], ["mat-menu-item", "", 4, "ngIf"], ["mat-menu-item", "", 3, "click", 4, "ngFor", "ngForOf"], [4, "ngIf"], ["name", "contact", 1, "relative", "flex", "flex-1", "flex-col", "items-center", "rounded-lg", "bg-base-100", "p-2"], [1, "mb-2", "text-2xl", 3, "user"], ["name", "contact-name", 1, "mb-2", "text-sm"], ["icon", "", "name", "close", 3, "click"], [3, "icon"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "leading-tight"], [1, "mr-2", "text-xl", 3, "user"], [1, "flex-1"], [1, "text-dark-fade", "text-xs"]], template: function DashboardContactsComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardContactsComponent, { className: "DashboardContactsComponent", filePath: "apps/workplace/src/app/dashboard/dashboard-contacts.component.ts", lineNumber: 150 });
})();
...
var DashboardScheduledItemComponent = class _DashboardScheduledItemComponent {
  get type() {
  ...
  static {
    this.\u0275fac = function DashboardScheduledItemComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _DashboardScheduledItemComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardScheduledItemComponent, selectors: [["", "scheduled-item", ""]], inputs: { item: "item" }, standalone: false, attrs: _c03, decls: 20, vars: 24, consts: [["btn", "", "matRipple", "", 1, "mx-4", "my-1", "h-24", "w-[calc(100%-2rem)]", "rounded-none", "bg-base-100", "p-0", "hover:shadow", 3, "routerLink"], [1, "flex", "items-center", "rounded-lg", "border", "border-base-200"], ["status", "", 1, "flex", "h-24", "w-20", "flex-col", "items-center", "justify-center", "leading-tight", "text-white"], [1, "text-2xl"], [1, "font-normal"], [1, "text-xs", "font-medium", "capitalize"], [1, "flex", "flex-1", "flex-col", "p-2", "text-left"], [1, "pl-1", "text-xl"], [1, "flex", "items-center", "space-x-1", "font-normal", "leading-normal"], [1, "text-lg"], [1, "text-sm"], ["class", "flex items-center space-x-1 font-normal leading-normal", 4, "ngIf"]], template: function DashboardScheduledItemComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardScheduledItemComponent, { className: "DashboardScheduledItemComponent", filePath: "apps/workplace/src/app/dashboard/dashboard-schedule-item.component.ts", lineNumber: 67 });
})();
...
var DashboardUpcomingComponent = class _DashboardUpcomingComponent {
  ...
  static {
    this.\u0275fac = function DashboardUpcomingComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardUpcomingComponent, selectors: [["a-dashboard-upcoming"]], standalone: false, decls: 5, vars: 7, consts: [[1, "m-0", "mb-4", "text-xl", "font-medium"], ["name", "event", "class", "relative mb-4 flex overflow-hidden rounded-lg bg-base-100 shadow", 4, "ngFor", "ngForOf"], ["name", "event", 1, "relative", "mb-4", "flex", "overflow-hidden", "rounded-lg", "bg-base-100", "shadow"], ["name", "status", 1, "absolute", "rounded-lg"], ["name", "details", 1, "mr-2", "flex-1"], ["time", "", 1, "mb-2", "text-sm", "font-bold", "text-primary"], ["name", "title", 1, "mb-2", "text-sm", "font-bold"], ["name", "space", 1, "mb-2", "flex", "items-center", "text-xs"], [1, "mr-2"], [1, "text-black", 3, "click", "matTooltip"], ["name", "attendees", "class", "mb-2 flex items-center text-xs", 4, "ngIf"], ["name", "guests", "class", "flex space-x-2 text-sm", 4, "ngIf"], ["btn", "", "matRipple", "", "class", "h-12 uppercase", 3, "href", 4, "ngIf"], ["name", "attendees", 1, "mb-2", "flex", "items-center", "text-xs"], [1, "mr-2", 3, "icon"], ["name", "guests", 1, "flex", "space-x-2", "text-sm"], [3, "user", 4, "ngFor", "ngForOf"], [3, "user"], ["btn", "", "matRipple", "", 1, "h-12", "uppercase", 3, "href"]], template: function DashboardUpcomingComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "h3", 0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardUpcomingComponent, { className: "DashboardUpcomingComponent", filePath: "apps/workplace/src/app/dashboard/dashboard-upcoming.component.ts", lineNumber: 127 });
})();
...
var DashboardComponent = class _DashboardComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["", "dashboard", ""]], standalone: false, attrs: _c05, decls: 8, vars: 2, consts: [[1, "flex", "h-1/2", "flex-1", "flex-col-reverse", "bg-base-200", "sm:flex-row"], [1, "relative", "z-0", "flex", "h-1/2", "flex-1", "flex-col", "overflow-hidden", "sm:h-auto"], [1, "flex", "h-px", "flex-1", "flex-wrap", "overflow-auto", "px-0", "sm:h-auto", "sm:px-8"], ["class", "min-w-64 flex-1", 4, "ngIf"], [1, "min-w-64", "flex-1"]], template: function DashboardComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "topbar");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardComponent, { className: "DashboardComponent", filePath: "apps/workplace/src/app/dashboard/dashboard.component.ts", lineNumber: 68 });
})();
...
//# sourceMappingURL=dashboard.module-W4DLXEDG.js.map
