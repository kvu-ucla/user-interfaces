...
var _RoomAlertModalComponent = class _RoomAlertModalComponent {
  ...
  save() {
    return __async(this, null, function* () {
      this.loading = true;
      const metadata = yield fu(this._org.organisation.id, "room_alerts").toPromise().catch((e) => {
...
var _RoomModalComponent = class _RoomModalComponent extends AsyncHandler {
  constructor() {
    ...
    this.query_fn = (_) => qc({ q: _ }).pipe(map((resp) => resp.data));
  ...
  ngOnInit() {
    return __async(this, null, function* () {
      const { details } = yield fu(this._org.organisation.id, "settings").toPromise();
  ...
  save() {
    return __async(this, null, function* () {
      ...
      yield (data.id ? cc(data.id, data) : ac(data)).toPromise();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomModalComponent, { className: "RoomModalComponent", filePath: "apps/concierge/src/app/room-manager/room-modal.component.ts", lineNumber: 395 });
})();
...
var _RoomManagementService = class _RoomManagementService {
  constructor() {
    ...
    ]).pipe(switchMap(() => fu(this._org.organisation.id, "room_alerts")), map((_) => _.details || {}), shareReplay(1));
...
//# sourceMappingURL=room-manager.module-W46ZYJOG.js.map
