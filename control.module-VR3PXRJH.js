...
function ControlSpaceListItemComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 6)(8, "app-icon", 7);
...
var ControlSpaceListComponent = class _ControlSpaceListComponent extends AsyncHandler {
  constructor(_spaces, _org) {
    ...
    ]).pipe(filter(([_]) => !!_), map(([bld]) => this._spaces.filter((s) => !!s.support_url && s.zones.includes(bld.id))), map((spaces) => spaces.sort((a, b) => this.sortSpaces(a, b))));
...
//# sourceMappingURL=control.module-VR3PXRJH.js.map
