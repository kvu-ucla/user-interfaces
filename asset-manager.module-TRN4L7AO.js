...
var _AssetManagerStateService = class _AssetManagerStateService extends AsyncHandler {
  ...
  postForm() {
    return __async(this, null, function* () {
      ...
      data.other_data = Vi(other_data, [void 0, null, ""]);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetItemListComponent, { className: "AssetItemListComponent", filePath: "apps/concierge/src/app/asset-manager/asset-item-list.component.ts", lineNumber: 193 });
})();
...
//# sourceMappingURL=asset-manager.module-TRN4L7AO.js.map
