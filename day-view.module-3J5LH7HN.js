...
} from "./chunk-VOUZ7AVT.js";
import "./chunk-TKQWXB6F.js";
import {
  ActivatedRoute,
...
function DayviewTopbarComponent_mat_option_9_Template(rf, ctx) {
  if (rf & 1) {
...
function DayviewTopbarComponent_mat_option_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 12);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function DayviewTopbarComponent_mat_slide_toggle_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-slide-toggle", 13);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275listener("ngModelChange", function DayviewTopbarComponent_mat_slide_toggle_16_Template_mat_slide_toggle_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
...
var DayviewTopbarComponent = class _DayviewTopbarComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function DayviewTopbarComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DayviewTopbarComponent, selectors: [["dayview-topbar"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 19, vars: 12, consts: [[1, "flex", "h-20", "items-center", "border-b", "border-base-200", "bg-base-100", "px-4"], ["btn", "", "matRipple", "", "new", "", 1, "w-12", "overflow-hidden", "xl:w-auto", 3, "click"], [1, "flex", "items-center"], [1, "mr-2", 3, "icon"], [1, "hidden", "xl:block"], ["appearance", "outline"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], ["multiple", "", "placeholder", "No Events", 3, "ngModelChange", "ngModel"], ["class", "m-2", 3, "ngModel", "ngModelChange", 4, "ngIf"], [1, "w-0", "flex-1"], [3, "dateChange"], [3, "value"], [1, "m-2", 3, "ngModelChange", "ngModel"], [1, "text-xs"]], template: function DayviewTopbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(9, DayviewTopbarComponent_mat_option_9_Template, 2, 2, "mat-option", 7);
        \u0275\u0275pipe(10, "async");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(11, "mat-form-field", 5)(12, "mat-select", 8);
        \u0275\u0275twoWayListener("ngModelChange", function DayviewTopbarComponent_Template_mat_select_ngModelChange_12_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.type_list, $event) || (ctx.type_list = $event);
          return $event;
        });
        \u0275\u0275listener("ngModelChange", function DayviewTopbarComponent_Template_mat_select_ngModelChange_12_listener($event) {
          return ctx.updateTypes($event);
        });
        \u0275\u0275elementStart(13, "mat-select-trigger");
        \u0275\u0275text(14, "Legend");
        \u0275\u0275elementEnd();
        \u0275\u0275template(15, DayviewTopbarComponent_mat_option_15_Template, 2, 2, "mat-option", 7);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(16, DayviewTopbarComponent_mat_slide_toggle_16_Template, 4, 3, "mat-slide-toggle", 9);
        \u0275\u0275element(17, "div", 10);
        \u0275\u0275elementStart(18, "date-options", 11);
        \u0275\u0275listener("dateChange", function DayviewTopbarComponent_Template_date_options_dateChange_18_listener($event) {
      ...
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275property("icon", \u0275\u0275pureFunction0(11, _c0));
        \u0275\u0275advance(4);
        \u0275\u0275twoWayProperty("ngModel", ctx.zones);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 7, "COMMON.LEVEL_ALL"));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(10, 9, ctx.levels));
        \u0275\u0275advance(3);
    ...
    }, dependencies: [NgForOf, NgIf, NgControlStatus, NgModel, DateOptionsComponent, MatFormField, MatSelect, MatSelectTrigger, MatOption, MatSlideToggle, MatRipple, IconComponent, AsyncPipe, TranslatePipe], styles: ["\n\nbutton[_ngcontent-%COMP%] {\n  min-width: 0;\n  padding: 0 0.85rem;\n}\nmat-form-field[_ngcontent-%COMP%] {\n  height: 3.25em;\n  width: 8em;\n  margin-left: 1em;\n}\nmat-slide-toggle[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  width: 5.5em;\n  white-space: initial;\n  line-height: 1.2em;\n}\n/*# sourceMappingURL=dayview-topbar.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DayviewTopbarComponent, { className: "DayviewTopbarComponent", filePath: "apps/concierge/src/app/day-view/dayview-topbar.component.ts", lineNumber: 93 });
})();
...
var DayviewEventComponent = class _DayviewEventComponent {
  get time() {
  ...
  static {
    this.\u0275fac = function DayviewEventComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DayviewEventComponent, selectors: [["dayview-event"]], inputs: { event: "event" }, standalone: false, features: [\u0275\u0275NgOnChangesFeature], decls: 5, vars: 7, consts: [[3, "class", "top", "height", 4, "ngIf"], ["event", "", "matRipple", "", 3, "class", "top", "height", "click", 4, "ngIf"], ["cleaning", "", "class", "absolute z-20 flex w-full overflow-hidden rounded bg-base-100 p-2 shadow hover:!h-48", 3, "top", "height", 4, "ngIf"], ["event", "", "matRipple", "", 3, "click"], [1, "px-2", "py-1", "font-medium"], ["class", "flex items-center py-1", 4, "ngIf"], [1, "flex", "items-center", "py-1"], [1, "mx-2"], ["cleaning", "", 1, "absolute", "z-20", "flex", "w-full", "overflow-hidden", "rounded", "bg-base-100", "p-2", "shadow", "hover:!h-48"], [1, "w-1/2", "flex-1"]], template: function DayviewEventComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DayviewEventComponent, { className: "DayviewEventComponent", filePath: "apps/concierge/src/app/day-view/dayview-event.component.ts", lineNumber: 127 });
})();
...
var DayviewSpaceComponent = class _DayviewSpaceComponent extends AsyncHandler {
  constructor(_state) {
    super();
    this._state = _state;
  ...
  static {
    this.\u0275fac = function DayviewSpaceComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _DayviewSpaceComponent)(\u0275\u0275directiveInject(EventsStateService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DayviewSpaceComponent, selectors: [["dayview-space"]], inputs: { space: "space" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [[4, "ngIf"], [3, "event", 4, "ngFor", "ngForOf"], [3, "event"]], template: function DayviewSpaceComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DayviewSpaceComponent, { className: "DayviewSpaceComponent", filePath: "apps/concierge/src/app/day-view/dayview-space.component.ts", lineNumber: 28 });
})();
...
var DayviewTimelineComponent = class _DayviewTimelineComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function DayviewTimelineComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DayviewTimelineComponent, selectors: [["dayview-timeline"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 19, vars: 14, consts: [["scroll_el", ""], [1, "absolute", "inset-0", "flex"], [1, "time", "relative", "h-full", "w-24", "overflow-hidden", "bg-base-100"], ["header", "", 1, "relative", "z-50", "h-16"], [1, "absolute", "bottom-8", "left-0", "right-0", "top-0", "bg-base-100"], ["change-transform", "", "class", "relative z-10 h-16 border-r border-base-300", 3, "transform", 4, "ngFor", "ngForOf"], [1, "absolute", "right-0", "top-8", "h-8", "w-px", "bg-base-300"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], ["header", "", 1, "relative", "flex", "h-16", "w-full", "overflow-hidden", "border-b", "border-base-300", "border-opacity-50", "bg-base-100"], ["change-transform", "", "class", "relative h-16 w-48 min-w-[12rem]", 3, "transform", 4, "ngFor", "ngForOf"], ["content", "", 1, "relative", "flex", "flex-1", "overflow-auto", 3, "scroll"], ["class", "h-[96rem] w-48 min-w-[12rem] border-r border-base-300", 3, "space", 4, "ngFor", "ngForOf"], ["class", "absolute left-0 h-px min-w-full bg-base-300", 3, "width", "top", 4, "ngFor", "ngForOf"], ["mode", "indeterminate", "class", "absolute bottom-0 left-0 right-0", 4, "ngIf"], [3, "event", 4, "ngIf"], ["change-transform", "", 1, "relative", "z-10", "h-16", "border-r", "border-base-300"], [1, "absolute", "top-0", "w-full", "-translate-y-1/2", "transform", "text-center", "text-xs", "opacity-40"], [1, "absolute", "right-0", "top-0", "h-px", "w-2", "bg-base-300"], ["change-transform", "", 1, "relative", "h-16", "w-48", "min-w-[12rem]"], ["bar", "", 1, "absolute", "-left-px", "bottom-0", "h-8", "w-px", "bg-base-300"], [1, "name", "m-2", "text-center"], [1, "h-[96rem]", "w-48", "min-w-[12rem]", "border-r", "border-base-300", 3, "space"], [1, "absolute", "left-0", "h-px", "min-w-full", "bg-base-300"], ["mode", "indeterminate", 1, "absolute", "bottom-0", "left-0", "right-0"], [3, "event"]], template: function DayviewTimelineComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DayviewTimelineComponent, { className: "DayviewTimelineComponent", filePath: "apps/concierge/src/app/day-view/dayview-timeline.component.ts", lineNumber: 115 });
})();
...
var DayViewComponent = class _DayViewComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DayViewComponent, selectors: [["", "app-dayview", ""]], standalone: false, attrs: _c02, decls: 4, vars: 0, consts: [[1, "h-full"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col", "overflow-hidden", "bg-base-200"]], template: function DayViewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DayViewComponent, { className: "DayViewComponent", filePath: "apps/concierge/src/app/day-view/day-view.component.ts", lineNumber: 27 });
})();
...
function EventFormComponent_form_0_mat_checkbox_21_Template(rf, ctx) {
  if (rf & 1) {
...
function EventFormComponent_form_0_div_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 21)(1, "div", 12)(2, "label", 28);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    ...
    \u0275\u0275text(7, ":");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "a-time-field", 29);
    \u0275\u0275listener("ngModelChange", function EventFormComponent_form_0_div_22_Template_a_time_field_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.form.patchValue({ date: $event }));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 12)(10, "label", 30);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "translate");
    ...
    \u0275\u0275text(15, ":");
    \u0275\u0275elementEnd();
    \u0275\u0275element(16, "a-duration-field", 31);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function EventFormComponent_form_0_div_46_mat_form_field_4_mat_option_5_Template(rf, ctx) {
  if (rf & 1) {
...
function EventFormComponent_form_0_div_46_mat_form_field_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-form-field", 37);
    \u0275\u0275listener("openedChange", function EventFormComponent_form_0_div_46_mat_form_field_4_Template_mat_form_field_openedChange_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.focusInput());
    });
    \u0275\u0275elementStart(1, "mat-select", 38)(2, "input", 39, 0);
    \u0275\u0275listener("ngModelChange", function EventFormComponent_form_0_div_46_mat_form_field_4_Template_input_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.code_filter.next($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "mat-option", 40);
    \u0275\u0275template(5, EventFormComponent_form_0_div_46_mat_form_field_4_mat_option_5_Template, 2, 2, "mat-option", 41);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275elementEnd();
...
function EventFormComponent_form_0_div_46_mat_form_field_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-form-field", 43);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275element(2, "textarea", 44);
...
function EventFormComponent_form_0_div_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32)(1, "label", 33);
    \u0275\u0275text(2, "Catering:");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "catering-list-field", 34);
    \u0275\u0275template(4, EventFormComponent_form_0_div_46_mat_form_field_4_Template, 9, 6, "mat-form-field", 35);
    \u0275\u0275pipe(5, "async");
    \u0275\u0275template(6, EventFormComponent_form_0_div_46_mat_form_field_6_Template, 5, 4, "mat-form-field", 36);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function EventFormComponent_form_0_div_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 45)(1, "label", 17);
    \u0275\u0275text(2, "Assets:");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "asset-list-field", 46);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function EventFormComponent_form_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(19, ":");
    \u0275\u0275elementEnd();
    \u0275\u0275element(20, "a-date-field", 9);
    \u0275\u0275template(21, EventFormComponent_form_0_mat_checkbox_21_Template, 3, 3, "mat-checkbox", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275template(22, EventFormComponent_form_0_div_22_Template, 17, 12, "div", 11);
    ...
    \u0275\u0275text(29, ":");
    \u0275\u0275elementEnd();
    \u0275\u0275element(30, "a-user-search-field", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "div", 12)(32, "label", 15);
    \u0275\u0275text(33);
    \u0275\u0275pipe(34, "translate");
    ...
    \u0275\u0275text(37, ":");
    \u0275\u0275elementEnd();
    \u0275\u0275element(38, "a-user-list-field", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "div", 12)(40, "label", 17);
    \u0275\u0275text(41);
    \u0275\u0275pipe(42, "translate");
    \u0275\u0275elementStart(43, "span");
    \u0275\u0275text(44, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(45, "space-list-field", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275template(46, EventFormComponent_form_0_div_46_Template, 7, 10, "div", 19);
    \u0275\u0275pipe(47, "async");
    \u0275\u0275template(48, EventFormComponent_form_0_div_48_Template, 4, 2, "div", 20);
    \u0275\u0275elementStart(49, "div", 21)(50, "div", 22)(51, "label", 23);
    \u0275\u0275text(52, "Setup Duration");
    \u0275\u0275elementEnd();
    \u0275\u0275element(53, "a-duration-field", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "div", 22)(55, "label", 25);
    \u0275\u0275text(56, "Breakdown Duration");
    \u0275\u0275elementEnd();
    \u0275\u0275element(57, "a-duration-field", 26);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(47, 27, ctx_r1.has_catering) && ctx_r1.form.contains("catering"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.has_assets);
    \u0275\u0275advance(5);
    \u0275\u0275property("min", 0)("custom_options", \u0275\u0275pureFunction0(29, _c03));
    \u0275\u0275advance(4);
    \u0275\u0275property("min", 0)("custom_options", \u0275\u0275pureFunction0(30, _c03));
  }
}
var EventFormComponent = class _EventFormComponent {
  ...
  static {
    this.\u0275fac = function EventFormComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventFormComponent, selectors: [["event-form"]], inputs: { form: "form" }, standalone: false, decls: 1, vars: 1, consts: [["input", ""], [3, "formGroup", 4, "ngIf"], [3, "formGroup"], [1, "flex", "flex-col"], ["for", "title"], ["appearance", "outline"], ["matInput", "", "name", "title", "formControlName", "title", "placeholder", "Meeting Title"], [1, "relative", "flex", "flex-col"], ["for", "date"], ["name", "date", "formControlName", "date"], ["formControlName", "all_day", "class", "absolute -top-2 right-0", 4, "ngIf"], ["class", "flex space-x-2", 4, "ngIf"], [1, "flex", "flex-1", "flex-col"], ["for", "organiser"], ["name", "organiser", "formControlName", "organiser", 1, "mb-4"], ["for", "attendees"], ["name", "attendees", "formControlName", "attendees"], ["for", "space"], ["formControlName", "resources", 1, "w-full"], ["class", "py-2", 4, "ngIf"], ["class", "mb-4 flex flex-1 flex-col", 4, "ngIf"], [1, "flex", "space-x-2"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "setup"], ["name", "setup", "formControlName", "setup_time", 3, "min", "custom_options"], ["for", "breakdown"], ["name", "breakdown", "formControlName", "breakdown_time", 3, "min", "custom_options"], ["formControlName", "all_day", 1, "absolute", "-top-2", "right-0"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "use_24hr"], ["for", "duration"], ["name", "duration", "formControlName", "duration", 3, "time", "use_24hr"], [1, "py-2"], ["for", "catering"], ["name", "catering", "formControlName", "catering", 3, "options"], ["appearance", "outline", "class", "mt-2 w-full", 3, "openedChange", 4, "ngIf"], ["appearance", "outline", "class", "w-full", 3, "mt-2", 4, "ngIf"], ["appearance", "outline", 1, "mt-2", "w-full", 3, "openedChange"], ["formControlName", "catering_charge_code", "placeholder", "Charge Code"], ["placeholder", "Search charge codes...", 1, "sticky", "top-0", "z-50", "w-full", "rounded-none", "border-x-0", "border-b", "border-t-0", "border-base-200", "bg-base-100", "px-4", "py-3", "text-base", "focus:border-b", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "hidden"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "formControlName", "catering_notes", "placeholder", "Extra catering details..."], [1, "mb-4", "flex", "flex-1", "flex-col"], ["formControlName", "assets", 3, "date", "duration"]], template: function EventFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, EventFormComponent_form_0_Template, 58, 31, "form", 1);
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventFormComponent, { className: "EventFormComponent", filePath: "apps/concierge/src/app/day-view/event-form.component.ts", lineNumber: 189 });
})();
...
var BookingModalComponent = class _BookingModalComponent {
  get form() {
  ...
  static {
    this.\u0275fac = function BookingModalComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingModalComponent, selectors: [["booking-modal"]], outputs: { event: "event" }, standalone: false, decls: 15, vars: 16, consts: [[1, "w-0", "flex-1"], ["icon", "", "mat-dialog-close", ""], [1, "relative", "p-4"], [3, "form"], ["loading", "", "class", "absolute inset-0 flex flex-col items-center justify-center", 4, "ngIf"], ["class", "flex items-center justify-center border-t border-base-200 p-2", 4, "ngIf"], ["loading", "", 1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center"], [1, "mb-4", 3, "diameter"], [1, "flex", "items-center", "justify-center", "border-t", "border-base-200", "p-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"]], template: function BookingModalComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingModalComponent, { className: "BookingModalComponent", filePath: "apps/concierge/src/app/day-view/booking-modal.component.ts", lineNumber: 59 });
})();

// apps/concierge/src/app/day-view/room-booking-search.component.ts
var _c04 = ["input_el"];
var _c12 = (a0, a1) => ({ count: a0, total: a1 });
function RoomBookingSearchComponent_app_icon_7_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingSearchComponent_div_8_div_7_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingSearchComponent_div_8_button_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 14);
    \u0275\u0275listener("click", function RoomBookingSearchComponent_div_8_button_10_Template_button_click_0_listener() {
...
function RoomBookingSearchComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(7, RoomBookingSearchComponent_div_8_div_7_Template, 4, 5, "div", 10);
    \u0275\u0275pipe(8, "async");
    \u0275\u0275elementStart(9, "div", 11);
    \u0275\u0275template(10, RoomBookingSearchComponent_div_8_button_10_Template, 22, 25, "button", 12);
    \u0275\u0275pipe(11, "async");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 7, "APP.CONCIERGE.ROOMS_SEARCH_COUNT", \u0275\u0275pureFunction2(14, _c12, (tmp_2_0 = \u0275\u0275pipeBind1(4, 3, ctx_r1.filtered)) == null ? null : tmp_2_0.length, (tmp_2_0 = \u0275\u0275pipeBind1(5, 5, ctx_r1.events)) == null ? null : tmp_2_0.length)), " ");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(8, 10, ctx_r1.filtered).length);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(11, 12, ctx_r1.filtered));
  }
}
var RoomBookingSearchComponent = class _RoomBookingSearchComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function RoomBookingSearchComponent_Factory(__ngFactoryType__) {
  ...
  static {
    ...
    }, outputs: { selected: "selected" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 9, vars: 10, consts: [["input_el", ""], [1, "relative"], ["icon", "", "matRipple", "", 3, "click"], [1, "absolute", "right-0", "top-1/2", "w-[20rem]", "-translate-y-1/2", "rounded-full", "border", "border-base-300", "bg-base-100", "py-3", "pl-10", "pr-4", "shadow", 3, "ngModelChange", "blur", "ngModel", "placeholder"], ["class", "absolute right-[17.5rem] top-1/2 -translate-y-1/2 text-2xl", 4, "ngIf"], ["class", "absolute right-4 top-full max-h-[65vh] w-[18rem] translate-y-2 overflow-auto rounded border border-base-300 bg-base-100 shadow", 4, "ngIf"], [1, "absolute", "right-[17.5rem]", "top-1/2", "-translate-y-1/2", "text-2xl"], [1, "absolute", "right-4", "top-full", "max-h-[65vh]", "w-[18rem]", "translate-y-2", "overflow-auto", "rounded", "border", "border-base-300", "bg-base-100", "shadow"], [1, "sticky", "top-0", "z-10", "rounded", "bg-base-100", "p-4"], [1, "text-xs", "opacity-60"], ["class", "flex items-center justify-center p-4 text-center text-sm opacity-30", 4, "ngIf"], [1, "-mt-2", "px-2", "pb-2"], ["matRipple", "", "class", "relative z-0 flex w-full items-center space-x-2 rounded p-2 text-left hover:bg-base-200", 3, "click", 4, "ngFor", "ngForOf"], [1, "flex", "items-center", "justify-center", "p-4", "text-center", "text-sm", "opacity-30"], ["matRipple", "", 1, "relative", "z-0", "flex", "w-full", "items-center", "space-x-2", "rounded", "p-2", "text-left", "hover:bg-base-200", 3, "click"], [1, "h-10", "w-1", "rounded-full"], ["date", "", 1, "leading-tight"], [1, "mx-auto", "text-2xl"], [1, "mx-auto", "-mt-1", "text-sm", "font-medium", "uppercase"], [1, "w-1/2", "flex-1"], [1, "flex", "w-full", "items-center", "space-x-2"], [1, "flex-1", "truncate", "text-sm"], [1, "truncate", "text-xs", "opacity-30"]], template: function RoomBookingSearchComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(7, RoomBookingSearchComponent_app_icon_7_Template, 2, 0, "app-icon", 4)(8, RoomBookingSearchComponent_div_8_Template, 12, 17, "div", 5);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(4);
    ...
    }, dependencies: [NgForOf, NgIf, DefaultValueAccessor, NgControlStatus, NgModel, MatRipple, IconComponent, AsyncPipe, DatePipe, TranslatePipe, UserPipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingSearchComponent, { className: "RoomBookingSearchComponent", filePath: "apps/concierge/src/app/day-view/room-booking-search.component.ts", lineNumber: 117 });
})();
...
Host:  ${event.organiser?.name || event.host}`;
  ...
  static {
    this.\u0275fac = function RoomBookingsTimelineComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsTimelineComponent, selectors: [["room-bookings-timeline"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 32, vars: 39, consts: [["class", "mx-2 mt-2 w-[calc(100%-1rem)] rounded-lg bg-info p-2 text-center text-xs text-info-content", 4, "ngIf"], [1, "relative", "z-20", "flex", "items-center", "justify-center", "space-x-2", "border-b", "border-base-200", "p-2"], [3, "dateChange", "date", "is_new", "hide_today"], ["class", "absolute left-4 top-1/2 -translate-y-1/2 text-sm text-info", 4, "ngIf"], [1, "absolute", "right-8", "top-1/2", "-translate-y-1/2"], [3, "selected"], ["timeline", "", 1, "z-0", "grid", "h-1/2", "w-full", "flex-1", "overflow-auto"], ["timezone", "", 1, "sticky", "left-0", "top-0", "z-30", "flex", "items-center", "justify-center", "bg-base-100"], [1, "text-xs", "opacity-30"], [1, "absolute", "bottom-0", "right-0", "h-2", "w-px", "bg-base-300"], [1, "absolute", "bottom-0", "right-0", "h-px", "w-2", "bg-base-300"], ["space-headers", "", 1, "sticky", "top-0", "z-20", "flex", "items-center", "border-b", "border-base-300", "bg-base-100"], ["class", "relative flex h-full w-56 items-center justify-center", 4, "ngFor", "ngForOf"], ["hour-blocks", "", 1, "sticky", "left-0", "z-10", "overflow-visible", "border-r", "border-base-300", "bg-base-100"], ["class", "relative w-full", 3, "height", 4, "ngFor", "ngForOf"], ["class", "absolute right-0 h-2 w-2 -translate-y-1/2 translate-x-1/2 rounded-full bg-secondary", 3, "top", 4, "ngIf"], ["space-blocks", "", 1, "relative", "overflow-hidden"], ["class", "relative w-full border-b border-base-200", 3, "height", 4, "ngFor", "ngForOf"], ["class", "absolute top-0 h-full w-px bg-base-200", 3, "left", 4, "ngFor", "ngForOf"], [4, "ngFor", "ngForOf"], ["class", "absolute inset-x-0 h-[2px] bg-secondary", 3, "top", 4, "ngIf"], [1, "mx-2", "mt-2", "w-[calc(100%-1rem)]", "rounded-lg", "bg-info", "p-2", "text-center", "text-xs", "text-info-content"], [1, "absolute", "left-4", "top-1/2", "-translate-y-1/2", "text-sm", "text-info"], [1, "relative", "flex", "h-full", "w-56", "items-center", "justify-center"], [1, "truncate"], [1, "absolute", "-left-px", "bottom-0", "h-2", "w-px", "bg-base-300"], [1, "relative", "w-full"], [1, "absolute", "-top-px", "right-0", "h-px", "w-2", "bg-base-300"], ["class", "absolute -top-px right-3 -translate-y-1/2 text-xs opacity-60", 4, "ngIf"], [1, "absolute", "-top-px", "right-3", "-translate-y-1/2", "text-xs", "opacity-60"], [1, "absolute", "right-0", "h-2", "w-2", "-translate-y-1/2", "translate-x-1/2", "rounded-full", "bg-secondary"], [1, "relative", "w-full", "border-b", "border-base-200"], [1, "absolute", "top-0", "h-full", "w-px", "bg-base-200"], ["event", "", "matRipple", "", "class", "absolute w-52 text-left hover:opacity-90", 3, "left", "top", "height", "matTooltip", "click", 4, "ngIf"], ["event", "", "matRipple", "", 1, "absolute", "w-52", "text-left", "hover:opacity-90", 3, "click", "matTooltip"], [1, "relative", "h-full", "w-full", "overflow-hidden", "rounded-lg", "border", "border-base-200", "bg-base-100", "px-3", "py-1", "text-xs", "shadow", "hover:bg-base-200"], [4, "ngIf"], [1, "absolute", "-inset-px", "bg-secondary", "opacity-30"], [1, "absolute", "inset-y-0", "left-0", "w-1"], [1, "absolute", "inset-x-0", "h-[2px]", "bg-secondary"]], template: function RoomBookingsTimelineComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, RoomBookingsTimelineComponent_div_0_Template, 3, 3, "div", 0);
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(4, RoomBookingsTimelineComponent_div_4_Template, 3, 3, "div", 3);
        \u0275\u0275pipe(5, "async");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(13, 23, \u0275\u0275pipeBind1(12, 21, ctx.date), "zzzz", ctx.tz), " ");
        \u0275\u0275advance(5);
    ...
    }, dependencies: [NgForOf, NgIf, DateOptionsComponent, MatTooltip, MatRipple, RoomBookingSearchComponent, AsyncPipe, DatePipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  max-width: 100%;\n}\n[timeline][_ngcontent-%COMP%] {\n  grid-template-columns: 4rem auto;\n  grid-template-rows: 3.5rem auto;\n}\n/*# sourceMappingURL=room-timeline.component.css.map */"] });
  }
};
(() => {
...
var _c06 = (a0, a1) => ({ count: a0, total: a1 });
function RoomBookingsApprovalsComponent_div_18_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsApprovalsComponent_div_20_span_12_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsApprovalsComponent_div_20_img_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 29);
  }
  if (rf & 2) {
...
function RoomBookingsApprovalsComponent_div_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275pipe(10, "date");
    \u0275\u0275pipe(11, "date");
    \u0275\u0275template(12, RoomBookingsApprovalsComponent_div_20_span_12_Template, 3, 5, "span", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 18);
    \u0275\u0275template(14, RoomBookingsApprovalsComponent_div_20_img_14_Template, 1, 1, "img", 19);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function RoomBookingsApprovalsComponent_div_20_Template_button_click_28_listener() {
    ...
    \u0275\u0275pipe(31, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "app-icon", 26);
    \u0275\u0275text(33, "done");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(34, "button", 27);
    \u0275\u0275listener("click", function RoomBookingsApprovalsComponent_div_20_Template_button_click_34_listener() {
      const event_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(31, 28, ctx_r2.status[event_r2.id] === "accept" ? "COMMON.APPROVED" : "COMMON.APPROVE"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275property("disabled", ctx_r2.status[event_r2.id] === "decline");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(37, 30, ctx_r2.status[event_r2.id] === "decline" ? "COMMON.DECLINED" : "COMMON.DECLINE"), " ");
  }
}
function RoomBookingsApprovalsComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsApprovalsComponent_button_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 34);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function RoomBookingsApprovalsComponent_button_23_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
...
var RoomBookingsApprovalsComponent = class _RoomBookingsApprovalsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsApprovalsComponent, selectors: [["room-bookings-approvals"]], standalone: false, decls: 24, vars: 30, consts: [[1, "flex", "h-full", "w-[20rem]", "flex-col", "overflow-hidden", "border-l", "border-base-200"], [1, "relative", "flex", "items-center", "justify-center", "space-x-2", "border-b", "border-base-200", "p-2"], ["btn", "", "icon", "", "matRipple", "", "matTooltipPosition", "left", 1, "absolute", "left-2", "top-3", "bg-base-200", 3, "click", "matTooltip"], [1, "flex-1", "py-3", "text-center"], [1, "relative", "-mt-px", "border-b", "border-base-200"], ["type", "text", 1, "w-full", "py-4", "pl-10", "pr-4", 3, "ngModelChange", "placeholder", "ngModel"], [1, "pointer-events-none", "absolute", "left-2", "top-1/2", "-translate-y-1/2", "text-2xl"], [1, "flex-1", "space-y-2", "overflow-auto", "p-3"], ["class", "flex h-full w-full flex-col items-center justify-center space-y-2", 4, "ngIf"], ["class", "relative w-full rounded border border-base-300 p-2", 4, "ngFor", "ngForOf"], ["class", "absolute bottom-0 left-0 right-0 top-14 flex flex-col items-center justify-center space-y-2 p-2", 4, "ngIf"], ["btn", "", "icon", "", "matRipple", "", "class", "absolute -left-8 top-3 bg-warning text-warning-content shadow", "matTooltipPosition", "left", 3, "matTooltip", "click", 4, "ngIf"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "space-y-2"], ["src", "assets/icons/no-pending.svg"], [1, "opacity-30"], [1, "relative", "w-full", "rounded", "border", "border-base-300", "p-2"], [1, "mb-2", "text-xs", "opacity-30"], [4, "ngIf"], [1, "mb-2", "h-32", "w-64", "overflow-hidden", "bg-base-200"], ["auth", "", "class", "min-h-full min-w-full object-cover", 3, "source", 4, "ngIf"], [1, "mb-2", "flex", "items-center", "space-x-2"], [1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "bg-base-200"], [1, "text-xl"], [1, "flex-1", "text-xs"], [1, "flex", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "flex", "flex-1", "items-center", "space-x-2", "border-success", "bg-success-light", "text-black", 3, "click", "disabled"], [1, "text-success"], ["btn", "", "matRipple", "", 1, "flex", "flex-1", "items-center", "space-x-2", "border-error", "bg-error-light", "text-black", 3, "click", "disabled"], [1, "text-error"], ["auth", "", 1, "min-h-full", "min-w-full", "object-cover", 3, "source"], [1, "absolute", "bottom-0", "left-0", "right-0", "top-14", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-2"], [1, "absolute", "inset-0", "z-0", "bg-base-100", "opacity-80"], ["diameter", "32"], [1, "relative", "z-10"], ["btn", "", "icon", "", "matRipple", "", "matTooltipPosition", "left", 1, "absolute", "-left-8", "top-3", "bg-warning", "text-warning-content", "shadow", 3, "click", "matTooltip"]], template: function RoomBookingsApprovalsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(15, "app-icon", 6);
        \u0275\u0275text(16, " search ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(17, "div", 7);
        \u0275\u0275template(18, RoomBookingsApprovalsComponent_div_18_Template, 5, 3, "div", 8);
        \u0275\u0275pipe(19, "async");
        \u0275\u0275template(20, RoomBookingsApprovalsComponent_div_20_Template, 40, 32, "div", 9);
        \u0275\u0275pipe(21, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(22, RoomBookingsApprovalsComponent_div_22_Template, 6, 3, "div", 10);
        \u0275\u0275elementEnd();
        \u0275\u0275template(23, RoomBookingsApprovalsComponent_button_23_Template, 4, 3, "button", 11);
      }
      if (rf & 2) {
        let tmp_2_0;
        let tmp_5_0;
        ...
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(10, 16, "APP.CONCIERGE.ROOMS_PENDING_HEADER", \u0275\u0275pureFunction2(27, _c06, ((tmp_2_0 = \u0275\u0275pipeBind1(8, 12, ctx.filtered_pending)) == null ? null : tmp_2_0.length) || "0", ((tmp_2_0 = \u0275\u0275pipeBind1(9, 14, ctx.pending)) == null ? null : tmp_2_0.length) || "0")), " ");
        \u0275\u0275advance(5);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(13, 19, "COMMON.SEARCH"))("ngModel", \u0275\u0275pipeBind1(14, 21, ctx.search));
        \u0275\u0275advance(6);
        \u0275\u0275property("ngIf", !((tmp_5_0 = \u0275\u0275pipeBind1(19, 23, ctx.filtered_pending)) == null ? null : tmp_5_0.length));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(21, 25, ctx.filtered_pending));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", ctx.loading);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.show);
      }
    }, dependencies: [NgForOf, NgIf, DefaultValueAccessor, NgControlStatus, NgModel, MatTooltip, MatProgressSpinner, MatRipple, IconComponent, AuthenticatedImageDirective, AsyncPipe, DatePipe, TranslatePipe, SpacePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n  position: relative;\n  height: 100%;\n}\n/*# sourceMappingURL=room-approvals.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsApprovalsComponent, { className: "RoomBookingsApprovalsComponent", filePath: "apps/concierge/src/app/day-view/room-approvals.component.ts", lineNumber: 191 });
})();
...
function RoomWeekBookingsTimelineComponent_div_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, RoomWeekBookingsTimelineComponent_div_18_div_4_Template, 3, 3, "div", 20);
    \u0275\u0275element(5, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function RoomWeekBookingsTimelineComponent_div_25_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(2, 1, ctx_r1.events)[date_r5] || \u0275\u0275pureFunction0(3, _c07));
  }
}
var RoomWeekBookingsTimelineComponent = class _RoomWeekBookingsTimelineComponent extends AsyncHandler {
  ...
  viewEvent(event, space_id, scroll_to = false) {
    ...
    ref.componentInstance.hide_edit = !this._settings.get("app.events.allow_edit");
    this.subscription("remove", ref.componentInstance.remove.subscribe(() => this.remove(event)));
    this.subscription("edit", ref.componentInstance.edit.subscribe(() => this.edit(event)));
    this.subscription("actions", ref.componentInstance.action.subscribe((action) => __async(this, null, function* () {
      if (!action.includes("breakdown"))
        return;
  ...
  static {
    this.\u0275fac = function RoomWeekBookingsTimelineComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomWeekBookingsTimelineComponent, selectors: [["room-week-bookings-timeline"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 27, vars: 37, consts: [["class", "mx-2 mt-2 w-[calc(100%-1rem)] rounded-lg bg-info p-2 text-center text-xs text-info-content", 4, "ngIf"], [1, "relative", "z-20", "flex", "items-center", "justify-center", "space-x-2", "border-b", "border-base-200", "p-2"], [3, "dateChange", "date", "step", "is_new", "hide_today"], ["class", "absolute left-4 top-1/2 -translate-y-1/2 text-sm text-info", 4, "ngIf"], [1, "absolute", "right-8", "top-1/2", "-translate-y-1/2"], [3, "selected"], ["timeline", "", 1, "z-0", "grid", "h-1/2", "w-full", "flex-1", "overflow-auto"], ["timezone", "", 1, "sticky", "left-0", "top-0", "z-30", "flex", "items-center", "justify-center", "bg-base-100"], [1, "text-xs", "opacity-30"], [1, "absolute", "bottom-0", "right-0", "h-2", "w-px", "bg-base-300"], [1, "absolute", "bottom-0", "right-0", "h-px", "w-2", "bg-base-300"], ["day-headers", "", 1, "sticky", "top-0", "z-20", "flex", "min-w-[calc(100%-3rem)]", "items-center", "border-b", "border-base-300", "bg-base-100"], ["class", "relative flex h-full min-w-48 flex-1 flex-col items-center justify-center leading-tight", 4, "ngFor", "ngForOf"], ["empty-block", "", 1, "sticky", "left-0", "z-10", "min-h-full", "border-r", "border-base-300", "bg-base-100"], ["date-blocks", "", 1, "relative", "flex", "min-w-[calc(100%-3rem)]", "overflow-hidden"], ["class", "min-w-48 flex-1 overflow-hidden border-r border-base-200 p-2", 4, "ngFor", "ngForOf"], [1, "mx-2", "mt-2", "w-[calc(100%-1rem)]", "rounded-lg", "bg-info", "p-2", "text-center", "text-xs", "text-info-content"], [1, "absolute", "left-4", "top-1/2", "-translate-y-1/2", "text-sm", "text-info"], [1, "relative", "flex", "h-full", "min-w-48", "flex-1", "flex-col", "items-center", "justify-center", "leading-tight"], [1, "truncate"], ["class", "absolute bottom-1 left-1/2 -translate-x-1/2 text-xs text-info", 4, "ngIf"], [1, "absolute", "-left-px", "bottom-0", "h-2", "w-px", "bg-base-300"], [1, "absolute", "bottom-1", "left-1/2", "-translate-x-1/2", "text-xs", "text-info"], [1, "min-w-48", "flex-1", "overflow-hidden", "border-r", "border-base-200", "p-2"], ["matRipple", "", "class", "flex w-full space-x-2 rounded p-2 text-left hover:bg-base-200", 3, "click", 4, "ngFor", "ngForOf"], ["matRipple", "", 1, "flex", "w-full", "space-x-2", "rounded", "p-2", "text-left", "hover:bg-base-200", 3, "click"], [1, "my-1.5", "h-2", "w-2", "rounded-full"], [1, "w-1/2", "flex-1"], [1, "truncate", "text-sm"], [1, "flex-1", "text-xs", "opacity-60"], [4, "ngIf"], [1, "truncate", "text-xs", "opacity-30"]], template: function RoomWeekBookingsTimelineComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, RoomWeekBookingsTimelineComponent_div_0_Template, 3, 3, "div", 0);
        \u0275\u0275elementStart(1, "div", 1)(2, "date-options", 2);
        \u0275\u0275pipe(3, "async");
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(4, RoomWeekBookingsTimelineComponent_div_4_Template, 3, 3, "div", 3);
        \u0275\u0275pipe(5, "async");
        \u0275\u0275elementStart(6, "div", 4)(7, "room-booking-search", 5);
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(13, 21, \u0275\u0275pipeBind1(12, 19, ctx.date), "zzzz", ctx.tz), " ");
        \u0275\u0275advance(5);
    ...
    }, dependencies: [NgForOf, NgIf, DateOptionsComponent, MatRipple, RoomBookingSearchComponent, AsyncPipe, DatePipe, TranslatePipe, UserPipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  max-width: 100%;\n}\n[timeline][_ngcontent-%COMP%] {\n  grid-template-columns: 4rem auto;\n  grid-template-rows: 3.5rem auto;\n}\n/*# sourceMappingURL=room-week-timeline.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomWeekBookingsTimelineComponent, { className: "RoomWeekBookingsTimelineComponent", filePath: "apps/concierge/src/app/day-view/room-week-timeline.component.ts", lineNumber: 169 });
})();

// apps/concierge/src/app/day-view/room-bookings.component.ts
var _forTrack0 = ($index, $item) => $item.id;
function RoomBookingsComponent_mat_option_26_div_2_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsComponent_mat_option_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 29)(1, "div", 30);
    \u0275\u0275template(2, RoomBookingsComponent_mat_option_26_div_2_Template, 5, 3, "div", 31);
...
function RoomBookingsComponent_ng_container_28_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 17);
  }
}
function RoomBookingsComponent_ng_container_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, RoomBookingsComponent_ng_container_28_div_1_Template, 1, 0, "div", 34);
    \u0275\u0275elementStart(2, "mat-slide-toggle", 35);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275listener("ngModelChange", function RoomBookingsComponent_ng_container_28_Template_mat_slide_toggle_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx_r2.use_region);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", (tmp_3_0 = \u0275\u0275pipeBind1(3, 3, ctx_r2.ui_options)) == null ? null : tmp_3_0.show_overflow);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 5, "APP.CONCIERGE.SETUP_BREAKDOWN"), " ");
  }
}
function RoomBookingsComponent_mat_checkbox_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-checkbox", 6);
    \u0275\u0275listener("ngModelChange", function RoomBookingsComponent_mat_checkbox_40_Template_mat_checkbox_ngModelChange_0_listener($event) {
...
function RoomBookingsComponent_For_43_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RoomBookingsComponent_For_43_div_0_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r7);
      const type_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setFilter(type_r8.id, true));
    });
    \u0275\u0275elementStart(5, "app-icon", 41);
    \u0275\u0275text(6, "close");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function RoomBookingsComponent_For_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, RoomBookingsComponent_For_43_div_0_Template, 7, 3, "div", 37);
  }
  if (rf & 2) {
...
function RoomBookingsComponent_room_bookings_timeline_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "room-bookings-timeline", 42);
  }
}
function RoomBookingsComponent_room_week_bookings_timeline_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "room-week-bookings-timeline", 42);
  }
}
function RoomBookingsComponent_room_bookings_approvals_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "room-bookings-approvals", 43);
  }
}
var EMPTY = [];
var RoomBookingsComponent = class _RoomBookingsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsComponent, selectors: [["room-bookings"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 50, vars: 37, consts: [["menu", "matMenu"], [1, "absolute", "inset-0", "flex", "flex-col", "overflow-hidden", "pl-8"], [1, "flex", "w-full", "items-center", "space-x-4", "py-4", "pr-8"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], ["appearance", "outline", 1, "no-subscript", "w-32"], [3, "ngModelChange", "ngModel"], ["value", "day"], ["value", "week"], ["btn", "", "matRipple", "", 1, "space-x-2", 3, "click"], [1, "pl-2"], [1, "text-2xl"], [1, "flex", "w-full", "items-center"], ["appearance", "outline", 1, "no-subscript", "w-52"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [4, "ngIf"], [1, "ml-8", "mr-4", "h-full", "border-l"], [1, "flex", "max-w-[calc(100%-16rem)]", "flex-1", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "inverse", 3, "matMenuTriggerFor"], [1, "mx-2"], [1, ""], [1, "flex", "w-48", "flex-col", "space-y-2", "overflow-hidden"], [3, "ngModel", "ngModelChange", 4, "ngFor", "ngForOf"], [1, "flex", "w-px", "flex-1", "items-center", "space-x-2", "overflow-x-auto", "px-2"], [1, "flex", "items-center", "rounded-3xl", "border", "border-base-200"], [1, "mt-4", "flex", "h-px", "w-full", "flex-1", "border-t", "border-base-200"], ["class", "relative z-0 w-1/2 flex-1", 4, "ngIf"], ["class", "relative z-10", 4, "ngIf"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], ["class", "ml-8 mr-4 h-full border-l", 4, "ngIf"], [1, "m-2", 3, "ngModelChange", "ngModel"], [1, "text-xs"], ["class", "flex items-center rounded-3xl border border-base-200", 4, "ngIf"], [1, "m-2", "h-4", "w-4", "rounded-full"], [1, "truncate"], ["icon", "", "matRipple", "", 3, "click"], [1, "text-xl"], [1, "relative", "z-0", "w-1/2", "flex-1"], [1, "relative", "z-10"]], template: function RoomBookingsComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        ...
        \u0275\u0275template(26, RoomBookingsComponent_mat_option_26_Template, 5, 3, "mat-option", 15);
        \u0275\u0275pipe(27, "async");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(28, RoomBookingsComponent_ng_container_28_Template, 7, 7, "ng-container", 16);
        \u0275\u0275element(29, "div", 17);
        \u0275\u0275elementStart(30, "div", 18)(31, "button", 19)(32, "app-icon");
        ...
        \u0275\u0275pipe(36, "translate");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(37, "mat-menu", 21, 0)(39, "div", 22);
        \u0275\u0275template(40, RoomBookingsComponent_mat_checkbox_40_Template, 2, 2, "mat-checkbox", 23);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(41, "div", 24);
        \u0275\u0275repeaterCreate(42, RoomBookingsComponent_For_43_Template, 1, 1, "div", 25, _forTrack0);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(44, "div", 26);
        \u0275\u0275template(45, RoomBookingsComponent_room_bookings_timeline_45_Template, 1, 0, "room-bookings-timeline", 27);
        \u0275\u0275pipe(46, "async");
        \u0275\u0275template(47, RoomBookingsComponent_room_week_bookings_timeline_47_Template, 1, 0, "room-week-bookings-timeline", 27);
        \u0275\u0275pipe(48, "async");
        \u0275\u0275template(49, RoomBookingsComponent_room_bookings_approvals_49_Template, 1, 0, "room-bookings-approvals", 28);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        const menu_r9 = \u0275\u0275reference(38);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 15, "APP.CONCIERGE.ROOM_BOOKINGS"), " ");
        \u0275\u0275advance(4);
        \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(8, 17, ctx.period));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 19, "COMMON.DAY"), " ");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(14, 21, "COMMON.WEEK"), " ");
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(18, 23, "APP.CONCIERGE.ROOMS_BOOK_ADD"), " ");
        \u0275\u0275advance(6);
        \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(24, 25, ctx.zones))("placeholder", \u0275\u0275pipeBind1(25, 27, "COMMON.LEVEL_ALL"));
        \u0275\u0275advance(3);
        \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(27, 29, ctx.levels));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", ctx.allow_setup_breakdown);
        \u0275\u0275advance(3);
        \u0275\u0275property("matMenuTriggerFor", menu_r9);
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(36, 31, "COMMON.FILTERS"), " ");
        \u0275\u0275advance(5);
        \u0275\u0275property("ngForOf", ctx.types);
        \u0275\u0275advance(2);
        \u0275\u0275repeater(ctx.types);
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(46, 33, ctx.period) === "day");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(48, 35, ctx.period) === "week");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", ctx.has_approvals);
      }
    }, dependencies: [NgForOf, NgIf, NgControlStatus, NgModel, MatFormField, MatSelect, MatOption, MatCheckbox, MatSlideToggle, MatMenu, MatMenuTrigger, MatRipple, IconComponent, RoomBookingsTimelineComponent, RoomBookingsApprovalsComponent, RoomWeekBookingsTimelineComponent, AsyncPipe, BuildingPipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
...
var _c08 = ["app-new-dayview", ""];
var NewDayViewComponent = class _NewDayViewComponent {
  static {
    this.\u0275fac = function NewDayViewComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NewDayViewComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDayViewComponent, selectors: [["", "app-new-dayview", ""]], standalone: false, attrs: _c08, decls: 5, vars: 0, consts: [[1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"]], template: function NewDayViewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDayViewComponent, { className: "NewDayViewComponent", filePath: "apps/concierge/src/app/day-view/new-dayview.component.ts", lineNumber: 33 });
})();
...
//# sourceMappingURL=day-view.module-3J5LH7HN.js.map
