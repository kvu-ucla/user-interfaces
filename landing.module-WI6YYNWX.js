...
} from "./chunk-GVIZUISE.js";
import {
  CalendarService
} from "./chunk-PI3URKQ6.js";
import {
  AsyncHandler,
  AsyncPipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingAvailabilityComponent, { className: "LandingAvailabilityComponent", filePath: "apps/workplace/src/app/landing/landing-availability.component.ts", lineNumber: 155 });
})();

// apps/workplace/src/app/landing/landing-colleagues.component.ts
var _c02 = ["search_input"];
function LandingColleaguesComponent_ng_container_5_div_1_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 28);
  }
  if (rf & 2) {
...
function LandingColleaguesComponent_ng_container_5_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 14)(1, "div", 15);
    \u0275\u0275element(2, "a-user-avatar", 16);
    \u0275\u0275template(3, LandingColleaguesComponent_ng_container_5_div_1_div_3_Template, 1, 9, "div", 17);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function LandingColleaguesComponent_ng_container_5_div_1_Template_button_click_16_listener() {
    ...
    \u0275\u0275listener("click", function LandingColleaguesComponent_ng_container_5_div_1_Template_button_click_23_listener() {
      const user_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
...
function LandingColleaguesComponent_ng_container_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LandingColleaguesComponent_ng_container_5_div_1_Template, 30, 14, "div", 13);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function LandingColleaguesComponent_div_17_ng_container_1_button_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 31);
    \u0275\u0275listener("click", function LandingColleaguesComponent_div_17_ng_container_1_button_1_Template_button_click_0_listener() {
...
function LandingColleaguesComponent_div_17_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LandingColleaguesComponent_div_17_ng_container_1_button_1_Template, 8, 3, "button", 30);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function LandingColleaguesComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29);
    \u0275\u0275template(1, LandingColleaguesComponent_div_17_ng_container_1_Template, 3, 3, "ng-container", 7);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LandingColleaguesComponent_ng_template_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 1, "WPA.COLLEAGUES_EMPTY"), " ");
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingColleaguesComponent, selectors: [["landing-colleagues"]], viewQuery: function LandingColleaguesComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275template(5, LandingColleaguesComponent_ng_container_5_Template, 3, 3, "ng-container", 7);
        \u0275\u0275pipe(6, "async");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275pipe(9, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(10, "div", 9)(11, "input", 10, 0);
        \u0275\u0275pipe(13, "async");
        ...
        \u0275\u0275text(16, "close");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(17, LandingColleaguesComponent_div_17_Template, 3, 4, "div", 12);
        \u0275\u0275pipe(18, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(19, LandingColleaguesComponent_ng_template_19_Template, 5, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(21, LandingColleaguesComponent_ng_template_21_Template, 5, 5, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(23, LandingColleaguesComponent_ng_template_23_Template, 5, 3, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        let tmp_4_0;
        let tmp_5_0;
        let tmp_9_0;
        const empty_state_r9 = \u0275\u0275reference(20);
        const load_state_r10 = \u0275\u0275reference(24);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1("", ((tmp_4_0 = \u0275\u0275pipeBind1(3, 9, ctx.contacts)) == null ? null : tmp_4_0.length) || 0, " Colleague(s)");
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", (tmp_5_0 = \u0275\u0275pipeBind1(6, 11, ctx.contacts)) == null ? null : tmp_5_0.length)("ngIfElse", empty_state_r9);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(9, 13, "WPA.ADD"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275classProp("hidden", !ctx.show_search);
        \u0275\u0275advance();
        \u0275\u0275property("ngModel", (tmp_9_0 = \u0275\u0275pipeBind1(13, 15, ctx.options)) == null ? null : tmp_9_0.search);
        \u0275\u0275advance(6);
        \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(18, 17, ctx.loading))("ngIfElse", load_state_r10);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingColleaguesComponent, { className: "LandingColleaguesComponent", filePath: "apps/workplace/src/app/landing/landing-colleagues.component.ts", lineNumber: 203 });
})();
...
function LandingFavouritesComponent_ng_container_4_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, LandingFavouritesComponent_ng_container_4_div_1_img_3_Template, 3, 5, "img", 11);
    \u0275\u0275pipe(4, "space");
    \u0275\u0275pipe(5, "async");
    ...
    \u0275\u0275listener("click", function LandingFavouritesComponent_ng_container_4_div_1_Template_button_click_29_listener() {
    ...
    \u0275\u0275pipe(31, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "button", 19)(33, "app-icon");
    \u0275\u0275text(34, "more_horiz");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "mat-menu", 20, 2)(37, "button", 21);
    \u0275\u0275listener("click", function LandingFavouritesComponent_ng_container_4_div_1_Template_button_click_37_listener() {
      const item_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.toggleFavourite("space", item_r2));
    });
    \u0275\u0275elementStart(38, "app-icon", 22);
    \u0275\u0275text(39, "cancel");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" Capacity ", ((tmp_10_0 = \u0275\u0275pipeBind1(28, 27, \u0275\u0275pipeBind1(27, 25, item_r2))) == null ? null : tmp_10_0.capacity) || 2, " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", ctx_r2.isClosed(item_r2));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(31, 29, "WPA.BOOK"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matMenuTriggerFor", menu_r5);
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(42, 31, "WPA.FAVOURITES_REMOVE"));
  }
}
...
function LandingFavouritesComponent_ng_container_4_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 8)(1, "div", 9)(2, "div", 10);
    \u0275\u0275template(3, LandingFavouritesComponent_ng_container_4_div_2_img_3_Template, 1, 1, "img", 11)(4, LandingFavouritesComponent_ng_container_4_div_2_ng_template_4_Template, 1, 1, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 12)(7, "div", 25);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "button", 27)(18, "app-icon");
    \u0275\u0275text(19, "more_horiz");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "mat-menu", 20, 2)(22, "button", 28);
    ...
    \u0275\u0275elementStart(23, "div", 29)(24, "app-icon", 30);
    \u0275\u0275text(25, " cancel ");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(16, 7, "WPA.BOOK"), " ");
    \u0275\u0275advance(2);
...
function LandingFavouritesComponent_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LandingFavouritesComponent_ng_container_4_div_1_Template, 43, 33, "div", 7)(2, LandingFavouritesComponent_ng_container_4_div_2_Template, 29, 11, "div", 7);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingFavouritesComponent, selectors: [["landing-favourites"]], features: [\u0275\u0275ProvidersFeature([SpacePipe]), \u0275\u0275InheritDefinitionFeature], decls: 8, vars: 5, consts: [["empty_state", ""], ["space_placeholder", ""], ["menu", "matMenu"], ["asset_placeholder", ""], [1, "flex", "items-center", "justify-between", "p-2", "mx-2", "bg-base-200", "text-sm", "rounded"], [1, "flex-1", "h-1/2", "w-full", "space-y-2", "overflow-auto", "pt-4", "divide-y", "divide-base-200"], [4, "ngIf", "ngIfElse"], ["class", "flex flex-col items-center mx-2 pt-2 space-y-2 relative", "item", "", 4, "ngFor", "ngForOf"], ["item", "", 1, "flex", "flex-col", "items-center", "mx-2", "pt-2", "space-y-2", "relative"], [1, "flex", "w-full", "items-center", "space-x-2", "relative"], [1, "w-16", "h-16", "overflow-hidden", "rounded", "relative", "flex", "items-center", "justify-center", "bg-base-300"], ["auth", "", "class", "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 object-cover min-w-full min-h-full", 3, "source", 4, "ngIf", "ngIfElse"], [1, "h-16", "flex-1", "w-1/2", "flex", "flex-col", "justify-center", "space-y-1"], [1, "truncate", "w-full", "pr-12"], [1, "flex", "items-center", "text-xs", "opacity-60", "space-x-1"], [1, "text-blue-500"], [1, "flex-1", "w-1/2", "truncate"], [1, "flex", "items-center", "text-xs", "opacity-60", "truncate", "space-x-2"], ["btn", "", "name", "book-favourite", "matRipple", "", 1, "w-full", "inverse", 3, "click", "disabled"], ["icon", "", "name", "favourite-more", 1, "absolute", "top-2", "right-0", "bg-base-200", "!rounded", "!m-0", 3, "matMenuTriggerFor"], ["xPosition", "before"], ["name", "landing-remove-favourite", "mat-menu-item", "", 1, "flex", "items-center", "space-x-2", 3, "click"], [1, "text-2xl"], ["auth", "", 1, "absolute", "top-1/2", "left-1/2", "-translate-x-1/2", "-translate-y-1/2", "object-cover", "min-w-full", "min-h-full", 3, "source"], ["src", "assets/icons/room-placeholder.svg", 1, "m-auto"], [1, "truncate"], ["btn", "", "name", "book-favourite", "matRipple", "", 1, "w-full", "inverse", 3, "click"], ["icon", "", "name", "favourite-more", 1, "absolute", "top-22", "right-0", "bg-base-200", "!rounded", "!m-0", 3, "matMenuTriggerFor"], ["name", "landing-remove-favourite", "mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl", "text-error"], [1, "pr-4"], [1, "m-auto", 3, "src"], [1, "w-full", "h-full", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], ["src", "assets/icons/no-favourites.svg"], [1, "opacity-60", "text-sm", "text-center"]], template: function LandingFavouritesComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1("", (ctx.spaces == null ? null : ctx.spaces.length) || 0, " Favourite(s)");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", (ctx.spaces == null ? null : ctx.spaces.length) || ((tmp_2_0 = \u0275\u0275pipeBind1(5, 3, ctx.assets)) == null ? null : tmp_2_0.length))("ngIfElse", empty_state_r10);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingFavouritesComponent, { className: "LandingFavouritesComponent", filePath: "apps/workplace/src/app/landing/landing-favourites.component.ts", lineNumber: 252 });
})();
...
function LandingComponent_div_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 8, "WPA.COLLEAGUES"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("inverse", ctx_r1.tab !== "fav");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(15, 10, "WPA.FAVOURITES"), " ");
    \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingComponent, { className: "LandingComponent", filePath: "apps/workplace/src/app/landing/landing.component.ts", lineNumber: 114 });
})();
...
//# sourceMappingURL=landing.module-WI6YYNWX.js.map
