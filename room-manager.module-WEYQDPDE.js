...
var _RoomModalComponent = class _RoomModalComponent extends AsyncHandler {
  ...
  save() {
    return __async(this, null, function* () {
      ...
      yield lastValueFrom(du(this._org.organisation.id, {
        name: "settings",
      ...
      yield lastValueFrom(data.id ? ac(data.id, data) : lc(data));
...
//# sourceMappingURL=room-manager.module-WEYQDPDE.js.map
