...
var _DesksStateService = class _DesksStateService extends AsyncHandler {
  ...
  constructor() {
    ...
    this.desks = combineLatest([
      ...
      return zones && !zones.includes("All") ? fu(zones[0], "desks").pipe(map((m) => m.details instanceof Array ? m.details : []), catchError((_) => of([]))) : _u(this._org.building?.id, {
        name: "desks"
...
//# sourceMappingURL=chunk-GS7ZPAKP.js.map
