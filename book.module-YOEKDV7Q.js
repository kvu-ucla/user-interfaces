...
function CateringListFieldComponent_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(8, 20, "CALENDAR_EVENT.CATERING_ORDER_AT_DATE", \u0275\u0275pureFunction2(31, _c08, \u0275\u0275pipeBind2(6, 14, order_r4.deliver_at_time, "mediumDate"), \u0275\u0275pipeBind2(7, 17, order_r4.deliver_at_time, ctx_r1.time_format))), " ");
    \u0275\u0275advance(4);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CodeFlowErrorComponent, selectors: [["code-flow-success"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 17, vars: 13, consts: [[1, "absolute", "inset-0", "z-50", "flex", "flex-col", "bg-base-100"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium"], [1, "py-4"], ["src", "assets/icons/not-found.svg", 1, "h-64"], [1, "max-w-[32rem]", "text-center", 3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"], [1, "mt-4", "flex", "w-full", "items-center", "justify-center", "space-x-2", "border-t", "border-base-200", "p-2"], ["btn", "", "matRipple", "", "class", "w-full max-w-[32rem]", 3, "routerLink", "queryParams", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "inverse", "w-full", "max-w-[32rem]", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "w-full", "max-w-[32rem]", 3, "routerLink", "queryParams"]], template: function CodeFlowErrorComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(12, _c09));
        \u0275\u0275advance();
...
function DeskFlowDetailedFormComponent_form_0_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ((tmp_2_0 = \u0275\u0275pipeBind1(2, 2, ctx_r1.options)) == null ? null : tmp_2_0.group) ? "group" : "single")("ngModelOptions", \u0275\u0275pureFunction0(4, _c012));
  }
}
...
function DeskFlowDetailedFormComponent_form_0_div_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(5, _c012));
    \u0275\u0275advance();
...
function DeskFlowDetailedFormComponent_form_0_div_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("disabled", !ctx_r1.building)("ngModelOptions", \u0275\u0275pureFunction0(5, _c012));
    \u0275\u0275advance();
...
function DeskFlowDetailedFormComponent_form_0_div_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(8, _c012));
    \u0275\u0275advance(4);
...
function DeskFlowDetailedFormComponent_form_0_div_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275property("simple", true)("ngModel", ((tmp_3_0 = \u0275\u0275pipeBind1(4, 3, ctx_r1.options)) == null ? null : tmp_3_0.members) || \u0275\u0275pureFunction0(5, _c17))("ngModelOptions", \u0275\u0275pureFunction0(6, _c012));
  }
}
...
function DeskFlowDetailedFormComponent_form_0_div_18_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ((tmp_2_0 = \u0275\u0275pipeBind1(5, 3, ctx_r1.options)) == null ? null : tmp_2_0.features) || \u0275\u0275pureFunction0(7, _c17))("ngModelOptions", \u0275\u0275pureFunction0(8, _c012));
    \u0275\u0275advance(2);
...
function DeskFlowDetailedFormComponent_form_0_div_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", !!ctx_r1.form.value.secondary_resource)("ngModelOptions", \u0275\u0275pureFunction0(2, _c012));
  }
}
...
var DeskFlowDetailedFormComponent = class _DeskFlowDetailedFormComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskFlowDetailedFormComponent, selectors: [["detailed-book-desks-form"]], inputs: { form: "form" }, standalone: false, decls: 1, vars: 1, consts: [[3, "formGroup", 4, "ngIf"], [3, "formGroup"], ["class", "mx-auto mb-4 w-[640px] max-w-[calc(100%-2rem)]", 4, "ngIf"], [1, "mx-auto", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "flex-col", "space-x-0", "sm:flex-row", "sm:space-x-2"], [1, "flex", "w-full", "flex-1", "flex-col", "sm:w-1/4"], ["formControlName", "date", 3, "to"], ["class", "flex w-full flex-1 flex-col sm:w-1/4", 4, "ngIf"], ["class", "mx-auto flex w-[640px] max-w-[calc(100%-2rem)] flex-col space-x-0 sm:flex-row sm:space-x-2", 4, "ngIf"], ["class", "mx-auto flex w-[640px] max-w-[calc(100%-2rem)] flex-col", 4, "ngIf"], ["class", "mx-auto flex w-[640px] max-w-[calc(100%-2rem)] flex-1 flex-col", 4, "ngIf"], ["class", "mx-auto mb-4 flex w-[640px] max-w-[calc(100%-2rem)] flex-1 flex-col", 4, "ngIf"], [1, "mx-auto", "mb-4", "w-[640px]", "max-w-[calc(100%-2rem)]"], [1, "w-full", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["value", "single", 1, "w-1/2"], ["value", "group", 1, "w-1/2"], ["appearance", "outline"], ["placeholder", "Select building", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["placeholder", "Any Level", "ngModel", "", 3, "ngModelChange", "disabled", "ngModelOptions"], [1, "flex", "w-full", "flex-1", "flex-col", "sm:w-1/3"], [3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "relative", "flex", "w-full", "flex-1", "flex-col", "sm:w-1/3"], ["formControlName", "duration", 3, "time", "max", "min", "step", "disabled"], ["formControlName", "all_day", "class", "absolute right-0 top-0", 4, "ngIf"], ["formControlName", "all_day", 1, "absolute", "right-0", "top-0"], [1, "mx-auto", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "flex-col"], ["formControlName", "user", 1, "mb-4"], [1, "mx-auto", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "flex-1", "flex-col"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "formControlName", "description", "placeholder", "Reason for booking..."], [3, "ngModelChange", "simple", "ngModel", "ngModelOptions"], ["placeholder", "None", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["value", "none"], [3, "ngModelChange", "disabled", "ngModel", "ngModelOptions", "to"], [1, "capitalize"], ["multiple", "", "placeholder", "Any Feature", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["class", "capitalize", 3, "value", 4, "ngFor", "ngForOf"], [1, "capitalize", 3, "value"], [1, "mx-auto", "mb-4", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "flex-1", "flex-col"]], template: function DeskFlowDetailedFormComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var DeskFlowFormComponent = class _DeskFlowFormComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskFlowFormComponent, selectors: [["desk-flow-form"]], standalone: false, decls: 15, vars: 5, consts: [["alloc_button", ""], ["form", "", 1, "min-h-[50%]", "flex-1"], [1, "mx-auto", "mb-2", "mt-4", "w-[640px]", "max-w-[calc(100%-2rem)]", "text-xl", "font-medium", "uppercase"], [3, "form"], [1, "mb-4", "w-full", "border-b", "border-base-200"], [1, "mx-auto", "mb-4", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "flex-col", "items-center", "justify-center", "space-x-0", "space-y-2", "sm:flex-row", "sm:space-x-2", "sm:space-y-0"], ["btn", "", "matRipple", "", "clear", "", 1, "inverse", "h-[2.75rem]", "w-full", "sm:w-auto", "sm:flex-1", 3, "click"], [1, "flex", "items-center", "justify-center"], [1, "text-xl"], [1, "mx-4", "ml-2"], ["class", "h-[2.75rem] w-full sm:w-auto sm:flex-1", "find", "", "btn", "", "matRipple", "", 3, "click", 4, "ngIf", "ngIfElse"], ["find", "", "btn", "", "matRipple", "", 1, "h-[2.75rem]", "w-full", "sm:w-auto", "sm:flex-1", 3, "click"]], template: function DeskFlowFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
...
function DeskFlowMapComponent_li_22_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", desk_r3.features || \u0275\u0275pureFunction0(6, _c18));
  }
}
...
var DeskFlowMapComponent = class _DeskFlowMapComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskFlowMapComponent, selectors: [["desk-flow-map"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 28, vars: 22, consts: [["menu", "matMenu"], ["topbar", "", 1, ""], ["btn", "", "matRipple", "", 1, "clear", "h-[2.75rem]", "text-white", 3, "routerLink"], [1, "flex", "h-full", "items-center", "justify-center"], [1, "text-xl"], [1, "mx-4", "ml-2"], [1, "flex", "h-1/2", "w-full", "flex-1", "flex-col"], [1, "px-4", "pt-4", "text-center", "text-2xl"], [1, "mx-auto", "my-4", "w-[640px]", "max-w-[calc(100vw-2rem)]", 3, "matMenuTriggerFor"], [1, "max-h-[65vh]", "overflow-auto", "pt-4", 3, "click"], [3, "form"], ["listing", "", 1, "relative", "flex", "h-1/2", "flex-1", "space-x-2"], [1, "list-style-none", "mx-auto", "h-full", "w-full", "max-w-[48rem]", "space-y-2", "overflow-auto", "rounded-tr-lg", "bg-base-200", "pb-32", "sm:w-[20rem]"], [1, "sticky", "inset-x-0", "top-0", "z-10", "border-b", "border-base-200", "bg-base-200", "px-4", "py-2"], ["matRipple", "", "class", "mx-2 flex min-h-[5rem] cursor-pointer items-center space-x-2 rounded border bg-base-100 p-2 shadow", 3, "border-primary", "click", 4, "ngFor", "ngForOf"], ["class", "relative hidden h-full flex-1 overflow-hidden rounded-tl-lg border-l border-t border-base-200 bg-base-200 sm:block", 4, "ngIf"], ["class", "absolute inset-0 z-20 !m-0 flex flex-col items-center justify-center space-y-2 bg-base-100 bg-opacity-60", 4, "ngIf"], ["selection", "", "class", "absolute bottom-2 left-1/2 !m-0 w-[24rem] max-w-[calc(100vw-1rem)] -translate-x-1/2 transform space-y-2 rounded border border-base-200 bg-base-100 p-2 shadow", 4, "ngIf"], ["matRipple", "", 1, "mx-2", "flex", "min-h-[5rem]", "cursor-pointer", "items-center", "space-x-2", "rounded", "border", "bg-base-100", "p-2", "shadow", 3, "click"], [1, "text-2xl"], [1, "flex", "w-1/2", "flex-1", "flex-col"], ["name", "", 1, ""], ["level", "", 1, "text-xs"], ["features", "", 1, "flex", "w-full", "flex-wrap"], ["class", "mr-2 mt-1 rounded-xl bg-primary px-2 py-1 text-xs text-white", 4, "ngFor", "ngForOf"], [1, "mr-2", "mt-1", "rounded-xl", "bg-primary", "px-2", "py-1", "text-xs", "text-white"], [1, "relative", "hidden", "h-full", "flex-1", "overflow-hidden", "rounded-tl-lg", "border-l", "border-t", "border-base-200", "bg-base-200", "sm:block"], [3, "src", "zoom", "center", "styles", "features", "actions", "labels", "focus"], ["class", "absolute left-2 top-2 flex h-10 items-center rounded-3xl border border-base-200 bg-base-100 px-3", 4, "ngIf"], [1, "absolute", "left-2", "top-2", "flex", "h-10", "items-center", "rounded-3xl", "border", "border-base-200", "bg-base-100", "px-3"], [1, "absolute", "inset-0", "z-20", "!m-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "bg-base-100", "bg-opacity-60"], [3, "diameter"], ["selection", "", 1, "absolute", "bottom-2", "left-1/2", "!m-0", "w-[24rem]", "max-w-[calc(100vw-1rem)]", "-translate-x-1/2", "transform", "space-y-2", "rounded", "border", "border-base-200", "bg-base-100", "p-2", "shadow"], [1, ""], [1, "flex", "items-center", "space-x-2"], ["matRipple", "", 1, "inverse", "flex-1", 3, "click"], ["matRipple", "", 1, "flex-1", 3, "click"]], template: function DeskFlowMapComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(21, _c013));
        \u0275\u0275advance(9);
...
var DeskFlowConfirmComponent = class _DeskFlowConfirmComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskFlowConfirmComponent, selectors: [["desk-flow-confirm"]], standalone: false, decls: 7, vars: 2, consts: [["topbar", "", 1, ""], ["btn", "", "matRipple", "", 1, "clear", "h-[2.75rem]", "text-white", 3, "routerLink"], [1, "flex", "h-full", "items-center", "justify-center"], [1, "text-xl"], [1, "mx-4", "ml-2"]], template: function DeskFlowConfirmComponent_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        \u0275\u0275advance();
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(1, _c014));
      }
...
var _c015 = (a0) => ["/book", a0];
var _c19 = () => ({});
var _c25 = () => ["/schedule"];
var _c34 = (a0) => ({ email: a0 });
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FlowSuccessComponent, selectors: [["flow-success"]], inputs: { calendar: "calendar", extra: "extra", route: "route", type: "type" }, standalone: false, decls: 15, vars: 14, consts: [["name", "success", 1, "bg-indigo-900", "fixed", "inset-0", "z-50", "flex", "flex-col", "items-center", "justify-center"], [1, "mb-4", "rounded-full", "bg-base-100", "text-7xl", "text-success"], [1, "mb-4", "text-center", "text-lg", "leading-10", "text-white"], [4, "ngIf"], [1, "flex", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "w-32", "border", "border-white", 3, "routerLink", "queryParams"]], template: function FlowSuccessComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(8, _c015, ctx.route))("queryParams", \u0275\u0275pureFunction0(10, _c19));
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(11, _c25))("queryParams", \u0275\u0275pureFunction1(12, _c34, ctx.calendar));
      }
...
var BookDeskFlowComponent = class _BookDeskFlowComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookDeskFlowComponent, selectors: [["placeos-book-desk-flow"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 6, vars: 4, consts: [[1, "h-full", "w-full", "bg-base-100"], [3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"], ["type", "desk", "route", "desks", 3, "calendar", "extra"]], template: function BookDeskFlowComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
...
function LockerFormDetailsComponent_div_0_div_29_div_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("time", (tmp_4_0 = ctx_r1.form.get("date")) == null ? null : tmp_4_0.value)("max", ctx_r1.max_duration)("min", 60)("step", 60)("use_24hr", ctx_r1.use_24hr)("custom_options", ctx_r1.custom_durations)("timezone", ctx_r1.timezone);
  }
}
function LockerFormDetailsComponent_div_0_div_29_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(9, _c016))("use_24hr", ctx_r1.use_24hr)("disabled", ctx_r1.form.value.duration > 24 * 60 - 1 || ctx_r1.only_duration || ctx_r1.disable_start)("timezone", ctx_r1.timezone);
    \u0275\u0275advance();
...
function LockerFormDetailsComponent_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.building);
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(24, _c016));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.allow_all_day && !ctx_r1.only_duration && !ctx_r1.disable_date);
    \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockerFormDetailsComponent, { className: "LockerFormDetailsComponent", filePath: "apps/workplace/src/app/book/locker-flow/locker-form-details.component.ts", lineNumber: 140 });
})();
...
var _c017 = (a0) => ({ name: a0 });
var _c110 = (a0, a1, a2, a3) => ({ name: a0, place: a1, date: a2, time: a3 });
var _c26 = () => ["/"];
...
var BookLockerFlowSuccessComponent = class _BookLockerFlowSuccessComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookLockerFlowSuccessComponent, selectors: [["locker-flow-success"]], standalone: false, decls: 17, vars: 30, consts: [[1, "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto", "bg-base-100"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-center", "text-2xl", "font-medium"], ["src", "assets/icons/locker-success.svg"], [1, "text-center"], ["class", "relative flex flex-col items-center space-y-4 p-4", 4, "ngIf"], [1, "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "border-base-200", "bg-base-100", "p-2"], ["btn", "", "name", "locker-confirm-continue", "matRipple", "", 1, "mx-auto", "w-full", "max-w-[32rem]", 3, "routerLink"], [1, "relative", "flex", "flex-col", "items-center", "space-y-4", "p-4"], ["btn", "", "matRipple", "", "name", "locker-outlook-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/outlook.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "locker-google-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/gcal.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "locker-ical-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], [1, "text-xl"]], template: function BookLockerFlowSuccessComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 5, "BOOKINGS.ITEM_BOOKED", \u0275\u0275pureFunction1(22, _c017, (ctx.last_event.asset_name || ctx.last_event.asset_id) + ", " + ctx.location)), " ");
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 17, "APP.WORKPLACE.LOCKER_SUCCESS_MSG", \u0275\u0275pureFunction4(24, _c110, ctx.last_event.asset_name, ctx.location, \u0275\u0275pipeBind2(8, 8, ctx.last_event.date, "mediumDate"), \u0275\u0275pipeBind2(9, 11, ctx.last_event.date, ctx.time_format) + " - " + \u0275\u0275pipeBind2(10, 14, ctx.last_event.date + ctx.last_event.duration * 60 * 1e3, ctx.time_format))), " ");
        \u0275\u0275advance(5);
        \u0275\u0275property("ngIf", ctx.show_links);
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(29, _c26));
        \u0275\u0275advance();
...
function BookLockerFlowComponent_ng_template_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 5, "APP.WORKPLACE.LOCKER_ASSIGNED", \u0275\u0275pureFunction1(10, _c018, (tmp_2_0 = \u0275\u0275pipeBind1(4, 3, ctx_r0.assigned_space)) == null ? null : tmp_2_0.name)), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(12, _c111));
    \u0275\u0275advance();
...
function MeetingFlowConfirmModalComponent_div_30_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 2, "CALENDAR_EVENT.ATTENDEE_COUNT", \u0275\u0275pureFunction1(5, _c019, ctx_r0.event.attendees == null ? null : ctx_r0.event.attendees.length)), " ");
    \u0275\u0275advance(5);
...
function MeetingFlowConfirmModalComponent_div_31_div_1_div_8_div_16_span_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 2, "CALENDAR_EVENT.CATERING_ORDER_OPTION_COUNT", \u0275\u0275pureFunction1(5, _c019, (item_r4.option_list == null ? null : item_r4.option_list.length) || "0")), " ");
  }
}
...
function MeetingFlowConfirmModalComponent_div_31_div_1_div_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 12, "CALENDAR_EVENT.CATERING_ORDER_AT", \u0275\u0275pureFunction1(21, _c112, \u0275\u0275pipeBind2(5, 9, order_r5.deliver_at, "MMM d, " + ctx_r0.time_format))), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r0.end_time < order_r5.deliver_at);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 15, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(23, _c019, order_r5.item_count)), " ");
    \u0275\u0275advance(3);
...
function MeetingFlowConfirmModalComponent_div_31_div_2_div_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 11, "CALENDAR_EVENT.ASSETS_REQUESTED_FOR", \u0275\u0275pureFunction1(17, _c112, \u0275\u0275pipeBind2(5, 8, request_r6.deliver_at_time, "MMM d, " + ctx_r0.time_format))), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r0.end_time < request_r6.deliver_at || request_r6.conflict);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 14, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(19, _c019, request_r6.item_count)), " ");
    \u0275\u0275advance(3);
...
function MeetingFlowConfirmModalComponent_div_31_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, MeetingFlowConfirmModalComponent_div_31_div_2_div_6_Template, 14, 21, "div", 46);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function MeetingFormDetailsComponent_div_0_div_14_div_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r0.form.value.date_end)("ngModelOptions", \u0275\u0275pureFunction0(9, _c021))("from", (ctx_r0.form == null ? null : (tmp_6_0 = ctx_r0.form.getRawValue()) == null ? null : tmp_6_0.date) + 30 * 60 * 1e3)("use_24hr", ctx_r0.use_24hr)("extra_info_fn", ctx_r0.duration_info)("timezone", ctx_r0.timezone);
  }
}
...
function MeetingFormDetailsComponent_div_0_div_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 7, "FORM.TIME_START"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r0.form.getRawValue().date)("ngModelOptions", \u0275\u0275pureFunction0(9, _c021))("use_24hr", ctx_r0.use_24hr)("timezone", ctx_r0.timezone);
    \u0275\u0275advance();
...
function MeetingFormDetailsComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, MeetingFormDetailsComponent_div_0_div_13_Template, 20, 22, "div", 8)(14, MeetingFormDetailsComponent_div_0_div_14_Template, 10, 10, "div", 9)(15, MeetingFormDetailsComponent_div_0_div_15_Template, 7, 3, "div", 10)(16, MeetingFormDetailsComponent_div_0_div_16_Template, 7, 3, "div", 10)(17, MeetingFormDetailsComponent_div_0_div_17_Template, 8, 5, "div", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFormDetailsComponent, { className: "MeetingFormDetailsComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-form-details.component.ts", lineNumber: 191 });
})();

// apps/workplace/src/app/book/meeting-flow/meeting-flow-form.component.ts
var _c022 = ["confirm_ref"];
var _c113 = ["input"];
var _c27 = (a0, a1, a2, a3) => ({ date: a0, duration: a1, all_day: a2, zone_id: a3 });
var _c35 = () => ({ standalone: true });
...
function MeetingFlowFormComponent_form_5_section_29_mat_form_field_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r1.code_filter.getValue())("ngModelOptions", \u0275\u0275pureFunction0(14, _c35))("placeholder", \u0275\u0275pipeBind1(5, 8, "CALENDAR_EVENT.CATERING_CHARGE_CODE_SEACH"));
    \u0275\u0275advance(4);
...
function MeetingFlowFormComponent_form_5_section_29_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("options", \u0275\u0275pureFunction4(10, _c27, ctx_r1.form.getRawValue().date, ctx_r1.form.value.duration, ctx_r1.form.value.all_day, (ctx_r1.form.value == null ? null : ctx_r1.form.value.resources == null ? null : ctx_r1.form.value.resources.length) ? ctx_r1.form.value == null ? null : ctx_r1.form.value.resources[0] == null ? null : ctx_r1.form.value.resources[0].level == null ? null : ctx_r1.form.value.resources[0].level.parent_id : ""));
    \u0275\u0275advance();
...
function MeetingFlowFormComponent_form_5_section_31_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("options", \u0275\u0275pureFunction4(10, _c27, ctx_r1.form.getRawValue().date, ctx_r1.form.value.duration, ctx_r1.form.value.all_day, (ctx_r1.form.value == null ? null : ctx_r1.form.value.resources == null ? null : ctx_r1.form.value.resources.length) ? ctx_r1.form.value == null ? null : ctx_r1.form.value.resources[0] == null ? null : ctx_r1.form.value.resources[0].level == null ? null : ctx_r1.form.value.resources[0].level.parent_id : ""))("rejected_ids", ctx_r1.invalid_assets);
  }
}
...
var MeetingFlowFormComponent = class _MeetingFlowFormComponent extends AsyncHandler {
  ...
  constructor(_state, _catering, _assets, _settings, _router, _dialog, _bottom_sheet, _org, _idle) {
    ...
    this.viewConfirm = () => __async(this, null, function* () {
      ...
      const has_codes = yield this.has_codes.pipe(take(1)).toPromise();
      if (!has_codes) {
        this.form.get("catering_charge_code").setValidators([]);
        this.form.updateValueAndValidity();
      }
...
var _c023 = (a0, a1, a2, a3) => ({ level: a0, space: a1, date: a2, time: a3 });
var _c114 = (a0) => ({ name: a0 });
var _c28 = () => ["/"];
function MeetingFlowSuccessComponent_div_3_ng_container_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function MeetingFlowSuccessComponent_div_3_ng_container_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function MeetingFlowSuccessComponent_div_3_p_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function MeetingFlowSuccessComponent_div_3_button_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 11);
    \u0275\u0275listener("click", function MeetingFlowSuccessComponent_div_3_button_12_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function MeetingFlowSuccessComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(6, "img", 4);
    \u0275\u0275elementStart(7, "p", 5);
    \u0275\u0275template(8, MeetingFlowSuccessComponent_div_3_ng_container_8_Template, 3, 4, "ng-container", 6)(9, MeetingFlowSuccessComponent_div_3_ng_container_9_Template, 3, 4, "ng-container", 6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, MeetingFlowSuccessComponent_div_3_p_10_Template, 3, 3, "p", 6);
    \u0275\u0275element(11, "div", 7);
    \u0275\u0275template(12, MeetingFlowSuccessComponent_div_3_button_12_Template, 3, 3, "button", 8);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 9, "BOOKINGS.ITEM_BOOKED", \u0275\u0275pureFunction1(14, _c114, \u0275\u0275pipeBind1(4, 7, "RESOURCE.ROOM"))), " ");
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(16, _c28));
    \u0275\u0275advance();
...
var MeetingFlowSuccessComponent = class _MeetingFlowSuccessComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowSuccessComponent, selectors: [["meeting-flow-success"]], standalone: false, decls: 4, vars: 13, consts: [["class", "absolute inset-0 z-50 flex flex-col overflow-auto bg-base-100", 4, "ngIf"], [1, "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto", "bg-base-100"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium"], ["src", "assets/icons/success.svg"], [1, "max-w-[32rem]", "text-center"], [4, "ngIf"], [1, "h-4"], ["btn", "", "matRipple", "", "class", "w-48", 3, "click", 4, "ngIf"], [1, "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "border-base-200", "bg-base-100", "p-2"], ["btn", "", "name", "meeting-created-continue", "matRipple", "", 1, "w-full", "max-w-[32rem]", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click"]], template: function MeetingFlowSuccessComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275declareLet(0);
        \u0275\u0275pipe(1, "date");
        \u0275\u0275pipe(2, "date");
        \u0275\u0275template(3, MeetingFlowSuccessComponent_div_3_Template, 17, 17, "div", 0);
      }
      if (rf & 2) {
        \u0275\u0275storeLet(\u0275\u0275pureFunction4(8, _c023, (ctx.level == null ? null : ctx.level.display_name) || (ctx.level == null ? null : ctx.level.name), (ctx.space == null ? null : ctx.space.display_name) || (ctx.space == null ? null : ctx.space.name), \u0275\u0275pipeBind2(1, 1, ctx.last_event.date, "mediumDate"), \u0275\u0275pipeBind2(2, 4, ctx.last_event.date, ctx.time_format)));
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", !ctx.loading);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowSuccessComponent, { className: "MeetingFlowSuccessComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-success.component.ts", lineNumber: 90 });
})();
...
function NewDeskFlowConfirmComponent_section_29_div_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 11, "FORM.ASSETS_REQUESTED_FOR", \u0275\u0275pureFunction1(17, _c024, \u0275\u0275pipeBind2(5, 8, request_r4.deliver_at_time, "MMM d, " + ctx_r1.time_format))), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r1.end_time < request_r4.deliver_at || request_r4.conflict);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 14, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(19, _c115, request_r4.item_count)), " ");
    \u0275\u0275advance(3);
...
function NewDeskFlowConfirmComponent_section_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 42)(1, "app-icon", 27);
    \u0275\u0275text(2, "done");
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDeskFlowConfirmComponent, { className: "NewDeskFlowConfirmComponent", filePath: "apps/workplace/src/app/book/new-desk-flow/new-desk-flow-confirm.component.ts", lineNumber: 208 });
})();

// apps/workplace/src/app/book/new-desk-flow/new-desk-form-details.component.ts
var _c025 = () => ({ standalone: true });
var _c116 = () => [];
var _c29 = (a0, a1, a2) => ({ date: a0, duration: a1, all_day: a2 });
...
function NewDeskFormDetailsComponent_div_0_div_34_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(16, _c025))("use_24hr", ctx_r1.use_24hr)("timezone", ctx_r1.timezone);
    \u0275\u0275advance(3);
...
function NewDeskFormDetailsComponent_div_0_div_35_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(7, _c025));
    \u0275\u0275advance();
...
function NewDeskFormDetailsComponent_div_0_div_36_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", !!ctx_r1.form.value.secondary_resource)("ngModelOptions", \u0275\u0275pureFunction0(5, _c025));
    \u0275\u0275advance();
...
function NewDeskFormDetailsComponent_div_0_section_37_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ((tmp_3_0 = \u0275\u0275pipeBind1(10, 5, ctx_r1.options)) == null ? null : tmp_3_0.members) || \u0275\u0275pureFunction0(7, _c116))("ngModelOptions", \u0275\u0275pureFunction0(8, _c025));
  }
}
...
function NewDeskFormDetailsComponent_div_0_section_40_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("options", \u0275\u0275pureFunction3(7, _c29, ctx_r1.form.getRawValue().date, ctx_r1.form.value.duration, ctx_r1.form.value.all_day));
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDeskFormDetailsComponent, { className: "NewDeskFormDetailsComponent", filePath: "apps/workplace/src/app/book/new-desk-flow/new-desk-form-details.component.ts", lineNumber: 262 });
})();
...
var NewDeskFlowFormComponent = class _NewDeskFlowFormComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDeskFlowFormComponent, selectors: [["new-desk-flow-form"]], standalone: false, decls: 11, vars: 7, consts: [[1, "h-full", "w-full", "overflow-auto", "bg-base-200"], [1, "mx-auto", "w-[48rem]", "max-w-full", "border", "border-base-200", "bg-base-100", "sm:my-4"], [1, "w-full", "border-b", "border-base-200", "p-4", "text-2xl", "font-medium", "sm:px-16", "sm:py-4"], [1, "block", "p-0", "sm:px-16", "sm:py-4", 3, "form"], [1, "w-full", "border-b", "border-base-200", "sm:mb-2"], [1, "flex", "flex-col", "items-center", "p-2", "sm:mb-2", "sm:flex-row", "sm:space-x-2", "sm:px-16"], ["btn", "", "name", "open-desk-confirm", "matRipple", "", "confirm", "", 1, "w-full", "sm:w-auto", 3, "click"]], template: function NewDeskFlowFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h2", 2);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
...
var _c026 = (a0) => ({ name: a0 });
var _c117 = () => ["/"];
var _c210 = (a0, a1, a2) => ({ date: a0, time: a1, size: a2 });
var _c36 = (a0) => ({ count: a0 });
...
function NewDeskFlowSuccessComponent_p_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275storeLet(\u0275\u0275pureFunction3(11, _c210, \u0275\u0275pipeBind2(2, 1, (ctx_r1.last_event == null ? null : ctx_r1.last_event.date) || 0, "mediumDate"), \u0275\u0275pipeBind2(3, 4, (ctx_r1.last_event == null ? null : ctx_r1.last_event.date) || 0, ctx_r1.time_format) + " - " + \u0275\u0275pipeBind2(4, 7, ctx_r1.last_event.date + ctx_r1.last_event.duration * 60 * 1e3, ctx_r1.time_format), ctx_r1.group_size));
    \u0275\u0275advance(4);
...
function NewDeskFlowSuccessComponent_p_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 1, "BOOKINGS.ASSETS_BOOKED", \u0275\u0275pureFunction1(4, _c36, ctx_r1.last_event == null ? null : ctx_r1.last_event.extension_data == null ? null : ctx_r1.last_event.extension_data.assets == null ? null : ctx_r1.last_event.extension_data.assets.length)), " ");
  }
}
...
var NewDeskFlowSuccessComponent = class _NewDeskFlowSuccessComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDeskFlowSuccessComponent, selectors: [["new-desk-flow-success"]], standalone: false, decls: 14, vars: 15, consts: [[1, "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto", "bg-base-100"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-center", "text-2xl", "font-medium"], ["src", "assets/icons/success.svg"], ["class", "text-center", 4, "ngIf"], ["assets", "", 4, "ngIf"], [4, "ngIf"], ["class", "relative flex flex-col items-center space-y-4 p-4", 4, "ngIf"], [1, "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "border-base-200", "bg-base-100", "p-2"], ["btn", "", "name", "desk-confirm-continue", "matRipple", "", 1, "mx-auto", "w-full", "max-w-[32rem]", 3, "routerLink"], [1, "text-center"], ["assets", ""], [1, "relative", "flex", "flex-col", "items-center", "space-y-4", "p-4"], ["btn", "", "matRipple", "", "name", "desk-outlook-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/outlook.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-google-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/gcal.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-ical-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], [1, "text-xl"]], template: function NewDeskFlowSuccessComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 7, "BOOKINGS.ITEM_BOOKED", \u0275\u0275pureFunction1(12, _c026, (ctx.last_event.asset_name || ctx.last_event.asset_id) + ctx.location)), " ");
        \u0275\u0275advance(3);
        ...
        \u0275\u0275property("ngIf", ctx.show_links);
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(14, _c117));
        \u0275\u0275advance();
...
function ParkingFormDetailsComponent_div_0_div_37_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(14, _c027))("use_24hr", ctx_r1.use_24hr)("timezone", ctx_r1.timezone);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 12, "FORM.TIME_START"), "");
    \u0275\u0275advance(4);
    \u0275\u0275property("time", ctx_r1.form == null ? null : ctx_r1.form.value == null ? null : ctx_r1.form.value.date)("max", ctx_r1.max_duration)("use_24hr", ctx_r1.use_24hr)("timezone", ctx_r1.timezone);
  }
}
...
function ParkingFormDetailsComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(37, ParkingFormDetailsComponent_div_0_div_37_Template, 15, 15, "div", 13)(38, ParkingFormDetailsComponent_div_0_div_38_Template, 7, 3, "div", 14);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(10, 19, ctx_r1.building))("ngModelOptions", \u0275\u0275pureFunction0(37, _c027));
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingFormDetailsComponent, { className: "ParkingFormDetailsComponent", filePath: "apps/workplace/src/app/book/new-parking-flow/parking-form-details.component.ts", lineNumber: 139 });
})();
...
var _c028 = (a0, a1, a2, a3) => ({ name: a0, place: a1, date: a2, time: a3 });
var _c118 = () => ["/"];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingFlowSuccessComponent, { className: "ParkingFlowSuccessComponent", filePath: "apps/workplace/src/app/book/new-parking-flow/parking-flow-success.component.ts", lineNumber: 100 });
})();

// apps/workplace/src/app/book/new-parking-flow.component.ts
var _c029 = (a0) => ({ name: a0 });
var _c119 = () => ["/your-bookings"];
...
function NewParkingFlowComponent_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 5, "APP.WORKPLACE.PARKING_ASSIGNED", \u0275\u0275pureFunction1(10, _c029, (tmp_3_0 = \u0275\u0275pipeBind1(4, 3, ctx_r0.assigned_space)) == null ? null : tmp_3_0.name)), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(12, _c119));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 8, "APP.WORKPLACE.VIEW_SCHEDULE"), " ");
  }
}
...
function ParkingFlowMapComponent_div_0_button_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", (\u0275\u0275pipeBind1(6, 6, ctx_r2.counts) || \u0275\u0275pureFunction0(8, _c030))[date_r2.id] || "0", " ");
  }
}
...
var SpacePingComponent = class _SpacePingComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpacePingComponent, selectors: [["space-ping"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 2, consts: [[1, "pointer-events-auto", "absolute", "inset-0"], [1, "border-green-600", "absolute", "inset-0", "animate-ping", "border-4"]], template: function SpacePingComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275element(1, "div", 1);
        \u0275\u0275elementEnd();
...
var ParkingFlowMapComponent = class _ParkingFlowMapComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingFlowMapComponent, selectors: [["parking-flow-map"]], standalone: false, features: [\u0275\u0275ProvidersFeature([ExploreParkingService]), \u0275\u0275InheritDefinitionFeature], decls: 4, vars: 4, consts: [["load_state", ""], ["class", "relative flex h-full w-full flex-col items-center", 4, "ngIf", "ngIfElse"], [1, "relative", "flex", "h-full", "w-full", "flex-col", "items-center"], [1, "z-10", "flex", "w-full", "items-center", "justify-center", "space-x-2", "bg-secondary", "p-4", "text-white", "shadow"], ["matRipple", "", "class", "flex h-24 w-28 flex-col items-center justify-center rounded border border-white", 3, "selected", "click", 4, "ngFor", "ngForOf"], [1, "z-0", "flex", "h-1/2", "w-full", "flex-1"], [1, "z-10", "h-full", "w-full", "space-y-2", "overflow-auto", "border-r", "border-base-200", "bg-base-200", "p-2", "shadow", "sm:w-[18rem]"], ["class", "sticky top-0 z-10 w-full bg-base-100", 4, "ngIf"], ["matRipple", "", "class", "flex w-full items-center justify-between rounded-lg border border-base-200 bg-base-100 p-2", 3, "active", "click", 4, "ngFor", "ngForOf"], [1, "relative", "z-0", "hidden", "h-full", "w-1/2", "flex-1", "bg-base-200", "sm:block"], [3, "src", "zoom", "center", "styles", "features", "actions", "labels"], [1, "absolute", "bottom-0", "right-0"], ["class", "absolute bottom-2 left-1/2 flex -translate-x-1/2 flex-col space-y-2 rounded bg-base-100 p-4 shadow", 4, "ngIf"], ["class", "bg-base-100/80 absolute inset-0 z-50 flex flex-col items-center justify-center", 4, "ngIf"], ["matRipple", "", 1, "flex", "h-24", "w-28", "flex-col", "items-center", "justify-center", "rounded", "border", "border-white", 3, "click"], [1, "mb-2", "font-medium"], [1, "text-2xl"], [1, "text-sm"], [1, "sticky", "top-0", "z-10", "w-full", "bg-base-100"], ["appearance", "outline", 1, "h-[3.25rem]", "w-full"], [3, "ngModelChange", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["matRipple", "", 1, "flex", "w-full", "items-center", "justify-between", "rounded-lg", "border", "border-base-200", "bg-base-100", "p-2", 3, "click"], [1, "text-lg"], [1, "opacity-60"], [1, "absolute", "bottom-2", "left-1/2", "flex", "-translate-x-1/2", "flex-col", "space-y-2", "rounded", "bg-base-100", "p-4", "shadow"], ["class", "text-pending max-w-[20rem] rounded p-2 text-center text-sm leading-tight", 4, "ngIf"], ["btn", "", "matRipple", "", 3, "click"], [1, "text-pending", "max-w-[20rem]", "rounded", "p-2", "text-center", "text-sm", "leading-tight"], [1, "bg-base-100/80", "absolute", "inset-0", "z-50", "flex", "flex-col", "items-center", "justify-center"], ["class", "bg-base-100/80 absolute inset-0 z-50 flex flex-col items-center justify-center space-y-2", 4, "ngIf"], [1, "bg-base-100/80", "absolute", "inset-0", "z-50", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], ["diameter", "32"]], template: function ParkingFlowMapComponent_Template(rf, ctx) {
      if (rf & 1) {
...
function DetailBookSpaceFormComponent_form_0_div_18_mat_form_field_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.building)("ngModelOptions", \u0275\u0275pureFunction0(5, _c031));
    \u0275\u0275advance();
...
function DetailBookSpaceFormComponent_form_0_div_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("placeholder", "Any " + ctx_r1.features_label)("ngModel", ctx_r1.options == null ? null : ctx_r1.options.features)("ngModelOptions", \u0275\u0275pureFunction0(4, _c031));
    \u0275\u0275advance();
...
function DetailBookSpaceFormComponent_form_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("formGroup", ctx_r1.form);
    \u0275\u0275advance(11);
    \u0275\u0275property("ngModel", ctx_r1.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(11, _c031));
    \u0275\u0275advance(4);
...
var DetailBookSpaceFormComponent = class _DetailBookSpaceFormComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DetailBookSpaceFormComponent, selectors: [["detailed-book-space-form"]], inputs: { form: "form", options: "options", features: "features" }, outputs: { optionsChange: "optionsChange" }, standalone: false, decls: 1, vars: 1, consts: [[3, "formGroup", 4, "ngIf"], [3, "formGroup"], [1, "mb-4", "border-b", "border-base-200"], [1, "mx-auto", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "flex-col", "space-x-0", "sm:flex-row", "sm:space-x-2"], [1, "flex", "w-full", "flex-1", "flex-col", "sm:w-1/3"], ["for", "date"], ["name", "date", "formControlName", "date"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "relative", "flex", "w-full", "flex-1", "flex-col", "sm:w-1/3"], ["for", "end-time"], ["name", "end-time", "formControlName", "duration", 3, "time", "max"], ["formControlName", "all_day", "class", "absolute right-0 top-0", 4, "ngIf"], ["class", "flex w-full flex-1 flex-col", 4, "ngIf"], ["class", "mb-4 border-b border-base-200", 4, "ngIf"], [1, "mx-auto", "w-[640px]", "max-w-[calc(100%-2rem)]"], [1, "flex", "flex-col"], ["for", "title"], ["appearance", "outline"], ["name", "title", "matInput", "", "formControlName", "title", "placeholder", "Meeting title"], ["class", "mb-4 flex resize-y flex-col", 4, "ngIf"], ["class", "mb-4 flex flex-col", 4, "ngIf"], ["formControlName", "all_day", 1, "absolute", "right-0", "top-0"], [1, "flex", "w-full", "flex-1", "flex-col"], ["for", "building"], ["overlay", "", "buildings", "", "class", "h-[3.25rem] w-full", "appearance", "outline", 4, "ngIf"], ["overlay", "", "buildings", "", "appearance", "outline", 1, "h-[3.25rem]", "w-full"], ["placeholder", "Select Building...", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["for", "features"], ["overlay", "", "appearance", "outline", 1, "h-[3.25rem]", "w-full"], ["multiple", "", 3, "ngModelChange", "placeholder", "ngModel", "ngModelOptions"], ["class", "mx-auto flex w-[640px] max-w-[calc(100%-2rem)] flex-col", 4, "ngIf"], ["class", "mx-auto mb-2 flex w-[640px] max-w-[calc(100%-2rem)] flex-col", 4, "ngIf"], [1, "mx-auto", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "flex-col"], ["for", "host"], ["name", "host", "formControlName", "organiser"], [1, "mx-auto", "mb-2", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "flex-col"], ["for", "attendees"], ["name", "attendees", "formControlName", "attendees", 3, "hide_actions"], [1, "mb-4", "flex", "resize-y", "flex-col"], ["for", "notes"], ["name", "notes", "formControlName", "body", "placeholder", "Add meeting notes here..."], [1, "mb-4", "flex", "flex-col"], [3, "onAction"], ["class", "opacity-40", 4, "ngIf"], ["class", "flex items-center", 4, "ngIf"], [1, "opacity-40"], [1, "flex", "items-center"], [1, "w-1/2", "flex-1"], [1, "px-4", "text-xs", "opacity-60"]], template: function DetailBookSpaceFormComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var SpaceFlowFormComponent = class _SpaceFlowFormComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpaceFlowFormComponent, selectors: [["space-flow-form"]], standalone: false, decls: 20, vars: 11, consts: [["form", "", 1, "min-h-[50%]", "flex-1"], [1, "mx-auto", "mb-2", "mt-4", "w-[640px]", "max-w-[calc(100%-2rem)]", "text-xl", "font-medium", "uppercase"], [3, "optionsChange", "form", "options", "features"], [1, "mx-auto", "mb-4", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "flex-col", "items-center", "justify-center", "space-x-0", "space-y-2", "sm:flex-row", "sm:space-x-2", "sm:space-y-0"], ["btn", "", "matRipple", "", "clear", "", 1, "inverse", "h-[2.75rem]", "w-full", "sm:w-auto", "sm:flex-1", 3, "click"], [1, "flex", "items-center", "justify-center"], [1, "text-xl"], [1, "mx-4", "ml-2"], ["btn", "", "matRipple", "", "find-space", "", 1, "h-[2.75rem]", "w-full", "sm:w-auto", "sm:flex-1", 3, "click"], ["class", "h-[2.75rem] w-full sm:w-auto sm:flex-1", "btn", "", "matRipple", "", "standalone", "", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", "standalone", "", 1, "h-[2.75rem]", "w-full", "sm:w-auto", "sm:flex-1", 3, "click"]], template: function SpaceFlowFormComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var SpaceFlowFindItemComponent = class _SpaceFlowFindItemComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpaceFlowFindItemComponent, selectors: [["space-flow-find-item"]], inputs: { space: "space", multiple: "multiple", book: "book" }, outputs: { bookChange: "bookChange" }, standalone: false, decls: 19, vars: 8, consts: [[1, "mx-auto", "my-2", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "items-center", "rounded", "bg-base-100", "p-2", "shadow"], [1, "flex", "flex-1", "flex-col", "space-y-2"], [1, "flex", "items-center"], [1, "mr-2", "rounded-full", "bg-base-200", "p-2"], [1, "ml-2", "flex", "flex-col", "space-y-2"], ["matRipple", "", "book", "", 3, "click"], ["locate", "", "btn", "", "matRipple", "", 1, "inverse", 3, "click"]], template: function SpaceFlowFindItemComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var SpaceFlowFindComponent = class _SpaceFlowFindComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpaceFlowFindComponent, selectors: [["space-flow-find"]], standalone: false, features: [\u0275\u0275ProvidersFeature([SpacePipe])], decls: 30, vars: 20, consts: [["load_state", ""], ["empty_state", ""], ["menu", "matMenu"], ["topbar", "", 1, ""], ["btn", "", "matRipple", "", 1, "clear", "h-[2.75rem]", "text-white", 3, "routerLink"], [1, "flex", "h-full", "items-center", "justify-center"], [1, "text-xl"], [1, "mx-4", "ml-2"], ["filters", ""], [1, "mx-auto", "w-[640px]", "max-w-[calc(100%-2rem)]", "py-4"], [1, "text-xl", "font-medium", "uppercase", "text-white"], [1, "flex", "flex-col", "items-center", "space-x-0", "sm:flex-row", "sm:space-x-2"], ["overlay", "", "buildings", "", "class", "h-[3.25rem] w-full sm:w-px sm:flex-1", "appearance", "outline", 4, "ngIf"], ["class", "h-[3.25rem] w-full sm:w-px sm:flex-1", "overlay", "", "appearance", "outline", 4, "ngIf"], ["overlay", "", "appearance", "outline", 1, "hidden", "h-[3.25rem]", "w-full", "sm:block", "sm:w-px", "sm:flex-1"], ["placeholder", "Any Capacity", 3, "ngModelChange", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], ["class", "hidden h-[3.25rem] w-full sm:block sm:w-px sm:flex-1", "overlay", "", "appearance", "outline", 4, "ngIf"], [1, "w-full", "flex-1", "overflow-auto", "bg-base-200"], [4, "ngIf", "ngIfElse"], ["class", "border-t border-base-200 bg-base-100", 4, "ngIf"], ["overlay", "", "buildings", "", "appearance", "outline", 1, "h-[3.25rem]", "w-full", "sm:w-px", "sm:flex-1"], ["placeholder", "Select Building...", 3, "ngModelChange", "ngModel"], [3, "value"], ["overlay", "", "appearance", "outline", 1, "h-[3.25rem]", "w-full", "sm:w-px", "sm:flex-1"], ["placeholder", "Level", 3, "ngModelChange", "ngModel"], ["multiple", "", 3, "ngModelChange", "placeholder", "ngModel"], ["class", "mx-auto w-[640px] max-w-[calc(100%-2rem)]", 3, "space", "multiple", "book", "bookChange", 4, "ngFor", "ngForOf"], [1, "p-4", "text-center", "opacity-60"], [1, "mx-auto", "w-[640px]", "max-w-[calc(100%-2rem)]", 3, "bookChange", "space", "multiple", "book"], [1, "border-t", "border-base-200", "bg-base-100"], [1, "mx-auto", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "items-center", "p-2"], [1, "flex-1", "underline", 3, "matMenuTriggerFor"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click", "disabled"], ["yPosition", "above"], ["class", "pointer-events-none flex items-center leading-tight", "mat-menu-item", "", 4, "ngFor", "ngForOf"], ["mat-menu-item", "", "class", "opacity-60", 4, "ngIf"], ["mat-menu-item", "", 1, "pointer-events-none", "flex", "items-center", "leading-tight"], [1, "mr-4", "flex", "flex-col"], [1, "text-xs", "opacity-70"], ["icon", "", "matRipple", "", 1, "pointer-events-auto", 3, "click"], ["mat-menu-item", "", 1, "opacity-60"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "text-center"]], template: function SpaceFlowFindComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(19, _c032));
        \u0275\u0275advance(11);
...
var _c033 = () => ["/book", "spaces", "find"];
var _c120 = () => ["/book", "spaces", "form"];
...
function SpaceFlowConfirmComponent_div_55_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(6, _c120));
    \u0275\u0275advance(2);
...
var SpaceFlowConfirmComponent = class _SpaceFlowConfirmComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpaceFlowConfirmComponent, selectors: [["space-flow-confirm"]], standalone: false, decls: 60, vars: 34, consts: [["topbar", "", 1, ""], ["button", "", "btn", "", "matRipple", "", 1, "clear", "h-[2.75rem]", "text-white", 3, "routerLink"], [1, "flex", "h-full", "items-center", "justify-center"], [1, "text-xl"], [1, "mx-4", "ml-2"], [1, "mx-auto", "mb-4", "flex", "w-[640px]", "max-w-[calc(100%-2rem)]", "flex-col", "items-center", "space-y-2"], [1, "my-4", "w-full", "text-xl", "font-medium", "uppercase"], [1, "flex", "w-full", "items-center", "space-x-2", "border-b", "border-base-200", "py-2"], [1, "mr-2", "rounded-full", "bg-base-200", "p-2"], [1, "flex-1", "truncate"], [4, "ngIf"], ["btn", "", "matRipple", "", 1, "clear", "underline", 3, "routerLink"], [1, "w-full", "border-b", "border-base-200"], [1, "flex", "items-center", "space-x-2", "py-2"], ["matRipple", "", 1, "clear", "bg-transparent", "border-none", "underline", 3, "click", "disabled"], ["list", "", 1, "overflow-hidden"], ["class", "flex h-10 items-center pl-12", 4, "ngFor", "ngForOf"], ["class", "flex h-12 items-center space-x-2 pl-12", 4, "ngFor", "ngForOf"], ["class", "w-full border-b border-base-200", 4, "ngIf"], ["matRipple", "", "confirm", "", 1, "w-32", 3, "click", "disabled"], ["class", "mx-auto", 3, "diameter", 4, "ngIf"], [1, "flex", "h-10", "items-center", "pl-12"], ["matRipple", "", "class", "bg-transparent border-none underline", 4, "ngIf"], ["matRipple", "", 1, "bg-transparent", "border-none", "underline"], [1, "flex", "h-12", "items-center", "space-x-2", "pl-12"], [1, "text-sm", 3, "user"], ["matRipple", "", 1, "clear", "bg-transparent", "border-none", "underline", 3, "click"], [1, "w-1/2", "flex-1"], ["class", "text-xs underline", 3, "matTooltip", 4, "ngIf"], [1, "mx-2", "rounded", "bg-primary", "px-4", "py-2", "text-xs", "font-medium", "text-white"], [3, "ngModelChange", "ngModel"], [1, "text-xs", "underline", 3, "matTooltip"], [1, "mx-auto", 3, "diameter"]], template: function SpaceFlowConfirmComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "a", 1)(2, "div", 2)(3, "app-icon", 3);
        \u0275\u0275text(4, "arrow_back");
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(32, _c033));
        \u0275\u0275advance(2);
        ...
        \u0275\u0275advance();
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(33, _c120));
        \u0275\u0275advance(2);
...
var BookSpaceFlowComponent = class _BookSpaceFlowComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookSpaceFlowComponent, selectors: [["placeos-book-space-flow"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 6, vars: 4, consts: [[1, "h-full", "w-full", "bg-base-100"], [3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"], [3, "calendar"]], template: function BookSpaceFlowComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275elementContainerStart(1, 1);
...
//# sourceMappingURL=book.module-YOEKDV7Q.js.map
