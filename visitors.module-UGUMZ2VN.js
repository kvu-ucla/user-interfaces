...
var GuestListingComponent = class _GuestListingComponent extends AsyncHandler {
  ...
  ngOnInit() {
    this.subscription("building", this._org.active_building.subscribe((bld) => __async(this, null, function* () {
      ...
      const metadata = yield hu(bld.id, visitor_kiosk_app).toPromise();
      const org_metadata = yield hu(this._org.organisation.id, visitor_kiosk_app).toPromise();
...
function VisitorsComponent_mat_option_18_div_2_Template(rf, ctx) {
  if (rf & 1) {
...
function VisitorsComponent_mat_option_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 14)(1, "div", 15);
    \u0275\u0275template(2, VisitorsComponent_mat_option_18_div_2_Template, 5, 3, "div", 16);
...
function VisitorsComponent_mat_progress_bar_24_Template(rf, ctx) {
  if (rf & 1) {
...
var VisitorsComponent = class _VisitorsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorsComponent, selectors: [["", "app-new-visitors", ""]], standalone: false, attrs: _c02, decls: 26, vars: 18, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "items-center", "space-x-2", "px-8", "py-4"], [1, "text-2xl", "font-medium"], [1, "w-2", "flex-1"], [1, "mr-2", 3, "modelChange"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], [1, "flex", "items-center", "px-8", "pb-4"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [3, "dateChange"], [1, "mx-8", "h-1/2", "flex-1", "overflow-auto"], ["class", "w-full", "mode", "indeterminate", 4, "ngIf"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], ["mode", "indeterminate", 1, "w-full"]], template: function VisitorsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275listener("modelChange", function VisitorsComponent_Template_searchbar_modelChange_9_listener($event) {
          return ctx.setSearch($event);
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(10, "button", 6);
        \u0275\u0275listener("click", function VisitorsComponent_Template_button_click_10_listener() {
        ...
        \u0275\u0275pipe(16, "async");
        \u0275\u0275pipe(17, "translate");
        \u0275\u0275listener("ngModelChange", function VisitorsComponent_Template_mat_select_ngModelChange_15_listener($event) {
          return ctx.updateZones($event);
        });
        \u0275\u0275template(18, VisitorsComponent_mat_option_18_Template, 5, 3, "mat-option", 10);
        \u0275\u0275pipe(19, "async");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(20, "div", 4);
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(24, VisitorsComponent_mat_progress_bar_24_Template, 1, 0, "mat-progress-bar", 13);
        \u0275\u0275pipe(25, "async");
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
...
//# sourceMappingURL=visitors.module-UGUMZ2VN.js.map
