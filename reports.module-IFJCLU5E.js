...
function ReportSpacesComponent_ng_container_13_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "report-spaces-overall")(2, "report-spaces-overall-list", 10)(3, "report-spaces-space-listing", 10)(4, "report-spaces-user-listing", 10);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function ReportSpacesComponent_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ReportSpacesComponent_ng_container_13_ng_container_1_Template, 5, 3, "ng-container", 9);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
var ReportSpacesComponent = class _ReportSpacesComponent extends AsyncHandler {
  ...
  static {
    ...
    }, dependencies: [NgIf, MatProgressSpinner, AuthenticatedImageDirective, ReportsOptionsComponent, ReportSpacesOverallComponent, ReportSpacesOverallListComponent, ReportSpacesSpaceListingComponent, ReportSpacesUserListingComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=report-spaces.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesComponent, { className: "ReportSpacesComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces.component.ts", lineNumber: 79 });
})();
...
//# sourceMappingURL=reports.module-IFJCLU5E.js.map
