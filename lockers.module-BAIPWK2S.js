...
} from "./chunk-U3GA6UJ2.js";
import {
  BookingFormService,
  LockerGridComponent
} from "./chunk-H7WX3QGT.js";
import {
  ActivatedRoute,
...
function LockerBankModalComponent_main_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r2.form.value.zones[0])("ngModelOptions", \u0275\u0275pureFunction0(46, _c0));
    \u0275\u0275advance();
...
var LockerBankModalComponent = class _LockerBankModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerBankModalComponent, selectors: [["locker-bank-modal"]], outputs: { event: "event" }, standalone: false, decls: 13, vars: 9, consts: [["load_state", ""], ["chipList", ""], [1, "w-[32rem]"], [1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "flex max-h-[65vh] flex-col overflow-auto p-4", 3, "formGroup", 4, "ngIf", "ngIfElse"], [1, "flex", "items-center", "justify-end", "space-x-2", "border-t", "border-base-300", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "max-h-[65vh]", "flex-col", "overflow-auto", "p-4", 3, "formGroup"], ["for", "name"], ["appearance", "outline", 1, "w-full"], [3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], [1, "flex", "space-x-4"], [1, "flex", "flex-1", "flex-col"], ["appearance", "outline"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], ["for", "map-id"], ["matInput", "", "name", "map-id", "formControlName", "map_id", 3, "placeholder"], ["for", "row"], ["formControlName", "height", 1, "mb-4", 3, "min", "max", "render_fn"], ["for", "notes"], ["matInput", "", "name", "notes", "formControlName", "notes", 3, "placeholder"], ["for", "tags"], ["name", "tags", "aria-label", "Tag List"], [3, "removed", 4, "ngFor", "ngForOf"], ["placeholder", "Tags...", 3, "matChipInputTokenEnd", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "removed"], [1, "max-w-md", "truncate"], ["matChipRemove", ""], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], ["diameter", "32"]], template: function LockerBankModalComponent_Template(rf, ctx) {
      if (rf & 1) {
    ...
    }, dependencies: [NgForOf, NgIf, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, FormGroupDirective, FormControlName, MatFormField, MatError, MatInput, MatSelect, MatOption, MatProgressSpinner, MatDialogClose, MatRipple, CounterComponent, MatChipGrid, MatChipInput, MatChipRemove, MatChipRow, IconComponent, AsyncPipe, TranslatePipe, BuildingPipe], encapsulation: 2 });
  }
};
(() => {
...
function LockerBookingModalComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
...
function LockerBookingModalComponent_mat_checkbox_31_Template(rf, ctx) {
  if (rf & 1) {
...
function LockerBookingModalComponent_div_32_div_8_Template(rf, ctx) {
  if (rf & 1) {
...
function LockerBookingModalComponent_div_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("ngModelChange", function LockerBookingModalComponent_div_32_Template_a_time_field_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.form.patchValue({ date: $event }));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, LockerBookingModalComponent_div_32_div_8_Template, 7, 6, "div", 23);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var LockerBookingModalComponent = class _LockerBookingModalComponent extends AsyncHandler {
  ...
  constructor(_data, _booking_form, _dialog_ref, _settings, _org, _dialog) {
    super();
    this._data = _data;
  ...
  static {
    this.\u0275fac = function LockerBookingModalComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LockerBookingModalComponent)(\u0275\u0275directiveInject(MAT_DIALOG_DATA), \u0275\u0275directiveInject(BookingFormService), \u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(SettingsService), \u0275\u0275directiveInject(OrganisationService), \u0275\u0275directiveInject(MatDialog));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerBookingModalComponent, selectors: [["locker-booking-modal"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 37, vars: 36, consts: [[3, "confirm", "heading", "loading"], [3, "formGroup"], ["class", "mb-4 flex items-center space-x-2", 4, "ngIf"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1"], ["for", "user-name"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "user-name", "formControlName", "user_name", 3, "placeholder"], ["for", "email"], ["matInput", "", "name", "email", "formControlName", "user_email", 3, "placeholder"], [1, "relative"], ["for", "date"], ["formControlName", "date"], ["formControlName", "all_day", "class", "absolute -top-2 right-0", 4, "ngIf"], ["class", "flex items-center space-x-2", 4, "ngIf"], ["for", "locker"], ["name", "locker", "formControlName", "resources", 1, "mb-2"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["name", "user", "formControlName", "user", 1, "flex-1"], ["formControlName", "all_day", 1, "absolute", "-top-2", "right-0"], [1, "w-1/3", "flex-1"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "disabled", "use_24hr"], ["class", "relative w-1/3 flex-1", 4, "ngIf"], [1, "relative", "w-1/3", "flex-1"], ["for", "end-time"], ["name", "end-time", "formControlName", "duration", 3, "time", "max", "use_24hr"]], template: function LockerBookingModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(4, LockerBookingModalComponent_div_4_Template, 2, 0, "div", 2);
        ...
        \u0275\u0275template(31, LockerBookingModalComponent_mat_checkbox_31_Template, 3, 3, "mat-checkbox", 13);
        \u0275\u0275elementEnd();
        \u0275\u0275template(32, LockerBookingModalComponent_div_32_Template, 9, 9, "div", 14);
        \u0275\u0275elementStart(33, "label", 15);
        \u0275\u0275text(34);
        \u0275\u0275pipe(35, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275element(36, "locker-list-field", 16);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", ctx.allow_all_day && !ctx.disable_date);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.form.value.all_day);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(35, 34, "RESOURCE.LOCKER"));
      }
    }, dependencies: [NgIf, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, FormGroupDirective, FormControlName, MatFormField, MatError, MatInput, MatCheckbox, DateFieldComponent, DurationFieldComponent, TimeFieldComponent, UserSearchFieldComponent, FullscreenModalShellComponent, LockerListFieldComponent, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockerBookingModalComponent, { className: "LockerBookingModalComponent", filePath: "apps/concierge/src/app/lockers/locker-booking-modal.component.ts", lineNumber: 138 });
})();
...
function LockerModalComponent_main_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("ngModel", ctx_r2.form.value.position[0] + 1)("ngModelOptions", \u0275\u0275pureFunction0(76, _c03))("min", 1)("max", 255);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r2.form.value.position[1] + 1)("ngModelOptions", \u0275\u0275pureFunction0(77, _c03))("min", 1)("max", ctx_r2.bank == null ? null : ctx_r2.bank.height);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r2.form.value.size[0])("ngModelOptions", \u0275\u0275pureFunction0(78, _c03))("min", 1)("max", 10)("render_fn", ctx_r2.render_fn);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(45, 64, "COMMON.HEIGHT"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r2.form.value.size[1])("ngModelOptions", \u0275\u0275pureFunction0(79, _c03))("min", 1)("max", ((ctx_r2.bank == null ? null : ctx_r2.bank.height) || 10) - ctx_r2.form.value.position[1])("render_fn", ctx_r2.render_fn);
    \u0275\u0275advance();
...
var LockerModalComponent = class _LockerModalComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerModalComponent, selectors: [["locker-modal"]], outputs: { event: "event" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 13, vars: 9, consts: [["load_state", ""], ["chipList", ""], [1, "w-[32rem]"], [1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "flex max-h-[65vh] flex-col overflow-auto p-4", 3, "formGroup", 4, "ngIf", "ngIfElse"], [1, "flex", "items-center", "justify-end", "space-x-2", "border-t", "border-base-300", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "max-h-[65vh]", "flex-col", "overflow-auto", "p-4", 3, "formGroup"], ["for", "name"], ["appearance", "outline"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], ["for", "user"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["name", "user", "formControlName", "assigned_user", 1, "flex-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "min-w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "matTooltip"], ["className", "material-symbols-outlined"], [1, "mb-4", "flex", "space-x-4"], ["formControlName", "accessible", 1, "flex-1", 3, "name"], ["formControlName", "bookable", 1, "flex-1", 3, "name"], [1, "mb-1", "flex", "space-x-4"], [1, "flex-1"], ["for", "row"], [3, "ngModelChange", "ngModel", "ngModelOptions", "min", "max"], ["for", "column"], [1, "mb-4", "text-xs", "text-error"], [3, "ngModelChange", "ngModel", "ngModelOptions", "min", "max", "render_fn"], ["for", "notes"], ["matInput", "", "name", "notes", "formControlName", "notes", 3, "placeholder"], ["for", "features"], ["appearance", "outline", 1, "w-full"], ["name", "features", "aria-label", "Tag List"], [3, "removed", 4, "ngFor", "ngForOf"], [3, "matChipInputTokenEnd", "placeholder", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur"], [3, "removed"], [1, "max-w-md", "truncate"], ["matChipRemove", ""], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], ["diameter", "32"]], template: function LockerModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "div", 2)(1, "header", 3)(2, "h2", 4);
        \u0275\u0275text(3);
    ...
    }, dependencies: [NgForOf, NgIf, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, FormGroupDirective, FormControlName, MatFormField, MatError, MatInput, MatTooltip, MatProgressSpinner, MatDialogClose, MatRipple, CounterComponent, UserSearchFieldComponent, MatChipGrid, MatChipInput, MatChipRemove, MatChipRow, IconComponent, SettingsToggleComponent, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
...
var ViewLockerBankModalComponent = class _ViewLockerBankModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ViewLockerBankModalComponent, selectors: [["view-locker-bank-modal"]], standalone: false, decls: 8, vars: 2, consts: [[1, "sticky", "top-0", "z-10", "mx-4", "mb-2", "mt-4", "w-[calc(100%-2rem)]", "rounded", "border-none", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "h-[65vh]", "w-[65vw]", "overflow-auto", "px-2", "pb-2"], ["default_status", "not-bookable", 3, "bank"]], template: function ViewLockerBankModalComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ViewLockerBankModalComponent, { className: "ViewLockerBankModalComponent", filePath: "apps/concierge/src/app/lockers/view-locker-bank-modal.component.ts", lineNumber: 27 });
})();
...
var LockerStateService = class _LockerStateService extends AsyncHandler {
  ...
  releaseAllLockers(confirm = false) {
    return __async(this, null, function* () {
      const mod = this._org.module("lockers", "Lockers");
      if (!mod)
        return notifyError(i18n("APP.CONCIERGE.LOCKERS_NO_DRIVER"));
      let close;
      const lockers = yield nextValueFrom(this.lockers$);
      if (!lockers.length)
        return;
      if (confirm) {
      ...
      yield mod.execute("release_all_lockers", []).catch((e) => {
  ...
  editLockerBank() {
    return __async(this, arguments, function* (bank = {}) {
      ...
      const banks = yield nextValueFrom(this.lockers_banks$);
  ...
  editBooking(_0) {
    return __async(this, arguments, function* (booking, { parent_id, user, link_id, date, space, allow_time_changes, external_user } = {}) {
      const levels = yield nextValueFrom(this.levels);
      const spaces = yield nextValueFrom(this.lockers$);
...
function LockerBookingsComponent_ng_template_16_ng_container_1_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
...
function LockerBookingsComponent_ng_template_16_ng_container_1_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function LockerBookingsComponent_ng_template_16_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 15);
    \u0275\u0275template(2, LockerBookingsComponent_ng_template_16_ng_container_1_ng_container_2_Template, 4, 8, "ng-container", 16)(3, LockerBookingsComponent_ng_template_16_ng_container_1_ng_container_3_Template, 3, 3, "ng-container", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function LockerBookingsComponent_ng_template_16_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
...
function LockerBookingsComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, LockerBookingsComponent_ng_template_16_ng_container_1_Template, 4, 2, "ng-container", 16)(2, LockerBookingsComponent_ng_template_16_ng_container_2_Template, 4, 3, "ng-container", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LockerBookingsComponent_ng_template_20_div_3_Template(rf, ctx) {
  if (rf & 1) {
...
function LockerBookingsComponent_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, LockerBookingsComponent_ng_template_20_div_3_Template, 2, 1, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LockerBookingsComponent_button_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 32);
    \u0275\u0275listener("click", function LockerBookingsComponent_button_26_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
...
var LockerBookingsComponent = class _LockerBookingsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerBookingsComponent, selectors: [["locker-bookings"]], standalone: false, decls: 27, vars: 57, consts: [["date_template", ""], ["period_template", ""], ["locker_template", ""], ["user_template", ""], ["status_template", ""], ["option_template", ""], ["menu", "matMenu"], ["checkinMenu", "matMenu"], [1, "h-4", "w-full"], [1, "flex", "h-full", "w-full", "flex-col", "pt-4"], [1, "mr-4", "block", "w-full", "min-w-[72rem]", "flex-1", "overflow-auto", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["btn", "", "matRipple", "", "class", "absolute bottom-2 left-4 z-20 w-32", 3, "click", 4, "ngIf"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "py-2"], [1, "opacity-60"], [1, "text-xl"], [1, "p-2"], [4, "ngIf"], [1, "rounded-3xl", "bg-error", "px-4", "py-2", "text-xs", "text-white"], [1, "p-4"], [1, "flex", "flex-col", "justify-center", "px-4", "py-2"], [1, "select-all"], ["class", "select-all text-xs opacity-30", 4, "ngIf"], [1, "select-all", "text-xs", "opacity-30"], [1, "px-2"], ["matRipple", "", 1, "h-10", "w-[7.5rem]", "rounded-3xl", "border-none", "bg-warning", "text-warning-content", 3, "matMenuTriggerFor", "disabled"], [1, "flex", "items-center", "space-x-2", "pl-4", "pr-2"], [1, "flex-1", "text-left"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], ["matRipple", "", 1, "h-10", "w-24", "rounded-3xl", "border-none", "bg-warning", "text-warning-content", 3, "matMenuTriggerFor", "disabled", "matTooltip"], ["btn", "", "matRipple", "", 1, "absolute", "bottom-2", "left-4", "z-20", "w-32", 3, "click"]], template: function LockerBookingsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275declareLet(0);
        \u0275\u0275pipe(1, "async");
        \u0275\u0275element(2, "div", 8);
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(26, LockerBookingsComponent_button_26_Template, 3, 3, "button", 11);
      }
      if (rf & 2) {
        let tmp_13_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockerBookingsComponent, { className: "LockerBookingsComponent", filePath: "apps/concierge/src/app/lockers/locker-bookings.component.ts", lineNumber: 263 });
})();
...
function LockersTopbarComponent_mat_option_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, LockersTopbarComponent_mat_option_16_div_2_Template, 5, 3, "div", 22);
    \u0275\u0275elementStart(3, "div");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()()();
  }
...
function LockersTopbarComponent_button_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 26);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function LockersTopbarComponent_button_20_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function LockersTopbarComponent_date_options_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "date-options", 27);
    \u0275\u0275listener("dateChange", function LockersTopbarComponent_date_options_21_Template_date_options_dateChange_0_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
...
var LockersTopbarComponent = class _LockersTopbarComponent extends AsyncHandler {
  ...
  newBooking() {
    return __async(this, null, function* () {
      const { date } = yield nextValueFrom(this.options);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersTopbarComponent, selectors: [["lockers-topbar"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 22, vars: 23, consts: [[1, "flex", "w-full", "items-center", "space-x-2", "px-8", "py-4"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], [1, "mr-2", 3, "modelChange", "model"], [3, "matTooltip"], ["btn", "", "matRipple", "", "class", "w-40 space-x-2", 3, "disabled", "click", 4, "ngIf"], ["btn", "", "matRipple", "", "class", "w-48 space-x-2", 3, "click", 4, "ngIf"], [1, "mb-2", "flex", "h-14", "items-center", "bg-base-100", "px-8"], ["appearance", "outline", 1, "no-subscript", "w-56"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [1, "w-0", "flex-1"], ["icon", "", "matRipple", "", "class", "mr-2 h-12 w-12 rounded border border-error text-error", 3, "matTooltip", "click", 4, "ngIf"], ["icon", "", "matRipple", "", "class", "h-12 w-12 rounded bg-secondary text-secondary-content", 3, "matTooltip", "click", 4, "ngIf"], [3, "dateChange", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "w-40", "space-x-2", 3, "click", "disabled"], [1, "pl-4"], [1, "text-2xl"], ["btn", "", "matRipple", "", 1, "w-48", "space-x-2", 3, "click"], [1, "pl-2"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], ["icon", "", "matRipple", "", 1, "mr-2", "h-12", "w-12", "rounded", "border", "border-error", "text-error", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "matTooltip"], [3, "dateChange"]], template: function LockersTopbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275element(18, "div", 11);
        \u0275\u0275template(19, LockersTopbarComponent_button_19_Template, 4, 3, "button", 12)(20, LockersTopbarComponent_button_20_Template, 4, 3, "button", 13)(21, LockersTopbarComponent_date_options_21_Template, 1, 0, "date-options", 14);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_1_0;
        ...
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(15, 19, "COMMON.LEVEL_ALL"));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(17, 21, ctx.levels));
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersTopbarComponent, { className: "LockersTopbarComponent", filePath: "apps/concierge/src/app/lockers/locker-topbar.component.ts", lineNumber: 130 });
})();
...
function LockerListComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 24)(1, "button", 25)(2, "icon");
    \u0275\u0275text(3, "more_vert");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementStart(7, "div", 27)(8, "icon", 28);
    \u0275\u0275text(9, "add");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(14, "div", 27)(15, "icon", 28);
    ...
    \u0275\u0275elementStart(20, "div", 27)(21, "icon", 28);
    \u0275\u0275text(22, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(27, "div", 27)(28, "icon", 29);
    \u0275\u0275text(29, "delete");
    \u0275\u0275elementEnd();
...
function LockerListComponent_ng_template_18_ng_template_3_div_0_Template(rf, ctx) {
  if (rf & 1) {
...
function LockerListComponent_ng_template_18_ng_template_3_button_1_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function LockerListComponent_ng_template_18_ng_template_3_button_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 20);
    \u0275\u0275listener("click", function LockerListComponent_ng_template_18_ng_template_3_button_1_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r11);
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, LockerListComponent_ng_template_18_ng_template_3_button_1_div_3_Template, 2, 1, "div", 22);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LockerListComponent_ng_template_18_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, LockerListComponent_ng_template_18_ng_template_3_div_0_Template, 3, 3, "div", 33)(1, LockerListComponent_ng_template_18_ng_template_3_button_1_Template, 4, 2, "button", 34);
  }
  if (rf & 2) {
...
function LockerListComponent_ng_template_18_ng_template_9_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function LockerListComponent_ng_template_18_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, LockerListComponent_ng_template_18_ng_template_9_div_1_Template, 4, 3, "div", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LockerListComponent_ng_template_18_ng_template_11_div_0_Template(rf, ctx) {
  if (rf & 1) {
...
function LockerListComponent_ng_template_18_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, LockerListComponent_ng_template_18_ng_template_11_div_0_Template, 4, 3, "div", 43);
  }
  if (rf & 2) {
...
function LockerListComponent_ng_template_18_ng_template_13_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(8, "div", 27)(9, "icon", 28);
    \u0275\u0275text(10, "share");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(15, "div", 27)(16, "icon", 28);
...
function LockerListComponent_ng_template_18_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(13, LockerListComponent_ng_template_18_ng_template_13_Conditional_13_Template, 21, 9);
    \u0275\u0275elementStart(14, "button", 26);
    ...
    \u0275\u0275elementStart(15, "div", 27)(16, "icon", 29);
    \u0275\u0275text(17, "delete");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "span");
    \u0275\u0275text(19);
...
var LockerListComponent = class _LockerListComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerListComponent, selectors: [["locker-list"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 20, vars: 42, consts: [["height_template", ""], ["id_template", ""], ["name_template", ""], ["action_template", ""], ["locker_list_template", ""], ["menu", "matMenu"], ["assigned_template", ""], ["pos_template", ""], ["size_template", ""], ["accessible_template", ""], ["bool_template", ""], ["locker_action_template", ""], ["locker_menu", "matMenu"], [1, "w-full"], [1, "block", "min-w-[52rem]", "text-sm", 3, "data", "columns", "filter", "show_children", "child_template", "sortable", "empty_message"], [1, "h-20", "w-full"], [1, "px-4", "font-mono"], [1, "px-4", "py-2", "text-left", "font-mono", "leading-tight", 3, "click"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], ["class", "font-mono text-[0.625rem] opacity-30", 4, "ngIf"], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "flex", "w-full", "items-center", "justify-end", "space-x-2", "px-2"], ["icon", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl"], [1, "text-xl", "text-error"], ["icon", "", "matRipple", "", 3, "click", "disabled"], [1, "text-2xl"], [3, "data", "show_header", "columns", "filter", "empty_message"], ["class", "p-4 opacity-30", 4, "ngIf"], ["class", "px-4 py-2 text-left leading-tight", 3, "click", 4, "ngIf"], [1, "p-4", "opacity-30"], [1, "flex", "w-full", "space-x-2", "p-2"], [1, "flex", "flex-col"], [1, "text-xs", "opacity-30"], [1, "w-12", "rounded", "bg-base-200", "px-2", "py-1", "text-center"], [1, "flex", "w-full", "items-center", "justify-center", "p-2"], ["class", "flex h-8 w-8 items-center justify-center rounded bg-info text-info-content", 3, "matTooltip", 4, "ngIf"], [1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "bg-info", "text-info-content", 3, "matTooltip"], ["class", "mx-auto flex h-8 w-8 items-center justify-center rounded bg-success text-2xl text-success-content", 3, "matTooltip", 4, "ngIf"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "bg-success", "text-2xl", "text-success-content", 3, "matTooltip"]], template: function LockerListComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockerListComponent, { className: "LockerListComponent", filePath: "apps/concierge/src/app/lockers/locker-list.component.ts", lineNumber: 325 });
})();

// apps/concierge/src/app/lockers/lockers.component.ts
var _c06 = ["app-new-lockers", ""];
function LockersComponent_mat_progress_bar_8_Template(rf, ctx) {
  if (rf & 1) {
...
var LockersComponent = class _LockersComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function LockersComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LockersComponent)(\u0275\u0275directiveInject(LockerStateService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(SettingsService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersComponent, selectors: [["", "app-new-lockers", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c06, decls: 10, vars: 3, consts: [[1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "w-full"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], [1, "h-full", "w-full", "overflow-auto"], ["class", "w-full", "mode", "indeterminate", 4, "ngIf"], ["mode", "indeterminate", 1, "w-full"]], template: function LockersComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275template(8, LockersComponent_mat_progress_bar_8_Template, 1, 0, "mat-progress-bar", 5);
        \u0275\u0275pipe(9, "async");
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersComponent, { className: "LockersComponent", filePath: "apps/concierge/src/app/lockers/lockers.component.ts", lineNumber: 43 });
})();
...
//# sourceMappingURL=lockers.module-BAIPWK2S.js.map
