...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GroupEventsFiltersListComponent, { className: "GroupEventsFiltersListComponent", filePath: "apps/workplace/src/app/events/group-events-filters-list.component.ts", lineNumber: 49 });
})();
...
var GroupEventsComponent = class _GroupEventsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GroupEventsComponent, selectors: [["", "group-events", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c02, decls: 12, vars: 7, consts: [["no_events", ""], [1, "flex", "flex-col", "sm:flex-row", "flex-1", "h-1/2", "bg-base-200"], [1, "w-full", "sm:w-1/2", "flex-1", "h-full", "overflow-auto", "p-2", "sm:p-4"], ["class", "my-2 mx-auto w-[64rem] max-w-full", 3, "event", "featured", 4, "ngIf"], [4, "ngIf", "ngIfElse"], [1, "my-2", "mx-auto", "w-[64rem]", "max-w-full", 3, "event", "featured"], [1, "flex", "flex-wrap", "mt-2", "w-[64rem]", "max-w-full", "mx-auto"], ["class", "m-2", 3, "event", 4, "ngFor", "ngForOf"], [1, "m-2", 3, "event"], [1, "flex", "flex-col", "items-center", "justify-center", "w-full", "h-full", "space-y-2"], ["src", "assets/icons/no-results.svg", 1, "w-32"], [1, "font-medium"], [1, "opacity-30"]], template: function GroupEventsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "topbar");
...
//# sourceMappingURL=group-events.module-4NSSMNHS.js.map
