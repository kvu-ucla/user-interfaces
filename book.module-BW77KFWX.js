...
function NewDeskFlowConfirmComponent_section_29_div_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 11, "FORM.ASSETS_REQUESTED_FOR", \u0275\u0275pureFunction1(17, _c012, \u0275\u0275pipeBind2(5, 8, request_r4.deliver_at_time, "MMM d, " + ctx_r1.time_format))), " ");
    \u0275\u0275advance(3);
...
function NewDeskFormDetailsComponent_div_0_div_35_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("date", ctx_r1.form.getRawValue().date)("ngModel", ctx_r1.form.value)("ngModelOptions", \u0275\u0275pureFunction0(7, _c013));
    \u0275\u0275advance();
...
function NewDeskFormDetailsComponent_div_0_div_36_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", !!ctx_r1.form.value.secondary_resource)("ngModelOptions", \u0275\u0275pureFunction0(5, _c013));
    \u0275\u0275advance();
...
function NewDeskFormDetailsComponent_div_0_section_37_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ((tmp_3_0 = \u0275\u0275pipeBind1(10, 5, ctx_r1.options)) == null ? null : tmp_3_0.members) || \u0275\u0275pureFunction0(7, _c18))("ngModelOptions", \u0275\u0275pureFunction0(8, _c013));
  }
}
...
var NewDeskFlowSuccessComponent = class _NewDeskFlowSuccessComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDeskFlowSuccessComponent, selectors: [["desk-flow-success"]], standalone: false, decls: 14, vars: 15, consts: [[1, "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto", "bg-base-100"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-center", "text-2xl", "font-medium"], ["src", "assets/icons/success.svg"], ["class", "text-center", 4, "ngIf"], ["assets", "", 4, "ngIf"], [4, "ngIf"], ["class", "relative flex flex-col items-center space-y-4 p-4", 4, "ngIf"], [1, "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "border-base-200", "bg-base-100", "p-2"], ["btn", "", "name", "desk-confirm-continue", "matRipple", "", 1, "mx-auto", "w-full", "max-w-[32rem]", 3, "routerLink"], [1, "text-center"], ["assets", ""], [1, "relative", "flex", "flex-col", "items-center", "space-y-4", "p-4"], ["btn", "", "matRipple", "", "name", "desk-outlook-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/outlook.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-google-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/gcal.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-ical-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], [1, "text-xl"]], template: function NewDeskFlowSuccessComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 7, "BOOKINGS.ITEM_BOOKED", \u0275\u0275pureFunction1(12, _c014, (ctx.last_event.asset_name || ctx.last_event.asset_id) + ctx.location)), " ");
        \u0275\u0275advance(3);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FlowSuccessComponent, selectors: [["flow-success"]], inputs: { calendar: "calendar", extra: "extra", route: "route", type: "type" }, standalone: false, decls: 15, vars: 14, consts: [["name", "success", 1, "bg-indigo-900", "fixed", "inset-0", "z-50", "flex", "flex-col", "items-center", "justify-center"], [1, "mb-4", "rounded-full", "bg-base-100", "text-7xl", "text-success"], [1, "mb-4", "text-center", "text-lg", "leading-10", "text-white"], [4, "ngIf"], [1, "flex", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "w-32", "border", "border-white", 3, "routerLink", "queryParams"]], template: function FlowSuccessComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(8, _c015, ctx.route))("queryParams", \u0275\u0275pureFunction0(10, _c110));
        \u0275\u0275advance(2);
...
function LockerFormDetailsComponent_div_0_div_29_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.getRawValue().date)("ngModelOptions", \u0275\u0275pureFunction0(9, _c016))("use_24hr", ctx_r1.use_24hr)("disabled", ctx_r1.form.controls.date.disabled || ctx_r1.form.value.duration > 24 * 60 - 1 || ctx_r1.disable_start)("timezone", ctx_r1.timezone);
    \u0275\u0275advance();
...
function MeetingFlowConfirmModalComponent_div_29_ng_container_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275declareLet(4);
    \u0275\u0275pipe(5, "level");
    \u0275\u0275elementStart(6, "div", 10)(7, "app-icon", 11);
    \u0275\u0275text(8, "layers");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const space_r3 = \u0275\u0275pipeBind1(3, 4, \u0275\u0275pipeBind1(2, 2, s_r2.email));
    const level_r4 = \u0275\u0275pipeBind1(5, 6, space_r3 == null ? null : space_r3.zones);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate2(" ", (level_r4 == null ? null : level_r4.display_name) || (level_r4 == null ? null : level_r4.name), ", ", s_r2.display_name || s_r2.name, " ");
  }
}
function MeetingFlowConfirmModalComponent_div_29_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10)(1, "app-icon", 11);
    \u0275\u0275text(2, "place");
    \u0275\u0275elementEnd();
...
function MeetingFlowConfirmModalComponent_div_31_div_1_div_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 15, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(23, _c019, order_r7.item_count)), " ");
    \u0275\u0275advance(3);
...
function MeetingFlowConfirmModalComponent_div_31_div_2_div_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 14, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(19, _c019, request_r8.item_count)), " ");
    \u0275\u0275advance(3);
...
function MeetingFlowConfirmModalComponent_div_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, MeetingFlowConfirmModalComponent_div_31_div_1_Template, 9, 4, "div", 17)(2, MeetingFlowConfirmModalComponent_div_31_div_2_Template, 8, 9, "div", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowConfirmModalComponent, { className: "MeetingFlowConfirmModalComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-confirm-modal.component.ts", lineNumber: 382 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowConfirmComponent, { className: "MeetingFlowConfirmComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-confirm.component.ts", lineNumber: 152 });
})();
...
function MeetingFormDetailsComponent_div_0_div_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r0.form.getRawValue().date)("ngModelOptions", \u0275\u0275pureFunction0(10, _c021))("disabled", ctx_r0.form.controls.date.disabled)("use_24hr", ctx_r0.use_24hr)("timezone", ctx_r0.timezone);
    \u0275\u0275advance();
...
var MeetingFlowSuccessComponent = class _MeetingFlowSuccessComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowSuccessComponent, selectors: [["meeting-flow-success"]], standalone: false, decls: 5, vars: 16, consts: [["class", "absolute inset-0 z-50 flex flex-col overflow-auto bg-base-100", 4, "ngIf"], [1, "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto", "bg-base-100"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium"], ["src", "assets/icons/success.svg"], [1, "max-w-[32rem]", "text-center"], [4, "ngIf"], [1, "h-4"], ["btn", "", "matRipple", "", "class", "w-48", 3, "click", 4, "ngIf"], [1, "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "border-base-200", "bg-base-100", "p-2"], ["btn", "", "name", "meeting-created-continue", "matRipple", "", 1, "w-full", "max-w-[32rem]", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click"]], template: function MeetingFlowSuccessComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275storeLet(\u0275\u0275pureFunction4(11, _c023, (ctx.level == null ? null : ctx.level.display_name) || (ctx.level == null ? null : ctx.level.name), (ctx.space == null ? null : ctx.space.display_name) || (ctx.space == null ? null : ctx.space.name), \u0275\u0275pipeBind2(1, 1, ctx.last_event.date, "mediumDate"), \u0275\u0275pipeBind2(2, 4, ctx.last_event.date, ctx.time_format) + " \u2014 " + \u0275\u0275pipeBind2(3, 7, ctx.last_event.date_end, ctx.time_format)));
        \u0275\u0275advance(4);
        \u0275\u0275property("ngIf", !ctx.loading);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewParkingFlowConfirmComponent, { className: "NewParkingFlowConfirmComponent", filePath: "apps/workplace/src/app/book/parking-flow/parking-flow-confirm.component.ts", lineNumber: 108 });
})();
...
function ParkingFormDetailsComponent_div_0_div_37_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.getRawValue().date)("ngModelOptions", \u0275\u0275pureFunction0(15, _c024))("use_24hr", ctx_r1.use_24hr)("disabled", ctx_r1.form.controls.date.disabled)("timezone", ctx_r1.timezone);
    \u0275\u0275advance(3);
...
function ParkingFormDetailsComponent_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(10, 19, ctx_r1.building))("ngModelOptions", \u0275\u0275pureFunction0(37, _c024));
    \u0275\u0275advance(2);
...
var _c025 = (a0, a1, a2, a3) => ({ name: a0, place: a1, date: a2, time: a3 });
var _c116 = () => ["/"];
...
function NewParkingFlowComponent_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 5, "APP.WORKPLACE.PARKING_ASSIGNED", \u0275\u0275pureFunction1(10, _c026, (tmp_3_0 = \u0275\u0275pipeBind1(4, 3, ctx_r0.assigned_space)) == null ? null : tmp_3_0.name)), " ");
    \u0275\u0275advance(3);
...
//# sourceMappingURL=book.module-BW77KFWX.js.map
