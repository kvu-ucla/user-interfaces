...
var FacilitiesTopbarComponent = class _FacilitiesTopbarComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FacilitiesTopbarComponent, selectors: [["facilities-topbar"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 13, vars: 9, consts: [[1, "flex", "items-center", "bg-base-100", "h-20", "px-4", "border-b", "border-base-200", "space-x-2"], ["appearance", "outline"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], ["multiple", "", "placeholder", "No Events", 3, "ngModelChange", "ngModel"], [1, "flex-full"], [1, "mr-2"], [3, "value"]], template: function FacilitiesTopbarComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var FacilitiesComponent = class _FacilitiesComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FacilitiesComponent, selectors: [["", "app-facilities", ""]], standalone: false, attrs: _c02, decls: 6, vars: 0, consts: [[1, "relative", "w-full", "flex", "flex-col", "bg-base-200"], [1, "flex", "flex-1"], [1, "flex-1", "h-full"], [1, "h-full", "space-y-4"]], template: function FacilitiesComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "sidebar");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FacilitiesComponent, { className: "FacilitiesComponent", filePath: "apps/concierge/src/app/facilities/facilities.component.ts", lineNumber: 30 });
})();

// apps/concierge/src/app/facilities/new-facilities.component.ts
var _c03 = ["app-new-facilities", ""];
var NewFacilitiesComponent = class _NewFacilitiesComponent {
  static {
    this.\u0275fac = function NewFacilitiesComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NewFacilitiesComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewFacilitiesComponent, selectors: [["", "app-new-facilities", ""]], standalone: false, attrs: _c03, decls: 8, vars: 0, consts: [[1, "flex", "flex-1", "h-px"], [1, "flex", "flex-col", "flex-1", "w-1/2", "h-full"], [1, "flex", "flex-1"], [1, "flex-1", "h-full"], [1, "h-full", "space-y-4"]], template: function NewFacilitiesComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewFacilitiesComponent, { className: "NewFacilitiesComponent", filePath: "apps/concierge/src/app/facilities/new-facilities.component.ts", lineNumber: 37 });
})();
...
//# sourceMappingURL=facilities.module-B3EPW7U4.js.map
