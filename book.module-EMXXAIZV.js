...
function CateringItemModalComponent_form_4_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22)(1, "label", 26);
    \u0275\u0275text(2, " Category");
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4, "*");
    \u0275\u0275elementEnd();
...
function CateringItemModalComponent_form_4_div_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22)(1, "label", 28);
    \u0275\u0275text(2, " Caterer");
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4, "*");
    \u0275\u0275elementEnd();
...
function CateringItemModalComponent_form_4_div_6_mat_chip_row_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275elementStart(2, "button", 36)(3, "app-icon");
    \u0275\u0275text(4, "cancel");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function CateringItemModalComponent_form_4_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275i18n(2, 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 24)(4, "mat-chip-grid", 32, 3);
    \u0275\u0275template(6, CateringItemModalComponent_form_4_div_6_mat_chip_row_6_Template, 5, 2, "mat-chip-row", 33);
    \u0275\u0275elementEnd();
...
function CateringItemModalComponent_form_4_div_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 30)(1, "label", 37);
    \u0275\u0275text(2, "Description:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 24);
    \u0275\u0275element(4, "textarea", 38);
    \u0275\u0275elementEnd()();
  }
}
function CateringItemModalComponent_form_4_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 30)(1, "label", 23);
    \u0275\u0275text(2, " Unit Price");
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4, "*");
    \u0275\u0275elementEnd();
...
function CateringItemModalComponent_form_4_div_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 30)(1, "label", 40);
    \u0275\u0275i18n(2, 5);
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "image-list-field", 41);
    \u0275\u0275elementEnd();
  }
}
function CateringItemModalComponent_form_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, CateringItemModalComponent_form_4_div_2_Template, 10, 2, "div", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 12);
    \u0275\u0275template(4, CateringItemModalComponent_form_4_div_4_Template, 10, 3, "div", 13)(5, CateringItemModalComponent_form_4_div_5_Template, 10, 3, "div", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, CateringItemModalComponent_form_4_div_6_Template, 8, 6, "div", 14)(7, CateringItemModalComponent_form_4_div_7_Template, 5, 0, "div", 14)(8, CateringItemModalComponent_form_4_div_8_Template, 10, 2, "div", 14);
    \u0275\u0275elementStart(9, "div", 15)(10, "label", 16);
    \u0275\u0275text(11, "Accept Points?");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "mat-checkbox", 17);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 18)(15, "mat-checkbox", 19);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "mat-checkbox", 19);
    ...
    \u0275\u0275text(18, " Vegan (VG) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "mat-checkbox", 19);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "mat-checkbox", 19);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "mat-checkbox", 19);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 15)(26, "label", 20);
    \u0275\u0275text(27, "Discount Cap");
    \u0275\u0275elementEnd();
    \u0275\u0275element(28, "a-counter", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275template(29, CateringItemModalComponent_form_4_div_29_Template, 4, 0, "div", 14);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_11_0;
...
function CateringItemModalComponent_footer_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "footer", 42)(1, "button", 43);
...
_CateringItemModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringItemModalComponent, selectors: [["catering-item-modal"]], outputs: { event: "event" }, decls: 14, vars: 7, consts: () => {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, CateringItemModalComponent_button_3_Template, 3, 0, "button", 6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, CateringItemModalComponent_form_4_Template, 30, 28, "form", 7)(5, CateringItemModalComponent_footer_5_Template, 3, 1, "footer", 8)(6, CateringItemModalComponent_ng_template_6_Template, 4, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementStart(8, "mat-autocomplete", null, 1);
    \u0275\u0275template(10, CateringItemModalComponent_mat_option_10_Template, 2, 2, "mat-option", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-autocomplete", null, 2);
    \u0275\u0275template(13, CateringItemModalComponent_mat_option_13_Template, 2, 2, "mat-option", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringItemModalComponent, { className: "CateringItemModalComponent", filePath: "libs/catering/src/lib/catering-item-modal.component.ts", lineNumber: 284 });
})();
...
function MeetingFlowFormComponent_form_5_section_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "section", 7)(1, "h3", 8)(2, "div", 9);
    \u0275\u0275text(3, " 2 ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(15, "a-user-list-field", 25);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MeetingFlowFormComponent_form_5_section_29_mat_form_field_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-form-field", 31);
    ...
    \u0275\u0275elementStart(1, "mat-select", 32)(2, "input", 33, 0);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "mat-option", 34);
    \u0275\u0275template(5, MeetingFlowFormComponent_form_5_section_29_mat_form_field_13_mat_option_5_Template, 2, 2, "mat-option", 35);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275elementEnd();
...
function MeetingFlowFormComponent_form_5_section_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(12, "catering-list-field", 28);
    \u0275\u0275template(13, MeetingFlowFormComponent_form_5_section_29_mat_form_field_13_Template, 9, 6, "mat-form-field", 29);
    \u0275\u0275pipe(14, "async");
    \u0275\u0275template(15, MeetingFlowFormComponent_form_5_section_29_mat_form_field_15_Template, 5, 4, "mat-form-field", 30);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MeetingFlowFormComponent_form_5_section_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(13, "asset-list-field", 40);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MeetingFlowFormComponent_form_5_section_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 7)(1, "h3", 41)(2, "div", 9);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "async");
    \u0275\u0275pipe(5, "async");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(13, "rich-text-input", 44);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MeetingFlowFormComponent_form_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "form", 6)(1, "section", 7)(2, "h3", 8)(3, "div", 9);
    \u0275\u0275text(4, " 1 ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 10);
    \u0275\u0275text(6);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "div", 13);
    \u0275\u0275element(13, "meeting-form-details", 14);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(14, MeetingFlowFormComponent_form_5_section_14_Template, 16, 10, "section", 15);
    \u0275\u0275elementStart(15, "section", 7)(16, "h3", 8)(17, "div", 9);
    \u0275\u0275text(18, " 3 ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(27, MeetingFlowFormComponent_form_5_div_27_Template, 2, 0, "div", 18);
    \u0275\u0275element(28, "space-list-field", 19);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(29, MeetingFlowFormComponent_form_5_section_29_Template, 16, 15, "section", 15);
    \u0275\u0275pipe(30, "async");
    \u0275\u0275template(31, MeetingFlowFormComponent_form_5_section_31_Template, 14, 15, "section", 15)(32, MeetingFlowFormComponent_form_5_section_32_Template, 14, 11, "section", 15);
    \u0275\u0275elementStart(33, "section", 20)(34, "button", 21);
...
_MeetingFlowFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowFormComponent, selectors: [["meeting-flow-form"]], viewQuery: function MeetingFlowFormComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, MeetingFlowFormComponent_form_5_Template, 42, 27, "form", 5);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowFormComponent, { className: "MeetingFlowFormComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-form.component.ts", lineNumber: 386 });
})();
...
//# sourceMappingURL=book.module-EMXXAIZV.js.map
