...
function PointsAssetModalComponent_main_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "mat-form-field", 10)(18, "app-icon", 14);
    \u0275\u0275text(19, "search");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(50, "div", 28)(51, "app-icon", 29);
    \u0275\u0275text(52, "add");
    \u0275\u0275elementEnd();
...
var PointsAssetModalComponent = class _PointsAssetModalComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsAssetModalComponent, selectors: [["points-asset-modal"]], outputs: { event: "event" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 10, vars: 9, consts: [["auto", "matAutocomplete"], [1, "sticky", "top-0", "p-2", "m-2", "w-[calc(100%-1rem)]", "border-none", "z-10", "bg-base-200", "rounded"], [1, "text-xl", "font-medium", "px-2"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "min-w-[28rem] overflow-hidden px-4 py-2", 3, "formGroup", 4, "ngIf"], [1, "flex", "items-center", "justify-end", "p-2", "space-x-2", "border-t", "border-base-200"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click", "disabled"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "min-w-[28rem]", "overflow-hidden", "px-4", "py-2", 3, "formGroup"], [1, "flex", "flex-col"], ["appearance", "outline", 1, "flex-1", "h-[3.25rem]"], ["formControlName", "type", "placeholder", "Select asset type"], ["value", "space"], ["value", "desk"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", "formControlName", "name", 3, "placeholder", "matAutocomplete"], ["matSuffix", "", 3, "diameter", 4, "ngIf"], [3, "value", 4, "ngFor", "ngForOf"], [3, "disabled", 4, "ngIf"], [1, "flex", "items-center", "mb-4"], ["formControlName", "accept_points", 1, "w-full", 3, "name"], [1, "flex", "space-x-4", "mb-4"], [1, "flex", "flex-col", "flex-1"], ["formControlName", "unit_price", 1, "w-full", 3, "min", "max", "step", "render_fn"], ["formControlName", "discount_cap", 1, "w-full", 3, "min", "max", "step", "render_fn"], [1, ""], ["rule", "", "class", "flex items-center", 4, "ngFor", "ngForOf"], ["btn", "", "matRipple", "", 1, "clear", "w-full", 3, "click"], [1, "flex", "items-center", "justify-center", "w-full"], [1, "text-lg"], [1, "underline"], ["matSuffix", "", 3, "diameter"], [3, "value"], [3, "disabled"], ["rule", "", 1, "flex", "items-center"], [1, "flex", "items-center", "flex-1", "w-1/2", "space-x-2"], ["appearance", "outline", 1, "flex-2", "h-[3.25rem]", "w-32"], [3, "ngModelChange", "ngModel", "ngModelOptions"], ["value", "before"], ["value", "between"], ["value", "after"], [1, "flex-1", "mt-2", "w-40", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["class", "flex-1 mt-2 w-40", 3, "ngModel", "from", "ngModelOptions", "ngModelChange", 4, "ngIf"], [1, "mx-2"], [1, "border", "border-base-200", "rounded", 3, "ngModelChange", "ngModel", "ngModelOptions", "min", "max", "step", "render_fn"], [1, "flex-1", "mt-2", "w-40", 3, "ngModelChange", "ngModel", "from", "ngModelOptions"]], template: function PointsAssetModalComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var PointsAssetsComponent = class _PointsAssetsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsAssetsComponent, selectors: [["points-assets"]], standalone: false, decls: 17, vars: 39, consts: [["type_template", ""], ["price_template", ""], ["bool_template", ""], ["discount_template", ""], ["action_template", ""], [1, "block", "min-w-[32rem]", "w-full", 3, "data", "columns", "sortable", "empty_message"], [1, "p-2"], [1, "bg-base-200", "rounded", "capitalize", "px-2", "py-1", "text-sm"], [1, "text-xs", "p-4", "font-mono"], [1, "rounded", "h-8", "w-8", "flex", "items-center", "justify-center", "text-2xl", "text-white", "mx-auto"], [1, "text-right", "p-4"], [1, "flex", "items-center", "justify-end", "p-2", "mx-auto"], ["icon", "", "matRipple", "", 3, "click"], [1, "text-error"]], template: function PointsAssetsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var PointsOverviewComponent = class _PointsOverviewComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsOverviewComponent, selectors: [["points-overview"]], standalone: false, decls: 40, vars: 34, consts: [[1, "px-4", "py-3", "bg-secondary", "text-white", "w-full", "rounded", "font-medium", "text-lg", "shadow"], [1, "bg-base-100", "w-full"], [1, "p-2", "underline", "font-medium", "text-lg"], [1, "flex", "items-center", "space-x-2", "p-4", "mb-4"], [1, "font-mono"], [1, "w-48", 3, "ngModelChange", "step", "ngModel", "render_fn"], [1, "text-2xl", 3, "matTooltip"], [1, "bg-base-100", "w-full", "flex-1"], [1, "p-4"], [1, "flex", "items-center", "space-x-4", "p-2", "border-b", "border-base-200"], [3, "ngModelChange", "ngModel"], [1, "flex", "items-center", "space-x-4", "p-2"]], template: function PointsOverviewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var PointsTopbarComponent = class _PointsTopbarComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsTopbarComponent, selectors: [["points-topbar"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], ngContentSelectors: _c03, decls: 8, vars: 3, consts: [[1, "flex", "items-center", "bg-base-100", "h-20", "px-8", "py-4", "space-x-2"], [1, "text-2xl", "font-medium"], [1, "flex-1", "w-px"], [1, "pl-2"]], template: function PointsTopbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275projectionDef();
...
var PointsComponent = class _PointsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsComponent, selectors: [["placeos-points"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 13, vars: 13, consts: [[1, "relative", "w-full", "flex", "flex-col", "bg-base-200"], [1, "relative", "z-10"], ["btn", "", "matRipple", "", 3, "click", 4, "ngIf"], ["mat-tab-nav-bar", ""], ["mat-tab-link", "", 3, "routerLink", "active"], [1, "flex-1", "w-full", "h-1/2", "overflow-auto"], ["btn", "", "matRipple", "", 3, "click"]], template: function PointsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "sidebar");
        \u0275\u0275elementStart(1, "main", 0)(2, "points-topbar", 1);
        \u0275\u0275template(3, PointsComponent_button_3_Template, 3, 3, "button", 2);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(11, _c04))("active", ctx.page === "overview");
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 7, "APP.CONCIERGE.POINTS_TAB_OVERVIEW"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(12, _c13))("active", ctx.page === "assets");
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 9, "APP.CONCIERGE.POINTS_TAB_ASSETS"), " ");
      }
    }, dependencies: [NgIf, SidebarComponent, MatRipple, MatTabNav, MatTabLink, RouterOutlet, RouterLink, PointsTopbarComponent, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  height: 100%;\n  width: 100%;\n}\n/*# sourceMappingURL=points.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PointsComponent, { className: "PointsComponent", filePath: "apps/concierge/src/app/points/points.component.ts", lineNumber: 53 });
})();
...
var NewPointsComponent = class _NewPointsComponent extends AsyncHandler {
  constructor(_state, _router) {
    super();
    this._state = _state;
    this._router = _router;
  ...
  static {
    this.\u0275fac = function NewPointsComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NewPointsComponent)(\u0275\u0275directiveInject(PointsStateService), \u0275\u0275directiveInject(Router));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewPointsComponent, selectors: [["placeos-new-points"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 17, vars: 14, consts: [["tabPanel", ""], [1, "flex", "flex-1", "h-px"], [1, "flex", "flex-col", "flex-1", "w-1/2", "h-full"], [1, "relative", "z-10"], ["btn", "", "matRipple", "", "class", "w-40", 3, "click", 4, "ngIf"], [1, "px-8", "mb-4"], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", 3, "routerLink", "active"], [1, "flex-1", "w-full", "h-1/2", "overflow-auto", "px-8"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"]], template: function NewPointsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "app-topbar");
        \u0275\u0275elementStart(1, "div", 1);
        \u0275\u0275element(2, "app-sidebar");
        \u0275\u0275elementStart(3, "main", 2)(4, "points-topbar", 3);
        \u0275\u0275template(5, NewPointsComponent_button_5_Template, 3, 3, "button", 4);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(12, _c05))("active", ctx.page === "overview");
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 8, "APP.CONCIERGE.POINTS_TAB_OVERVIEW"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(13, _c14))("active", ctx.page === "assets");
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewPointsComponent, { className: "NewPointsComponent", filePath: "apps/concierge/src/app/points/new-points.component.ts", lineNumber: 74 });
})();
...
//# sourceMappingURL=points.module-NXEPHJXT.js.map
