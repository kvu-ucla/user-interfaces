...
function POIModalComponent_main_4_form_1_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275i18nEnd();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 15)(5, "mat-select", 24);
    \u0275\u0275twoWayListener("ngModelChange", function POIModalComponent_main_4_form_1_div_2_Template_mat_select_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext(3);
      \u0275\u0275twoWayBindingSet(ctx_r2.building, $event) || (ctx_r2.building = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(6, POIModalComponent_main_4_form_1_div_2_mat_option_6_Template, 2, 2, "mat-option", 25);
    \u0275\u0275pipe(7, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(7, 3, ctx_r2.building_list));
  }
}
...
function POIModalComponent_main_4_form_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275i18nEnd();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 15)(5, "mat-select", 27);
    \u0275\u0275template(6, POIModalComponent_main_4_form_1_div_4_mat_option_6_Template, 2, 2, "mat-option", 25);
    \u0275\u0275pipe(7, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(6);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(7, 1, ctx_r2.level_list));
  }
}
function POIModalComponent_main_4_form_1_div_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 28)(1, "mat-form-field", 29);
    \u0275\u0275element(2, "input", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 31);
    \u0275\u0275listener("click", function POIModalComponent_main_4_form_1_div_15_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext(3);
...
function POIModalComponent_main_4_form_1_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 32)(1, "mat-form-field", 33)(2, "input", 34);
    \u0275\u0275listener("ngModelChange", function POIModalComponent_main_4_form_1_div_16_Template_input_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.form.patchValue({ location: [$event, ctx_r2.form.value.location[1]] }));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "mat-form-field", 33)(4, "input", 35);
    \u0275\u0275listener("ngModelChange", function POIModalComponent_main_4_form_1_div_16_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext(3);
...
function POIModalComponent_main_4_form_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, POIModalComponent_main_4_form_1_div_1_Template, 6, 0, "div", 12)(2, POIModalComponent_main_4_form_1_div_2_Template, 8, 6, "div", 12);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275template(4, POIModalComponent_main_4_form_1_div_4_Template, 8, 3, "div", 12);
    \u0275\u0275elementStart(5, "div", 13)(6, "label", 14);
    \u0275\u0275i18nStart(7, 1);
    \u0275\u0275element(8, "span");
    \u0275\u0275i18nEnd();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "mat-form-field", 15)(10, "mat-select", 16);
    \u0275\u0275twoWayListener("ngModelChange", function POIModalComponent_main_4_form_1_Template_mat_select_ngModelChange_10_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(14, "Coordinates");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(15, POIModalComponent_main_4_form_1_div_15_Template, 6, 0, "div", 19)(16, POIModalComponent_main_4_form_1_div_16_Template, 5, 6, "div", 20);
    \u0275\u0275elementStart(17, "div", 21)(18, "mat-checkbox", 22);
    \u0275\u0275text(19, " Is Searchable? ");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    let tmp_5_0;
...
function POIModalComponent_main_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, POIModalComponent_main_4_form_1_Template, 20, 11, "form", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
_POIModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _POIModalComponent, selectors: [["poi-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 8, vars: 5, consts: () => {
  let i18n_0;
  if (false) {
    const MSG_EXTERNAL_nameLabel$$APPS_CONCIERGE_SRC_APP_POI_MANAGER_POI_MODAL_COMPONENT_TS_0 = goog.getMsg(" Location{$startTagSpan}*{$closeTagSpan}: ", { "closeTagSpan": "\uFFFD/#8\uFFFD", "startTagSpan": "\uFFFD#8\uFFFD" }, { original_code: { "closeTagSpan": "</span>", "startTagSpan": "<span>" } });
  ...
  let i18n_2;
  if (false) {
    const MSG_EXTERNAL_nameLabel$$APPS_CONCIERGE_SRC_APP_POI_MANAGER_POI_MODAL_COMPONENT_TS_2 = goog.getMsg(" Name{$startTagSpan}*{$closeTagSpan}: ", { "closeTagSpan": "\uFFFD/#3\uFFFD", "startTagSpan": "\uFFFD#3\uFFFD" }, { original_code: { "closeTagSpan": "</span>", "startTagSpan": "<span>" } });
  ...
  let i18n_3;
  if (false) {
    const MSG_EXTERNAL_nameLabel$$APPS_CONCIERGE_SRC_APP_POI_MANAGER_POI_MODAL_COMPONENT_TS_3 = goog.getMsg(" Building{$startTagSpan}*{$closeTagSpan}: ", { "closeTagSpan": "\uFFFD/#3\uFFFD", "startTagSpan": "\uFFFD#3\uFFFD" }, { original_code: { "closeTagSpan": "</span>", "startTagSpan": "<span>" } });
  ...
  let i18n_4;
  if (false) {
    const MSG_EXTERNAL_nameLabel$$APPS_CONCIERGE_SRC_APP_POI_MANAGER_POI_MODAL_COMPONENT_TS_4 = goog.getMsg(" Level{$startTagSpan}*{$closeTagSpan}: ", { "closeTagSpan": "\uFFFD/#3\uFFFD", "startTagSpan": "\uFFFD#3\uFFFD" }, { original_code: { "closeTagSpan": "</span>", "startTagSpan": "<span>" } });
  ...
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, POIModalComponent_button_3_Template, 3, 0, "button", 5);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, POIModalComponent_main_4_Template, 2, 1, "main", 6)(5, POIModalComponent_footer_5_Template, 3, 0, "footer", 7)(6, POIModalComponent_ng_template_6_Template, 4, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(POIModalComponent, { className: "POIModalComponent", filePath: "apps/concierge/src/app/poi-manager/poi-modal.component.ts", lineNumber: 197 });
})();
...
//# sourceMappingURL=poi-manager.module-DZCISDQL.js.map
