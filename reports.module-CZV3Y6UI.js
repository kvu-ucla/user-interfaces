import "./chunk-2M7M7N5H.js";
import "./chunk-DTAUH5C2.js";
import "./chunk-QTMAESUL.js";
import {
  SharedUsersModule
} from "./chunk-YYZ34HP3.js";
import {
  ActivatedRoute,
...
_ReportSpacesOverallListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesOverallListComponent, selectors: [["report-spaces-overall-list"]], inputs: { print: "print" }, decls: 11, vars: 16, consts: [["date_template", ""], ["percent_template", ""], [1, "w-full"], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "p-4", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"]], template: function ReportSpacesOverallListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesOverallListComponent, { className: "ReportSpacesOverallListComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces-overall-list.component.ts", lineNumber: 48 });
})();
...
var _c44 = () => ({ key: "no_shows", name: "No Shows" });
...
_ReportSpacesUserListingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesUserListingComponent, selectors: [["report-spaces-user-listing"]], inputs: { print: "print" }, decls: 6, vars: 16, consts: [[1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"]], template: function ReportSpacesUserListingComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.user_list)("columns", \u0275\u0275pureFunction5(10, _c52, \u0275\u0275pureFunction0(5, _c05), \u0275\u0275pureFunction0(6, _c14), \u0275\u0275pureFunction0(7, _c24), \u0275\u0275pureFunction0(8, _c34), \u0275\u0275pureFunction0(9, _c44)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesUserListingComponent, { className: "ReportSpacesUserListingComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces-user-listing.component.ts", lineNumber: 39 });
})();
...
function ReportSpacesComponent_ng_container_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ReportSpacesComponent_ng_container_12_ng_container_1_Template, 5, 3, "ng-container", 9);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
}, dependencies: [NgIf, MatProgressSpinner, AuthenticatedImageDirective, ReportsOptionsComponent, ReportSpacesOverallComponent, ReportSpacesOverallListComponent, ReportSpacesSpaceListing, ReportSpacesUserListingComponent, AsyncPipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=report-spaces.component.css.map */"] });
var ReportSpacesComponent = _ReportSpacesComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesComponent, { className: "ReportSpacesComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces.component.ts", lineNumber: 74 });
})();

// apps/concierge/src/app/reports/desks/report-desks-overall-list.component.ts
var _c07 = (a0) => ({ key: "date", name: "Date", content: a0 });
var _c15 = () => ({ key: "approved", name: "Approved Bookings" });
var _c25 = () => ({ key: "count", name: "Total Requests" });
var _c35 = (a0) => ({ key: "utilisation", name: "Utilisation", content: a0 });
...
_ReportDesksOverallListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksOverallListComponent, selectors: [["report-desks-overall-list"]], inputs: { print: "print" }, decls: 11, vars: 16, consts: [["date_template", ""], ["percent_template", ""], [1, "pb-2", "w-full"], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "p-4", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "page_size", "sortable"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"]], template: function ReportDesksOverallListComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.day_list)("columns", \u0275\u0275pureFunction4(11, _c45, \u0275\u0275pureFunction1(5, _c07, date_template_r5), \u0275\u0275pureFunction0(7, _c15), \u0275\u0275pureFunction0(8, _c25), \u0275\u0275pureFunction1(9, _c35, percent_template_r6)))("page_size", ctx.print ? 0 : 10)("sortable", true);
  }
}, dependencies: [NgIf, MatRipple, IconComponent, SimpleTableComponent, DatePipe], encapsulation: 2 });
...
var _c08 = () => ({ key: "name", name: "Level" });
var _c16 = () => ({ key: "avg_usage", name: "Avg. Used Desks" });
var _c26 = () => ({ key: "approved", name: "Approved Bookings" });
var _c36 = () => ({ key: "count", name: "Total Requests" });
var _c46 = (a0) => ({ key: "utilisation", name: "Utilisation", content: a0 });
...
_ReportDesksLevelListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksLevelListComponent, selectors: [["report-desks-levels-list"]], inputs: { print: "print" }, decls: 9, vars: 17, consts: [["percent_view", ""], [1, "px-4", "pb-2", "w-full"], [1, "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden", "w-full"], [1, "border-b", "border-base-200", "p-4", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "page_size", "sortable"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"]], template: function ReportDesksLevelListComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.level_list)("columns", \u0275\u0275pureFunction5(11, _c53, \u0275\u0275pureFunction0(5, _c08), \u0275\u0275pureFunction0(6, _c16), \u0275\u0275pureFunction0(7, _c26), \u0275\u0275pureFunction0(8, _c36), \u0275\u0275pureFunction1(9, _c46, percent_view_r4)))("page_size", ctx.print ? 0 : 10)("sortable", true);
  }
...
var _c010 = (a0) => ({ key: "deliver_at", name: "Deliver At", content: a0 });
var _c17 = () => ({ key: "item_count", name: "Items" });
var _c27 = (a0) => ({ key: "total_cost", name: "Total Cost", content: a0 });
...
_CateringReportOrdersComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportOrdersComponent, selectors: [["catering-report-orders"]], inputs: { print: "print" }, decls: 12, vars: 13, consts: [["date_template", ""], ["cost_template", ""], [1, "w-[64rem]", "max-w-[calc(100%-2rem)]", "rounded", "overflow-hidden", "bg-base-100", "border", "border-base-200", "mx-auto", "my-2"], [1, "border-b", "border-base-200", "flex", "items-center", "justify-between", "px-4"], [1, "py-2", "text-xl", "font-medium"], ["matRipple-icon", "", "matTooltip", "Download list", 1, "print:hidden", 3, "click"], ["empty_message", "No orders for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], [1, "p-4"]], template: function CateringReportOrdersComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(7);
    \u0275\u0275property("data", ctx.orders)("columns", \u0275\u0275pureFunction3(9, _c37, \u0275\u0275pureFunction1(4, _c010, date_template_r5), \u0275\u0275pureFunction0(6, _c17), \u0275\u0275pureFunction1(7, _c27, cost_template_r6)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
...
var _c011 = () => ({ key: "name", name: "Name" });
var _c18 = (a0) => ({ key: "options", name: "Options", content: a0 });
var _c28 = () => ({ key: "caterer", name: "Caterer" });
var _c38 = () => ({ key: "quantity", name: "Quantity" });
var _c47 = (a0) => ({ key: "unit_price", name: "Unit Price", content: a0 });
var _c54 = (a0) => ({ key: "total_cost", name: "Total Cost", content: a0 });
...
_CateringReportItemsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportItemsComponent, selectors: [["catering-report-items"]], inputs: { print: "print" }, decls: 9, vars: 20, consts: [["option_template", ""], ["cost_template", ""], [1, "w-[64rem]", "max-w-[calc(100%-2rem)]", "rounded", "overflow-hidden", "bg-base-100", "border", "border-base-200", "mx-auto", "my-2"], [1, "border-b", "border-base-200", "flex", "items-center", "justify-between", "px-4"], [1, "py-2", "text-xl", "font-medium"], ["empty_message", "No orders for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "page_size", "sortable"], [1, "p-4"], ["class", "text-xs px-2 py-1 rounded bg-base-200", 3, "matTooltip", 4, "ngIf"], [1, "text-xs", "px-2", "py-1", "rounded", "bg-base-200", 3, "matTooltip"]], template: function CateringReportItemsComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("data", ctx.items)("columns", \u0275\u0275pureFunction6(13, _c62, \u0275\u0275pureFunction0(4, _c011), \u0275\u0275pureFunction1(5, _c18, option_template_r4), \u0275\u0275pureFunction0(7, _c28), \u0275\u0275pureFunction0(8, _c38), \u0275\u0275pureFunction1(9, _c47, cost_template_r5), \u0275\u0275pureFunction1(11, _c54, cost_template_r5)))("page_size", ctx.print ? 0 : 10)("sortable", true);
  }
...
_NewReportsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewReportsComponent, selectors: [["", "app-new-reports", ""]], attrs: _c013, decls: 6, vars: 1, consts: [[1, "screen-only"], [1, "flex", "flex-1", "h-px"], [1, "flex", "flex-col", "flex-1", "w-1/2", "h-full", "relative"], ["reports-menu", "", "class", "absolute inset-0 screen-only", 4, "ngIf"], ["reports-menu", "", 1, "absolute", "inset-0", "screen-only"]], template: function NewReportsComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _c014 = () => ({ key: "name", name: "Name" });
var _c110 = (a0) => ({ key: "date", name: "Date", content: a0 });
var _c210 = () => ({ key: "booking_count", name: "Bookings Count" });
var _c310 = () => ({ key: "booked_count", name: "Number Booked" });
var _c49 = () => ({ key: "asset_count", name: "Assets Available" });
...
_AssetReportDailyUsageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportDailyUsageComponent, selectors: [["asset-report-daily-usage"]], inputs: { print: "print" }, decls: 8, vars: 17, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"]], template: function AssetReportDailyUsageComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.daily_products)("columns", \u0275\u0275pureFunction5(11, _c55, \u0275\u0275pureFunction0(5, _c014), \u0275\u0275pureFunction1(6, _c110, date_template_r4), \u0275\u0275pureFunction0(8, _c210), \u0275\u0275pureFunction0(9, _c310), \u0275\u0275pureFunction0(10, _c49)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
...
var _c111 = () => ({ key: "booking_count", name: "Bookings with Product" });
var _c211 = () => ({ key: "booked_count", name: "Number Booked" });
var _c311 = () => ({ key: "asset_count", name: "Assets Available" });
...
_AssetReportProductUsageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportProductUsageComponent, selectors: [["asset-report-product-usage"]], inputs: { print: "print" }, decls: 6, vars: 14, consts: [[1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"]], template: function AssetReportProductUsageComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.products)("columns", \u0275\u0275pureFunction4(9, _c410, \u0275\u0275pureFunction0(5, _c015), \u0275\u0275pureFunction0(6, _c111), \u0275\u0275pureFunction0(7, _c211), \u0275\u0275pureFunction0(8, _c311)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
}, dependencies: [NgIf, MatRipple, IconComponent, SimpleTableComponent] });
...
var _c112 = () => ({ key: "booking_count", name: "Bookings" });
var _c212 = () => ({ key: "asset_count", name: "Assets Booked" });
var _c312 = () => ({ key: "asset_types", name: "Asset Types" });
...
_AssetReportUsersComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportUsersComponent, selectors: [["asset-report-users"]], inputs: { print: "print" }, decls: 6, vars: 14, consts: [[1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"]], template: function AssetReportUsersComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.users)("columns", \u0275\u0275pureFunction4(9, _c411, \u0275\u0275pureFunction0(5, _c016), \u0275\u0275pureFunction0(6, _c112), \u0275\u0275pureFunction0(7, _c212), \u0275\u0275pureFunction0(8, _c312)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
}, dependencies: [NgIf, MatRipple, IconComponent, SimpleTableComponent] });
...
var _c017 = () => ({ key: "purchase_order_number", name: "PO Number" });
var _c113 = () => ({ key: "invoice_number", name: "Invoice Number" });
var _c213 = (a0) => ({ key: "purchase_date", name: "Purchase Date", content: a0 });
var _c313 = (a0) => ({ key: "expected_service_start_date", name: "Service Start", content: a0 });
var _c412 = (a0) => ({ key: "expected_service_end_date", name: "Service End", content: a0 });
...
_AssetReportExpiredItemsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportExpiredItemsComponent, selectors: [["asset-report-expired-items"]], inputs: { print: "print" }, decls: 8, vars: 19, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No purchase orders expired for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"]], template: function AssetReportExpiredItemsComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.expired_items)("columns", \u0275\u0275pureFunction5(13, _c56, \u0275\u0275pureFunction0(5, _c017), \u0275\u0275pureFunction0(6, _c113), \u0275\u0275pureFunction1(7, _c213, date_template_r4), \u0275\u0275pureFunction1(9, _c313, date_template_r4), \u0275\u0275pureFunction1(11, _c412, date_template_r4)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
}, dependencies: [NgIf, MatRipple, IconComponent, SimpleTableComponent, DatePipe] });
...
_AssetsReportComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetsReportComponent, selectors: [["", "report-assets", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c018, decls: 18, vars: 15, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8", "screen-only"]], template: function AssetsReportComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "reports-options", 2);
    \u0275\u0275pipe(1, "async");
...
var _c019 = (a0) => ({ key: "date", name: "Date", content: a0 });
var _c114 = () => ({ key: "booking_count", name: "Unique Visitors" });
var _c214 = () => ({ key: "host_count", name: "Host Count" });
var _c314 = () => ({ key: "booked_count", name: "Booking Count" });
...
_VisitorReportDailyUsageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorReportDailyUsageComponent, selectors: [["visitor-report-daily-usage"]], inputs: { print: "print" }, decls: 8, vars: 15, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"]], template: function VisitorReportDailyUsageComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.daily_stats)("columns", \u0275\u0275pureFunction4(10, _c413, \u0275\u0275pureFunction1(5, _c019, date_template_r4), \u0275\u0275pureFunction0(7, _c114), \u0275\u0275pureFunction0(8, _c214), \u0275\u0275pureFunction0(9, _c314)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
}, dependencies: [NgIf, MatRipple, IconComponent, SimpleTableComponent, DatePipe] });
...
var _c020 = () => ({ key: "visitor_name", name: "Visitor Name" });
var _c115 = (a0) => ({ key: "date", name: "Date", content: a0 });
var _c215 = () => ({ key: "host", name: "Host" });
var _c315 = () => ({ key: "checked_in", name: "Checked In" });
var _c414 = () => ({ key: "self_registered", name: "Self Registered" });
...
_VisitorReportListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorReportListComponent, selectors: [["visitor-report-list"]], inputs: { print: "print" }, decls: 8, vars: 17, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"]], template: function VisitorReportListComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.visitor_bookings)("columns", \u0275\u0275pureFunction5(11, _c57, \u0275\u0275pureFunction0(5, _c020), \u0275\u0275pureFunction1(6, _c115, date_template_r4), \u0275\u0275pureFunction0(8, _c215), \u0275\u0275pureFunction0(9, _c315), \u0275\u0275pureFunction0(10, _c414)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
}, dependencies: [NgIf, MatRipple, IconComponent, SimpleTableComponent, DatePipe] });
...
var _c022 = (a0) => ({ key: "date", name: "Date", content: a0 });
var _c116 = () => ({ key: "booking_count", name: "Unique Spaces Reserved" });
var _c216 = () => ({ key: "host_count", name: "Reservee Count" });
var _c316 = () => ({ key: "booked_count", name: "Booking Count" });
...
_ParkingReportDailyUsageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportDailyUsageComponent, selectors: [["parking-report-daily-usage"]], inputs: { print: "print" }, decls: 8, vars: 15, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"]], template: function ParkingReportDailyUsageComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.daily_stats)("columns", \u0275\u0275pureFunction4(10, _c415, \u0275\u0275pureFunction1(5, _c022, date_template_r4), \u0275\u0275pureFunction0(7, _c116), \u0275\u0275pureFunction0(8, _c216), \u0275\u0275pureFunction0(9, _c316)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
}, dependencies: [NgIf, MatRipple, IconComponent, SimpleTableComponent, DatePipe] });
...
var _c023 = () => ({ key: "parking_name", name: "Parking Name" });
var _c117 = (a0) => ({ key: "date", name: "Date", content: a0 });
var _c217 = (a0) => ({ key: "duration", name: "Duration", content: a0 });
var _c317 = () => ({ key: "host", name: "Booked For" });
var _c416 = () => ({ key: "checked_in", name: "Checked In" });
...
_ParkingReportListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportListComponent, selectors: [["parking-report-list"]], inputs: { print: "print" }, decls: 10, vars: 18, consts: [["date_template", ""], ["duration_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"]], template: function ParkingReportListComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.parking_bookings)("columns", \u0275\u0275pureFunction5(12, _c58, \u0275\u0275pureFunction0(5, _c023), \u0275\u0275pureFunction1(6, _c117, date_template_r5), \u0275\u0275pureFunction1(8, _c217, duration_template_r6), \u0275\u0275pureFunction0(10, _c317), \u0275\u0275pureFunction0(11, _c416)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
...
_ParkingReportComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportComponent, selectors: [["", "parking-report", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c024, decls: 18, vars: 15, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8", "screen-only"]], template: function ParkingReportComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "reports-options", 2);
    \u0275\u0275pipe(1, "async");
...
_LockersReportService.\u0275fac = function LockersReportService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _LockersReportService)(\u0275\u0275inject(SettingsService), \u0275\u0275inject(OrganisationService));
};
...
var _c025 = (a0) => ({ key: "date", name: "Date", content: a0 });
var _c118 = () => ({ key: "booking_count", name: "Unique Spaces Reserved" });
var _c218 = () => ({ key: "host_count", name: "Reservee Count" });
var _c318 = () => ({ key: "booked_count", name: "Booking Count" });
var _c417 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
function LockersReportDailyUsageComponent_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 6);
    \u0275\u0275listener("click", function LockersReportDailyUsageComponent_button_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
function LockersReportDailyUsageComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
_LockersReportDailyUsageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportDailyUsageComponent, selectors: [["lockers-report-daily-usage"]], inputs: { print: "print" }, decls: 8, vars: 15, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"]], template: function LockersReportDailyUsageComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
    \u0275\u0275text(3, "Daily Lockers Details");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, LockersReportDailyUsageComponent_button_4_Template, 3, 0, "button", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275element(5, "simple-table", 5);
    \u0275\u0275template(6, LockersReportDailyUsageComponent_ng_template_6_Template, 3, 4, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const date_template_r4 = \u0275\u0275reference(7);
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.daily_stats)("columns", \u0275\u0275pureFunction4(10, _c417, \u0275\u0275pureFunction1(5, _c025, date_template_r4), \u0275\u0275pureFunction0(7, _c118), \u0275\u0275pureFunction0(8, _c218), \u0275\u0275pureFunction0(9, _c318)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
}, dependencies: [NgIf, MatRipple, IconComponent, SimpleTableComponent, DatePipe] });
var LockersReportDailyUsageComponent = _LockersReportDailyUsageComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportDailyUsageComponent, { className: "LockersReportDailyUsageComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-daily-usage.component.ts", lineNumber: 40 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportOverallComponent, { className: "LockersReportOverallComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-overall.component.ts", lineNumber: 28 });
})();

// apps/concierge/src/app/reports/lockers/lockers-report-list.component.ts
var _c026 = () => ({ key: "lockers_name", name: "Lockers Name" });
var _c119 = (a0) => ({ key: "date", name: "Date", content: a0 });
var _c219 = (a0) => ({ key: "duration", name: "Duration", content: a0 });
var _c319 = () => ({ key: "host", name: "Booked For" });
var _c418 = () => ({ key: "checked_in", name: "Checked In" });
var _c59 = (a0, a1, a2, a3, a4) => [a0, a1, a2, a3, a4];
function LockersReportListComponent_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 7);
    \u0275\u0275listener("click", function LockersReportListComponent_button_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
function LockersReportListComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 8);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function LockersReportListComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 8);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "duration");
...
_LockersReportListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportListComponent, selectors: [["lockers-report-list"]], inputs: { print: "print" }, decls: 10, vars: 18, consts: [["date_template", ""], ["duration_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"]], template: function LockersReportListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "h3", 4);
    \u0275\u0275text(3, "Lockers List");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, LockersReportListComponent_button_4_Template, 3, 0, "button", 5);
    \u0275\u0275elementEnd();
    \u0275\u0275element(5, "simple-table", 6);
    \u0275\u0275template(6, LockersReportListComponent_ng_template_6_Template, 3, 4, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(8, LockersReportListComponent_ng_template_8_Template, 3, 4, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const date_template_r5 = \u0275\u0275reference(7);
    ...
    \u0275\u0275property("ngIf", !ctx.print);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.lockers_bookings)("columns", \u0275\u0275pureFunction5(12, _c59, \u0275\u0275pureFunction0(5, _c026), \u0275\u0275pureFunction1(6, _c119, date_template_r5), \u0275\u0275pureFunction1(8, _c219, duration_template_r6), \u0275\u0275pureFunction0(10, _c319), \u0275\u0275pureFunction0(11, _c418)))("sortable", true)("page_size", ctx.print ? 0 : 10);
  }
}, dependencies: [NgIf, MatRipple, IconComponent, SimpleTableComponent, DatePipe, DurationPipe] });
var LockersReportListComponent = _LockersReportListComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportListComponent, { className: "LockersReportListComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-list.component.ts", lineNumber: 54 });
})();
...
_LockersReportChartsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportChartsComponent, selectors: [["lockers-report-charts"]], inputs: { print: "print" }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 9, vars: 2, consts: [[1, "flex", "items-center", "space-x-4", "w-full", "px-4", 3, "resize"], [1, "bg-base-100", "border", "border-base-200", "rounded", "flex-1", "w-1/2", "h-[18rem]"], [1, "border-b", "border-base-200", "p-4", "text-xl", "font-bold"], ["id", "daily-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-full", "h-56", "mx-auto", "relative", "top-2", "-left-2"], ["id", "level-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-[24rem]", "h-56", "mx-auto"]], template: function LockersReportChartsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportChartsComponent, { className: "LockersReportChartsComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-charts.component.ts", lineNumber: 55 });
})();

// apps/concierge/src/app/reports/lockers/lockers-report.component.ts
var _c027 = ["lockers-report", ""];
function LockersReportComponent_ng_container_12_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
...
function LockersReportComponent_ng_container_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LockersReportComponent_ng_container_12_ng_container_1_Template, 5, 2, "ng-container", 9);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function LockersReportComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275element(1, "mat-spinner", 12);
    \u0275\u0275elementStart(2, "p", 13);
...
function LockersReportComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "p", 13);
    \u0275\u0275text(2, " Select levels and time period to generate a report. ");
    \u0275\u0275elementEnd()();
...
_LockersReportComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportComponent, selectors: [["", "lockers-report", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c027, decls: 18, vars: 15, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8", "screen-only"]], template: function LockersReportComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "reports-options", 2);
    \u0275\u0275pipe(1, "async");
    ...
    \u0275\u0275element(9, "div", 7);
    \u0275\u0275elementStart(10, "h2", 8);
    \u0275\u0275text(11, "Lockers Report");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(12, LockersReportComponent_ng_container_12_Template, 3, 4, "ng-container", 9);
    \u0275\u0275pipe(13, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, LockersReportComponent_ng_template_14_Template, 4, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(16, LockersReportComponent_ng_template_16_Template, 3, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    let tmp_4_0;
    const load_state_r4 = \u0275\u0275reference(15);
...
}, dependencies: [NgIf, MatProgressSpinner, AuthenticatedImageDirective, ReportsOptionsComponent, LockersReportDailyUsageComponent, LockersReportOverallComponent, LockersReportListComponent, LockersReportChartsComponent, AsyncPipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=lockers-report.component.css.map */"] });
var LockersReportComponent = _LockersReportComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportComponent, { className: "LockersReportComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report.component.ts", lineNumber: 71 });
})();
...
//# sourceMappingURL=reports.module-CZV3Y6UI.js.map
