...
var FacilitiesComponent = class _FacilitiesComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FacilitiesComponent, selectors: [["", "app-facilities", ""]], standalone: false, attrs: _c02, decls: 6, vars: 0, consts: [[1, "relative", "flex", "w-full", "flex-col", "bg-base-200"], [1, "flex", "flex-1"], [1, "h-full", "flex-1"], [1, "h-full", "space-y-4"]], template: function FacilitiesComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "sidebar");
...
var NewFacilitiesComponent = class _NewFacilitiesComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewFacilitiesComponent, selectors: [["", "app-new-facilities", ""]], standalone: false, attrs: _c03, decls: 8, vars: 0, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "flex-1"], [1, "h-full", "flex-1"], [1, "h-full", "space-y-4"]], template: function NewFacilitiesComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=facilities.module-TIRJMZ25.js.map
