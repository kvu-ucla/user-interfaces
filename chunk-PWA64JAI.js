...
function ParkingBookingModalComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
function ParkingBookingModalComponent_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function ParkingBookingModalComponent_Conditional_33_Template_a_time_field_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r1);
...
function ParkingBookingModalComponent_Conditional_41_Template(rf, ctx) {
  if (rf & 1) {
...
_ParkingBookingModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingBookingModalComponent, selectors: [["parking-booking-modal"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 48, vars: 46, consts: [[3, "confirm", "heading", "loading"], [3, "formGroup"], [1, "mb-4", "flex", "items-center", "space-x-2"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1"], ["for", "user-name"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "user-name", "formControlName", "user_name", 3, "placeholder"], ["for", "email"], ["matInput", "", "name", "email", "formControlName", "user_email", 3, "placeholder"], [1, "relative"], ["for", "date"], ["formControlName", "date"], ["formControlName", "all_day", 1, "absolute", "-top-2", "right-0"], ["for", "parking-space"], ["name", "parking-space", "formControlName", "resources", 1, "mb-2"], ["for", "plate-number"], ["matInput", "", "name", "plate-number", "formControlName", "plate_number", 3, "placeholder"], ["name", "user", "formControlName", "user", 1, "flex-1"], [1, "w-1/3", "flex-1"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "disabled", "use_24hr"], [1, "relative", "w-1/3", "flex-1"], ["for", "end-time"], ["name", "end-time", "formControlName", "duration", 3, "time", "max", "use_24hr"]], template: function ParkingBookingModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(5, ParkingBookingModalComponent_Conditional_5_Template, 2, 0, "div", 2);
    ...
    \u0275\u0275conditionalCreate(32, ParkingBookingModalComponent_Conditional_32_Template, 3, 3, "mat-checkbox", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(33, ParkingBookingModalComponent_Conditional_33_Template, 15, 14, "div", 3);
    \u0275\u0275elementStart(34, "label", 14);
    \u0275\u0275text(35);
    \u0275\u0275pipe(36, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(37, "parking-space-list-field", 15);
    \u0275\u0275elementStart(38, "label", 16);
    \u0275\u0275text(39);
    \u0275\u0275pipe(40, "translate");
    \u0275\u0275conditionalCreate(41, ParkingBookingModalComponent_Conditional_41_Template, 2, 0, "span");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx.allow_all_day && !ctx.form.controls.duration.disabled ? 32 : -1);
    \u0275\u0275advance();
...
(() => {
  ...
  }] }, { type: BookingFormService }, { type: MatDialogRef }, { type: SettingsService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingBookingModalComponent, { className: "ParkingBookingModalComponent", filePath: "apps/concierge/src/app/parking/parking-booking-modal.component.ts", lineNumber: 158 });
})();
...
}, dependencies: [MatFormField, MatError, MatInput, MatTooltip, MatProgressSpinner, MatDialogClose, MatRipple, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, UserSearchFieldComponent, IconComponent, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingSpaceModalComponent, { className: "ParkingSpaceModalComponent", filePath: "apps/concierge/src/app/parking/parking-space-modal.component.ts", lineNumber: 122 });
})();
...
}, dependencies: [MatFormField, MatError, MatInput, MatTooltip, MatProgressSpinner, MatDialogClose, MatRipple, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, UserSearchFieldComponent, IconComponent, SettingsToggleComponent, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingUserModalComponent, { className: "ParkingUserModalComponent", filePath: "apps/concierge/src/app/parking/parking-user-modal.component.ts", lineNumber: 158 });
})();
...
var _ParkingStateService = class _ParkingStateService extends AsyncHandler {
  constructor(_org, _dialog, _settings) {
    ...
    this.spaces = combineLatest([
      ...
      return hu(options.zones[0] || levels[0]?.id, "parking-spaces").pipe(map(({ details }) => (details instanceof Array ? details : []).map((space) => __spreadProps(__spreadValues({}, space), {
  ...
  editSpace() {
    return __async(this, arguments, function* (space = {}) {
      ...
      const spaces = yield nextValueFrom(this.spaces);
      ...
      if ((space.assigned_to !== new_space.assigned_to || recreate) && new_space.assigned_to) {
        const users = yield nextValueFrom(this.users);
        const user = users.find((_) => _.email === new_space.assigned_to);
        const user_details = yield USER_PIPE.transform(new_space.assigned_to);
...
//# sourceMappingURL=chunk-PWA64JAI.js.map
