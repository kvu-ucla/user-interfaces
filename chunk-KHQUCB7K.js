...
var _BookingFormService = class _BookingFormService extends AsyncHandler {
  ...
  async postFormForGroup() {
    ...
    const available = await Promise.all(group_members.map((_, idx) => this.checkResourceAvailable(__spreadProps(__spreadValues({}, form), {
...
//# sourceMappingURL=chunk-KHQUCB7K.js.map
