...
} from "./chunk-KDZHQFXM.js";
import {
  CalendarService
} from "./chunk-E2CW6FXM.js";
import {
  AsyncHandler,
  AsyncPipe,
...
var LandingAvailabilityComponent = class _LandingAvailabilityComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingAvailabilityComponent, selectors: [["landing-availability"]], standalone: false, features: [\u0275\u0275ProvidersFeature([ExploreSpacesService])], decls: 8, vars: 5, consts: [["space_placeholder", ""], ["placeholder", ""], [1, "py-2"], ["class", "sm:text-lg font-medium mb-2 sm:mb-4 px-4", 4, "ngIf"], ["class", "flex items-center text-sm sm:text-base px-4 space-x-2", 4, "ngIf"], ["class", "w-[calc(100%-2rem)] overflow-auto flex items-center space-x-2 mx-4 py-2 snap-x", 3, "mb-4", 4, "ngIf"], ["class", "w-[calc(100%-2rem)] overflow-auto flex items-center space-x-2 mx-4 py-2 snap-x", 4, "ngIf"], [1, "sm:text-lg", "font-medium", "mb-2", "sm:mb-4", "px-4"], [1, "flex", "items-center", "text-sm", "sm:text-base", "px-4", "space-x-2"], [1, "w-[calc(100%-2rem)]", "overflow-auto", "flex", "items-center", "space-x-2", "mx-4", "py-2", "snap-x"], ["name", "landing-view-space", "matRipple", "", "class", "w-64 p-2 rounded shadow border border-base-200 flex items-center space-x-4 bg-base-100 snap-start", 3, "routerLink", "queryParams", 4, "ngFor", "ngForOf"], ["class", "opacity-60 text-sm mb-2", 4, "ngIf"], ["name", "landing-view-space", "matRipple", "", 1, "w-64", "p-2", "rounded", "shadow", "border", "border-base-200", "flex", "items-center", "space-x-4", "bg-base-100", "snap-start", 3, "routerLink", "queryParams"], [1, "min-w-[4rem]", "w-16", "h-16", "rounded", "bg-base-200", "flex", "items-center", "justify-center", "overflow-hidden"], ["auth", "", "class", "h-full w-full object-cover object-center", 3, "source", 4, "ngIf", "ngIfElse"], [1, "text-left"], [1, "max-w-full", "truncate", "px-1.5", "font-medium"], [1, "max-w-full", "truncate", "text-sm", "opacity-60", "flex", "items-center"], [1, "text-blue-500", "text-lg"], ["auth", "", 1, "h-full", "w-full", "object-cover", "object-center", 3, "source"], ["src", "assets/icons/desk-placeholder.svg", 1, "h-1/2", "w-1/2", "object-contain", "object-center"], [1, "opacity-60", "text-sm", "mb-2"], ["diameter", "24", 4, "ngIf"], ["diameter", "24"], ["name", "landing-book-room", "matRipple", "", "class", "w-64 p-2 rounded shadow border border-base-200 flex items-center space-x-4 bg-base-100 snap-start", 3, "click", 4, "ngFor", "ngForOf", "ngForTrackBy"], ["name", "landing-book-room", "matRipple", "", 1, "w-64", "p-2", "rounded", "shadow", "border", "border-base-200", "flex", "items-center", "space-x-4", "bg-base-100", "snap-start", 3, "click"], ["src", "assets/icons/room-placeholder.svg", 1, "h-1/2", "w-1/2", "object-contain", "object-center"]], template: function LandingAvailabilityComponent_Template(rf, ctx) {
      if (rf & 1) {
...
function LandingColleaguesComponent_ng_container_6_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "button", 22)(12, "app-icon");
    ...
    \u0275\u0275elementStart(17, "div", 25)(18, "app-icon", 26);
    \u0275\u0275text(19, "today");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(24, "div", 25)(25, "app-icon", 26);
    \u0275\u0275text(26, "cancel");
    \u0275\u0275elementEnd();
...
function LandingColleaguesComponent_ng_template_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36)(1, "p", 38);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275pipe(5, "async");
...
var LandingColleaguesComponent = class _LandingColleaguesComponent extends AsyncHandler {
  ...
  static {
    ...
    }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 27, vars: 27, consts: [["search_input", ""], ["empty_state", ""], ["search_empty", ""], ["load_state", ""], ["menu", "matMenu"], [1, "flex", "items-center", "justify-between", "p-2", "mx-2", "bg-base-200", "text-sm", "rounded"], [1, "flex-1", "h-1/2", "w-full", "space-y-4", "overflow-auto", "pt-4"], [4, "ngIf", "ngIfElse"], ["btn", "", "name", "open-colleague-search", "matRipple", "", 1, "inverse", "w-[calc(100%-1rem)]", "m-2", 3, "click"], ["search", "", 1, "absolute", "inset-x-2", "top-2", "bottom-16", "rounded", "overflow-hidden", "flex", "flex-col", "bg-base-100", "border", "border-base-200"], [1, "w-full", "border-b", "border-base-200", "p-2", 3, "ngModelChange", "ngModel", "placeholder"], ["icon", "", "name", "close-colleague-search", 1, "absolute", "top-0", "right-0", 3, "click"], ["class", "overflow-auto flex-1 h-1/2 flex flex-col space-y-2", 4, "ngIf", "ngIfElse"], ["class", "flex items-center px-2 space-x-2 relative", "user", "", 4, "ngFor", "ngForOf"], ["user", "", 1, "flex", "items-center", "px-2", "space-x-2", "relative"], [1, "text-xl", "relative"], [3, "user"], ["class", "rounded-full h-3 w-3 border border-white absolute bottom-1 right-1", 3, "bg-error", "bg-success", "bg-warning", "bg-neutral", "matTooltip", 4, "ngIf"], [1, "leading-tight", "flex-1", "w-1/2"], [1, "truncate", 3, "matTooltip"], [1, "text-sm", "truncate", 3, "matTooltip"], [1, "text-xs", "opacity-60", "truncate"], ["icon", "", "name", "colleague-more", 1, "!rounded", "bg-base-200", 3, "matMenuTriggerFor"], ["xPosition", "before"], ["mat-menu-item", "", "name", "meeting-with-colleague", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], ["name", "remove-colleague", "mat-menu-item", "", 3, "click"], [1, "rounded-full", "h-3", "w-3", "border", "border-white", "absolute", "bottom-1", "right-1", 3, "matTooltip"], [1, "overflow-auto", "flex-1", "h-1/2", "flex", "flex-col", "space-y-2"], ["matRipple", "", "name", "add-colleague", "class", "flex items-center p-1 space-x-2 w-full text-left min-h-12", 3, "click", 4, "ngFor", "ngForOf"], ["matRipple", "", "name", "add-colleague", 1, "flex", "items-center", "p-1", "space-x-2", "w-full", "text-left", "min-h-12", 3, "click"], [1, "text-base", "relative"], [1, "leading-tight", "flex-1"], [1, "truncate"], [1, "text-xs", "truncate", "opacity-60"], [1, "w-full", "h-full", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], ["src", "assets/icons/no-contacts.svg"], [1, "opacity-60", "text-sm", "text-center"], ["diameter", "32"]], template: function LandingColleaguesComponent_Template(rf, ctx) {
      if (rf & 1) {
...
function LandingFavouritesComponent_ng_container_5_div_1_img_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 24);
    \u0275\u0275pipe(1, "space");
    \u0275\u0275pipe(2, "async");
...
function LandingFavouritesComponent_ng_container_5_div_1_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 25);
  }
}
function LandingFavouritesComponent_ng_container_5_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 8)(1, "div", 9)(2, "div", 10);
    \u0275\u0275template(3, LandingFavouritesComponent_ng_container_5_div_1_img_3_Template, 3, 5, "img", 11);
    \u0275\u0275pipe(4, "space");
    \u0275\u0275pipe(5, "async");
    \u0275\u0275template(6, LandingFavouritesComponent_ng_container_5_div_1_ng_template_6_Template, 1, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(14, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 14)(16, "app-icon", 15);
    \u0275\u0275text(17, "place");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(21, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 17)(23, "app-icon", 15);
    \u0275\u0275text(24, " people ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function LandingFavouritesComponent_ng_container_5_div_1_Template_button_click_30_listener() {
    ...
    \u0275\u0275pipe(32, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "button", 19)(34, "app-icon");
    \u0275\u0275text(35, "more_horiz");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "mat-menu", 20, 2)(38, "button", 21);
    \u0275\u0275listener("click", function LandingFavouritesComponent_ng_container_5_div_1_Template_button_click_38_listener() {
      const item_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.toggleFavourite("space", item_r2));
    });
    \u0275\u0275elementStart(39, "div", 22)(40, "app-icon", 23);
    \u0275\u0275text(41, "delete");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const menu_r5 = \u0275\u0275reference(37);
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", (tmp_6_0 = \u0275\u0275pipeBind1(5, 11, \u0275\u0275pipeBind1(4, 9, item_r2))) == null ? null : tmp_6_0.images == null ? null : tmp_6_0.images.length)("ngIfElse", space_placeholder_r4);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", ((tmp_8_0 = \u0275\u0275pipeBind1(12, 15, \u0275\u0275pipeBind1(11, 13, item_r2))) == null ? null : tmp_8_0.display_name) || ((tmp_8_0 = \u0275\u0275pipeBind1(14, 19, \u0275\u0275pipeBind1(13, 17, item_r2))) == null ? null : tmp_8_0.name), " ");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate1(" ", (tmp_9_0 = ctx_r2.level(\u0275\u0275pipeBind1(21, 23, \u0275\u0275pipeBind1(20, 21, item_r2)))) == null ? null : tmp_9_0.display_name, " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(29, 29, "APP.WORKPLACE.CAPACITY", \u0275\u0275pureFunction1(36, _c03, ((tmp_10_0 = \u0275\u0275pipeBind1(28, 27, \u0275\u0275pipeBind1(27, 25, item_r2))) == null ? null : tmp_10_0.capacity) || 2)), " ");
    \u0275\u0275advance(4);
    \u0275\u0275property("disabled", ctx_r2.isClosed(item_r2));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(32, 32, "COMMON.BOOK"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matMenuTriggerFor", menu_r5);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(44, 34, "APP.WORKPLACE.FAVOURITES_REMOVE"), " ");
  }
}
function LandingFavouritesComponent_ng_container_5_div_2_img_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 24);
  }
  if (rf & 2) {
...
function LandingFavouritesComponent_ng_container_5_div_2_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 30);
  }
  if (rf & 2) {
...
function LandingFavouritesComponent_ng_container_5_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 8)(1, "div", 9)(2, "div", 10);
    \u0275\u0275template(3, LandingFavouritesComponent_ng_container_5_div_2_img_3_Template, 1, 1, "img", 11)(4, LandingFavouritesComponent_ng_container_5_div_2_ng_template_4_Template, 1, 1, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 12)(7, "div", 26);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 14)(10, "app-icon", 15);
    \u0275\u0275text(11, "place");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function LandingFavouritesComponent_ng_container_5_div_2_Template_button_click_14_listener() {
    ...
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "button", 28)(18, "app-icon");
    \u0275\u0275text(19, "more_horiz");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "mat-menu", 20, 2)(22, "button", 21);
    \u0275\u0275listener("click", function LandingFavouritesComponent_ng_container_5_div_2_Template_button_click_22_listener() {
      const item_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.toggleFavourite(item_r7.type, item_r7.id));
    });
    \u0275\u0275elementStart(23, "div", 22)(24, "app-icon", 23);
    \u0275\u0275text(25, " delete ");
    \u0275\u0275elementEnd();
...
function LandingFavouritesComponent_ng_container_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LandingFavouritesComponent_ng_container_5_div_1_Template, 45, 38, "div", 7)(2, LandingFavouritesComponent_ng_container_5_div_2_Template, 29, 11, "div", 7);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function LandingFavouritesComponent_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
...
var LandingFavouritesComponent = class _LandingFavouritesComponent extends AsyncHandler {
    ...
    return __async(this, null, function* () {
      ...
      if (this._settings.get("app.new_features")) {
        this._router.navigate([
          "/book",
          type === "desk" ? "new-desk" : type === "locker" ? "locker" : "new-parking"
        ]);
      } else {
        this._router.navigate([
          "/book",
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingFavouritesComponent, selectors: [["landing-favourites"]], standalone: false, features: [\u0275\u0275ProvidersFeature([SpacePipe]), \u0275\u0275InheritDefinitionFeature], decls: 9, vars: 10, consts: [["empty_state", ""], ["space_placeholder", ""], ["menu", "matMenu"], ["asset_placeholder", ""], [1, "flex", "items-center", "justify-between", "p-2", "mx-2", "bg-base-200", "text-sm", "rounded"], [1, "flex-1", "h-1/2", "w-full", "space-y-2", "overflow-auto", "pt-4", "divide-y", "divide-base-200"], [4, "ngIf", "ngIfElse"], ["class", "flex flex-col items-center mx-2 pt-2 space-y-2 relative", "item", "", 4, "ngFor", "ngForOf"], ["item", "", 1, "flex", "flex-col", "items-center", "mx-2", "pt-2", "space-y-2", "relative"], [1, "flex", "w-full", "items-center", "space-x-2", "relative"], [1, "w-16", "h-16", "overflow-hidden", "rounded", "relative", "flex", "items-center", "justify-center", "bg-base-300"], ["auth", "", "class", "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 object-cover min-w-full min-h-full", 3, "source", 4, "ngIf", "ngIfElse"], [1, "h-16", "flex-1", "w-1/2", "flex", "flex-col", "justify-center", "space-y-1"], [1, "truncate", "w-full", "pr-12"], [1, "flex", "items-center", "text-xs", "opacity-60", "space-x-1"], [1, "text-blue-500"], [1, "flex-1", "w-1/2", "truncate"], [1, "flex", "items-center", "text-xs", "opacity-60", "truncate", "space-x-2"], ["btn", "", "name", "book-favourite", "matRipple", "", 1, "w-full", "inverse", 3, "click", "disabled"], ["icon", "", "name", "favourite-more", 1, "absolute", "top-2", "right-0", "bg-base-200", "!rounded", "!m-0", 3, "matMenuTriggerFor"], ["xPosition", "before"], ["name", "landing-remove-favourite", "mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl", "text-error"], ["auth", "", 1, "absolute", "top-1/2", "left-1/2", "-translate-x-1/2", "-translate-y-1/2", "object-cover", "min-w-full", "min-h-full", 3, "source"], ["src", "assets/icons/room-placeholder.svg", 1, "m-auto"], [1, "truncate"], ["btn", "", "name", "book-favourite", "matRipple", "", 1, "w-full", "inverse", 3, "click"], ["icon", "", "name", "favourite-more", 1, "absolute", "top-22", "right-0", "bg-base-200", "!rounded", "!m-0", 3, "matMenuTriggerFor"], [1, "pr-4"], [1, "m-auto", 3, "src"], [1, "w-full", "h-full", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], ["src", "assets/icons/no-favourites.svg"], [1, "opacity-60", "text-sm", "text-center"]], template: function LandingFavouritesComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(5, LandingFavouritesComponent_ng_container_5_Template, 4, 4, "ng-container", 6);
        \u0275\u0275pipe(6, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(7, LandingFavouritesComponent_ng_template_7_Template, 5, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        let tmp_2_0;
        const empty_state_r10 = \u0275\u0275reference(8);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 3, "APP.WORKPLACE.FAVOURITES_COUNT", \u0275\u0275pureFunction1(8, _c03, (ctx.spaces == null ? null : ctx.spaces.length) || 0)), " ");
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", (ctx.spaces == null ? null : ctx.spaces.length) || ((tmp_2_0 = \u0275\u0275pipeBind1(6, 6, ctx.assets)) == null ? null : tmp_2_0.length))("ngIfElse", empty_state_r10);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingFavouritesComponent, { className: "LandingFavouritesComponent", filePath: "apps/workplace/src/app/landing/landing-favourites.component.ts", lineNumber: 276 });
})();

// apps/workplace/src/app/landing/landing-quick-links.component.ts
var _c04 = () => ["/book", "meeting"];
var _c13 = () => ["/book", "new-desk"];
var _c22 = () => ["/book", "new-parking"];
var _c3 = () => ["/book", "locker"];
...
var LandingQuickLinksComponent = class _LandingQuickLinksComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingQuickLinksComponent, selectors: [["landing-quick-links"]], standalone: false, decls: 8, vars: 7, consts: [[1, "sm:text-lg", "font-medium", "mb-2", "sm:mb-4", "px-4"], [1, "flex", "w-[calc(100%-2rem)]", "overflow-auto", "space-x-2", "mx-4", "mb-4", "snap-x"], ["matRipple", "", "class", "w-64 min-w-64 snap-start p-2 rounded shadow border border-base-200 flex items-center space-x-4 bg-base-100", 3, "routerLink", 4, "ngIf"], ["matRipple", "", 1, "w-64", "min-w-64", "snap-start", "p-2", "rounded", "shadow", "border", "border-base-200", "flex", "items-center", "space-x-4", "bg-base-100", 3, "routerLink"], [1, "min-w-[4rem]", "h-16", "rounded", "bg-base-200", "flex", "items-center", "justify-center"], ["src", "assets/icons/room-placeholder.svg", 1, "h-1/2", "w-1/2", "object-contain", "object-center"], [1, "text-xl"], ["src", "assets/icons/desk-placeholder.svg", 1, "h-1/2", "w-1/2", "object-contain", "object-center"], ["src", "assets/icons/car-placeholder.svg", 1, "h-1/2", "w-1/2", "object-contain", "object-center"], ["src", "assets/icons/locker-placeholder.svg", 1, "h-1/2", "w-1/2", "object-contain", "object-center"]], template: function LandingQuickLinksComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingUpcomingComponent, { className: "LandingUpcomingComponent", filePath: "apps/workplace/src/app/landing/landing-upcoming.component.ts", lineNumber: 92 });
})();
...
function LandingComponent_div_2_landing_colleagues_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "landing-colleagues");
  }
}
function LandingComponent_div_2_landing_favourites_18_Template(rf, ctx) {
  if (rf & 1) {
...
function LandingComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LandingComponent_div_2_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.tab = "people");
    });
    \u0275\u0275elementStart(3, "div", 17)(4, "app-icon");
    \u0275\u0275text(5, "people");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function LandingComponent_div_2_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.tab = "fav");
    });
    \u0275\u0275elementStart(10, "div", 17)(11, "app-icon");
    \u0275\u0275text(12, "favorite");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(17, LandingComponent_div_2_landing_colleagues_17_Template, 1, 0, "landing-colleagues", 11)(18, LandingComponent_div_2_landing_favourites_18_Template, 1, 0, "landing-favourites", 11);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275classProp("inverse", ctx_r1.tab !== "people");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 8, "APP.WORKPLACE.COLLEAGUES"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("inverse", ctx_r1.tab !== "fav");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(15, 10, "COMMON.FAVOURITES"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r1.tab === "people" && !ctx_r1.hide_colleagues);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.tab === "fav" || ctx_r1.hide_colleagues);
  }
}
...
var LandingComponent = class _LandingComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingComponent, selectors: [["app-landing"]], standalone: false, decls: 20, vars: 15, consts: [["class", "z-10", 4, "ngIf"], [1, "flex", "flex-1", "h-1/2", "bg-base-200"], ["class", "relative hidden sm:flex flex-col w-[18rem] h-full overflow-hidden bg-base-100 border-r border-base-300", 4, "ngIf"], [1, "flex-1", "h-full", "w-1/2", "sm:px-4", "overflow-auto", "z-0"], [1, "sticky", "top-0", "z-50", "bg-ternary", "px-4", "mb-4", "sm:rounded-b", "flex", "items-center", "justify-between", "overflow-hidden"], [1, ""], [1, "sm:text-xl", "font-medium"], ["date", "", 1, "text-sm", "sm:text-base"], ["class", "text-sm sm:text-base", 4, "ngIf"], [1, "h-32", "pt-4"], ["src", "assets/img/landing.svg"], [4, "ngIf"], [1, "mx-4", "w-[calc(100%-2rem)]", "h-px", "bg-base-200", "mb-2"], [1, "z-10"], [1, "relative", "hidden", "sm:flex", "flex-col", "w-[18rem]", "h-full", "overflow-hidden", "bg-base-100", "border-r", "border-base-300"], [1, "flex", "items-center", "space-x-2", "p-2"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "click"], [1, "flex", "items-center", "space-x-2", "capitalize"], [1, "pr-2"], [1, "flex-1", "w-full", "h-1/2"], [1, "text-sm", "sm:text-base"]], template: function LandingComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, LandingComponent_topbar_0_Template, 1, 0, "topbar", 0);
        \u0275\u0275elementStart(1, "div", 1);
        \u0275\u0275template(2, LandingComponent_div_2_Template, 19, 12, "div", 2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingComponent, { className: "LandingComponent", filePath: "apps/workplace/src/app/landing/landing.component.ts", lineNumber: 115 });
})();
...
//# sourceMappingURL=landing.module-KBGMVRQH.js.map
