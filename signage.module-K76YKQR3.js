...
var SignageMediaPreviewModalComponent = class _SignageMediaPreviewModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaPreviewModalComponent, selectors: [["signage-media-preview-modal"]], outputs: { save: "save" }, standalone: false, decls: 11, vars: 9, consts: [["load_state", ""], [1, "flex", "items-center", "justify-between", "p-2", "border-b", "border-base-300"], [1, "px-2"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], ["class", "bg-base-200", 4, "ngIf", "ngIfElse"], ["class", "p-2 flex items-center justify-end space-x-2 border-t border-base-300", 4, "ngIf"], [1, "bg-base-200"], [1, "max-w-[80vw]", "max-h-[65vh]", "w-[80vw]", "h-[65vh]", "flex", "items-center", "justify-center"], ["class", "w-full h-full object-contain object-center", "auth", "", 3, "source", 4, "ngIf"], ["class", "w-full h-full object-contain object-center", "auth", "", "autoplay", "", "controls", "", 3, "source", 4, "ngIf"], ["auth", "", 1, "w-full", "h-full", "object-contain", "object-center", 3, "source"], ["auth", "", "autoplay", "", "controls", "", 1, "w-full", "h-full", "object-contain", "object-center", 3, "source"], [1, "p-2", "flex", "items-center", "justify-end", "space-x-2", "border-t", "border-base-300"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "w-[28rem]", "h-[20rem]", "max-w-[80vw]", "max-h-[65vh]"], [3, "diameter"]], template: function SignageMediaPreviewModalComponent_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 4, "APP.CONCIERGE.SIGNAGE_MEDIA_PREVIEW_HEADER", \u0275\u0275pureFunction1(7, _c0, ctx.name)), " ");
        \u0275\u0275advance(5);
...
var SignagePlaylistModalComponent = class _SignagePlaylistModalComponent {
  ...
  static {
    ...
    }, dependencies: [\u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, MatFormField, MatError, MatInput, MatSelect, MatOption, MatTooltip, FormGroupDirective, FormControlName, DateFieldComponent, IconComponent, SettingsToggleComponent, FullscreenModalShellComponent, MatSlider, MatSliderThumb, MediaDurationPipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePlaylistModalComponent, { className: "SignagePlaylistModalComponent", filePath: "apps/concierge/src/app/signage/signage-playlist-modal.component.ts", lineNumber: 210 });
})();
...
var SignageMediaModalComponent = class _SignageMediaModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaModalComponent, selectors: [["signage-media-modal"]], standalone: false, decls: 71, vars: 69, consts: [[3, "confirm", "heading", "loading"], [3, "formGroup"], [1, "flex", "flex-col"], ["matRipple", "", 1, "relative", "w-full", "h-48", "mx-auto", "bg-base-300", "rounded-xl", "overflow-hidden", "mb-4", 3, "click"], ["auth", "", 1, "h-full", "w-full", "object-contain", "object-center", 3, "source"], [1, "absolute", "top-2", "left-2", "px-2", "py-1", "rounded", "text-xs", "bg-base-400", "capitalize"], ["for", "name"], ["appearance", "outline"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], [1, "flex", "items-center", "space-x-4"], ["for", "play-time", 1, "w-auto", "min-w-0", "m-0"], [1, "text-xs", "font-mono"], [1, "opacity-30"], ["step", "100", 3, "min", "max"], ["name", "play-time", "matSliderThumb", "", "formControlName", "play_time"], ["for", "animation"], ["name", "animation", "formControlName", "animation", "placeholder", "Playlist Default"], [3, "value"], ["for", "description"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "description", "formControlName", "description", 1, "min-h-32", 3, "placeholder"], [1, "flex", "space-x-4"], [1, "flex-1"], ["for", "valid-from"], ["name", "valid-from", "formControlName", "valid_from"], ["for", "valid-until"], ["name", "valid-until", "formControlName", "valid_until", 3, "from"], ["for", "start-time", 1, "w-auto", "min-w-0", "m-0"], ["min", "0", "step", "100", 3, "max"], ["name", "start-time", "matSliderThumb", "", "formControlName", "start_time"]], template: function SignageMediaModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
        \u0275\u0275pipe(1, "translate");
        \u0275\u0275pipe(2, "translate");
    ...
    }, dependencies: [\u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, MatFormField, MatError, MatInput, MatSelect, MatOption, MatRipple, FormGroupDirective, FormControlName, DateFieldComponent, FullscreenModalShellComponent, AuthenticatedImageDirective, MatSlider, MatSliderThumb, MediaDurationPipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaModalComponent, { className: "SignageMediaModalComponent", filePath: "apps/concierge/src/app/signage/signage-media-modal.component.ts", lineNumber: 197 });
})();
...
var SignageComponent = class _SignageComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageComponent, selectors: [["", "app-new-staff", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c03, decls: 16, vars: 5, consts: [["tabPanel", ""], [1, "flex", "flex-1", "h-px"], [1, "flex", "flex-col", "flex-1", "w-1/2", "h-full"], [1, "p-8", "h-28", "flex", "items-center", "justify-between"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", "class", "w-40", 3, "click", 4, "ngIf"], [1, "px-8"], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", 3, "routerLink", "active"], [1, "flex-1", "h-1/2", "overflow-auto", "px-8", "py-4"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], ["mat-tab-link", "", 3, "click", "routerLink", "active"]], template: function SignageComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var SignageTopbarComponent = class _SignageTopbarComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageTopbarComponent, selectors: [["signage-topbar"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 0, consts: [[1, "flex", "items-center", "bg-base-100", "h-20", "px-4", "border-b", "border-base-200", "space-x-2"]], template: function SignageTopbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "div", 0);
      }
...
function SignageMediaListComponent_Conditional_12_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "button", 21)(14, "app-icon");
    \u0275\u0275text(15, "more_vert");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementStart(29, "div", 27)(30, "app-icon", 28);
    \u0275\u0275text(31, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(34, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(35, "button", 30)(36, "div", 27)(37, "app-icon", 28);
    \u0275\u0275text(38, "add");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(43, "div", 27)(44, "app-icon", 28);
    ...
    \u0275\u0275elementStart(50, "div", 27)(51, "app-icon", 31);
    \u0275\u0275text(52, " delete ");
    \u0275\u0275elementEnd();
...
function SignageMediaListComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, SignageMediaListComponent_Conditional_12_For_3_Template, 56, 40, "div", 11, _forTrack0);
    \u0275\u0275pipe(4, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var SignageMediaListComponent = class _SignageMediaListComponent {
  ...
  static {
    ...
    }, dependencies: [NgForOf, NgIf, DefaultValueAccessor, NgControlStatus, NgModel, MatFormField, MatInput, MatMenu, MatMenuItem, MatMenuTrigger, MatTooltip, MatRipple, IconComponent, AuthenticatedImageDirective, CdkDropList, CdkDrag, CdkDragPlaceholder, AsyncPipe, MediaDurationPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=signage-media-list.component.css.map */"] });
  }
};
(() => {
...
function SignagePlaylistMediaListComponent_Conditional_53_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(25, "div", 5)(26, "app-icon", 6);
    ...
    \u0275\u0275elementStart(32, "div", 5)(33, "app-icon", 8);
    \u0275\u0275text(34, " delete ");
    \u0275\u0275elementEnd();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignagePlaylistMediaListComponent, selectors: [["signage-playlist-media-list"]], inputs: { playlist: "playlist", playlist_count: "playlist_count" }, standalone: false, features: [\u0275\u0275NgOnChangesFeature], decls: 56, vars: 57, consts: [["menu", "matMenu"], [1, "flex", "flex-col", "space-y-4", "relative", "p-4", "h-full", "w-full"], [1, "text-xl", "font-medium", "text-center"], ["icon", "", "matRipple", "", 1, "absolute", "top-2", "right-2", "!m-0", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], [1, "text-2xl", "text-error"], ["details", "", 1, "flex", "items-center", "flex-wrap"], [1, "ml-2", "text-xs", "px-2", "py-1", "m-1", "rounded"], ["class", "ml-2 text-xs px-2 py-1 m-1 rounded bg-secondary text-secondary-content", 4, "ngIf"], ["matTooltip", "Default Transition Animation", 1, "text-xs", "px-2", "py-2", "m-1", "rounded", "bg-base-200"], [1, "ml-1", "uppercase", "bg-base-300", "px-2", "py-1", "rounded"], ["matTooltip", "Default Playback Duration", 1, "text-xs", "px-2", "py-2", "m-1", "rounded", "bg-base-200"], [1, "ml-1", "font-mono", "bg-base-300", "px-2", "py-1", "rounded"], ["matTooltip", "Prefered Orientation", 1, "text-xs", "px-2", "py-2", "m-1", "rounded", "bg-base-200"], ["cdkDropList", "", "id", "playlist-list", 1, "flex-1", "h-1/2", "overflow-auto", "flex", "flex-col", "space-y-2", 3, "cdkDropListData", "cdkDropListConnectedTo"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "space-y-2", "opacity-30", "mx-auto", "flex-1"], [1, "ml-2", "text-xs", "px-2", "py-1", "m-1", "rounded", "bg-secondary", "text-secondary-content"], ["cdkDropList", "", "id", "playlist-list", 1, "flex-1", "h-1/2", "overflow-auto", "flex", "flex-col", "space-y-2", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"], [4, "ngFor", "ngForOf"], ["cdkDrag", "", 1, "relative", "w-full", "bg-base-100", "h-20", "rounded-lg", "flex", "items-center", "p-2", "space-x-2", "border", "border-base-300"], [1, "absolute", "inset-0", "z-0", "bg-warning", "opacity-10", "rounded-lg"], [1, "absolute", "inset-0", "z-0", "bg-error", "opacity-10", "rounded-lg"], ["class", "min-h-10 min-w-10 border-4 rounded-2xl border-base-400 bg-base-300 border-dashed flex items-center justify-center", 4, "cdkDragPlaceholder"], ["matRipple", "", "cdkDragHandle", "", "matTooltip", "Drag to reorder", 1, "flex", "items-center", "justify-center", "w-6", "h-full", "rounded", "hover:bg-base-200"], ["preview", "", 1, "w-[4.5rem]", "h-16", "bg-base-200", "rounded-lg", "overflow-hidden"], ["auth", "", 1, "w-full", "h-full", "object-contain", 3, "source"], [1, "text-base-content", "truncate", "flex-1", "w-1/2"], ["icon", "", "matRipple", "", "aria-label", "Media Actions", 3, "matMenuTriggerFor"], [1, "min-h-10", "min-w-10", "border-4", "rounded-2xl", "border-base-400", "bg-base-300", "border-dashed", "flex", "items-center", "justify-center"], [1, "text-2xl", "text-base-100"], [1, "text-6xl"]], template: function SignagePlaylistMediaListComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementStart(17, "div", 5)(18, "app-icon", 8);
        \u0275\u0275text(19, "delete");
        \u0275\u0275elementEnd();
    ...
    }, dependencies: [NgForOf, NgIf, MatMenu, MatMenuItem, MatMenuTrigger, MatTooltip, MatRipple, IconComponent, AuthenticatedImageDirective, CdkDropList, CdkDrag, CdkDragHandle, CdkDragPlaceholder, AsyncPipe, MediaDurationPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  height: 100%;\n}\n/*# sourceMappingURL=signage-playlist-media-list.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePlaylistMediaListComponent, { className: "SignagePlaylistMediaListComponent", filePath: "apps/concierge/src/app/signage/signage-playlist-media-list.component.ts", lineNumber: 264 });
})();
...
function SignageMediaComponent_Conditional_12_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(9, _c04))("queryParams", \u0275\u0275pureFunction1(10, _c2, playlist_r2.id))("id", "playlist-" + $index_r4)("cdkDropListConnectedTo", \u0275\u0275pureFunction0(12, _c3));
    \u0275\u0275advance(2);
...
function SignageMediaComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, SignageMediaComponent_Conditional_12_For_1_Template, 3, 13, "a", 12, _forTrack02);
    \u0275\u0275pipe(2, "async");
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaComponent, selectors: [["signage-media"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 20, vars: 24, consts: [[1, "relative", "h-full", "w-full", "overflow-visible", "flex", "space-x-4"], ["sidebar", "", 1, "w-64", "h-full", "flex", "flex-col", "space-y-4", "py-4", "overflow-auto"], [1, "text-xl", "font-medium", "text-center"], ["appearance", "outline", 1, "w-full", "no-subscript"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], ["matRipple", "", 1, "w-full", "px-6", "rounded-3xl", "min-h-12", "flex", "items-center", "hover:bg-base-200", 3, "routerLink", "queryParams"], [1, "w-full"], [1, "relative", "flex-1", "w-1/2", "h-full", "overflow-hidden", "rounded-lg", "border", "border-base-300", "shadow", 3, "dragover", "dragenter", "drop"], [1, "h-full", "w-full", "overflow-auto"], [3, "playlist_count", 4, "ngIf"], [3, "playlist", "playlist_count", 4, "ngIf"], ["class", "absolute inset-0", 3, "dragleave", "drop", 4, "ngIf"], ["matRipple", "", "cdkDropList", "", 1, "w-full", "px-6", "rounded-3xl", "h-12", "min-h-12", "flex", "items-center", "hover:bg-base-200", 3, "!bg-secondary", "text-secondary-content", "routerLink", "queryParams", "id", "cdkDropListConnectedTo"], ["matRipple", "", "cdkDropList", "", 1, "w-full", "px-6", "rounded-3xl", "h-12", "min-h-12", "flex", "items-center", "hover:bg-base-200", 3, "cdkDropListDropped", "routerLink", "queryParams", "id", "cdkDropListConnectedTo"], [1, "flex-1"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "space-y-2", "opacity-30"], [1, "text-6xl"], [1, "text-center"], ["btn", "", "matRipple", "", "class", "inverse", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "inverse", 3, "click"], [1, "flex", "items-center", "justify-center", "w-full"], [1, "text-2xl"], [1, "ml-2", "mr-4"], [3, "playlist_count"], [3, "playlist", "playlist_count"], [1, "absolute", "inset-0", 3, "dragleave", "drop"], [1, "absolute", "inset-0", "bg-base-content", "opacity-60"], [1, "absolute", "inset-4", "border-4", "border-dashed", "border-base-300", "flex", "flex-col", "items-center", "justify-center", "rounded-2xl", "text-base-100", "space-y-4"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"]], template: function SignageMediaComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(22, _c04))("queryParams", \u0275\u0275pureFunction0(23, _c1));
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaComponent, { className: "SignageMediaComponent", filePath: "apps/concierge/src/app/signage/signage-media.component.ts", lineNumber: 161 });
})();
...
function SearchOverlayComponent_For_9_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("ngTemplateOutlet", ctx_r2.result_template)("ngTemplateOutletContext", \u0275\u0275pureFunction1(2, _c05, item_r2));
  }
}
...
var SearchOverlayComponent = class _SearchOverlayComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SearchOverlayComponent, selectors: [["search-overlay"]], inputs: { item_list: "item_list", result_template: "result_template" }, outputs: { selected: "selected", close: "close" }, standalone: false, features: [\u0275\u0275NgOnChangesFeature], decls: 14, vars: 5, consts: [[1, "absolute", "inset-0", "flex", "flex-col", "p-8", "items-center", 3, "click", "keydown.esc"], [1, "absolute", "inset-0", "bg-base-content", "opacity-70", "z-0"], [1, "relative", "mb-4", "w-[32rem]", "max-w-[calc(100%-2rem)]", "mx-auto", "z-10", 3, "click"], [1, "rounded-[4rem]", "text-xl", "text-base-content", "bg-base-100", "border", "border-base-300", "shadow", "pl-14", "pr-6", "py-4", "w-full", 3, "ngModelChange", "ngModel", "placeholder"], [1, "absolute", "left-3", "top-1/2", "-translate-y-1/2", "text-3xl", "pointer-events-none"], [1, "overflow-auto", "max-h-[65%]", "w-[32rem]", "max-w-[calc(100%-2rem)]", "mx-auto", "rounded", "z-10", 3, "click"], ["matRipple", "", 1, "w-full", "text-left"], ["matRipple", "", 1, "w-full", "p-4", "text-base-100"], ["icon", "", "matRipple", "", 1, "absolute", "top-10", "right-8", "text-base-100", "text-xl", "h-12", "w-12"], ["matRipple", "", 1, "w-full", "text-left", 3, "click"], [1, "p-4", "w-full", "bg-base-100", "hover:bg-base-200", "border", "border-base-300"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], ["matRipple", "", 1, "w-full", "p-4", "text-base-100", 3, "click"], [1, "opacity-30"]], template: function SearchOverlayComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(11, "button", 8)(12, "app-icon");
        \u0275\u0275text(13, "close");
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
...
var _c22 = () => ["/signage", "media"];
var _c32 = (a0) => ({ playlist: a0 });
var _c4 = (a0) => ({ name: a0 });
...
function SignageItemPlaylistsComponent_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "button", 14)(13, "app-icon");
    \u0275\u0275text(14, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "mat-menu", null, 0)(17, "a", 15)(18, "div", 16)(19, "app-icon", 17);
    ...
    \u0275\u0275elementStart(25, "div", 16)(26, "app-icon", 20);
    \u0275\u0275text(27, " delete ");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(19, _c22))("queryParams", \u0275\u0275pureFunction1(20, _c32, item_r4.id));
    \u0275\u0275advance(5);
...
function SignageItemPlaylistsComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, SignageItemPlaylistsComponent_Conditional_5_For_2_Template, 31, 22, "div", 7, _forTrack03);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementEnd();
...
var SignageItemPlaylistsComponent = class _SignageItemPlaylistsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageItemPlaylistsComponent, selectors: [["signage-item-playlists"]], inputs: { item: "item", name: "name", extra: "extra" }, outputs: { add: "add", remove: "remove", ondrop: "ondrop" }, standalone: false, features: [\u0275\u0275NgOnChangesFeature], ngContentSelectors: _c06, decls: 8, vars: 5, consts: [["menu", "matMenu"], [1, "flex", "items-center", "justify-center", "space-x-2"], [1, "text-xl", "font-medium"], ["class", "px-2 py-1 text-xs font-mono bg-base-200 rounded-lg uppercase", 4, "ngIf"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "space-y-2", "mx-auto", "flex-1"], [1, "px-2", "py-1", "text-xs", "font-mono", "bg-base-200", "rounded-lg", "uppercase"], ["cdkDropList", "", 1, "flex-1", "h-1/2", "overflow-auto", "flex", "flex-col", "space-y-2", "mt-4", 3, "cdkDropListDropped"], ["cdkDrag", "", 1, "w-full", "bg-base-100", "h-20", "rounded-lg", "flex", "items-center", "p-2", "space-x-2", "border", "border-base-300"], ["btn", "", "matRipple", "", 3, "click"], ["class", "h-20 w-full border-4 border-dashed border-base-400 bg-base-300 rounded-xl", 4, "cdkDragPlaceholder"], ["matRipple", "", "cdkDragHandle", "", 1, "flex", "items-center", "justify-center", "w-6", "h-full", "rounded", "hover:bg-base-200", 3, "matTooltip"], [1, "text-base-content", "flex-1", "w-1/2"], [1, "truncate"], [1, "truncate", "text-sm", "opacity-30"], ["icon", "", "matRipple", "", "aria-label", "Media Actions", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "routerLink", "queryParams"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], ["mat-menu-item", "", 3, "click"], [1, "text-2xl", "text-error"], [1, "h-20", "w-full", "border-4", "border-dashed", "border-base-400", "bg-base-300", "rounded-xl"], [1, "flex", "flex-col", "items-center", "justify-center", "opacity-30"], [1, "text-6xl"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"]], template: function SignageItemPlaylistsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275projectionDef();
        \u0275\u0275elementStart(0, "div", 1)(1, "h3", 2);
        \u0275\u0275text(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageItemPlaylistsComponent, { className: "SignageItemPlaylistsComponent", filePath: "apps/concierge/src/app/signage/signage-item-playlists.component.ts", lineNumber: 148 });
})();
...
function SignageDisplaysComponent_Conditional_8_For_2_Conditional_2_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(7, _c07))("queryParams", \u0275\u0275pureFunction2(8, _c23, display_r2.id, trigger_r1 == null ? null : trigger_r1.id));
    \u0275\u0275advance(2);
...
function SignageDisplaysComponent_Conditional_8_For_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, SignageDisplaysComponent_Conditional_8_For_2_Conditional_2_For_1_Template, 6, 11, "div", 13, _forTrack04);
    \u0275\u0275pipe(2, "async");
  }
  if (rf & 2) {
...
function SignageDisplaysComponent_Conditional_8_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(10, _c07))("queryParams", \u0275\u0275pureFunction1(11, _c13, display_r2.id));
    \u0275\u0275advance();
...
function SignageDisplaysComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6);
    \u0275\u0275repeaterCreate(1, SignageDisplaysComponent_Conditional_8_For_2_Template, 4, 13, null, null, _forTrack04);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SignageDisplaysComponent_Conditional_12_div_6_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(11, _c33))("queryParams", \u0275\u0275pureFunction1(12, _c42, zone_r5));
    \u0275\u0275advance();
...
function SignageDisplaysComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(22, "div", 24)(23, "app-icon", 28);
    \u0275\u0275text(24, "delete");
    \u0275\u0275elementEnd();
...
var SignageDisplaysComponent = class _SignageDisplaysComponent extends AsyncHandler {
  ...
  static {
    ...
    }, dependencies: [NgIf, DefaultValueAccessor, NgControlStatus, NgModel, MatFormField, MatInput, MatMenu, MatMenuItem, MatMenuTrigger, MatRipple, IconComponent, RouterLink, SearchOverlayComponent, SignageItemPlaylistsComponent, AsyncPipe, ZonePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageDisplaysComponent, { className: "SignageDisplaysComponent", filePath: "apps/concierge/src/app/signage/signage-displays.component.ts", lineNumber: 238 });
})();
...
function SignageZonesComponent_Conditional_8_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(10, _c08))("queryParams", \u0275\u0275pureFunction1(11, _c14, zone_r2.id));
    \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageZonesComponent, { className: "SignageZonesComponent", filePath: "apps/concierge/src/app/signage/signage-zones.component.ts", lineNumber: 149 });
})();
...
//# sourceMappingURL=signage.module-K76YKQR3.js.map
