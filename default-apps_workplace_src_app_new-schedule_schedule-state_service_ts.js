...
class ScheduleStateService extends _placeos_common__WEBPACK_IMPORTED_MODULE_2__.AsyncHandler {
  ...
  constructor(_settings, _org, _lockers, _dialog, _parking) {
    ...
    this.visitors = (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.combineLatest)([this._update, this.options]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.switchMap)(([[date], {
      period
    }]) => this._bookingQuery('visitor', period, date)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_15__.map)(_ => _.filter(_ => !_.parent_id && !_.linked_event)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(() => this.timeout('end_loading', () => this._loading.next(false))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.shareReplay)(1));
    /** List of desk bookings for the selected date */
    this.desks = (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.combineLatest)([this._update, this.options]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.switchMap)(([[date], {
      period
    }]) => this._bookingQuery('desk', period, date)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(() => this.timeout('end_loading', () => this._loading.next(false))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.shareReplay)(1));
    /** List of parking bookings for the selected date */
    this.parking = (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.combineLatest)([this._update, this.options]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.switchMap)(([[date], {
      period
    }]) => this._bookingQuery('parking', period, date)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(() => this.timeout('end_loading', () => this._loading.next(false))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.shareReplay)(1));
    /** List of calendar events for the selected date */
    ...
    this.locker_bookings = (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.combineLatest)([this._update, this.options]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.switchMap)(([[date], {
      period
    }]) => this._bookingQuery('locker', period, date)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(() => this.timeout('end_loading', () => this._loading.next(false))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.shareReplay)(1));
    /** List of parking bookings for the selected date */
    ...
    this.bookings = (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.combineLatest)([this.events, this.visitors, this.desks, this.parking, this.lockers, this.locker_bookings, this.group_events]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_15__.map)(([events, visitors, desks, parking, lockers, locker_bookings, group_events]) => {
      const filtered_events = events.filter(ev => !desks.find(bkn => `${ev.meeting_id}` === `${bkn.id}`) && ev.linked_bookings[0]?.booking_type !== 'group-event');
      return [...filtered_events, ...visitors, ...desks, ...parking, ...lockers, ...locker_bookings, ...group_events].sort((a, b) => a.date - b.date);
    }));
  ...
  setType(name, state) {
    ...
    const new_types = state ? (0,_placeos_common__WEBPACK_IMPORTED_MODULE_2__.unique)([...shown_types, name]) : shown_types.filter(_ => _ !== name);
    this._filters.next({
      ...filters,
