...
function AutoReleaseSettingsModalComponent_main_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(17, 24, "RESOURCE.DESKS"), " ");
    \u0275\u0275advance(3);
...
var AutoReleaseSettingsModalComponent = class _AutoReleaseSettingsModalComponent {
  ...
  loadSettings(id) {
    return __async(this, null, function* () {
      ...
      this.settings = {};
      const settings = yield ec({ parent_id: id }).pipe(map((_) => _.data)).toPromise();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AutoReleaseSettingsModalComponent, selectors: [["auto-release-modal"]], standalone: false, decls: 9, vars: 7, consts: [["load_state", ""], [1, "border-gray-300", "flex", "items-center", "justify-between", "border-b", "p-4"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "w-[20rem] px-2", 4, "ngIf", "ngIfElse"], ["class", "flex justify-end p-4", 4, "ngIf"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "text-2xl"], [1, "w-[20rem]", "px-2"], [3, "ngModelChange", "min", "max", "step", "ngModel"], ["appearance", "outline", 1, "w-full"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], ["value", "desk"], ["value", "visitor"], ["value", "parking"], [1, "flex", "justify-end", "p-4"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-32"], [3, "diameter"]], template: function AutoReleaseSettingsModalComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var InductionSettingsModalComponent = class _InductionSettingsModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InductionSettingsModalComponent, selectors: [["induction-settings-modal"]], standalone: false, decls: 9, vars: 7, consts: [["load_state", ""], [1, "border-gray-300", "flex", "items-center", "justify-between", "border-b", "p-4"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "flex flex-col space-y-2 p-4", 4, "ngIf", "ngIfElse"], ["class", "flex justify-end px-4 pb-4", 4, "ngIf"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "text-2xl"], [1, "flex", "flex-col", "space-y-2", "p-4"], ["appearance", "outline", 1, "h-[50vh]", "w-[36rem]", "max-w-[80vw]"], ["matInput", "", 1, "h-[calc(50vh-2rem)]", "w-[34rem]", "max-w-[calc(80vw-2rem)]", "resize-none", 3, "ngModelChange", "ngModel", "placeholder"], [3, "ngModelChange", "ngModel"], [1, "flex", "justify-end", "px-4", "pb-4"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-32"], [3, "diameter"]], template: function InductionSettingsModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "header", 1)(1, "h3", 2);
        \u0275\u0275text(2);
        \u0275\u0275pipe(3, "translate");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InductionSettingsModalComponent, { className: "InductionSettingsModalComponent", filePath: "apps/concierge/src/app/building-manager/induction-settings-modal.component.ts", lineNumber: 61 });
})();
...
//# sourceMappingURL=building-manager.module-K7GP2YR7.js.map
