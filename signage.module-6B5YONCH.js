...
var _SignageDisplaysComponent = class _SignageDisplaysComponent extends AsyncHandler {
  ...
  setOrientation(orientation) {
    return __async(this, null, function* () {
      ...
      if (!display)
        return;
      yield lastValueFrom(ac(display.id, { orientation, version: display.version }, "patch")).catch((e) => {
  ...
  addZone() {
    return __async(this, null, function* () {
      ...
      if (!result)
        return;
      yield lastValueFrom(ac(display.id, {
...
//# sourceMappingURL=signage.module-6B5YONCH.js.map
