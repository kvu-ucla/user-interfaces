...
var WeekViewTopbarComponent = class _WeekViewTopbarComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WeekViewTopbarComponent, selectors: [["week-view-topbar"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 17, vars: 10, consts: [["btn", "", "matRipple", "", "new", "", 1, "w-12", "xl:w-auto", 3, "click"], [1, "flex", "items-center"], [1, "mr-2"], [1, "hidden", "xl:block"], ["appearance", "outline"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [1, "m-2", 3, "ngModelChange", "ngModel"], [1, "text-xs"], [1, "flex-1", "w-0"], [3, "dateChange"], [3, "value"]], template: function WeekViewTopbarComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var WeekViewDayComponent = class _WeekViewDayComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WeekViewDayComponent, selectors: [["week-view-day"]], inputs: { index: "index" }, standalone: false, features: [\u0275\u0275NgOnChangesFeature], decls: 9, vars: 10, consts: [["empty_state", ""], [1, "flex", "items-center", "justify-center", "border-b", "border-base-200", "bg-base-300", "w-full", "py-3", "text-white"], [1, "flex-1", "h-1/2", "overflow-auto", "w-full"], [4, "ngIf", "ngIfElse"], [3, "event", 4, "ngFor", "ngForOf"], [3, "event"], [1, "text-center", "p-2"]], template: function WeekViewDayComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var WeekViewTimelineComponent = class _WeekViewTimelineComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WeekViewTimelineComponent, selectors: [["week-view-timeline"]], standalone: false, decls: 6, vars: 7, consts: [[1, "flex", "divide-x", "border-base-200", "h-full"], [4, "ngFor", "ngForOf"], ["mode", "indeterminate", 4, "ngIf"], [3, "event", 4, "ngIf"], [4, "ngIf"], [1, "h-full", "flex-1", 3, "index"], ["mode", "indeterminate"], [3, "event"]], template: function WeekViewTimelineComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=week-view.module-OT6LS2YV.js.map
