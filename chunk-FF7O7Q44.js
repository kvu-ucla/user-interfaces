...
function DeskModalComponent_main_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "main", 9)(1, "div", 10)(2, "label", 11);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementStart(5, "span");
    \u0275\u0275text(6, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "mat-form-field", 12);
    ...
    \u0275\u0275pipe(23, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(24, "div", 15)(25, "label", 18);
    \u0275\u0275text(26);
    \u0275\u0275pipe(27, "translate");
    \u0275\u0275elementStart(28, "span");
    \u0275\u0275text(29, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div", 19)(31, "mat-form-field", 12);
    ...
    \u0275\u0275pipe(38, "translate");
    \u0275\u0275listener("click", function DeskModalComponent_main_6_Template_button_click_37_listener() {
      \u0275\u0275restoreView(_r2);
    ...
    \u0275\u0275text(40, "place");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(41, "label", 22);
    \u0275\u0275text(42);
    \u0275\u0275pipe(43, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "div", 23);
    \u0275\u0275element(45, "a-user-search-field", 24);
    \u0275\u0275elementStart(46, "button", 25);
    \u0275\u0275pipe(47, "translate");
    \u0275\u0275listener("click", function DeskModalComponent_main_6_Template_button_click_46_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.form.patchValue({ assigned_user: null, assigned_to: null, assigned_name: null }));
    });
    \u0275\u0275elementStart(48, "icon", 26);
    \u0275\u0275text(49, " person_cancel ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(50, "div", 27);
    \u0275\u0275element(51, "settings-toggle", 28);
    \u0275\u0275pipe(52, "translate");
    \u0275\u0275element(53, "div", 29);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(56, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(57, "item-list-field", 31);
    \u0275\u0275pipe(58, "translate");
    \u0275\u0275elementStart(59, "label", 30);
    \u0275\u0275text(60);
    \u0275\u0275pipe(61, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(62, "item-list-field", 32);
    \u0275\u0275pipe(63, "translate");
    \u0275\u0275elementStart(64, "label", 30);
    \u0275\u0275text(65);
    \u0275\u0275pipe(66, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(67, "mat-form-field", 33);
    \u0275\u0275element(68, "textarea", 34);
    \u0275\u0275pipe(69, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "label", 35);
    \u0275\u0275text(71);
    \u0275\u0275pipe(72, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "mat-form-field", 12);
    \u0275\u0275element(74, "input", 36);
    \u0275\u0275pipe(75, "translate");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskModalComponent, selectors: [["desk-modal"]], outputs: { event: "event" }, standalone: false, decls: 13, vars: 9, consts: [["load_state", ""], [1, "w-[32rem]"], [1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "flex max-h-[65vh] flex-col overflow-auto p-4", 3, "formGroup", 4, "ngIf", "ngIfElse"], [1, "flex", "items-center", "justify-end", "space-x-2", "border-t", "border-base-300", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "max-h-[65vh]", "flex-col", "overflow-auto", "p-4", 3, "formGroup"], [1, "w-full"], ["for", "id"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "id", "formControlName", "id", "placeholder", "desk-10.123"], [1, "flex", "space-x-4"], [1, "w-1/3", "flex-1"], ["for", "name"], ["matInput", "", "name", "name", "formControlName", "name", "placeholder", "e.g. Office Desk"], ["for", "map-id"], [1, "flex", "space-x-2"], ["matInput", "", "name", "map-id", "formControlName", "map_id", 3, "placeholder"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "min-w-12", "rounded", "border", "border-secondary", "text-secondary", 3, "click", "matTooltip"], ["for", "user"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["name", "user", "formControlName", "assigned_user", 1, "flex-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "min-w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "matTooltip"], ["className", "material-symbols-outlined"], [1, "flex", "space-x-4", "pb-4"], ["formControlName", "bookable", 1, "flex-1", 3, "name"], [1, "flex-1"], ["for", "notes"], ["formControlName", "groups", 1, "w-full", 3, "placeholder"], ["formControlName", "features", 1, "w-full", 3, "placeholder"], ["appearance", "outline"], ["matInput", "", "name", "notes", "formControlName", "notes", 3, "placeholder"], ["for", "security"], ["matInput", "", "name", "security", "formControlName", "security", 3, "placeholder"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], ["diameter", "32"]], template: function DeskModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(6, DeskModalComponent_main_6_Template, 76, 58, "main", 5);
    ...
    }, dependencies: [NgIf, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, MatFormField, MatError, MatInput, MatTooltip, MatProgressSpinner, MatDialogClose, MatRipple, ItemListFieldComponent, UserSearchFieldComponent, IconComponent, SettingsToggleComponent, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskModalComponent, { className: "DeskModalComponent", filePath: "apps/concierge/src/app/desks/desk-modal.component.ts", lineNumber: 198 });
})();
...
var DesksStateService = class _DesksStateService extends AsyncHandler {
  ...
  constructor(_org, _dialog, _settings) {
    ...
    this.desks = combineLatest([
      ...
      return zones && !zones.includes("All") ? hu(zones[0], "desks").pipe(map((m) => m.details instanceof Array ? m.details : []), catchError((_) => of([]))) : mu(this._org.building?.id, {
        name: "desks"
  ...
  addDesks(list) {
    return __async(this, null, function* () {
      ...
      const desk_list = yield nextValueFrom(this.desks);
  ...
  cancelBooking(booking) {
    return __async(this, null, function* () {
      ...
      yield nextValueFrom(removeBooking(booking.id)).catch((e) => {
  ...
  rejectAllDesks() {
    return __async(this, null, function* () {
      const list = yield nextValueFrom(this.bookings);
      if (list.length <= 0)
  ...
  _clearAssignedBooking(desk) {
    return __async(this, null, function* () {
      const booking_list = yield lastValueFrom(queryBookings({
      ...
      yield Promise.all(filtered.map((_) => lastValueFrom(removeBooking(_.id))));
    });
  }
  static {
...
//# sourceMappingURL=chunk-FF7O7Q44.js.map
