...
var InviteVisitorModalComponent = class _InviteVisitorModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InviteVisitorModalComponent, selectors: [["invite-visitor-modal"]], decls: 2, vars: 1, consts: [[1, "relative", "min-w-[40rem]", "min-h-[40rem]"], [3, "done", "date"]], template: function InviteVisitorModalComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=visitors.module-VNZSHCS2.js.map
