...
var _AssetGroupFormComponent = class _AssetGroupFormComponent extends AsyncHandler {
  ...
  ngOnInit() {
    this.subscription("route.query", this._route.queryParamMap.subscribe((params) => __async(this, null, function* () {
      if (params.get("id")) {
        this.loading = "Loading Product Details...";
        const product = yield lastValueFrom(showAssetGroup(params.get("id"))).catch(() => null);
        if (!product) {
  ...
  save() {
    return __async(this, null, function* () {
      ...
      this.loading = "Saving Product...";
      const data = this.form.value;
      const item = yield lastValueFrom(saveAssetGroup(data)).catch((e) => {
        this.loading = "";
...
//# sourceMappingURL=asset-manager.module-FOOAYFHC.js.map
