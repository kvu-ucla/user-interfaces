...
var AssetCategoryFormComponent = class _AssetCategoryFormComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetCategoryFormComponent, selectors: [["asset-category-form"]], standalone: false, decls: 9, vars: 7, consts: [["load_state", ""], [1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "h-1/2 w-[24rem] max-w-[80vw] flex-1 overflow-auto p-2", 3, "formGroup", 4, "ngIf", "ngIfElse"], ["class", "flex justify-end space-x-2 border-t border-base-200 p-2", 4, "ngIf"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "h-1/2", "w-[24rem]", "max-w-[80vw]", "flex-1", "overflow-auto", "p-2", 3, "formGroup"], [1, "flex", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], ["formControlName", "parent_category_id", 3, "placeholder", "disabled"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [1, "flex", "justify-end", "space-x-2", "border-t", "border-base-200", "p-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8"], [3, "diameter"], [1, "mt-4"]], template: function AssetCategoryFormComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var AssetCategoryManagementModalComponent = class _AssetCategoryManagementModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetCategoryManagementModalComponent, selectors: [["asset-category-management-modal"]], standalone: false, decls: 17, vars: 8, consts: [[1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "h-[32rem]", "max-h-[65vh]", "min-w-[28rem]"], [1, "hover:bg-base-200:bg-base-300", "m-2", "flex", "items-center", "space-x-2", "rounded", "border", "border-base-200", "p-2"], ["btn", "", "matRipple", "", 1, "m-2", "flex", "w-[calc(100%-1rem)]", "items-center", "justify-center", "space-x-2", 3, "click"], [1, "truncate", "pl-2"], [1, "text-2xl"], ["class", "hover:bg-base-200:bg-base-300 m-2 flex items-center space-x-2 rounded border border-base-200 p-2", 4, "ngIf"], [1, "flex-1", "truncate", "px-2"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "border", "border-secondary", "text-secondary", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "border", "border-error", "text-error", 3, "click", "matTooltip"]], template: function AssetCategoryManagementModalComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var AssetManagerStateService = class _AssetManagerStateService extends AsyncHandler {
  ...
  constructor(_spaces, _org, _dialog, _settings) {
    ...
    this.settings = combineLatest([
      this._org.active_building,
      this._change
    ]).pipe(filter(([_]) => !!_), switchMap(([_]) => hu(_.id, "assets-settings").pipe(catchError((_2) => of({})))), map((_) => _.details || {}), shareReplay(1));
  ...
  deleteActiveProduct() {
    return __async(this, null, function* () {
      const item = yield nextValueFrom(this.active_product);
      if (!item?.id)
        return;
  ...
  editConfig() {
    return __async(this, null, function* () {
      ...
      const items = yield nextValueFrom(this.products);
  ...
  getConfig() {
    return __async(this, arguments, function* (zone_id = this._org.building.id) {
      const rules = (yield hu(zone_id, "assets_config").toPromise()).details;
...
var AssetBulkFormComponent = class _AssetBulkFormComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetBulkFormComponent, selectors: [["asset-bulk-form"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 41, vars: 51, consts: [[3, "confirm", "heading", "close", "loading"], [3, "formGroup"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", 3, "ngModel", "ngModelOptions", "disabled"], [1, "flex", "items-center", "space-x-2"], ["for", "count"], ["matInput", "", "name", "count", "type", "number", 3, "ngModelChange", "ngModel", "placeholder", "ngModelOptions"], ["for", "identifier"], ["matInput", "", "name", "identifier", "formControlName", "identifier", 3, "placeholder"], ["for", "purchase-order-id"], ["formControlName", "purchase_order_id", 3, "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], ["class", "opacity-60", 3, "disabled", 4, "ngIf"], [3, "value"], [1, "opacity-60", 3, "disabled"]], template: function AssetBulkFormComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        let tmp_18_0;
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 20, ctx.form.value.id ? "APP.CONCIERGE.ASSETS_BULK_EDIT" : "APP.CONCIERGE.ASSETS_BULK_ADD"))("close", ctx.product ? \u0275\u0275pureFunction2(44, _c03, ctx.base_route, ctx.product.id) : \u0275\u0275pureFunction1(47, _c12, ctx.base_route))("loading", ctx.loading);
        \u0275\u0275advance(2);
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 22, "APP.CONCIERGE.ASSETS_PRODUCT"));
        \u0275\u0275advance(3);
        \u0275\u0275property("ngModel", (ctx.product == null ? null : ctx.product.name) || "No Product")("ngModelOptions", \u0275\u0275pureFunction0(49, _c22))("disabled", true);
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 24, "APP.CONCIERGE.ASSETS_BULK_COUNT"));
        \u0275\u0275advance(3);
        \u0275\u0275twoWayProperty("ngModel", ctx.count);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(16, 26, "APP.CONCIERGE.ASSETS_BULK_COUNT"))("ngModelOptions", \u0275\u0275pureFunction0(50, _c22));
        \u0275\u0275advance(4);
...
var AssetFormComponent = class _AssetFormComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetFormComponent, selectors: [["asset-form"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 54, vars: 60, consts: [[3, "confirm", "heading", "close", "loading"], [3, "formGroup"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", 3, "ngModel", "ngModelOptions", "disabled"], [1, "flex", "items-center", "space-x-2"], ["for", "serial-number"], ["matInput", "", "name", "serial-number", "formControlName", "serial_number", 3, "placeholder"], ["for", "identifier"], ["matInput", "", "name", "identifier", "formControlName", "identifier", 3, "placeholder"], ["for", "purchase-order-id"], ["formControlName", "purchase_order_id", 3, "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], ["class", "opacity-60", 3, "disabled", 4, "ngIf"], ["matInput", "", "name", "barcode", "formControlName", "barcode", 3, "placeholder"], [3, "value"], [1, "opacity-60", 3, "disabled"]], template: function AssetFormComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        let tmp_17_0;
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 22, ctx.form.value.id ? "APP.CONCIERGE.ASSETS_EDIT" : "APP.CONCIERGE.ASSETS_NEW"))("close", ctx.product ? \u0275\u0275pureFunction2(54, _c04, ctx.base_route, ctx.product.id) : \u0275\u0275pureFunction1(57, _c13, ctx.base_route))("loading", ctx.loading);
        \u0275\u0275advance(2);
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 24, "APP.CONCIERGE.ASSETS_PRODUCT"));
        \u0275\u0275advance(3);
        \u0275\u0275property("ngModel", (ctx.product == null ? null : ctx.product.name) || "No Product")("ngModelOptions", \u0275\u0275pureFunction0(59, _c23))("disabled", true);
        \u0275\u0275advance(4);
...
var AssetGroupFormComponent = class _AssetGroupFormComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetGroupFormComponent, selectors: [["asset-group-form"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 62, vars: 53, consts: [[3, "confirm", "heading", "close", "loading"], [3, "formGroup"], [1, "flex", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], ["formControlName", "category_id", 3, "click", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [1, "relative", 3, "click"], [1, "flex", "items-center", "space-x-2"], ["for", "brand"], ["matInput", "", "name", "brand", "formControlName", "brand", 3, "placeholder"], ["for", "description"], ["matInput", "", "name", "description", "placeholder", "Description of the product", "formControlName", "description"], ["for", "images"], ["name", "images", "formControlName", "images"], [3, "value"]], template: function AssetGroupFormComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 18, ctx.form.value.id ? "APP.CONCIERGE.ASSETS_ITEM_EDIT" : "APP.CONCIERGE.ASSETS_ITEM_NEW"))("close", ctx.form.value.id ? \u0275\u0275pureFunction2(48, _c05, ctx.base_route, ctx.form.value.id) : \u0275\u0275pureFunction1(51, _c14, ctx.base_route))("loading", ctx.loading);
        \u0275\u0275advance(2);
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(3);
...
function AssetItemListComponent_div_0_ng_container_1_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" (", \u0275\u0275pipeBind2(7, 6, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(11, _c06, (tmp_6_0 = \u0275\u0275pipeBind1(6, 4, ctx_r2.products)[group_r4.id]) == null ? null : tmp_6_0.length)), ") ");
    \u0275\u0275advance(3);
...
function AssetManagerTopbarComponent_a_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(4, _c07, ctx_r0.base_route));
    \u0275\u0275advance();
...
var AssetManagerTopbarComponent = class _AssetManagerTopbarComponent extends AsyncHandler {
  ...
  setRoomAvailability() {
    return __async(this, null, function* () {
      const ref = this._dialog.open(AvailableRoomsStateModalComponent, {
        data: {
          type: "Assets",
          disabled_rooms: yield nextValueFrom(this._state.availability)
        }
      });
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetManagerTopbarComponent, selectors: [["asset-manager-topbar"]], inputs: { active: "active" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 16, vars: 15, consts: [[1, "flex", "w-full", "items-center", "space-x-2", "bg-base-100", "px-8", "pb-2", "pt-4"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], ["appearance", "outline", 1, "no-subscript"], ["matPrefix", "", 1, "relative", "-left-1", "top-1", "text-2xl"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["btn", "", "matRipple", "", "class", "w-40", 3, "routerLink", 4, "ngIf"], ["btn", "", "matRipple", "", "class", "w-48", 3, "routerLink", 4, "ngIf"], ["class", "mb-2 flex items-center space-x-2 px-8", 4, "ngIf"], ["class", "flex items-center space-x-2 px-4 pb-2", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "w-40", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "w-48", 3, "routerLink"], [1, "mb-2", "flex", "items-center", "space-x-2", "px-8"], [3, "ngModelChange", "ngModel"], ["value", "grid", 3, "matTooltip"], [1, "flex", "h-12", "w-8", "items-center", "justify-center"], [1, "text-2xl"], ["value", "list", 3, "matTooltip"], [1, "flex-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", "class", "h-12 w-12 rounded bg-secondary text-secondary-content", 3, "matTooltip", "click", 4, "ngIf"], [1, "flex", "items-center", "space-x-2", "px-4", "pb-2"], ["appearance", "outline", 1, "no-subscript", "w-48"], [3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]], template: function AssetManagerTopbarComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetManagerTopbarComponent, { className: "AssetManagerTopbarComponent", filePath: "apps/concierge/src/app/asset-manager/asset-manager-topbar.component.ts", lineNumber: 142 });
})();

// apps/concierge/src/app/asset-manager/asset-listing.component.ts
var _c08 = (a0) => [a0, "list", "items"];
...
function AssetListingComponent_nav_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(12, _c08, ctx_r2.base_route))("active", ctx_r2.active === "items");
    \u0275\u0275advance();
...
var AssetLocationModalComponent = class _AssetLocationModalComponent {
  ...
  setTracking(item, state) {
    return __async(this, null, function* () {
      ...
      yield this._state.setTracking(item, state);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetLocationModalComponent, selectors: [["asset-location-modal"]], standalone: false, decls: 24, vars: 23, consts: [["empty_state", ""], ["level_template", ""], ["tracking_template", ""], ["tracking_menu", "matMenu"], [1, "relative", "p-6"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 1, "absolute", "right-4", "top-4"], [1, "mb-2", "font-medium"], ["appearance", "outline", 1, "mb-2", "h-[3.5rem]"], ["matPrefix", ""], ["matInput", "", "placeholder", "Search..."], [1, "flex", "w-[90vw]", "items-center", "space-x-4", "text-sm"], [1, "h-[60vh]", "w-1/2", "flex-1", "overflow-auto", "border", "border-base-200", "bg-base-200"], ["empty_message", "No requested assets for this product", 1, "block", "w-full", 3, "row_clicked", "data", "columns", "sortable"], [1, "relative", "flex", "h-[60vh]", "w-1/2", "flex-1", "items-center", "justify-center", "border", "border-base-200", "bg-base-200"], ["class", "absolute left-4 top-4 rounded-3xl border border-base-200 bg-base-100 px-4 py-2", 4, "ngIf"], [3, "src", "styles", "features", 4, "ngIf", "ngIfElse"], [1, "absolute", "left-4", "top-4", "rounded-3xl", "border", "border-base-200", "bg-base-100", "px-4", "py-2"], [3, "src", "styles", "features"], [1, "opacity-30"], [1, "p-4"], [1, "px-4", "py-2"], ["matRipple", "", 1, "flex", "w-full", "items-center", "rounded", "bg-none", "px-2", "py-1", "text-left", 3, "click", "matMenuTriggerFor", "disabled"], [1, "min-w-32", "flex-1", "capitalize"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"]], template: function AssetLocationModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(9);
        \u0275\u0275property("data", ctx.requests)("columns", \u0275\u0275pureFunction4(18, _c4, \u0275\u0275pureFunction1(12, _c09, level_template_r8), \u0275\u0275pureFunction0(14, _c18), \u0275\u0275pureFunction1(15, _c26, tracking_template_r9), \u0275\u0275pureFunction0(17, _c3)))("sortable", true);
        \u0275\u0275advance(2);
...
var AssetManagerComponent = class _AssetManagerComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetManagerComponent, selectors: [["", "asset-manager", ""]], standalone: false, attrs: _c010, decls: 5, vars: 0, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"]], template: function AssetManagerComponent_Template(rf, ctx) {
      if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetPurchaseOrderFormComponent, selectors: [["asset-purchase-order-form"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 52, vars: 45, consts: [[3, "confirm", "heading", "close", "loading"], [3, "formGroup"], [1, "flex", "flex-col", "space-y-2"], ["for", "order-number"], ["appearance", "outline"], ["matInput", "", "name", "order-number", "formControlName", "order_number", 3, "placeholder"], ["for", "invoice-number"], ["matInput", "", "name", "invoice-number", "formControlName", "invoice_number", 3, "placeholder"], [1, "flex", "space-x-2"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "purchase-date"], ["name", "purchase-date", "formControlName", "purchase_date", 3, "from"], ["for", "unit-price"], ["appearance", "outline", 1, "w-full"], ["matPrefix", ""], ["matInput", "", "name", "unit-price", "formControlName", "unit_price"], ["for", "depreciation-start-date"], ["name", "depreciation-start-date", "formControlName", "expected_service_start_date", 3, "from"], ["for", "depreciation-end-date"], ["name", "depreciation-end-date", "formControlName", "expected_service_end_date"], ["class", "mb-2 font-medium", 4, "ngIf"], ["class", "block w-full text-sm", 3, "data", "columns", "empty_message", 4, "ngIf"], [1, "mb-2", "font-medium"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "empty_message"]], template: function AssetPurchaseOrderFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275template(50, AssetPurchaseOrderFormComponent_h3_50_Template, 4, 8, "h3", 20)(51, AssetPurchaseOrderFormComponent_simple_table_51_Template, 6, 27, "simple-table", 21);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 18, ctx.form.value.id ? "APP.CONCIERGE.ASSETS_PURCHASE_EDIT" : "APP.CONCIERGE.ASSETS_PURCHASE_NEW"))("close", ctx.product_id ? \u0275\u0275pureFunction2(40, _c011, ctx.base_route, ctx.product_id) : \u0275\u0275pureFunction1(43, _c19, ctx.base_route))("loading", ctx.loading);
        \u0275\u0275advance(2);
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(3);
...
var _c012 = (a0) => ({ key: "purchase_order_number", name: a0 });
var _c110 = (a0) => ({ key: "invoice_number", name: a0 });
var _c28 = (a0, a1) => ({ key: "purchase_date", name: a0, content: a1 });
var _c33 = (a0, a1) => ({ key: "expected_service_start_date", name: a0, content: a1 });
...
var AssetPurchaseOrderListComponent = class _AssetPurchaseOrderListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetPurchaseOrderListComponent, selectors: [["app-asset-purchase-order-list"]], standalone: false, decls: 13, vars: 40, consts: [["date_template", ""], [1, "relative", "-left-4", "mt-4", "flex", "h-[calc(100%-1rem)]", "w-[calc(100%+2rem)]", "flex-col"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "p-4"], ["purchase-orders", "", 1, "block", "min-w-[52rem]", "text-sm", 3, "row_clicked", "data", "columns", "empty_message", "filter", "sortable"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"]], template: function AssetPurchaseOrderListComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
...
function AssetRequestDetailsComponent_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(7);
    \u0275\u0275property("user", \u0275\u0275pureFunction1(73, _c013, ctx_r1.request.user_name));
    \u0275\u0275advance(3);
...
var AssetRequestDetailsComponent = class _AssetRequestDetailsComponent {
  ...
  setTracking(state) {
    return __async(this, null, function* () {
      this.loading = true;
      yield this._state.setTracking(this.request, state);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetRequestDetailsComponent, selectors: [["asset-request-details"]], inputs: { request: "request" }, outputs: { requestChange: "requestChange" }, standalone: false, decls: 1, vars: 1, consts: [["menu", "matMenu"], ["tracking_menu", "matMenu"], ["class", "fixed inset-0 z-50", 3, "click", 4, "ngIf"], [1, "fixed", "inset-0", "z-50", 3, "click"], [1, "absolute", "inset-0", "bg-black", "opacity-50"], [1, "absolute", "inset-y-0", "right-0", "w-[480px]", "bg-base-100", 3, "click"], ["icon", "", "matRipple", "", 1, "absolute", "right-1", "top-1", 3, "click"], [1, "flex", "space-x-4", "border-b", "border-base-200", "px-2", "py-4"], [1, "text-xl", 3, "user"], ["details", "", 1, "space-y-1"], [1, "font-medium"], [1, "flex", "items-center", "space-x-2", "text-sm"], [1, "underline", 3, "href"], [1, "relative", "px-3", "py-4"], [1, "flex", "items-center", "space-x-4"], [1, "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", "bg-base-200", "text-secondary"], [1, "text-sm"], [1, "mt-1", "flex", "flex-col", "pl-10"], [4, "ngFor", "ngForOf"], [1, "mt-4", "flex", "items-center", "space-x-4"], [1, "mt-1", "pl-10"], [1, "absolute", "right-4", "top-4", "text-sm"], ["matRipple", "", 1, "mb-4", "flex", "w-full", "items-center", "space-x-2", "rounded-3xl", "!bg-opacity-20", "px-2", "py-1", "text-left", 3, "matMenuTriggerFor", "disabled"], [1, "text-xl"], [1, "flex-1", "capitalize"], [1, "text-2xl"], [1, "w-36"], ["mat-menu-item", "", 3, "click"], ["matRipple", "", 1, "flex", "w-full", "items-center", "rounded-none", "border", "border-base-200", "bg-none", "px-2", "py-1", "text-left", 3, "matMenuTriggerFor", "disabled"], [1, "rounded", "bg-success", "px-2", "py-1", "text-xs", "text-success-content"]], template: function AssetRequestDetailsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
function AssetRequestListComponent_ng_template_23_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const row_r5 = ctx.row;
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", (row_r5.extension_data == null ? null : row_r5.extension_data.request == null ? null : row_r5.extension_data.request.items) || \u0275\u0275pureFunction0(1, _c9));
  }
}
...
function AssetRequestListComponent_ng_template_27_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r2.level(row_r7));
  }
}
...
var AssetRequestListComponent = class _AssetRequestListComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetRequestListComponent, selectors: [["app-asset-request-list"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 34, vars: 65, consts: [["user_template", ""], ["assets_template", ""], ["date_template", ""], ["level_template", ""], ["approval_template", ""], ["tracking_template", ""], ["menu", "matMenu"], ["tracking_menu", "matMenu"], [1, "relative", "flex", "h-[calc(100%-1rem)]", "w-full", "flex-col"], [1, "flex", "items-center", "justify-between"], [1, "p-4", "text-sm", "opacity-60"], [3, "dateChange", "date"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "pt-2"], ["asset-requests", "", 1, "block", "min-w-[82rem]", "text-sm", 3, "row_clicked", "data", "filter", "columns", "empty_message", "sortable"], [1, "h-20", "w-full"], [3, "requestChange", "request"], [1, "flex", "flex-col", "px-4", "py-2", "text-left"], [1, "text-xs", "opacity-30"], [1, "flex", "flex-col", "p-4"], [4, "ngFor", "ngForOf"], [1, "font-mono", "text-sm"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"], [1, "px-4", "py-2"], ["matRipple", "", 1, "flex", "w-full", "items-center", "space-x-2", "rounded-3xl", "!bg-opacity-20", "px-2", "py-1", "text-left", 3, "click", "matMenuTriggerFor", "disabled"], [1, "text-xl"], [1, "flex-1", "capitalize"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], ["matRipple", "", 1, "flex", "w-full", "items-center", "rounded", "bg-none", "px-2", "py-1", "text-left", 3, "click", "matMenuTriggerFor", "disabled"], [1, "min-w-32", "flex-1", "capitalize"]], template: function AssetRequestListComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
...
var _c015 = () => ["/book/assets", "list", "items"];
...
function AssetViewComponent_div_0_ng_template_73_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(10, _c55, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction2(12, _c192, row_r4.id, (tmp_10_0 = \u0275\u0275pipeBind1(2, 4, ctx_r1.item)) == null ? null : tmp_10_0.id))("matTooltip", \u0275\u0275pipeBind1(3, 6, "APP.CONCIERGE.ASSETS_ITEM_ASSET_EDIT"));
    \u0275\u0275advance(5);
...
function AssetViewComponent_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(114, _c015));
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(115, _c112, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction1(117, _c210, (tmp_11_0 = \u0275\u0275pipeBind1(14, 42, ctx_r1.item)) == null ? null : tmp_11_0.id));
    \u0275\u0275advance(6);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("images", ((tmp_15_0 = \u0275\u0275pipeBind1(31, 48, ctx_r1.item)) == null ? null : tmp_15_0.images) || \u0275\u0275pureFunction0(119, _c35));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", (tmp_16_0 = \u0275\u0275pipeBind1(35, 50, ctx_r1.item)) == null ? null : tmp_16_0.description)("ngIfElse", no_desc_state_r7);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(44, 56, "APP.CONCIERGE.ASSETS_ITEM_AVAILABLE", \u0275\u0275pureFunction1(120, _c45, \u0275\u0275pipeBind1(42, 52, ctx_r1.asset_list).length - ((tmp_18_0 = \u0275\u0275pipeBind1(43, 54, ctx_r1.requests)) == null ? null : tmp_18_0.length) || 0)), " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(49, 61, "APP.CONCIERGE.ASSETS_ITEM_IN_USE", \u0275\u0275pureFunction1(122, _c45, ((tmp_19_0 = \u0275\u0275pipeBind1(48, 59, ctx_r1.requests)) == null ? null : tmp_19_0.length) || 0)), " ");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(124, _c55, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction1(126, _c64, (tmp_24_0 = \u0275\u0275pipeBind1(61, 72, ctx_r1.item)) == null ? null : tmp_24_0.id));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(63, 74, "APP.CONCIERGE.ASSETS_ITEM_ASSET_ADD"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(128, _c73, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction1(130, _c64, (tmp_27_0 = \u0275\u0275pipeBind1(65, 76, ctx_r1.item)) == null ? null : tmp_27_0.id));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(67, 78, "APP.CONCIERGE.ASSETS_ITEM_ASSET_BULK_ADD"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx_r1.asset_list)("columns", \u0275\u0275pureFunction4(140, _c122, \u0275\u0275pureFunction1(132, _c83, \u0275\u0275pipeBind1(69, 80, "APP.CONCIERGE.ASSETS_ITEM_ASSET_ID")), \u0275\u0275pureFunction1(134, _c92, \u0275\u0275pipeBind1(70, 82, "APP.CONCIERGE.ASSETS_ITEM_ASSET_NAME")), \u0275\u0275pureFunction1(136, _c10, \u0275\u0275pipeBind1(71, 84, "APP.CONCIERGE.ASSETS_ITEM_ASSET_SERIAL")), \u0275\u0275pureFunction1(138, _c11, action_template_r8)))("empty_message", \u0275\u0275pipeBind1(72, 86, "APP.CONCIERGE.ASSETS_ITEM_ASSET_EMPTY"))("sortable", true);
    \u0275\u0275advance(7);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(145, _c132, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction1(147, _c64, (tmp_39_0 = \u0275\u0275pipeBind1(93, 98, ctx_r1.item)) == null ? null : tmp_39_0.id));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(95, 100, "APP.CONCIERGE.ASSETS_PURCHASE_ADD"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("data", (tmp_41_0 = \u0275\u0275pipeBind1(97, 102, ctx_r1.item)) == null ? null : tmp_41_0.purchase_orders)("columns", \u0275\u0275pureFunction5(161, _c182, \u0275\u0275pureFunction1(149, _c142, \u0275\u0275pipeBind1(98, 104, "APP.CONCIERGE.ASSETS_PURCHASE_NUMBER")), \u0275\u0275pureFunction1(151, _c152, \u0275\u0275pipeBind1(99, 106, "APP.CONCIERGE.ASSETS_PURCHASE_INVOICE")), \u0275\u0275pureFunction2(153, _c162, \u0275\u0275pipeBind1(100, 108, "APP.CONCIERGE.ASSETS_PURCHASE_START"), date_template_r10), \u0275\u0275pureFunction2(156, _c172, \u0275\u0275pipeBind1(101, 110, "APP.CONCIERGE.ASSETS_PURCHASE_END"), date_template_r10), \u0275\u0275pureFunction1(159, _c11, po_action_template_r9)))("empty_message", \u0275\u0275pipeBind1(102, 112, "APP.CONCIERGE.ASSETS_ITEM_PURCHASES_EMPTY"))("sortable", true);
  }
}
...
var AssetViewComponent = class _AssetViewComponent extends AsyncHandler {
  ...
  static {
    ...
    }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 8, vars: 4, consts: [["loading_state", ""], ["date_template", ""], ["delete_tooltip", ""], ["no_desc_state", ""], ["action_template", ""], ["po_action_template", ""], ["delete_loading", ""], ["class", "flex h-full w-full flex-col", 4, "ngIf", "ngIfElse"], [1, "flex", "h-full", "w-full", "flex-col"], [1, "flex", "w-full", "space-x-2", "bg-base-100", "pb-4", "pl-4", "pr-8", "pt-8"], ["icon", "", "matRipple", "", 3, "routerLink"], [1, "flex", "flex-col"], [1, "text-2xl", "font-medium"], [1, "flex-1"], ["btn", "", "matRipple", "", 1, "h-12", "w-32", 3, "routerLink", "queryParams"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl"], [1, "pr-2"], ["btn", "", "matRipple", "", "customTooltip", "", 1, "h-12", "w-32", "border-error", "bg-base-100", "text-error", 3, "content"], [1, "mb-4", "flex", "items-center", "space-x-4", "px-8"], [1, "h-64", "w-[24rem]", "flex-1", "overflow-hidden", "rounded-xl", "bg-base-200"], [3, "images"], [1, "flex", "h-64", "w-1/2", "flex-1", "flex-col", "space-y-4", "rounded-lg", "border", "border-base-300", "p-4"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto"], [4, "ngIf", "ngIfElse"], [1, "w-full", "divide-y", "divide-base-200", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "h-16", "items-center", "justify-between", "p-2"], [1, "pl-2"], ["btn", "", "matRipple", "", 3, "click", "disabled"], [1, "h-px", "flex-1"], [3, "label"], [1, "mx-auto", "max-w-[768px]", "px-8", "py-4"], [1, "mb-2", "flex", "w-full", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "routerLink", "queryParams"], [1, "block", "min-w-[40rem]", "text-sm", 3, "data", "columns", "empty_message", "sortable"], [1, "p-2"], ["data-table", "", 1, "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "justify-between", "p-2", "even:bg-base-200"], [1, "w-32", "flex-1", "text-sm", "font-medium"], ["btn", "", "matRipple", "", 1, "mb-2", 3, "routerLink", "queryParams"], ["asset-purchases", "", 1, "block", "min-w-[40rem]", "text-sm", 3, "data", "columns", "empty_message", "sortable"], [1, "opacity-30"], [1, "flex", "w-full", "items-center", "justify-end", "p-2"], ["icon", "", "matRipple", "", 3, "routerLink", "queryParams", "matTooltip"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 3, "routerLink", "queryParams"], [1, "text-lg"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center"], [3, "diameter"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], ["class", "my-2 w-[18rem] rounded bg-base-100 p-4 text-center", 4, "ngIf", "ngIfElse"], [1, "my-2", "w-[18rem]", "rounded", "bg-base-100", "p-4", "text-center"], [1, "mt-6", "flex", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "inverse", "w-24", "flex-1", 3, "click"], ["btn", "", "matRipple", "", 1, "error", "w-24", "flex-1", 3, "click"], [1, "l", "my-2", "flex", "h-36", "w-64", "flex-col", "items-center", "justify-center", "space-y-2", "rounded", "bg-base-100", "p-4"]], template: function AssetViewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetViewComponent, { className: "AssetViewComponent", filePath: "apps/concierge/src/app/asset-manager/asset-view.component.ts", lineNumber: 468 });
})();
...
//# sourceMappingURL=asset-manager.module-6DQ4AHZJ.js.map
