...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportsMenuComponent, { className: "ReportsMenuComponent", filePath: "apps/concierge/src/app/reports/reports-menu.component.ts", lineNumber: 105 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportsComponent, { className: "ReportsComponent", filePath: "apps/concierge/src/app/reports/reports.component.ts", lineNumber: 37 });
})();

// apps/concierge/src/app/reports/reports-options.component.ts
function ReportsOptionsComponent_mat_option_4_div_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ReportsOptionsComponent_mat_option_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 13)(1, "div", 14);
    \u0275\u0275template(2, ReportsOptionsComponent_mat_option_4_div_2_Template, 5, 3, "div", 15);
...
function ReportsOptionsComponent_mat_spinner_12_Template(rf, ctx) {
  if (rf & 1) {
...
function ReportsOptionsComponent_p_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
var ReportsOptionsComponent = class _ReportsOptionsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function ReportsOptionsComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportsOptionsComponent, selectors: [["reports-options"]], inputs: { loading: "loading", has_data: "has_data" }, outputs: { printing: "printing", generate: "generate", download: "download" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 23, vars: 21, consts: [["startDate", ""], ["endDate", ""], [1, "bg-base-100", "h-20", "w-full", "flex", "items-center", "space-x-2", "p-4", "z-20", "border-b", "border-base-200", "print:hidden"], ["appearance", "outline", 1, "w-60", "no-subscript"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [3, "week_start"], [3, "ngModelChange", "ngModel"], ["btn", "", "matRipple", "", 3, "click", "disabled"], [3, "diameter", 4, "ngIf"], [4, "ngIf"], [1, "flex-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "disabled", "matTooltip"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "diameter"]], template: function ReportsOptionsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(4, ReportsOptionsComponent_mat_option_4_Template, 5, 3, "mat-option", 5);
        \u0275\u0275pipe(5, "async");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(6, "date-range-field", 6)(7, "input", 7, 0);
        \u0275\u0275listener("ngModelChange", function ReportsOptionsComponent_Template_input_ngModelChange_7_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView($event ? ctx.setStartDate($event) : "");
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(9, "input", 7, 1);
        \u0275\u0275listener("ngModelChange", function ReportsOptionsComponent_Template_input_ngModelChange_9_listener($event) {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275template(12, ReportsOptionsComponent_mat_spinner_12_Template, 1, 1, "mat-spinner", 9)(13, ReportsOptionsComponent_p_13_Template, 3, 3, "p", 10);
        \u0275\u0275elementEnd();
        \u0275\u0275element(14, "div", 11);
        ...
        \u0275\u0275pipe(20, "translate");
        \u0275\u0275listener("click", function ReportsOptionsComponent_Template_button_click_19_listener() {
          \u0275\u0275restoreView(_r1);
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(5, 15, ctx.levels));
        \u0275\u0275advance(2);
        ...
        \u0275\u0275property("ngIf", !ctx.loading);
        \u0275\u0275advance(2);
        \u0275\u0275property("disabled", !ctx.has_data)("matTooltip", \u0275\u0275pipeBind1(16, 17, "APP.CONCIERGE.REPORTS_DOWNLOAD"));
        \u0275\u0275advance(4);
        \u0275\u0275property("disabled", !ctx.has_data)("matTooltip", \u0275\u0275pipeBind1(20, 19, "APP.CONCIERGE.REPORTS_PRINT"));
      }
    }, dependencies: [NgForOf, NgIf, DefaultValueAccessor, NgControlStatus, NgModel, MatFormField, MatSelect, MatOption, MatTooltip, MatProgressSpinner, MatRipple, DateRangeFieldComponent, IconComponent, AsyncPipe, BuildingPipe, TranslatePipe], styles: ["\n\nbutton[_ngcontent-%COMP%] {\n  min-width: 0;\n  padding: 0 0.85rem;\n}\nbutton[icon][disabled][_ngcontent-%COMP%] {\n  background-color: var(--n) !important;\n}\nmat-slide-toggle[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  width: 5.5em;\n  white-space: initial;\n  line-height: 1.2em;\n}\n/*# sourceMappingURL=reports-options.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportsOptionsComponent, { className: "ReportsOptionsComponent", filePath: "apps/concierge/src/app/reports/reports-options.component.ts", lineNumber: 104 });
})();
...
function ReportSpacesOverallComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesOverallComponent, selectors: [["report-spaces-overall"]], standalone: false, decls: 24, vars: 21, consts: [[1, "m-4", "p-4", "rounded", "bg-base-100", "border", "border-base-200", "flex", "justify-center", "items-center", "space-x-2"], [1, "flex", "flex-col", "items-center", "flex-1"], ["class", "m-4 p-4 rounded bg-base-100 flex justify-center items-center space-x-2", 4, "ngIf"], [1, "m-4", "p-4", "rounded", "bg-base-100", "flex", "justify-center", "items-center", "space-x-2"], [1, "flex-1", "flex", "flex-col", "items-center", "justify-center"]], template: function ReportSpacesOverallComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(21, "async");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(22, ReportSpacesOverallComponent_div_22_Template, 22, 18, "div", 2);
        \u0275\u0275pipe(23, "async");
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(23, 19, ctx.has_attendance));
      }
    }, dependencies: [NgIf, AsyncPipe, TranslatePipe], styles: ["\n\nh3[_ngcontent-%COMP%] {\n  font-weight: 500;\n}\np[_ngcontent-%COMP%]:not([simple]) {\n  font-size: 1.75rem;\n}\n/*# sourceMappingURL=report-spaces-overall.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesOverallComponent, { className: "ReportSpacesOverallComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces-overall.component.ts", lineNumber: 63 });
})();

// apps/concierge/src/app/reports/spaces/report-spaces-overall-list.component.ts
var _c03 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
var _c12 = (a0) => ({ key: "approved", name: a0 });
var _c22 = (a0) => ({ key: "count", name: a0 });
var _c32 = (a0, a1) => ({ key: "utilisation", name: a0, content: a1 });
var _c42 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
function ReportSpacesOverallListComponent_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 8);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function ReportSpacesOverallListComponent_button_6_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
...
var ReportSpacesOverallListComponent = class _ReportSpacesOverallListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesOverallListComponent, selectors: [["report-spaces-overall-list"]], inputs: { print: "print" }, standalone: false, decls: 17, vars: 34, consts: [["date_template", ""], ["percent_template", ""], [1, "w-full"], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "p-4", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ReportSpacesOverallListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "div", 4)(3, "h3", 5);
        \u0275\u0275text(4);
        \u0275\u0275pipe(5, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(6, ReportSpacesOverallListComponent_button_6_Template, 4, 3, "button", 6);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.day_list)("columns", \u0275\u0275pureFunction4(29, _c42, \u0275\u0275pureFunction2(19, _c03, \u0275\u0275pipeBind1(8, 9, "FORM.DATE"), date_template_r5), \u0275\u0275pureFunction1(22, _c12, \u0275\u0275pipeBind1(9, 11, "APP.CONCIERGE.REPORTS_APPROVED")), \u0275\u0275pureFunction1(24, _c22, \u0275\u0275pipeBind1(10, 13, "APP.CONCIERGE.REPORTS_TOTAL_REQUESTS")), \u0275\u0275pureFunction2(26, _c32, \u0275\u0275pipeBind1(11, 15, "APP.CONCIERGE.REPORTS_UTILISATION"), percent_template_r6)))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesOverallListComponent, { className: "ReportSpacesOverallListComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces-overall-list.component.ts", lineNumber: 74 });
})();

// apps/concierge/src/app/reports/spaces/report-spaces-space-listing.component.ts
var _c04 = (a0) => ({ key: "name", name: a0 });
var _c13 = (a0, a1) => ({ key: "capacity", name: a0, content: a1 });
var _c23 = (a0) => ({ key: "booking_count", name: a0 });
var _c33 = (a0) => ({ key: "utilisation", name: a0 });
var _c43 = (a0) => ({ key: "avg_attendees", name: a0 });
var _c5 = (a0, a1) => ({ key: "no_shows", name: a0, show: a1 });
var _c6 = (a0, a1) => ({ key: "min_attendance", name: a0, show: a1 });
var _c7 = (a0, a1) => ({ key: "max_attendance", name: a0, show: a1 });
var _c8 = (a0) => ({ key: "occupancy", name: a0 });
var _c9 = (a0, a1, a2, a3, a4, a5, a6, a7, a8) => [a0, a1, a2, a3, a4, a5, a6, a7, a8];
function ReportSpacesSpaceListingComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 6);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function ReportSpacesSpaceListingComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
function ReportSpacesSpaceListingComponent_ng_template_20_span_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ReportSpacesSpaceListingComponent_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275template(2, ReportSpacesSpaceListingComponent_ng_template_20_span_2_Template, 3, 3, "span", 8);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const data_r3 = ctx.data;
...
var ReportSpacesSpaceListingComponent = class _ReportSpacesSpaceListingComponent {
  ...
  static {
    this.\u0275fac = function ReportSpacesSpaceListingComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ReportSpacesSpaceListingComponent)(\u0275\u0275directiveInject(ReportsStateService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesSpaceListingComponent, selectors: [["report-spaces-space-listing"]], inputs: { print: "print" }, standalone: false, decls: 22, vars: 67, consts: [["capacity_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"]], template: function ReportSpacesSpaceListingComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, ReportSpacesSpaceListingComponent_button_5_Template, 4, 3, "button", 4);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.space_list)("columns", \u0275\u0275pureFunctionV(57, _c9, [\u0275\u0275pureFunction1(35, _c04, \u0275\u0275pipeBind1(7, 9, "FORM.NAME")), \u0275\u0275pureFunction2(37, _c13, \u0275\u0275pipeBind1(8, 11, "COMMON.CAPACITY"), capacity_template_r4), \u0275\u0275pureFunction1(40, _c23, \u0275\u0275pipeBind1(9, 13, "RESOURCE.BOOKINGS")), \u0275\u0275pureFunction1(42, _c33, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_UTILISATION")), \u0275\u0275pureFunction1(44, _c43, \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_AVG_BOOKING_INVITES")), \u0275\u0275pureFunction2(46, _c5, \u0275\u0275pipeBind1(12, 19, "APP.CONCIERGE.REPORTS_NO_SHOWS"), \u0275\u0275pipeBind1(13, 21, ctx.has_attendance)), \u0275\u0275pureFunction2(49, _c6, \u0275\u0275pipeBind1(14, 23, "APP.CONCIERGE.REPORTS_MIN_ATTENDANCE"), \u0275\u0275pipeBind1(15, 25, ctx.has_attendance)), \u0275\u0275pureFunction2(52, _c7, \u0275\u0275pipeBind1(16, 27, "APP.CONCIERGE.REPORTS_MAX_ATTENDANCE"), \u0275\u0275pipeBind1(17, 29, ctx.has_attendance)), \u0275\u0275pureFunction1(55, _c8, \u0275\u0275pipeBind1(18, 31, "APP.CONCIERGE.REPORTS_OCCUPANCY"))]))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(19, 33, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, AsyncPipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesSpaceListingComponent, { className: "ReportSpacesSpaceListingComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces-space-listing.component.ts", lineNumber: 96 });
})();
...
var _c24 = (a0) => ({ key: "avg_attendees", name: a0 });
var _c34 = (a0) => ({ key: "total_time", name: a0 });
var _c44 = (a0) => ({ key: "no_shows", name: a0 });
var _c52 = (a0, a1, a2, a3, a4) => [a0, a1, a2, a3, a4];
function ReportSpacesUserListingComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 5);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function ReportSpacesUserListingComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var ReportSpacesUserListingComponent = class _ReportSpacesUserListingComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesUserListingComponent, selectors: [["report-spaces-user-listing"]], inputs: { print: "print" }, standalone: false, decls: 13, vars: 37, consts: [[1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"]], template: function ReportSpacesUserListingComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, ReportSpacesUserListingComponent_button_5_Template, 4, 3, "button", 3);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.user_list)("columns", \u0275\u0275pureFunction5(31, _c52, \u0275\u0275pureFunction1(21, _c05, \u0275\u0275pipeBind1(7, 9, "FORM.NAME")), \u0275\u0275pureFunction1(23, _c14, \u0275\u0275pipeBind1(8, 11, "RESOURCE.BOOKINGS")), \u0275\u0275pureFunction1(25, _c24, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_AVG_BOOKING_INVITES")), \u0275\u0275pureFunction1(27, _c34, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_TOTAL_TIME")), \u0275\u0275pureFunction1(29, _c44, \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_NO_SHOWS"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 19, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesUserListingComponent, { className: "ReportSpacesUserListingComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces-user-listing.component.ts", lineNumber: 64 });
})();
...
var ReportSpacesChartsComponent = class _ReportSpacesChartsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function ReportSpacesChartsComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ReportSpacesChartsComponent)(\u0275\u0275directiveInject(ReportsStateService), \u0275\u0275directiveInject(OrganisationService), \u0275\u0275directiveInject(SettingsService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesChartsComponent, selectors: [["report-spaces-charts"]], inputs: { print: "print" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 11, vars: 8, consts: [[1, "flex", "items-center", "space-x-4", "w-full", "px-4", 3, "resize"], [1, "bg-base-100", "border", "border-base-200", "rounded", "flex-1", "h-[18rem]"], [1, "border-b", "border-base-200", "p-4", "text-xl", "font-bold"], ["id", "daily-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-full", "h-56", "mx-auto"], ["id", "level-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-[24rem]", "h-56", "mx-auto"]], template: function ReportSpacesChartsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesChartsComponent, { className: "ReportSpacesChartsComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces-charts.component.ts", lineNumber: 62 });
})();

// apps/concierge/src/app/reports/spaces/report-spaces.component.ts
var _c06 = ["report-spaces", ""];
function ReportSpacesComponent_ng_container_13_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "report-spaces-overall")(2, "report-spaces-charts", 10)(3, "report-spaces-overall-list", 10)(4, "report-spaces-space-listing", 10)(5, "report-spaces-user-listing", 10);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function ReportSpacesComponent_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ReportSpacesComponent_ng_container_13_ng_container_1_Template, 6, 4, "ng-container", 9);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    const empty_state_r3 = \u0275\u0275reference(18);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(2, 2, ctx_r1.total_count))("ngIfElse", empty_state_r3);
  }
}
function ReportSpacesComponent_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
...
function ReportSpacesComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
...
var ReportSpacesComponent = class _ReportSpacesComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function ReportSpacesComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesComponent, selectors: [["", "report-spaces", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c06, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8", "screen-only"]], template: function ReportSpacesComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(12, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(13, ReportSpacesComponent_ng_container_13_Template, 3, 4, "ng-container", 9);
        \u0275\u0275pipe(14, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(15, ReportSpacesComponent_ng_template_15_Template, 5, 4, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(17, ReportSpacesComponent_ng_template_17_Template, 4, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        let tmp_4_0;
        const load_state_r4 = \u0275\u0275reference(16);
        \u0275\u0275property("loading", \u0275\u0275pipeBind1(1, 6, ctx.loading))("has_data", \u0275\u0275pipeBind1(2, 8, ctx.total_count));
        \u0275\u0275advance(6);
        \u0275\u0275property("source", ((tmp_4_0 = \u0275\u0275pipeBind1(7, 10, ctx.logo)) == null ? null : tmp_4_0.src) || \u0275\u0275pipeBind1(8, 12, ctx.logo));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 14, "APP.CONCIERGE.REPORTS_ROOMS_HEADER"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(14, 16, ctx.loading))("ngIfElse", load_state_r4);
      }
    }, dependencies: [NgIf, MatProgressSpinner, AuthenticatedImageDirective, ReportsOptionsComponent, ReportSpacesOverallComponent, ReportSpacesOverallListComponent, ReportSpacesSpaceListingComponent, ReportSpacesUserListingComponent, ReportSpacesChartsComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=report-spaces.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesComponent, { className: "ReportSpacesComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces.component.ts", lineNumber: 82 });
})();

// apps/concierge/src/app/reports/desks/report-desks-overall-list.component.ts
var _c07 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
var _c15 = (a0) => ({ key: "approved", name: a0 });
var _c25 = (a0) => ({ key: "count", name: a0 });
var _c35 = (a0, a1) => ({ key: "utilisation", name: a0, content: a1 });
var _c45 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
function ReportDesksOverallListComponent_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 8);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function ReportDesksOverallListComponent_button_6_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var ReportDesksOverallListComponent = class _ReportDesksOverallListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksOverallListComponent, selectors: [["report-desks-overall-list"]], inputs: { print: "print" }, standalone: false, decls: 17, vars: 34, consts: [["date_template", ""], ["percent_template", ""], [1, "pb-2", "w-full"], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "p-4", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "page_size", "sortable", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ReportDesksOverallListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "div", 4)(3, "h3", 5);
        \u0275\u0275text(4);
        \u0275\u0275pipe(5, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(6, ReportDesksOverallListComponent_button_6_Template, 4, 3, "button", 6);
        \u0275\u0275elementEnd();
        \u0275\u0275element(7, "simple-table", 7);
        \u0275\u0275pipe(8, "translate");
        \u0275\u0275pipe(9, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.day_list)("columns", \u0275\u0275pureFunction4(29, _c45, \u0275\u0275pureFunction2(19, _c07, \u0275\u0275pipeBind1(8, 9, "FORM.DATE"), date_template_r5), \u0275\u0275pureFunction1(22, _c15, \u0275\u0275pipeBind1(9, 11, "APP.CONCIERGE.REPORTS_APPROVED")), \u0275\u0275pureFunction1(24, _c25, \u0275\u0275pipeBind1(10, 13, "APP.CONCIERGE.REPORTS_TOTAL_REQUESTS")), \u0275\u0275pureFunction2(26, _c35, \u0275\u0275pipeBind1(11, 15, "APP.CONCIERGE.REPORTS_UTILISATION"), percent_template_r6)))("page_size", ctx.print ? 0 : 10)("sortable", true)("empty_message", \u0275\u0275pipeBind1(12, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportDesksOverallListComponent, { className: "ReportDesksOverallListComponent", filePath: "apps/concierge/src/app/reports/desks/report-desks-overall-list.component.ts", lineNumber: 75 });
})();

// apps/concierge/src/app/reports/desks/report-desks-level-list.component.ts
var _c08 = (a0) => ({ key: "name", name: a0 });
var _c16 = (a0) => ({ key: "avg_usage", name: a0 });
var _c26 = (a0) => ({ key: "approved", name: a0 });
var _c36 = (a0) => ({ key: "count", name: a0 });
var _c46 = (a0, a1) => ({ key: "utilisation", name: a0, content: a1 });
var _c53 = (a0, a1, a2, a3, a4) => [a0, a1, a2, a3, a4];
function ReportDesksLevelListComponent_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 7);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function ReportDesksLevelListComponent_button_6_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var ReportDesksLevelListComponent = class _ReportDesksLevelListComponent {
  constructor(_state, _org, _settings) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield this.level_list.pipe(take(1)).toPromise();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksLevelListComponent, selectors: [["report-desks-levels-list"]], inputs: { print: "print" }, standalone: false, decls: 16, vars: 38, consts: [["percent_view", ""], [1, "px-4", "pb-2", "w-full"], [1, "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden", "w-full"], [1, "border-b", "border-base-200", "p-4", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "page_size", "sortable", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ReportDesksLevelListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "div", 3)(3, "h3", 4);
        \u0275\u0275text(4);
        \u0275\u0275pipe(5, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(6, ReportDesksLevelListComponent_button_6_Template, 4, 3, "button", 5);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.level_list)("columns", \u0275\u0275pureFunction5(32, _c53, \u0275\u0275pureFunction1(21, _c08, \u0275\u0275pipeBind1(8, 9, "RESOURCE.LEVEL")), \u0275\u0275pureFunction1(23, _c16, \u0275\u0275pipeBind1(9, 11, "APP.CONCIERGE.REPORTS_AVG_DESKS")), \u0275\u0275pureFunction1(25, _c26, \u0275\u0275pipeBind1(10, 13, "APP.CONCIERGE.REPORTS_APPROVED")), \u0275\u0275pureFunction1(27, _c36, \u0275\u0275pipeBind1(11, 15, "APP.CONCIERGE.REPORTS_TOTAL_REQUESTS")), \u0275\u0275pureFunction2(29, _c46, \u0275\u0275pipeBind1(12, 17, "APP.CONCIERGE.REPORTS_UTILISATION"), percent_view_r4)))("page_size", ctx.print ? 0 : 10)("sortable", true)("empty_message", \u0275\u0275pipeBind1(13, 19, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportDesksLevelListComponent, { className: "ReportDesksLevelListComponent", filePath: "apps/concierge/src/app/reports/desks/report-desks-level-list.component.ts", lineNumber: 77 });
})();
...
var ReportDesksChartsComponent = class _ReportDesksChartsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksChartsComponent, selectors: [["report-desks-charts"]], inputs: { print: "print" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 11, vars: 8, consts: [[1, "flex", "items-center", "space-x-4", "w-full", "px-4", 3, "resize"], [1, "bg-base-100", "border", "border-base-200", "rounded", "flex-1", "h-[18rem]"], [1, "border-b", "border-base-200", "p-4", "text-xl", "font-bold"], ["id", "daily-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-full", "h-56", "mx-auto"], ["id", "level-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-[24rem]", "h-56", "mx-auto"]], template: function ReportDesksChartsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportDesksChartsComponent, { className: "ReportDesksChartsComponent", filePath: "apps/concierge/src/app/reports/desks/report-desks-charts.component.ts", lineNumber: 62 });
})();

// apps/concierge/src/app/reports/desks/report-desks.component.ts
var _c09 = ["report-desks", ""];
function ReportDesksComponent_ng_container_13_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    ...
    \u0275\u0275pipe(15, "async");
    \u0275\u0275elementEnd()()();
    \u0275\u0275element(16, "report-desks-charts", 12)(17, "report-desks-overall-list", 12)(18, "report-desks-levels-list", 12);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 7, "APP.CONCIERGE.REPORTS_TOTAL_BOOKINGS"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 9, ctx_r1.total_count) || 0);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 11, "APP.CONCIERGE.REPORTS_UTILISATION"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(15, 13, ctx_r1.utilisation) || 0, "%");
    \u0275\u0275advance(2);
    \u0275\u0275property("print", ctx_r1.printing);
    \u0275\u0275advance();
    \u0275\u0275property("print", ctx_r1.printing);
...
function ReportDesksComponent_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ReportDesksComponent_ng_container_13_ng_container_1_Template, 19, 15, "ng-container", 9);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function ReportDesksComponent_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
...
function ReportDesksComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksComponent, selectors: [["", "report-desks", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c09, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [1, "m-4", "p-4", "rounded", "bg-base-100", "border", "border-base-200", "flex", "justify-center", "items-center", "space-x-2"], [1, "flex", "flex-col", "items-center", "flex-1"], [3, "print"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8", "screen-only"]], template: function ReportDesksComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(12, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(13, ReportDesksComponent_ng_container_13_Template, 3, 4, "ng-container", 9);
        \u0275\u0275pipe(14, "async");
        \u0275\u0275template(15, ReportDesksComponent_ng_template_15_Template, 5, 4, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(17, ReportDesksComponent_ng_template_17_Template, 4, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_4_0;
        ...
        \u0275\u0275property("source", ((tmp_4_0 = \u0275\u0275pipeBind1(7, 10, ctx.logo)) == null ? null : tmp_4_0.src) || \u0275\u0275pipeBind1(8, 12, ctx.logo));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 14, "APP.CONCIERGE.REPORTS_DESKS_HEADER"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(14, 16, ctx.loading))("ngIfElse", load_state_r4);
      }
    }, dependencies: [NgIf, MatProgressSpinner, AuthenticatedImageDirective, ReportsOptionsComponent, ReportDesksOverallListComponent, ReportDesksLevelListComponent, ReportDesksChartsComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\nh3[_ngcontent-%COMP%] {\n  font-weight: 500;\n}\n/*# sourceMappingURL=report-desks.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportDesksComponent, { className: "ReportDesksComponent", filePath: "apps/concierge/src/app/reports/desks/report-desks.component.ts", lineNumber: 104 });
})();
...
var CateringReportOverallComponent = class _CateringReportOverallComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportOverallComponent, selectors: [["catering-report-overall"]], standalone: false, decls: 37, vars: 36, consts: [["item", "", 1, "flex", "flex-col", "flex-1", "items-center", "justify-center"], ["count", "", 1, "text-3xl"], [1, "print:text-sm"], ["unique", "", 1, "text-3xl"], ["items", "", 1, "text-3xl"], ["total", "", 1, "text-3xl"], ["average", "", 1, "text-3xl"]], template: function CateringReportOverallComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1);
        \u0275\u0275text(2);
        \u0275\u0275pipe(3, "async");
    ...
    }, dependencies: [AsyncPipe, CurrencyPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n  justify-content: center;\n  padding: 0.5rem;\n  max-width: 64rem;\n  margin: 0 auto;\n}\n[item][_ngcontent-%COMP%] {\n  border: 1px solid var(--b2);\n  border-radius: 0.5rem;\n  padding: 1rem;\n  margin: 0.5rem;\n  height: 6rem;\n  width: 12rem;\n  min-width: 7rem;\n}\n/*# sourceMappingURL=catering-report-overall.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringReportOverallComponent, { className: "CateringReportOverallComponent", filePath: "apps/concierge/src/app/reports/catering/catering-report-overall.component.ts", lineNumber: 76 });
})();

// apps/concierge/src/app/reports/catering/catering-report-orders.component.ts
var _c010 = (a0, a1) => ({ key: "deliver_at", name: a0, content: a1 });
...
var CateringReportOrdersComponent = class _CateringReportOrdersComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportOrdersComponent, selectors: [["catering-report-orders"]], inputs: { print: "print" }, standalone: false, decls: 18, vars: 31, consts: [["date_template", ""], ["cost_template", ""], [1, "w-[64rem]", "max-w-[calc(100%-2rem)]", "rounded", "overflow-hidden", "bg-base-100", "border", "border-base-200", "mx-auto", "my-2"], [1, "border-b", "border-base-200", "flex", "items-center", "justify-between", "px-4"], [1, "py-2", "text-xl", "font-medium"], ["matRipple-icon", "", 1, "print:hidden", 3, "click", "matTooltip"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], [1, "p-4"]], template: function CateringReportOrdersComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(4);
        \u0275\u0275property("data", ctx.orders)("columns", \u0275\u0275pureFunction3(27, _c37, \u0275\u0275pureFunction2(19, _c010, \u0275\u0275pipeBind1(10, 11, "APP.CONCIERGE.ASSETS_REQUESTS_TIME"), date_template_r5), \u0275\u0275pureFunction1(22, _c17, \u0275\u0275pipeBind1(11, 13, "APP.CONCIERGE.REPORTS_CATERING_ITEMS")), \u0275\u0275pureFunction2(24, _c27, \u0275\u0275pipeBind1(12, 15, "CATERING.TOTAL_COST"), cost_template_r6)))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(13, 17, "APP.CONCIERGE.REPORTS_CATERING_ORDERS_EMPTY"));
      }
    }, dependencies: [MatTooltip, IconComponent, SimpleTableComponent, CurrencyPipe, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringReportOrdersComponent, { className: "CateringReportOrdersComponent", filePath: "apps/concierge/src/app/reports/catering/catering-report-orders.component.ts", lineNumber: 74 });
})();

// apps/concierge/src/app/reports/catering/catering-report-items.component.ts
var _c011 = (a0) => ({ key: "name", name: a0 });
var _c18 = (a0, a1) => ({ key: "options", name: a0, content: a1 });
var _c28 = (a0) => ({ key: "caterer", name: a0 });
var _c38 = (a0) => ({ key: "quantity", name: a0 });
var _c47 = (a0, a1) => ({ key: "unit_price", name: a0, content: a1 });
var _c54 = (a0, a1) => ({ key: "total_cost", name: a0, content: a1 });
var _c62 = (a0, a1, a2, a3, a4, a5) => [a0, a1, a2, a3, a4, a5];
var _c72 = (a0) => ({ count: a0 });
function CateringReportItemsComponent_ng_template_13_span_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 2, "APP.CONCIERGE.REPORTS_CATERING_OPTIONS", \u0275\u0275pureFunction1(5, _c72, (data_r1 == null ? null : data_r1.length) || 0)), " ");
  }
}
function CateringReportItemsComponent_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6);
    \u0275\u0275template(1, CateringReportItemsComponent_ng_template_13_span_1_Template, 3, 7, "span", 7);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var CateringReportItemsComponent = class _CateringReportItemsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportItemsComponent, selectors: [["catering-report-items"]], inputs: { print: "print" }, standalone: false, decls: 17, vars: 44, consts: [["option_template", ""], ["cost_template", ""], [1, "w-[64rem]", "max-w-[calc(100%-2rem)]", "rounded", "overflow-hidden", "bg-base-100", "border", "border-base-200", "mx-auto", "my-2"], [1, "border-b", "border-base-200", "flex", "items-center", "justify-between", "px-4"], [1, "py-2", "text-xl", "font-medium"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "page_size", "empty_message", "sortable"], [1, "p-4"], ["class", "text-xs px-2 py-1 rounded bg-base-200", 3, "matTooltip", 4, "ngIf"], [1, "text-xs", "px-2", "py-1", "rounded", "bg-base-200", 3, "matTooltip"]], template: function CateringReportItemsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "h2", 4);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("data", ctx.items)("columns", \u0275\u0275pureFunction6(37, _c62, \u0275\u0275pureFunction1(22, _c011, \u0275\u0275pipeBind1(6, 8, "FORM.NAME")), \u0275\u0275pureFunction2(24, _c18, \u0275\u0275pipeBind1(7, 10, "APP.CONCIERGE.REPORTS_CATERING_OPTIONS"), option_template_r4), \u0275\u0275pureFunction1(27, _c28, \u0275\u0275pipeBind1(8, 12, "CATERING.CATERER")), \u0275\u0275pureFunction1(29, _c38, \u0275\u0275pipeBind1(9, 14, "CATERING.QUANTITY")), \u0275\u0275pureFunction2(31, _c47, \u0275\u0275pipeBind1(10, 16, "COMMON.ITEM_PRICE"), cost_template_r5), \u0275\u0275pureFunction2(34, _c54, \u0275\u0275pipeBind1(11, 18, "CATERING.TOTAL_COST"), cost_template_r5)))("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 20, "APP.CONCIERGE.REPORTS_CATERING_ORDERS_EMPTY"))("sortable", true);
      }
    }, dependencies: [NgIf, MatTooltip, SimpleTableComponent, CurrencyPipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringReportItemsComponent, { className: "CateringReportItemsComponent", filePath: "apps/concierge/src/app/reports/catering/catering-report-items.component.ts", lineNumber: 81 });
})();

// apps/concierge/src/app/reports/catering/catering-report.component.ts
function CateringReportComponent_ng_container_13_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
...
function CateringReportComponent_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, CateringReportComponent_ng_container_13_ng_container_1_Template, 4, 2, "ng-container", 9);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function CateringReportComponent_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275element(1, "mat-spinner", 12);
    \u0275\u0275elementStart(2, "p", 13);
...
function CateringReportComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "p", 13);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportComponent, selectors: [["catering-report"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200", "overflow-hidden"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8", "screen-only"]], template: function CateringReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(12, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(13, CateringReportComponent_ng_container_13_Template, 3, 4, "ng-container", 9);
        \u0275\u0275pipe(14, "async");
        \u0275\u0275template(15, CateringReportComponent_ng_template_15_Template, 5, 4, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(17, CateringReportComponent_ng_template_17_Template, 4, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_4_0;
        ...
        \u0275\u0275property("source", ((tmp_4_0 = \u0275\u0275pipeBind1(7, 10, ctx.logo)) == null ? null : tmp_4_0.src) || \u0275\u0275pipeBind1(8, 12, ctx.logo));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 14, "APP.CONCIERGE.REPORTS_CATERING_HEADER"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(14, 16, ctx.loading))("ngIfElse", load_state_r4);
      }
    }, dependencies: [NgIf, MatProgressSpinner, AuthenticatedImageDirective, ReportsOptionsComponent, CateringReportOverallComponent, CateringReportOrdersComponent, CateringReportItemsComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=catering-report.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringReportComponent, { className: "CateringReportComponent", filePath: "apps/concierge/src/app/reports/catering/catering-report.component.ts", lineNumber: 79 });
})();
...
var GetUserPipe = class _GetUserPipe {
  ...
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({ name: "user", type: _GetUserPipe, pure: true, standalone: false });
  }
};
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContactTracingOptionsComponent, { className: "ContactTracingOptionsComponent", filePath: "apps/concierge/src/app/reports/contact-tracing/contact-tracing-options.component.ts", lineNumber: 67 });
})();

// apps/concierge/src/app/reports/contact-tracing/contact-tracing-report.component.ts
var _c012 = (a0) => ({ key: "date", name: "Time of Contact", content: a0 });
var _c19 = (a0) => ({ key: "user_id", name: "Person", content: a0 });
var _c29 = (a0) => ({ key: "contact_id", name: "Close Contact", content: a0 });
var _c39 = (a0) => ({ key: "duration", name: "Duration", content: a0 });
var _c48 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
function ContactTracingReportComponent_ng_container_11_ng_container_1_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
...
function ContactTracingReportComponent_ng_container_11_ng_container_1_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function ContactTracingReportComponent_ng_container_11_ng_container_1_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ContactTracingReportComponent_ng_container_11_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    ...
    \u0275\u0275template(6, ContactTracingReportComponent_ng_container_11_ng_container_1_ng_template_6_Template, 4, 5, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(8, ContactTracingReportComponent_ng_container_11_ng_container_1_ng_template_8_Template, 4, 8, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(10, ContactTracingReportComponent_ng_container_11_ng_container_1_ng_template_10_Template, 2, 1, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("data", ctx_r4.tracing_events)("columns", \u0275\u0275pureFunction4(12, _c48, \u0275\u0275pureFunction1(4, _c012, date_template_r8), \u0275\u0275pureFunction1(6, _c19, user_template_r7), \u0275\u0275pureFunction1(8, _c29, user_template_r7), \u0275\u0275pureFunction1(10, _c39, duration_template_r9)))("sortable", true)("page_size", ctx_r4.print ? 0 : 30);
  }
}
function ContactTracingReportComponent_ng_container_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ContactTracingReportComponent_ng_container_11_ng_container_1_Template, 12, 17, "ng-container", 12);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    const empty_state_r10 = \u0275\u0275reference(16);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_3_0 = \u0275\u0275pipeBind1(2, 2, ctx_r4.options)) == null ? null : tmp_3_0.user)("ngIfElse", empty_state_r10);
  }
}
function ContactTracingReportComponent_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
...
function ContactTracingReportComponent_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactTracingReportComponent, selectors: [["app-contact-tracing-report"]], standalone: false, decls: 17, vars: 12, consts: [["load_state", ""], ["empty_state", ""], ["user_template", ""], ["date_template", ""], ["duration_template", ""], [1, "print:hidden", 3, "printing", "download"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200", "overflow-hidden"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [1, "w-[64rem]", "max-w-[calc(100%-2rem)]", "mx-auto", "my-2", "rounded-lg", "border", "border-base-200"], [1, "border-b", "border-base-200", "flex", "items-center", "justify-between", "px-4"], [1, "py-2", "text-xl", "font-medium"], ["empty_message", "No contact tracing events for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], [1, "p-4"], [1, "p-8", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], ["diameter", "32"], [1, "opacity-30"], [1, "p-8", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "screen-only"]], template: function ContactTracingReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(10, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(11, ContactTracingReportComponent_ng_container_11_Template, 3, 4, "ng-container", 12);
        \u0275\u0275pipe(12, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(13, ContactTracingReportComponent_ng_template_13_Template, 5, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(15, ContactTracingReportComponent_ng_template_15_Template, 3, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        let tmp_2_0;
        const load_state_r11 = \u0275\u0275reference(14);
        \u0275\u0275advance(4);
        \u0275\u0275property("source", ((tmp_2_0 = \u0275\u0275pipeBind1(5, 4, ctx.logo)) == null ? null : tmp_2_0.src) || \u0275\u0275pipeBind1(6, 6, ctx.logo));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 8, "APP.CONCIERGE.REPORTS_CONTACTS_HEADER"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(12, 10, ctx.loading))("ngIfElse", load_state_r11);
      }
    }, dependencies: [NgIf, SimpleTableComponent, AuthenticatedImageDirective, ContactTracingOptionsComponent, AsyncPipe, DatePipe, TranslatePipe, GetUserPipe], styles: ["\n\n[_nghost-%COMP%] {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n}\n/*# sourceMappingURL=contact-tracing-report.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContactTracingReportComponent, { className: "ContactTracingReportComponent", filePath: "apps/concierge/src/app/reports/contact-tracing/contact-tracing-report.component.ts", lineNumber: 135 });
})();
...
var CustomReportComponent = class _CustomReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CustomReportComponent, selectors: [["custom-report"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [["class", "w-full h-full", 3, "src", 4, "ngIf"], [1, "w-full", "h-full", 3, "src"]], template: function CustomReportComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CustomReportComponent, { className: "CustomReportComponent", filePath: "apps/concierge/src/app/reports/custom-report.component.ts", lineNumber: 26 });
})();

// apps/concierge/src/app/reports/new-reports.component.ts
var _c013 = ["app-new-reports", ""];
function NewReportsComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 4);
  }
}
var NewReportsComponent = class _NewReportsComponent {
  get path() {
    const parts = this._router.url.split("/");
    return parts[parts.length - 1];
  }
  ...
  static {
    this.\u0275fac = function NewReportsComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NewReportsComponent)(\u0275\u0275directiveInject(Router));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewReportsComponent, selectors: [["", "app-new-reports", ""]], standalone: false, attrs: _c013, decls: 6, vars: 1, consts: [[1, "screen-only"], [1, "flex", "flex-1", "h-px"], [1, "flex", "flex-col", "flex-1", "w-1/2", "h-full", "relative"], ["reports-menu", "", "class", "absolute inset-0 screen-only", 4, "ngIf"], ["reports-menu", "", 1, "absolute", "inset-0", "screen-only"]], template: function NewReportsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewReportsComponent, { className: "NewReportsComponent", filePath: "apps/concierge/src/app/reports/new-reports.component.ts", lineNumber: 40 });
})();
...
var AssetReportOverallComponent = class _AssetReportOverallComponent {
  ...
  static {
    ...
    }, dependencies: [AsyncPipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetReportOverallComponent, { className: "AssetReportOverallComponent", filePath: "apps/concierge/src/app/reports/assets/asset-report-overall.component.ts", lineNumber: 36 });
})();

// apps/concierge/src/app/reports/assets/asset-report-daily-usage.component.ts
var _c014 = (a0) => ({ key: "name", name: a0 });
var _c110 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
var _c210 = (a0) => ({ key: "booking_count", name: a0 });
var _c310 = (a0) => ({ key: "booked_count", name: a0 });
var _c49 = (a0) => ({ key: "asset_count", name: a0 });
var _c55 = (a0, a1, a2, a3, a4) => [a0, a1, a2, a3, a4];
function AssetReportDailyUsageComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 6);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function AssetReportDailyUsageComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var AssetReportDailyUsageComponent = class _AssetReportDailyUsageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportDailyUsageComponent, selectors: [["asset-report-daily-usage"]], inputs: { print: "print" }, standalone: false, decls: 15, vars: 38, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function AssetReportDailyUsageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, AssetReportDailyUsageComponent_button_5_Template, 4, 3, "button", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275element(6, "simple-table", 5);
        \u0275\u0275pipe(7, "translate");
        \u0275\u0275pipe(8, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.daily_products)("columns", \u0275\u0275pureFunction5(32, _c55, \u0275\u0275pureFunction1(21, _c014, \u0275\u0275pipeBind1(7, 9, "FORM.NAME")), \u0275\u0275pureFunction2(23, _c110, \u0275\u0275pipeBind1(8, 11, "FORM.DATE"), date_template_r4), \u0275\u0275pureFunction1(26, _c210, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_BOOKING_COUNT_HEADER")), \u0275\u0275pureFunction1(28, _c310, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_TOTAL_BOOKED")), \u0275\u0275pureFunction1(30, _c49, \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_ASSETS_AVAILABLE"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 19, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetReportDailyUsageComponent, { className: "AssetReportDailyUsageComponent", filePath: "apps/concierge/src/app/reports/assets/asset-report-daily-usage.component.ts", lineNumber: 72 });
})();

// apps/concierge/src/app/reports/assets/asset-report-product-usage.component.ts
var _c015 = (a0) => ({ key: "name", name: a0 });
var _c111 = (a0) => ({ key: "booking_count", name: a0 });
var _c211 = (a0) => ({ key: "booked_count", name: a0 });
var _c311 = (a0) => ({ key: "asset_count", name: a0 });
var _c410 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
function AssetReportProductUsageComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 5);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function AssetReportProductUsageComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var AssetReportProductUsageComponent = class _AssetReportProductUsageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportProductUsageComponent, selectors: [["asset-report-product-usage"]], inputs: { print: "print" }, standalone: false, decls: 12, vars: 32, consts: [[1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"]], template: function AssetReportProductUsageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, AssetReportProductUsageComponent_button_5_Template, 4, 3, "button", 3);
        \u0275\u0275elementEnd();
        \u0275\u0275element(6, "simple-table", 4);
        \u0275\u0275pipe(7, "translate");
        \u0275\u0275pipe(8, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.products)("columns", \u0275\u0275pureFunction4(27, _c410, \u0275\u0275pureFunction1(19, _c015, \u0275\u0275pipeBind1(7, 9, "FORM.NAME")), \u0275\u0275pureFunction1(21, _c111, \u0275\u0275pipeBind1(8, 11, "RESOURCE.BOOKINGS")), \u0275\u0275pureFunction1(23, _c211, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_ASSETS_BOOKED")), \u0275\u0275pureFunction1(25, _c311, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_ASSETS_AVAILABLE"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetReportProductUsageComponent, { className: "AssetReportProductUsageComponent", filePath: "apps/concierge/src/app/reports/assets/asset-report-product-usage.component.ts", lineNumber: 62 });
})();

// apps/concierge/src/app/reports/assets/asset-report-users.component.ts
var _c016 = (a0) => ({ key: "name", name: a0 });
var _c112 = (a0) => ({ key: "booking_count", name: a0 });
var _c212 = (a0) => ({ key: "asset_count", name: a0 });
var _c312 = (a0) => ({ key: "asset_types", name: a0 });
var _c411 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
function AssetReportUsersComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 5);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function AssetReportUsersComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var AssetReportUsersComponent = class _AssetReportUsersComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportUsersComponent, selectors: [["asset-report-users"]], inputs: { print: "print" }, standalone: false, decls: 12, vars: 32, consts: [[1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"]], template: function AssetReportUsersComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, AssetReportUsersComponent_button_5_Template, 4, 3, "button", 3);
        \u0275\u0275elementEnd();
        \u0275\u0275element(6, "simple-table", 4);
        \u0275\u0275pipe(7, "translate");
        \u0275\u0275pipe(8, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.users)("columns", \u0275\u0275pureFunction4(27, _c411, \u0275\u0275pureFunction1(19, _c016, \u0275\u0275pipeBind1(7, 9, "FORM.NAME")), \u0275\u0275pureFunction1(21, _c112, \u0275\u0275pipeBind1(8, 11, "RESOURCE.BOOKINGS")), \u0275\u0275pureFunction1(23, _c212, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_ASSETS_BOOKED")), \u0275\u0275pureFunction1(25, _c312, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_ASSETS_TYPES"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetReportUsersComponent, { className: "AssetReportUsersComponent", filePath: "apps/concierge/src/app/reports/assets/asset-report-users.component.ts", lineNumber: 57 });
})();

// apps/concierge/src/app/reports/assets/asset-report-expired-items.component.ts
var _c017 = (a0) => ({ key: "purchase_order_number", name: a0 });
var _c113 = (a0) => ({ key: "invoice_number", name: a0 });
var _c213 = (a0, a1) => ({ key: "purchase_date", name: a0, content: a1 });
var _c313 = (a0, a1) => ({ key: "expected_service_start_date", name: a0, content: a1 });
var _c412 = (a0, a1) => ({ key: "expected_service_end_date", name: a0, content: a1 });
var _c56 = (a0, a1, a2, a3, a4) => [a0, a1, a2, a3, a4];
function AssetReportExpiredItemsComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 6);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function AssetReportExpiredItemsComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
function AssetReportExpiredItemsComponent_ng_template_13_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 9);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function AssetReportExpiredItemsComponent_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7);
    \u0275\u0275template(1, AssetReportExpiredItemsComponent_ng_template_13_span_1_Template, 3, 3, "span", 8);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "date");
    \u0275\u0275elementEnd();
  }
...
var AssetReportExpiredItemsComponent = class _AssetReportExpiredItemsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportExpiredItemsComponent, selectors: [["asset-report-expired-items"]], inputs: { print: "print" }, standalone: false, decls: 15, vars: 40, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"]], template: function AssetReportExpiredItemsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, AssetReportExpiredItemsComponent_button_5_Template, 4, 3, "button", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275element(6, "simple-table", 5);
        \u0275\u0275pipe(7, "translate");
        \u0275\u0275pipe(8, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.expired_items)("columns", \u0275\u0275pureFunction5(34, _c56, \u0275\u0275pureFunction1(21, _c017, \u0275\u0275pipeBind1(7, 9, "APP.CONCIERGE.ASSETS_PURCHASE_NUMBER")), \u0275\u0275pureFunction1(23, _c113, \u0275\u0275pipeBind1(8, 11, "APP.CONCIERGE.ASSETS_PURCHASE_INVOICE")), \u0275\u0275pureFunction2(25, _c213, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.ASSETS_PURCHASE_DATE"), date_template_r4), \u0275\u0275pureFunction2(28, _c313, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.ASSETS_PURCHASE_START"), date_template_r4), \u0275\u0275pureFunction2(31, _c412, \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.ASSETS_PURCHASE_END"), date_template_r4)))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 19, "APP.CONCIERGE.REPORTS_ASSETS_EXPIRED_PO_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetReportExpiredItemsComponent, { className: "AssetReportExpiredItemsComponent", filePath: "apps/concierge/src/app/reports/assets/asset-report-expired-items.component.ts", lineNumber: 80 });
})();

// apps/concierge/src/app/reports/assets/assets-report.component.ts
var _c018 = ["report-assets", ""];
function AssetsReportComponent_ng_container_13_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
...
function AssetsReportComponent_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, AssetsReportComponent_ng_container_13_ng_container_1_Template, 6, 4, "ng-container", 9);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AssetsReportComponent_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275element(1, "mat-spinner", 12);
    \u0275\u0275elementStart(2, "p", 13);
...
function AssetsReportComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "p", 13);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
...
var AssetsReportComponent = class _AssetsReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function AssetsReportComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetsReportComponent, selectors: [["", "report-assets", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c018, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8", "screen-only"]], template: function AssetsReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
        ...
        \u0275\u0275pipe(12, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(13, AssetsReportComponent_ng_container_13_Template, 3, 4, "ng-container", 9);
        \u0275\u0275pipe(14, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(15, AssetsReportComponent_ng_template_15_Template, 5, 4, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(17, AssetsReportComponent_ng_template_17_Template, 4, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        let tmp_4_0;
        const load_state_r4 = \u0275\u0275reference(16);
        ...
        \u0275\u0275property("source", ((tmp_4_0 = \u0275\u0275pipeBind1(7, 10, ctx.logo)) == null ? null : tmp_4_0.src) || \u0275\u0275pipeBind1(8, 12, ctx.logo));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 14, "APP.CONCIERGE.REPORTS_ASSETS_HEADER"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(14, 16, ctx.loading))("ngIfElse", load_state_r4);
      }
    }, dependencies: [NgIf, MatProgressSpinner, AuthenticatedImageDirective, ReportsOptionsComponent, AssetReportOverallComponent, AssetReportDailyUsageComponent, AssetReportProductUsageComponent, AssetReportUsersComponent, AssetReportExpiredItemsComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=assets-report.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetsReportComponent, { className: "AssetsReportComponent", filePath: "apps/concierge/src/app/reports/assets/assets-report.component.ts", lineNumber: 81 });
})();
...
var _c114 = (a0) => ({ key: "booking_count", name: a0 });
var _c214 = (a0) => ({ key: "host_count", name: a0 });
var _c314 = (a0) => ({ key: "booked_count", name: a0 });
var _c413 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
function VisitorReportDailyUsageComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 6);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function VisitorReportDailyUsageComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var VisitorReportDailyUsageComponent = class _VisitorReportDailyUsageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorReportDailyUsageComponent, selectors: [["visitor-report-daily-usage"]], inputs: { print: "print" }, standalone: false, decls: 14, vars: 33, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function VisitorReportDailyUsageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, VisitorReportDailyUsageComponent_button_5_Template, 4, 3, "button", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275element(6, "simple-table", 5);
        \u0275\u0275pipe(7, "translate");
        \u0275\u0275pipe(8, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.daily_stats)("columns", \u0275\u0275pureFunction4(28, _c413, \u0275\u0275pureFunction2(19, _c019, \u0275\u0275pipeBind1(7, 9, "FORM.DATE"), date_template_r4), \u0275\u0275pureFunction1(22, _c114, \u0275\u0275pipeBind1(8, 11, "APP.CONCIERGE.REPORTS_VISITORS_UNIQUE")), \u0275\u0275pureFunction1(24, _c214, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_VISITORS_HOSTS")), \u0275\u0275pureFunction1(26, _c314, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_BOOKING_COUNT_HEADER"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorReportDailyUsageComponent, { className: "VisitorReportDailyUsageComponent", filePath: "apps/concierge/src/app/reports/visitors/visitor-report-daily-usage.component.ts", lineNumber: 70 });
})();

// apps/concierge/src/app/reports/visitors/visitor-report-list.component.ts
var _c020 = (a0) => ({ key: "visitor_name", name: a0 });
var _c115 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
var _c215 = (a0) => ({ key: "host", name: a0 });
var _c315 = (a0) => ({ key: "checked_in", name: a0 });
var _c414 = (a0) => ({ key: "self_registered", name: a0 });
var _c57 = (a0, a1, a2, a3, a4) => [a0, a1, a2, a3, a4];
function VisitorReportListComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 6);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function VisitorReportListComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var VisitorReportListComponent = class _VisitorReportListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorReportListComponent, selectors: [["visitor-report-list"]], inputs: { print: "print" }, standalone: false, decls: 15, vars: 38, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function VisitorReportListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, VisitorReportListComponent_button_5_Template, 4, 3, "button", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275element(6, "simple-table", 5);
        \u0275\u0275pipe(7, "translate");
        \u0275\u0275pipe(8, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.visitor_bookings)("columns", \u0275\u0275pureFunction5(32, _c57, \u0275\u0275pureFunction1(21, _c020, \u0275\u0275pipeBind1(7, 9, "FORM.NAME")), \u0275\u0275pureFunction2(23, _c115, \u0275\u0275pipeBind1(8, 11, "FORM.DATE"), date_template_r4), \u0275\u0275pureFunction1(26, _c215, \u0275\u0275pipeBind1(9, 13, "FORM.HOST")), \u0275\u0275pureFunction1(28, _c315, \u0275\u0275pipeBind1(10, 15, "COMMON.CHECKED_IN")), \u0275\u0275pureFunction1(30, _c414, \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_VISITORS_SELF_REGISTERED"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 19, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorReportListComponent, { className: "VisitorReportListComponent", filePath: "apps/concierge/src/app/reports/visitors/visitor-report-list.component.ts", lineNumber: 68 });
})();

// apps/concierge/src/app/reports/visitors/visitors-report.component.ts
var _c021 = ["visitors-report", ""];
function VisitorsReportComponent_ng_container_13_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
...
function VisitorsReportComponent_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, VisitorsReportComponent_ng_container_13_ng_container_1_Template, 4, 1, "ng-container", 9);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function VisitorsReportComponent_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275element(1, "mat-spinner", 12);
    \u0275\u0275elementStart(2, "p", 13);
...
function VisitorsReportComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "p", 13);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
...
var VisitorsReportComponent = class _VisitorsReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function VisitorsReportComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorsReportComponent, selectors: [["", "visitors-report", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c021, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8", "screen-only"]], template: function VisitorsReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
        ...
        \u0275\u0275pipe(12, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(13, VisitorsReportComponent_ng_container_13_Template, 3, 4, "ng-container", 9);
        \u0275\u0275pipe(14, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(15, VisitorsReportComponent_ng_template_15_Template, 5, 4, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(17, VisitorsReportComponent_ng_template_17_Template, 4, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        let tmp_4_0;
        const load_state_r4 = \u0275\u0275reference(16);
        ...
        \u0275\u0275property("source", ((tmp_4_0 = \u0275\u0275pipeBind1(7, 10, ctx.logo)) == null ? null : tmp_4_0.src) || \u0275\u0275pipeBind1(8, 12, ctx.logo));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 14, "APP.CONCIERGE.REPORTS_VISITORS_HEADER"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(14, 16, ctx.loading))("ngIfElse", load_state_r4);
      }
    }, dependencies: [NgIf, MatProgressSpinner, AuthenticatedImageDirective, ReportsOptionsComponent, VisitorReportOverallComponent, VisitorReportDailyUsageComponent, VisitorReportListComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=visitors-report.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorsReportComponent, { className: "VisitorsReportComponent", filePath: "apps/concierge/src/app/reports/visitors/visitors-report.component.ts", lineNumber: 75 });
})();

// apps/concierge/src/app/reports/parking/parking-report.service.ts
var ParkingReportService = class _ParkingReportService {
  constructor(_settings, _org, _report) {
    this._settings = _settings;
    this._org = _org;
    this._report = _report;
    this._options = new BehaviorSubject({});
  ...
  static {
    this.\u0275fac = function ParkingReportService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ParkingReportService)(\u0275\u0275inject(SettingsService), \u0275\u0275inject(OrganisationService), \u0275\u0275inject(ReportsStateService));
    };
  }
  static {
...
var _c216 = (a0) => ({ key: "host_count", name: a0 });
var _c316 = (a0) => ({ key: "booked_count", name: a0 });
var _c415 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
function ParkingReportDailyUsageComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 6);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function ParkingReportDailyUsageComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var ParkingReportDailyUsageComponent = class _ParkingReportDailyUsageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportDailyUsageComponent, selectors: [["parking-report-daily-usage"]], inputs: { print: "print" }, standalone: false, decls: 14, vars: 33, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ParkingReportDailyUsageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, ParkingReportDailyUsageComponent_button_5_Template, 4, 3, "button", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275element(6, "simple-table", 5);
        \u0275\u0275pipe(7, "translate");
        \u0275\u0275pipe(8, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.daily_stats)("columns", \u0275\u0275pureFunction4(28, _c415, \u0275\u0275pureFunction2(19, _c022, \u0275\u0275pipeBind1(7, 9, "FORM.DATE"), date_template_r4), \u0275\u0275pureFunction1(22, _c116, \u0275\u0275pipeBind1(8, 11, "APP.CONCIERGE.REPORTS_UNIQUE_HEADER")), \u0275\u0275pureFunction1(24, _c216, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_HOST_COUNT_HEADER")), \u0275\u0275pureFunction1(26, _c316, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_BOOKING_COUNT_HEADER"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingReportDailyUsageComponent, { className: "ParkingReportDailyUsageComponent", filePath: "apps/concierge/src/app/reports/parking/parking-report-daily-usage.component.ts", lineNumber: 70 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingReportOverallComponent, { className: "ParkingReportOverallComponent", filePath: "apps/concierge/src/app/reports/parking/parking-report-overall.component.ts", lineNumber: 36 });
})();

// apps/concierge/src/app/reports/parking/parking-report-list.component.ts
var _c023 = (a0) => ({ key: "parking_name", name: a0 });
var _c117 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
var _c217 = (a0, a1) => ({ key: "duration", name: a0, content: a1 });
var _c317 = (a0) => ({ key: "host", name: a0 });
var _c416 = (a0) => ({ key: "checked_in", name: a0 });
var _c58 = (a0, a1, a2, a3, a4) => [a0, a1, a2, a3, a4];
function ParkingReportListComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 7);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function ParkingReportListComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var ParkingReportListComponent = class _ParkingReportListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportListComponent, selectors: [["parking-report-list"]], inputs: { print: "print" }, standalone: false, decls: 17, vars: 39, consts: [["date_template", ""], ["duration_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ParkingReportListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "h3", 4);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, ParkingReportListComponent_button_5_Template, 4, 3, "button", 5);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.parking_bookings)("columns", \u0275\u0275pureFunction5(33, _c58, \u0275\u0275pureFunction1(21, _c023, \u0275\u0275pipeBind1(7, 9, "RESOURCE.PARKING_SPACE")), \u0275\u0275pureFunction2(23, _c117, \u0275\u0275pipeBind1(8, 11, "FORM.DATE"), date_template_r5), \u0275\u0275pureFunction2(26, _c217, \u0275\u0275pipeBind1(9, 13, "FORM.DURATION"), duration_template_r6), \u0275\u0275pureFunction1(29, _c317, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.PARKING_RESERVED_FOR")), \u0275\u0275pureFunction1(31, _c416, \u0275\u0275pipeBind1(11, 17, "COMMON.CHECKED_IN"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 19, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, DurationPipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingReportListComponent, { className: "ParkingReportListComponent", filePath: "apps/concierge/src/app/reports/parking/parking-report-list.component.ts", lineNumber: 82 });
})();
...
var ParkingReportChartsComponent = class _ParkingReportChartsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportChartsComponent, selectors: [["parking-report-charts"]], inputs: { print: "print" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 11, vars: 8, consts: [[1, "flex", "items-center", "space-x-4", "w-full", "px-4", 3, "resize"], [1, "bg-base-100", "border", "border-base-200", "rounded", "flex-1", "w-1/2", "h-[18rem]"], [1, "border-b", "border-base-200", "p-4", "text-xl", "font-bold"], ["id", "daily-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-full", "h-56", "mx-auto", "relative", "top-2", "-left-2"], ["id", "level-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-[24rem]", "h-56", "mx-auto"]], template: function ParkingReportChartsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingReportChartsComponent, { className: "ParkingReportChartsComponent", filePath: "apps/concierge/src/app/reports/parking/parking-report-charts.component.ts", lineNumber: 56 });
})();

// apps/concierge/src/app/reports/parking/parking-report.component.ts
var _c024 = ["parking-report", ""];
function ParkingReportComponent_ng_container_13_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
...
function ParkingReportComponent_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ParkingReportComponent_ng_container_13_ng_container_1_Template, 5, 2, "ng-container", 9);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function ParkingReportComponent_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275element(1, "mat-spinner", 12);
    \u0275\u0275elementStart(2, "p", 13);
...
function ParkingReportComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "p", 13);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
...
var ParkingReportComponent = class _ParkingReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportComponent, selectors: [["", "parking-report", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c024, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8", "screen-only"]], template: function ParkingReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
        ...
        \u0275\u0275pipe(12, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(13, ParkingReportComponent_ng_container_13_Template, 3, 4, "ng-container", 9);
        \u0275\u0275pipe(14, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(15, ParkingReportComponent_ng_template_15_Template, 5, 4, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(17, ParkingReportComponent_ng_template_17_Template, 4, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        let tmp_4_0;
        const load_state_r4 = \u0275\u0275reference(16);
        ...
        \u0275\u0275property("source", ((tmp_4_0 = \u0275\u0275pipeBind1(7, 10, ctx.logo)) == null ? null : tmp_4_0.src) || \u0275\u0275pipeBind1(8, 12, ctx.logo));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 14, "APP.CONCIERGE.REPORTS_PARKING_HEADER"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(14, 16, ctx.loading))("ngIfElse", load_state_r4);
      }
    }, dependencies: [NgIf, MatProgressSpinner, AuthenticatedImageDirective, ReportsOptionsComponent, ParkingReportDailyUsageComponent, ParkingReportOverallComponent, ParkingReportListComponent, ParkingReportChartsComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=parking-report.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingReportComponent, { className: "ParkingReportComponent", filePath: "apps/concierge/src/app/reports/parking/parking-report.component.ts", lineNumber: 76 });
})();
...
var LockersReportService = class _LockersReportService {
  constructor(_settings, _org, _report) {
    ...
    this.counts$ = this._options.pipe(debounceTime(500), switchMap((filters) => {
      ...
      return Promise.all(zones.map((z) => showMetadata(z, "lockers-spaces").pipe(catchError(() => of({ details: [] })), map((m) => [z, m.details.length])).toPromise()));
    }), map((list) => {
      const mapping = {};
      list.forEach(([id, count]) => mapping[id] = Math.max(count || 0, 1));
      return mapping;
  ...
  static {
    this.\u0275fac = function LockersReportService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LockersReportService)(\u0275\u0275inject(SettingsService), \u0275\u0275inject(OrganisationService), \u0275\u0275inject(ReportsStateService));
    };
  }
  static {
...
var _c118 = (a0) => ({ key: "booking_count", name: a0 });
var _c218 = (a0) => ({ key: "host_count", name: a0 });
var _c318 = (a0) => ({ key: "booked_count", name: a0 });
var _c417 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
function LockersReportDailyUsageComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 6);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function LockersReportDailyUsageComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var LockersReportDailyUsageComponent = class _LockersReportDailyUsageComponent {
  ...
  static {
    this.\u0275fac = function LockersReportDailyUsageComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LockersReportDailyUsageComponent)(\u0275\u0275directiveInject(LockersReportService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportDailyUsageComponent, selectors: [["lockers-report-daily-usage"]], inputs: { print: "print" }, standalone: false, decls: 14, vars: 33, consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function LockersReportDailyUsageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, LockersReportDailyUsageComponent_button_5_Template, 4, 3, "button", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275element(6, "simple-table", 5);
        \u0275\u0275pipe(7, "translate");
        \u0275\u0275pipe(8, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.daily_stats)("columns", \u0275\u0275pureFunction4(28, _c417, \u0275\u0275pureFunction2(19, _c025, \u0275\u0275pipeBind1(7, 9, "FORM.DATE"), date_template_r4), \u0275\u0275pureFunction1(22, _c118, \u0275\u0275pipeBind1(8, 11, "APP.CONCIERGE.REPORTS_UNIQUE_HEADER")), \u0275\u0275pureFunction1(24, _c218, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_HOST_COUNT_HEADER")), \u0275\u0275pureFunction1(26, _c318, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_BOOKING_COUNT_HEADER"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportDailyUsageComponent, { className: "LockersReportDailyUsageComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-daily-usage.component.ts", lineNumber: 70 });
})();
...
var LockersReportOverallComponent = class _LockersReportOverallComponent {
  ...
  static {
    this.\u0275fac = function LockersReportOverallComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LockersReportOverallComponent)(\u0275\u0275directiveInject(LockersReportService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportOverallComponent, selectors: [["lockers-report-overall"]], standalone: false, decls: 22, vars: 18, consts: [[1, "m-4", "p-4", "rounded", "bg-base-100", "border", "border-base-200", "flex", "justify-center", "items-center", "space-x-2"], [1, "flex", "flex-col", "items-center", "flex-1"], [1, "text-sm"], [1, "text-2xl"]], template: function LockersReportOverallComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportOverallComponent, { className: "LockersReportOverallComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-overall.component.ts", lineNumber: 36 });
})();

// apps/concierge/src/app/reports/lockers/lockers-report-list.component.ts
var _c026 = (a0) => ({ key: "lockers_name", name: a0 });
var _c119 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
var _c219 = (a0, a1) => ({ key: "duration", name: a0, content: a1 });
var _c319 = (a0) => ({ key: "type", name: a0 });
var _c418 = (a0) => ({ key: "host", name: a0 });
var _c59 = (a0) => ({ key: "checked_in", name: a0 });
var _c63 = (a0, a1, a2, a3, a4, a5) => [a0, a1, a2, a3, a4, a5];
function LockersReportListComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 7);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function LockersReportListComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.download());
    });
...
var LockersReportListComponent = class _LockersReportListComponent {
  constructor(_state) {
    ...
    this.download = () => __async(this, null, function* () {
      const data = yield this.lockers_bookings.pipe(take(1)).toPromise();
      downloadFile("report-assets-daily-usage.csv", jsonToCsv(data));
    });
  }
  static {
    this.\u0275fac = function LockersReportListComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LockersReportListComponent)(\u0275\u0275directiveInject(LockersReportService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportListComponent, selectors: [["lockers-report-list"]], inputs: { print: "print" }, standalone: false, decls: 18, vars: 44, consts: [["date_template", ""], ["duration_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function LockersReportListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "h3", 4);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, LockersReportListComponent_button_5_Template, 4, 3, "button", 5);
        \u0275\u0275elementEnd();
        \u0275\u0275element(6, "simple-table", 6);
        \u0275\u0275pipe(7, "translate");
        \u0275\u0275pipe(8, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.lockers_bookings)("columns", \u0275\u0275pureFunction6(37, _c63, \u0275\u0275pureFunction1(23, _c026, \u0275\u0275pipeBind1(7, 9, "RESOURCE.LOCKER")), \u0275\u0275pureFunction2(25, _c119, \u0275\u0275pipeBind1(8, 11, "FORM.DATE"), date_template_r5), \u0275\u0275pureFunction2(28, _c219, \u0275\u0275pipeBind1(9, 13, "FORM.DURATION"), duration_template_r6), \u0275\u0275pureFunction1(31, _c319, \u0275\u0275pipeBind1(10, 15, "COMMON.TYPE")), \u0275\u0275pureFunction1(33, _c418, \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.BOOKED_FOR")), \u0275\u0275pureFunction1(35, _c59, \u0275\u0275pipeBind1(12, 19, "COMMON.CHECKED_IN"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(13, 21, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, DurationPipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportListComponent, { className: "LockersReportListComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-list.component.ts", lineNumber: 86 });
})();
...
var LockersReportChartsComponent = class _LockersReportChartsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function LockersReportChartsComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LockersReportChartsComponent)(\u0275\u0275directiveInject(LockersReportService), \u0275\u0275directiveInject(OrganisationService), \u0275\u0275directiveInject(SettingsService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportChartsComponent, selectors: [["lockers-report-charts"]], inputs: { print: "print" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 11, vars: 8, consts: [[1, "flex", "items-center", "space-x-4", "w-full", "px-4", 3, "resize"], [1, "bg-base-100", "border", "border-base-200", "rounded", "flex-1", "w-1/2", "h-[18rem]"], [1, "border-b", "border-base-200", "p-4", "text-xl", "font-bold"], ["id", "daily-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-full", "h-56", "mx-auto", "relative", "top-2", "-left-2"], ["id", "level-chart", 1, "ct-chart", "ct-octave", "max-w-full", "w-[24rem]", "h-56", "mx-auto"]], template: function LockersReportChartsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportChartsComponent, { className: "LockersReportChartsComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-charts.component.ts", lineNumber: 67 });
})();

// apps/concierge/src/app/reports/lockers/lockers-report.component.ts
var _c027 = ["lockers-report", ""];
function LockersReportComponent_ng_container_13_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "lockers-report-overall")(2, "lockers-report-charts")(3, "lockers-report-daily-usage", 10)(4, "lockers-report-list", 10);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function LockersReportComponent_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LockersReportComponent_ng_container_13_ng_container_1_Template, 5, 2, "ng-container", 9);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function LockersReportComponent_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275element(1, "mat-spinner", 12);
    \u0275\u0275elementStart(2, "p", 13);
...
function LockersReportComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "p", 13);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
...
var LockersReportComponent = class _LockersReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function LockersReportComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LockersReportComponent)(\u0275\u0275directiveInject(LockersReportService), \u0275\u0275directiveInject(SettingsService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(OrganisationService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportComponent, selectors: [["", "lockers-report", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c027, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8", "screen-only"]], template: function LockersReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
        ...
        \u0275\u0275pipe(12, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(13, LockersReportComponent_ng_container_13_Template, 3, 4, "ng-container", 9);
        \u0275\u0275pipe(14, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(15, LockersReportComponent_ng_template_15_Template, 5, 4, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(17, LockersReportComponent_ng_template_17_Template, 4, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        let tmp_4_0;
        const load_state_r4 = \u0275\u0275reference(16);
        ...
        \u0275\u0275property("source", ((tmp_4_0 = \u0275\u0275pipeBind1(7, 10, ctx.logo)) == null ? null : tmp_4_0.src) || \u0275\u0275pipeBind1(8, 12, ctx.logo));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 14, "APP.CONCIERGE.REPORTS_LOCKERS_HEADER"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(14, 16, ctx.loading))("ngIfElse", load_state_r4);
      }
    }, dependencies: [NgIf, MatProgressSpinner, AuthenticatedImageDirective, ReportsOptionsComponent, LockersReportDailyUsageComponent, LockersReportOverallComponent, LockersReportListComponent, LockersReportChartsComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=lockers-report.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportComponent, { className: "LockersReportComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report.component.ts", lineNumber: 76 });
})();
...
//# sourceMappingURL=reports.module-EZFEWXLM.js.map
