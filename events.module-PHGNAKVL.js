...
function EventManageComponent_div_0_mat_chip_row_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-chip-row", 47);
...
function EventManageComponent_div_0_div_58_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 49)(1, "div", 50)(2, "label", 51);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
function EventManageComponent_div_0_ng_container_90_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "label", 57);
    \u0275\u0275text(2, "Building Location");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 32)(4, "mat-select", 58);
    ...
    \u0275\u0275template(5, EventManageComponent_div_0_ng_container_90_mat_option_5_Template, 2, 2, "mat-option", 35);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 59)(8, "div", 60)(9, "label", 61);
    \u0275\u0275text(10, "Level");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 32)(12, "mat-select", 62);
    ...
    \u0275\u0275template(13, EventManageComponent_div_0_ng_container_90_mat_option_13_Template, 2, 2, "mat-option", 35);
    \u0275\u0275pipe(14, "async");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "div", 63)(16, "label", 61);
    \u0275\u0275text(17, "Room");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "mat-form-field", 32)(19, "mat-select", 64);
    \u0275\u0275pipe(20, "async");
    ...
    \u0275\u0275text(23, "None");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(24, EventManageComponent_div_0_ng_container_90_mat_option_24_Template, 2, 2, "mat-option", 35);
    \u0275\u0275pipe(25, "async");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementContainerEnd();
  }
...
function EventManageComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 5)(1, "a", 6)(2, "app-icon");
    \u0275\u0275text(3, "close");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "form", 7)(5, "h3", 8);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "section", 9)(8, "label", 10);
    ...
    \u0275\u0275text(21, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(22, "a-user-search-field", 14);
    \u0275\u0275elementStart(23, "label", 15);
    \u0275\u0275text(24, "Tags");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "mat-form-field", 16)(26, "mat-chip-grid", 17, 1);
    \u0275\u0275template(28, EventManageComponent_div_0_mat_chip_row_28_Template, 4, 3, "mat-chip-row", 18);
    ...
    \u0275\u0275text(32, " Featured ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "mat-checkbox", 22);
    ...
    \u0275\u0275elementContainerEnd();
    \u0275\u0275element(35, "div", 23);
    \u0275\u0275elementStart(36, "h3", 8);
    \u0275\u0275text(37, "Date and Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerStart(38);
    \u0275\u0275elementStart(39, "div", 24)(40, "div", 25)(41, "label", 26);
    \u0275\u0275text(42);
    \u0275\u0275pipe(43, "translate");
    \u0275\u0275elementStart(44, "span");
    \u0275\u0275text(45, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "a-date-field", 27);
    \u0275\u0275text(47);
    \u0275\u0275pipe(48, "translate");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(54, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "a-date-field", 28);
    \u0275\u0275text(56);
    \u0275\u0275pipe(57, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(58, EventManageComponent_div_0_div_58_Template, 15, 17, "div", 29);
    \u0275\u0275elementStart(59, "div", 30)(60, "label", 31);
    \u0275\u0275i18n(61, 3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "mat-form-field", 32)(63, "app-icon", 33);
    \u0275\u0275text(64, " search ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(65, "input", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "mat-autocomplete", null, 2);
    \u0275\u0275template(68, EventManageComponent_div_0_mat_option_68_Template, 2, 2, "mat-option", 35)(69, EventManageComponent_div_0_mat_option_69_Template, 2, 1, "mat-option", 36);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
    \u0275\u0275element(70, "div", 23);
    \u0275\u0275elementStart(71, "h3", 8);
    \u0275\u0275text(72, "Location");
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerStart(73);
    \u0275\u0275elementStart(74, "div", 37)(75, "button", 38);
    ...
    \u0275\u0275elementStart(76, "app-icon", 39);
    \u0275\u0275text(77, "domain");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(78, "div", 40);
    \u0275\u0275text(79, "On Premise");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(80, "button", 38);
    ...
    \u0275\u0275elementStart(86, "app-icon", 39);
    \u0275\u0275text(87, "add");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(88, "div", 40);
    \u0275\u0275text(89, "Both");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(90, EventManageComponent_div_0_ng_container_90_Template, 26, 21, "ng-container", 41);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275element(91, "div", 23);
    \u0275\u0275elementStart(92, "h3", 8);
    \u0275\u0275text(93, "Event Information");
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerStart(94);
    \u0275\u0275elementStart(95, "label", 10);
    \u0275\u0275text(96, "Event Description");
    \u0275\u0275elementEnd();
    \u0275\u0275element(97, "rich-text-input", 42);
    \u0275\u0275elementStart(98, "label", 15);
    \u0275\u0275text(99, "Images");
    \u0275\u0275elementEnd();
    \u0275\u0275element(100, "image-list-field", 43);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(101, "div", 44)(102, "a", 45);
    \u0275\u0275text(103, " Cancel ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(104, "button", 46);
...
_EventManageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventManageComponent, selectors: [["app-event-manage"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 3, vars: 2, consts: () => {
  let i18n_0;
  if (false) {
  ...
  if (rf & 1) {
    \u0275\u0275template(0, EventManageComponent_div_0_Template, 106, 44, "div", 4)(1, EventManageComponent_ng_template_1_Template, 4, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventManageComponent, { className: "EventManageComponent", filePath: "apps/concierge/src/app/events/event-manage.component.ts", lineNumber: 417 });
})();
...
//# sourceMappingURL=events.module-PHGNAKVL.js.map
