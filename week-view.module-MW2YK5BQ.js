...
var WeekViewEventComponent = class _WeekViewEventComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WeekViewEventComponent, selectors: [["week-view-event"]], inputs: { event: "event" }, decls: 1, vars: 1, consts: [["content", "", "matRipple", "", 3, "class", "click", 4, "ngIf"], ["content", "", "matRipple", "", 3, "click"], [1, "text-base"], [1, "text-sm"]], template: function WeekViewEventComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var WeekViewComponent = class _WeekViewComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WeekViewComponent, selectors: [["", "app-weekview", ""]], attrs: _c0, decls: 4, vars: 0, consts: [[1, "relative", "overflow-hidden"]], template: function WeekViewComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "sidebar");
...
//# sourceMappingURL=week-view.module-MW2YK5BQ.js.map
