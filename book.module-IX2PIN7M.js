import {
  subMinutes
} from "./chunk-KUXO6IX3.js";
import {
  FindAvailabilityModalComponent
} from "./chunk-5E5ZMQDL.js";
import {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringItemDetailsComponent, { className: "CateringItemDetailsComponent", filePath: "libs/catering/src/lib/catering-order-modal/catering-item-details.component.ts", lineNumber: 271 });
})();
...
function CateringItemFiltersComponent_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.at_time())("matTooltip", ctx_r1.exact_tooltip);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r1.offset())("time", ctx_r1.offset_day() > 0 ? ctx_r1.start_of_date : (tmp_7_0 = \u0275\u0275pipeBind1(9, 15, ctx_r1.filters)) == null ? null : tmp_7_0.date)("step", ctx_r1.step_interval)("min", ctx_r1.min_offset)("max", ctx_r1.max_offset)("use_24hr", ctx_r1.use_24hr);
  }
}
...
_CateringItemFiltersComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringItemFiltersComponent, selectors: [["catering-item-filters"]], inputs: { search: [1, "search"], at_time: [1, "at_time"], offset: [1, "offset"], offset_day: [1, "offset_day"] }, outputs: { at_timeChange: "at_timeChange", offsetChange: "offsetChange", offset_dayChange: "offset_dayChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 16, vars: 20, consts: [[1, "mb-2", "mt-2", "px-2"], ["appearance", "outline", 1, "h-14", "w-full"], ["matPrefix", "", 1, "text-xl"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], [1, "hidden", "px-2", "py-2", "sm:block"], [1, "hidden", "px-2", "py-2", "font-medium", "sm:block"], [1, "flex", "flex-col", "px-2"], [1, "hidden", "px-2", "py-4", "font-medium", "sm:block"], [1, "flex", "flex-col", "space-y-2", "px-2"], [3, "ngModel"], [3, "ngModelChange", "ngModel"], [3, "value"], [3, "ngModelChange", "ngModel", "matTooltip"], [3, "ngModelChange", "ngModel", "time", "step", "min", "max", "use_24hr"], ["appearance", "outline", 1, "no-subscript", "mb-4", "w-full"]], template: function CateringItemFiltersComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringItemFiltersComponent, { className: "CateringItemFiltersComponent", filePath: "libs/catering/src/lib/catering-order-modal/catering-item-filters.component.ts", lineNumber: 209 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringItemListComponent, { className: "CateringItemListComponent", filePath: "libs/catering/src/lib/catering-order-modal/catering-item-list.component.ts", lineNumber: 99 });
})();
...
_NewCateringItemListItemComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewCateringItemListItemComponent, selectors: [["new-catering-item-list-item"]], inputs: { item: [1, "item"], active: [1, "active"], selected: [1, "selected"], favourite: [1, "favourite"], code: [1, "code"] }, outputs: { toggleFav: "toggleFav", select: "select" }, decls: 23, vars: 16, consts: [["item", "", "matRipple", "", 1, "relative", "w-full", "rounded-lg", "border", "border-base-200", "bg-base-100", "p-2", "shadow"], ["name", "select-catering-item", 1, "z-0", "flex", "h-full", "w-full", "items-center", 3, "click"], [1, "relative", "mr-4", "flex", "h-16", "w-16", "items-center", "justify-center", "overflow-hidden", "rounded-xl", "border", "border-base-200", "bg-neutral"], [1, "absolute", "left-1", "top-1", "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", "border", "border-white", "bg-neutral", "text-xs", "text-white"], ["auth", "", 1, "min-h-full", "min-w-full", "object-cover", 3, "source"], ["src", "assets/icons/catering-placeholder.svg", 1, "m-auto"], [1, "flex-1", "space-y-2", "text-left"], [1, "flex", "flex-col", "pr-10", "font-medium"], [1, "text-xs", "opacity-60"], [1, "flex", "items-center", "space-x-1", "text-sm"], [1, "w-px", "flex-1", "rounded", "bg-base-100"], [1, "rounded-2xl", "border", "border-base-200", "px-2", "py-1", "text-xs", "shadow"], [1, "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "bg-success", "text-xs", "shadow"], [1, "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "bg-info", "text-xs", "shadow"], [1, "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "bg-warning", "text-xs", "shadow"], [1, "bg-orange-600", "flex", "h-5", "w-7", "items-center", "justify-center", "rounded-xl", "text-xs", "shadow"], ["icon", "", "matRipple", "", "name", "toggle-catering-item-favourite", 1, "absolute", "right-1", "top-1", 3, "click"], [3, "className"]], template: function NewCateringItemListItemComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 0)(1, "button", 1);
...
var _FlowSuccessComponent = class _FlowSuccessComponent {
  constructor() {
    this.calendar = input(void 0);
    this.extra = input("");
    this.route = input("spaces");
    this.type = input("space");
  }
  get is_host() {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowConfirmModalComponent, { className: "MeetingFlowConfirmModalComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-confirm-modal.component.ts", lineNumber: 456 });
})();
...
function MeetingFormDetailsComponent_Conditional_0_Conditional_14_Conditional_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r0.form().value.date_end)("ngModelOptions", \u0275\u0275pureFunction0(9, _c022))("from", ((tmp_6_0 = ctx_r0.form()) == null ? null : (tmp_6_0 = tmp_6_0.getRawValue()) == null ? null : tmp_6_0.date) + 30 * 60 * 1e3)("use_24hr", ctx_r0.use_24hr)("extra_info_fn", ctx_r0.duration_info)("timezone", ctx_r0.timezone);
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFormDetailsComponent, { className: "MeetingFormDetailsComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-form-details.component.ts", lineNumber: 214 });
})();
...
//# sourceMappingURL=book.module-IX2PIN7M.js.map
