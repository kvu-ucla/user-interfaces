...
var AssetReportDailyUsageComponent = class _AssetReportDailyUsageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportDailyUsageComponent, selectors: [["asset-report-daily-usage"]], inputs: { print: "print" }, standalone: false, decls: 15, vars: 38, consts: [["date_template", ""], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function AssetReportDailyUsageComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var AssetReportExpiredItemsComponent = class _AssetReportExpiredItemsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportExpiredItemsComponent, selectors: [["asset-report-expired-items"]], inputs: { print: "print" }, standalone: false, decls: 15, vars: 40, consts: [["date_template", ""], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"]], template: function AssetReportExpiredItemsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
...
var AssetReportOverallComponent = class _AssetReportOverallComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportOverallComponent, selectors: [["asset-report-overall"]], standalone: false, decls: 22, vars: 18, consts: [[1, "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded", "border", "border-base-200", "bg-base-100", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], [1, "text-sm"], [1, "text-2xl"]], template: function AssetReportOverallComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var AssetReportProductUsageComponent = class _AssetReportProductUsageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportProductUsageComponent, selectors: [["asset-report-product-usage"]], inputs: { print: "print" }, standalone: false, decls: 12, vars: 32, consts: [[1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"]], template: function AssetReportProductUsageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
...
var AssetReportUsersComponent = class _AssetReportUsersComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportUsersComponent, selectors: [["asset-report-users"]], inputs: { print: "print" }, standalone: false, decls: 12, vars: 32, consts: [[1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"]], template: function AssetReportUsersComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
...
var ReportsOptionsComponent = class _ReportsOptionsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportsOptionsComponent, selectors: [["reports-options"]], inputs: { loading: "loading", has_data: "has_data" }, outputs: { printing: "printing", generate: "generate", download: "download" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 23, vars: 21, consts: [["startDate", ""], ["endDate", ""], [1, "z-20", "flex", "h-20", "w-full", "items-center", "space-x-2", "border-b", "border-base-200", "bg-base-100", "p-4", "print:hidden"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [3, "week_start"], [3, "ngModelChange", "ngModel"], ["btn", "", "matRipple", "", 3, "click", "disabled"], [3, "diameter", 4, "ngIf"], [4, "ngIf"], [1, "flex-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "disabled", "matTooltip"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "diameter"]], template: function ReportsOptionsComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportsOptionsComponent, { className: "ReportsOptionsComponent", filePath: "apps/concierge/src/app/reports/reports-options.component.ts", lineNumber: 103 });
})();
...
var AssetsReportComponent = class _AssetsReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetsReportComponent, selectors: [["", "report-assets", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c05, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "m-4", "flex", "items-center", "rounded", "bg-base-200", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"]], template: function AssetsReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
...
var CateringReportItemsComponent = class _CateringReportItemsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportItemsComponent, selectors: [["catering-report-items"]], inputs: { print: "print" }, standalone: false, decls: 17, vars: 44, consts: [["option_template", ""], ["cost_template", ""], [1, "mx-auto", "my-2", "w-[64rem]", "max-w-[calc(100%-2rem)]", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "justify-between", "border-b", "border-base-200", "px-4"], [1, "py-2", "text-xl", "font-medium"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "page_size", "empty_message", "sortable"], [1, "p-4"], ["class", "rounded bg-base-200 px-2 py-1 text-xs", 3, "matTooltip", 4, "ngIf"], [1, "rounded", "bg-base-200", "px-2", "py-1", "text-xs", 3, "matTooltip"]], template: function CateringReportItemsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var CateringReportOrdersComponent = class _CateringReportOrdersComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportOrdersComponent, selectors: [["catering-report-orders"]], inputs: { print: "print" }, standalone: false, decls: 18, vars: 31, consts: [["date_template", ""], ["cost_template", ""], [1, "mx-auto", "my-2", "w-[64rem]", "max-w-[calc(100%-2rem)]", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "justify-between", "border-b", "border-base-200", "px-4"], [1, "py-2", "text-xl", "font-medium"], ["matRipple-icon", "", 1, "print:hidden", 3, "click", "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], [1, "p-4"]], template: function CateringReportOrdersComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "h2", 4);
        \u0275\u0275text(3);
...
var CateringReportOverallComponent = class _CateringReportOverallComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportOverallComponent, selectors: [["catering-report-overall"]], standalone: false, decls: 37, vars: 36, consts: [["item", "", 1, "flex", "flex-1", "flex-col", "items-center", "justify-center"], ["count", "", 1, "text-3xl"], [1, "print:text-sm"], ["unique", "", 1, "text-3xl"], ["items", "", 1, "text-3xl"], ["total", "", 1, "text-3xl"], ["average", "", 1, "text-3xl"]], template: function CateringReportOverallComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var CateringReportComponent = class _CateringReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportComponent, selectors: [["catering-report"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "m-4", "flex", "items-center", "overflow-hidden", "rounded", "bg-base-200", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"]], template: function CateringReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
...
function ContactTracingReportComponent_ng_container_11_ng_container_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("data", ctx_r4.tracing_events)("columns", \u0275\u0275pureFunction4(12, _c46, \u0275\u0275pureFunction1(4, _c08, date_template_r8), \u0275\u0275pureFunction1(6, _c17, user_template_r7), \u0275\u0275pureFunction1(8, _c27, user_template_r7), \u0275\u0275pureFunction1(10, _c37, duration_template_r9)))("sortable", true)("page_size", ctx_r4.print ? 0 : 30);
  }
}
...
var ContactTracingReportComponent = class _ContactTracingReportComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactTracingReportComponent, selectors: [["app-contact-tracing-report"]], standalone: false, decls: 17, vars: 12, consts: [["load_state", ""], ["empty_state", ""], ["user_template", ""], ["date_template", ""], ["duration_template", ""], [1, "print:hidden", 3, "printing", "download"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "m-4", "flex", "items-center", "overflow-hidden", "rounded", "bg-base-200", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [4, "ngIf", "ngIfElse"], [1, "mx-auto", "my-2", "w-[64rem]", "max-w-[calc(100%-2rem)]", "rounded-lg", "border", "border-base-200"], [1, "flex", "items-center", "justify-between", "border-b", "border-base-200", "px-4"], [1, "py-2", "text-xl", "font-medium"], ["empty_message", "No contact tracing events for selected period", 1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size"], [1, "p-4"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], ["diameter", "32"], [1, "opacity-30"], [1, "screen-only", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"]], template: function ContactTracingReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
...
var CustomReportComponent = class _CustomReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CustomReportComponent, selectors: [["custom-report"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [["class", "h-full w-full", 3, "src", 4, "ngIf"], [1, "h-full", "w-full", 3, "src"]], template: function CustomReportComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var ReportDesksLevelListComponent = class _ReportDesksLevelListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksLevelListComponent, selectors: [["report-desks-levels-list"]], inputs: { print: "print" }, standalone: false, decls: 16, vars: 38, consts: [["percent_view", ""], [1, "w-full", "px-4", "pb-2"], [1, "w-full", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "p-4"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "page_size", "sortable", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ReportDesksLevelListComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var ReportDesksOverallListComponent = class _ReportDesksOverallListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksOverallListComponent, selectors: [["report-desks-overall-list"]], inputs: { print: "print" }, standalone: false, decls: 17, vars: 34, consts: [["date_template", ""], ["percent_template", ""], [1, "w-full", "pb-2"], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "p-4"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "page_size", "sortable", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ReportDesksOverallListComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var ReportDesksComponent = class _ReportDesksComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksComponent, selectors: [["", "report-desks", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c011, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "m-4", "flex", "items-center", "rounded", "bg-base-200", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [4, "ngIf", "ngIfElse"], [1, "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded", "border", "border-base-200", "bg-base-100", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], [3, "print"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"]], template: function ReportDesksComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
...
var LockersReportDailyUsageComponent = class _LockersReportDailyUsageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportDailyUsageComponent, selectors: [["lockers-report-daily-usage"]], inputs: { print: "print" }, standalone: false, decls: 14, vars: 33, consts: [["date_template", ""], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function LockersReportDailyUsageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
...
var LockersReportListComponent = class _LockersReportListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportListComponent, selectors: [["lockers-report-list"]], inputs: { print: "print" }, standalone: false, decls: 18, vars: 44, consts: [["date_template", ""], ["duration_template", ""], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function LockersReportListComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportListComponent, { className: "LockersReportListComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-list.component.ts", lineNumber: 87 });
})();
...
var LockersReportOverallComponent = class _LockersReportOverallComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportOverallComponent, selectors: [["lockers-report-overall"]], standalone: false, decls: 22, vars: 18, consts: [[1, "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded", "border", "border-base-200", "bg-base-100", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], [1, "text-sm"], [1, "text-2xl"]], template: function LockersReportOverallComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
...
var LockersReportComponent = class _LockersReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportComponent, selectors: [["", "lockers-report", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c014, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "m-4", "flex", "items-center", "rounded", "bg-base-200", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"]], template: function LockersReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
...
var _c015 = () => ["/reports", "desks"];
var _c112 = () => ["/reports", "bookings"];
var _c212 = () => ["/reports", "catering"];
var _c312 = () => ["/reports", "contact-tracing"];
var _c411 = (a0) => ["/reports", a0];
...
function ReportsMenuComponent_a_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(1, _c112));
  }
}
function ReportsMenuComponent_a_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(1, _c212));
  }
}
function ReportsMenuComponent_a_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(1, _c312));
  }
}
function ReportsMenuComponent_a_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(3, _c411, report_r1.id));
    \u0275\u0275advance(2);
...
var ReportsMenuComponent = class _ReportsMenuComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportsMenuComponent, selectors: [["reports-menu"], ["", "reports-menu", ""]], standalone: false, decls: 7, vars: 5, consts: [[1, "absolute", "inset-0", "flex", "items-center", "justify-center", "overflow-auto", "bg-base-200"], [1, "grid", "w-full", "justify-items-center"], ["matRipple", "", "class", "flex h-64 w-64 flex-col items-center justify-center rounded border border-base-200 bg-base-100 p-4 shadow hover:opacity-80", 3, "routerLink", 4, "ngIf"], ["matRipple", "", "class", "flex h-64 w-64 flex-col items-center justify-center rounded border border-base-200 bg-base-100 p-4 shadow hover:opacity-80", 3, "routerLink", 4, "ngFor", "ngForOf"], ["matRipple", "", 1, "flex", "h-64", "w-64", "flex-col", "items-center", "justify-center", "rounded", "border", "border-base-200", "bg-base-100", "p-4", "shadow", "hover:opacity-80", 3, "routerLink"], [1, "text-8xl"], [1, "mb-4", "text-xl", "font-bold"], [1, "flex", "items-center"], [1, "ml-2"]], template: function ReportsMenuComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1);
...
var NewReportsComponent = class _NewReportsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewReportsComponent, selectors: [["", "app-new-reports", ""]], standalone: false, attrs: _c016, decls: 6, vars: 1, consts: [[1, "screen-only"], [1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"], ["reports-menu", "", "class", "screen-only absolute inset-0", 4, "ngIf"], ["reports-menu", "", 1, "screen-only", "absolute", "inset-0"]], template: function NewReportsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var _c313 = (a0) => ({ key: "booked_count", name: a0 });
...
var ParkingReportDailyUsageComponent = class _ParkingReportDailyUsageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportDailyUsageComponent, selectors: [["parking-report-daily-usage"]], inputs: { print: "print" }, standalone: false, decls: 14, vars: 33, consts: [["date_template", ""], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ParkingReportDailyUsageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.daily_stats)("columns", \u0275\u0275pureFunction4(28, _c412, \u0275\u0275pureFunction2(19, _c017, \u0275\u0275pipeBind1(7, 9, "FORM.DATE"), date_template_r4), \u0275\u0275pureFunction1(22, _c113, \u0275\u0275pipeBind1(8, 11, "APP.CONCIERGE.REPORTS_UNIQUE_HEADER")), \u0275\u0275pureFunction1(24, _c213, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_HOST_COUNT_HEADER")), \u0275\u0275pureFunction1(26, _c313, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_BOOKING_COUNT_HEADER"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
...
var _c018 = (a0) => ({ key: "parking_name", name: a0 });
...
var ParkingReportListComponent = class _ParkingReportListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportListComponent, selectors: [["parking-report-list"]], inputs: { print: "print" }, standalone: false, decls: 17, vars: 39, consts: [["date_template", ""], ["duration_template", ""], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ParkingReportListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "h3", 4);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.parking_bookings)("columns", \u0275\u0275pureFunction5(33, _c56, \u0275\u0275pureFunction1(21, _c018, \u0275\u0275pipeBind1(7, 9, "RESOURCE.PARKING_SPACE")), \u0275\u0275pureFunction2(23, _c114, \u0275\u0275pipeBind1(8, 11, "FORM.DATE"), date_template_r5), \u0275\u0275pureFunction2(26, _c214, \u0275\u0275pipeBind1(9, 13, "FORM.DURATION"), duration_template_r6), \u0275\u0275pureFunction1(29, _c314, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.PARKING_RESERVED_FOR")), \u0275\u0275pureFunction1(31, _c413, \u0275\u0275pipeBind1(11, 17, "COMMON.CHECKED_IN"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 19, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, DurationPipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingReportListComponent, { className: "ParkingReportListComponent", filePath: "apps/concierge/src/app/reports/parking/parking-report-list.component.ts", lineNumber: 83 });
})();
...
var ParkingReportOverallComponent = class _ParkingReportOverallComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportOverallComponent, selectors: [["parking-report-overall"]], standalone: false, decls: 22, vars: 18, consts: [[1, "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded", "border", "border-base-200", "bg-base-100", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], [1, "text-sm"], [1, "text-2xl"]], template: function ParkingReportOverallComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
...
var ParkingReportComponent = class _ParkingReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportComponent, selectors: [["", "parking-report", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c019, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "m-4", "flex", "items-center", "rounded", "bg-base-200", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"]], template: function ParkingReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
...
var ReportsComponent = class _ReportsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportsComponent, selectors: [["", "app-reports", ""]], standalone: false, attrs: _c020, decls: 4, vars: 1, consts: [[1, "screen-only", "h-full"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col", "overflow-hidden", "bg-base-200"], ["reports-menu", "", "class", "screen-only absolute inset-0", 4, "ngIf"], ["reports-menu", "", 1, "screen-only", "absolute", "inset-0"]], template: function ReportsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var _c021 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
var _c115 = (a0) => ({ key: "approved", name: a0 });
...
var ReportSpacesOverallListComponent = class _ReportSpacesOverallListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesOverallListComponent, selectors: [["report-spaces-overall-list"]], inputs: { print: "print" }, standalone: false, decls: 17, vars: 34, consts: [["date_template", ""], ["percent_template", ""], [1, "w-full"], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "p-4"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ReportSpacesOverallListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "div", 4)(3, "h3", 5);
        \u0275\u0275text(4);
        \u0275\u0275pipe(5, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.day_list)("columns", \u0275\u0275pureFunction4(29, _c414, \u0275\u0275pureFunction2(19, _c021, \u0275\u0275pipeBind1(8, 9, "FORM.DATE"), date_template_r5), \u0275\u0275pureFunction1(22, _c115, \u0275\u0275pipeBind1(9, 11, "APP.CONCIERGE.REPORTS_APPROVED")), \u0275\u0275pureFunction1(24, _c215, \u0275\u0275pipeBind1(10, 13, "APP.CONCIERGE.REPORTS_TOTAL_REQUESTS")), \u0275\u0275pureFunction2(26, _c315, \u0275\u0275pipeBind1(11, 15, "APP.CONCIERGE.REPORTS_UTILISATION"), percent_template_r6)))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
...
var ReportSpacesOverallComponent = class _ReportSpacesOverallComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesOverallComponent, selectors: [["report-spaces-overall"]], standalone: false, decls: 24, vars: 21, consts: [[1, "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded", "border", "border-base-200", "bg-base-100", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], ["class", "m-4 flex items-center justify-center space-x-2 rounded bg-base-100 p-4", 4, "ngIf"], [1, "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded", "bg-base-100", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center"]], template: function ReportSpacesOverallComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var _c116 = (a0, a1) => ({ key: "capacity", name: a0, content: a1 });
...
var ReportSpacesSpaceListingComponent = class _ReportSpacesSpaceListingComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesSpaceListingComponent, selectors: [["report-spaces-space-listing"]], inputs: { print: "print" }, standalone: false, decls: 22, vars: 67, consts: [["capacity_template", ""], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"]], template: function ReportSpacesSpaceListingComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
...
var ReportSpacesUserListingComponent = class _ReportSpacesUserListingComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesUserListingComponent, selectors: [["report-spaces-user-listing"]], inputs: { print: "print" }, standalone: false, decls: 13, vars: 37, consts: [[1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"]], template: function ReportSpacesUserListingComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
...
var ReportSpacesComponent = class _ReportSpacesComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesComponent, selectors: [["", "report-spaces", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c024, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "m-4", "flex", "items-center", "rounded", "bg-base-200", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"]], template: function ReportSpacesComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
...
var VisitorReportDailyUsageComponent = class _VisitorReportDailyUsageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorReportDailyUsageComponent, selectors: [["visitor-report-daily-usage"]], inputs: { print: "print" }, standalone: false, decls: 14, vars: 33, consts: [["date_template", ""], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function VisitorReportDailyUsageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.daily_stats)("columns", \u0275\u0275pureFunction4(28, _c417, \u0275\u0275pureFunction2(19, _c025, \u0275\u0275pipeBind1(7, 9, "FORM.DATE"), date_template_r4), \u0275\u0275pureFunction1(22, _c118, \u0275\u0275pipeBind1(8, 11, "APP.CONCIERGE.REPORTS_VISITORS_UNIQUE")), \u0275\u0275pureFunction1(24, _c218, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_VISITORS_HOSTS")), \u0275\u0275pureFunction1(26, _c318, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_BOOKING_COUNT_HEADER"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
...
var VisitorReportListComponent = class _VisitorReportListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorReportListComponent, selectors: [["visitor-report-list"]], inputs: { print: "print" }, standalone: false, decls: 15, vars: 38, consts: [["date_template", ""], [1, "m-4", "overflow-hidden", "rounded", "border", "border-base-200", "bg-base-100"], [1, "flex", "items-center", "border-b", "border-base-200", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip", "click", 4, "ngIf"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function VisitorReportListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.print);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.visitor_bookings)("columns", \u0275\u0275pureFunction5(32, _c59, \u0275\u0275pureFunction1(21, _c026, \u0275\u0275pipeBind1(7, 9, "FORM.NAME")), \u0275\u0275pureFunction2(23, _c119, \u0275\u0275pipeBind1(8, 11, "FORM.DATE"), date_template_r4), \u0275\u0275pureFunction1(26, _c219, \u0275\u0275pipeBind1(9, 13, "FORM.HOST")), \u0275\u0275pureFunction1(28, _c319, \u0275\u0275pipeBind1(10, 15, "COMMON.CHECKED_IN")), \u0275\u0275pureFunction1(30, _c418, \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_VISITORS_SELF_REGISTERED"))))("sortable", true)("page_size", ctx.print ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 19, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
      }
    }, dependencies: [NgIf, MatTooltip, MatRipple, IconComponent, SimpleTableComponent, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorReportListComponent, { className: "VisitorReportListComponent", filePath: "apps/concierge/src/app/reports/visitors/visitor-report-list.component.ts", lineNumber: 69 });
})();
...
var VisitorReportOverallComponent = class _VisitorReportOverallComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorReportOverallComponent, selectors: [["visitor-report-overall"]], standalone: false, decls: 22, vars: 18, consts: [[1, "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded", "border", "border-base-200", "bg-base-100", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], [1, "text-sm"], [1, "text-2xl"]], template: function VisitorReportOverallComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
...
var VisitorsReportComponent = class _VisitorsReportComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorsReportComponent, selectors: [["", "visitors-report", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c027, decls: 19, vars: 18, consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "m-4", "flex", "items-center", "rounded", "bg-base-200", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"]], template: function VisitorsReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "reports-options", 2);
        \u0275\u0275pipe(1, "async");
...
//# sourceMappingURL=reports.module-CVHOXO3C.js.map
