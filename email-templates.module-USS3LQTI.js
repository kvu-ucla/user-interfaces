...
var EmailTemplatesComponent = class _EmailTemplatesComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplatesComponent, selectors: [["", "app-email-templates", ""]], attrs: _c0, decls: 5, vars: 0, consts: [[1, "flex", "flex-1", "h-px"], [1, "relative", "flex", "flex-col", "flex-1", "w-1/2", "h-full"]], template: function EmailTemplatesComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=email-templates.module-USS3LQTI.js.map
