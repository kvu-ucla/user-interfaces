...
var RegionManagerComponent = class _RegionManagerComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegionManagerComponent, selectors: [["", "app-region-manager", ""]], standalone: false, attrs: _c02, decls: 46, vars: 20, consts: [["app_settings_menu", "matMenu"], [1, "flex", "flex-1", "h-px"], [1, "flex", "flex-col", "flex-1", "w-1/2", "h-full"], [1, "flex", "items-center", "justify-between", "mb-2", "px-8", "pt-4", "pb-2"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], [1, "flex", "justify-end", "px-8", "pb-8"], ["icon", "", "matRipple", "", 3, "matMenuTriggerFor", "matTooltip"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl"], [1, "block", "w-full", "relative", "flex-1", "h-1/2"]], template: function RegionManagerComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
...
//# sourceMappingURL=region-manager.module-VYWTTLAR.js.map
