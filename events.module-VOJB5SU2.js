...
var _EventManageComponent = class _EventManageComponent extends AsyncHandler {
  ...
  async save() {
    ...
    const date = this.form.getRawValue().date;
    const res = await this._form_state.postForm(false, [this._state.calendar], true).catch((e) => notifyError(e));
    this._state.changed();
    this.loading = false;
    if (res) {
...
//# sourceMappingURL=events.module-VOJB5SU2.js.map
