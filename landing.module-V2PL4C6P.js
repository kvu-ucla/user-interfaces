...
var LandingStateService = class _LandingStateService extends AsyncHandler {
  ...
  updateContacts() {
    return __async(this, null, function* () {
      ...
      const users = yield Promise.all(list.map((_) => showUser(_.email).pipe(catchError(() => of(_))).toPromise()));
...
function LandingFavouritesComponent_ng_container_6_ng_container_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 19)(15, "app-icon", 17);
    \u0275\u0275text(16, " people ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(22, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "button", 21)(24, "app-icon");
    ...
    \u0275\u0275elementStart(29, "div", 24)(30, "app-icon", 25);
    \u0275\u0275text(31, "delete");
    \u0275\u0275elementEnd();
...
function LandingFavouritesComponent_ng_container_6_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "button", 30)(18, "app-icon");
    ...
    \u0275\u0275elementStart(23, "div", 24)(24, "app-icon", 25);
    \u0275\u0275text(25, " delete ");
    \u0275\u0275elementEnd();
...
function LandingComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(4, "div", 18)(5, "app-icon");
    \u0275\u0275text(6, "favorite");
    \u0275\u0275elementEnd();
...
//# sourceMappingURL=landing.module-V2PL4C6P.js.map
