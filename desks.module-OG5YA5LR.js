...
var DeskBookingsComponent = class _DeskBookingsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskBookingsComponent, selectors: [["desk-bookings"]], standalone: false, decls: 27, vars: 63, consts: [["date_template", ""], ["group_template", ""], ["period_template", ""], ["user_template", ""], ["status_template", ""], ["option_template", ""], ["menu", "matMenu"], ["checkinMenu", "matMenu"], [1, "h-full", "w-full", "overflow-auto", "pb-16"], [1, "block", "min-w-[72rem]", "text-sm", 3, "data", "filter", "filter_on", "columns", "empty_message", "sortable"], ["btn", "", "matRipple", "", "class", "absolute bottom-2 left-4 z-20 w-32", 3, "click", 4, "ngIf"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "py-2"], [1, "opacity-60"], [1, "text-xl"], [1, "p-4", "font-mono", "text-[0.625rem]"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"], [1, "p-2"], [4, "ngIf"], [1, "rounded-3xl", "bg-error", "px-4", "py-2", "text-xs", "text-white"], [1, "flex", "flex-col", "justify-center", "px-4", "py-2"], [1, "select-all"], ["class", "select-all text-xs opacity-30", 4, "ngIf"], [1, "select-all", "text-xs", "opacity-30"], [1, "px-2"], ["matRipple", "", 1, "h-10", "w-[7.5rem]", "rounded-3xl", "border-none", "bg-warning", "text-warning-content", 3, "matMenuTriggerFor", "disabled"], [1, "flex", "items-center", "space-x-2", "pl-4", "pr-2"], [1, "flex-1", "text-left"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], ["matRipple", "", 1, "h-10", "w-[4.5rem]", "rounded-3xl", "border-none", "bg-warning", "text-warning-content", 3, "matMenuTriggerFor", "disabled", "matTooltip"], ["btn", "", "matRipple", "", 1, "absolute", "bottom-2", "left-4", "z-20", "w-32", 3, "click"]], template: function DeskBookingsComponent_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.bookings)("filter", (tmp_7_0 = \u0275\u0275pipeBind1(2, 7, ctx.filters)) == null ? null : tmp_7_0.search)("filter_on", \u0275\u0275pureFunction0(31, _c0))("columns", \u0275\u0275pureFunction8(54, _c9, \u0275\u0275pureFunction2(32, _c1, \u0275\u0275pipeBind1(3, 9, "FORM.DATE"), date_template_r14), \u0275\u0275pureFunction2(35, _c2, \u0275\u0275pipeBind1(4, 11, "FORM.PERIOD"), period_template_r16), \u0275\u0275pureFunction2(38, _c3, \u0275\u0275pipeBind1(5, 13, "COMMON.PERSON"), user_template_r17), \u0275\u0275pureFunction2(41, _c4, \u0275\u0275pipeBind1(6, 15, "COMMON.GROUP"), group_template_r15), \u0275\u0275pureFunction1(44, _c5, \u0275\u0275pipeBind1(7, 17, "RESOURCE.DESK")), \u0275\u0275pureFunction1(46, _c6, \u0275\u0275pipeBind1(8, 19, "APP.CONCIERGE.APPROVER")), \u0275\u0275pureFunction2(48, _c7, \u0275\u0275pipeBind1(9, 21, "COMMON.STATUS"), status_template_r18), \u0275\u0275pureFunction2(51, _c8, \u0275\u0275pipeBind1(10, 23, "COMMON.CHECKED_IN"), option_template_r19)))("empty_message", \u0275\u0275pipeBind1(12, 27, ((tmp_10_0 = \u0275\u0275pipeBind1(11, 25, ctx.filters)) == null ? null : tmp_10_0.search) ? "APP.CONCIERGE.DESKS_BOOKINGS_SEARCH_EMPTY" : "APP.CONCIERGE.DESKS_BOOKINGS_EMPTY"))("sortable", true);
        \u0275\u0275advance(24);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskBookingsComponent, { className: "DeskBookingsComponent", filePath: "apps/concierge/src/app/desks/desk-bookings.component.ts", lineNumber: 287 });
})();
...
var _c22 = (a0, a1) => ({ key: "groups", name: a0, content: a1 });
var _c32 = (a0) => ({ key: "assigned_to", name: "Assigned", content: a0 });
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DesksManageComponent, selectors: [["desks-manage"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 23, vars: 54, consts: [["name_template", ""], ["item_list_template", ""], ["bool_template", ""], ["assigned_template", ""], ["action_template", ""], ["qr_menu", ""], [1, "h-full", "w-full", "overflow-auto", "pb-4", 3, "dragenter", "dragend"], [1, "block", "w-full", "min-w-[72rem]", "text-sm", 3, "filter", "data", "columns", "sortable", "empty_message"], ["class", "absolute inset-0 flex flex-col items-center justify-center space-y-2 bg-base-100 bg-opacity-60", 4, "ngIf"], ["class", "absolute inset-0 flex items-center justify-center bg-neutral", 4, "ngIf"], [1, "flex", "flex-col", "px-4", "py-2", "text-left", "leading-tight", 3, "click"], ["class", "font-mono text-[0.625rem] opacity-30", 4, "ngIf"], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "flex", "flex-wrap", "p-2"], ["class", "m-1 rounded-2xl bg-info px-2 py-1 font-mono text-xs text-info-content", 4, "ngFor", "ngForOf"], [1, "m-1", "rounded-2xl", "bg-info", "px-2", "py-1", "font-mono", "text-xs", "text-info-content"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "text-2xl", "text-white"], ["class", "p-4 opacity-30", 4, "ngIf"], ["class", "px-4 py-2 text-left leading-tight", 3, "click", 4, "ngIf"], [1, "p-4", "opacity-30"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "flex", "items-center", "justify-end", "space-x-2", "p-2"], ["icon", "", "matRipple", "", "customTooltip", "", 3, "click", "content", "matTooltip"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "text-error"], [1, "rounded", "bg-base-100", "py-2", "shadow"], ["printable", "", 1, ""], ["target", "_blank", "ref", "noopener noreferrer", 1, "mx-4", "my-2", "block", "rounded-lg", "border", "border-base-200", "bg-base-100", "p-2", 3, "href"], [1, "w-48", 3, "src"], [1, "mx-4", "mt-2", "w-[calc(100%-2rem)]", "rounded", "bg-base-200", "p-2", "text-center", "font-mono", "text-sm"], ["btn", "", "matRipple", "", 1, "mx-4", "my-2", "w-[calc(100%-2rem)]", 3, "click"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "bg-base-100", "bg-opacity-60"], ["diameter", "32"], [1, "absolute", "inset-0", "flex", "items-center", "justify-center", "bg-neutral"], [1, "rounded", "bg-base-100", "p-4", "shadow"], [1, "flex", "h-64", "w-64", "flex-col", "items-center", "justify-center", "rounded", "border-4", "border-dashed", "border-base-200"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"]], template: function DesksManageComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("filter", (tmp_5_0 = \u0275\u0275pipeBind1(2, 7, ctx.filters)) == null ? null : tmp_5_0.search)("data", ctx.desks)("columns", \u0275\u0275pureFunction8(45, _c82, \u0275\u0275pureFunction2(25, _c02, \u0275\u0275pipeBind1(3, 9, "APP.CONCIERGE.DESKS_ID"), name_template_r17), \u0275\u0275pureFunction1(28, _c12, \u0275\u0275pipeBind1(4, 11, "APP.CONCIERGE.DESKS_NAME")), \u0275\u0275pureFunction2(30, _c22, \u0275\u0275pipeBind1(5, 13, "COMMON.GROUPS"), item_list_template_r18), \u0275\u0275pureFunction1(33, _c32, assigned_template_r20), \u0275\u0275pureFunction2(35, _c42, \u0275\u0275pipeBind1(6, 15, "COMMON.FEATURES"), item_list_template_r18), \u0275\u0275pureFunction1(38, _c52, \u0275\u0275pipeBind1(7, 17, "APP.CONCIERGE.DESKS_SECURITY")), \u0275\u0275pureFunction2(40, _c62, \u0275\u0275pipeBind1(8, 19, "COMMON.BOOKABLE"), bool_template_r19), \u0275\u0275pureFunction1(43, _c72, action_template_r21)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(10, 23, ((tmp_9_0 = \u0275\u0275pipeBind1(9, 21, ctx.filters)) == null ? null : tmp_9_0.search) ? "APP.CONCIERGE.DESKS_MANAGE_SEARCH_EMPTY" : "APP.CONCIERGE.DESKS_MANAGE_EMPTY"));
        \u0275\u0275advance(20);
...
function NewDeskFormDetailsComponent_div_0_div_35_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(7, _c03));
    \u0275\u0275advance();
...
var _c04 = ["app-desks", ""];
var _c14 = () => ["/book", "desks", "events"];
var _c24 = () => ["/book", "desks", "map"];
var _c33 = () => ["/book", "desks", "manage"];
...
var DesksComponent = class _DesksComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DesksComponent, selectors: [["", "app-desks", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c04, decls: 15, vars: 12, consts: [[1, "relative", "flex", "w-1/2", "flex-1", "flex-col", "overflow-hidden", "bg-base-100"], [1, "w-full"], [1, "dark"], ["mat-tab-nav-bar", ""], ["mat-tab-link", "", "queryParamsHandling", "merge", 3, "routerLink", "active"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto"], ["class", "w-full", "mode", "indeterminate", 4, "ngIf"], ["mode", "indeterminate", 1, "w-full"]], template: function DesksComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "sidebar");
      ...
      if (rf & 2) {
        \u0275\u0275advance(5);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(9, _c14))("active", ctx.path === "events");
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(10, _c24))("active", ctx.path === "map");
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(11, _c33))("active", ctx.path === "manage");
        \u0275\u0275advance(4);
...
var NewDesksComponent = class _NewDesksComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDesksComponent, selectors: [["", "app-new-desks", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c05, decls: 23, vars: 15, consts: [[1, "print:hidden"], [1, "flex", "h-px", "flex-1", "print:hidden"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "w-full", "items-center", "space-x-2", "px-8", "py-4"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], [1, "mr-2", 3, "modelChange", "model"], ["btn", "", "matRipple", "", "class", "w-44 space-x-2", 3, "click", 4, "ngIf"], [1, "mb-4", "flex", "w-full", "items-center", "space-x-2", "px-8"], ["appearance", "outline", "class", "no-subscript w-60", 4, "ngIf"], [4, "ngIf"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], ["class", "w-full", "mode", "indeterminate", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "w-44", "space-x-2", 3, "click"], [1, "pl-2"], [1, "text-2xl"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "ngModelChange", "ngModel", "placeholder"], [3, "dateChange"], ["btn", "", "icon", "", "matRipple", "", 1, "ml-2", "rounded", "border", "border-base-200", 3, "click", "matTooltip", "disabled"], ["btn", "", "icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "matTooltip"], ["btn", "", "icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "matTooltip"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "matTooltip"], ["mode", "indeterminate", 1, "w-full"]], template: function NewDesksComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDesksComponent, { className: "NewDesksComponent", filePath: "apps/concierge/src/app/desks/new-desks.component.ts", lineNumber: 249 });
})();
...
//# sourceMappingURL=desks.module-OG5YA5LR.js.map
