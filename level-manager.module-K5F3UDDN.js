...
function LevelModalComponent_main_4_form_1_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(6, LevelModalComponent_main_4_form_1_div_1_mat_option_6_Template, 2, 2, "mat-option", 17);
    \u0275\u0275pipe(7, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "mat-error");
    \u0275\u0275text(9, "Building is required");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(7, 3, ctx_r1.building_list));
  }
}
function LevelModalComponent_main_4_form_1_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13)(1, "label", 19);
    \u0275\u0275i18n(2, 2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 15);
...
function LevelModalComponent_main_4_form_1_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13)(1, "label", 21);
    \u0275\u0275i18n(2, 3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 15);
...
function LevelModalComponent_main_4_form_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, LevelModalComponent_main_4_form_1_div_1_Template, 10, 5, "div", 11)(2, LevelModalComponent_main_4_form_1_div_2_Template, 5, 0, "div", 11)(3, LevelModalComponent_main_4_form_1_div_3_Template, 5, 0, "div", 11)(4, LevelModalComponent_main_4_form_1_div_4_Template, 3, 0, "div", 12);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LevelModalComponent_main_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, LevelModalComponent_main_4_form_1_Template, 5, 5, "form", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
_LevelModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LevelModalComponent, selectors: [["level-modal"]], decls: 8, vars: 5, consts: () => {
  let i18n_0;
  if (false) {
    const MSG_EXTERNAL_zoneLabel$$APPS_CONCIERGE_SRC_APP_LEVEL_MANAGER_LEVEL_MODAL_COMPONENT_TS_0 = goog.getMsg(" Building{$startTagSpan}*{$closeTagSpan}: ", { "closeTagSpan": "\uFFFD/#3\uFFFD", "startTagSpan": "\uFFFD#3\uFFFD" }, { original_code: { "closeTagSpan": "</span>", "startTagSpan": "<span>" } });
  ...
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, LevelModalComponent_button_3_Template, 3, 0, "button", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, LevelModalComponent_main_4_Template, 2, 1, "main", 5)(5, LevelModalComponent_footer_5_Template, 3, 0, "footer", 6)(6, LevelModalComponent_ng_template_6_Template, 4, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LevelModalComponent, { className: "LevelModalComponent", filePath: "apps/concierge/src/app/level-manager/level-modal.component.ts", lineNumber: 101 });
})();
...
//# sourceMappingURL=level-manager.module-K5F3UDDN.js.map
