...
function WeekViewEventComponent_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classMap("m-2 rounded border-2 bg-base-100 p-2 text-left font-normal text-black shadow " + ((ctx_r1.event == null ? null : ctx_r1.event.state) === "done" ? "done" : ctx_r1.event == null ? null : ctx_r1.event.type));
    \u0275\u0275advance(2);
...
var WeekViewEventComponent = class _WeekViewEventComponent {
  get time_format() {
  ...
  static {
    this.\u0275fac = function WeekViewEventComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WeekViewEventComponent, selectors: [["week-view-event"]], inputs: { event: "event" }, standalone: false, decls: 1, vars: 1, consts: [["content", "", "matRipple", "", 3, "class", "click", 4, "ngIf"], ["content", "", "matRipple", "", 3, "click"], [1, "text-base"], [1, "text-sm"]], template: function WeekViewEventComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WeekViewEventComponent, { className: "WeekViewEventComponent", filePath: "apps/concierge/src/app/week-view/week-view-event.component.ts", lineNumber: 63 });
})();
...
var WeekViewDayComponent = class _WeekViewDayComponent {
  constructor(_state) {
    this._state = _state;
  ...
  static {
    this.\u0275fac = function WeekViewDayComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _WeekViewDayComponent)(\u0275\u0275directiveInject(EventsStateService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WeekViewDayComponent, selectors: [["week-view-day"]], inputs: { index: "index" }, standalone: false, features: [\u0275\u0275NgOnChangesFeature], decls: 9, vars: 10, consts: [["empty_state", ""], [1, "flex", "w-full", "items-center", "justify-center", "border-b", "border-base-200", "bg-base-300", "py-3", "text-white"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto"], [4, "ngIf", "ngIfElse"], [3, "event", 4, "ngFor", "ngForOf"], [3, "event"], [1, "p-2", "text-center"]], template: function WeekViewDayComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WeekViewDayComponent, { className: "WeekViewDayComponent", filePath: "apps/concierge/src/app/week-view/week-view-day.component.ts", lineNumber: 40 });
})();
...
var WeekViewTimelineComponent = class _WeekViewTimelineComponent {
  constructor(_state) {
    this._state = _state;
  ...
  static {
    this.\u0275fac = function WeekViewTimelineComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _WeekViewTimelineComponent)(\u0275\u0275directiveInject(EventsStateService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WeekViewTimelineComponent, selectors: [["week-view-timeline"]], standalone: false, decls: 6, vars: 7, consts: [[1, "flex", "h-full", "divide-x", "border-base-200"], [4, "ngFor", "ngForOf"], ["mode", "indeterminate", 4, "ngIf"], [3, "event", 4, "ngIf"], [4, "ngIf"], [1, "h-full", "flex-1", 3, "index"], ["mode", "indeterminate"], [3, "event"]], template: function WeekViewTimelineComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WeekViewTimelineComponent, { className: "WeekViewTimelineComponent", filePath: "apps/concierge/src/app/week-view/week-view-timeline.component.ts", lineNumber: 42 });
})();

// apps/concierge/src/app/week-view/week-view-topbar.component.ts
function WeekViewTopbarComponent_mat_option_9_Template(rf, ctx) {
  if (rf & 1) {
...
var WeekViewTopbarComponent = class _WeekViewTopbarComponent extends AsyncHandler {
  ...
  static {
    this.\u0275fac = function WeekViewTopbarComponent_Factory(__ngFactoryType__) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WeekViewTopbarComponent, selectors: [["week-view-topbar"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 17, vars: 10, consts: [["btn", "", "matRipple", "", "new", "", 1, "w-12", "xl:w-auto", 3, "click"], [1, "flex", "items-center"], [1, "mr-2"], [1, "hidden", "xl:block"], ["appearance", "outline"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value", 4, "ngFor", "ngForOf"], [1, "m-2", 3, "ngModelChange", "ngModel"], [1, "text-xs"], [1, "w-0", "flex-1"], [3, "dateChange"], [3, "value"]], template: function WeekViewTopbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(9, WeekViewTopbarComponent_mat_option_9_Template, 2, 2, "mat-option", 6);
        \u0275\u0275pipe(10, "async");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(11, "mat-slide-toggle", 7);
        \u0275\u0275pipe(12, "async");
        \u0275\u0275listener("ngModelChange", function WeekViewTopbarComponent_Template_mat_slide_toggle_ngModelChange_11_listener($event) {
          return ctx.setWeekends($event);
        });
        \u0275\u0275elementStart(13, "div", 8);
        \u0275\u0275text(14, "Show weekends");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(15, "div", 9);
        \u0275\u0275elementStart(16, "date-options", 10);
        \u0275\u0275listener("dateChange", function WeekViewTopbarComponent_Template_date_options_dateChange_16_listener($event) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 4, "COMMON.LEVEL_ALL"));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(10, 6, ctx.levels));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngModel", (tmp_3_0 = \u0275\u0275pipeBind1(12, 8, ctx.options)) == null ? null : tmp_3_0.show_weekends);
      }
    }, dependencies: [NgForOf, NgControlStatus, NgModel, DateOptionsComponent, MatFormField, MatSelect, MatOption, MatSlideToggle, MatRipple, IconComponent, AsyncPipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  align-items: center;\n  background-color: var(--b1);\n  height: 5em;\n  padding: 0 1em;\n}\nbutton[_ngcontent-%COMP%] {\n  min-width: 0;\n  padding: 0 0.85rem;\n}\nmat-form-field[_ngcontent-%COMP%] {\n  height: 3.25em;\n  width: 8em;\n  margin-left: 1em;\n}\n/*# sourceMappingURL=week-view-topbar.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WeekViewTopbarComponent, { className: "WeekViewTopbarComponent", filePath: "apps/concierge/src/app/week-view/week-view-topbar.component.ts", lineNumber: 68 });
})();

// apps/concierge/src/app/week-view/week-view.component.ts
var _c0 = ["app-weekview", ""];
var WeekViewComponent = class _WeekViewComponent {
  static {
    this.\u0275fac = function WeekViewComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _WeekViewComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WeekViewComponent, selectors: [["", "app-weekview", ""]], standalone: false, attrs: _c0, decls: 4, vars: 0, consts: [[1, "relative", "overflow-hidden"]], template: function WeekViewComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "sidebar");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WeekViewComponent, { className: "WeekViewComponent", filePath: "apps/concierge/src/app/week-view/week-view.component.ts", lineNumber: 36 });
})();
...
var WeekViewModule = class _WeekViewModule {
  static {
    this.\u0275fac = function WeekViewModule_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _WeekViewModule)();
    };
  }
  static {
    this.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _WeekViewModule });
  }
  static {
...
//# sourceMappingURL=week-view.module-SQNTOVVI.js.map
