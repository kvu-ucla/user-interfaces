...
var _RegionManagementService = class _RegionManagementService {
  ...
  removeRegion(region) {
    return __async(this, null, function* () {
      ...
      yield Lc(region.id).toPromise().catch((e) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(RegionListComponent, [{
    ...
    `, standalone: false }]
  }], () => [{ type: RegionManagementService }, { type: Clipboard }, { type: MatDialog }], null);
})();
(() => {
...
(() => {
  ...
  }], () => [{ type: RegionManagementService }, { type: MatDialog }, { type: OrganisationService }], null);
})();
(() => {
...
//# sourceMappingURL=region-manager.module-TPV7NKC6.js.map
