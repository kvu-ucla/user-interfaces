...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleFilterCardComponent, { className: "ScheduleFilterCardComponent", filePath: "apps/workplace/src/app/schedule/schedule-filter-card.component.ts", lineNumber: 197 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleFiltersComponent, { className: "ScheduleFiltersComponent", filePath: "apps/workplace/src/app/schedule/schedule-filters.component.ts", lineNumber: 242 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleMobileCalendarComponent, { className: "ScheduleMobileCalendarComponent", filePath: "apps/workplace/src/app/schedule/schedule-mobile-calendar.component.ts", lineNumber: 81 });
})();
...
function ScheduleSidebarComponent_button_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 21)(2, "icon");
    \u0275\u0275text(3, "place");
    \u0275\u0275elementEnd()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleSidebarComponent, { className: "ScheduleSidebarComponent", filePath: "apps/workplace/src/app/schedule/schedule-sidebar.component.ts", lineNumber: 256 });
})();
...
function ScheduleComponent_ng_container_15_For_2_span_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ScheduleComponent_ng_container_15_For_2_For_5_event_card_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "event-card", 23);
  }
  if (rf & 2) {
    const item_r6 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275property("event", item_r6)("edit_fn", ctx_r2.edit_fn)("remove_fn", ctx_r2.remove_fn);
  }
}
function ScheduleComponent_ng_container_15_For_2_For_5_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "booking-card", 24);
  }
  if (rf & 2) {
    const item_r6 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275property("booking", item_r6)("edit_fn", ctx_r2.edit_booking_fn)("remove_fn", ctx_r2.remove_fn)("end_fn", ctx_r2.end_fn);
  }
}
function ScheduleComponent_ng_container_15_For_2_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ScheduleComponent_ng_container_15_For_2_For_5_event_card_0_Template, 1, 3, "event-card", 22)(1, ScheduleComponent_ng_container_15_For_2_For_5_ng_template_1_Template, 1, 4, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const item_r6 = ctx.$implicit;
    const booking_card_r7 = \u0275\u0275reference(2);
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275property("ngIf", ctx_r2.isEvent(item_r6))("ngIfElse", booking_card_r7);
  }
}
function ScheduleComponent_ng_container_15_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h3", 21);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
    \u0275\u0275template(3, ScheduleComponent_ng_container_15_For_2_span_3_Template, 3, 3, "span", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(4, ScheduleComponent_ng_container_15_For_2_For_5_Template, 3, 2, null, null, _forTrack1);
  }
  if (rf & 2) {
    const date_block_r8 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 2, date_block_r8.date, "EEE dd LLL yyyy"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", date_block_r8.is_today);
    \u0275\u0275advance();
    \u0275\u0275repeater(date_block_r8.bookings);
  }
}
function ScheduleComponent_ng_container_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275repeaterCreate(1, ScheduleComponent_ng_container_15_For_2_Template, 6, 5, null, null, _forTrack0);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(\u0275\u0275pipeBind1(3, 0, ctx_r2.booking_dates));
  }
}
...
var ScheduleComponent = class _ScheduleComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleComponent, selectors: [["app-schedule"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 22, vars: 21, consts: [["empty_state", ""], ["booking_card", ""], [4, "ngIf"], [1, "relative", "flex", "h-1/2", "flex-1", "flex-col", "bg-base-200", "sm:flex-row"], [1, "hidden", "bg-base-100", "sm:block"], [1, "w-full", "border-b", "border-neutral", "bg-base-100", "sm:hidden"], [1, "flex", "items-center", "space-x-2", "px-2", "pt-2"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "click"], [3, "ngModel", "ngModelChange", 4, "ngIf"], ["class", "my-2 w-full px-2", 4, "ngIf"], [1, "h-full", "flex-1", "space-y-2", "overflow-auto", "p-4"], [4, "ngIf", "ngIfElse"], ["class", "absolute inset-x-0 bottom-0", "mode", "indeterminate", 4, "ngIf"], [3, "ngModelChange", "ngModel"], [1, "my-2", "w-full", "px-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], [3, "ngModelChange", "ngModel", "placeholder"], ["class", "leading-tight", 3, "value", 4, "ngFor", "ngForOf"], [1, "leading-tight", 3, "value"], ["class", "px-1 text-xs text-info", 3, "matTooltip", 4, "ngIf"], [1, "px-1", "text-xs", "text-info", 3, "matTooltip"], [1, "my-2", "font-medium"], [3, "event", "edit_fn", "remove_fn", 4, "ngIf", "ngIfElse"], [3, "event", "edit_fn", "remove_fn"], [3, "booking", "edit_fn", "remove_fn", "end_fn"], ["mode", "indeterminate", 1, "absolute", "inset-x-0", "bottom-0"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "space-y-4", "p-8"], ["src", "assets/img/no-events.svg", 1, "mr-4"], [1, "opacity-30"]], template: function ScheduleComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        ...
        \u0275\u0275template(15, ScheduleComponent_ng_container_15_Template, 4, 2, "ng-container", 11);
        \u0275\u0275pipe(16, "async");
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", ctx.period === "week");
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", (tmp_8_0 = \u0275\u0275pipeBind1(16, 17, ctx.booking_dates)) == null ? null : tmp_8_0.length)("ngIfElse", empty_state_r9);
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleComponent, { className: "ScheduleComponent", filePath: "apps/workplace/src/app/schedule/schedule.component.ts", lineNumber: 164 });
})();
...
//# sourceMappingURL=schedule.module-S6SJSIWS.js.map
