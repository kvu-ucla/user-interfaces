...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringItemModalComponent, { className: "CateringItemModalComponent", filePath: "libs/catering/src/lib/catering-item-modal.component.ts", lineNumber: 282 });
})();
...
function CateringItemDetailsComponent_ng_container_0_div_21_ng_container_4_mat_radio_button_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, CateringItemDetailsComponent_ng_container_0_div_21_ng_container_4_mat_radio_button_5_div_4_Template, 3, 4, "div", 32);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const opt_r6 = ctx.$implicit;
...
function CateringItemDetailsComponent_ng_container_0_div_21_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(2, "mat-radio-button", 26)(3, "span", 27);
    \u0275\u0275text(4, "None");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(5, CateringItemDetailsComponent_ng_container_0_div_21_ng_container_4_mat_radio_button_5_Template, 5, 3, "mat-radio-button", 28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function CateringItemDetailsComponent_ng_container_0_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(4, CateringItemDetailsComponent_ng_container_0_div_21_ng_container_4_Template, 6, 3, "ng-container", 2)(5, CateringItemDetailsComponent_ng_container_0_div_21_ng_template_5_Template, 1, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function CateringItemDetailsComponent_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, " Select an item to view it's details ");
    \u0275\u0275elementEnd()();
  }
}
var CateringItemDetailsComponent = class _CateringItemDetailsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringItemDetailsComponent, selectors: [["catering-item-details"]], inputs: { item: "item", active: "active", fav: "fav", code: "code" }, outputs: { toggleFav: "toggleFav", activeChange: "activeChange", close: "close" }, features: [\u0275\u0275NgOnChangesFeature], decls: 3, vars: 2, consts: [["empty_state", ""], ["multi_options", ""], [4, "ngIf", "ngIfElse"], ["image", "", 1, "relative", "w-full", "h-64", "sm:h-40", "bg-neutral"], [1, "absolute", "inset-0", 3, "images"], ["icon", "", "matRipple", "", "name", "close-catering-item-details", 1, "absolute", "top-2", "left-2", "bg-neutral", "sm:hidden", "text-white", 3, "click"], ["icon", "", "matRipple", "", "name", "toggle-catering-item-favourite-details", 1, "absolute", "top-2", "right-2", "bg-neutral", 3, "click"], [1, "p-2", "space-y-2", "flex-1", "h-1/2", "overflow-auto"], ["actions", "", 1, "z-0", "flex", "items-center", "justify-between"], [1, "text-xl", "font-medium", "mb-2", "mt-4"], [4, "ngIf"], [3, "ngModelChange", "ngModel", "min", "max"], [1, "flex", "items-center", "flex-wrap"], ["class", "px-2 py-1 rounded-2xl bg-base-200 text-sm capitalize m-1", 4, "ngFor", "ngForOf"], ["details", "", 1, "space-y-2"], [1, "flex", "flex-col", "flex-wrap"], ["class", "min-w-1/2 flex-1", 4, "ngFor", "ngForOf"], [1, "px-2", "pt-2", "pb-[5.5rem]", "border-t", "border-base-200", "shadow", "sm:hidden"], ["btn", "", "matRipple", "", "name", "select-catering-item-details", 1, "w-full", 3, "click"], [1, "flex", "items-center", "justify-center"], [1, "text-2xl"], [1, "px-2", "py-1", "rounded-2xl", "bg-base-200", "text-sm", "capitalize", "m-1"], [1, "min-w-1/2", "flex-1"], [1, "font-medium", "p-2", "capitalize"], [1, "flex", "flex-col", "pl-4"], ["aria-label", "Select an option", 1, "flex", "flex-col", 3, "ngModelChange", "ngModel", "disabled"], ["value", "", 1, "m-0"], [1, "font-medium", "p-2"], ["class", "m-0", 3, "value", 4, "ngFor", "ngForOf"], [1, "m-0", 3, "value"], [1, "flex", "items-center", "justify-center", "max-w-[calc(100vw-4rem)]", "sm:max-w-[15rem]"], [1, "font-medium", "p-2", "flex-1", "w-1/2", "whitespace-normal"], ["class", "opacity-60 text-xs", 4, "ngIf"], [1, "opacity-60", "text-xs"], [3, "ngModel", "disabled", "ngModelChange", 4, "ngFor", "ngForOf"], [3, "ngModelChange", "ngModel", "disabled"], [1, "font-medium", "p-2", "flex-1", "w-1/2"], ["empty", "", 1, "p-16", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "opacity-30", "text-center"]], template: function CateringItemDetailsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, CateringItemDetailsComponent_ng_container_0_Template, 29, 17, "ng-container", 2)(1, CateringItemDetailsComponent_ng_template_1_Template, 3, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
...
function CateringItemFiltersComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "Caterer:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 1)(4, "mat-select", 11);
    \u0275\u0275pipe(5, "async");
    \u0275\u0275pipe(6, "async");
    ...
    \u0275\u0275template(7, CateringItemFiltersComponent_div_6_mat_option_7_Template, 2, 2, "mat-option", 12);
    \u0275\u0275pipe(8, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function CateringItemFiltersComponent_div_9_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 19)(4, "mat-select", 11);
    ...
    \u0275\u0275template(5, CateringItemFiltersComponent_div_9_ng_container_3_mat_option_5_Template, 3, 5, "mat-option", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function CateringItemFiltersComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, " Exact Time ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, CateringItemFiltersComponent_div_9_ng_container_3_Template, 6, 2, "ng-container", 17);
    \u0275\u0275elementStart(4, "label");
    \u0275\u0275text(5, "Deliver After:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "a-duration-field", 18);
    \u0275\u0275pipe(7, "async");
...
var CateringItemFiltersComponent = class _CateringItemFiltersComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringItemFiltersComponent, selectors: [["catering-item-filters"]], inputs: { search: "search", at_time: "at_time", offset: "offset", offset_day: "offset_day" }, outputs: { at_timeChange: "at_timeChange", offsetChange: "offsetChange", offset_dayChange: "offset_dayChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 14, vars: 18, consts: [[1, "px-4", "mt-3", "mb-2"], ["appearance", "outline", 1, "w-full", "h-14"], ["matPrefix", "", 1, "text-xl"], ["matInput", "", "placeholder", "Search menu...", 3, "ngModelChange", "ngModel"], ["class", "hidden sm:block px-2 py-2", 4, "ngIf"], ["class", "hidden sm:block font-medium px-2 py-2", 4, "ngIf"], ["class", "flex flex-col px-2", 4, "ngIf"], ["class", "hidden sm:block font-medium px-2 py-4", 4, "ngIf"], [1, "flex", "flex-col", "px-2", "space-y-4"], [3, "ngModel", "ngModelChange", 4, "ngFor", "ngForOf"], [1, "hidden", "sm:block", "px-2", "py-2"], [3, "ngModelChange", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [1, "hidden", "sm:block", "font-medium", "px-2", "py-2"], [1, "flex", "flex-col", "px-2"], [3, "ngModelChange", "ngModel", "matTooltip"], [4, "ngIf"], [3, "ngModelChange", "ngModel", "time", "step", "min", "max", "use_24hr"], ["appearance", "outline", 1, "w-full", "no-subscript", "mb-4"], [1, "hidden", "sm:block", "font-medium", "px-2", "py-4"]], template: function CateringItemFiltersComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(6, CateringItemFiltersComponent_div_6_Template, 9, 8, "div", 4);
        \u0275\u0275pipe(7, "async");
        \u0275\u0275template(8, CateringItemFiltersComponent_h3_8_Template, 2, 0, "h3", 5)(9, CateringItemFiltersComponent_div_9_Template, 8, 11, "div", 6)(10, CateringItemFiltersComponent_h3_10_Template, 2, 0, "h3", 7);
        \u0275\u0275elementStart(11, "div", 8);
        \u0275\u0275template(12, CateringItemFiltersComponent_mat_checkbox_12_Template, 3, 5, "mat-checkbox", 9);
        \u0275\u0275pipe(13, "async");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewCateringOrderModalComponent, selectors: [["new-catering-order-modal"]], decls: 32, vars: 28, consts: [[1, "w-[100vw]", "h-[100vh]", "sm:relative", "sm:w-auto", "sm:h-auto", "flex", "flex-col", "bg-base-100"], [1, "flex", "items-center", "space-x-4", "w-full"], ["icon", "", "matRipple", "", 1, "bg-neutral", 3, "mat-dialog-close"], [1, "flex-1", "flex", "items-center", "divide-x", "divide-base-200", "min-h-[65vh]", "h-[65vh]", "sm:max-h-[65vh]", "sm:max-w-[95vw]", "w-full", "overflow-hidden"], [1, "h-full", "hidden", "sm:block", "sm:max-w-[12rem]", "sm:h-[65vh]", "sm:max-h-full", 3, "at_timeChange", "offsetChange", "offset_dayChange", "at_time", "offset", "offset_day"], [1, "flex", "flex-col", "items-center", "flex-1", "w-1/2", "h-full", "sm:h-[65vh]"], [1, "w-full", "border-b", "border-base-200", 3, "search"], [1, "flex-1", "h-1/2", "w-full", "overflow-hidden", 3, "toggleFav", "onSelect", "active", "selected", "selected_items", "favorites"], [1, "h-full", "w-full", "sm:h-[65vh]", "absolute", "sm:relative", "sm:flex", "sm:max-w-[16rem]", "z-20", "bg-base-100", 3, "activeChange", "toggleFav", "close", "item", "active", "code", "fav"], [1, "flex", "sm:hidden", "flex-col-reverse", "items-center", "justify-end", "px-2", "pt-2", "pb-[5.5rem]", "border-t", "border-base-200", "w-full"], ["btn", "", "matRipple", "", "name", "catering-item-return", "class", "inverse sm:hidden w-full sm:w-auto", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", "name", "save-catering-item", 1, "w-full", "sm:w-auto", "sm:mb-0", 3, "mat-dialog-close"], [1, "hidden", "sm:flex", "items-center", "justify-between", "p-2", "border-t", "border-base-200", "w-full"], ["btn", "", "matRipple", "", "name", "catering-item-return", 1, "clear", "text-secondary", 3, "mat-dialog-close"], [1, "flex", "items-center"], [1, "text-xl"], [1, "mr-1", "underline"], [1, "opacity-60", "text-sm"], ["btn", "", "matRipple", "", "name", "toggle-catering-item", 3, "click", "disabled"], [1, "mr-1"], ["btn", "", "matRipple", "", "name", "catering-item-return", 1, "inverse", "sm:hidden", "w-full", "sm:w-auto", 3, "click"]], template: function NewCateringOrderModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(10, "catering-item-filters", 6);
        \u0275\u0275elementStart(11, "catering-item-list", 7);
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(12, "catering-item-details", 8);
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(13, "footer", 9);
        \u0275\u0275template(14, NewCateringOrderModalComponent_button_14_Template, 2, 0, "button", 10);
        \u0275\u0275elementStart(15, "button", 11);
        \u0275\u0275text(16, " View List ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(17, "footer", 12)(18, "button", 13)(19, "div", 14)(20, "app-icon", 15);
        \u0275\u0275text(21, "arrow_back");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(22, "div", 16);
        \u0275\u0275text(23, "Back to form");
        \u0275\u0275elementEnd()()();
        ...
        \u0275\u0275elementStart(27, "div", 14)(28, "app-icon", 15);
        \u0275\u0275text(29);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("mat-dialog-close", ctx.selected);
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate1("", ctx.count, " items(s) added");
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewCateringOrderModalComponent, { className: "NewCateringOrderModalComponent", filePath: "libs/catering/src/lib/catering-order-modal/new-catering-order-modal.component.ts", lineNumber: 140 });
})();
...
var BookComponent = class _BookComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookComponent, selectors: [["placeos-book"]], decls: 5, vars: 2, consts: [[4, "ngIf"], [1, "flex-1", "flex", "sm:flex-row", "flex-col-reverse", "h-1/2"], [1, "flex", "flex-col", "flex-1", "h-1/2", "sm:h-auto", "overflow-hidden"], ["class", "z-10", 4, "ngIf"], [1, "z-10"]], template: function BookComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var BookSpaceFlowComponent = class _BookSpaceFlowComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookSpaceFlowComponent, selectors: [["placeos-book-space-flow"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 6, vars: 4, consts: [[1, "bg-base-100", "h-full", "w-full"], [3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"], [3, "calendar"]], template: function BookSpaceFlowComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275elementContainerStart(1, 1);
...
var SpacePingComponent = class _SpacePingComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpacePingComponent, selectors: [["space-ping"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 2, consts: [[1, "absolute", "inset-0", "pointer-events-auto"], [1, "absolute", "inset-0", "animate-ping", "border-4", "border-green-600"]], template: function SpacePingComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275element(1, "div", 1);
        \u0275\u0275elementEnd();
...
var ParkingFlowConfirmComponent = class _ParkingFlowConfirmComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingFlowConfirmComponent, selectors: [["parking-flow-confirm"]], decls: 0, vars: 0, template: function ParkingFlowConfirmComponent_Template(rf, ctx) {
    } });
  }
};
(() => {
...
function MeetingFlowConfirmModalComponent_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "Booked Room");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, MeetingFlowConfirmModalComponent_div_28_ng_container_6_Template, 6, 2, "ng-container", 23);
    \u0275\u0275elementStart(7, "div", 10)(8, "app-icon", 11);
    \u0275\u0275text(9, "place");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div");
    \u0275\u0275text(11);
...
function MeetingFlowConfirmModalComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 25)(7, "mat-chip-list", 26, 0);
    \u0275\u0275template(9, MeetingFlowConfirmModalComponent_div_29_mat_chip_9_Template, 5, 1, "mat-chip", 23);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", ctx_r0.event.attendees.length, " Attendee(s) ");
    \u0275\u0275advance(4);
...
function MeetingFlowConfirmModalComponent_div_30_div_1_div_7_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, MeetingFlowConfirmModalComponent_div_30_div_1_div_7_div_14_span_4_Template, 2, 2, "span", 44);
    \u0275\u0275elementEnd();
...
function MeetingFlowConfirmModalComponent_div_30_div_1_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, MeetingFlowConfirmModalComponent_div_30_div_1_div_7_div_6_Template, 3, 1, "div", 35);
    \u0275\u0275element(7, "div", 36);
    ...
    \u0275\u0275template(14, MeetingFlowConfirmModalComponent_div_30_div_1_div_7_div_14_Template, 13, 11, "div", 40);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function MeetingFlowConfirmModalComponent_div_30_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(7, MeetingFlowConfirmModalComponent_div_30_div_1_div_7_Template, 15, 15, "div", 30);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function MeetingFlowConfirmModalComponent_div_30_div_2_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, MeetingFlowConfirmModalComponent_div_30_div_2_div_6_div_6_Template, 3, 1, "div", 35);
    \u0275\u0275element(7, "div", 36);
    \u0275\u0275elementStart(8, "div", 37);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "div", 39);
    \u0275\u0275template(11, MeetingFlowConfirmModalComponent_div_30_div_2_div_6_div_11_Template, 6, 2, "div", 40);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function MeetingFlowConfirmModalComponent_div_30_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "Assets");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, MeetingFlowConfirmModalComponent_div_30_div_2_div_6_Template, 12, 11, "div", 48);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function MeetingFlowConfirmModalComponent_div_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, MeetingFlowConfirmModalComponent_div_30_div_1_Template, 8, 1, "div", 17)(2, MeetingFlowConfirmModalComponent_div_30_div_2_Template, 7, 6, "div", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowConfirmModalComponent, selectors: [["meeting-flow-confirm-modal"]], inputs: { show_close: "show_close" }, features: [\u0275\u0275ProvidersFeature([SpacePipe]), \u0275\u0275InheritDefinitionFeature], decls: 34, vars: 20, consts: [["chipList", ""], ["header", "", 1, "p-4", "flex", "items-center", "justify-center", "border-b", "border-base-200", "relative"], ["icon", "", "name", "close-meeting-confirm", "matRipple", "", "mat-dialog-close", "", "class", "absolute left-2 top-1/2 -translate-y-1/2", 4, "ngIf"], [1, "text-xl", "font-medium"], ["diameter", "32", 1, "absolute", "right-2", "top-1/2", "-translate-y-1/2"], [1, "flex-1", "min-w-[48rem]", "divide-y", "divide-base-200", "p-4", "space-y-4", "max-h-[65vh]", "overflow-auto"], [1, "flex", "divide-x", "divide-base-200"], [1, "pr-4", "py-4", "pl-16", "relative", "space-y-2", "flex-1"], [1, "absolute", "top-4", "left-4", "flex", "items-center", "justify-center", "rounded-full", "border", "border-success", "text-success", "text-2xl"], [1, "text-xl", "!mt-0"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], ["date", ""], ["class", "flex items-center space-x-2", 4, "ngIf"], [1, "flex", "flex-col", "leading-tight"], ["time", ""], ["class", "text-xs opacity-30", 4, "ngIf"], ["class", "pr-4 py-4 pl-16 relative space-y-2 flex-1", 4, "ngIf"], ["class", "pr-4 py-4 pl-16 relative space-y-2", 4, "ngIf"], ["class", "flex divide-x divide-base-200", 4, "ngIf"], ["class", "p-2 border-t border-base-200 flex items-center justify-end", 4, "ngIf"], ["icon", "", "name", "close-meeting-confirm", "matRipple", "", "mat-dialog-close", "", 1, "absolute", "left-2", "top-1/2", "-translate-y-1/2"], [1, "text-xs", "opacity-30"], [4, "ngFor", "ngForOf"], [1, "pr-4", "py-4", "pl-16", "relative", "space-y-2"], ["attendee-list", ""], ["aria-label", "User selection"], [1, "flex", "items-center"], [1, "mr-2"], [1, "flex", "flex-col", "space-y-2"], ["order", "", "class", "border bg-base-100 rounded-xl overflow-hidden", 3, "border-error", "border-base-300", 4, "ngFor", "ngForOf"], ["order", "", 1, "border", "bg-base-100", "rounded-xl", "overflow-hidden"], [1, "flex", "items-center", "space-x-2", "p-3"], [1, "flex-1", "flex", "items-center", "space-x-2"], [1, "text-sm"], ["class", "flex items-center justify-center h-6 w-6 rounded-full bg-error text-error-content", 3, "matTooltip", 4, "ngIf"], [1, "flex-1"], [1, "text-xs", "bg-success", "text-success-content", "px-2", "py-1", "rounded"], [1, "text-xs", "bg-info", "text-info-content", "px-2", "py-1", "rounded"], [1, "flex", "flex-col", "bg-base-200", "divide-y", "divide-base-100"], ["class", "flex items-center px-3 py-1 space-x-2 hover:opacity-90", 4, "ngFor", "ngForOf"], [1, "flex", "items-center", "justify-center", "h-6", "w-6", "rounded-full", "bg-error", "text-error-content", 3, "matTooltip"], [1, "flex", "items-center", "px-3", "py-1", "space-x-2", "hover:opacity-90"], [1, "flex", "items-center", "flex-1"], ["class", "text-xs opacity-60 ml-4 font-normal", 3, "matTooltip", 4, "ngIf"], [1, "rounded", "bg-success", "text-success-content", "text-xs", "px-2", "py-1"], [1, "rounded", "bg-info", "text-info-content", "text-xs", "px-2", "py-1"], [1, "text-xs", "opacity-60", "ml-4", "font-normal", 3, "matTooltip"], ["request", "", "class", "border bg-base-100 rounded-xl overflow-hidden", 3, "border-error", "border-base-300", 4, "ngFor", "ngForOf"], ["request", "", 1, "border", "bg-base-100", "rounded-xl", "overflow-hidden"], [3, "innerHTML"], [1, "p-2", "border-t", "border-base-200", "flex", "items-center", "justify-end"], ["btn", "", "name", "confirm-meeting", "matRipple", "", 1, "w-32", 3, "click"]], template: function MeetingFlowConfirmModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(19, "date");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(20, MeetingFlowConfirmModalComponent_div_20_Template, 5, 1, "div", 13);
        \u0275\u0275elementStart(21, "div", 10)(22, "app-icon", 11);
        \u0275\u0275text(23, "schedule");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(24, "div", 14)(25, "div", 15);
        \u0275\u0275text(26);
        \u0275\u0275elementEnd();
        \u0275\u0275template(27, MeetingFlowConfirmModalComponent_div_27_Template, 2, 1, "div", 16);
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(28, MeetingFlowConfirmModalComponent_div_28_Template, 12, 2, "div", 17);
        \u0275\u0275elementEnd();
        \u0275\u0275template(29, MeetingFlowConfirmModalComponent_div_29_Template, 10, 2, "div", 18)(30, MeetingFlowConfirmModalComponent_div_30_Template, 3, 2, "div", 19)(31, MeetingFlowConfirmModalComponent_div_31_Template, 8, 3, "div", 18);
        \u0275\u0275elementEnd();
        \u0275\u0275template(32, MeetingFlowConfirmModalComponent_footer_32_Template, 3, 0, "footer", 20);
        \u0275\u0275pipe(33, "async");
      }
      if (rf & 2) {
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowConfirmModalComponent, { className: "MeetingFlowConfirmModalComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-confirm-modal.component.ts", lineNumber: 342 });
})();
...
function MeetingFlowConfirmComponent_section_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 22)(7, "mat-chip-list", 23, 0);
    \u0275\u0275template(9, MeetingFlowConfirmComponent_section_26_mat_chip_9_Template, 5, 1, "mat-chip", 24);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r1.event.attendees.length, " Attendee(s)");
    \u0275\u0275advance(4);
...
function MeetingFlowConfirmComponent_section_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "Booked Room");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, MeetingFlowConfirmComponent_section_27_ng_container_6_Template, 6, 2, "ng-container", 24);
    \u0275\u0275elementStart(7, "div", 7)(8, "app-icon", 8);
    \u0275\u0275text(9, "place");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div");
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowConfirmComponent, selectors: [["meeting-flow-confirm"]], inputs: { show_close: "show_close" }, features: [\u0275\u0275ProvidersFeature([SpacePipe]), \u0275\u0275InheritDefinitionFeature], decls: 31, vars: 17, consts: [["chipList", ""], ["icon", "", "matRipple", "", "name", "close-meeting-confirm", 3, "click", 4, "ngIf"], [1, "flex", "items-center", "justify-between", "px-2"], ["diameter", "32", 4, "ngIf"], ["period", "", 1, "flex", "space-x-1", "px-2"], [1, "text-success", "mt-1"], ["details", "", 1, "leading-6"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], ["date", ""], ["class", "flex items-center space-x-2", 4, "ngIf"], [1, "flex", "flex-col", "leading-tight"], ["time", ""], ["class", "text-xs opacity-30", 4, "ngIf"], ["attendees", "", "class", "flex space-x-1 px-2", 4, "ngIf"], ["spaces", "", "class", "flex space-x-1 px-2", 4, "ngIf"], [1, "p-2", "w-full", "border-t", "border-base-200", "mt-4"], ["btn", "", "name", "confirm-meeting", "matRipple", "", "class", "w-full", 3, "click", 4, "ngIf"], ["icon", "", "matRipple", "", "name", "close-meeting-confirm", 3, "click"], ["diameter", "32"], [1, "text-xs", "opacity-30"], ["attendees", "", 1, "flex", "space-x-1", "px-2"], ["attendee-list", ""], ["aria-label", "User selection"], [4, "ngFor", "ngForOf"], [1, "flex", "items-center"], [1, "mr-2"], ["spaces", "", 1, "flex", "space-x-1", "px-2"], ["btn", "", "name", "confirm-meeting", "matRipple", "", 1, "w-full", 3, "click"]], template: function MeetingFlowConfirmComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(5, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "section", 4)(7, "app-icon", 5);
        \u0275\u0275text(8, "done");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(9, "div", 6)(10, "h3");
        \u0275\u0275text(11);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(12, "div", 7)(13, "app-icon", 8);
        \u0275\u0275text(14, "today");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275pipe(17, "date");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(18, MeetingFlowConfirmComponent_div_18_Template, 5, 1, "div", 10);
        \u0275\u0275elementStart(19, "div", 7)(20, "app-icon", 8);
        \u0275\u0275text(21, "schedule");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(22, "div", 11)(23, "div", 12);
        \u0275\u0275text(24);
        \u0275\u0275elementEnd();
        \u0275\u0275template(25, MeetingFlowConfirmComponent_div_25_Template, 2, 1, "div", 13);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(26, MeetingFlowConfirmComponent_section_26_Template, 10, 2, "section", 14)(27, MeetingFlowConfirmComponent_section_27_Template, 12, 2, "section", 15);
        \u0275\u0275elementStart(28, "footer", 16);
        \u0275\u0275template(29, MeetingFlowConfirmComponent_button_29_Template, 2, 0, "button", 17);
        \u0275\u0275pipe(30, "async");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowConfirmComponent, { className: "MeetingFlowConfirmComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-confirm.component.ts", lineNumber: 146 });
})();
...
function MeetingFormDetailsComponent_div_0_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, MeetingFormDetailsComponent_div_0_div_11_mat_checkbox_9_Template, 3, 3, "mat-checkbox", 14);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function MeetingFormDetailsComponent_div_0_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, MeetingFormDetailsComponent_div_0_div_12_mat_checkbox_10_Template, 3, 3, "mat-checkbox", 14);
    \u0275\u0275elementEnd();
...
function MeetingFormDetailsComponent_div_0_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, MeetingFormDetailsComponent_div_0_div_13_div_8_Template, 7, 10, "div", 22)(9, MeetingFormDetailsComponent_div_0_div_13_div_9_Template, 7, 7, "div", 22);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function MeetingFormDetailsComponent_div_0_div_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(7, MeetingFormDetailsComponent_div_0_div_15_mat_checkbox_7_Template, 2, 0, "mat-checkbox", 31);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function MeetingFormDetailsComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(11, MeetingFormDetailsComponent_div_0_div_11_Template, 10, 10, "div", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275template(12, MeetingFormDetailsComponent_div_0_div_12_Template, 20, 22, "div", 8)(13, MeetingFormDetailsComponent_div_0_div_13_Template, 10, 10, "div", 9)(14, MeetingFormDetailsComponent_div_0_div_14_Template, 7, 3, "div", 10)(15, MeetingFormDetailsComponent_div_0_div_15_Template, 8, 5, "div", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("formGroup", ctx_r0.form);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 8, "FORM.TITLE"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(10, 10, "FORM.TITLE_ERROR"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !ctx_r0.allow_multiday);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.allow_multiday);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFormDetailsComponent, { className: "MeetingFormDetailsComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-form-details.component.ts", lineNumber: 180 });
})();
...
function MeetingFlowFormComponent_form_5_section_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 6, "FORM.ATTENDEES"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 8, "WPA.AVAILABILITY"), " ");
    \u0275\u0275advance(4);
...
function MeetingFlowFormComponent_form_5_section_29_mat_form_field_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "mat-select", 31)(2, "input", 32, 0);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "mat-option", 33);
    \u0275\u0275template(5, MeetingFlowFormComponent_form_5_section_29_mat_form_field_13_mat_option_5_Template, 2, 2, "mat-option", 34);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275elementEnd();
...
function MeetingFlowFormComponent_form_5_section_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(13, MeetingFlowFormComponent_form_5_section_29_mat_form_field_13_Template, 9, 6, "mat-form-field", 28);
    \u0275\u0275pipe(14, "async");
    \u0275\u0275template(15, MeetingFlowFormComponent_form_5_section_29_mat_form_field_15_Template, 5, 4, "mat-form-field", 29);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MeetingFlowFormComponent_form_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(27, MeetingFlowFormComponent_form_5_div_27_Template, 2, 0, "div", 17);
    \u0275\u0275element(28, "space-list-field", 18);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(29, MeetingFlowFormComponent_form_5_section_29_Template, 16, 15, "section", 14);
    \u0275\u0275pipe(30, "async");
    \u0275\u0275template(31, MeetingFlowFormComponent_form_5_section_31_Template, 14, 15, "section", 14)(32, MeetingFlowFormComponent_form_5_section_32_Template, 14, 11, "section", 14);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", !!ctx_r1.form.value.id ? "Reset" : "Clear", " ", \u0275\u0275pipeBind1(39, 25, "WPA.CLEAR_FORM"), " ");
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowFormComponent, { className: "MeetingFlowFormComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-form.component.ts", lineNumber: 383 });
})();
...
function MeetingFlowSuccessComponent_span_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275template(2, MeetingFlowSuccessComponent_span_8_span_2_Template, 2, 0, "span", 5);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" room booking for ", (ctx_r0.level == null ? null : ctx_r0.level.display_name) || (ctx_r0.level == null ? null : ctx_r0.level.name), "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.level);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", (ctx_r0.space == null ? null : ctx_r0.space.display_name) || (ctx_r0.space == null ? null : ctx_r0.space.name), " ");
  }
}
...
function MeetingFlowSuccessComponent_span_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" at ", \u0275\u0275pipeBind2(2, 2, ctx_r0.last_event.date, ctx_r0.time_format), "-", \u0275\u0275pipeBind2(3, 5, ctx_r0.last_event.date + ctx_r0.last_event.duration * 60 * 1e3, ctx_r0.time_format), "");
  }
}
function MeetingFlowSuccessComponent_p_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
...
function MeetingFlowSuccessComponent_button_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 10);
    \u0275\u0275listener("click", function MeetingFlowSuccessComponent_button_16_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
...
var MeetingFlowSuccessComponent = class _MeetingFlowSuccessComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowSuccessComponent, selectors: [["meeting-flow-success"]], decls: 21, vars: 17, consts: [[1, "absolute", "inset-0", "bg-base-100", "flex", "flex-col", "z-50", "overflow-auto"], [1, "flex-1", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium"], ["src", "assets/icons/success.svg"], [1, "text-center", "max-w-[32rem]"], [4, "ngIf"], [1, "h-4"], ["btn", "", "matRipple", "", "class", "w-48", 3, "click", 4, "ngIf"], [1, "sticky", "bottom-0", "bg-base-100", "p-2", "w-full", "border-t", "border-base-200", "mt-4", "flex", "items-center", "justify-center"], ["btn", "", "name", "meeting-created-continue", "matRipple", "", 1, "w-full", "max-w-[32rem]", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click"]], template: function MeetingFlowSuccessComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(7, " Your ");
        \u0275\u0275template(8, MeetingFlowSuccessComponent_span_8_Template, 4, 3, "span", 5)(9, MeetingFlowSuccessComponent_span_9_Template, 2, 0, "span", 5);
        \u0275\u0275text(10);
        \u0275\u0275pipe(11, "date");
        \u0275\u0275template(12, MeetingFlowSuccessComponent_span_12_Template, 4, 8, "span", 5);
        \u0275\u0275text(13, ". ");
        \u0275\u0275elementEnd();
        \u0275\u0275template(14, MeetingFlowSuccessComponent_p_14_Template, 2, 0, "p", 5);
        \u0275\u0275element(15, "div", 6);
        \u0275\u0275template(16, MeetingFlowSuccessComponent_button_16_Template, 2, 0, "button", 7);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(17, "footer", 8)(18, "a", 9);
        \u0275\u0275text(19);
        \u0275\u0275pipe(20, "translate");
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", !ctx.space);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" has been successfully booked for ", \u0275\u0275pipeBind2(11, 11, ctx.last_event.date, "mediumDate"), "");
        \u0275\u0275advance(2);
        ...
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(20, 14, "WPA.BOOKING_DONE_CONTINUE"), " ");
      }
...
var BookMeetingFlowComponent = class _BookMeetingFlowComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookMeetingFlowComponent, selectors: [["placeos-book-meeting-flow"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 3, consts: [[1, "bg-base-100", "h-full", "w-full", "z-50", 3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"]], template: function BookMeetingFlowComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
...
function NewDeskFlowConfirmComponent_section_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 22)(1, "app-icon", 5);
    \u0275\u0275text(2, "done");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 6)(4, "h3", 23);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 7)(7, "app-icon");
    \u0275\u0275text(8, "person");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(11, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 7)(13, "app-icon");
    \u0275\u0275text(14, "place");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div");
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(17, NewDeskFlowConfirmComponent_section_26_ng_container_17_Template, 6, 1, "ng-container", 24);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(11, 4, ctx_r1.is_group) ? "Multiple Desks" : "Single desk");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r1.location);
    \u0275\u0275advance();
...
function NewDeskFlowConfirmComponent_section_27_div_6_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38)(1, "app-icon");
    \u0275\u0275text(2, "priority_high");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function NewDeskFlowConfirmComponent_section_27_div_6_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39)(1, "div", 40)(2, "span", 32);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
...
function NewDeskFlowConfirmComponent_section_27_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, NewDeskFlowConfirmComponent_section_27_div_6_div_6_Template, 3, 1, "div", 33);
    \u0275\u0275element(7, "div", 34);
    \u0275\u0275elementStart(8, "div", 35);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "div", 36);
    \u0275\u0275template(11, NewDeskFlowConfirmComponent_section_27_div_6_div_11_Template, 6, 2, "div", 37);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function NewDeskFlowConfirmComponent_section_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 26)(1, "app-icon", 5);
    \u0275\u0275text(2, "done");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 27)(4, "h3");
    \u0275\u0275text(5, "Asset Requests");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, NewDeskFlowConfirmComponent_section_27_div_6_Template, 12, 11, "div", 28);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function NewDeskFlowConfirmComponent_section_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 42)(1, "app-icon", 5);
    \u0275\u0275text(2, "done");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 6)(4, "h3");
    \u0275\u0275text(5, "Requested Locker");
    \u0275\u0275elementEnd();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDeskFlowConfirmComponent, selectors: [["new-desk-flow-confirm"]], inputs: { show_close: "show_close" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 32, vars: 18, consts: [["icon", "", "name", "close-desk-confirm", "matRipple", "", "class", "absolute right-2 top-2 bg-base-200", 3, "click", 4, "ngIf"], [1, "flex", "items-center", "justify-between", "px-4", "pt-4"], [1, "text-2xl", "font-medium", "mb-2"], ["diameter", "32", 4, "ngIf"], ["period", "", 1, "flex", "space-x-1", "py-4", "px-2"], [1, "text-success"], ["details", "", 1, "leading-6"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], ["date", ""], ["class", "flex items-center space-x-2", 4, "ngIf"], [1, "flex", "flex-col", "leading-tight"], ["time", ""], ["class", "text-xs opacity-30", 4, "ngIf"], ["desk", "", "class", "flex space-x-1 py-4 px-2 border-t border-neutral", 4, "ngIf"], ["assets", "", "class", "flex space-x-1 py-4 px-2 border-t max-h-[50vh] overflow-auto", 4, "ngIf"], ["locker", "", "class", "flex space-x-1 py-4 px-2 border-t", 4, "ngIf"], [1, "p-2", "w-full", "border-t", "border-base-200", "mt-4"], ["name", "confirm-desk", "btn", "", "matRipple", "", "class", "w-full", 3, "click", 4, "ngIf"], ["icon", "", "name", "close-desk-confirm", "matRipple", "", 1, "absolute", "right-2", "top-2", "bg-base-200", 3, "click"], ["diameter", "32"], [1, "text-xs", "opacity-30"], ["desk", "", 1, "flex", "space-x-1", "py-4", "px-2", "border-t", "border-neutral"], ["name", ""], [4, "ngFor", "ngForOf"], ["features", "", 1, "flex", "items-center", "space-x-2"], ["assets", "", 1, "flex", "space-x-1", "py-4", "px-2", "border-t", "max-h-[50vh]", "overflow-auto"], ["details", "", 1, "flex-1", "leading-6", "w-1/2", "pr-2"], ["request", "", "class", "border bg-base-100 rounded-xl overflow-hidden", 3, "border-error", "border-base-300", 4, "ngFor", "ngForOf"], ["request", "", 1, "border", "bg-base-100", "rounded-xl", "overflow-hidden"], [1, "flex", "items-center", "space-x-2", "p-3"], [1, "flex-1", "flex", "items-center", "space-x-2"], [1, "text-sm"], ["class", "flex items-center justify-center h-6 w-6 rounded-full bg-error text-error-content", 3, "matTooltip", 4, "ngIf"], [1, "flex-1"], [1, "text-xs", "bg-success", "text-success-content", "px-2", "py-1", "rounded"], [1, "flex", "flex-col", "bg-base-200", "divide-y", "divide-base-100"], ["class", "flex items-center px-3 py-1 space-x-2 hover:opacity-90", 4, "ngFor", "ngForOf"], [1, "flex", "items-center", "justify-center", "h-6", "w-6", "rounded-full", "bg-error", "text-error-content", 3, "matTooltip"], [1, "flex", "items-center", "px-3", "py-1", "space-x-2", "hover:opacity-90"], [1, "flex", "items-center", "flex-1"], [1, "rounded", "bg-success", "text-success-content", "text-xs", "px-2", "py-1"], ["locker", "", 1, "flex", "space-x-1", "py-4", "px-2", "border-t"], [1, "flex", "space-x-2"], ["name", "confirm-desk", "btn", "", "matRipple", "", 1, "w-full", 3, "click"]], template: function NewDeskFlowConfirmComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(17, "date");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(18, NewDeskFlowConfirmComponent_div_18_Template, 5, 1, "div", 10);
        \u0275\u0275elementStart(19, "div", 7)(20, "app-icon", 8);
        \u0275\u0275text(21, "schedule");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(22, "div", 11)(23, "div", 12);
        \u0275\u0275text(24);
        \u0275\u0275elementEnd();
        \u0275\u0275template(25, NewDeskFlowConfirmComponent_div_25_Template, 2, 1, "div", 13);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(26, NewDeskFlowConfirmComponent_section_26_Template, 18, 6, "section", 14)(27, NewDeskFlowConfirmComponent_section_27_Template, 7, 1, "section", 15)(28, NewDeskFlowConfirmComponent_section_28_Template, 9, 0, "section", 16);
        \u0275\u0275elementStart(29, "footer", 17);
        \u0275\u0275template(30, NewDeskFlowConfirmComponent_button_30_Template, 2, 0, "button", 18);
        \u0275\u0275pipe(31, "async");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDeskFlowConfirmComponent, { className: "NewDeskFlowConfirmComponent", filePath: "apps/workplace/src/app/book/new-desk-flow/new-desk-flow-confirm.component.ts", lineNumber: 192 });
})();
...
function NewDeskFormDetailsComponent_div_0_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(5, "a-user-search-field", 26);
    \u0275\u0275elementEnd();
  }
}
function NewDeskFormDetailsComponent_div_0_mat_checkbox_27_Template(rf, ctx) {
  if (rf & 1) {
...
function NewDeskFormDetailsComponent_div_0_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function NewDeskFormDetailsComponent_div_0_div_28_Template_a_time_field_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.form.patchValue({ date: $event }));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 29)(8, "label", 32);
    \u0275\u0275text(9, " End Time");
    \u0275\u0275elementStart(10, "span");
    \u0275\u0275text(11, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(12, "a-duration-field", 33);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_6_0;
...
function NewDeskFormDetailsComponent_div_0_div_29_mat_checkbox_7_Template(rf, ctx) {
  if (rf & 1) {
...
function NewDeskFormDetailsComponent_div_0_div_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function NewDeskFormDetailsComponent_div_0_div_29_Template_recurrence_field_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.recurrence, $event) || (ctx_r1.recurrence = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function NewDeskFormDetailsComponent_div_0_div_29_Template_recurrence_field_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onRecurrenceChange($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, NewDeskFormDetailsComponent_div_0_div_29_mat_checkbox_7_Template, 2, 0, "mat-checkbox", 37);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function NewDeskFormDetailsComponent_div_0_div_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 28)(1, "div", 29)(2, "mat-checkbox", 39);
    \u0275\u0275listener("ngModelChange", function NewDeskFormDetailsComponent_div_0_div_30_Template_mat_checkbox_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.form.patchValue({ secondary_resource: $event ? "locker" : "" }));
    });
...
function NewDeskFormDetailsComponent_div_0_section_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "Group Members");
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "div", 41);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 42)(8, "a-user-list-field", 43);
    \u0275\u0275pipe(9, "async");
    \u0275\u0275listener("ngModelChange", function NewDeskFormDetailsComponent_div_0_section_31_Template_a_user_list_field_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.setOptions({ members: $event }));
    });
...
function NewDeskFormDetailsComponent_div_0_section_33_p_8_Template(rf, ctx) {
  if (rf & 1) {
...
function NewDeskFormDetailsComponent_div_0_section_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6, "Desk");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(7, "desk-list-field", 44);
    \u0275\u0275template(8, NewDeskFormDetailsComponent_div_0_section_33_p_8_Template, 2, 0, "p", 45);
    \u0275\u0275pipe(9, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function NewDeskFormDetailsComponent_div_0_section_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 3)(1, "h3", 4)(2, "div", 5);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 6);
    \u0275\u0275text(6, "Request Asset");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(7, "asset-list-field", 47);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_2_0;
...
function NewDeskFormDetailsComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1);
    \u0275\u0275template(1, NewDeskFormDetailsComponent_div_0_section_1_Template, 19, 24, "section", 2);
    ...
    \u0275\u0275text(7, "Details");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, NewDeskFormDetailsComponent_div_0_div_8_Template, 6, 0, "div", 7);
    \u0275\u0275pipe(9, "async");
    ...
    \u0275\u0275text(19, "Booking title is required.");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275text(24, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "a-date-field", 15);
    \u0275\u0275text(26, " Date and time must be in the future ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(27, NewDeskFormDetailsComponent_div_0_mat_checkbox_27_Template, 2, 0, "mat-checkbox", 16);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(28, NewDeskFormDetailsComponent_div_0_div_28_Template, 13, 11, "div", 17)(29, NewDeskFormDetailsComponent_div_0_div_29_Template, 8, 8, "div", 18)(30, NewDeskFormDetailsComponent_div_0_div_30_Template, 4, 3, "div", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275template(31, NewDeskFormDetailsComponent_div_0_section_31_Template, 10, 6, "section", 19);
    \u0275\u0275pipe(32, "async");
    \u0275\u0275template(33, NewDeskFormDetailsComponent_div_0_section_33_Template, 10, 6, "section", 19)(34, NewDeskFormDetailsComponent_div_0_section_34_Template, 8, 8, "section", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
    ...
    \u0275\u0275property("ngIf", ctx_r1.can_book_lockers);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_11_0 = \u0275\u0275pipeBind1(32, 16, ctx_r1.options)) == null ? null : tmp_11_0.group);
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDeskFormDetailsComponent, { className: "NewDeskFormDetailsComponent", filePath: "apps/workplace/src/app/book/new-desk-flow/new-desk-form-details.component.ts", lineNumber: 240 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDeskFlowFormComponent, { className: "NewDeskFlowFormComponent", filePath: "apps/workplace/src/app/book/new-desk-flow/new-desk-flow-form.component.ts", lineNumber: 51 });
})();
...
function NewDeskFlowSuccessComponent_span_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" group of ", (ctx_r0.last_event == null ? null : ctx_r0.last_event.attendees == null ? null : ctx_r0.last_event.attendees.length) + 1, " ");
  }
}
function NewDeskFlowSuccessComponent_span_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" including ", ctx_r0.last_event == null ? null : ctx_r0.last_event.extension_data == null ? null : ctx_r0.last_event.extension_data.assets == null ? null : ctx_r0.last_event.extension_data.assets.length, " asset(s) ");
  }
}
function NewDeskFlowSuccessComponent_span_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function NewDeskFlowSuccessComponent_p_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1, " Please allow up to 5 minutes for you booking to be approved. ");
    \u0275\u0275elementEnd();
...
function NewDeskFlowSuccessComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13)(1, "a", 14);
    \u0275\u0275pipe(2, "sanitize");
    \u0275\u0275element(3, "img", 15);
    \u0275\u0275elementStart(4, "span");
    \u0275\u0275text(5, "Add to Outlook");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "a", 16);
    \u0275\u0275pipe(7, "sanitize");
    \u0275\u0275element(8, "img", 17);
    \u0275\u0275elementStart(9, "span");
    \u0275\u0275text(10, "Add to Google Calendar");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "a", 18);
    \u0275\u0275pipe(12, "safe");
    \u0275\u0275elementStart(13, "app-icon", 19);
    \u0275\u0275text(14, "download");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "span");
    \u0275\u0275text(16, "Download iCal File");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDeskFlowSuccessComponent, selectors: [["new-desk-flow-success"]], decls: 19, vars: 14, consts: [[1, "absolute", "inset-0", "bg-base-100", "flex", "flex-col", "z-50", "overflow-auto"], [1, "flex-1", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium", "text-center"], ["src", "assets/icons/success.svg"], [1, "text-center"], ["group", "", 4, "ngIf"], ["assets", "", 4, "ngIf"], [4, "ngIf"], ["class", "flex flex-col items-center space-y-4 p-4 relative", 4, "ngIf"], [1, "sticky", "bottom-0", "p-2", "w-full", "border-t", "bg-base-100", "border-base-200", "mt-4", "flex", "items-center", "justify-center"], ["btn", "", "name", "desk-confirm-continue", "matRipple", "", 1, "w-full", "max-w-[32rem]", "mx-auto", 3, "routerLink"], ["group", ""], ["assets", ""], [1, "flex", "flex-col", "items-center", "space-y-4", "p-4", "relative"], ["btn", "", "matRipple", "", "name", "desk-outlook-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], ["src", "assets/icons/outlook.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-google-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], ["src", "assets/icons/gcal.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-ical-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], [1, "text-xl"]], template: function NewDeskFlowSuccessComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(6, " Your ");
        \u0275\u0275template(7, NewDeskFlowSuccessComponent_span_7_Template, 2, 1, "span", 5);
        \u0275\u0275text(8);
        \u0275\u0275template(9, NewDeskFlowSuccessComponent_span_9_Template, 2, 1, "span", 6);
        \u0275\u0275text(10);
        \u0275\u0275pipe(11, "date");
        \u0275\u0275template(12, NewDeskFlowSuccessComponent_span_12_Template, 4, 8, "span", 7);
        \u0275\u0275text(13, ". ");
        \u0275\u0275elementEnd();
        \u0275\u0275template(14, NewDeskFlowSuccessComponent_p_14_Template, 2, 0, "p", 7)(15, NewDeskFlowSuccessComponent_div_15_Template, 17, 12, "div", 8);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(16, "footer", 9)(17, "a", 10);
        \u0275\u0275text(18, " Great, thanks! ");
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate2(" ", ctx.last_event.asset_name || ctx.last_event.asset_id, "", ctx.location, " Booked! ");
        \u0275\u0275advance(4);
        \u0275\u0275property("ngIf", ctx.last_event == null ? null : ctx.last_event.attendees == null ? null : ctx.last_event.attendees.length);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" desk", (ctx.last_event == null ? null : ctx.last_event.attendees == null ? null : ctx.last_event.attendees.length) ? "s" : "", " has been successfully booked ");
        \u0275\u0275advance();
        ...
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" for ", \u0275\u0275pipeBind2(11, 10, ctx.last_event.date, "mediumDate"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !(ctx.last_event == null ? null : ctx.last_event.all_day));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", true);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDeskFlowSuccessComponent, { className: "NewDeskFlowSuccessComponent", filePath: "apps/workplace/src/app/book/new-desk-flow/new-desk-flow-success.component.ts", lineNumber: 110 });
})();
...
var NewDeskFlowComponent = class _NewDeskFlowComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDeskFlowComponent, selectors: [["placeos-new-book-desk-flow"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 2, consts: [[1, "bg-base-100", "h-full", "w-full", "z-50"], [3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"]], template: function NewDeskFlowComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275elementContainerStart(1, 1);
...
function NewParkingFlowConfirmComponent_section_25_ng_container_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 19)(2, "app-icon");
    \u0275\u0275text(3, "arrow_upward");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div");
    \u0275\u0275text(5);
...
function NewParkingFlowConfirmComponent_section_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 16)(1, "app-icon", 5);
    \u0275\u0275text(2, "done");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 6)(4, "h3", 17);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 7)(7, "app-icon");
    \u0275\u0275text(8, "person");
    ...
    \u0275\u0275text(10, "Car Park");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 7)(12, "app-icon");
    \u0275\u0275text(13, "place");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div");
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(16, NewParkingFlowConfirmComponent_section_25_ng_container_16_Template, 6, 1, "ng-container", 18);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function NewParkingFlowConfirmComponent_section_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 20)(1, "app-icon", 5);
    \u0275\u0275text(2, "done");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 6)(4, "h3");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, NewParkingFlowConfirmComponent_section_26_div_6_Template, 5, 2, "div", 21);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r1.assets_count, " Asset(s)");
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.assets);
  }
}
...
var NewParkingFlowConfirmComponent = class _NewParkingFlowConfirmComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewParkingFlowConfirmComponent, selectors: [["new-parking-flow-confirm"]], inputs: { show_close: "show_close" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 30, vars: 21, consts: [["close", "", "icon", "", "matRipple", "", 3, "click", 4, "ngIf"], [1, "flex", "items-center", "justify-between", "px-2"], [1, "text-2xl", "font-medium", "mb-2"], ["diameter", "32", 4, "ngIf"], ["period", "", 1, "flex", "space-x-1", "py-4", "px-2"], [1, "text-success"], ["details", "", 1, "leading-6"], [1, "flex", "items-center", "space-x-2"], ["date", ""], ["time", ""], ["resource", "", "class", "flex space-x-1 py-4 px-2 border-t", 4, "ngIf"], ["assets", "", "class", "flex space-x-1 py-4 px-2 border-t", 4, "ngIf"], [1, "p-2", "w-full", "border-t", "border-base-200", "mt-4"], ["confirm", "", "btn", "", "matRipple", "", "class", "w-full", 3, "click", 4, "ngIf"], ["close", "", "icon", "", "matRipple", "", 3, "click"], ["diameter", "32"], ["resource", "", 1, "flex", "space-x-1", "py-4", "px-2", "border-t"], ["name", ""], [4, "ngFor", "ngForOf"], ["features", "", 1, "flex", "items-center", "space-x-2"], ["assets", "", 1, "flex", "space-x-1", "py-4", "px-2", "border-t"], ["class", "flex space-x-2", 4, "ngFor", "ngForOf"], [1, "flex", "space-x-2"], [1, "h-5", "w-5", "bg-base-200", "rounded-full"], ["confirm", "", "btn", "", "matRipple", "", 1, "w-full", 3, "click"]], template: function NewParkingFlowConfirmComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, NewParkingFlowConfirmComponent_button_0_Template, 3, 0, "button", 0);
        \u0275\u0275elementStart(1, "header", 1)(2, "h2", 2);
        \u0275\u0275text(3, " Confirm Parking Reservation ");
        \u0275\u0275elementEnd();
        \u0275\u0275template(4, NewParkingFlowConfirmComponent_mat_spinner_4_Template, 1, 0, "mat-spinner", 3);
        \u0275\u0275pipe(5, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "section", 4)(7, "app-icon", 5);
        \u0275\u0275text(8, "done");
        ...
        \u0275\u0275pipe(17, "date");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(18, "div", 7)(19, "app-icon");
        \u0275\u0275text(20, "schedule");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275pipe(24, "date");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(25, NewParkingFlowConfirmComponent_section_25_Template, 17, 3, "section", 10)(26, NewParkingFlowConfirmComponent_section_26_Template, 7, 2, "section", 11);
        \u0275\u0275elementStart(27, "footer", 12);
        \u0275\u0275template(28, NewParkingFlowConfirmComponent_button_28_Template, 2, 0, "button", 13);
        \u0275\u0275pipe(29, "async");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewParkingFlowConfirmComponent, { className: "NewParkingFlowConfirmComponent", filePath: "apps/workplace/src/app/book/new-parking-flow/parking-flow-confirm.component.ts", lineNumber: 116 });
})();

// apps/workplace/src/app/book/new-parking-flow/parking-form-details.component.ts
var _c020 = () => ({ standalone: true });
function ParkingFormDetailsComponent_div_0_mat_option_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 18);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ParkingFormDetailsComponent_div_0_mat_checkbox_31_Template(rf, ctx) {
  if (rf & 1) {
...
function ParkingFormDetailsComponent_div_0_div_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("ngModelChange", function ParkingFormDetailsComponent_div_0_div_32_Template_a_time_field_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.form.patchValue({ date: $event }));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 24)(8, "label", 25);
    \u0275\u0275text(9, "End Time");
    \u0275\u0275elementStart(10, "span");
    \u0275\u0275text(11, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(12, "a-duration-field", 26);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ParkingFormDetailsComponent_div_0_div_33_Template(rf, ctx) {
  if (rf & 1) {
...
function ParkingFormDetailsComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "async");
    \u0275\u0275listener("ngModelChange", function ParkingFormDetailsComponent_div_0_Template_mat_select_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setBuilding($event));
    });
    \u0275\u0275template(10, ParkingFormDetailsComponent_div_0_mat_option_10_Template, 2, 2, "mat-option", 7);
    \u0275\u0275pipe(11, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "mat-error");
    \u0275\u0275text(13, "Building is required");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(14, "div", 2)(15, "div", 3)(16, "label", 4);
    \u0275\u0275text(17, "Add Title");
    ...
    \u0275\u0275text(23, "Meeting title is required.");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275text(28, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "a-date-field", 11);
    \u0275\u0275text(30, " Date and time must be in the future ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(31, ParkingFormDetailsComponent_div_0_mat_checkbox_31_Template, 2, 0, "mat-checkbox", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(32, ParkingFormDetailsComponent_div_0_div_32_Template, 13, 7, "div", 13)(33, ParkingFormDetailsComponent_div_0_div_33_Template, 7, 3, "div", 14);
    \u0275\u0275elementStart(34, "div", 15)(35, "label", 16);
    \u0275\u0275text(36, "Plate Number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "mat-form-field", 5);
    \u0275\u0275element(38, "input", 17);
    \u0275\u0275elementStart(39, "mat-error");
    \u0275\u0275text(40, "A plate number is required");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("formGroup", ctx_r1.form);
    \u0275\u0275advance(8);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(9, 8, ctx_r1.building))("ngModelOptions", \u0275\u0275pureFunction0(12, _c020));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(11, 10, ctx_r1.building_list));
    \u0275\u0275advance(19);
...
var ParkingFormDetailsComponent = class _ParkingFormDetailsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingFormDetailsComponent, selectors: [["parking-form-details"]], inputs: { form: "form" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [[3, "formGroup", 4, "ngIf"], [3, "formGroup"], [1, "flex", "items-center", "flex-wrap", "sm:space-x-2"], [1, "flex-1", "min-w-[256px]"], ["for", "title"], ["appearance", "outline", 1, "w-full"], [3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], ["matInput", "", "name", "title", "formControlName", "title", "placeholder", "e.g. Team Meeting"], [1, "flex-1", "min-w-[256px]", "relative"], ["for", "date"], ["name", "date", "formControlName", "date", 3, "to"], ["formControlName", "all_day", "class", "absolute -top-2 right-0", 4, "ngIf"], ["class", "flex items-center space-x-2", 4, "ngIf"], ["class", "w-full flex flex-col", 4, "ngIf"], [1, "flex", "flex-col"], ["for", "plate-number"], ["matInput", "", "name", "plate-number", "formControlName", "plate_number", "placeholder", "e.g. ABC123"], [3, "value"], ["formControlName", "all_day", 1, "absolute", "-top-2", "right-0"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1", "w-1/3"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "use_24hr"], [1, "flex-1", "w-1/3", "relative"], ["for", "end-time"], ["name", "end-time", "formControlName", "duration", 3, "time", "max", "use_24hr"], [1, "w-full", "flex", "flex-col"], ["for", "host"], ["name", "host", "formControlName", "organiser"]], template: function ParkingFormDetailsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, ParkingFormDetailsComponent_div_0_Template, 41, 13, "div", 0);
      }
      if (rf & 2) {
        \u0275\u0275property("ngIf", ctx.form);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingFormDetailsComponent, { className: "ParkingFormDetailsComponent", filePath: "apps/workplace/src/app/book/new-parking-flow/parking-form-details.component.ts", lineNumber: 113 });
})();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingFlowFormComponent, selectors: [["parking-flow-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 34, vars: 8, consts: [[1, "h-full", "w-full", "bg-base-200", "overflow-auto"], [1, "max-w-full", "w-[48rem]", "mx-auto", "sm:my-4", "bg-base-100", "border", "border-base-200"], [1, "w-full", "p-4", "sm:py-4", "sm:px-16", "text-2xl", "font-medium", "border-b", "border-base-200"], [1, "p-0", "sm:py-4", "sm:px-16", "divide-y", "divide-base-200", "space-y-2", 3, "formGroup"], [1, "p-2"], [1, "space-x-2", "flex", "items-center"], [1, "bg-base-200", "rounded-full", "h-6", "w-6", "flex", "items-center", "justify-center"], [1, "text-xl"], [1, "flex-1", "w-px"], ["icon", "", "matRipple", "", 3, "click"], [1, "overflow-hidden"], [1, "mt-4", 3, "form"], ["formControlName", "resources"], [1, "flex", "flex-col", "sm:flex-row", "items-center", "sm:space-x-2", "p-2"], ["btn", "", "matRipple", "", "confirm", "", 1, "mb-2", "sm:mb-0", "w-full", "sm:w-auto", 3, "click"], ["btn", "", "matRipple", "", "clear-form", "", 1, "inverse", "w-full", "sm:w-auto", 3, "click"]], template: function ParkingFlowFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(16, "parking-form-details", 11);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(17, "section", 4)(18, "h3", 5)(19, "div", 6);
        \u0275\u0275text(20, " 2 ");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275element(28, "parking-space-list-field", 12);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(29, "section", 13)(30, "button", 14);
        \u0275\u0275listener("click", function ParkingFlowFormComponent_Template_button_click_30_listener() {
          return ctx.viewConfirm();
        });
        \u0275\u0275text(31, " Confirm Reservation ");
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", ctx.form.value.id ? "Edit" : "Book", " Parking Reservation ");
        \u0275\u0275advance();
        ...
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate1(" ", ctx.form.value.id ? "Reset" : "Clear", " Form ");
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingFlowFormComponent, { className: "ParkingFlowFormComponent", filePath: "apps/workplace/src/app/book/new-parking-flow/parking-flow-form.component.ts", lineNumber: 124 });
})();

// apps/workplace/src/app/book/new-parking-flow/parking-flow-success.component.ts
var _c021 = () => ["/"];
function ParkingFlowSuccessComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingFlowSuccessComponent, selectors: [["parking-flow-success"]], decls: 17, vars: 17, consts: [[1, "absolute", "inset-0", "bg-base-100", "flex", "flex-col", "z-50", "overflow-auto"], [1, "flex-1", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium"], [1, "text-center", "max-w-[32rem]"], ["src", "assets/icons/parking-success.svg"], ["class", "flex flex-col items-center space-y-4 p-4 relative", 4, "ngIf"], [1, "sticky", "bottom-0", "bg-base-100", "p-2", "w-full", "border-t", "border-base-200", "mt-4", "flex", "items-center", "justify-center"], ["btn", "", "matRipple", "", 1, "w-full", "max-w-[32rem]", 3, "routerLink"], [1, "flex", "flex-col", "items-center", "space-y-4", "p-4", "relative"], ["btn", "", "matRipple", "", "name", "desk-outlook-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], ["src", "assets/icons/outlook.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-google-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], ["src", "assets/icons/gcal.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-ical-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], [1, "text-xl"]], template: function ParkingFlowSuccessComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275element(12, "img", 4);
        \u0275\u0275template(13, ParkingFlowSuccessComponent_div_13_Template, 17, 12, "div", 5);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(14, "footer", 6)(15, "a", 7);
        \u0275\u0275text(16, " Great, thanks! ");
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate2(" parking space reservation for ", ctx.last_event.asset_name, " at ", ctx.location, ", ");
        \u0275\u0275advance();
        \u0275\u0275textInterpolate3("has been successfully booked for the ", \u0275\u0275pipeBind2(9, 7, ctx.last_event.date, "mediumDate"), " at ", \u0275\u0275pipeBind2(10, 10, ctx.last_event.date, ctx.time_format), "-", \u0275\u0275pipeBind2(11, 13, ctx.last_event.date + ctx.last_event.duration * 60 * 1e3, ctx.time_format), ". ");
        \u0275\u0275advance(5);
        \u0275\u0275property("ngIf", ctx.show_links);
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingFlowSuccessComponent, { className: "ParkingFlowSuccessComponent", filePath: "apps/workplace/src/app/book/new-parking-flow/parking-flow-success.component.ts", lineNumber: 91 });
})();
...
function BookLockerFlowConfirmComponent_section_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, BookLockerFlowConfirmComponent_section_25_ng_container_11_Template, 6, 1, "ng-container", 18);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function BookLockerFlowConfirmComponent_section_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, BookLockerFlowConfirmComponent_section_26_div_6_Template, 5, 2, "div", 21);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var BookLockerFlowConfirmComponent = class _BookLockerFlowConfirmComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookLockerFlowConfirmComponent, selectors: [["locker-flow-confirm"]], inputs: { show_close: "show_close" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 30, vars: 21, consts: [["icon", "", "name", "close-locker-confirm", "matRipple", "", 3, "click", 4, "ngIf"], [1, "flex", "items-center", "justify-between", "px-2"], [1, "text-2xl", "font-medium", "mb-2"], ["diameter", "32", 4, "ngIf"], ["period", "", 1, "flex", "space-x-1", "py-4", "px-2"], [1, "text-success"], ["details", "", 1, "leading-6"], [1, "flex", "items-center", "space-x-2"], ["date", ""], ["time", ""], ["locker", "", "class", "flex space-x-1 py-4 px-2 border-t", 4, "ngIf"], ["assets", "", "class", "flex space-x-1 py-4 px-2 border-t", 4, "ngIf"], [1, "p-2", "w-full", "border-t", "border-base-200", "mt-4"], ["name", "confirm-locker", "btn", "", "matRipple", "", "class", "w-full", 3, "click", 4, "ngIf"], ["icon", "", "name", "close-locker-confirm", "matRipple", "", 3, "click"], ["diameter", "32"], ["locker", "", 1, "flex", "space-x-1", "py-4", "px-2", "border-t"], ["name", ""], [4, "ngFor", "ngForOf"], ["features", "", 1, "flex", "items-center", "space-x-2"], ["assets", "", 1, "flex", "space-x-1", "py-4", "px-2", "border-t"], ["class", "flex space-x-2", 4, "ngFor", "ngForOf"], [1, "flex", "space-x-2"], [1, "h-5", "w-5", "bg-base-200", "rounded-full"], ["name", "confirm-locker", "btn", "", "matRipple", "", 1, "w-full", 3, "click"]], template: function BookLockerFlowConfirmComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, BookLockerFlowConfirmComponent_button_0_Template, 3, 0, "button", 0);
        \u0275\u0275elementStart(1, "header", 1)(2, "h2", 2);
        \u0275\u0275text(3, "Confirm Locker Booking");
        \u0275\u0275elementEnd();
        \u0275\u0275template(4, BookLockerFlowConfirmComponent_mat_spinner_4_Template, 1, 0, "mat-spinner", 3);
        \u0275\u0275pipe(5, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "section", 4)(7, "app-icon", 5);
        \u0275\u0275text(8, "done");
        ...
        \u0275\u0275pipe(24, "date");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(25, BookLockerFlowConfirmComponent_section_25_Template, 12, 3, "section", 10)(26, BookLockerFlowConfirmComponent_section_26_Template, 7, 2, "section", 11);
        \u0275\u0275elementStart(27, "footer", 12);
        \u0275\u0275template(28, BookLockerFlowConfirmComponent_button_28_Template, 2, 0, "button", 13);
        \u0275\u0275pipe(29, "async");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookLockerFlowConfirmComponent, { className: "BookLockerFlowConfirmComponent", filePath: "apps/workplace/src/app/book/locker-flow/locker-flow-confirm.component.ts", lineNumber: 113 });
})();

// apps/workplace/src/app/book/locker-flow/locker-form-details.component.ts
var _c025 = () => ({ standalone: true });
function LockerFormDetailsComponent_div_0_mat_option_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 21);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function LockerFormDetailsComponent_div_0_section_37_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6, "Locker");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(7, "locker-list-field", 22);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_2_0;
...
function LockerFormDetailsComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(12, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "mat-form-field", 9)(14, "mat-select", 10);
    \u0275\u0275twoWayListener("ngModelChange", function LockerFormDetailsComponent_div_0_Template_mat_select_ngModelChange_14_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.building, $event) || (ctx_r1.building = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(15, LockerFormDetailsComponent_div_0_mat_option_15_Template, 2, 2, "mat-option", 11);
    \u0275\u0275pipe(16, "async");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275text(21, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "a-date-field", 12);
    ...
    \u0275\u0275text(29, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "a-time-field", 16);
    \u0275\u0275listener("ngModelChange", function LockerFormDetailsComponent_div_0_Template_a_time_field_ngModelChange_30_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.form.patchValue({ date: $event }));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 17)(32, "label", 18);
    \u0275\u0275text(33, " End Time");
    \u0275\u0275elementStart(34, "span");
    \u0275\u0275text(35, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(36, "a-duration-field", 19);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(37, LockerFormDetailsComponent_div_0_section_37_Template, 8, 3, "section", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_10_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(16, 17, ctx_r1.buildings));
    \u0275\u0275advance(15);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockerFormDetailsComponent, { className: "LockerFormDetailsComponent", filePath: "apps/workplace/src/app/book/locker-flow/locker-form-details.component.ts", lineNumber: 102 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookLockerFlowFormComponent, { className: "BookLockerFlowFormComponent", filePath: "apps/workplace/src/app/book/locker-flow/locker-flow-form.component.ts", lineNumber: 53 });
})();
...
function BookLockerFlowSuccessComponent_span_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 11);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function BookLockerFlowSuccessComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookLockerFlowSuccessComponent, selectors: [["locker-flow-success"]], decls: 18, vars: 20, consts: [[1, "absolute", "inset-0", "bg-base-100", "flex", "flex-col", "z-50", "overflow-auto"], [1, "flex-1", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium", "text-center"], ["src", "assets/icons/locker-success.svg"], [1, "text-center"], ["group", "", 4, "ngIf"], ["assets", "", 4, "ngIf"], ["class", "flex flex-col items-center space-y-4 p-4 relative", 4, "ngIf"], [1, "sticky", "bottom-0", "bg-base-100", "p-2", "w-full", "border-t", "border-base-200", "mt-4", "flex", "items-center", "justify-center"], ["btn", "", "name", "locker-confirm-continue", "matRipple", "", 1, "w-full", "max-w-[32rem]", "mx-auto", 3, "routerLink"], ["group", ""], ["assets", ""], [1, "flex", "flex-col", "items-center", "space-y-4", "p-4", "relative"], ["btn", "", "matRipple", "", "name", "locker-outlook-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], ["src", "assets/icons/outlook.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "locker-google-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], ["src", "assets/icons/gcal.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "locker-ical-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], [1, "text-xl"]], template: function BookLockerFlowSuccessComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementStart(5, "p", 4);
        \u0275\u0275text(6, " Your ");
        \u0275\u0275template(7, BookLockerFlowSuccessComponent_span_7_Template, 2, 1, "span", 5);
        \u0275\u0275text(8);
        \u0275\u0275template(9, BookLockerFlowSuccessComponent_span_9_Template, 2, 1, "span", 6);
        \u0275\u0275text(10);
        \u0275\u0275pipe(11, "date");
        \u0275\u0275pipe(12, "date");
        \u0275\u0275pipe(13, "date");
        \u0275\u0275elementEnd();
        \u0275\u0275template(14, BookLockerFlowSuccessComponent_div_14_Template, 17, 12, "div", 7);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(15, "footer", 8)(16, "a", 9);
        \u0275\u0275text(17, " Great, thanks! ");
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        ...
        \u0275\u0275property("ngIf", ctx.last_event == null ? null : ctx.last_event.attendees == null ? null : ctx.last_event.attendees.length);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" locker", (ctx.last_event == null ? null : ctx.last_event.attendees == null ? null : ctx.last_event.attendees.length) ? "s" : "", " has been successfully booked ");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.last_event == null ? null : ctx.last_event.extension_data == null ? null : ctx.last_event.extension_data.assets == null ? null : ctx.last_event.extension_data.assets.length);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate3(" for the ", \u0275\u0275pipeBind2(11, 10, ctx.last_event.date, "mediumDate"), " at ", \u0275\u0275pipeBind2(12, 13, ctx.last_event.date, ctx.time_format), "-", \u0275\u0275pipeBind2(13, 16, ctx.last_event.date + ctx.last_event.duration * 60 * 1e3, ctx.time_format), ". ");
        \u0275\u0275advance(4);
        \u0275\u0275property("ngIf", ctx.show_links);
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookLockerFlowSuccessComponent, { className: "BookLockerFlowSuccessComponent", filePath: "apps/workplace/src/app/book/locker-flow/locker-flow-success.component.ts", lineNumber: 106 });
})();
...
//# sourceMappingURL=book.module-H3OB6PLN.js.map
