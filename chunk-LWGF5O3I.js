...
var _ParkingStateService = class _ParkingStateService extends AsyncHandler {
  constructor() {
    ...
    this.spaces = combineLatest([
      ...
      return fu(options.zones[0] || levels[0]?.id, "parking-spaces").pipe(map(({ details }) => (details instanceof Array ? details : []).map((space) => __spreadProps(__spreadValues({}, space), {
...
//# sourceMappingURL=chunk-LWGF5O3I.js.map
