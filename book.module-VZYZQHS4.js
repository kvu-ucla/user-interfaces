...
function MeetingFlowSuccessComponent_div_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 9, "BOOKINGS.ITEM_BOOKED", \u0275\u0275pureFunction1(14, _c112, \u0275\u0275pipeBind1(4, 7, "RESOURCE.ROOM"))), " ");
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(16, _c26));
    \u0275\u0275advance();
...
var MeetingFlowSuccessComponent = class _MeetingFlowSuccessComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowSuccessComponent, selectors: [["meeting-flow-success"]], standalone: false, decls: 4, vars: 13, consts: [["class", "absolute inset-0 bg-base-100 flex flex-col z-50 overflow-auto", 4, "ngIf"], [1, "absolute", "inset-0", "bg-base-100", "flex", "flex-col", "z-50", "overflow-auto"], [1, "flex-1", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium"], ["src", "assets/icons/success.svg"], [1, "text-center", "max-w-[32rem]"], [4, "ngIf"], [1, "h-4"], ["btn", "", "matRipple", "", "class", "w-48", 3, "click", 4, "ngIf"], [1, "sticky", "bottom-0", "bg-base-100", "p-2", "w-full", "border-t", "border-base-200", "mt-4", "flex", "items-center", "justify-center"], ["btn", "", "name", "meeting-created-continue", "matRipple", "", 1, "w-full", "max-w-[32rem]", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click"]], template: function MeetingFlowSuccessComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275declareLet(0);
        \u0275\u0275pipe(1, "date");
        \u0275\u0275pipe(2, "date");
      ...
      if (rf & 2) {
        \u0275\u0275storeLet(\u0275\u0275pureFunction4(8, _c022, (ctx.level == null ? null : ctx.level.display_name) || (ctx.level == null ? null : ctx.level.name), (ctx.space == null ? null : ctx.space.display_name) || (ctx.space == null ? null : ctx.space.name), \u0275\u0275pipeBind2(1, 1, ctx.last_event.date, "mediumDate"), \u0275\u0275pipeBind2(2, 4, ctx.last_event.date, ctx.time_format)));
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", !ctx.loading);
      }
...
var _c114 = () => [];
var _c27 = (a0, a1, a2) => ({ date: a0, duration: a1, all_day: a2 });
...
function NewDeskFormDetailsComponent_div_0_section_40_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("options", \u0275\u0275pureFunction3(7, _c27, ctx_r1.form.getRawValue().date, ctx_r1.form.value.duration, ctx_r1.form.value.all_day));
  }
}
...
var _c115 = () => ["/"];
var _c28 = (a0, a1, a2) => ({ date: a0, time: a1, size: a2 });
...
function NewDeskFlowSuccessComponent_p_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275storeLet(\u0275\u0275pureFunction3(11, _c28, \u0275\u0275pipeBind2(2, 1, (ctx_r1.last_event == null ? null : ctx_r1.last_event.date) || 0, "mediumDate"), \u0275\u0275pipeBind2(3, 4, (ctx_r1.last_event == null ? null : ctx_r1.last_event.date) || 0, ctx_r1.time_format) + " - " + \u0275\u0275pipeBind2(4, 7, ctx_r1.last_event.date + ctx_r1.last_event.duration * 60 * 1e3, ctx_r1.time_format), ctx_r1.group_size));
    \u0275\u0275advance(4);
...
function ParkingFormDetailsComponent_div_0_div_37_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(14, _c026))("use_24hr", ctx_r1.use_24hr)("timezone", ctx_r1.timezone);
    \u0275\u0275advance(3);
...
function ParkingFormDetailsComponent_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(10, 19, ctx_r1.building))("ngModelOptions", \u0275\u0275pureFunction0(37, _c026));
    \u0275\u0275advance(2);
...
var ParkingFormDetailsComponent = class _ParkingFormDetailsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingFormDetailsComponent, selectors: [["parking-form-details"]], inputs: { form: "form" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [[3, "formGroup", 4, "ngIf"], [3, "formGroup"], [1, "flex", "items-center", "flex-wrap", "sm:space-x-2"], [1, "flex-1", "min-w-[256px]"], ["for", "title"], ["appearance", "outline", 1, "w-full"], [3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], ["matInput", "", "name", "title", "formControlName", "title", "placeholder", "e.g. Team Meeting"], [1, "flex-1", "min-w-[256px]", "relative"], ["for", "date"], ["name", "date", "formControlName", "date", 3, "to", "timezone"], ["formControlName", "all_day", "class", "absolute -top-2 right-0", 4, "ngIf"], ["class", "flex items-center space-x-2", 4, "ngIf"], ["class", "w-full flex flex-col", 4, "ngIf"], [1, "flex", "flex-col"], ["for", "plate-number"], ["matInput", "", "name", "plate-number", "formControlName", "plate_number", 3, "placeholder"], [3, "value"], ["formControlName", "all_day", 1, "absolute", "-top-2", "right-0"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1", "w-1/3"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "use_24hr", "timezone"], [1, "flex-1", "w-1/3", "relative"], ["for", "end-time"], ["name", "end-time", "formControlName", "duration", 3, "time", "max", "use_24hr", "timezone"], [1, "w-full", "flex", "flex-col"], ["for", "host"], ["name", "host", "formControlName", "organiser"]], template: function ParkingFormDetailsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
function CodeFlowErrorComponent_a_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(5, _c118))("queryParams", \u0275\u0275pureFunction1(6, _c29, ctx_r0.asset_id));
    \u0275\u0275advance();
...
function CodeFlowErrorComponent_a_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(5, _c36))("queryParams", \u0275\u0275pureFunction1(6, _c29, ctx_r0.asset_id));
    \u0275\u0275advance();
...
function LockerFormDetailsComponent_div_0_div_29_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(18, _c031))("use_24hr", ctx_r1.use_24hr)("disabled", ctx_r1.form.value.duration > 24 * 60 - 1)("timezone", ctx_r1.timezone);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 16, "FORM.TIME_END"), "");
    \u0275\u0275advance(4);
    \u0275\u0275property("time", (tmp_9_0 = ctx_r1.form.get("date")) == null ? null : tmp_9_0.value)("max", 10 * 60)("min", 60)("step", 60)("use_24hr", ctx_r1.use_24hr)("custom_options", ctx_r1.custom_durations)("timezone", ctx_r1.timezone);
  }
}
...
function LockerFormDetailsComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(29, LockerFormDetailsComponent_div_0_div_29_Template, 15, 19, "div", 15);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.building);
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(24, _c031));
    \u0275\u0275advance();
...
var LockerFormDetailsComponent = class _LockerFormDetailsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockerFormDetailsComponent, selectors: [["new-locker-form-details"]], inputs: { form: "form" }, outputs: { find: "find" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 1, vars: 1, consts: [["class", "p-0 sm:py-4 sm:px-16 divide-y divide-base-200 space-y-2", 3, "formGroup", 4, "ngIf"], [1, "p-0", "sm:py-4", "sm:px-16", "divide-y", "divide-base-200", "space-y-2", 3, "formGroup"], [1, "p-2"], [1, "space-x-2", "flex", "items-center", "mb-4"], [1, "bg-base-200", "rounded-full", "h-6", "w-6", "flex", "items-center", "justify-center"], [1, "text-xl"], [1, "flex", "items-center", "flex-wrap", "sm:space-x-2"], [1, "flex-1", "min-w-[256px]"], ["for", "date"], ["appearance", "outline", 1, "w-full"], ["placeholder", "Select Building", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value", 4, "ngFor", "ngForOf"], [1, "relative", "flex-1", "min-w-[256px]"], ["name", "date", "formControlName", "date", 3, "timezone"], ["formControlName", "all_day", "class", "absolute -top-2 right-0", 4, "ngIf"], ["class", "flex items-center space-x-2", 4, "ngIf"], ["class", "p-2", 4, "ngIf"], [3, "value"], ["formControlName", "all_day", 1, "absolute", "-top-2", "right-0"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1", "w-1/3"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "use_24hr", "disabled", "timezone"], [1, "flex-1", "w-1/3", "relative"], ["for", "end-time"], ["name", "end-time", "formControlName", "duration", 3, "time", "max", "min", "step", "use_24hr", "custom_options", "timezone"], ["formControlName", "resources"]], template: function LockerFormDetailsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockerFormDetailsComponent, { className: "LockerFormDetailsComponent", filePath: "apps/workplace/src/app/book/locker-flow/locker-form-details.component.ts", lineNumber: 130 });
})();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookLockerFlowSuccessComponent, selectors: [["locker-flow-success"]], standalone: false, decls: 17, vars: 30, consts: [[1, "absolute", "inset-0", "bg-base-100", "flex", "flex-col", "z-50", "overflow-auto"], [1, "flex-1", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium", "text-center"], ["src", "assets/icons/locker-success.svg"], [1, "text-center"], ["class", "flex flex-col items-center space-y-4 p-4 relative", 4, "ngIf"], [1, "sticky", "bottom-0", "bg-base-100", "p-2", "w-full", "border-t", "border-base-200", "mt-4", "flex", "items-center", "justify-center"], ["btn", "", "name", "locker-confirm-continue", "matRipple", "", 1, "w-full", "max-w-[32rem]", "mx-auto", 3, "routerLink"], [1, "flex", "flex-col", "items-center", "space-y-4", "p-4", "relative"], ["btn", "", "matRipple", "", "name", "locker-outlook-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], ["src", "assets/icons/outlook.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "locker-google-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], ["src", "assets/icons/gcal.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "locker-ical-link", "target", "_blank", "rel", "noopener noreferer", 1, "flex", "items-center", "p-2", "space-x-2", "pr-4", "w-64", "rounded", "inverse", 3, "href"], [1, "text-xl"]], template: function BookLockerFlowSuccessComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngIf", ctx.show_links);
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(29, _c210));
        \u0275\u0275advance();
