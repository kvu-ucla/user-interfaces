...
var EventsComponent = class _EventsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventsComponent, selectors: [["", "app-events", ""]], standalone: false, attrs: _c0, decls: 5, vars: 0, consts: [[1, "flex", "flex-1", "h-px"], [1, "relative", "flex", "flex-col", "flex-1", "w-1/2", "h-full"]], template: function EventsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var _c1 = (a0, a1) => ({ key: "level", name: a0, content: a1, size: "8rem", sortable: false });
...
function EventListingComponent_ng_template_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(13, "div", 36)(14, "app-icon", 37);
    ...
    \u0275\u0275pipe(18, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(19, "a", 40)(20, "div", 36)(21, "app-icon", 37);
    \u0275\u0275text(22, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "button", 35)(27, "div", 36)(28, "app-icon", 37);
    ...
    \u0275\u0275elementStart(34, "div", 36)(35, "app-icon", 41);
    \u0275\u0275text(36, "delete");
    \u0275\u0275elementEnd();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventListingComponent, selectors: [["event-listing"]], standalone: false, decls: 26, vars: 50, consts: [["event_template", ""], ["level_template", ""], ["room_template", ""], ["interested_template", ""], ["attending_template", ""], ["published_template", ""], ["status_template", ""], ["actions_template", ""], ["view_attendees", ""], ["menu", "matMenu"], ["mode", "indeterminate", 1, "w-full"], ["empty_message", "No group events for selected period", 1, "min-w-[72rem]", "w-full", "block", "text-sm", 3, "data", "columns", "sortable"], [1, "w-full", "h-20"], [1, "flex", "items-center", "space-x-2", "px-3", "py-2"], ["date", "", 1, "flex", "flex-col", "items-center", "leading-tight", "w-8"], ["month", "", 1, "text-sm", "font-medium", "relative", "top-0.5", "opacity-60"], ["day", "", 1, "text-2xl", "font-light", "relative", "-top-0.5"], [1, "flex", "items-center", "justify-center", "h-12", "w-12", "rounded", "overflow-hidden", "bg-base-200", "border", "border-base-200"], ["auth", "", "class", "min-h-full min-w-full object-cover", 3, "source", 4, "ngIf"], ["details", "", 1, "flex", "flex-col"], [1, "text-sm"], [1, "text-xs", "opacity-40"], [1, "text-xs"], ["auth", "", 1, "min-h-full", "min-w-full", "object-cover", 3, "source"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"], ["icon", "", "matRipple", "", "customTooltip", "", 1, "rounded", "h-12", "w-12", "mx-auto", 3, "content", "disabled"], [1, "relative", "w-[20rem]", "h-[28rem]", "overflow-auto", "bg-white", "rounded", "shadow"], [3, "list", "host", "show_host", "hide_close", "custom_title"], [3, "show_host", "list", "host", "hide_close"], ["class", "rounded h-8 w-8 flex items-center justify-center text-2xl bg-success text-success-content mx-auto", 4, "ngIf"], [1, "rounded", "h-8", "w-8", "flex", "items-center", "justify-center", "text-2xl", "bg-success", "text-success-content", "mx-auto"], [1, "px-4", "py-1", "rounded-full"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "mx-2", 3, "matMenuTriggerFor", "disabled"], ["mat-menu-item", "", 3, "disabled"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "mr-2"], ["mat-menu-item", "", 3, "click"], ["mat-menu-item", "", 3, "routerLink"], [1, "text-2xl", "text-error"]], template: function EventListingComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("data", ctx.event_list)("columns", \u0275\u0275pureFunction8(41, _c8, \u0275\u0275pureFunction1(19, _c02, event_template_r14), \u0275\u0275pureFunction2(21, _c1, \u0275\u0275pipeBind1(3, 7, "RESOURCE.LEVEL"), level_template_r15), \u0275\u0275pureFunction2(24, _c2, \u0275\u0275pipeBind1(4, 9, "RESOURCE.ROOM"), room_template_r16), \u0275\u0275pureFunction2(27, _c3, \u0275\u0275pipeBind1(5, 11, "CALENDAR_EVENT.GROUP_INTERESTED"), interested_template_r17), \u0275\u0275pureFunction2(30, _c4, \u0275\u0275pipeBind1(6, 13, "CALENDAR_EVENT.GROUP_ATTENDING_FIELD"), attending_template_r18), \u0275\u0275pureFunction2(33, _c5, \u0275\u0275pipeBind1(7, 15, "COMMON.STATUS"), status_template_r20), \u0275\u0275pureFunction2(36, _c6, \u0275\u0275pipeBind1(8, 17, "COMMON.PUBLISHED"), published_template_r19), \u0275\u0275pureFunction1(39, _c7, actions_template_r21)))("sortable", true);
      }
    }, dependencies: [NgIf, MatMenu, MatMenuItem, MatMenuTrigger, MatProgressBar, MatRipple, IconComponent, CustomTooltipComponent, SimpleTableComponent, AuthenticatedImageDirective, AttendeeListComponent, RouterLink, AsyncPipe, DatePipe, LevelPipe, BuildingPipe, TranslatePipe, SpacePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventListingComponent, { className: "EventListingComponent", filePath: "apps/concierge/src/app/events/event-listing.component.ts", lineNumber: 297 });
})();
...
function EventMonthViewComponent_div_3_button_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 4, "APP.CONCIERGE.EVENTS_MORE_COUNT", \u0275\u0275pureFunction1(8, _c12, (\u0275\u0275pipeBind1(2, 2, ctx_r3.event_day_map)[ctx_r3.dateString(day_r6.id)] || \u0275\u0275pureFunction0(7, _c04)).length - 3)), " ");
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventsListComponent, selectors: [["app-event-list"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 44, vars: 32, consts: [[1, "absolute", "inset-0", "flex", "flex-col"], [1, "flex", "items-center", "justify-between", "p-8"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 3, "routerLink"], [1, "ml-2"], [1, "text-2xl"], ["filters", "", 1, "flex", "items-center", "px-8", "space-x-2", "pb-4"], ["btn", "", "matRipple", "", 1, "rounded-3xl", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl"], [1, "pr-2"], [1, "h-full", "px-2"], [1, "w-px", "h-full", "bg-base-300"], ["appearance", "outline", 1, "w-32", "no-subscript"], [3, "ngModelChange", "ngModel"], ["value", "week"], ["value", "month"], ["appearance", "outline", 1, "w-64", "no-subscript"], [3, "value", 4, "ngFor", "ngForOf"], [1, "h-1/2", "flex-1", "w-full", "px-8", "overflow-y-auto", "relative"], ["class", "w-full min-h-full overflow-x-auto", 4, "ngIf"], [3, "period", 4, "ngIf"], ["class", "absolute inset-0 flex items-center justify-center z-50", 4, "ngIf"], [3, "value"], [1, "w-full", "min-h-full", "overflow-x-auto"], [1, "block"], [3, "period"], [1, "absolute", "inset-0", "flex", "items-center", "justify-center", "z-50"], [1, "absolute", "inset-0", "bg-base-100", "opacity-80"], [1, "opacity-60", "text-lg", "max-w-[32rem]"]], template: function EventsListComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementStart(20, "div", 8)(21, "app-icon", 9);
        \u0275\u0275text(22, "event");
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(31, _c05));
        \u0275\u0275advance(2);
...
var _c13 = () => ["/entertainment", "events"];
function EventManageComponent_div_0_a_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 50)(1, "app-icon");
    \u0275\u0275text(2, "close");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(1, _c13));
  }
}
...
function EventManageComponent_div_0_div_63_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r3.form.getRawValue().date)("disabled", ctx_r3.form.controls.date.disabled)("ngModelOptions", \u0275\u0275pureFunction0(15, _c06))("use_24hr", ctx_r3.use_24hr);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 13, "FORM.TIME_END"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r3.form.value.date_end || ctx_r3.form.value.date + ctx_r3.form.value.duration * 60 * 1e3)("ngModelOptions", \u0275\u0275pureFunction0(16, _c06))("from", (ctx_r3.form == null ? null : (tmp_13_0 = ctx_r3.form.getRawValue()) == null ? null : tmp_13_0.date) + 30 * 60 * 1e3)("use_24hr", ctx_r3.use_24hr)("extra_info_fn", ctx_r3.duration_info);
  }
}
...
function EventManageComponent_div_0_ng_container_101_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r3.building_zone)("ngModelOptions", \u0275\u0275pureFunction0(39, _c06))("placeholder", \u0275\u0275pipeBind1(6, 19, "COMMON.BUILDING_SELECT"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(8, 21, ctx_r3.building_list));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 23, "RESOURCE.LEVEL"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r3.level_zone)("ngModelOptions", \u0275\u0275pureFunction0(40, _c06))("placeholder", \u0275\u0275pipeBind1(16, 25, "COMMON.LEVEL_SELECT"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(41, _c06))("disabled", ((tmp_18_0 = \u0275\u0275pipeBind1(25, 31, ctx_r3.available_spaces)) == null ? null : tmp_18_0.length) === 0)("placeholder", \u0275\u0275pipeBind1(26, 33, "COMMON.ROOM_SELECT"));
    \u0275\u0275advance(5);
...
function EventManageComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(67, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "mat-form-field", 34)(69, "app-icon", 35);
    \u0275\u0275text(70, " search ");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(38, 58, "APP.CONCIERGE.EVENTS_PUBLISH"))("ngModel", ctx_r3.form.value.view_access === "OPEN")("ngModelOptions", \u0275\u0275pureFunction0(88, _c06));
    \u0275\u0275advance(4);
...
var EventManageComponent = class _EventManageComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventManageComponent, selectors: [["app-event-manage"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 3, vars: 2, consts: [["load_state", ""], ["chipList", ""], ["auto", "matAutocomplete"], ["class", "absolute inset-0 bg-base-100 overflow-auto", 4, "ngIf", "ngIfElse"], [1, "absolute", "inset-0", "bg-base-100", "overflow-auto"], [1, "sticky", "flex", "items-center", "justify-between", "top-0", "px-4", "py-2", "mx-auto", "my-2", "max-w-[640px]", "w-full", "border-none", "z-10", "bg-base-200", "rounded"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", 3, "routerLink", 4, "ngIf"], [1, "flex", "flex-col", "w-[40rem]", "max-w-full", "mx-auto", "px-4", "my-2", "pb-16", 3, "formGroup"], [1, "flex", "flex-col", "space-y-2"], ["for", "title"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "title", "formControlName", "title", "placeholder", "e.g. Team Meeting"], ["for", "host"], [1, "pb-4"], ["name", "host", "formControlName", "organiser"], ["for", "tags"], ["appearance", "outline", 1, "no-subscript"], ["aria-label", "Event Tags"], [3, "selectable", "removable", "removed", 4, "ngFor", "ngForOf"], ["placeholder", "Add new tags relevant to this event...", 3, "matChipInputTokenEnd", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur"], [1, "py-4", "flex", "items-center", "space-x-4"], ["formControlName", "featured", 1, "flex-1", 3, "name"], [1, "flex-1", 3, "ngModelChange", "name", "ngModel", "ngModelOptions"], [1, "w-full", "h-px", "bg-base-200"], [1, "py-4", "text-2xl", "font-medium"], [1, "flex", "items-center", "flex-wrap", "sm:space-x-2"], [1, "flex-1", "min-w-[256px]", "relative"], ["for", "date"], ["name", "date", "formControlName", "date", 3, "to"], ["name", "date", "formControlName", "date_end", 3, "from", "to"], ["class", "flex items-center space-x-2", 4, "ngIf"], [1, "flex", "flex-col"], ["for", "display-name"], ["appearance", "outline"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", "formControlName", "timezone", 3, "placeholder", "matAutocomplete"], [3, "value", 4, "ngFor", "ngForOf"], [3, "disabled", 4, "ngIf"], [1, "flex", "items-center", "space-x-2", "pb-2"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "click"], [1, "text-2xl"], [1, "mx-2"], [4, "ngIf"], ["for", "description"], [1, "mb-16"], ["formControlName", "body"], ["for", "images"], ["formControlName", "images"], ["class", "fixed bottom-0 left-1/2 -translate-x-1/2 px-4 py-2 mx-auto my-2 max-w-[640px] w-full border-none z-10 bg-base-200 rounded flex items-center justify-end", 4, "ngIf"], ["icon", "", "matRipple", "", 3, "routerLink"], [3, "removed", "selectable", "removable"], ["matChipRemove", ""], [1, "flex", "items-center", "space-x-2"], [1, "flex-1", "w-1/3"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "disabled", "ngModelOptions", "use_24hr"], ["for", "end-time"], ["name", "end-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "from", "use_24hr", "extra_info_fn"], [3, "value"], [3, "disabled"], ["for", "location"], [3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [1, "flex", "space-x-2"], [1, "flex", "flex-col", "flex-[2]"], ["for", "level"], [1, "flex", "flex-col", "flex-[3]"], [3, "ngModelChange", "ngModel", "ngModelOptions", "disabled", "placeholder"], [1, "fixed", "bottom-0", "left-1/2", "-translate-x-1/2", "px-4", "py-2", "mx-auto", "my-2", "max-w-[640px]", "w-full", "border-none", "z-10", "bg-base-200", "rounded", "flex", "items-center", "justify-end"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "absolute", "inset-0", "bg-base-100", "flex", "flex-col", "items-center", "justify-center", "space-y-4"], ["diameter", "48"]], template: function EventManageComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=events.module-MXTDIQJK.js.map
